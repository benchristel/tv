var Od=Object.defineProperty;var Pn=(e,n)=>{for(var a in n)Od(e,a,{get:n[a],enumerable:!0})};var At=(e,n,a)=>new Promise((t,i)=>{var r=l=>{try{s(a.next(l))}catch(d){i(d)}},o=l=>{try{s(a.throw(l))}catch(d){i(d)}},s=l=>l.done?t(l.value):Promise.resolve(l.value).then(r,o);s((a=a.apply(e,n)).next())});function Qe(e,n,a){return a={path:n,exports:{},require:function(t,i){return Nd(t,i==null?a.path:i)}},e(a,a.exports),a.exports}function Nd(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var ts=Object.getOwnPropertySymbols,Gd=Object.prototype.hasOwnProperty,Bd=Object.prototype.propertyIsEnumerable;function Wd(e){if(e==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(e)}function Rd(){try{if(!Object.assign)return!1;var e=new String("abc");if(e[5]="de",Object.getOwnPropertyNames(e)[0]==="5")return!1;for(var n={},a=0;a<10;a++)n["_"+String.fromCharCode(a)]=a;var t=Object.getOwnPropertyNames(n).map(function(r){return n[r]});if(t.join("")!=="0123456789")return!1;var i={};return"abcdefghijklmnopqrst".split("").forEach(function(r){i[r]=r}),Object.keys(Object.assign({},i)).join("")==="abcdefghijklmnopqrst"}catch(r){return!1}}var Ud=Rd()?Object.assign:function(e,n){for(var a,t=Wd(e),i,r=1;r<arguments.length;r++){a=Object(arguments[r]);for(var o in a)Gd.call(a,o)&&(t[o]=a[o]);if(ts){i=ts(a);for(var s=0;s<i.length;s++)Bd.call(a,i[s])&&(t[i[s]]=a[i[s]])}}return t},x=Ud;var Dd=Qe(function(e,n){var a=60103,t=60106;n.Fragment=60107,n.StrictMode=60108,n.Profiler=60114;var i=60109,r=60110,o=60112;n.Suspense=60113;var s=60115,l=60116;if(typeof Symbol=="function"&&Symbol.for){var d=Symbol.for;a=d("react.element"),t=d("react.portal"),n.Fragment=d("react.fragment"),n.StrictMode=d("react.strict_mode"),n.Profiler=d("react.profiler"),i=d("react.provider"),r=d("react.context"),o=d("react.forward_ref"),n.Suspense=d("react.suspense"),s=d("react.memo"),l=d("react.lazy")}var y=typeof Symbol=="function"&&Symbol.iterator;function C(g){return g===null||typeof g!="object"?null:(g=y&&g[y]||g["@@iterator"],typeof g=="function"?g:null)}function S(g){for(var A="https://reactjs.org/docs/error-decoder.html?invariant="+g,K=1;K<arguments.length;K++)A+="&args[]="+encodeURIComponent(arguments[K]);return"Minified React error #"+g+"; visit "+A+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},W={};function N(g,A,K){this.props=g,this.context=A,this.refs=W,this.updater=K||M}N.prototype.isReactComponent={},N.prototype.setState=function(g,A){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error(S(85));this.updater.enqueueSetState(this,g,A,"setState")},N.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function h(){}h.prototype=N.prototype;function u(g,A,K){this.props=g,this.context=A,this.refs=W,this.updater=K||M}var c=u.prototype=new h;c.constructor=u,x(c,N.prototype),c.isPureReactComponent=!0;var m={current:null},p=Object.prototype.hasOwnProperty,R={key:!0,ref:!0,__self:!0,__source:!0};function v(g,A,K){var j,k={},w=null,B=null;if(A!=null)for(j in A.ref!==void 0&&(B=A.ref),A.key!==void 0&&(w=""+A.key),A)p.call(A,j)&&!R.hasOwnProperty(j)&&(k[j]=A[j]);var P=arguments.length-2;if(P===1)k.children=K;else if(1<P){for(var F=Array(P),ee=0;ee<P;ee++)F[ee]=arguments[ee+2];k.children=F}if(g&&g.defaultProps)for(j in P=g.defaultProps,P)k[j]===void 0&&(k[j]=P[j]);return{$$typeof:a,type:g,key:w,ref:B,props:k,_owner:m.current}}function G(g,A){return{$$typeof:a,type:g.type,key:A,ref:g.ref,props:g.props,_owner:g._owner}}function D(g){return typeof g=="object"&&g!==null&&g.$$typeof===a}function U(g){var A={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(K){return A[K]})}var J=/\/+/g;function ke(g,A){return typeof g=="object"&&g!==null&&g.key!=null?U(""+g.key):A.toString(36)}function Dn(g,A,K,j,k){var w=typeof g;(w==="undefined"||w==="boolean")&&(g=null);var B=!1;if(g===null)B=!0;else switch(w){case"string":case"number":B=!0;break;case"object":switch(g.$$typeof){case a:case t:B=!0}}if(B)return B=g,k=k(B),g=j===""?"."+ke(B,0):j,Array.isArray(k)?(K="",g!=null&&(K=g.replace(J,"$&/")+"/"),Dn(k,A,K,"",function(ee){return ee})):k!=null&&(D(k)&&(k=G(k,K+(!k.key||B&&B.key===k.key?"":(""+k.key).replace(J,"$&/")+"/")+g)),A.push(k)),1;if(B=0,j=j===""?".":j+":",Array.isArray(g))for(var P=0;P<g.length;P++){w=g[P];var F=j+ke(w,P);B+=Dn(w,A,K,F,k)}else if(F=C(g),typeof F=="function")for(g=F.call(g),P=0;!(w=g.next()).done;)w=w.value,F=j+ke(w,P++),B+=Dn(w,A,K,F,k);else if(w==="object")throw A=""+g,Error(S(31,A==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":A));return B}function oe(g,A,K){if(g==null)return g;var j=[],k=0;return Dn(g,j,"","",function(w){return A.call(K,w,k++)}),j}function ie(g){if(g._status===-1){var A=g._result;A=A(),g._status=0,g._result=A,A.then(function(K){g._status===0&&(K=K.default,g._status=1,g._result=K)},function(K){g._status===0&&(g._status=2,g._result=K)})}if(g._status===1)return g._result;throw g._result}var Sn={current:null};function se(){var g=Sn.current;if(g===null)throw Error(S(321));return g}var kn={ReactCurrentDispatcher:Sn,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:m,IsSomeRendererActing:{current:!1},assign:x};n.Children={map:oe,forEach:function(g,A,K){oe(g,function(){A.apply(this,arguments)},K)},count:function(g){var A=0;return oe(g,function(){A++}),A},toArray:function(g){return oe(g,function(A){return A})||[]},only:function(g){if(!D(g))throw Error(S(143));return g}},n.Component=N,n.PureComponent=u,n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=kn,n.cloneElement=function(g,A,K){if(g==null)throw Error(S(267,g));var j=x({},g.props),k=g.key,w=g.ref,B=g._owner;if(A!=null){if(A.ref!==void 0&&(w=A.ref,B=m.current),A.key!==void 0&&(k=""+A.key),g.type&&g.type.defaultProps)var P=g.type.defaultProps;for(F in A)p.call(A,F)&&!R.hasOwnProperty(F)&&(j[F]=A[F]===void 0&&P!==void 0?P[F]:A[F])}var F=arguments.length-2;if(F===1)j.children=K;else if(1<F){P=Array(F);for(var ee=0;ee<F;ee++)P[ee]=arguments[ee+2];j.children=P}return{$$typeof:a,type:g.type,key:k,ref:w,props:j,_owner:B}},n.createContext=function(g,A){return A===void 0&&(A=null),g={$$typeof:r,_calculateChangedBits:A,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider={$$typeof:i,_context:g},g.Consumer=g},n.createElement=v,n.createFactory=function(g){var A=v.bind(null,g);return A.type=g,A},n.createRef=function(){return{current:null}},n.forwardRef=function(g){return{$$typeof:o,render:g}},n.isValidElement=D,n.lazy=function(g){return{$$typeof:l,_payload:{_status:-1,_result:g},_init:ie}},n.memo=function(g,A){return{$$typeof:s,type:g,compare:A===void 0?null:A}},n.useCallback=function(g,A){return se().useCallback(g,A)},n.useContext=function(g,A){return se().useContext(g,A)},n.useDebugValue=function(){},n.useEffect=function(g,A){return se().useEffect(g,A)},n.useImperativeHandle=function(g,A,K){return se().useImperativeHandle(g,A,K)},n.useLayoutEffect=function(g,A){return se().useLayoutEffect(g,A)},n.useMemo=function(g,A){return se().useMemo(g,A)},n.useReducer=function(g,A,K){return se().useReducer(g,A,K)},n.useRef=function(g){return se().useRef(g)},n.useState=function(g){return se().useState(g)},n.version="17.0.2"}),H=Qe(function(e){e.exports=Dd});var sm=H.Children,is=H.Component,Fn=H.Fragment,lm=H.Profiler,um=H.PureComponent,dm=H.StrictMode,cm=H.Suspense,hm=H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,gm=H.cloneElement,mm=H.createContext,E=H.createElement,fm=H.createFactory,pm=H.createRef,Sm=H.forwardRef,km=H.isValidElement,ym=H.lazy,Im=H.memo,Tm=H.useCallback,Am=H.useContext,Em=H.useDebugValue,Kn=H.useEffect,vm=H.useImperativeHandle,Mm=H.useLayoutEffect,wm=H.useMemo,Cm=H.useReducer,Aa=H.useRef,Be=H.useState,Om=H.version;var Ld=Qe(function(e,n){var a,t,i,r;if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;n.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();n.unstable_now=function(){return s.now()-l}}if(typeof window=="undefined"||typeof MessageChannel!="function"){var d=null,y=null,C=function(){if(d!==null)try{var k=n.unstable_now();d(!0,k),d=null}catch(w){throw setTimeout(C,0),w}};a=function(k){d!==null?setTimeout(a,0,k):(d=k,setTimeout(C,0))},t=function(k,w){y=setTimeout(k,w)},i=function(){clearTimeout(y)},n.unstable_shouldYield=function(){return!1},r=n.unstable_forceFrameRate=function(){}}else{var S=window.setTimeout,M=window.clearTimeout;if(typeof console!="undefined"){var W=window.cancelAnimationFrame;typeof window.requestAnimationFrame!="function"&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),typeof W!="function"&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var N=!1,h=null,u=-1,c=5,m=0;n.unstable_shouldYield=function(){return n.unstable_now()>=m},r=function(){},n.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):c=0<k?Math.floor(1e3/k):5};var p=new MessageChannel,R=p.port2;p.port1.onmessage=function(){if(h!==null){var k=n.unstable_now();m=k+c;try{h(!0,k)?R.postMessage(null):(N=!1,h=null)}catch(w){throw R.postMessage(null),w}}else N=!1},a=function(k){h=k,N||(N=!0,R.postMessage(null))},t=function(k,w){u=S(function(){k(n.unstable_now())},w)},i=function(){M(u),u=-1}}function v(k,w){var B=k.length;k.push(w);e:for(;;){var P=B-1>>>1,F=k[P];if(F!==void 0&&0<U(F,w))k[P]=w,k[B]=F,B=P;else break e}}function G(k){return k=k[0],k===void 0?null:k}function D(k){var w=k[0];if(w!==void 0){var B=k.pop();if(B!==w){k[0]=B;e:for(var P=0,F=k.length;P<F;){var ee=2*(P+1)-1,yn=k[ee],Ta=ee+1,Ln=k[Ta];if(yn!==void 0&&0>U(yn,B))Ln!==void 0&&0>U(Ln,yn)?(k[P]=Ln,k[Ta]=B,P=Ta):(k[P]=yn,k[ee]=B,P=ee);else if(Ln!==void 0&&0>U(Ln,B))k[P]=Ln,k[Ta]=B,P=Ta;else break e}}return w}return null}function U(k,w){var B=k.sortIndex-w.sortIndex;return B!==0?B:k.id-w.id}var J=[],ke=[],Dn=1,oe=null,ie=3,Sn=!1,se=!1,kn=!1;function g(k){for(var w=G(ke);w!==null;){if(w.callback===null)D(ke);else if(w.startTime<=k)D(ke),w.sortIndex=w.expirationTime,v(J,w);else break;w=G(ke)}}function A(k){if(kn=!1,g(k),!se)if(G(J)!==null)se=!0,a(K);else{var w=G(ke);w!==null&&t(A,w.startTime-k)}}function K(k,w){se=!1,kn&&(kn=!1,i()),Sn=!0;var B=ie;try{for(g(w),oe=G(J);oe!==null&&(!(oe.expirationTime>w)||k&&!n.unstable_shouldYield());){var P=oe.callback;if(typeof P=="function"){oe.callback=null,ie=oe.priorityLevel;var F=P(oe.expirationTime<=w);w=n.unstable_now(),typeof F=="function"?oe.callback=F:oe===G(J)&&D(J),g(w)}else D(J);oe=G(J)}if(oe!==null)var ee=!0;else{var yn=G(ke);yn!==null&&t(A,yn.startTime-w),ee=!1}return ee}finally{oe=null,ie=B,Sn=!1}}var j=r;n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(k){k.callback=null},n.unstable_continueExecution=function(){se||Sn||(se=!0,a(K))},n.unstable_getCurrentPriorityLevel=function(){return ie},n.unstable_getFirstCallbackNode=function(){return G(J)},n.unstable_next=function(k){switch(ie){case 1:case 2:case 3:var w=3;break;default:w=ie}var B=ie;ie=w;try{return k()}finally{ie=B}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=j,n.unstable_runWithPriority=function(k,w){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var B=ie;ie=k;try{return w()}finally{ie=B}},n.unstable_scheduleCallback=function(k,w,B){var P=n.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?P+B:P):B=P,k){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=B+F,k={id:Dn++,callback:w,priorityLevel:k,startTime:B,expirationTime:F,sortIndex:-1},B>P?(k.sortIndex=B,v(ke,k),G(J)===null&&k===G(ke)&&(kn?i():kn=!0,t(A,B-P))):(k.sortIndex=F,v(J,k),se||Sn||(se=!0,a(K))),k},n.unstable_wrapCallback=function(k){var w=ie;return function(){var B=ie;ie=w;try{return k.apply(this,arguments)}finally{ie=B}}}}),ne=Qe(function(e){e.exports=Ld});function T(e){for(var n="https://reactjs.org/docs/error-decoder.html?invariant="+e,a=1;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!H)throw Error(T(227));var rs=new Set,Ea={};function In(e,n){Hn(e,n),Hn(e+"Capture",n)}function Hn(e,n){for(Ea[e]=n,e=0;e<n.length;e++)rs.add(n[e])}var He=!(typeof window=="undefined"||typeof window.document=="undefined"||typeof window.document.createElement=="undefined"),Pd=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,os=Object.prototype.hasOwnProperty,ss={},ls={};function Fd(e){return os.call(ls,e)?!0:os.call(ss,e)?!1:Pd.test(e)?ls[e]=!0:(ss[e]=!0,!1)}function Kd(e,n,a,t){if(a!==null&&a.type===0)return!1;switch(typeof n){case"function":case"symbol":return!0;case"boolean":return t?!1:a!==null?!a.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function Hd(e,n,a,t){if(n===null||typeof n=="undefined"||Kd(e,n,a,t))return!0;if(t)return!1;if(a!==null)switch(a.type){case 3:return!n;case 4:return n===!1;case 5:return isNaN(n);case 6:return isNaN(n)||1>n}return!1}function fe(e,n,a,t,i,r,o){this.acceptsBooleans=n===2||n===3||n===4,this.attributeName=t,this.attributeNamespace=i,this.mustUseProperty=a,this.propertyName=e,this.type=n,this.sanitizeURL=r,this.removeEmptyString=o}var le={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){le[e]=new fe(e,0,!1,e,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var n=e[0];le[n]=new fe(n,1,!1,e[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(e){le[e]=new fe(e,2,!1,e.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){le[e]=new fe(e,2,!1,e,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){le[e]=new fe(e,3,!1,e.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(e){le[e]=new fe(e,3,!0,e,null,!1,!1)});["capture","download"].forEach(function(e){le[e]=new fe(e,4,!1,e,null,!1,!1)});["cols","rows","size","span"].forEach(function(e){le[e]=new fe(e,6,!1,e,null,!1,!1)});["rowSpan","start"].forEach(function(e){le[e]=new fe(e,5,!1,e.toLowerCase(),null,!1,!1)});var Fi=/[\-:]([a-z])/g;function Ki(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var n=e.replace(Fi,Ki);le[n]=new fe(n,1,!1,e,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var n=e.replace(Fi,Ki);le[n]=new fe(n,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var n=e.replace(Fi,Ki);le[n]=new fe(n,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(e){le[e]=new fe(e,1,!1,e.toLowerCase(),null,!1,!1)});le.xlinkHref=new fe("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(e){le[e]=new fe(e,1,!1,e.toLowerCase(),null,!0,!0)});function Hi(e,n,a,t){var i=le.hasOwnProperty(n)?le[n]:null,r=i!==null?i.type===0:t?!1:!(!(2<n.length)||n[0]!=="o"&&n[0]!=="O"||n[1]!=="n"&&n[1]!=="N");r||(Hd(n,a,i,t)&&(a=null),t||i===null?Fd(n)&&(a===null?e.removeAttribute(n):e.setAttribute(n,""+a)):i.mustUseProperty?e[i.propertyName]=a===null?i.type===3?!1:"":a:(n=i.attributeName,t=i.attributeNamespace,a===null?e.removeAttribute(n):(i=i.type,a=i===3||i===4&&a===!0?"":""+a,t?e.setAttributeNS(t,n,a):e.setAttribute(n,a))))}var Tn=H.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,va=60103,An=60106,Je=60107,bi=60108,Ma=60114,xi=60109,Yi=60110,Et=60112,wa=60113,vt=60120,Mt=60115,ji=60116,Vi=60121,zi=60128,us=60129,_i=60130,Qi=60131;typeof Symbol=="function"&&Symbol.for&&(ae=Symbol.for,va=ae("react.element"),An=ae("react.portal"),Je=ae("react.fragment"),bi=ae("react.strict_mode"),Ma=ae("react.profiler"),xi=ae("react.provider"),Yi=ae("react.context"),Et=ae("react.forward_ref"),wa=ae("react.suspense"),vt=ae("react.suspense_list"),Mt=ae("react.memo"),ji=ae("react.lazy"),Vi=ae("react.block"),ae("react.scope"),zi=ae("react.opaque.id"),us=ae("react.debug_trace_mode"),_i=ae("react.offscreen"),Qi=ae("react.legacy_hidden"));var ae,ds=typeof Symbol=="function"&&Symbol.iterator;function Ca(e){return e===null||typeof e!="object"?null:(e=ds&&e[ds]||e["@@iterator"],typeof e=="function"?e:null)}var Ji;function Oa(e){if(Ji===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Ji=n&&n[1]||""}return`
...
`+i[o].replace(" at new "," at ");while(1<=o&&0<=s);break}}}finally{qi=!1,Error.prepareStackTrace=a}return(e=e?e.displayName||e.name:"")?Oa(e):""}function bd(e){switch(e.tag){case 5:return Oa(e.type);case 16:return Oa("Lazy");case 13:return Oa("Suspense");case 19:return Oa("SuspenseList");case 0:case 2:case 15:return e=wt(e.type,!1),e;case 11:return e=wt(e.type.render,!1),e;case 22:return e=wt(e.type._render,!1),e;case 1:return e=wt(e.type,!0),e;default:return""}}function bn(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Je:return"Fragment";case An:return"Portal";case Ma:return"Profiler";case bi:return"StrictMode";case wa:return"Suspense";case vt:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case Yi:return(e.displayName||"Context")+".Consumer";case xi:return(e._context.displayName||"Context")+".Provider";case Et:var n=e.render;return n=n.displayName||n.name||"",e.displayName||(n!==""?"ForwardRef("+n+")":"ForwardRef");case Mt:return bn(e.type);case Vi:return bn(e._render);case ji:n=e._payload,e=e._init;try{return bn(e(n))}catch(a){}}return null}function qe(e){switch(typeof e){case"boolean":case"number":case"object":case"string":case"undefined":return e;default:return""}}function cs(e){var n=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(n==="checkbox"||n==="radio")}function xd(e){var n=cs(e)?"checked":"value",a=Object.getOwnPropertyDescriptor(e.constructor.prototype,n),t=""+e[n];if(!e.hasOwnProperty(n)&&typeof a!="undefined"&&typeof a.get=="function"&&typeof a.set=="function"){var i=a.get,r=a.set;return Object.defineProperty(e,n,{configurable:!0,get:function(){return i.call(this)},set:function(o){t=""+o,r.call(this,o)}}),Object.defineProperty(e,n,{enumerable:a.enumerable}),{getValue:function(){return t},setValue:function(o){t=""+o},stopTracking:function(){e._valueTracker=null,delete e[n]}}}}function Ct(e){e._valueTracker||(e._valueTracker=xd(e))}function hs(e){if(!e)return!1;var n=e._valueTracker;if(!n)return!0;var a=n.getValue(),t="";return e&&(t=cs(e)?e.checked?"true":"false":e.value),e=t,e!==a?(n.setValue(e),!0):!1}function Ot(e){if(e=e||(typeof document!="undefined"?document:void 0),typeof e=="undefined")return null;try{return e.activeElement||e.body}catch(n){return e.body}}function Zi(e,n){var a=n.checked;return x({},n,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:a!=null?a:e._wrapperState.initialChecked})}function gs(e,n){var a=n.defaultValue==null?"":n.defaultValue,t=n.checked!=null?n.checked:n.defaultChecked;a=qe(n.value!=null?n.value:a),e._wrapperState={initialChecked:t,initialValue:a,controlled:n.type==="checkbox"||n.type==="radio"?n.checked!=null:n.value!=null}}function ms(e,n){n=n.checked,n!=null&&Hi(e,"checked",n,!1)}function $i(e,n){ms(e,n);var a=qe(n.value),t=n.type;if(a!=null)t==="number"?(a===0&&e.value===""||e.value!=a)&&(e.value=""+a):e.value!==""+a&&(e.value=""+a);else if(t==="submit"||t==="reset"){e.removeAttribute("value");return}n.hasOwnProperty("value")?Xi(e,n.type,a):n.hasOwnProperty("defaultValue")&&Xi(e,n.type,qe(n.defaultValue)),n.checked==null&&n.defaultChecked!=null&&(e.defaultChecked=!!n.defaultChecked)}function fs(e,n,a){if(n.hasOwnProperty("value")||n.hasOwnProperty("defaultValue")){var t=n.type;if(!(t!=="submit"&&t!=="reset"||n.value!==void 0&&n.value!==null))return;n=""+e._wrapperState.initialValue,a||n===e.value||(e.value=n),e.defaultValue=n}a=e.name,a!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,a!==""&&(e.name=a)}function Xi(e,n,a){(n!=="number"||Ot(e.ownerDocument)!==e)&&(a==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+a&&(e.defaultValue=""+a))}function Yd(e){var n="";return H.Children.forEach(e,function(a){a!=null&&(n+=a)}),n}function er(e,n){return e=x({children:void 0},n),(n=Yd(n.children))&&(e.children=n),e}function xn(e,n,a,t){if(e=e.options,n){n={};for(var i=0;i<a.length;i++)n["$"+a[i]]=!0;for(a=0;a<e.length;a++)i=n.hasOwnProperty("$"+e[a].value),e[a].selected!==i&&(e[a].selected=i),i&&t&&(e[a].defaultSelected=!0)}else{for(a=""+qe(a),n=null,i=0;i<e.length;i++){if(e[i].value===a){e[i].selected=!0,t&&(e[i].defaultSelected=!0);return}n!==null||e[i].disabled||(n=e[i])}n!==null&&(n.selected=!0)}}function nr(e,n){if(n.dangerouslySetInnerHTML!=null)throw Error(T(91));return x({},n,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function ps(e,n){var a=n.value;if(a==null){if(a=n.children,n=n.defaultValue,a!=null){if(n!=null)throw Error(T(92));if(Array.isArray(a)){if(!(1>=a.length))throw Error(T(93));a=a[0]}n=a}n==null&&(n=""),a=n}e._wrapperState={initialValue:qe(a)}}function Ss(e,n){var a=qe(n.value),t=qe(n.defaultValue);a!=null&&(a=""+a,a!==e.value&&(e.value=a),n.defaultValue==null&&e.defaultValue!==a&&(e.defaultValue=a)),t!=null&&(e.defaultValue=""+t)}function ks(e){var n=e.textContent;n===e._wrapperState.initialValue&&n!==""&&n!==null&&(e.value=n)}var ar={html:"http://www.w3.org/1999/xhtml",mathml:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg"};function ys(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function tr(e,n){return e==null||e==="http://www.w3.org/1999/xhtml"?ys(n):e==="http://www.w3.org/2000/svg"&&n==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var Nt,Is=function(e){return typeof MSApp!="undefined"&&MSApp.execUnsafeLocalFunction?function(n,a,t,i){MSApp.execUnsafeLocalFunction(function(){return e(n,a,t,i)})}:e}(function(e,n){if(e.namespaceURI!==ar.svg||"innerHTML"in e)e.innerHTML=n;else{for(Nt=Nt||document.createElement("div"),Nt.innerHTML="<svg>"+n.valueOf().toString()+"</svg>",n=Nt.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;n.firstChild;)e.appendChild(n.firstChild)}});function Na(e,n){if(n){var a=e.firstChild;if(a&&a===e.lastChild&&a.nodeType===3){a.nodeValue=n;return}}e.textContent=n}var Ga={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},jd=["Webkit","ms","Moz","O"];Object.keys(Ga).forEach(function(e){jd.forEach(function(n){n=n+e.charAt(0).toUpperCase()+e.substring(1),Ga[n]=Ga[e]})});function Ts(e,n,a){return n==null||typeof n=="boolean"||n===""?"":a||typeof n!="number"||n===0||Ga.hasOwnProperty(e)&&Ga[e]?(""+n).trim():n+"px"}function As(e,n){e=e.style;for(var a in n)if(n.hasOwnProperty(a)){var t=a.indexOf("--")===0,i=Ts(a,n[a],t);a==="float"&&(a="cssFloat"),t?e.setProperty(a,i):e[a]=i}}var Vd=x({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function ir(e,n){if(n){if(Vd[e]&&(n.children!=null||n.dangerouslySetInnerHTML!=null))throw Error(T(137,e));if(n.dangerouslySetInnerHTML!=null){if(n.children!=null)throw Error(T(60));if(!(typeof n.dangerouslySetInnerHTML=="object"&&"__html"in n.dangerouslySetInnerHTML))throw Error(T(61))}if(n.style!=null&&typeof n.style!="object")throw Error(T(62))}}function rr(e,n){if(e.indexOf("-")===-1)return typeof n.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}function or(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var sr=null,Yn=null,jn=null;function Es(e){if(e=Ba(e)){if(typeof sr!="function")throw Error(T(280));var n=e.stateNode;n&&(n=Gt(n),sr(e.stateNode,e.type,n))}}function vs(e){Yn?jn?jn.push(e):jn=[e]:Yn=e}function Ms(){if(Yn){var e=Yn,n=jn;if(jn=Yn=null,Es(e),n)for(e=0;e<n.length;e++)Es(n[e])}}function lr(e,n){return e(n)}function ws(e,n,a,t,i){return e(n,a,t,i)}function ur(){}var Cs=lr,En=!1,dr=!1;function cr(){(Yn!==null||jn!==null)&&(ur(),Ms())}function zd(e,n,a){if(dr)return e(n,a);dr=!0;try{return Cs(e,n,a)}finally{dr=!1,cr()}}function Wa(e,n){var a=e.stateNode;if(a===null)return null;var t=Gt(a);if(t===null)return null;a=t[n];e:switch(n){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(t=!t.disabled)||(e=e.type,t=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!t;break e;default:e=!1}if(e)return null;if(a&&typeof a!="function")throw Error(T(231,n,typeof a));return a}var hr=!1;if(He)try{Vn={},Object.defineProperty(Vn,"passive",{get:function(){hr=!0}}),window.addEventListener("test",Vn,Vn),window.removeEventListener("test",Vn,Vn)}catch(e){hr=!1}var Vn;function _d(e,n,a,t,i,r,o,s,l){var d=Array.prototype.slice.call(arguments,3);try{n.apply(a,d)}catch(y){this.onError(y)}}var Ra=!1,Bt=null,Wt=!1,gr=null,Qd={onError:function(e){Ra=!0,Bt=e}};function Jd(e,n,a,t,i,r,o,s,l){Ra=!1,Bt=null,_d.apply(Qd,arguments)}function qd(e,n,a,t,i,r,o,s,l){if(Jd.apply(this,arguments),Ra){if(Ra){var d=Bt;Ra=!1,Bt=null}else throw Error(T(198));Wt||(Wt=!0,gr=d)}}function vn(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&1026)!=0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function Os(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function Ns(e){if(vn(e)!==e)throw Error(T(188))}function Zd(e){var n=e.alternate;if(!n){if(n=vn(e),n===null)throw Error(T(188));return n!==e?null:e}for(var a=e,t=n;;){var i=a.return;if(i===null)break;var r=i.alternate;if(r===null){if(t=i.return,t!==null){a=t;continue}break}if(i.child===r.child){for(r=i.child;r;){if(r===a)return Ns(i),e;if(r===t)return Ns(i),n;r=r.sibling}throw Error(T(188))}if(a.return!==t.return)a=i,t=r;else{for(var o=!1,s=i.child;s;){if(s===a){o=!0,a=i,t=r;break}if(s===t){o=!0,t=i,a=r;break}s=s.sibling}if(!o){for(s=r.child;s;){if(s===a){o=!0,a=r,t=i;break}if(s===t){o=!0,t=r,a=i;break}s=s.sibling}if(!o)throw Error(T(189))}}if(a.alternate!==t)throw Error(T(190))}if(a.tag!==3)throw Error(T(188));return a.stateNode.current===a?e:n}function Gs(e){if(e=Zd(e),!e)return null;for(var n=e;;){if(n.tag===5||n.tag===6)return n;if(n.child)n.child.return=n,n=n.child;else{if(n===e)break;for(;!n.sibling;){if(!n.return||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}}return null}function Bs(e,n){for(var a=e.alternate;n!==null;){if(n===e||n===a)return!0;n=n.return}return!1}var Ws,mr,Rs,Us,fr=!1,Ue=[],Ze=null,Xe=null,$e=null,Ua=new Map,Da=new Map,La=[],Ds="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function pr(e,n,a,t,i){return{blockedOn:e,domEventName:n,eventSystemFlags:a|16,nativeEvent:i,targetContainers:[t]}}function Ls(e,n){switch(e){case"focusin":case"focusout":Ze=null;break;case"dragenter":case"dragleave":Xe=null;break;case"mouseover":case"mouseout":$e=null;break;case"pointerover":case"pointerout":Ua.delete(n.pointerId);break;case"gotpointercapture":case"lostpointercapture":Da.delete(n.pointerId)}}function Pa(e,n,a,t,i,r){return e===null||e.nativeEvent!==r?(e=pr(n,a,t,i,r),n!==null&&(n=Ba(n),n!==null&&mr(n)),e):(e.eventSystemFlags|=t,n=e.targetContainers,i!==null&&n.indexOf(i)===-1&&n.push(i),e)}function Xd(e,n,a,t,i){switch(n){case"focusin":return Ze=Pa(Ze,e,n,a,t,i),!0;case"dragenter":return Xe=Pa(Xe,e,n,a,t,i),!0;case"mouseover":return $e=Pa($e,e,n,a,t,i),!0;case"pointerover":var r=i.pointerId;return Ua.set(r,Pa(Ua.get(r)||null,e,n,a,t,i)),!0;case"gotpointercapture":return r=i.pointerId,Da.set(r,Pa(Da.get(r)||null,e,n,a,t,i)),!0}return!1}function $d(e){var n=Mn(e.target);if(n!==null){var a=vn(n);if(a!==null){if(n=a.tag,n===13){if(n=Os(a),n!==null){e.blockedOn=n,Us(e.lanePriority,function(){ne.unstable_runWithPriority(e.priority,function(){Rs(a)})});return}}else if(n===3&&a.stateNode.hydrate){e.blockedOn=a.tag===3?a.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Rt(e){if(e.blockedOn!==null)return!1;for(var n=e.targetContainers;0<n.length;){var a=Sr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null)return n=Ba(a),n!==null&&mr(n),e.blockedOn=a,!1;n.shift()}return!0}function Ps(e,n,a){Rt(e)&&a.delete(n)}function ec(){for(fr=!1;0<Ue.length;){var e=Ue[0];if(e.blockedOn!==null){e=Ba(e.blockedOn),e!==null&&Ws(e);break}for(var n=e.targetContainers;0<n.length;){var a=Sr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null){e.blockedOn=a;break}n.shift()}e.blockedOn===null&&Ue.shift()}Ze!==null&&Rt(Ze)&&(Ze=null),Xe!==null&&Rt(Xe)&&(Xe=null),$e!==null&&Rt($e)&&($e=null),Ua.forEach(Ps),Da.forEach(Ps)}function Fa(e,n){e.blockedOn===n&&(e.blockedOn=null,fr||(fr=!0,ne.unstable_scheduleCallback(ne.unstable_NormalPriority,ec)))}function Fs(e){function n(i){return Fa(i,e)}if(0<Ue.length){Fa(Ue[0],e);for(var a=1;a<Ue.length;a++){var t=Ue[a];t.blockedOn===e&&(t.blockedOn=null)}}for(Ze!==null&&Fa(Ze,e),Xe!==null&&Fa(Xe,e),$e!==null&&Fa($e,e),Ua.forEach(n),Da.forEach(n),a=0;a<La.length;a++)t=La[a],t.blockedOn===e&&(t.blockedOn=null);for(;0<La.length&&(a=La[0],a.blockedOn===null);)$d(a),a.blockedOn===null&&La.shift()}function Ut(e,n){var a={};return a[e.toLowerCase()]=n.toLowerCase(),a["Webkit"+e]="webkit"+n,a["Moz"+e]="moz"+n,a}var zn={animationend:Ut("Animation","AnimationEnd"),animationiteration:Ut("Animation","AnimationIteration"),animationstart:Ut("Animation","AnimationStart"),transitionend:Ut("Transition","TransitionEnd")},kr={},Ks={};He&&(Ks=document.createElement("div").style,"AnimationEvent"in window||(delete zn.animationend.animation,delete zn.animationiteration.animation,delete zn.animationstart.animation),"TransitionEvent"in window||delete zn.transitionend.transition);function Dt(e){if(kr[e])return kr[e];if(!zn[e])return e;var n=zn[e],a;for(a in n)if(n.hasOwnProperty(a)&&a in Ks)return kr[e]=n[a];return e}var Hs=Dt("animationend"),bs=Dt("animationiteration"),xs=Dt("animationstart"),Ys=Dt("transitionend"),js=new Map,yr=new Map,nc=["abort","abort",Hs,"animationEnd",bs,"animationIteration",xs,"animationStart","canplay","canPlay","canplaythrough","canPlayThrough","durationchange","durationChange","emptied","emptied","encrypted","encrypted","ended","ended","error","error","gotpointercapture","gotPointerCapture","load","load","loadeddata","loadedData","loadedmetadata","loadedMetadata","loadstart","loadStart","lostpointercapture","lostPointerCapture","playing","playing","progress","progress","seeking","seeking","stalled","stalled","suspend","suspend","timeupdate","timeUpdate",Ys,"transitionEnd","waiting","waiting"];function Ir(e,n){for(var a=0;a<e.length;a+=2){var t=e[a],i=e[a+1];i="on"+(i[0].toUpperCase()+i.slice(1)),yr.set(t,n),js.set(t,i),In(i,[t])}}var ac=ne.unstable_now;ac();var V=8;function _n(e){if((1&e)!=0)return V=15,1;if((2&e)!=0)return V=14,2;if((4&e)!=0)return V=13,4;var n=24&e;return n!==0?(V=12,n):(e&32)!=0?(V=11,32):(n=192&e,n!==0?(V=10,n):(e&256)!=0?(V=9,256):(n=3584&e,n!==0?(V=8,n):(e&4096)!=0?(V=7,4096):(n=4186112&e,n!==0?(V=6,n):(n=62914560&e,n!==0?(V=5,n):e&67108864?(V=4,67108864):(e&134217728)!=0?(V=3,134217728):(n=805306368&e,n!==0?(V=2,n):(1073741824&e)!=0?(V=1,1073741824):(V=8,e))))))}function tc(e){switch(e){case 99:return 15;case 98:return 10;case 97:case 96:return 8;case 95:return 2;default:return 0}}function ic(e){switch(e){case 15:case 14:return 99;case 13:case 12:case 11:case 10:return 98;case 9:case 8:case 7:case 6:case 4:case 5:return 97;case 3:case 2:case 1:return 95;case 0:return 90;default:throw Error(T(358,e))}}function Ka(e,n){var a=e.pendingLanes;if(a===0)return V=0;var t=0,i=0,r=e.expiredLanes,o=e.suspendedLanes,s=e.pingedLanes;if(r!==0)t=r,i=V=15;else if(r=a&134217727,r!==0){var l=r&~o;l!==0?(t=_n(l),i=V):(s&=r,s!==0&&(t=_n(s),i=V))}else r=a&~o,r!==0?(t=_n(r),i=V):s!==0&&(t=_n(s),i=V);if(t===0)return 0;if(t=31-en(t),t=a&((0>t?0:1<<t)<<1)-1,n!==0&&n!==t&&(n&o)==0){if(_n(n),i<=V)return n;V=i}if(n=e.entangledLanes,n!==0)for(e=e.entanglements,n&=t;0<n;)a=31-en(n),i=1<<a,t|=e[a],n&=~i;return t}function Vs(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function Lt(e,n){switch(e){case 15:return 1;case 14:return 2;case 12:return e=Qn(24&~n),e===0?Lt(10,n):e;case 10:return e=Qn(192&~n),e===0?Lt(8,n):e;case 8:return e=Qn(3584&~n),e===0&&(e=Qn(4186112&~n),e===0&&(e=512)),e;case 2:return n=Qn(805306368&~n),n===0&&(n=268435456),n}throw Error(T(358,e))}function Qn(e){return e&-e}function Tr(e){for(var n=[],a=0;31>a;a++)n.push(e);return n}function Pt(e,n,a){e.pendingLanes|=n;var t=n-1;e.suspendedLanes&=t,e.pingedLanes&=t,e=e.eventTimes,n=31-en(n),e[n]=a}var en=Math.clz32?Math.clz32:rc,oc=Math.log,sc=Math.LN2;function rc(e){return e===0?32:31-(oc(e)/sc|0)|0}var lc=ne.unstable_UserBlockingPriority,uc=ne.unstable_runWithPriority,Ft=!0;function dc(e,n,a,t){En||ur();var i=Ar,r=En;En=!0;try{ws(i,e,n,a,t)}finally{(En=r)||cr()}}function cc(e,n,a,t){uc(lc,Ar.bind(null,e,n,a,t))}function Ar(e,n,a,t){if(Ft){var i;if((i=(n&4)==0)&&0<Ue.length&&-1<Ds.indexOf(e))e=pr(null,e,n,a,t),Ue.push(e);else{var r=Sr(e,n,a,t);if(r===null)i&&Ls(e,t);else{if(i){if(-1<Ds.indexOf(e)){e=pr(r,e,n,a,t),Ue.push(e);return}if(Xd(r,e,n,a,t))return;Ls(e,t)}zs(e,n,t,null,a)}}}}function Sr(e,n,a,t){var i=or(t);if(i=Mn(i),i!==null){var r=vn(i);if(r===null)i=null;else{var o=r.tag;if(o===13){if(i=Os(r),i!==null)return i;i=null}else if(o===3){if(r.stateNode.hydrate)return r.tag===3?r.stateNode.containerInfo:null;i=null}else r!==i&&(i=null)}}return zs(e,n,t,i,a),null}var nn=null,Er=null,Kt=null;function _s(){if(Kt)return Kt;var e,n=Er,a=n.length,t,i="value"in nn?nn.value:nn.textContent,r=i.length;for(e=0;e<a&&n[e]===i[e];e++);var o=a-e;for(t=1;t<=o&&n[a-t]===i[r-t];t++);return Kt=i.slice(e,1<t?1-t:void 0)}function Ht(e){var n=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&n===13&&(e=13)):e=n,e===10&&(e=13),32<=e||e===13?e:0}function bt(){return!0}function Qs(){return!1}function Ee(e){function n(a,t,i,r,o){this._reactName=a,this._targetInst=i,this.type=t,this.nativeEvent=r,this.target=o,this.currentTarget=null;for(var s in e)e.hasOwnProperty(s)&&(a=e[s],this[s]=a?a(r):r[s]);return this.isDefaultPrevented=(r.defaultPrevented!=null?r.defaultPrevented:r.returnValue===!1)?bt:Qs,this.isPropagationStopped=Qs,this}return x(n.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():typeof a.returnValue!="unknown"&&(a.returnValue=!1),this.isDefaultPrevented=bt)},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():typeof a.cancelBubble!="unknown"&&(a.cancelBubble=!0),this.isPropagationStopped=bt)},persist:function(){},isPersistent:bt}),n}var Jn={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},vr=Ee(Jn),Ha=x({},Jn,{view:0,detail:0}),hc=Ee(Ha),Mr,wr,ba,xt=x({},Ha,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Cr,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==ba&&(ba&&e.type==="mousemove"?(Mr=e.screenX-ba.screenX,wr=e.screenY-ba.screenY):wr=Mr=0,ba=e),Mr)},movementY:function(e){return"movementY"in e?e.movementY:wr}}),Js=Ee(xt),gc=x({},xt,{dataTransfer:0}),mc=Ee(gc),fc=x({},Ha,{relatedTarget:0}),Or=Ee(fc),pc=x({},Jn,{animationName:0,elapsedTime:0,pseudoElement:0}),Sc=Ee(pc),kc=x({},Jn,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),yc=Ee(kc),Ic=x({},Jn,{data:0}),qs=Ee(Ic),Tc={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},Ac={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},Ec={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function vc(e){var n=this.nativeEvent;return n.getModifierState?n.getModifierState(e):(e=Ec[e])?!!n[e]:!1}function Cr(){return vc}var Mc=x({},Ha,{key:function(e){if(e.key){var n=Tc[e.key]||e.key;if(n!=="Unidentified")return n}return e.type==="keypress"?(e=Ht(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?Ac[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Cr,charCode:function(e){return e.type==="keypress"?Ht(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Ht(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),wc=Ee(Mc),Cc=x({},xt,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),Zs=Ee(Cc),Oc=x({},Ha,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Cr}),Nc=Ee(Oc),Gc=x({},Jn,{propertyName:0,elapsedTime:0,pseudoElement:0}),Bc=Ee(Gc),Wc=x({},xt,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),Rc=Ee(Wc),Uc=[9,13,27,32],Nr=He&&"CompositionEvent"in window,xa=null;He&&"documentMode"in document&&(xa=document.documentMode);var Dc=He&&"TextEvent"in window&&!xa,Xs=He&&(!Nr||xa&&8<xa&&11>=xa),$s=String.fromCharCode(32),el=!1;function nl(e,n){switch(e){case"keyup":return Uc.indexOf(n.keyCode)!==-1;case"keydown":return n.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function al(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var qn=!1;function Lc(e,n){switch(e){case"compositionend":return al(n);case"keypress":return n.which!==32?null:(el=!0,$s);case"textInput":return e=n.data,e===$s&&el?null:e;default:return null}}function Pc(e,n){if(qn)return e==="compositionend"||!Nr&&nl(e,n)?(e=_s(),Kt=Er=nn=null,qn=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(n.ctrlKey||n.altKey||n.metaKey)||n.ctrlKey&&n.altKey){if(n.char&&1<n.char.length)return n.char;if(n.which)return String.fromCharCode(n.which)}return null;case"compositionend":return Xs&&n.locale!=="ko"?null:n.data;default:return null}}var Fc={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function tl(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n==="input"?!!Fc[e.type]:n==="textarea"}function il(e,n,a,t){vs(t),n=Yt(n,"onChange"),0<n.length&&(a=new vr("onChange","change",null,a,t),e.push({event:a,listeners:n}))}var Ya=null,ja=null;function Kc(e){rl(e,0)}function jt(e){var n=Zn(e);if(hs(n))return e}function Hc(e,n){if(e==="change")return n}var ol=!1;He&&(He?(zt="oninput"in document,zt||(Gr=document.createElement("div"),Gr.setAttribute("oninput","return;"),zt=typeof Gr.oninput=="function"),Vt=zt):Vt=!1,ol=Vt&&(!document.documentMode||9<document.documentMode));var Vt,zt,Gr;function ll(){Ya&&(Ya.detachEvent("onpropertychange",sl),ja=Ya=null)}function sl(e){if(e.propertyName==="value"&&jt(ja)){var n=[];if(il(n,ja,e,or(e)),e=Kc,En)e(n);else{En=!0;try{lr(e,n)}finally{En=!1,cr()}}}}function bc(e,n,a){e==="focusin"?(ll(),Ya=n,ja=a,Ya.attachEvent("onpropertychange",sl)):e==="focusout"&&ll()}function xc(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return jt(ja)}function Yc(e,n){if(e==="click")return jt(n)}function jc(e,n){if(e==="input"||e==="change")return jt(n)}function Vc(e,n){return e===n&&(e!==0||1/e==1/n)||e!==e&&n!==n}var we=typeof Object.is=="function"?Object.is:Vc,zc=Object.prototype.hasOwnProperty;function Va(e,n){if(we(e,n))return!0;if(typeof e!="object"||e===null||typeof n!="object"||n===null)return!1;var a=Object.keys(e),t=Object.keys(n);if(a.length!==t.length)return!1;for(t=0;t<a.length;t++)if(!zc.call(n,a[t])||!we(e[a[t]],n[a[t]]))return!1;return!0}function ul(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function dl(e,n){var a=ul(e);e=0;for(var t;a;){if(a.nodeType===3){if(t=e+a.textContent.length,e<=n&&t>=n)return{node:a,offset:n-e};e=t}e:{for(;a;){if(a.nextSibling){a=a.nextSibling;break e}a=a.parentNode}a=void 0}a=ul(a)}}function cl(e,n){return e&&n?e===n?!0:e&&e.nodeType===3?!1:n&&n.nodeType===3?cl(e,n.parentNode):"contains"in e?e.contains(n):e.compareDocumentPosition?!!(e.compareDocumentPosition(n)&16):!1:!1}function hl(){for(var e=window,n=Ot();n instanceof e.HTMLIFrameElement;){try{var a=typeof n.contentWindow.location.href=="string"}catch(t){a=!1}if(a)e=n.contentWindow;else break;n=Ot(e.document)}return n}function Br(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n&&(n==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||n==="textarea"||e.contentEditable==="true")}var _c=He&&"documentMode"in document&&11>=document.documentMode,Xn=null,Wr=null,za=null,Rr=!1;function gl(e,n,a){var t=a.window===a?a.document:a.nodeType===9?a:a.ownerDocument;Rr||Xn==null||Xn!==Ot(t)||(t=Xn,"selectionStart"in t&&Br(t)?t={start:t.selectionStart,end:t.selectionEnd}:(t=(t.ownerDocument&&t.ownerDocument.defaultView||window).getSelection(),t={anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}),za&&Va(za,t)||(za=t,t=Yt(Wr,"onSelect"),0<t.length&&(n=new vr("onSelect","select",null,n,a),e.push({event:n,listeners:t}),n.target=Xn)))}Ir("cancel cancel click click close close contextmenu contextMenu copy copy cut cut auxclick auxClick dblclick doubleClick dragend dragEnd dragstart dragStart drop drop focusin focus focusout blur input input invalid invalid keydown keyDown keypress keyPress keyup keyUp mousedown mouseDown mouseup mouseUp paste paste pause pause play play pointercancel pointerCancel pointerdown pointerDown pointerup pointerUp ratechange rateChange reset reset seeked seeked submit submit touchcancel touchCancel touchend touchEnd touchstart touchStart volumechange volumeChange".split(" "),0);Ir("drag drag dragenter dragEnter dragexit dragExit dragleave dragLeave dragover dragOver mousemove mouseMove mouseout mouseOut mouseover mouseOver pointermove pointerMove pointerout pointerOut pointerover pointerOver scroll scroll toggle toggle touchmove touchMove wheel wheel".split(" "),1);Ir(nc,2);for(var ml="change selectionchange textInput compositionstart compositionend compositionupdate".split(" "),Ur=0;Ur<ml.length;Ur++)yr.set(ml[Ur],0);Hn("onMouseEnter",["mouseout","mouseover"]);Hn("onMouseLeave",["mouseout","mouseover"]);Hn("onPointerEnter",["pointerout","pointerover"]);Hn("onPointerLeave",["pointerout","pointerover"]);In("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));In("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));In("onBeforeInput",["compositionend","keypress","textInput","paste"]);In("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));In("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));In("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var _a="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),fl=new Set("cancel close invalid load scroll toggle".split(" ").concat(_a));function pl(e,n,a){var t=e.type||"unknown-event";e.currentTarget=a,qd(t,n,void 0,e),e.currentTarget=null}function rl(e,n){n=(n&4)!=0;for(var a=0;a<e.length;a++){var t=e[a],i=t.event;t=t.listeners;e:{var r=void 0;if(n)for(var o=t.length-1;0<=o;o--){var s=t[o],l=s.instance,d=s.currentTarget;if(s=s.listener,l!==r&&i.isPropagationStopped())break e;pl(i,s,d),r=l}else for(o=0;o<t.length;o++){if(s=t[o],l=s.instance,d=s.currentTarget,s=s.listener,l!==r&&i.isPropagationStopped())break e;pl(i,s,d),r=l}}}if(Wt)throw e=gr,Wt=!1,gr=null,e}function _(e,n){var a=kl(n),t=e+"__bubble";a.has(t)||(Sl(n,e,2,!1),a.add(t))}var yl="_reactListening"+Math.random().toString(36).slice(2);function Tl(e){e[yl]||(e[yl]=!0,rs.forEach(function(n){fl.has(n)||Il(n,!1,e,null),Il(n,!0,e,null)}))}function Il(e,n,a,t){var i=4<arguments.length&&arguments[4]!==void 0?arguments[4]:0,r=a;if(e==="selectionchange"&&a.nodeType!==9&&(r=a.ownerDocument),t!==null&&!n&&fl.has(e)){if(e!=="scroll")return;i|=2,r=t}var o=kl(r),s=e+"__"+(n?"capture":"bubble");o.has(s)||(n&&(i|=4),Sl(r,e,i,n),o.add(s))}function Sl(e,n,a,t){var i=yr.get(n);switch(i===void 0?2:i){case 0:i=dc;break;case 1:i=cc;break;default:i=Ar}a=i.bind(null,n,a,e),i=void 0,!hr||n!=="touchstart"&&n!=="touchmove"&&n!=="wheel"||(i=!0),t?i!==void 0?e.addEventListener(n,a,{capture:!0,passive:i}):e.addEventListener(n,a,!0):i!==void 0?e.addEventListener(n,a,{passive:i}):e.addEventListener(n,a,!1)}function zs(e,n,a,t,i){var r=t;if((n&1)==0&&(n&2)==0&&t!==null)e:for(;;){if(t===null)return;var o=t.tag;if(o===3||o===4){var s=t.stateNode.containerInfo;if(s===i||s.nodeType===8&&s.parentNode===i)break;if(o===4)for(o=t.return;o!==null;){var l=o.tag;if((l===3||l===4)&&(l=o.stateNode.containerInfo,l===i||l.nodeType===8&&l.parentNode===i))return;o=o.return}for(;s!==null;){if(o=Mn(s),o===null)return;if(l=o.tag,l===5||l===6){t=r=o;continue e}s=s.parentNode}}t=t.return}zd(function(){var d=r,y=or(a),C=[];e:{var S=js.get(e);if(S!==void 0){var M=vr,W=e;switch(e){case"keypress":if(Ht(a)===0)break e;case"keydown":case"keyup":M=wc;break;case"focusin":W="focus",M=Or;break;case"focusout":W="blur",M=Or;break;case"beforeblur":case"afterblur":M=Or;break;case"click":if(a.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":M=Js;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":M=mc;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":M=Nc;break;case Hs:case bs:case xs:M=Sc;break;case Ys:M=Bc;break;case"scroll":M=hc;break;case"wheel":M=Rc;break;case"copy":case"cut":case"paste":M=yc;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":M=Zs}var N=(n&4)!=0,h=!N&&e==="scroll",u=N?S!==null?S+"Capture":null:S;N=[];for(var c=d,m;c!==null;){m=c;var p=m.stateNode;if(m.tag===5&&p!==null&&(m=p,u!==null&&(p=Wa(c,u),p!=null&&N.push(Qa(c,p,m)))),h)break;c=c.return}0<N.length&&(S=new M(S,W,null,a,y),C.push({event:S,listeners:N}))}}if((n&7)==0){e:{if(S=e==="mouseover"||e==="pointerover",M=e==="mouseout"||e==="pointerout",S&&(n&16)==0&&(W=a.relatedTarget||a.fromElement)&&(Mn(W)||W[ea]))break e;if((M||S)&&(S=y.window===y?y:(S=y.ownerDocument)?S.defaultView||S.parentWindow:window,M?(W=a.relatedTarget||a.toElement,M=d,W=W?Mn(W):null,W!==null&&(h=vn(W),W!==h||W.tag!==5&&W.tag!==6)&&(W=null)):(M=null,W=d),M!==W)){if(N=Js,p="onMouseLeave",u="onMouseEnter",c="mouse",(e==="pointerout"||e==="pointerover")&&(N=Zs,p="onPointerLeave",u="onPointerEnter",c="pointer"),h=M==null?S:Zn(M),m=W==null?S:Zn(W),S=new N(p,c+"leave",M,a,y),S.target=h,S.relatedTarget=m,p=null,Mn(y)===d&&(N=new N(u,c+"enter",W,a,y),N.target=m,N.relatedTarget=h,p=N),h=p,M&&W)n:{for(N=M,u=W,c=0,m=N;m;m=$n(m))c++;for(m=0,p=u;p;p=$n(p))m++;for(;0<c-m;)N=$n(N),c--;for(;0<m-c;)u=$n(u),m--;for(;c--;){if(N===u||u!==null&&N===u.alternate)break n;N=$n(N),u=$n(u)}N=null}else N=null;M!==null&&Al(C,S,M,N,!1),W!==null&&h!==null&&Al(C,h,W,N,!0)}}e:{if(S=d?Zn(d):window,M=S.nodeName&&S.nodeName.toLowerCase(),M==="select"||M==="input"&&S.type==="file")var R=Hc;else if(tl(S))if(ol)R=jc;else{R=xc;var v=bc}else(M=S.nodeName)&&M.toLowerCase()==="input"&&(S.type==="checkbox"||S.type==="radio")&&(R=Yc);if(R&&(R=R(e,d))){il(C,R,a,y);break e}v&&v(e,S,d),e==="focusout"&&(v=S._wrapperState)&&v.controlled&&S.type==="number"&&Xi(S,"number",S.value)}switch(v=d?Zn(d):window,e){case"focusin":(tl(v)||v.contentEditable==="true")&&(Xn=v,Wr=d,za=null);break;case"focusout":za=Wr=Xn=null;break;case"mousedown":Rr=!0;break;case"contextmenu":case"mouseup":case"dragend":Rr=!1,gl(C,a,y);break;case"selectionchange":if(_c)break;case"keydown":case"keyup":gl(C,a,y)}var G;if(Nr)e:{switch(e){case"compositionstart":var D="onCompositionStart";break e;case"compositionend":D="onCompositionEnd";break e;case"compositionupdate":D="onCompositionUpdate";break e}D=void 0}else qn?nl(e,a)&&(D="onCompositionEnd"):e==="keydown"&&a.keyCode===229&&(D="onCompositionStart");D&&(Xs&&a.locale!=="ko"&&(qn||D!=="onCompositionStart"?D==="onCompositionEnd"&&qn&&(G=_s()):(nn=y,Er="value"in nn?nn.value:nn.textContent,qn=!0)),v=Yt(d,D),0<v.length&&(D=new qs(D,e,null,a,y),C.push({event:D,listeners:v}),G?D.data=G:(G=al(a),G!==null&&(D.data=G)))),(G=Dc?Lc(e,a):Pc(e,a))&&(d=Yt(d,"onBeforeInput"),0<d.length&&(y=new qs("onBeforeInput","beforeinput",null,a,y),C.push({event:y,listeners:d}),y.data=G))}rl(C,n)})}function Qa(e,n,a){return{instance:e,listener:n,currentTarget:a}}function Yt(e,n){for(var a=n+"Capture",t=[];e!==null;){var i=e,r=i.stateNode;i.tag===5&&r!==null&&(i=r,r=Wa(e,a),r!=null&&t.unshift(Qa(e,r,i)),r=Wa(e,n),r!=null&&t.push(Qa(e,r,i))),e=e.return}return t}function $n(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function Al(e,n,a,t,i){for(var r=n._reactName,o=[];a!==null&&a!==t;){var s=a,l=s.alternate,d=s.stateNode;if(l!==null&&l===t)break;s.tag===5&&d!==null&&(s=d,i?(l=Wa(a,r),l!=null&&o.unshift(Qa(a,l,s))):i||(l=Wa(a,r),l!=null&&o.push(Qa(a,l,s)))),a=a.return}o.length!==0&&e.push({event:n,listeners:o})}function _t(){}var Dr=null,Lr=null;function El(e,n){switch(e){case"button":case"input":case"select":case"textarea":return!!n.autoFocus}return!1}function Pr(e,n){return e==="textarea"||e==="option"||e==="noscript"||typeof n.children=="string"||typeof n.children=="number"||typeof n.dangerouslySetInnerHTML=="object"&&n.dangerouslySetInnerHTML!==null&&n.dangerouslySetInnerHTML.__html!=null}var vl=typeof setTimeout=="function"?setTimeout:void 0,Qc=typeof clearTimeout=="function"?clearTimeout:void 0;function Fr(e){e.nodeType===1?e.textContent="":e.nodeType===9&&(e=e.body,e!=null&&(e.textContent=""))}function na(e){for(;e!=null;e=e.nextSibling){var n=e.nodeType;if(n===1||n===3)break}return e}function Ml(e){e=e.previousSibling;for(var n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="$"||a==="$!"||a==="$?"){if(n===0)return e;n--}else a==="/$"&&n++}e=e.previousSibling}return null}var Kr=0;function Jc(e){return{$$typeof:zi,toString:e,valueOf:e}}var Qt=Math.random().toString(36).slice(2),an="__reactFiber$"+Qt,Jt="__reactProps$"+Qt,ea="__reactContainer$"+Qt,wl="__reactEvents$"+Qt;function Mn(e){var n=e[an];if(n)return n;for(var a=e.parentNode;a;){if(n=a[ea]||a[an]){if(a=n.alternate,n.child!==null||a!==null&&a.child!==null)for(e=Ml(e);e!==null;){if(a=e[an])return a;e=Ml(e)}return n}e=a,a=e.parentNode}return null}function Ba(e){return e=e[an]||e[ea],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function Zn(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(T(33))}function Gt(e){return e[Jt]||null}function kl(e){var n=e[wl];return n===void 0&&(n=e[wl]=new Set),n}var Hr=[],aa=-1;function tn(e){return{current:e}}function Q(e){0>aa||(e.current=Hr[aa],Hr[aa]=null,aa--)}function q(e,n){aa++,Hr[aa]=e.current,e.current=n}var rn={},ce=tn(rn),ye=tn(!1),wn=rn;function ta(e,n){var a=e.type.contextTypes;if(!a)return rn;var t=e.stateNode;if(t&&t.__reactInternalMemoizedUnmaskedChildContext===n)return t.__reactInternalMemoizedMaskedChildContext;var i={},r;for(r in a)i[r]=n[r];return t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=i),i}function Ie(e){return e=e.childContextTypes,e!=null}function qt(){Q(ye),Q(ce)}function Cl(e,n,a){if(ce.current!==rn)throw Error(T(168));q(ce,n),q(ye,a)}function Ol(e,n,a){var t=e.stateNode;if(e=n.childContextTypes,typeof t.getChildContext!="function")return a;t=t.getChildContext();for(var i in t)if(!(i in e))throw Error(T(108,bn(n)||"Unknown",i));return x({},a,t)}function Zt(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||rn,wn=ce.current,q(ce,e),q(ye,ye.current),!0}function Nl(e,n,a){var t=e.stateNode;if(!t)throw Error(T(169));a?(e=Ol(e,n,wn),t.__reactInternalMemoizedMergedChildContext=e,Q(ye),Q(ce),q(ce,e)):Q(ye),q(ye,a)}var br=null,Cn=null,qc=ne.unstable_runWithPriority,xr=ne.unstable_scheduleCallback,Yr=ne.unstable_cancelCallback,Zc=ne.unstable_shouldYield,Gl=ne.unstable_requestPaint,jr=ne.unstable_now,Xc=ne.unstable_getCurrentPriorityLevel,Xt=ne.unstable_ImmediatePriority,Bl=ne.unstable_UserBlockingPriority,Wl=ne.unstable_NormalPriority,Rl=ne.unstable_LowPriority,Ul=ne.unstable_IdlePriority,Vr={},$c=Gl!==void 0?Gl:function(){},be=null,$t=null,zr=!1,Dl=jr(),he=1e4>Dl?jr:function(){return jr()-Dl};function ia(){switch(Xc()){case Xt:return 99;case Bl:return 98;case Wl:return 97;case Rl:return 96;case Ul:return 95;default:throw Error(T(332))}}function Ll(e){switch(e){case 99:return Xt;case 98:return Bl;case 97:return Wl;case 96:return Rl;case 95:return Ul;default:throw Error(T(332))}}function On(e,n){return e=Ll(e),qc(e,n)}function Ja(e,n,a){return e=Ll(e),xr(e,n,a)}function De(){if($t!==null){var e=$t;$t=null,Yr(e)}Pl()}function Pl(){if(!zr&&be!==null){zr=!0;var e=0;try{var n=be;On(99,function(){for(;e<n.length;e++){var a=n[e];do a=a(!0);while(a!==null)}}),be=null}catch(a){throw be!==null&&(be=be.slice(e+1)),xr(Xt,De),a}finally{zr=!1}}}var eh=Tn.ReactCurrentBatchConfig;function We(e,n){if(e&&e.defaultProps){n=x({},n),e=e.defaultProps;for(var a in e)n[a]===void 0&&(n[a]=e[a]);return n}return n}var ei=tn(null),ni=null,ra=null,ai=null;function _r(){ai=ra=ni=null}function Qr(e){var n=ei.current;Q(ei),e.type._context._currentValue=n}function Fl(e,n){for(;e!==null;){var a=e.alternate;if((e.childLanes&n)===n){if(a===null||(a.childLanes&n)===n)break;a.childLanes|=n}else e.childLanes|=n,a!==null&&(a.childLanes|=n);e=e.return}}function oa(e,n){ni=e,ai=ra=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&n)!=0&&(Re=!0),e.firstContext=null)}function Ce(e,n){if(ai!==e&&n!==!1&&n!==0)if((typeof n!="number"||n===1073741823)&&(ai=e,n=1073741823),n={context:e,observedBits:n,next:null},ra===null){if(ni===null)throw Error(T(308));ra=n,ni.dependencies={lanes:0,firstContext:n,responders:null}}else ra=ra.next=n;return e._currentValue}var on=!1;function Jr(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null},effects:null}}function Kl(e,n){e=e.updateQueue,n.updateQueue===e&&(n.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function sn(e,n){return{eventTime:e,lane:n,tag:0,payload:null,callback:null,next:null}}function ln(e,n){if(e=e.updateQueue,e!==null){e=e.shared;var a=e.pending;a===null?n.next=n:(n.next=a.next,a.next=n),e.pending=n}}function Hl(e,n){var a=e.updateQueue,t=e.alternate;if(t!==null&&(t=t.updateQueue,a===t)){var i=null,r=null;if(a=a.firstBaseUpdate,a!==null){do{var o={eventTime:a.eventTime,lane:a.lane,tag:a.tag,payload:a.payload,callback:a.callback,next:null};r===null?i=r=o:r=r.next=o,a=a.next}while(a!==null);r===null?i=r=n:r=r.next=n}else i=r=n;a={baseState:t.baseState,firstBaseUpdate:i,lastBaseUpdate:r,shared:t.shared,effects:t.effects},e.updateQueue=a;return}e=a.lastBaseUpdate,e===null?a.firstBaseUpdate=n:e.next=n,a.lastBaseUpdate=n}function Za(e,n,a,t){var i=e.updateQueue;on=!1;var r=i.firstBaseUpdate,o=i.lastBaseUpdate,s=i.shared.pending;if(s!==null){i.shared.pending=null;var l=s,d=l.next;l.next=null,o===null?r=d:o.next=d,o=l;var y=e.alternate;if(y!==null){y=y.updateQueue;var C=y.lastBaseUpdate;C!==o&&(C===null?y.firstBaseUpdate=d:C.next=d,y.lastBaseUpdate=l)}}if(r!==null){C=i.baseState,o=0,y=d=l=null;do{s=r.lane;var S=r.eventTime;if((t&s)===s){y!==null&&(y=y.next={eventTime:S,lane:0,tag:r.tag,payload:r.payload,callback:r.callback,next:null});e:{var M=e,W=r;switch(s=n,S=a,W.tag){case 1:if(M=W.payload,typeof M=="function"){C=M.call(S,C,s);break e}C=M;break e;case 3:M.flags=M.flags&-4097|64;case 0:if(M=W.payload,s=typeof M=="function"?M.call(S,C,s):M,s==null)break e;C=x({},C,s);break e;case 2:on=!0}}r.callback!==null&&(e.flags|=32,s=i.effects,s===null?i.effects=[r]:s.push(r))}else S={eventTime:S,lane:s,tag:r.tag,payload:r.payload,callback:r.callback,next:null},y===null?(d=y=S,l=C):y=y.next=S,o|=s;if(r=r.next,r===null){if(s=i.shared.pending,s===null)break;r=s.next,s.next=null,i.lastBaseUpdate=s,i.shared.pending=null}}while(1);y===null&&(l=C),i.baseState=l,i.firstBaseUpdate=d,i.lastBaseUpdate=y,qa|=o,e.lanes=o,e.memoizedState=C}}function bl(e,n,a){if(e=n.effects,n.effects=null,e!==null)for(n=0;n<e.length;n++){var t=e[n],i=t.callback;if(i!==null){if(t.callback=null,t=a,typeof i!="function")throw Error(T(191,i));i.call(t)}}}var xl=new H.Component().refs;function ti(e,n,a,t){n=e.memoizedState,a=a(t,n),a=a==null?n:x({},n,a),e.memoizedState=a,e.lanes===0&&(e.updateQueue.baseState=a)}var ii={isMounted:function(e){return(e=e._reactInternals)?vn(e)===e:!1},enqueueSetState:function(e,n,a){e=e._reactInternals;var t=ve(),i=un(e),r=sn(t,i);r.payload=n,a!=null&&(r.callback=a),ln(e,r),dn(e,i,t)},enqueueReplaceState:function(e,n,a){e=e._reactInternals;var t=ve(),i=un(e),r=sn(t,i);r.tag=1,r.payload=n,a!=null&&(r.callback=a),ln(e,r),dn(e,i,t)},enqueueForceUpdate:function(e,n){e=e._reactInternals;var a=ve(),t=un(e),i=sn(a,t);i.tag=2,n!=null&&(i.callback=n),ln(e,i),dn(e,t,a)}};function Yl(e,n,a,t,i,r,o){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(t,r,o):n.prototype&&n.prototype.isPureReactComponent?!Va(a,t)||!Va(i,r):!0}function jl(e,n,a){var t=!1,i=rn,r=n.contextType;return typeof r=="object"&&r!==null?r=Ce(r):(i=Ie(n)?wn:ce.current,t=n.contextTypes,r=(t=t!=null)?ta(e,i):rn),n=new n(a,r),e.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,n.updater=ii,e.stateNode=n,n._reactInternals=e,t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=i,e.__reactInternalMemoizedMaskedChildContext=r),n}function Vl(e,n,a,t){e=n.state,typeof n.componentWillReceiveProps=="function"&&n.componentWillReceiveProps(a,t),typeof n.UNSAFE_componentWillReceiveProps=="function"&&n.UNSAFE_componentWillReceiveProps(a,t),n.state!==e&&ii.enqueueReplaceState(n,n.state,null)}function qr(e,n,a,t){var i=e.stateNode;i.props=a,i.state=e.memoizedState,i.refs=xl,Jr(e);var r=n.contextType;typeof r=="object"&&r!==null?i.context=Ce(r):(r=Ie(n)?wn:ce.current,i.context=ta(e,r)),Za(e,a,i,t),i.state=e.memoizedState,r=n.getDerivedStateFromProps,typeof r=="function"&&(ti(e,n,r,a),i.state=e.memoizedState),typeof n.getDerivedStateFromProps=="function"||typeof i.getSnapshotBeforeUpdate=="function"||typeof i.UNSAFE_componentWillMount!="function"&&typeof i.componentWillMount!="function"||(n=i.state,typeof i.componentWillMount=="function"&&i.componentWillMount(),typeof i.UNSAFE_componentWillMount=="function"&&i.UNSAFE_componentWillMount(),n!==i.state&&ii.enqueueReplaceState(i,i.state,null),Za(e,a,i,t),i.state=e.memoizedState),typeof i.componentDidMount=="function"&&(e.flags|=4)}var ri=Array.isArray;function Xa(e,n,a){if(e=a.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(a._owner){if(a=a._owner,a){if(a.tag!==1)throw Error(T(309));var t=a.stateNode}if(!t)throw Error(T(147,e));var i=""+e;return n!==null&&n.ref!==null&&typeof n.ref=="function"&&n.ref._stringRef===i?n.ref:(n=function(r){var o=t.refs;o===xl&&(o=t.refs={}),r===null?delete o[i]:o[i]=r},n._stringRef=i,n)}if(typeof e!="string")throw Error(T(284));if(!a._owner)throw Error(T(290,e))}return e}function oi(e,n){if(e.type!=="textarea")throw Error(T(31,Object.prototype.toString.call(n)==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":n))}function zl(e){function n(h,u){if(e){var c=h.lastEffect;c!==null?(c.nextEffect=u,h.lastEffect=u):h.firstEffect=h.lastEffect=u,u.nextEffect=null,u.flags=8}}function a(h,u){if(!e)return null;for(;u!==null;)n(h,u),u=u.sibling;return null}function t(h,u){for(h=new Map;u!==null;)u.key!==null?h.set(u.key,u):h.set(u.index,u),u=u.sibling;return h}function i(h,u){return h=cn(h,u),h.index=0,h.sibling=null,h}function r(h,u,c){return h.index=c,e?(c=h.alternate,c!==null?(c=c.index,c<u?(h.flags=2,u):c):(h.flags=2,u)):u}function o(h){return e&&h.alternate===null&&(h.flags=2),h}function s(h,u,c,m){return u===null||u.tag!==6?(u=Zr(c,h.mode,m),u.return=h,u):(u=i(u,c),u.return=h,u)}function l(h,u,c,m){return u!==null&&u.elementType===c.type?(m=i(u,c.props),m.ref=Xa(h,u,c),m.return=h,m):(m=si(c.type,c.key,c.props,null,h.mode,m),m.ref=Xa(h,u,c),m.return=h,m)}function d(h,u,c,m){return u===null||u.tag!==4||u.stateNode.containerInfo!==c.containerInfo||u.stateNode.implementation!==c.implementation?(u=Xr(c,h.mode,m),u.return=h,u):(u=i(u,c.children||[]),u.return=h,u)}function y(h,u,c,m,p){return u===null||u.tag!==7?(u=sa(c,h.mode,m,p),u.return=h,u):(u=i(u,c),u.return=h,u)}function C(h,u,c){if(typeof u=="string"||typeof u=="number")return u=Zr(""+u,h.mode,c),u.return=h,u;if(typeof u=="object"&&u!==null){switch(u.$$typeof){case va:return c=si(u.type,u.key,u.props,null,h.mode,c),c.ref=Xa(h,null,u),c.return=h,c;case An:return u=Xr(u,h.mode,c),u.return=h,u}if(ri(u)||Ca(u))return u=sa(u,h.mode,c,null),u.return=h,u;oi(h,u)}return null}function S(h,u,c,m){var p=u!==null?u.key:null;if(typeof c=="string"||typeof c=="number")return p!==null?null:s(h,u,""+c,m);if(typeof c=="object"&&c!==null){switch(c.$$typeof){case va:return c.key===p?c.type===Je?y(h,u,c.props.children,m,p):l(h,u,c,m):null;case An:return c.key===p?d(h,u,c,m):null}if(ri(c)||Ca(c))return p!==null?null:y(h,u,c,m,null);oi(h,c)}return null}function M(h,u,c,m,p){if(typeof m=="string"||typeof m=="number")return h=h.get(c)||null,s(u,h,""+m,p);if(typeof m=="object"&&m!==null){switch(m.$$typeof){case va:return h=h.get(m.key===null?c:m.key)||null,m.type===Je?y(u,h,m.props.children,p,m.key):l(u,h,m,p);case An:return h=h.get(m.key===null?c:m.key)||null,d(u,h,m,p)}if(ri(m)||Ca(m))return h=h.get(c)||null,y(u,h,m,p,null);oi(u,m)}return null}function W(h,u,c,m){for(var p=null,R=null,v=u,G=u=0,D=null;v!==null&&G<c.length;G++){v.index>G?(D=v,v=null):D=v.sibling;var U=S(h,v,c[G],m);if(U===null){v===null&&(v=D);break}e&&v&&U.alternate===null&&n(h,v),u=r(U,u,G),R===null?p=U:R.sibling=U,R=U,v=D}if(G===c.length)return a(h,v),p;if(v===null){for(;G<c.length;G++)v=C(h,c[G],m),v!==null&&(u=r(v,u,G),R===null?p=v:R.sibling=v,R=v);return p}for(v=t(h,v);G<c.length;G++)D=M(v,h,G,c[G],m),D!==null&&(e&&D.alternate!==null&&v.delete(D.key===null?G:D.key),u=r(D,u,G),R===null?p=D:R.sibling=D,R=D);return e&&v.forEach(function(J){return n(h,J)}),p}function N(h,u,c,m){var p=Ca(c);if(typeof p!="function")throw Error(T(150));if(c=p.call(c),c==null)throw Error(T(151));for(var R=p=null,v=u,G=u=0,D=null,U=c.next();v!==null&&!U.done;G++,U=c.next()){v.index>G?(D=v,v=null):D=v.sibling;var J=S(h,v,U.value,m);if(J===null){v===null&&(v=D);break}e&&v&&J.alternate===null&&n(h,v),u=r(J,u,G),R===null?p=J:R.sibling=J,R=J,v=D}if(U.done)return a(h,v),p;if(v===null){for(;!U.done;G++,U=c.next())U=C(h,U.value,m),U!==null&&(u=r(U,u,G),R===null?p=U:R.sibling=U,R=U);return p}for(v=t(h,v);!U.done;G++,U=c.next())U=M(v,h,G,U.value,m),U!==null&&(e&&U.alternate!==null&&v.delete(U.key===null?G:U.key),u=r(U,u,G),R===null?p=U:R.sibling=U,R=U);return e&&v.forEach(function(ke){return n(h,ke)}),p}return function(h,u,c,m){var p=typeof c=="object"&&c!==null&&c.type===Je&&c.key===null;p&&(c=c.props.children);var R=typeof c=="object"&&c!==null;if(R)switch(c.$$typeof){case va:e:{for(R=c.key,p=u;p!==null;){if(p.key===R){switch(p.tag){case 7:if(c.type===Je){a(h,p.sibling),u=i(p,c.props.children),u.return=h,h=u;break e}break;default:if(p.elementType===c.type){a(h,p.sibling),u=i(p,c.props),u.ref=Xa(h,p,c),u.return=h,h=u;break e}}a(h,p);break}else n(h,p);p=p.sibling}c.type===Je?(u=sa(c.props.children,h.mode,m,c.key),u.return=h,h=u):(m=si(c.type,c.key,c.props,null,h.mode,m),m.ref=Xa(h,u,c),m.return=h,h=m)}return o(h);case An:e:{for(p=c.key;u!==null;){if(u.key===p)if(u.tag===4&&u.stateNode.containerInfo===c.containerInfo&&u.stateNode.implementation===c.implementation){a(h,u.sibling),u=i(u,c.children||[]),u.return=h,h=u;break e}else{a(h,u);break}else n(h,u);u=u.sibling}u=Xr(c,h.mode,m),u.return=h,h=u}return o(h)}if(typeof c=="string"||typeof c=="number")return c=""+c,u!==null&&u.tag===6?(a(h,u.sibling),u=i(u,c),u.return=h,h=u):(a(h,u),u=Zr(c,h.mode,m),u.return=h,h=u),o(h);if(ri(c))return W(h,u,c,m);if(Ca(c))return N(h,u,c,m);if(R&&oi(h,c),typeof c=="undefined"&&!p)switch(h.tag){case 1:case 22:case 0:case 11:case 15:throw Error(T(152,bn(h.type)||"Component"))}return a(h,u)}}var li=zl(!0),_l=zl(!1),$a={},Le=tn($a),et=tn($a),nt=tn($a);function Nn(e){if(e===$a)throw Error(T(174));return e}function $r(e,n){switch(q(nt,n),q(et,e),q(Le,$a),e=n.nodeType,e){case 9:case 11:n=(n=n.documentElement)?n.namespaceURI:tr(null,"");break;default:e=e===8?n.parentNode:n,n=e.namespaceURI||null,e=e.tagName,n=tr(n,e)}Q(Le),q(Le,n)}function la(){Q(Le),Q(et),Q(nt)}function Ql(e){Nn(nt.current);var n=Nn(Le.current),a=tr(n,e.type);n!==a&&(q(et,e),q(Le,a))}function eo(e){et.current===e&&(Q(Le),Q(et))}var Z=tn(0);function ui(e){for(var n=e;n!==null;){if(n.tag===13){var a=n.memoizedState;if(a!==null&&(a=a.dehydrated,a===null||a.data==="$?"||a.data==="$!"))return n}else if(n.tag===19&&n.memoizedProps.revealOrder!==void 0){if((n.flags&64)!=0)return n}else if(n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}return null}var xe=null,hn=null,Pe=!1;function Jl(e,n){var a=Oe(5,null,null,0);a.elementType="DELETED",a.type="DELETED",a.stateNode=n,a.return=e,a.flags=8,e.lastEffect!==null?(e.lastEffect.nextEffect=a,e.lastEffect=a):e.firstEffect=e.lastEffect=a}function ql(e,n){switch(e.tag){case 5:var a=e.type;return n=n.nodeType!==1||a.toLowerCase()!==n.nodeName.toLowerCase()?null:n,n!==null?(e.stateNode=n,!0):!1;case 6:return n=e.pendingProps===""||n.nodeType!==3?null:n,n!==null?(e.stateNode=n,!0):!1;case 13:return!1;default:return!1}}function no(e){if(Pe){var n=hn;if(n){var a=n;if(!ql(e,n)){if(n=na(a.nextSibling),!n||!ql(e,n)){e.flags=e.flags&-1025|2,Pe=!1,xe=e;return}Jl(xe,a)}xe=e,hn=na(n.firstChild)}else e.flags=e.flags&-1025|2,Pe=!1,xe=e}}function Zl(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;xe=e}function di(e){if(e!==xe)return!1;if(!Pe)return Zl(e),Pe=!0,!1;var n=e.type;if(e.tag!==5||n!=="head"&&n!=="body"&&!Pr(n,e.memoizedProps))for(n=hn;n;)Jl(e,n),n=na(n.nextSibling);if(Zl(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(T(317));e:{for(e=e.nextSibling,n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="/$"){if(n===0){hn=na(e.nextSibling);break e}n--}else a!=="$"&&a!=="$!"&&a!=="$?"||n++}e=e.nextSibling}hn=null}}else hn=xe?na(e.stateNode.nextSibling):null;return!0}function ao(){hn=xe=null,Pe=!1}var ua=[];function to(){for(var e=0;e<ua.length;e++)ua[e]._workInProgressVersionPrimary=null;ua.length=0}var at=Tn.ReactCurrentDispatcher,Ne=Tn.ReactCurrentBatchConfig,tt=0,X=null,ge=null,ue=null,ci=!1,it=!1;function Te(){throw Error(T(321))}function io(e,n){if(n===null)return!1;for(var a=0;a<n.length&&a<e.length;a++)if(!we(e[a],n[a]))return!1;return!0}function ro(e,n,a,t,i,r){if(tt=r,X=n,n.memoizedState=null,n.updateQueue=null,n.lanes=0,at.current=e===null||e.memoizedState===null?nh:ah,e=a(t,i),it){r=0;do{if(it=!1,!(25>r))throw Error(T(301));r+=1,ue=ge=null,n.updateQueue=null,at.current=th,e=a(t,i)}while(it)}if(at.current=hi,n=ge!==null&&ge.next!==null,tt=0,ue=ge=X=null,ci=!1,n)throw Error(T(300));return e}function Gn(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return ue===null?X.memoizedState=ue=e:ue=ue.next=e,ue}function Bn(){if(ge===null){var e=X.alternate;e=e!==null?e.memoizedState:null}else e=ge.next;var n=ue===null?X.memoizedState:ue.next;if(n!==null)ue=n,ge=e;else{if(e===null)throw Error(T(310));ge=e,e={memoizedState:ge.memoizedState,baseState:ge.baseState,baseQueue:ge.baseQueue,queue:ge.queue,next:null},ue===null?X.memoizedState=ue=e:ue=ue.next=e}return ue}function Fe(e,n){return typeof n=="function"?n(e):n}function rt(e){var n=Bn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=ge,i=t.baseQueue,r=a.pending;if(r!==null){if(i!==null){var o=i.next;i.next=r.next,r.next=o}t.baseQueue=i=r,a.pending=null}if(i!==null){i=i.next,t=t.baseState;var s=o=r=null,l=i;do{var d=l.lane;if((tt&d)===d)s!==null&&(s=s.next={lane:0,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null}),t=l.eagerReducer===e?l.eagerState:e(t,l.action);else{var y={lane:d,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null};s===null?(o=s=y,r=t):s=s.next=y,X.lanes|=d,qa|=d}l=l.next}while(l!==null&&l!==i);s===null?r=t:s.next=o,we(t,n.memoizedState)||(Re=!0),n.memoizedState=t,n.baseState=r,n.baseQueue=s,a.lastRenderedState=t}return[n.memoizedState,a.dispatch]}function ot(e){var n=Bn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=a.dispatch,i=a.pending,r=n.memoizedState;if(i!==null){a.pending=null;var o=i=i.next;do r=e(r,o.action),o=o.next;while(o!==i);we(r,n.memoizedState)||(Re=!0),n.memoizedState=r,n.baseQueue===null&&(n.baseState=r),a.lastRenderedState=r}return[r,t]}function Xl(e,n,a){var t=n._getVersion;t=t(n._source);var i=n._workInProgressVersionPrimary;if(i!==null?e=i===t:(e=e.mutableReadLanes,(e=(tt&e)===e)&&(n._workInProgressVersionPrimary=t,ua.push(n))),e)return a(n._source);throw ua.push(n),Error(T(350))}function $l(e,n,a,t){var i=pe;if(i===null)throw Error(T(349));var r=n._getVersion,o=r(n._source),s=at.current,l=s.useState(function(){return Xl(i,n,a)}),d=l[1],y=l[0];l=ue;var C=e.memoizedState,S=C.refs,M=S.getSnapshot,W=C.source;C=C.subscribe;var N=X;return e.memoizedState={refs:S,source:n,subscribe:t},s.useEffect(function(){S.getSnapshot=a,S.setSnapshot=d;var h=r(n._source);if(!we(o,h)){h=a(n._source),we(y,h)||(d(h),h=un(N),i.mutableReadLanes|=h&i.pendingLanes),h=i.mutableReadLanes,i.entangledLanes|=h;for(var u=i.entanglements,c=h;0<c;){var m=31-en(c),p=1<<m;u[m]|=h,c&=~p}}},[a,n,t]),s.useEffect(function(){return t(n._source,function(){var h=S.getSnapshot,u=S.setSnapshot;try{u(h(n._source));var c=un(N);i.mutableReadLanes|=c&i.pendingLanes}catch(m){u(function(){throw m})}})},[n,t]),we(M,a)&&we(W,n)&&we(C,t)||(e={pending:null,dispatch:null,lastRenderedReducer:Fe,lastRenderedState:y},e.dispatch=d=oo.bind(null,X,e),l.queue=e,l.baseQueue=null,y=Xl(i,n,a),l.memoizedState=l.baseState=y),y}function eu(e,n,a){var t=Bn();return $l(t,e,n,a)}function st(e){var n=Gn();return typeof e=="function"&&(e=e()),n.memoizedState=n.baseState=e,e=n.queue={pending:null,dispatch:null,lastRenderedReducer:Fe,lastRenderedState:e},e=e.dispatch=oo.bind(null,X,e),[n.memoizedState,e]}function gi(e,n,a,t){return e={tag:e,create:n,destroy:a,deps:t,next:null},n=X.updateQueue,n===null?(n={lastEffect:null},X.updateQueue=n,n.lastEffect=e.next=e):(a=n.lastEffect,a===null?n.lastEffect=e.next=e:(t=a.next,a.next=e,e.next=t,n.lastEffect=e)),e}function nu(e){var n=Gn();return e={current:e},n.memoizedState=e}function mi(){return Bn().memoizedState}function so(e,n,a,t){var i=Gn();X.flags|=e,i.memoizedState=gi(1|n,a,void 0,t===void 0?null:t)}function lo(e,n,a,t){var i=Bn();t=t===void 0?null:t;var r=void 0;if(ge!==null){var o=ge.memoizedState;if(r=o.destroy,t!==null&&io(t,o.deps)){gi(n,a,r,t);return}}X.flags|=e,i.memoizedState=gi(1|n,a,r,t)}function au(e,n){return so(516,4,e,n)}function fi(e,n){return lo(516,4,e,n)}function tu(e,n){return lo(4,2,e,n)}function iu(e,n){if(typeof n=="function")return e=e(),n(e),function(){n(null)};if(n!=null)return e=e(),n.current=e,function(){n.current=null}}function ru(e,n,a){return a=a!=null?a.concat([e]):null,lo(4,2,iu.bind(null,n,e),a)}function uo(){}function ou(e,n){var a=Bn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&io(n,t[1])?t[0]:(a.memoizedState=[e,n],e)}function su(e,n){var a=Bn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&io(n,t[1])?t[0]:(e=e(),a.memoizedState=[e,n],e)}function ih(e,n){var a=ia();On(98>a?98:a,function(){e(!0)}),On(97<a?97:a,function(){var t=Ne.transition;Ne.transition=1;try{e(!1),n()}finally{Ne.transition=t}})}function oo(e,n,a){var t=ve(),i=un(e),r={lane:i,action:a,eagerReducer:null,eagerState:null,next:null},o=n.pending;if(o===null?r.next=r:(r.next=o.next,o.next=r),n.pending=r,o=e.alternate,e===X||o!==null&&o===X)it=ci=!0;else{if(e.lanes===0&&(o===null||o.lanes===0)&&(o=n.lastRenderedReducer,o!==null))try{var s=n.lastRenderedState,l=o(s,a);if(r.eagerReducer=o,r.eagerState=l,we(l,s))return}catch(d){}finally{}dn(e,i,t)}}var hi={readContext:Ce,useCallback:Te,useContext:Te,useEffect:Te,useImperativeHandle:Te,useLayoutEffect:Te,useMemo:Te,useReducer:Te,useRef:Te,useState:Te,useDebugValue:Te,useDeferredValue:Te,useTransition:Te,useMutableSource:Te,useOpaqueIdentifier:Te,unstable_isNewReconciler:!1},nh={readContext:Ce,useCallback:function(e,n){return Gn().memoizedState=[e,n===void 0?null:n],e},useContext:Ce,useEffect:au,useImperativeHandle:function(e,n,a){return a=a!=null?a.concat([e]):null,so(4,2,iu.bind(null,n,e),a)},useLayoutEffect:function(e,n){return so(4,2,e,n)},useMemo:function(e,n){var a=Gn();return n=n===void 0?null:n,e=e(),a.memoizedState=[e,n],e},useReducer:function(e,n,a){var t=Gn();return n=a!==void 0?a(n):n,t.memoizedState=t.baseState=n,e=t.queue={pending:null,dispatch:null,lastRenderedReducer:e,lastRenderedState:n},e=e.dispatch=oo.bind(null,X,e),[t.memoizedState,e]},useRef:nu,useState:st,useDebugValue:uo,useDeferredValue:function(e){var n=st(e),a=n[0],t=n[1];return au(function(){var i=Ne.transition;Ne.transition=1;try{t(e)}finally{Ne.transition=i}},[e]),a},useTransition:function(){var e=st(!1),n=e[0];return e=ih.bind(null,e[1]),nu(e),[e,n]},useMutableSource:function(e,n,a){var t=Gn();return t.memoizedState={refs:{getSnapshot:n,setSnapshot:null},source:e,subscribe:a},$l(t,e,n,a)},useOpaqueIdentifier:function(){if(Pe){var e=!1,n=Jc(function(){throw e||(e=!0,a("r:"+(Kr++).toString(36))),Error(T(355))}),a=st(n)[1];return(X.mode&2)==0&&(X.flags|=516,gi(5,function(){a("r:"+(Kr++).toString(36))},void 0,null)),n}return n="r:"+(Kr++).toString(36),st(n),n},unstable_isNewReconciler:!1},ah={readContext:Ce,useCallback:ou,useContext:Ce,useEffect:fi,useImperativeHandle:ru,useLayoutEffect:tu,useMemo:su,useReducer:rt,useRef:mi,useState:function(){return rt(Fe)},useDebugValue:uo,useDeferredValue:function(e){var n=rt(Fe),a=n[0],t=n[1];return fi(function(){var i=Ne.transition;Ne.transition=1;try{t(e)}finally{Ne.transition=i}},[e]),a},useTransition:function(){var e=rt(Fe)[0];return[mi().current,e]},useMutableSource:eu,useOpaqueIdentifier:function(){return rt(Fe)[0]},unstable_isNewReconciler:!1},th={readContext:Ce,useCallback:ou,useContext:Ce,useEffect:fi,useImperativeHandle:ru,useLayoutEffect:tu,useMemo:su,useReducer:ot,useRef:mi,useState:function(){return ot(Fe)},useDebugValue:uo,useDeferredValue:function(e){var n=ot(Fe),a=n[0],t=n[1];return fi(function(){var i=Ne.transition;Ne.transition=1;try{t(e)}finally{Ne.transition=i}},[e]),a},useTransition:function(){var e=ot(Fe)[0];return[mi().current,e]},useMutableSource:eu,useOpaqueIdentifier:function(){return ot(Fe)[0]},unstable_isNewReconciler:!1},rh=Tn.ReactCurrentOwner,Re=!1;function Ae(e,n,a,t){n.child=e===null?_l(n,null,a,t):li(n,e.child,a,t)}function lu(e,n,a,t,i){a=a.render;var r=n.ref;return oa(n,i),t=ro(e,n,a,t,r,i),e!==null&&!Re?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,Ye(e,n,i)):(n.flags|=1,Ae(e,n,t,i),n.child)}function du(e,n,a,t,i,r){if(e===null){var o=a.type;return typeof o=="function"&&!co(o)&&o.defaultProps===void 0&&a.compare===null&&a.defaultProps===void 0?(n.tag=15,n.type=o,uu(e,n,o,t,i,r)):(e=si(a.type,null,t,n,n.mode,r),e.ref=n.ref,e.return=n,n.child=e)}return o=e.child,(i&r)==0&&(i=o.memoizedProps,a=a.compare,a=a!==null?a:Va,a(i,t)&&e.ref===n.ref)?Ye(e,n,r):(n.flags|=1,e=cn(o,t),e.ref=n.ref,e.return=n,n.child=e)}function uu(e,n,a,t,i,r){if(e!==null&&Va(e.memoizedProps,t)&&e.ref===n.ref)if(Re=!1,(r&i)!=0)(e.flags&16384)!=0&&(Re=!0);else return n.lanes=e.lanes,Ye(e,n,r);return ho(e,n,a,t,r)}function go(e,n,a){var t=n.pendingProps,i=t.children,r=e!==null?e.memoizedState:null;if(t.mode==="hidden"||t.mode==="unstable-defer-without-hiding")if((n.mode&4)==0)n.memoizedState={baseLanes:0},pi(n,a);else if((a&1073741824)!=0)n.memoizedState={baseLanes:0},pi(n,r!==null?r.baseLanes:a);else return e=r!==null?r.baseLanes|a:a,n.lanes=n.childLanes=1073741824,n.memoizedState={baseLanes:e},pi(n,e),null;else r!==null?(t=r.baseLanes|a,n.memoizedState=null):t=a,pi(n,t);return Ae(e,n,i,a),n.child}function cu(e,n){var a=n.ref;(e===null&&a!==null||e!==null&&e.ref!==a)&&(n.flags|=128)}function ho(e,n,a,t,i){var r=Ie(a)?wn:ce.current;return r=ta(n,r),oa(n,i),a=ro(e,n,a,t,r,i),e!==null&&!Re?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,Ye(e,n,i)):(n.flags|=1,Ae(e,n,a,i),n.child)}function hu(e,n,a,t,i){if(Ie(a)){var r=!0;Zt(n)}else r=!1;if(oa(n,i),n.stateNode===null)e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),jl(n,a,t),qr(n,a,t,i),t=!0;else if(e===null){var o=n.stateNode,s=n.memoizedProps;o.props=s;var l=o.context,d=a.contextType;typeof d=="object"&&d!==null?d=Ce(d):(d=Ie(a)?wn:ce.current,d=ta(n,d));var y=a.getDerivedStateFromProps,C=typeof y=="function"||typeof o.getSnapshotBeforeUpdate=="function";C||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==t||l!==d)&&Vl(n,o,t,d),on=!1;var S=n.memoizedState;o.state=S,Za(n,t,o,i),l=n.memoizedState,s!==t||S!==l||ye.current||on?(typeof y=="function"&&(ti(n,a,y,t),l=n.memoizedState),(s=on||Yl(n,a,s,t,S,l,d))?(C||typeof o.UNSAFE_componentWillMount!="function"&&typeof o.componentWillMount!="function"||(typeof o.componentWillMount=="function"&&o.componentWillMount(),typeof o.UNSAFE_componentWillMount=="function"&&o.UNSAFE_componentWillMount()),typeof o.componentDidMount=="function"&&(n.flags|=4)):(typeof o.componentDidMount=="function"&&(n.flags|=4),n.memoizedProps=t,n.memoizedState=l),o.props=t,o.state=l,o.context=d,t=s):(typeof o.componentDidMount=="function"&&(n.flags|=4),t=!1)}else{o=n.stateNode,Kl(e,n),s=n.memoizedProps,d=n.type===n.elementType?s:We(n.type,s),o.props=d,C=n.pendingProps,S=o.context,l=a.contextType,typeof l=="object"&&l!==null?l=Ce(l):(l=Ie(a)?wn:ce.current,l=ta(n,l));var M=a.getDerivedStateFromProps;(y=typeof M=="function"||typeof o.getSnapshotBeforeUpdate=="function")||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==C||S!==l)&&Vl(n,o,t,l),on=!1,S=n.memoizedState,o.state=S,Za(n,t,o,i);var W=n.memoizedState;s!==C||S!==W||ye.current||on?(typeof M=="function"&&(ti(n,a,M,t),W=n.memoizedState),(d=on||Yl(n,a,d,t,S,W,l))?(y||typeof o.UNSAFE_componentWillUpdate!="function"&&typeof o.componentWillUpdate!="function"||(typeof o.componentWillUpdate=="function"&&o.componentWillUpdate(t,W,l),typeof o.UNSAFE_componentWillUpdate=="function"&&o.UNSAFE_componentWillUpdate(t,W,l)),typeof o.componentDidUpdate=="function"&&(n.flags|=4),typeof o.getSnapshotBeforeUpdate=="function"&&(n.flags|=256)):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&S===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&S===e.memoizedState||(n.flags|=256),n.memoizedProps=t,n.memoizedState=W),o.props=t,o.state=W,o.context=l,t=d):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&S===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&S===e.memoizedState||(n.flags|=256),t=!1)}return mo(e,n,a,t,r,i)}function mo(e,n,a,t,i,r){cu(e,n);var o=(n.flags&64)!=0;if(!t&&!o)return i&&Nl(n,a,!1),Ye(e,n,r);t=n.stateNode,rh.current=n;var s=o&&typeof a.getDerivedStateFromError!="function"?null:t.render();return n.flags|=1,e!==null&&o?(n.child=li(n,e.child,null,r),n.child=li(n,null,s,r)):Ae(e,n,s,r),n.memoizedState=t.state,i&&Nl(n,a,!0),n.child}function gu(e){var n=e.stateNode;n.pendingContext?Cl(e,n.pendingContext,n.pendingContext!==n.context):n.context&&Cl(e,n.context,!1),$r(e,n.containerInfo)}var Si={dehydrated:null,retryLane:0};function Su(e,n,a){var t=n.pendingProps,i=Z.current,r=!1,o;return(o=(n.flags&64)!=0)||(o=e!==null&&e.memoizedState===null?!1:(i&2)!=0),o?(r=!0,n.flags&=-65):e!==null&&e.memoizedState===null||t.fallback===void 0||t.unstable_avoidThisFallback===!0||(i|=1),q(Z,i&1),e===null?(t.fallback!==void 0&&no(n),e=t.children,i=t.fallback,r?(e=mu(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=Si,e):typeof t.unstable_expectedLoadTime=="number"?(e=mu(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=Si,n.lanes=33554432,e):(a=fo({mode:"visible",children:e},n.mode,a,null),a.return=n,n.child=a)):e.memoizedState!==null?r?(t=pu(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=Si,t):(a=fu(e,n,t.children,a),n.memoizedState=null,a):r?(t=pu(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=Si,t):(a=fu(e,n,t.children,a),n.memoizedState=null,a)}function mu(e,n,a,t){var i=e.mode,r=e.child;return n={mode:"hidden",children:n},(i&2)==0&&r!==null?(r.childLanes=0,r.pendingProps=n):r=fo(n,i,0,null),a=sa(a,i,t,null),r.return=e,a.return=e,r.sibling=a,e.child=r,a}function fu(e,n,a,t){var i=e.child;return e=i.sibling,a=cn(i,{mode:"visible",children:a}),(n.mode&2)==0&&(a.lanes=t),a.return=n,a.sibling=null,e!==null&&(e.nextEffect=null,e.flags=8,n.firstEffect=n.lastEffect=e),n.child=a}function pu(e,n,a,t,i){var r=n.mode,o=e.child;e=o.sibling;var s={mode:"hidden",children:a};return(r&2)==0&&n.child!==o?(a=n.child,a.childLanes=0,a.pendingProps=s,o=a.lastEffect,o!==null?(n.firstEffect=a.firstEffect,n.lastEffect=o,o.nextEffect=null):n.firstEffect=n.lastEffect=null):a=cn(o,s),e!==null?t=cn(e,t):(t=sa(t,r,i,null),t.flags|=2),t.return=n,a.return=n,a.sibling=t,n.child=a,t}function ku(e,n){e.lanes|=n;var a=e.alternate;a!==null&&(a.lanes|=n),Fl(e.return,n)}function po(e,n,a,t,i,r){var o=e.memoizedState;o===null?e.memoizedState={isBackwards:n,rendering:null,renderingStartTime:0,last:t,tail:a,tailMode:i,lastEffect:r}:(o.isBackwards=n,o.rendering=null,o.renderingStartTime=0,o.last=t,o.tail=a,o.tailMode=i,o.lastEffect=r)}function yu(e,n,a){var t=n.pendingProps,i=t.revealOrder,r=t.tail;if(Ae(e,n,t.children,a),t=Z.current,(t&2)!=0)t=t&1|2,n.flags|=64;else{if(e!==null&&(e.flags&64)!=0)e:for(e=n.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&ku(e,a);else if(e.tag===19)ku(e,a);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===n)break e;for(;e.sibling===null;){if(e.return===null||e.return===n)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}t&=1}if(q(Z,t),(n.mode&2)==0)n.memoizedState=null;else switch(i){case"forwards":for(a=n.child,i=null;a!==null;)e=a.alternate,e!==null&&ui(e)===null&&(i=a),a=a.sibling;a=i,a===null?(i=n.child,n.child=null):(i=a.sibling,a.sibling=null),po(n,!1,i,a,r,n.lastEffect);break;case"backwards":for(a=null,i=n.child,n.child=null;i!==null;){if(e=i.alternate,e!==null&&ui(e)===null){n.child=i;break}e=i.sibling,i.sibling=a,a=i,i=e}po(n,!0,a,null,r,n.lastEffect);break;case"together":po(n,!1,null,null,void 0,n.lastEffect);break;default:n.memoizedState=null}return n.child}function Ye(e,n,a){if(e!==null&&(n.dependencies=e.dependencies),qa|=n.lanes,(a&n.childLanes)!=0){if(e!==null&&n.child!==e.child)throw Error(T(153));if(n.child!==null){for(e=n.child,a=cn(e,e.pendingProps),n.child=a,a.return=n;e.sibling!==null;)e=e.sibling,a=a.sibling=cn(e,e.pendingProps),a.return=n;a.sibling=null}return n.child}return null}var Iu,So,Tu,Au;Iu=function(e,n){for(var a=n.child;a!==null;){if(a.tag===5||a.tag===6)e.appendChild(a.stateNode);else if(a.tag!==4&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return}a.sibling.return=a.return,a=a.sibling}};So=function(){};Tu=function(e,n,a,t){var i=e.memoizedProps;if(i!==t){e=n.stateNode,Nn(Le.current);var r=null;switch(a){case"input":i=Zi(e,i),t=Zi(e,t),r=[];break;case"option":i=er(e,i),t=er(e,t),r=[];break;case"select":i=x({},i,{value:void 0}),t=x({},t,{value:void 0}),r=[];break;case"textarea":i=nr(e,i),t=nr(e,t),r=[];break;default:typeof i.onClick!="function"&&typeof t.onClick=="function"&&(e.onclick=_t)}ir(a,t);var o;a=null;for(d in i)if(!t.hasOwnProperty(d)&&i.hasOwnProperty(d)&&i[d]!=null)if(d==="style"){var s=i[d];for(o in s)s.hasOwnProperty(o)&&(a||(a={}),a[o]="")}else d!=="dangerouslySetInnerHTML"&&d!=="children"&&d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&d!=="autoFocus"&&(Ea.hasOwnProperty(d)?r||(r=[]):(r=r||[]).push(d,null));for(d in t){var l=t[d];if(s=i!=null?i[d]:void 0,t.hasOwnProperty(d)&&l!==s&&(l!=null||s!=null))if(d==="style")if(s){for(o in s)!s.hasOwnProperty(o)||l&&l.hasOwnProperty(o)||(a||(a={}),a[o]="");for(o in l)l.hasOwnProperty(o)&&s[o]!==l[o]&&(a||(a={}),a[o]=l[o])}else a||(r||(r=[]),r.push(d,a)),a=l;else d==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,s=s?s.__html:void 0,l!=null&&s!==l&&(r=r||[]).push(d,l)):d==="children"?typeof l!="string"&&typeof l!="number"||(r=r||[]).push(d,""+l):d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&(Ea.hasOwnProperty(d)?(l!=null&&d==="onScroll"&&_("scroll",e),r||s===l||(r=[])):typeof l=="object"&&l!==null&&l.$$typeof===zi?l.toString():(r=r||[]).push(d,l))}a&&(r=r||[]).push("style",a);var d=r;(n.updateQueue=d)&&(n.flags|=4)}};Au=function(e,n,a,t){a!==t&&(n.flags|=4)};function lt(e,n){if(!Pe)switch(e.tailMode){case"hidden":n=e.tail;for(var a=null;n!==null;)n.alternate!==null&&(a=n),n=n.sibling;a===null?e.tail=null:a.sibling=null;break;case"collapsed":a=e.tail;for(var t=null;a!==null;)a.alternate!==null&&(t=a),a=a.sibling;t===null?n||e.tail===null?e.tail=null:e.tail.sibling=null:t.sibling=null}}function oh(e,n,a){var t=n.pendingProps;switch(n.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return null;case 1:return Ie(n.type)&&qt(),null;case 3:return la(),Q(ye),Q(ce),to(),t=n.stateNode,t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(e===null||e.child===null)&&(di(n)?n.flags|=4:t.hydrate||(n.flags|=256)),So(n),null;case 5:eo(n);var i=Nn(nt.current);if(a=n.type,e!==null&&n.stateNode!=null)Tu(e,n,a,t,i),e.ref!==n.ref&&(n.flags|=128);else{if(!t){if(n.stateNode===null)throw Error(T(166));return null}if(e=Nn(Le.current),di(n)){t=n.stateNode,a=n.type;var r=n.memoizedProps;switch(t[an]=n,t[Jt]=r,a){case"dialog":_("cancel",t),_("close",t);break;case"iframe":case"object":case"embed":_("load",t);break;case"video":case"audio":for(e=0;e<_a.length;e++)_(_a[e],t);break;case"source":_("error",t);break;case"img":case"image":case"link":_("error",t),_("load",t);break;case"details":_("toggle",t);break;case"input":gs(t,r),_("invalid",t);break;case"select":t._wrapperState={wasMultiple:!!r.multiple},_("invalid",t);break;case"textarea":ps(t,r),_("invalid",t)}ir(a,r),e=null;for(var o in r)r.hasOwnProperty(o)&&(i=r[o],o==="children"?typeof i=="string"?t.textContent!==i&&(e=["children",i]):typeof i=="number"&&t.textContent!==""+i&&(e=["children",""+i]):Ea.hasOwnProperty(o)&&i!=null&&o==="onScroll"&&_("scroll",t));switch(a){case"input":Ct(t),fs(t,r,!0);break;case"textarea":Ct(t),ks(t);break;case"select":case"option":break;default:typeof r.onClick=="function"&&(t.onclick=_t)}t=e,n.updateQueue=t,t!==null&&(n.flags|=4)}else{switch(o=i.nodeType===9?i:i.ownerDocument,e===ar.html&&(e=ys(a)),e===ar.html?a==="script"?(e=o.createElement("div"),e.innerHTML="<script></script>",e=e.removeChild(e.firstChild)):typeof t.is=="string"?e=o.createElement(a,{is:t.is}):(e=o.createElement(a),a==="select"&&(o=e,t.multiple?o.multiple=!0:t.size&&(o.size=t.size))):e=o.createElementNS(e,a),e[an]=n,e[Jt]=t,Iu(e,n,!1,!1),n.stateNode=e,o=rr(a,t),a){case"dialog":_("cancel",e),_("close",e),i=t;break;case"iframe":case"object":case"embed":_("load",e),i=t;break;case"video":case"audio":for(i=0;i<_a.length;i++)_(_a[i],e);i=t;break;case"source":_("error",e),i=t;break;case"img":case"image":case"link":_("error",e),_("load",e),i=t;break;case"details":_("toggle",e),i=t;break;case"input":gs(e,t),i=Zi(e,t),_("invalid",e);break;case"option":i=er(e,t);break;case"select":e._wrapperState={wasMultiple:!!t.multiple},i=x({},t,{value:void 0}),_("invalid",e);break;case"textarea":ps(e,t),i=nr(e,t),_("invalid",e);break;default:i=t}ir(a,i);var s=i;for(r in s)if(s.hasOwnProperty(r)){var l=s[r];r==="style"?As(e,l):r==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,l!=null&&Is(e,l)):r==="children"?typeof l=="string"?(a!=="textarea"||l!=="")&&Na(e,l):typeof l=="number"&&Na(e,""+l):r!=="suppressContentEditableWarning"&&r!=="suppressHydrationWarning"&&r!=="autoFocus"&&(Ea.hasOwnProperty(r)?l!=null&&r==="onScroll"&&_("scroll",e):l!=null&&Hi(e,r,l,o))}switch(a){case"input":Ct(e),fs(e,t,!1);break;case"textarea":Ct(e),ks(e);break;case"option":t.value!=null&&e.setAttribute("value",""+qe(t.value));break;case"select":e.multiple=!!t.multiple,r=t.value,r!=null?xn(e,!!t.multiple,r,!1):t.defaultValue!=null&&xn(e,!!t.multiple,t.defaultValue,!0);break;default:typeof i.onClick=="function"&&(e.onclick=_t)}El(a,t)&&(n.flags|=4)}n.ref!==null&&(n.flags|=128)}return null;case 6:if(e&&n.stateNode!=null)Au(e,n,e.memoizedProps,t);else{if(typeof t!="string"&&n.stateNode===null)throw Error(T(166));a=Nn(nt.current),Nn(Le.current),di(n)?(t=n.stateNode,a=n.memoizedProps,t[an]=n,t.nodeValue!==a&&(n.flags|=4)):(t=(a.nodeType===9?a:a.ownerDocument).createTextNode(t),t[an]=n,n.stateNode=t)}return null;case 13:return Q(Z),t=n.memoizedState,(n.flags&64)!=0?(n.lanes=a,n):(t=t!==null,a=!1,e===null?n.memoizedProps.fallback!==void 0&&di(n):a=e.memoizedState!==null,t&&!a&&(n.mode&2)!=0&&(e===null&&n.memoizedProps.unstable_avoidThisFallback!==!0||(Z.current&1)!=0?de===0&&(de=3):((de===0||de===3)&&(de=4),pe===null||(qa&134217727)==0&&(da&134217727)==0||ca(pe,me))),(t||a)&&(n.flags|=4),null);case 4:return la(),So(n),e===null&&Tl(n.stateNode.containerInfo),null;case 10:return Qr(n),null;case 17:return Ie(n.type)&&qt(),null;case 19:if(Q(Z),t=n.memoizedState,t===null)return null;if(r=(n.flags&64)!=0,o=t.rendering,o===null)if(r)lt(t,!1);else{if(de!==0||e!==null&&(e.flags&64)!=0)for(e=n.child;e!==null;){if(o=ui(e),o!==null){for(n.flags|=64,lt(t,!1),r=o.updateQueue,r!==null&&(n.updateQueue=r,n.flags|=4),t.lastEffect===null&&(n.firstEffect=null),n.lastEffect=t.lastEffect,t=a,a=n.child;a!==null;)r=a,e=t,r.flags&=2,r.nextEffect=null,r.firstEffect=null,r.lastEffect=null,o=r.alternate,o===null?(r.childLanes=0,r.lanes=e,r.child=null,r.memoizedProps=null,r.memoizedState=null,r.updateQueue=null,r.dependencies=null,r.stateNode=null):(r.childLanes=o.childLanes,r.lanes=o.lanes,r.child=o.child,r.memoizedProps=o.memoizedProps,r.memoizedState=o.memoizedState,r.updateQueue=o.updateQueue,r.type=o.type,e=o.dependencies,r.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),a=a.sibling;return q(Z,Z.current&1|2),n.child}e=e.sibling}t.tail!==null&&he()>ko&&(n.flags|=64,r=!0,lt(t,!1),n.lanes=33554432)}else{if(!r)if(e=ui(o),e!==null){if(n.flags|=64,r=!0,a=e.updateQueue,a!==null&&(n.updateQueue=a,n.flags|=4),lt(t,!0),t.tail===null&&t.tailMode==="hidden"&&!o.alternate&&!Pe)return n=n.lastEffect=t.lastEffect,n!==null&&(n.nextEffect=null),null}else 2*he()-t.renderingStartTime>ko&&a!==1073741824&&(n.flags|=64,r=!0,lt(t,!1),n.lanes=33554432);t.isBackwards?(o.sibling=n.child,n.child=o):(a=t.last,a!==null?a.sibling=o:n.child=o,t.last=o)}return t.tail!==null?(a=t.tail,t.rendering=a,t.tail=a.sibling,t.lastEffect=n.lastEffect,t.renderingStartTime=he(),a.sibling=null,n=Z.current,q(Z,r?n&1|2:n&1),a):null;case 23:case 24:return yo(),e!==null&&e.memoizedState!==null!=(n.memoizedState!==null)&&t.mode!=="unstable-defer-without-hiding"&&(n.flags|=4),null}throw Error(T(156,n.tag))}function sh(e){switch(e.tag){case 1:Ie(e.type)&&qt();var n=e.flags;return n&4096?(e.flags=n&-4097|64,e):null;case 3:if(la(),Q(ye),Q(ce),to(),n=e.flags,(n&64)!=0)throw Error(T(285));return e.flags=n&-4097|64,e;case 5:return eo(e),null;case 13:return Q(Z),n=e.flags,n&4096?(e.flags=n&-4097|64,e):null;case 19:return Q(Z),null;case 4:return la(),null;case 10:return Qr(e),null;case 23:case 24:return yo(),null;default:return null}}function Io(e,n){try{var a="",t=n;do a+=bd(t),t=t.return;while(t);var i=a}catch(r){i=`
Error generating stack: `+r.message+`
`+r.stack}return{value:e,source:n,stack:i}}function To(e,n){try{console.error(n.value)}catch(a){setTimeout(function(){throw a})}}var lh=typeof WeakMap=="function"?WeakMap:Map;function Eu(e,n,a){a=sn(-1,a),a.tag=3,a.payload={element:null};var t=n.value;return a.callback=function(){ki||(ki=!0,Ao=t),To(e,n)},a}function vu(e,n,a){a=sn(-1,a),a.tag=3;var t=e.type.getDerivedStateFromError;if(typeof t=="function"){var i=n.value;a.payload=function(){return To(e,n),t(i)}}var r=e.stateNode;return r!==null&&typeof r.componentDidCatch=="function"&&(a.callback=function(){typeof t!="function"&&(Ke===null?Ke=new Set([this]):Ke.add(this),To(e,n));var o=n.stack;this.componentDidCatch(n.value,{componentStack:o!==null?o:""})}),a}var uh=typeof WeakSet=="function"?WeakSet:Set;function Mu(e){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(a){gn(e,a)}else n.current=null}function dh(e,n){switch(n.tag){case 0:case 11:case 15:case 22:return;case 1:if(n.flags&256&&e!==null){var a=e.memoizedProps,t=e.memoizedState;e=n.stateNode,n=e.getSnapshotBeforeUpdate(n.elementType===n.type?a:We(n.type,a),t),e.__reactInternalSnapshotBeforeUpdate=n}return;case 3:n.flags&256&&Fr(n.stateNode.containerInfo);return;case 5:case 6:case 4:case 17:return}throw Error(T(163))}function hh(e,n,a){switch(a.tag){case 0:case 11:case 15:case 22:if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{if((e.tag&3)==3){var t=e.create;e.destroy=t()}e=e.next}while(e!==n)}if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{var i=e;t=i.next,i=i.tag,(i&4)!=0&&(i&1)!=0&&(wu(a,e),ch(a,e)),e=t}while(e!==n)}return;case 1:e=a.stateNode,a.flags&4&&(n===null?e.componentDidMount():(t=a.elementType===a.type?n.memoizedProps:We(a.type,n.memoizedProps),e.componentDidUpdate(t,n.memoizedState,e.__reactInternalSnapshotBeforeUpdate))),n=a.updateQueue,n!==null&&bl(a,n,e);return;case 3:if(n=a.updateQueue,n!==null){if(e=null,a.child!==null)switch(a.child.tag){case 5:e=a.child.stateNode;break;case 1:e=a.child.stateNode}bl(a,n,e)}return;case 5:e=a.stateNode,n===null&&a.flags&4&&El(a.type,a.memoizedProps)&&e.focus();return;case 6:return;case 4:return;case 12:return;case 13:a.memoizedState===null&&(a=a.alternate,a!==null&&(a=a.memoizedState,a!==null&&(a=a.dehydrated,a!==null&&Fs(a))));return;case 19:case 17:case 20:case 21:case 23:case 24:return}throw Error(T(163))}function Cu(e,n){for(var a=e;;){if(a.tag===5){var t=a.stateNode;if(n)t=t.style,typeof t.setProperty=="function"?t.setProperty("display","none","important"):t.display="none";else{t=a.stateNode;var i=a.memoizedProps.style;i=i!=null&&i.hasOwnProperty("display")?i.display:null,t.style.display=Ts("display",i)}}else if(a.tag===6)a.stateNode.nodeValue=n?"":a.memoizedProps;else if((a.tag!==23&&a.tag!==24||a.memoizedState===null||a===e)&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===e)break;for(;a.sibling===null;){if(a.return===null||a.return===e)return;a=a.return}a.sibling.return=a.return,a=a.sibling}}function Nu(e,n){if(Cn&&typeof Cn.onCommitFiberUnmount=="function")try{Cn.onCommitFiberUnmount(br,n)}catch(r){}switch(n.tag){case 0:case 11:case 14:case 15:case 22:if(e=n.updateQueue,e!==null&&(e=e.lastEffect,e!==null)){var a=e=e.next;do{var t=a,i=t.destroy;if(t=t.tag,i!==void 0)if((t&4)!=0)wu(n,a);else{t=n;try{i()}catch(r){gn(t,r)}}a=a.next}while(a!==e)}break;case 1:if(Mu(n),e=n.stateNode,typeof e.componentWillUnmount=="function")try{e.props=n.memoizedProps,e.state=n.memoizedState,e.componentWillUnmount()}catch(r){gn(n,r)}break;case 5:Mu(n);break;case 4:Ou(e,n)}}function Gu(e){e.alternate=null,e.child=null,e.dependencies=null,e.firstEffect=null,e.lastEffect=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.return=null,e.updateQueue=null}function Bu(e){return e.tag===5||e.tag===3||e.tag===4}function Wu(e){e:{for(var n=e.return;n!==null;){if(Bu(n))break e;n=n.return}throw Error(T(160))}var a=n;switch(n=a.stateNode,a.tag){case 5:var t=!1;break;case 3:n=n.containerInfo,t=!0;break;case 4:n=n.containerInfo,t=!0;break;default:throw Error(T(161))}a.flags&16&&(Na(n,""),a.flags&=-17);e:n:for(a=e;;){for(;a.sibling===null;){if(a.return===null||Bu(a.return)){a=null;break e}a=a.return}for(a.sibling.return=a.return,a=a.sibling;a.tag!==5&&a.tag!==6&&a.tag!==18;){if(a.flags&2||a.child===null||a.tag===4)continue n;a.child.return=a,a=a.child}if(!(a.flags&2)){a=a.stateNode;break e}}t?Eo(e,a,n):vo(e,a,n)}function Eo(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.nodeType===8?a.parentNode.insertBefore(e,n):a.insertBefore(e,n):(a.nodeType===8?(n=a.parentNode,n.insertBefore(e,a)):(n=a,n.appendChild(e)),a=a._reactRootContainer,a!=null||n.onclick!==null||(n.onclick=_t));else if(t!==4&&(e=e.child,e!==null))for(Eo(e,n,a),e=e.sibling;e!==null;)Eo(e,n,a),e=e.sibling}function vo(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.insertBefore(e,n):a.appendChild(e);else if(t!==4&&(e=e.child,e!==null))for(vo(e,n,a),e=e.sibling;e!==null;)vo(e,n,a),e=e.sibling}function Ou(e,n){for(var a=n,t=!1,i,r;;){if(!t){t=a.return;e:for(;;){if(t===null)throw Error(T(160));switch(i=t.stateNode,t.tag){case 5:r=!1;break e;case 3:i=i.containerInfo,r=!0;break e;case 4:i=i.containerInfo,r=!0;break e}t=t.return}t=!0}if(a.tag===5||a.tag===6){e:for(var o=e,s=a,l=s;;)if(Nu(o,l),l.child!==null&&l.tag!==4)l.child.return=l,l=l.child;else{if(l===s)break e;for(;l.sibling===null;){if(l.return===null||l.return===s)break e;l=l.return}l.sibling.return=l.return,l=l.sibling}r?(o=i,s=a.stateNode,o.nodeType===8?o.parentNode.removeChild(s):o.removeChild(s)):i.removeChild(a.stateNode)}else if(a.tag===4){if(a.child!==null){i=a.stateNode.containerInfo,r=!0,a.child.return=a,a=a.child;continue}}else if(Nu(e,a),a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return,a.tag===4&&(t=!1)}a.sibling.return=a.return,a=a.sibling}}function wo(e,n){switch(n.tag){case 0:case 11:case 14:case 15:case 22:var a=n.updateQueue;if(a=a!==null?a.lastEffect:null,a!==null){var t=a=a.next;do(t.tag&3)==3&&(e=t.destroy,t.destroy=void 0,e!==void 0&&e()),t=t.next;while(t!==a)}return;case 1:return;case 5:if(a=n.stateNode,a!=null){t=n.memoizedProps;var i=e!==null?e.memoizedProps:t;e=n.type;var r=n.updateQueue;if(n.updateQueue=null,r!==null){for(a[Jt]=t,e==="input"&&t.type==="radio"&&t.name!=null&&ms(a,t),rr(e,i),n=rr(e,t),i=0;i<r.length;i+=2){var o=r[i],s=r[i+1];o==="style"?As(a,s):o==="dangerouslySetInnerHTML"?Is(a,s):o==="children"?Na(a,s):Hi(a,o,s,n)}switch(e){case"input":$i(a,t);break;case"textarea":Ss(a,t);break;case"select":e=a._wrapperState.wasMultiple,a._wrapperState.wasMultiple=!!t.multiple,r=t.value,r!=null?xn(a,!!t.multiple,r,!1):e!==!!t.multiple&&(t.defaultValue!=null?xn(a,!!t.multiple,t.defaultValue,!0):xn(a,!!t.multiple,t.multiple?[]:"",!1))}}}return;case 6:if(n.stateNode===null)throw Error(T(162));n.stateNode.nodeValue=n.memoizedProps;return;case 3:a=n.stateNode,a.hydrate&&(a.hydrate=!1,Fs(a.containerInfo));return;case 12:return;case 13:n.memoizedState!==null&&(Mo=he(),Cu(n.child,!0)),Ru(n);return;case 19:Ru(n);return;case 17:return;case 23:case 24:Cu(n,n.memoizedState!==null);return}throw Error(T(163))}function Ru(e){var n=e.updateQueue;if(n!==null){e.updateQueue=null;var a=e.stateNode;a===null&&(a=e.stateNode=new uh),n.forEach(function(t){var i=gh.bind(null,e,t);a.has(t)||(a.add(t),t.then(i,i))})}}function mh(e,n){return e!==null&&(e=e.memoizedState,e===null||e.dehydrated!==null)?(n=n.memoizedState,n!==null&&n.dehydrated===null):!1}var fh=Math.ceil,yi=Tn.ReactCurrentDispatcher,Co=Tn.ReactCurrentOwner,L=0,pe=null,te=null,me=0,Wn=0,Oo=tn(0),de=0,Ii=null,ha=0,qa=0,da=0,No=0,Go=null,Mo=0,ko=Infinity;function ga(){ko=he()+500}var O=null,ki=!1,Ao=null,Ke=null,mn=!1,ut=null,dt=90,Bo=[],Wo=[],je=null,ct=0,Ro=null,Ti=-1,Ve=0,Ai=0,ht=null,Ei=!1;function ve(){return(L&48)!=0?he():Ti!==-1?Ti:Ti=he()}function un(e){if(e=e.mode,(e&2)==0)return 1;if((e&4)==0)return ia()===99?1:2;if(Ve===0&&(Ve=ha),eh.transition!==0){Ai!==0&&(Ai=Go!==null?Go.pendingLanes:0),e=Ve;var n=4186112&~Ai;return n&=-n,n===0&&(e=4186112&~e,n=e&-e,n===0&&(n=8192)),n}return e=ia(),(L&4)!=0&&e===98?e=Lt(12,Ve):(e=tc(e),e=Lt(e,Ve)),e}function dn(e,n,a){if(50<ct)throw ct=0,Ro=null,Error(T(185));if(e=vi(e,n),e===null)return null;Pt(e,n,a),e===pe&&(da|=n,de===4&&ca(e,me));var t=ia();n===1?(L&8)!=0&&(L&48)==0?Uo(e):(Ge(e,a),L===0&&(ga(),De())):((L&4)==0||t!==98&&t!==99||(je===null?je=new Set([e]):je.add(e)),Ge(e,a)),Go=e}function vi(e,n){e.lanes|=n;var a=e.alternate;for(a!==null&&(a.lanes|=n),a=e,e=e.return;e!==null;)e.childLanes|=n,a=e.alternate,a!==null&&(a.childLanes|=n),a=e,e=e.return;return a.tag===3?a.stateNode:null}function Ge(e,n){for(var a=e.callbackNode,t=e.suspendedLanes,i=e.pingedLanes,r=e.expirationTimes,o=e.pendingLanes;0<o;){var s=31-en(o),l=1<<s,d=r[s];if(d===-1){if((l&t)==0||(l&i)!=0){d=n,_n(l);var y=V;r[s]=10<=y?d+250:6<=y?d+5e3:-1}}else d<=n&&(e.expiredLanes|=l);o&=~l}if(t=Ka(e,e===pe?me:0),n=V,t===0)a!==null&&(a!==Vr&&Yr(a),e.callbackNode=null,e.callbackPriority=0);else{if(a!==null){if(e.callbackPriority===n)return;a!==Vr&&Yr(a)}n===15?(a=Uo.bind(null,e),be===null?(be=[a],$t=xr(Xt,Pl)):be.push(a),a=Vr):n===14?a=Ja(99,Uo.bind(null,e)):(a=ic(n),a=Ja(a,Uu.bind(null,e))),e.callbackPriority=n,e.callbackNode=a}}function Uu(e){if(Ti=-1,Ai=Ve=0,(L&48)!=0)throw Error(T(327));var n=e.callbackNode;if(fn()&&e.callbackNode!==n)return null;var a=Ka(e,e===pe?me:0);if(a===0)return null;var t=a,i=L;L|=16;var r=Lu();(pe!==e||me!==t)&&(ga(),ma(e,t));do try{ph();break}catch(s){Du(e,s)}while(1);if(_r(),yi.current=r,L=i,te!==null?t=0:(pe=null,me=0,t=de),(ha&da)!=0)ma(e,0);else if(t!==0){if(t===2&&(L|=64,e.hydrate&&(e.hydrate=!1,Fr(e.containerInfo)),a=Vs(e),a!==0&&(t=gt(e,a))),t===1)throw n=Ii,ma(e,0),ca(e,a),Ge(e,he()),n;switch(e.finishedWork=e.current.alternate,e.finishedLanes=a,t){case 0:case 1:throw Error(T(345));case 2:Rn(e);break;case 3:if(ca(e,a),(a&62914560)===a&&(t=Mo+500-he(),10<t)){if(Ka(e,0)!==0)break;if(i=e.suspendedLanes,(i&a)!==a){ve(),e.pingedLanes|=e.suspendedLanes&i;break}e.timeoutHandle=vl(Rn.bind(null,e),t);break}Rn(e);break;case 4:if(ca(e,a),(a&4186112)===a)break;for(t=e.eventTimes,i=-1;0<a;){var o=31-en(a);r=1<<o,o=t[o],o>i&&(i=o),a&=~r}if(a=i,a=he()-a,a=(120>a?120:480>a?480:1080>a?1080:1920>a?1920:3e3>a?3e3:4320>a?4320:1960*fh(a/1960))-a,10<a){e.timeoutHandle=vl(Rn.bind(null,e),a);break}Rn(e);break;case 5:Rn(e);break;default:throw Error(T(329))}}return Ge(e,he()),e.callbackNode===n?Uu.bind(null,e):null}function ca(e,n){for(n&=~No,n&=~da,e.suspendedLanes|=n,e.pingedLanes&=~n,e=e.expirationTimes;0<n;){var a=31-en(n),t=1<<a;e[a]=-1,n&=~t}}function Uo(e){if((L&48)!=0)throw Error(T(327));if(fn(),e===pe&&(e.expiredLanes&me)!=0){var n=me,a=gt(e,n);(ha&da)!=0&&(n=Ka(e,n),a=gt(e,n))}else n=Ka(e,0),a=gt(e,n);if(e.tag!==0&&a===2&&(L|=64,e.hydrate&&(e.hydrate=!1,Fr(e.containerInfo)),n=Vs(e),n!==0&&(a=gt(e,n))),a===1)throw a=Ii,ma(e,0),ca(e,n),Ge(e,he()),a;return e.finishedWork=e.current.alternate,e.finishedLanes=n,Rn(e),Ge(e,he()),null}function Sh(){if(je!==null){var e=je;je=null,e.forEach(function(n){n.expiredLanes|=24&n.pendingLanes,Ge(n,he())})}De()}function Pu(e,n){var a=L;L|=1;try{return e(n)}finally{L=a,L===0&&(ga(),De())}}function Fu(e,n){var a=L;L&=-2,L|=8;try{return e(n)}finally{L=a,L===0&&(ga(),De())}}function pi(e,n){q(Oo,Wn),Wn|=n,ha|=n}function yo(){Wn=Oo.current,Q(Oo)}function ma(e,n){e.finishedWork=null,e.finishedLanes=0;var a=e.timeoutHandle;if(a!==-1&&(e.timeoutHandle=-1,Qc(a)),te!==null)for(a=te.return;a!==null;){var t=a;switch(t.tag){case 1:t=t.type.childContextTypes,t!=null&&qt();break;case 3:la(),Q(ye),Q(ce),to();break;case 5:eo(t);break;case 4:la();break;case 13:Q(Z);break;case 19:Q(Z);break;case 10:Qr(t);break;case 23:case 24:yo()}a=a.return}pe=e,te=cn(e.current,null),me=Wn=ha=n,de=0,Ii=null,No=da=qa=0}function Du(e,n){do{var a=te;try{if(_r(),at.current=hi,ci){for(var t=X.memoizedState;t!==null;){var i=t.queue;i!==null&&(i.pending=null),t=t.next}ci=!1}if(tt=0,ue=ge=X=null,it=!1,Co.current=null,a===null||a.return===null){de=1,Ii=n,te=null;break}e:{var r=e,o=a.return,s=a,l=n;if(n=me,s.flags|=2048,s.firstEffect=s.lastEffect=null,l!==null&&typeof l=="object"&&typeof l.then=="function"){var d=l;if((s.mode&2)==0){var y=s.alternate;y?(s.updateQueue=y.updateQueue,s.memoizedState=y.memoizedState,s.lanes=y.lanes):(s.updateQueue=null,s.memoizedState=null)}var C=(Z.current&1)!=0,S=o;do{var M;if(M=S.tag===13){var W=S.memoizedState;if(W!==null)M=W.dehydrated!==null;else{var N=S.memoizedProps;M=N.fallback===void 0?!1:N.unstable_avoidThisFallback!==!0?!0:!C}}if(M){var h=S.updateQueue;if(h===null){var u=new Set;u.add(d),S.updateQueue=u}else h.add(d);if((S.mode&2)==0){if(S.flags|=64,s.flags|=16384,s.flags&=-2981,s.tag===1)if(s.alternate===null)s.tag=17;else{var c=sn(-1,1);c.tag=2,ln(s,c)}s.lanes|=1;break e}l=void 0,s=n;var m=r.pingCache;if(m===null?(m=r.pingCache=new lh,l=new Set,m.set(d,l)):(l=m.get(d),l===void 0&&(l=new Set,m.set(d,l))),!l.has(s)){l.add(s);var p=kh.bind(null,r,d,s);d.then(p,p)}S.flags|=4096,S.lanes=n;break e}S=S.return}while(S!==null);l=Error((bn(s.type)||"A React component")+` suspended while rendering, but no fallback UI was specified.

Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.`)}de!==5&&(de=2),l=Io(l,s),S=o;do{switch(S.tag){case 3:r=l,S.flags|=4096,n&=-n,S.lanes|=n;var R=Eu(S,r,n);Hl(S,R);break e;case 1:r=l;var v=S.type,G=S.stateNode;if((S.flags&64)==0&&(typeof v.getDerivedStateFromError=="function"||G!==null&&typeof G.componentDidCatch=="function"&&(Ke===null||!Ke.has(G)))){S.flags|=4096,n&=-n,S.lanes|=n;var D=vu(S,r,n);Hl(S,D);break e}}S=S.return}while(S!==null)}Ku(a)}catch(U){n=U,te===a&&a!==null&&(te=a=a.return);continue}break}while(1)}function Lu(){var e=yi.current;return yi.current=hi,e===null?hi:e}function gt(e,n){var a=L;L|=16;var t=Lu();pe===e&&me===n||ma(e,n);do try{yh();break}catch(i){Du(e,i)}while(1);if(_r(),L=a,yi.current=t,te!==null)throw Error(T(261));return pe=null,me=0,de}function yh(){for(;te!==null;)Hu(te)}function ph(){for(;te!==null&&!Zc();)Hu(te)}function Hu(e){var n=bu(e.alternate,e,Wn);e.memoizedProps=e.pendingProps,n===null?Ku(e):te=n,Co.current=null}function Ku(e){var n=e;do{var a=n.alternate;if(e=n.return,(n.flags&2048)==0){if(a=oh(a,n,Wn),a!==null){te=a;return}if(a=n,a.tag!==24&&a.tag!==23||a.memoizedState===null||(Wn&1073741824)!=0||(a.mode&4)==0){for(var t=0,i=a.child;i!==null;)t|=i.lanes|i.childLanes,i=i.sibling;a.childLanes=t}e!==null&&(e.flags&2048)==0&&(e.firstEffect===null&&(e.firstEffect=n.firstEffect),n.lastEffect!==null&&(e.lastEffect!==null&&(e.lastEffect.nextEffect=n.firstEffect),e.lastEffect=n.lastEffect),1<n.flags&&(e.lastEffect!==null?e.lastEffect.nextEffect=n:e.firstEffect=n,e.lastEffect=n))}else{if(a=sh(n),a!==null){a.flags&=2047,te=a;return}e!==null&&(e.firstEffect=e.lastEffect=null,e.flags|=2048)}if(n=n.sibling,n!==null){te=n;return}te=n=e}while(n!==null);de===0&&(de=5)}function Rn(e){var n=ia();return On(99,Ih.bind(null,e,n)),null}function Ih(e,n){do fn();while(ut!==null);if((L&48)!=0)throw Error(T(327));var a=e.finishedWork;if(a===null)return null;if(e.finishedWork=null,e.finishedLanes=0,a===e.current)throw Error(T(177));e.callbackNode=null;var t=a.lanes|a.childLanes,i=t,r=e.pendingLanes&~i;e.pendingLanes=i,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=i,e.mutableReadLanes&=i,e.entangledLanes&=i,i=e.entanglements;for(var o=e.eventTimes,s=e.expirationTimes;0<r;){var l=31-en(r),d=1<<l;i[l]=0,o[l]=-1,s[l]=-1,r&=~d}if(je!==null&&(t&24)==0&&je.has(e)&&je.delete(e),e===pe&&(te=pe=null,me=0),1<a.flags?a.lastEffect!==null?(a.lastEffect.nextEffect=a,t=a.firstEffect):t=a:t=a.firstEffect,t!==null){if(i=L,L|=32,Co.current=null,Dr=Ft,o=hl(),Br(o)){if("selectionStart"in o)s={start:o.selectionStart,end:o.selectionEnd};else e:if(s=(s=o.ownerDocument)&&s.defaultView||window,(d=s.getSelection&&s.getSelection())&&d.rangeCount!==0){s=d.anchorNode,r=d.anchorOffset,l=d.focusNode,d=d.focusOffset;try{s.nodeType,l.nodeType}catch(U){s=null;break e}var y=0,C=-1,S=-1,M=0,W=0,N=o,h=null;n:for(;;){for(var u;N!==s||r!==0&&N.nodeType!==3||(C=y+r),N!==l||d!==0&&N.nodeType!==3||(S=y+d),N.nodeType===3&&(y+=N.nodeValue.length),(u=N.firstChild)!==null;)h=N,N=u;for(;;){if(N===o)break n;if(h===s&&++M===r&&(C=y),h===l&&++W===d&&(S=y),(u=N.nextSibling)!==null)break;N=h,h=N.parentNode}N=u}s=C===-1||S===-1?null:{start:C,end:S}}else s=null;s=s||{start:0,end:0}}else s=null;Lr={focusedElem:o,selectionRange:s},Ft=!1,ht=null,Ei=!1,O=t;do try{Th()}catch(U){if(O===null)throw Error(T(330));gn(O,U),O=O.nextEffect}while(O!==null);ht=null,O=t;do try{for(o=e;O!==null;){var c=O.flags;if(c&16&&Na(O.stateNode,""),c&128){var m=O.alternate;if(m!==null){var p=m.ref;p!==null&&(typeof p=="function"?p(null):p.current=null)}}switch(c&1038){case 2:Wu(O),O.flags&=-3;break;case 6:Wu(O),O.flags&=-3,wo(O.alternate,O);break;case 1024:O.flags&=-1025;break;case 1028:O.flags&=-1025,wo(O.alternate,O);break;case 4:wo(O.alternate,O);break;case 8:s=O,Ou(o,s);var R=s.alternate;Gu(s),R!==null&&Gu(R)}O=O.nextEffect}}catch(U){if(O===null)throw Error(T(330));gn(O,U),O=O.nextEffect}while(O!==null);if(p=Lr,m=hl(),c=p.focusedElem,o=p.selectionRange,m!==c&&c&&c.ownerDocument&&cl(c.ownerDocument.documentElement,c)){for(o!==null&&Br(c)&&(m=o.start,p=o.end,p===void 0&&(p=m),"selectionStart"in c?(c.selectionStart=m,c.selectionEnd=Math.min(p,c.value.length)):(p=(m=c.ownerDocument||document)&&m.defaultView||window,p.getSelection&&(p=p.getSelection(),s=c.textContent.length,R=Math.min(o.start,s),o=o.end===void 0?R:Math.min(o.end,s),!p.extend&&R>o&&(s=o,o=R,R=s),s=dl(c,R),r=dl(c,o),s&&r&&(p.rangeCount!==1||p.anchorNode!==s.node||p.anchorOffset!==s.offset||p.focusNode!==r.node||p.focusOffset!==r.offset)&&(m=m.createRange(),m.setStart(s.node,s.offset),p.removeAllRanges(),R>o?(p.addRange(m),p.extend(r.node,r.offset)):(m.setEnd(r.node,r.offset),p.addRange(m)))))),m=[],p=c;p=p.parentNode;)p.nodeType===1&&m.push({element:p,left:p.scrollLeft,top:p.scrollTop});for(typeof c.focus=="function"&&c.focus(),c=0;c<m.length;c++)p=m[c],p.element.scrollLeft=p.left,p.element.scrollTop=p.top}Ft=!!Dr,Lr=Dr=null,e.current=a,O=t;do try{for(c=e;O!==null;){var v=O.flags;if(v&36&&hh(c,O.alternate,O),v&128){m=void 0;var G=O.ref;if(G!==null){var D=O.stateNode;switch(O.tag){case 5:m=D;break;default:m=D}typeof G=="function"?G(m):G.current=m}}O=O.nextEffect}}catch(U){if(O===null)throw Error(T(330));gn(O,U),O=O.nextEffect}while(O!==null);O=null,$c(),L=i}else e.current=a;if(mn)mn=!1,ut=e,dt=n;else for(O=t;O!==null;)n=O.nextEffect,O.nextEffect=null,O.flags&8&&(v=O,v.sibling=null,v.stateNode=null),O=n;if(t=e.pendingLanes,t===0&&(Ke=null),t===1?e===Ro?ct++:(ct=0,Ro=e):ct=0,a=a.stateNode,Cn&&typeof Cn.onCommitFiberRoot=="function")try{Cn.onCommitFiberRoot(br,a,void 0,(a.current.flags&64)==64)}catch(U){}if(Ge(e,he()),ki)throw ki=!1,e=Ao,Ao=null,e;return(L&8)!=0||De(),null}function Th(){for(;O!==null;){var e=O.alternate;Ei||ht===null||((O.flags&8)!=0?Bs(O,ht)&&(Ei=!0):O.tag===13&&mh(e,O)&&Bs(O,ht)&&(Ei=!0));var n=O.flags;(n&256)!=0&&dh(e,O),(n&512)==0||mn||(mn=!0,Ja(97,function(){return fn(),null})),O=O.nextEffect}}function fn(){if(dt!==90){var e=97<dt?97:dt;return dt=90,On(e,Ah)}return!1}function ch(e,n){Bo.push(n,e),mn||(mn=!0,Ja(97,function(){return fn(),null}))}function wu(e,n){Wo.push(n,e),mn||(mn=!0,Ja(97,function(){return fn(),null}))}function Ah(){if(ut===null)return!1;var e=ut;if(ut=null,(L&48)!=0)throw Error(T(331));var n=L;L|=32;var a=Wo;Wo=[];for(var t=0;t<a.length;t+=2){var i=a[t],r=a[t+1],o=i.destroy;if(i.destroy=void 0,typeof o=="function")try{o()}catch(l){if(r===null)throw Error(T(330));gn(r,l)}}for(a=Bo,Bo=[],t=0;t<a.length;t+=2){i=a[t],r=a[t+1];try{var s=i.create;i.destroy=s()}catch(l){if(r===null)throw Error(T(330));gn(r,l)}}for(s=e.current.firstEffect;s!==null;)e=s.nextEffect,s.nextEffect=null,s.flags&8&&(s.sibling=null,s.stateNode=null),s=e;return L=n,De(),!0}function xu(e,n,a){n=Io(a,n),n=Eu(e,n,1),ln(e,n),n=ve(),e=vi(e,1),e!==null&&(Pt(e,1,n),Ge(e,n))}function gn(e,n){if(e.tag===3)xu(e,e,n);else for(var a=e.return;a!==null;){if(a.tag===3){xu(a,e,n);break}else if(a.tag===1){var t=a.stateNode;if(typeof a.type.getDerivedStateFromError=="function"||typeof t.componentDidCatch=="function"&&(Ke===null||!Ke.has(t))){e=Io(n,e);var i=vu(a,e,1);if(ln(a,i),i=ve(),a=vi(a,1),a!==null)Pt(a,1,i),Ge(a,i);else if(typeof t.componentDidCatch=="function"&&(Ke===null||!Ke.has(t)))try{t.componentDidCatch(n,e)}catch(r){}break}}a=a.return}}function kh(e,n,a){var t=e.pingCache;t!==null&&t.delete(n),n=ve(),e.pingedLanes|=e.suspendedLanes&a,pe===e&&(me&a)===a&&(de===4||de===3&&(me&62914560)===me&&500>he()-Mo?ma(e,0):No|=a),Ge(e,n)}function gh(e,n){var a=e.stateNode;a!==null&&a.delete(n),n=0,n===0&&(n=e.mode,(n&2)==0?n=1:(n&4)==0?n=ia()===99?1:2:(Ve===0&&(Ve=ha),n=Qn(62914560&~Ve),n===0&&(n=4194304))),a=ve(),e=vi(e,n),e!==null&&(Pt(e,n,a),Ge(e,a))}var bu;bu=function(e,n,a){var t=n.lanes;if(e!==null)if(e.memoizedProps!==n.pendingProps||ye.current)Re=!0;else if((a&t)!=0)Re=(e.flags&16384)!=0;else{switch(Re=!1,n.tag){case 3:gu(n),ao();break;case 5:Ql(n);break;case 1:Ie(n.type)&&Zt(n);break;case 4:$r(n,n.stateNode.containerInfo);break;case 10:t=n.memoizedProps.value;var i=n.type._context;q(ei,i._currentValue),i._currentValue=t;break;case 13:if(n.memoizedState!==null)return(a&n.child.childLanes)!=0?Su(e,n,a):(q(Z,Z.current&1),n=Ye(e,n,a),n!==null?n.sibling:null);q(Z,Z.current&1);break;case 19:if(t=(a&n.childLanes)!=0,(e.flags&64)!=0){if(t)return yu(e,n,a);n.flags|=64}if(i=n.memoizedState,i!==null&&(i.rendering=null,i.tail=null,i.lastEffect=null),q(Z,Z.current),t)break;return null;case 23:case 24:return n.lanes=0,go(e,n,a)}return Ye(e,n,a)}else Re=!1;switch(n.lanes=0,n.tag){case 2:if(t=n.type,e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,i=ta(n,ce.current),oa(n,a),i=ro(null,n,t,e,i,a),n.flags|=1,typeof i=="object"&&i!==null&&typeof i.render=="function"&&i.$$typeof===void 0){if(n.tag=1,n.memoizedState=null,n.updateQueue=null,Ie(t)){var r=!0;Zt(n)}else r=!1;n.memoizedState=i.state!==null&&i.state!==void 0?i.state:null,Jr(n);var o=t.getDerivedStateFromProps;typeof o=="function"&&ti(n,t,o,e),i.updater=ii,n.stateNode=i,i._reactInternals=n,qr(n,t,e,a),n=mo(null,n,t,!0,r,a)}else n.tag=0,Ae(null,n,i,a),n=n.child;return n;case 16:i=n.elementType;e:{switch(e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,r=i._init,i=r(i._payload),n.type=i,r=n.tag=Eh(i),e=We(i,e),r){case 0:n=ho(null,n,i,e,a);break e;case 1:n=hu(null,n,i,e,a);break e;case 11:n=lu(null,n,i,e,a);break e;case 14:n=du(null,n,i,We(i.type,e),t,a);break e}throw Error(T(306,i,""))}return n;case 0:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:We(t,i),ho(e,n,t,i,a);case 1:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:We(t,i),hu(e,n,t,i,a);case 3:if(gu(n),t=n.updateQueue,e===null||t===null)throw Error(T(282));if(t=n.pendingProps,i=n.memoizedState,i=i!==null?i.element:null,Kl(e,n),Za(n,t,null,a),t=n.memoizedState.element,t===i)ao(),n=Ye(e,n,a);else{if(i=n.stateNode,(r=i.hydrate)&&(hn=na(n.stateNode.containerInfo.firstChild),xe=n,r=Pe=!0),r){if(e=i.mutableSourceEagerHydrationData,e!=null)for(i=0;i<e.length;i+=2)r=e[i],r._workInProgressVersionPrimary=e[i+1],ua.push(r);for(a=_l(n,null,t,a),n.child=a;a;)a.flags=a.flags&-3|1024,a=a.sibling}else Ae(e,n,t,a),ao();n=n.child}return n;case 5:return Ql(n),e===null&&no(n),t=n.type,i=n.pendingProps,r=e!==null?e.memoizedProps:null,o=i.children,Pr(t,i)?o=null:r!==null&&Pr(t,r)&&(n.flags|=16),cu(e,n),Ae(e,n,o,a),n.child;case 6:return e===null&&no(n),null;case 13:return Su(e,n,a);case 4:return $r(n,n.stateNode.containerInfo),t=n.pendingProps,e===null?n.child=li(n,null,t,a):Ae(e,n,t,a),n.child;case 11:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:We(t,i),lu(e,n,t,i,a);case 7:return Ae(e,n,n.pendingProps,a),n.child;case 8:return Ae(e,n,n.pendingProps.children,a),n.child;case 12:return Ae(e,n,n.pendingProps.children,a),n.child;case 10:e:{t=n.type._context,i=n.pendingProps,o=n.memoizedProps,r=i.value;var s=n.type._context;if(q(ei,s._currentValue),s._currentValue=r,o!==null)if(s=o.value,r=we(s,r)?0:(typeof t._calculateChangedBits=="function"?t._calculateChangedBits(s,r):1073741823)|0,r===0){if(o.children===i.children&&!ye.current){n=Ye(e,n,a);break e}}else for(s=n.child,s!==null&&(s.return=n);s!==null;){var l=s.dependencies;if(l!==null){o=s.child;for(var d=l.firstContext;d!==null;){if(d.context===t&&(d.observedBits&r)!=0){s.tag===1&&(d=sn(-1,a&-a),d.tag=2,ln(s,d)),s.lanes|=a,d=s.alternate,d!==null&&(d.lanes|=a),Fl(s.return,a),l.lanes|=a;break}d=d.next}}else o=s.tag===10&&s.type===n.type?null:s.child;if(o!==null)o.return=s;else for(o=s;o!==null;){if(o===n){o=null;break}if(s=o.sibling,s!==null){s.return=o.return,o=s;break}o=o.return}s=o}Ae(e,n,i.children,a),n=n.child}return n;case 9:return i=n.type,r=n.pendingProps,t=r.children,oa(n,a),i=Ce(i,r.unstable_observedBits),t=t(i),n.flags|=1,Ae(e,n,t,a),n.child;case 14:return i=n.type,r=We(i,n.pendingProps),r=We(i.type,r),du(e,n,i,r,t,a);case 15:return uu(e,n,n.type,n.pendingProps,t,a);case 17:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:We(t,i),e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),n.tag=1,Ie(t)?(e=!0,Zt(n)):e=!1,oa(n,a),jl(n,t,i),qr(n,t,i,a),mo(null,n,t,!0,e,a);case 19:return yu(e,n,a);case 23:return go(e,n,a);case 24:return go(e,n,a)}throw Error(T(156,n.tag))};function vh(e,n,a,t){this.tag=e,this.key=a,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=n,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=t,this.flags=0,this.lastEffect=this.firstEffect=this.nextEffect=null,this.childLanes=this.lanes=0,this.alternate=null}function Oe(e,n,a,t){return new vh(e,n,a,t)}function co(e){return e=e.prototype,!(!e||!e.isReactComponent)}function Eh(e){if(typeof e=="function")return co(e)?1:0;if(e!=null){if(e=e.$$typeof,e===Et)return 11;if(e===Mt)return 14}return 2}function cn(e,n){var a=e.alternate;return a===null?(a=Oe(e.tag,n,e.key,e.mode),a.elementType=e.elementType,a.type=e.type,a.stateNode=e.stateNode,a.alternate=e,e.alternate=a):(a.pendingProps=n,a.type=e.type,a.flags=0,a.nextEffect=null,a.firstEffect=null,a.lastEffect=null),a.childLanes=e.childLanes,a.lanes=e.lanes,a.child=e.child,a.memoizedProps=e.memoizedProps,a.memoizedState=e.memoizedState,a.updateQueue=e.updateQueue,n=e.dependencies,a.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext},a.sibling=e.sibling,a.index=e.index,a.ref=e.ref,a}function si(e,n,a,t,i,r){var o=2;if(t=e,typeof e=="function")co(e)&&(o=1);else if(typeof e=="string")o=5;else e:switch(e){case Je:return sa(a.children,i,r,n);case us:o=8,i|=16;break;case bi:o=8,i|=1;break;case Ma:return e=Oe(12,a,n,i|8),e.elementType=Ma,e.type=Ma,e.lanes=r,e;case wa:return e=Oe(13,a,n,i),e.type=wa,e.elementType=wa,e.lanes=r,e;case vt:return e=Oe(19,a,n,i),e.elementType=vt,e.lanes=r,e;case _i:return fo(a,i,r,n);case Qi:return e=Oe(24,a,n,i),e.elementType=Qi,e.lanes=r,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case xi:o=10;break e;case Yi:o=9;break e;case Et:o=11;break e;case Mt:o=14;break e;case ji:o=16,t=null;break e;case Vi:o=22;break e}throw Error(T(130,e==null?e:typeof e,""))}return n=Oe(o,a,n,i),n.elementType=e,n.type=t,n.lanes=r,n}function sa(e,n,a,t){return e=Oe(7,e,t,n),e.lanes=a,e}function fo(e,n,a,t){return e=Oe(23,e,t,n),e.elementType=_i,e.lanes=a,e}function Zr(e,n,a){return e=Oe(6,e,null,n),e.lanes=a,e}function Xr(e,n,a){return n=Oe(4,e.children!==null?e.children:[],e.key,n),n.lanes=a,n.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},n}function Mh(e,n,a){this.tag=n,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.pendingContext=this.context=null,this.hydrate=a,this.callbackNode=null,this.callbackPriority=0,this.eventTimes=Tr(0),this.expirationTimes=Tr(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Tr(0),this.mutableSourceEagerHydrationData=null}function wh(e,n,a){var t=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:An,key:t==null?null:""+t,children:e,containerInfo:n,implementation:a}}function Mi(e,n,a,t){var i=n.current,r=ve(),o=un(i);e:if(a){a=a._reactInternals;n:{if(vn(a)!==a||a.tag!==1)throw Error(T(170));var s=a;do{switch(s.tag){case 3:s=s.stateNode.context;break n;case 1:if(Ie(s.type)){s=s.stateNode.__reactInternalMemoizedMergedChildContext;break n}}s=s.return}while(s!==null);throw Error(T(171))}if(a.tag===1){var l=a.type;if(Ie(l)){a=Ol(a,l,s);break e}}a=s}else a=rn;return n.context===null?n.context=a:n.pendingContext=a,n=sn(r,o),n.payload={element:e},t=t===void 0?null:t,t!==null&&(n.callback=t),ln(i,n),dn(i,o,r),o}function Do(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function Yu(e,n){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var a=e.retryLane;e.retryLane=a!==0&&a<n?a:n}}function Lo(e,n){Yu(e,n),(e=e.alternate)&&Yu(e,n)}function Ch(){return null}function Po(e,n,a){var t=a!=null&&a.hydrationOptions!=null&&a.hydrationOptions.mutableSources||null;if(a=new Mh(e,n,a!=null&&a.hydrate===!0),n=Oe(3,null,null,n===2?7:n===1?3:0),a.current=n,n.stateNode=a,Jr(n),e[ea]=a.current,Tl(e.nodeType===8?e.parentNode:e),t)for(e=0;e<t.length;e++){n=t[e];var i=n._getVersion;i=i(n._source),a.mutableSourceEagerHydrationData==null?a.mutableSourceEagerHydrationData=[n,i]:a.mutableSourceEagerHydrationData.push(n,i)}this._internalRoot=a}Po.prototype.render=function(e){Mi(e,this._internalRoot,null,null)};Po.prototype.unmount=function(){var e=this._internalRoot,n=e.containerInfo;Mi(null,e,null,function(){n[ea]=null})};function mt(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function Oh(e,n){if(n||(n=e?e.nodeType===9?e.documentElement:e.firstChild:null,n=!(!n||n.nodeType!==1||!n.hasAttribute("data-reactroot"))),!n)for(var a;a=e.lastChild;)e.removeChild(a);return new Po(e,0,n?{hydrate:!0}:void 0)}function wi(e,n,a,t,i){var r=a._reactRootContainer;if(r){var o=r._internalRoot;if(typeof i=="function"){var s=i;i=function(){var d=Do(o);s.call(d)}}Mi(n,o,e,i)}else{if(r=a._reactRootContainer=Oh(a,t),o=r._internalRoot,typeof i=="function"){var l=i;i=function(){var d=Do(o);l.call(d)}}Fu(function(){Mi(n,o,e,i)})}return Do(o)}Ws=function(e){if(e.tag===13){var n=ve();dn(e,4,n),Lo(e,4)}};mr=function(e){if(e.tag===13){var n=ve();dn(e,67108864,n),Lo(e,67108864)}};Rs=function(e){if(e.tag===13){var n=ve(),a=un(e);dn(e,a,n),Lo(e,a)}};Us=function(e,n){return n()};sr=function(e,n,a){switch(n){case"input":if($i(e,a),n=a.name,a.type==="radio"&&n!=null){for(a=e;a.parentNode;)a=a.parentNode;for(a=a.querySelectorAll("input[name="+JSON.stringify(""+n)+'][type="radio"]'),n=0;n<a.length;n++){var t=a[n];if(t!==e&&t.form===e.form){var i=Gt(t);if(!i)throw Error(T(90));hs(t),$i(t,i)}}}break;case"textarea":Ss(e,a);break;case"select":n=a.value,n!=null&&xn(e,!!a.multiple,n,!1)}};lr=Pu;ws=function(e,n,a,t,i){var r=L;L|=4;try{return On(98,e.bind(null,n,a,t,i))}finally{L=r,L===0&&(ga(),De())}};ur=function(){(L&49)==0&&(Sh(),fn())};Cs=function(e,n){var a=L;L|=2;try{return e(n)}finally{L=a,L===0&&(ga(),De())}};function ju(e,n){var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!mt(n))throw Error(T(200));return wh(e,n,null,a)}var Nh={Events:[Ba,Zn,Gt,vs,Ms,fn,{current:!1}]},ft={findFiberByHostInstance:Mn,bundleType:0,version:"17.0.2",rendererPackageName:"react-dom"},Gh={bundleType:ft.bundleType,version:ft.version,rendererPackageName:ft.rendererPackageName,rendererConfig:ft.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:Tn.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=Gs(e),e===null?null:e.stateNode},findFiberByHostInstance:ft.findFiberByHostInstance||Ch,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__!="undefined"&&(pt=__REACT_DEVTOOLS_GLOBAL_HOOK__,!pt.isDisabled&&pt.supportsFiber))try{br=pt.inject(Gh),Cn=pt}catch(e){}var pt,Bh=Nh,Wh=ju,Rh=function(e){if(e==null)return null;if(e.nodeType===1)return e;var n=e._reactInternals;if(n===void 0)throw typeof e.render=="function"?Error(T(188)):Error(T(268,Object.keys(e)));return e=Gs(n),e=e===null?null:e.stateNode,e},Uh=function(e,n){var a=L;if((a&48)!=0)return e(n);L|=1;try{if(e)return On(99,e.bind(null,n))}finally{L=a,De()}},Dh=function(e,n,a){if(!mt(n))throw Error(T(200));return wi(null,e,n,!0,a)},Lh=function(e,n,a){if(!mt(n))throw Error(T(200));return wi(null,e,n,!1,a)},Ph=function(e){if(!mt(e))throw Error(T(40));return e._reactRootContainer?(Fu(function(){wi(null,null,e,!1,function(){e._reactRootContainer=null,e[ea]=null})}),!0):!1},Fh=Pu,Kh=function(e,n){return ju(e,n,2<arguments.length&&arguments[2]!==void 0?arguments[2]:null)},Hh=function(e,n,a,t){if(!mt(a))throw Error(T(200));if(e==null||e._reactInternals===void 0)throw Error(T(38));return wi(e,n,a,!1,t)},bh="17.0.2",xh={__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:Bh,createPortal:Wh,findDOMNode:Rh,flushSync:Uh,hydrate:Dh,render:Lh,unmountComponentAtNode:Ph,unstable_batchedUpdates:Fh,unstable_createPortal:Kh,unstable_renderSubtreeIntoContainer:Hh,version:bh},Yh=Qe(function(e){function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__=="undefined"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(a){console.error(a)}}n(),e.exports=xh}),Fo=Yh.render;var Ko=Symbol(),Ho=Symbol(),bo=Symbol(),Ci=Symbol();function Un(e,n){function a(...t){if(t.length>=e.length)return e(...t);{let i=(...r)=>a(...t,...r);return i[Ko]=e,i[Ho]=a,i[bo]=t,i[Ci]=a[Ci],i}}return a[Ko]=e,a[Ho]=a,a[bo]=[],a[Ci]=n||Vu(e),a}function xo(e){return e[Ko]}function jh(e){return e[Ho]}function Oi(e){return e[bo]||[]}function Vu(e){return e[Ci]||e.name}function zh(){let e=[];return{test:n,getAllTests:a};function n(t,i){e.push(...Object.entries(i).map(([r,o])=>Vh(t,r,o)))}function a(){return e}}function f(e,n,...a){let t=n(...a,e);if(typeof t=="function")throw new Error("The matcher function `"+Yo(t)+"` returned a function instead of a boolean. You might need to pass another argument to it.");if(!t)throw new Ni([e,n,...a])}function Vh(e,n,a){return{subject:e,scenario:n,fn:a}}var Ni=class extends Error{constructor(n){super("Expectation failed");this.expectArgs=n}};function _h(e){return e[e.length-1]}function zu(e){return e[0]}var Qh=Un(function(e,n){return e(n)},"which"),b=Un(function(e,n){var a,t;if(Jh(e))return e(n);if(Array.isArray(e)&&Array.isArray(n))return e.length===n.length&&e.every((i,r)=>b(e[r],n[r]));if(e instanceof Function&&n instanceof Function)return xo(e)&&xo(e)===xo(n)?b(Oi(e),Oi(n)):e===n;if(e instanceof Date&&n instanceof Date)return e.toISOString()===n.toISOString();if(e instanceof Set&&n instanceof Set)return e.size===n.size&&[...e.values()].every(i=>n.has(i));if(e instanceof Error&&n instanceof Error)return e.message===n.message&&e.__proto__.constructor===n.__proto__.constructor;if(_u(e)&&_u(n)){let i=Object.keys(e),r=Object.keys(n);return i.length===r.length&&i.every(o=>b(e[o],n[o]))&&((a=e.__proto__)==null?void 0:a.constructor)===((t=n.__proto__)==null?void 0:t.constructor)}return e===n},"equals"),I=Un(function(e,n){return e===n},"is"),jo=Un(function(e,n,...a){return!e(n,...a)},"not"),Qu=Un(function(e){return/^\s*$/.test(e)},"isBlank");function _u(e){return!!e&&typeof e=="object"}function Jh(e){return e instanceof Function&&jh(e)===Qh&&Oi(e).length===1}function Yo(e){return Vu(e)||"<function>"}function qu(e){let n=[];return a(e);function a(l){var d;if(l===null)return"null";if(typeof l=="function")return t(l,i);if(typeof l=="string")return Vo(l);if(typeof l=="bigint")return`${l}n`;if(Array.isArray(l))return t(l,r);if(l instanceof Date)return`Date(${l.toISOString().replace("T"," ").replace("Z"," UTC")})`;if(l instanceof RegExp)return String(l);if(l instanceof Error)return`${Ju(l)}(${Vo(l.message)})`;if(l instanceof Set)return t(l,s);if(typeof l=="object"){let y=(d=l==null?void 0:l.__proto__)==null?void 0:d.constructor;return y===Object||!y?t(l,o):`${Ju(l)} ${t(l,o)}`}return String(l)}function t(l,d){if(n.indexOf(l)>-1)return"<circular reference>";n.push(l);let y=d(l);return n.pop(),y}function i(l){let d=Oi(l).map(a),y=Yo(l);return d.length?St(y+"(",d,",",")"):y}function r(l){return St("[",l.map(a),",","]")}function o(l){let d=Object.entries(l).map(([y,C])=>`${qh(y)}: ${a(C)}`);return St("{",d,",","}")}function s(l){let d=[...l.values()].map(a);return St("Set {",d,",","}")}}function qh(e){return/^[a-zA-Z0-9_$]+$/.test(e)?e:Vo(e)}function Ju(e){return Yo(e.__proto__.constructor)}function Vo(e){return'"'+String(e).replace(/\\/g,"\\\\").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/"/g,'\\"').replace(/[\x00-\x1f\x7f]/g,Zh)+'"'}function Zh(e){let n=e.charCodeAt(0).toString(16);return"\\x"+(n.length<2?"0"+n:n)}function Gi(e,n){return n.split(`
`).map(a=>a&&$h(Xh(e," "))(a)).join(`
`)}function Xh(e,n){return Array(e+1).join(n)}var $h=e=>n=>e+n,eg=Un(function(n,a){return a.slice(0,n.length)===n?a.slice(n.length):a});function ng(e){return String(e).split(/\r?\n/)}function ag(e){let n=ng(e);Qu(zu(n))&&n.shift(),Qu(_h(n))&&n.pop();let a=/^[ \t]*/.exec(zu(n))[0];return n.map(eg(a)).join(`
`)}function St(e,n,a,t){return n.length<2?e+n.join("")+t:e+`
`+Gi(2,n.join(a+`
`))+`
`+t}function Xu(e){return At(this,null,function*(){let n=[];for(let a of e){let t=yield tg(a.fn),i=Zu.map(r=>({type:"debug",args:r}));Zu.length=0,n.push({test:a,error:t,instrumentLog:i})}return{results:n}})}function tg(e){let n;try{let a=e();if(a instanceof Promise)return new Promise(t=>{a.then(()=>t()).catch(t)})}catch(a){n=a}return Promise.resolve(n)}var Zu=[],Pm=Un(function(n,a){return a instanceof Ni&&b(n,a.expectArgs)}),Bi=`

`;function $u({results:e}){let n=!1,a=!1,t=[];for(let i of e){let r=!1;i.error&&(r=n=!0),i.instrumentLog.length&&(r=a=!0),r&&t.push(i)}return n?ig(t):a?og(e.length,t):rg(e.length)}function ig(e){return e.map(ed).join(Bi)+Bi+"Tests failed."}function rg(e){switch(e){case 0:return"No tests to run.";case 1:return"One test ran, and found no issues.";default:return`${e} tests ran, and found no issues.`}}function og(e,n){return n.map(ed).join(Bi)+Bi+sg(e)+`, but debugging instrumentation is present.
Remove it before shipping.`}function sg(e){switch(e){case 1:return"The test passed";case 2:return"Both tests passed";default:return`All ${e} tests passed`}}function ed({test:e,error:n,instrumentLog:a}){let i=[e.subject+" "+e.scenario];return a.length&&i.push(Gi(2,ug(a))),n&&i.push(Gi(2,lg(n))),i.join(`
`)}function lg(e){return e instanceof Ni?dg(e):cg(e)}function ug(e){return e.map(({args:n})=>nd("debug",n)).join("")}function dg(e){return nd("expect",e.expectArgs)}function cg(e){return qu(e)+" thrown"+Gi(2,hg(e.stack))}function nd(e,n){return St(e+"(",n.map(qu),",",")")}function hg(e){if(!e)return"";let n=ag(e).split(`
`);return`
`+n.slice(0,gg(n)).map(a=>a.replace(/(file:\/\/|http:\/\/[^/]*)/,"").replace(/^([^@]*)@(.*)$/,"at $1 ($2)")).join(`
`)}function gg(e){let n=e.findIndex(a=>a.includes("errorFrom"));return n===-1?e.length:n}var Fm=Object.freeze({test:{subject:"a thing",scenario:"does something",fn(){}},error:void 0,instrumentLog:[]}),mg=zh(),{getAllTests:ad}=mg;function z(...e){}function pn(){return(+new Date%1e6/1e3).toFixed(3)}function Y(e,n=0){return isNaN(e)||e===Infinity||e===-Infinity?"--:--":e<0?"-"+td(-e,n):td(e,n)}function td(e,n){function a(o,s=fg){return(o<10?"0":"")+s(o)}let t=Math.floor(e/3600),i=Math.floor(e%3600/60),r=e%60;return t>0?`${t}:${a(i)}:${a(r,id(n))}`:`${i}:${a(r,id(n))}`}function ze(e){let[n,a]=(()=>{switch(!0){case e>86400:return["days",e/86400];case e>3600:return["hours",e/3600];case e>60:return["minutes",e/60];default:return["seconds",e]}})();return`${a.toFixed(1)} ${n}`}z("hoursMinutesSeconds",{"formats NaN"(){f(Y(0/0),I,"--:--")},"formats Infinities"(){f(Y(Infinity),I,"--:--"),f(Y(-Infinity),I,"--:--")},"formats negative numbers"(){f(Y(-1),I,"-0:01"),f(Y(-3661.12,2),I,"-1:01:01.12")},"formats single-digit seconds with leading zero"(){f(Y(0),I,"0:00"),f(Y(1),I,"0:01"),f(Y(9),I,"0:09")},"formats double-digit seconds"(){f(Y(10),I,"0:10"),f(Y(59),I,"0:59")},"formats minutes"(){f(Y(60),I,"1:00"),f(Y(61),I,"1:01"),f(Y(119),I,"1:59"),f(Y(120),I,"2:00"),f(Y(3599),I,"59:59")},"formats hours"(){f(Y(3600),I,"1:00:00"),f(Y(7200),I,"2:00:00"),f(Y(3661),I,"1:01:01"),f(Y(3610),I,"1:00:10"),f(Y(3600+600),I,"1:10:00"),f(Y(36001),I,"10:00:01")},"adds decimal places"(){f(Y(0,0),I,"0:00"),f(Y(0,1),I,"0:00.0"),f(Y(0,2),I,"0:00.00")},"formats fractional seconds"(){f(Y(1.23,2),I,"0:01.23")},"rounds decimals"(){f(Y(2.3456,2),I,"0:02.35")}});z("durationAsWords",{zero(){f(ze(0),I,"0.0 seconds")},"two seconds"(){f(ze(2),I,"2.0 seconds")},"two minutes"(){f(ze(120),I,"2.0 minutes")},"two and a half minutes"(){f(ze(150),I,"2.5 minutes")},"two and a third minutes"(){f(ze(140),I,"2.3 minutes")},"two hours"(){f(ze(7200),I,"2.0 hours")},"two days"(){f(ze(48*3600),I,"2.0 days")}});var fg=e=>e,id=e=>n=>n.toFixed(e);function fa(e){var n;return(n=/v=(.{11})/.exec(e))==null?void 0:n[1]}function rd(){return{getPlayerState(){return re.UNSTARTED},getCurrentTime(){return 0},getVideoUrl(){return""},cueVideoById(){},playVideo(){},seekTo(){},getDuration(){return 0},addEventListener(){},removeEventListener(){}}}function od(e){return{getPlayerState(){return e.getPlayerState()},getCurrentTime(){return e.getCurrentTime()},getVideoUrl(){return e.getVideoUrl()},cueVideoById(...n){return console.debug(pn(),"player.cueVideoById",...n),e.cueVideoById(...n)},playVideo(...n){return console.debug(pn(),"player.playVideo",...n),e.playVideo(...n)},seekTo(...n){return console.debug(pn(),"player.seekTo",...n,fa(e.getVideoUrl())),e.seekTo(...n)},getDuration(){return e.getDuration()},addEventListener(...n){return console.debug(pn(),"player.addEventListener"),e.addEventListener(...n)},removeEventListener(...n){return console.debug(pn(),"player.removeEventListener"),e.removeEventListener(...n)}}}var re={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};function sd(e){return At(this,null,function*(){let n=yield pg();return new Promise(a=>{let t=new n.Player(e,{height:450,width:800,videoId:null,playerVars:{controls:0,disablekb:1},events:{onReady(){a(t)}}})})})}function pg(){return ld?Promise.resolve(window.YT):new Promise(e=>{var n;if(document.querySelector("script[src='https://www.youtube.com/iframe_api']")===null){let a=document.createElement("script");a.src="https://www.youtube.com/iframe_api";let t=document.getElementsByTagName("script")[0];(n=t.parentNode)==null||n.insertBefore(a,t)}zo.push(e)})}var ld=!1,zo=[];window.onYouTubeIframeAPIReady=()=>{ld=!0,zo.forEach(e=>e(window.YT)),zo.length=0};function ud(e,n){let a=Aa(),t=Aa();t.current=e,Kn(()=>(a.current=setInterval(()=>{var i;return(i=t.current)==null?void 0:i.call(t)},n),()=>clearInterval(a.current)),[n])}function dd(){let[e,n]=Be(!1);return[e,()=>n(!0)]}function kt(e){switch(e){case re.BUFFERING:return"buffering";case re.UNSTARTED:return"unstarted";case re.CUED:return"cued";case re.ENDED:return"ended";case re.PLAYING:return"playing";case re.PAUSED:return"paused";default:return""}}function cd(e){return e.channel.getName()+" "+kt(e.code)}function hd(e){return E(Fn,null,e.channels.map(n=>E("button",{key:n.getName(),onClick:()=>e.onChannelSelected(n)},n.getName())))}var _o={};Pn(_o,{episodes:()=>Sg,videos:()=>kg});var Sg=[`# Elif'in Hecesi
...
g8twezOz2h4 0:03 WGBH Boston | Title Card | 2003 | PBS Kids
g8twezOz2h4 0:03 WGBH Boston | Title Card | 2003 | PBS Kids
`;var Qo={};Pn(Qo,{episodes:()=>yg,videos:()=>Ig});var yg=[],Ig=`
# Slow TV
...
`;var Jo={};Pn(Jo,{episodes:()=>Ag,videos:()=>Tg});var Tg="",Ag=["BecZdQvjGrY 54:49 In Gowan Ring - Compendium (Full Album)","B3oAx9VmAdA 43:52 In Gowan Ring - Hazel Steps Through A Weathered Home",`
  ...
  `,"Gf1RHyuuLnI 4:59 Kirsten Bråten Berg - Heiemo og Nykkjen(folkesang)","Tt8p5AxJn18 4:14 Sinéad O'Connor - Mna na h Eireann (Women of Ireland)","HgwypQ_9_DE 4:25 Ripoff Raskolnikov - Azt gondoltam eső esik (Live at Paks)","apE1n63ZhMQ 3:39 Muzsikás: Repülj madár, repülj (Fly Bird, fly) + pics of Hollókő (read the info)","8n5u_IfVLd0 5:45 Cirque Du Soleil O, Gamelan"];var qo={};Pn(qo,{episodes:()=>Eg,videos:()=>vg});var Eg=[],vg=`
if6iWVgR8h4 19:58 Silent Meditations (20 min) | 4 intervals
`;var Zo={};Pn(Zo,{episodes:()=>Mg,videos:()=>wg});var Mg=[`
...
`;var Xo={};Pn(Xo,{episodes:()=>Cg,videos:()=>Og});var Cg=[],Og=`
...
`;var Ng=!1,gd=[["Channel 1",_o],["Channel 2",Qo],["Channel 3",Jo],["Channel 4",qo],["🎄",Zo],Ng?["debug",Xo]:null].filter(Boolean);function md(){let[e,n]=Be(+new Date);return ud(()=>n(+new Date),250),e}function fd(e=""){return{type:"nothing",nextVideoId:e}}function yt(e){try{e()}catch(n){return n}}function pa(e,n){if(e.length===0)throw new Error("can't pick element from an empty array");if(n>=1||n<0)throw new Error("fraction out of bounds: "+n);return e[Math.floor(n*e.length)]}z("pick",{"throws if the array is empty"(){f(yt(()=>pa([],0)),b,new Error("can't pick element from an empty array"))},"throws if the fraction is 1"(){f(yt(()=>pa([""],1)),b,new Error("fraction out of bounds: 1"))},"throws if the fraction is > 1"(){f(yt(()=>pa([""],1.25)),b,new Error("fraction out of bounds: 1.25"))},"throws if the fraction is > 0"(){f(yt(()=>pa([""],-.25)),b,new Error("fraction out of bounds: -0.25"))},"picks the first element of the array given 0"(){f(pa([1,2],0),I,1)},"picks the last element of the array given 1 - epsilon"(){f(pa([1,2],.99),I,2)}});function Wi(e){return e.length===0}function Sa(e,n){let a={};return t=>(t in a||(Object.keys(a).length===e&&(a={}),a[t]=n(t)),a[t])}z("cache",{"caches a value"(){let e=0,n=Sa(1,()=>(e++,123));n("foo"),n("foo"),f(e,I,1)},"computes and caches values by key"(){let e=Sa(2,n=>n+"x");f(e("foo"),I,"foox"),f(e("bar"),I,"barx")},"caches multiple values"(){let e=0,n=Sa(2,a=>(e++,a+"x"));n("foo"),n("foo"),n("bar"),n("bar"),f(e,I,2),f(n("foo"),I,"foox"),f(n("bar"),I,"barx")},"a max size of 0 means no limit"(){let e=0,n=Sa(0,()=>(e++,123));n("a"),n("b"),n("c"),f(e,I,3)}});function It(e){let n=1779033703,a=3144134277,t=1013904242,i=2773480762;for(let r=0,o;r<e.length;r++)o=e.charCodeAt(r),n=a^Math.imul(n^o,597399067),a=t^Math.imul(a^o,2869860233),t=i^Math.imul(t^o,951274213),i=n^Math.imul(i^o,2716044179);return n=Math.imul(t^n>>>18,597399067),a=Math.imul(i^a>>>22,2869860233),t=Math.imul(n^t>>>17,951274213),i=Math.imul(a^i>>>19,2716044179),[(n^a^t^i)>>>0,(a^n)>>>0,(t^n)>>>0,(i^n)>>>0]}z("cyrb128_32",{"hashes unix timestamps to random-looking values"(){f(It("1661673600"),b,[1866196007,1194674827,898714046,497018642]),f(It("1661760000"),b,[3655929289,901600698,732811234,3355023249]),f(It("1661846400"),b,[2165297363,2940322590,3636107238,4143219755])}});function Ri(e,n,a,t){function i(){e|=0,n|=0,a|=0,t|=0;var r=(e+n|0)+t|0;return t=t+1|0,e=n^n>>>9,n=a+(a<<3)|0,a=a<<21|a>>>11,a=a+r|0,(r>>>0)/4294967296}for(let r=0;r<20;r++)i();return i}z("sfc32",{"flips coins fairly"(){let e=0,n=0,a=Ri(0,0,0,0);for(let t=0;t<200;t++)a()<.5?e++:n++;f(e-n,I,-8)},"generates a reasonably uniform distribution of numbers"(){let e=new Set,n=Ri(0,0,0,0);for(let a=0;a<100;a++)e.add(Math.floor(n()*1e4));f(e.size,I,99)}});function $(e,n){let a=-1,t=e.length-1;for(;a<t;){let i=Gg(a,t);n(e[i])?a=i:t=i-1}return e[a]}function Gg(e,n){return Math.ceil((e+n)/2)}z("binarySearch",{"returns undefined given an empty array"(){f($([],()=>!1),I,void 0)},"returns an element that is to the left of the target"(){f($([1],()=>!0),I,1)},"returns undefined when the only element is not left of the target"(){f($([1],()=>!1),I,void 0)},"returns the rightmost element that is left of the target"(){f($([1,2,3,4],e=>e<=2.5),I,2)},"works with duplicates"(){f($([0,1,2,3,0,0,0,0,0],e=>e>0),I,3)},"works with two elements"(){f($([1,2],e=>e<=1.5),I,1),f($([1,2],e=>e<=2),I,2)},"works with three elements"(){f($([1,2,3],e=>e<=1.5),I,1),f($([1,2,3],e=>e<=2),I,2),f($([1,2,3],e=>e<=3),I,3)},"works with four elements"(){f($([1,2,3,4],e=>e<=1.5),I,1),f($([1,2,3,4],e=>e<=2),I,2),f($([1,2,3,4],e=>e<=3),I,3),f($([1,2,3,4],e=>e<=4),I,4)},"works with five elements"(){f($([1,2,3,4,5],e=>e<=1.5),I,1),f($([1,2,3,4,5],e=>e<=2),I,2),f($([1,2,3,4,5],e=>e<=3),I,3),f($([1,2,3,4,5],e=>e<=4),I,4),f($([1,2,3,4,5],e=>e<=5),I,5)}});var Ui=(...e)=>e.reduce(Bg);z("pipe",{"given one function"(){f(Ui(n=>n+1)(1),I,2)},"given two functions"(){let e=n=>n+1;f(Ui(e,e)(1),I,3)}});function Bg(e,n){return(...a)=>n(e(...a))}function pd(e){return n=>n.map(e)}function Sd(e){return e.trim()}function Di({videos:e,episodes:n}){return[...Wg(n),...Me(e).map(Rg)]}var Wg=pd(Ui(Me,kd));function Me(e){return e.split(/\n+/).map(Sd).filter(jo(Ug)).filter(jo(Wi)).map(ka(/ +/,3)).flatMap(([n,a,t])=>a==="SHORTS"?[]:[{videoId:n,segments:Dg(a),title:t}])}function Rg(e){return kd([e])}function kd(e){return{videos:e}}function _e(e){return{start:0,end:e}}function ya(e,n){return{start:e,end:n}}function Ug(e){return e.startsWith("#")}function Dg(e){return e.split(",").map(Lg)}function Lg(e){let n=e.split("-");return n.length===1?_e(Se(n[0])):ya(Se(n[0]),Se(n[1]))}function Se(e){let n=[1,60,3600,86400],a=e.split(":").map(t=>parseInt(t,10)).reverse();return Pg(a,n).map(([t,i])=>t*i).reduce(Fg,0)}var ka=(e,n=Infinity)=>a=>{if(typeof e=="string"&&e.length===0)throw"split(): empty delimiter not supported";let t=0,i=0,r=[],o=a;for(;r.length<n-1&&o.length>0;){let s=o.match(e);if(s==null)break;r.push(o.slice(0,s.index)),o=o.slice(s.index+s[0].length)}return r.push(o),r};function Pg(e,n){let a=[];for(let t=0;t<e.length&&t<n.length;t++)a.push([e[t],n[t]]);return a}function Fg(e,n){return e+n}z("parseVideos",{"handles empty string"(){f(Me(""),b,[])},"ignores spaces"(){f(Me("  "),b,[])},"ignores blank links"(){f(Me(`


`),b,[])},"ignores space-only lines"(){f(Me(` 
 
 
`),b,[])},"strips comments"(){f(Me(`#foo
# bar`),b,[])},"strips spaces before comments"(){f(Me(`  #foo
  # bar`),b,[])},"parses actual data"(){f(Me(`
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
      Ga8tNxnHjt4 3:01 Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971
    `),b,[{videoId:"leb645Xu6uo",segments:[{start:0,end:654}],title:"Captain Murderer - Emlyn Williams"},{videoId:"Ga8tNxnHjt4",segments:[{start:0,end:181}],title:"Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971"}])},"parses time ranges"(){f(Me(`
      leb645Xu6uo 1:01-5:00 The Title
    `),b,[{videoId:"leb645Xu6uo",segments:[{start:61,end:300}],title:"The Title"}])},"parses a video with multiple segments"(){f(Me(`
      leb645Xu6uo 1-3:00,10:00-11:01 The Title
    `),b,[{videoId:"leb645Xu6uo",segments:[{start:1,end:180},{start:600,end:661}],title:"The Title"}])},"removes shorts"(){f(Me(`
      undefined SHORTS blah blah
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
    `),b,[{videoId:"leb645Xu6uo",segments:[{start:0,end:654}],title:"Captain Murderer - Emlyn Williams"}])}});z("parseDuration",{"0:00"(){f(Se("0:00"),I,0)},"00:00"(){f(Se("00:00"),I,0)},"1 second"(){f(Se("0:01"),I,1)},"10 seconds"(){f(Se("0:10"),I,10)},"1 minute"(){f(Se("1:00"),I,60)},"1 minute 10 seconds"(){f(Se("1:10"),I,70)},"10 minutes 10 seconds"(){f(Se("10:10"),I,610)},"1 hour"(){f(Se("1:00:00"),I,3600)},"1 hour 1 second"(){f(Se("1:00:01"),I,3601)},"10 hours 1 second"(){f(Se("10:00:01"),I,36001)},"1 day 1 second"(){f(Se("1:0:00:01"),I,86401)}});z("split",{"empty string"(){f(ka(" ")(""),b,[""])},"no limit"(){f(ka(" ")("a b c"),b,["a","b","c"])},limit(){f(ka(" ",2)("a b c"),b,["a","b c"])},regex(){f(ka(/ +/)("a b   c"),b,["a","b","c"])}});function Li({start:e,end:n}){return n-e}function $o(e){return e.segments.map(Li).reduce(Kg,0)}z("duration",{"is the difference between the segment's start and end"(){f(Li({start:50,end:99}),I,49)}});z("videoDuration",{"is the sum of the segment durations"(){f($o({videoId:"",title:"",segments:[{start:1,end:5},{start:10,end:13}]}),I,7)}});var Kg=(e,n)=>e+n;var Pi=2,yd=24*3600,Id=8*3600;function Ia(e,n){let a=Sa(1,Tt(n)),t=null;return{getBroadcast:i,getTotalDuration:r,getName(){return e}};function i(o){var S;let s=o/1e3,l=(s-Id)%yd,d=s-l,y=a(String(d)),C=$(y,M=>M.startSecondOfDay<=l);return(C==null?void 0:C.type)==="video"?{type:"video",videoId:C.videoId,videoTitle:C.videoTitle,currentTime:l-C.startSecondOfDay+C.startSecondOfVideo}:{type:"nothing",nextVideoId:(S=C==null?void 0:C.nextVideoId)!=null?S:""}}function r(){return t==null&&(t=n.flatMap(bg).map($o).reduce(Hg,0)),t}}var Tt=e=>n=>{if(Wi(e))return[];e=[...e];let a=Ri(...It(n)),t=0,i=[],r=0;for(;t<yd;){r===e.length&&(r=0),xg(e,r,es(r,e.length-1,a));let o=e[r++];for(let s of o.videos){i.push({type:"nothing",startSecondOfDay:t,nextVideoId:s.videoId}),t+=Pi;for(let l of s.segments)i.push({type:"video",videoId:s.videoId,videoTitle:s.title,startSecondOfDay:t,startSecondOfVideo:l.start}),t+=Li(l)}}return i};function xg(e,n,a){let t=e[n];e[n]=e[a],e[a]=t}function es(e,n,a){return e+Math.floor(a()*(n+1-e))}function Hg(e,n){return e+n}function bg(e){return e.videos}z("a Channel",{"broadcasts nothing given no episodes"(){let n=Ia("",[]);f(n.getBroadcast(999),b,{type:"nothing",nextVideoId:""})},"starts a video when it's supposed to start"(){let e=[{videos:[{segments:[ya(1e3,2e3)],videoId:"",title:""}]}],n=Ia("",e),a=(Id+5)*1e3;f(n.getBroadcast(a),b,{type:"video",currentTime:1003,videoId:"",videoTitle:""})},"has a total duration of 0 given no videos"(){let n=Ia("",[]);f(n.getTotalDuration(),I,0)},"sums the durations of its videos"(){let n=Ia("",[{videos:[{segments:[{start:0,end:1}],title:"",videoId:""},{segments:[{start:0,end:2}],title:"",videoId:""}]},{videos:[{segments:[{start:0,end:3}],title:"",videoId:""}]}]);f(n.getTotalDuration(),I,6)}});z("randomIntInRange",{"when low and high are the same"(){f(es(3,3,Math.random),I,3)},"when low and high are 1 apart"(){let e=new Set;for(let n=0;n<30;n++)e.add(es(0,1,Math.random));f(e,b,new Set([0,1]))}});z("ScheduleGenerator",{"schedules a single 24-hour video"(){let e=[{videos:[{segments:[_e(3600*24)],videoId:"the-video-id",title:"the-title"}]}],n=Tt(e);f(n(""),b,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:2,startSecondOfVideo:0}])},"schedules a 12-hour video twice"(){let e=[{videos:[{segments:[_e(3600*12)],videoId:"the-video-id",title:"the-title"}]}],n=Tt(e);f(n(""),b,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:2,startSecondOfVideo:0},{type:"nothing",startSecondOfDay:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:43204,startSecondOfVideo:0}])},"schedules a time window of a video"(){let e=[{videos:[{segments:[ya(3600,3600*13)],videoId:"the-video-id",title:"the-title"}]}],n=Tt(e);f(n(""),b,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:2,startSecondOfVideo:3600},{type:"nothing",startSecondOfDay:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:43204,startSecondOfVideo:3600}])},"picks the videos to show randomly"(){let e=[{videos:[{segments:[_e(3600*2)],videoId:"one",title:""}]},{videos:[{segments:[_e(3600*2)],videoId:"two",title:""}]},{videos:[{segments:[_e(3600*2)],videoId:"three",title:""}]}],n=Tt(e);f(n("asdfx").map(a=>a.videoId).filter(Boolean),b,["three","one","two","three","two","one","one","two","three","two","three","one"])}});function Td(e,n){let{state:a,videoId:t,time:i}=n;if(e.type==="nothing")switch(a){case re.ENDED:case re.CUED:case re.UNSTARTED:return e.nextVideoId?t!==e.nextVideoId?[{type:"cue",videoId:e.nextVideoId,timestamp:0}]:[{type:"seek",timestamp:0},{type:"play"}]:[];default:return[]}else{if(a===re.BUFFERING)return[];let{videoId:r,currentTime:o}=e;if(t!==r)return[{type:"cue",videoId:r,timestamp:o<Pi?0:o}];{let s=[];switch(a){case re.PAUSED:case re.CUED:case re.UNSTARTED:t&&s.push({type:"play"})}return i&&Yg(i,o)>=Pi&&(console.debug("time is off; seeking",i,o),s.push({type:"seek",timestamp:o})),s}}}function Yg(e,n){return Math.abs(e-n)}var jg=0;function Vg(){let[,e]=Be(0);return()=>e(++jg)}function Ad(e){let n=Vg(),a=Aa(rd());return Kn(()=>{sd(e).then(t=>{a.current=t,t.addEventListener("onStateChange",i=>{console.debug(pn(),"player onStateChange",kt(i.data),fa(t.getVideoUrl())),n()}),n()})},[e]),a.current}var Ed="javascript:(function()%7Bfunction%20last(e)%7Breturn%20e%5Be.length-1%5D%7Dvideos%3D%2F%5C%2Fwatch%5C%3F%2F.test(window.location)%3F%5B%2Fv%3D(.%7B11%7D)%2F.exec(window.location)%3F.%5B1%5D%2Clast(document.querySelectorAll(%22.ytp-time-duration%22)).innerText.trim()%2Cdocument.querySelector(%22.title%20.ytd-video-primary-info-renderer%22).innerText.split(%22%5Cn%22)%5B0%5D.trim()%5D.join(%22%20%22)%3A%2F%5C%2Fplaylist%5C%3F%2F.test(window.location)%3F%5B...document.querySelectorAll(%22ytd-playlist-video-renderer%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22a%23video-title%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Ci%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Cn%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bi%7D%20%24%7Bn%7D%60%7D)).join(%22%5Cn%22)%3A%5B...document.querySelectorAll(%22ytd-rich-grid-media%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22%23thumbnail%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Ci%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Cn%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bi%7D%20%24%7Bn%7D%60%7D)).join(%22%5Cn%22)%2Cconsole.log(videos)%2Cnavigator.clipboard.writeText(videos).catch((e%3D%3Econsole.error(e)))%3B%7D)()";function zg({broadcast:e,player:n}){var t;let a=i=>Y(i,2);return{videoLink:e.type==="video"?{text:e.videoTitle,href:"https://youtube.com/watch?v="+e.videoId}:null,actual:{video:(t=n.videoId)!=null?t:"",playerState:kt(n.state),currentTime:n.time!=null?a(n.time):"-"},scheduled:{video:e.type==="video"?e.videoId:"-",playerState:e.type,currentTime:e.type==="video"?a(e.currentTime):"-"},secondsBehindSchedule:e.type==="video"&&n.time!=null?(e.currentTime-n.time).toFixed(2):"-",timeRemainingInVideo:n.duration!=null&&n.time!=null?a(n.duration-n.time):"-"}}function vd(e){let{broadcast:n,player:a,onClose:t}=e,i=zg({broadcast:n,player:a});return E(Fn,null,E("button",{className:"close-button",onClick:t},"close"),E("h1",null,"Culture Machine"),E("p",null,"Made by ",E("a",{href:"https://github.com/benchristel"},"Ben Christel"),"."," ",E("a",{href:"https://github.com/benchristel/tv"},"Source code here"),". Some rights reserved. See the"," ",E("a",{href:"https://www.gnu.org/licenses/gpl-3.0.en.html"},"license"),"."),E("p",null,E("span",{dangerouslySetInnerHTML:{__html:`
          <a href="${Ed}">
            Bookmarklet to scrape videos from YouTube
          </a>
        `}})," ","(",E("a",{href:"https://github.com/benchristel/tv#what-is-a-bookmarklet"},"What's this?"),")"),E("hr",null),E("h2",null,"Video Info"),E("p",{style:{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},"Now playing:"," ",i.videoLink?E("a",{href:i.videoLink.href},i.videoLink.text):"-"),E("table",null,E("thead",null,E("tr",null,E("td",null),E("th",{scope:"col"},"actual"),E("th",{scope:"col"},"scheduled"))),E("tbody",null,E("tr",null,E("th",{scope:"row"},"video"),E("td",null,i.actual.video),E("td",null,i.scheduled.video)),E("tr",null,E("th",{scope:"row"},"player state"),E("td",null,i.actual.playerState),E("td",null,i.scheduled.playerState)),E("tr",null,E("th",{scope:"row"},"current time"),E("td",null,i.actual.currentTime),E("td",null,i.scheduled.currentTime)))),E("p",null,"Seconds behind schedule: ",i.secondsBehindSchedule),E("p",null,"Time remaining in video: ",i.timeRemainingInVideo),E("h2",null,"Channel Stats"),E("table",null,E("thead",null,E("tr",null,E("th",{scope:"col"},"name"),E("th",{scope:"col"},"duration"))),E("tbody",null,e.channels.map(r=>E(_g,{channel:r})))),E("div",{style:{height:60}}))}function _g(e){return E("tr",null,E("td",null,e.channel.getName()),E("td",null,ze(e.channel.getTotalDuration())))}var ns=class extends is{componentDidUpdate(){let{player:n,commands:a}=this.props;a.forEach(t=>{switch(t.type){case"play":n.playVideo();break;case"cue":n.cueVideoById(t.videoId,t.timestamp);break;case"seek":n.seekTo(t.timestamp);break;default:console.error("unexpected video command type",t.type,t)}})}render(){return null}};function Md(e){return{state:e.getPlayerState(),videoId:fa(e.getVideoUrl()),time:e.getCurrentTime(),duration:e.getDuration()}}var as=gd.map(([e,n])=>Ia(e,Di(n)));function wd(){let[e,n]=dd(),[a,t]=Be(!1),[i,r]=Be(as[0]),o=md(),s=e?i.getBroadcast(o):fd(),l=od(Ad("player-container")),d=Md(l),y=d.state,C=y!==re.PLAYING,S=Td(s,d);return E(Qg,{effects:E(ns,{commands:S,player:l}),screen:E("div",{className:a?"info-pane-open":""},E("div",{className:"player-assembly"},E("div",{id:"player-container"}),C&&E("div",{className:"black-screen"},E(cd,{code:y,channel:i})),!e&&E(Jg,{onClick:n})),E("div",{className:"info-pane"},E(vd,{player:d,broadcast:s,channels:as,onClose:()=>t(!1)})),E("div",{className:"info-pane-close-overlay","aria-hidden":!0,onClick:()=>t(!1)})),controlPanel:E(Fn,null,E(hd,{channels:as,onChannelSelected:M=>{r(M),n()}}),E("button",{className:a?"info-button info-button-info-pane-open":"info-button",onClick:()=>t(!a)},"Info"))})}function Qg(e){return E("div",{className:"App"},E("div",{className:"bezel"},E("div",{className:"screen"},e.screen),E("div",{style:{height:"12px"}}),E("div",{className:"controls"},e.controlPanel),e.effects))}function Jg(e){return E("button",{id:"start",onClick:e.onClick},"▸ Play")}function Cd(){let[e,n]=Be("");return Kn(()=>{Xu(ad()).then($u).then(n).catch(a=>n(a.message))},[]),/fail/i.test(e)?E("div",{className:"TestResults"},E("code",null,E("pre",null,e))):null}Fo(E(wd,null),document.getElementById("app"));Fo(E(Cd,null),document.getElementById("test-results"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
