...
# bar`),B,[])},"strips spaces before comments"(){y(fe(`  #foo
  ...
  `]);q("pipe",{"given one function"(){y(ji(t=>t+1)(1),S,2)},"given two functions"(){let e=t=>t+1;y(ji(e,e)(1),S,3)}});function fp(e,t){return(...n)=>t(e(...n))}function dp(e){return t=>t.map(e)}var om=fe(`
