var gs=Object.defineProperty;var Yd=Object.prototype.hasOwnProperty;var ms=Object.getOwnPropertySymbols,Vd=Object.prototype.propertyIsEnumerable;var fs=(e,n,a)=>n in e?gs(e,n,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[n]=a,xe=(e,n)=>{for(var a in n||(n={}))Yd.call(n,a)&&fs(e,a,n[a]);if(ms)for(var a of ms(n))Vd.call(n,a)&&fs(e,a,n[a]);return e};var zn=(e,n)=>{for(var a in n)gs(e,a,{get:n[a],enumerable:!0})};var Ct=(e,n,a)=>new Promise((t,i)=>{var r=l=>{try{s(a.next(l))}catch(c){i(c)}},o=l=>{try{s(a.throw(l))}catch(c){i(c)}},s=l=>l.done?t(l.value):Promise.resolve(l.value).then(r,o);s((a=a.apply(e,n)).next())});function Xe(e,n,a){return a={path:n,exports:{},require:function(t,i){return jd(t,i==null?a.path:i)}},e(a,a.exports),a.exports}function jd(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var ps=Object.getOwnPropertySymbols,zd=Object.prototype.hasOwnProperty,Jd=Object.prototype.propertyIsEnumerable;function _d(e){if(e==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(e)}function Qd(){try{if(!Object.assign)return!1;var e=new String("abc");if(e[5]="de",Object.getOwnPropertyNames(e)[0]==="5")return!1;for(var n={},a=0;a<10;a++)n["_"+String.fromCharCode(a)]=a;var t=Object.getOwnPropertyNames(n).map(function(r){return n[r]});if(t.join("")!=="0123456789")return!1;var i={};return"abcdefghijklmnopqrst".split("").forEach(function(r){i[r]=r}),Object.keys(Object.assign({},i)).join("")==="abcdefghijklmnopqrst"}catch(r){return!1}}var qd=Qd()?Object.assign:function(e,n){for(var a,t=_d(e),i,r=1;r<arguments.length;r++){a=Object(arguments[r]);for(var o in a)zd.call(a,o)&&(t[o]=a[o]);if(ps){i=ps(a);for(var s=0;s<i.length;s++)Jd.call(a,i[s])&&(t[i[s]]=a[i[s]])}}return t},Y=qd;var Zd=Xe(function(e,n){var a=60103,t=60106;n.Fragment=60107,n.StrictMode=60108,n.Profiler=60114;var i=60109,r=60110,o=60112;n.Suspense=60113;var s=60115,l=60116;if(typeof Symbol=="function"&&Symbol.for){var c=Symbol.for;a=c("react.element"),t=c("react.portal"),n.Fragment=c("react.fragment"),n.StrictMode=c("react.strict_mode"),n.Profiler=c("react.profiler"),i=c("react.provider"),r=c("react.context"),o=c("react.forward_ref"),n.Suspense=c("react.suspense"),s=c("react.memo"),l=c("react.lazy")}var y=typeof Symbol=="function"&&Symbol.iterator;function v(g){return g===null||typeof g!="object"?null:(g=y&&g[y]||g["@@iterator"],typeof g=="function"?g:null)}function p(g){for(var A="https://reactjs.org/docs/error-decoder.html?invariant="+g,K=1;K<arguments.length;K++)A+="&args[]="+encodeURIComponent(arguments[K]);return"Minified React error #"+g+"; visit "+A+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var w={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},G={};function N(g,A,K){this.props=g,this.context=A,this.refs=G,this.updater=K||w}N.prototype.isReactComponent={},N.prototype.setState=function(g,A){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error(p(85));this.updater.enqueueSetState(this,g,A,"setState")},N.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function h(){}h.prototype=N.prototype;function u(g,A,K){this.props=g,this.context=A,this.refs=G,this.updater=K||w}var d=u.prototype=new h;d.constructor=u,Y(d,N.prototype),d.isPureReactComponent=!0;var f={current:null},S=Object.prototype.hasOwnProperty,R={key:!0,ref:!0,__self:!0,__source:!0};function M(g,A,K){var j,k={},C=null,W=null;if(A!=null)for(j in A.ref!==void 0&&(W=A.ref),A.key!==void 0&&(C=""+A.key),A)S.call(A,j)&&!R.hasOwnProperty(j)&&(k[j]=A[j]);var U=arguments.length-2;if(U===1)k.children=K;else if(1<U){for(var H=Array(U),ee=0;ee<U;ee++)H[ee]=arguments[ee+2];k.children=H}if(g&&g.defaultProps)for(j in U=g.defaultProps,U)k[j]===void 0&&(k[j]=U[j]);return{$$typeof:a,type:g,key:C,ref:W,props:k,_owner:f.current}}function B(g,A){return{$$typeof:a,type:g.type,key:A,ref:g.ref,props:g.props,_owner:g._owner}}function D(g){return typeof g=="object"&&g!==null&&g.$$typeof===a}function L(g){var A={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(K){return A[K]})}var q=/\/+/g;function ye(g,A){return typeof g=="object"&&g!==null&&g.key!=null?L(""+g.key):A.toString(36)}function Vn(g,A,K,j,k){var C=typeof g;(C==="undefined"||C==="boolean")&&(g=null);var W=!1;if(g===null)W=!0;else switch(C){case"string":case"number":W=!0;break;case"object":switch(g.$$typeof){case a:case t:W=!0}}if(W)return W=g,k=k(W),g=j===""?"."+ye(W,0):j,Array.isArray(k)?(K="",g!=null&&(K=g.replace(q,"$&/")+"/"),Vn(k,A,K,"",function(ee){return ee})):k!=null&&(D(k)&&(k=B(k,K+(!k.key||W&&W.key===k.key?"":(""+k.key).replace(q,"$&/")+"/")+g)),A.push(k)),1;if(W=0,j=j===""?".":j+":",Array.isArray(g))for(var U=0;U<g.length;U++){C=g[U];var H=j+ye(C,U);W+=Vn(C,A,K,H,k)}else if(H=v(g),typeof H=="function")for(g=H.call(g),U=0;!(C=g.next()).done;)C=C.value,H=j+ye(C,U++),W+=Vn(C,A,K,H,k);else if(C==="object")throw A=""+g,Error(p(31,A==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":A));return W}function oe(g,A,K){if(g==null)return g;var j=[],k=0;return Vn(g,j,"","",function(C){return A.call(K,C,k++)}),j}function ie(g){if(g._status===-1){var A=g._result;A=A(),g._status=0,g._result=A,A.then(function(K){g._status===0&&(K=K.default,g._status=1,g._result=K)},function(K){g._status===0&&(g._status=2,g._result=K)})}if(g._status===1)return g._result;throw g._result}var Mn={current:null};function se(){var g=Mn.current;if(g===null)throw Error(p(321));return g}var wn={ReactCurrentDispatcher:Mn,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:f,IsSomeRendererActing:{current:!1},assign:Y};n.Children={map:oe,forEach:function(g,A,K){oe(g,function(){A.apply(this,arguments)},K)},count:function(g){var A=0;return oe(g,function(){A++}),A},toArray:function(g){return oe(g,function(A){return A})||[]},only:function(g){if(!D(g))throw Error(p(143));return g}},n.Component=N,n.PureComponent=u,n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=wn,n.cloneElement=function(g,A,K){if(g==null)throw Error(p(267,g));var j=Y({},g.props),k=g.key,C=g.ref,W=g._owner;if(A!=null){if(A.ref!==void 0&&(C=A.ref,W=f.current),A.key!==void 0&&(k=""+A.key),g.type&&g.type.defaultProps)var U=g.type.defaultProps;for(H in A)S.call(A,H)&&!R.hasOwnProperty(H)&&(j[H]=A[H]===void 0&&U!==void 0?U[H]:A[H])}var H=arguments.length-2;if(H===1)j.children=K;else if(1<H){U=Array(H);for(var ee=0;ee<H;ee++)U[ee]=arguments[ee+2];j.children=U}return{$$typeof:a,type:g.type,key:k,ref:C,props:j,_owner:W}},n.createContext=function(g,A){return A===void 0&&(A=null),g={$$typeof:r,_calculateChangedBits:A,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider={$$typeof:i,_context:g},g.Consumer=g},n.createElement=M,n.createFactory=function(g){var A=M.bind(null,g);return A.type=g,A},n.createRef=function(){return{current:null}},n.forwardRef=function(g){return{$$typeof:o,render:g}},n.isValidElement=D,n.lazy=function(g){return{$$typeof:l,_payload:{_status:-1,_result:g},_init:ie}},n.memo=function(g,A){return{$$typeof:s,type:g,compare:A===void 0?null:A}},n.useCallback=function(g,A){return se().useCallback(g,A)},n.useContext=function(g,A){return se().useContext(g,A)},n.useDebugValue=function(){},n.useEffect=function(g,A){return se().useEffect(g,A)},n.useImperativeHandle=function(g,A,K){return se().useImperativeHandle(g,A,K)},n.useLayoutEffect=function(g,A){return se().useLayoutEffect(g,A)},n.useMemo=function(g,A){return se().useMemo(g,A)},n.useReducer=function(g,A,K){return se().useReducer(g,A,K)},n.useRef=function(g){return se().useRef(g)},n.useState=function(g){return se().useState(g)},n.version="17.0.2"}),b=Xe(function(e){e.exports=Zd});var wm=b.Children,Ss=b.Component,Ot=b.Fragment,Cm=b.Profiler,Om=b.PureComponent,Nm=b.StrictMode,Bm=b.Suspense,Wm=b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,Gm=b.cloneElement,Rm=b.createContext,E=b.createElement,Lm=b.createFactory,Dm=b.createRef,Pm=b.forwardRef,Um=b.isValidElement,Fm=b.lazy,Hm=b.memo,zi=b.useCallback,Km=b.useContext,bm=b.useDebugValue,$e=b.useEffect,xm=b.useImperativeHandle,Ym=b.useLayoutEffect,Vm=b.useMemo,jm=b.useReducer,Ye=b.useRef,we=b.useState,zm=b.version;var Xd=Xe(function(e,n){var a,t,i,r;if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;n.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();n.unstable_now=function(){return s.now()-l}}if(typeof window=="undefined"||typeof MessageChannel!="function"){var c=null,y=null,v=function(){if(c!==null)try{var k=n.unstable_now();c(!0,k),c=null}catch(C){throw setTimeout(v,0),C}};a=function(k){c!==null?setTimeout(a,0,k):(c=k,setTimeout(v,0))},t=function(k,C){y=setTimeout(k,C)},i=function(){clearTimeout(y)},n.unstable_shouldYield=function(){return!1},r=n.unstable_forceFrameRate=function(){}}else{var p=window.setTimeout,w=window.clearTimeout;if(typeof console!="undefined"){var G=window.cancelAnimationFrame;typeof window.requestAnimationFrame!="function"&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),typeof G!="function"&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var N=!1,h=null,u=-1,d=5,f=0;n.unstable_shouldYield=function(){return n.unstable_now()>=f},r=function(){},n.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):d=0<k?Math.floor(1e3/k):5};var S=new MessageChannel,R=S.port2;S.port1.onmessage=function(){if(h!==null){var k=n.unstable_now();f=k+d;try{h(!0,k)?R.postMessage(null):(N=!1,h=null)}catch(C){throw R.postMessage(null),C}}else N=!1},a=function(k){h=k,N||(N=!0,R.postMessage(null))},t=function(k,C){u=p(function(){k(n.unstable_now())},C)},i=function(){w(u),u=-1}}function M(k,C){var W=k.length;k.push(C);e:for(;;){var U=W-1>>>1,H=k[U];if(H!==void 0&&0<L(H,C))k[U]=C,k[W]=H,W=U;else break e}}function B(k){return k=k[0],k===void 0?null:k}function D(k){var C=k[0];if(C!==void 0){var W=k.pop();if(W!==C){k[0]=W;e:for(var U=0,H=k.length;U<H;){var ee=2*(U+1)-1,Cn=k[ee],Ca=ee+1,jn=k[Ca];if(Cn!==void 0&&0>L(Cn,W))jn!==void 0&&0>L(jn,Cn)?(k[U]=jn,k[Ca]=W,U=Ca):(k[U]=Cn,k[ee]=W,U=ee);else if(jn!==void 0&&0>L(jn,W))k[U]=jn,k[Ca]=W,U=Ca;else break e}}return C}return null}function L(k,C){var W=k.sortIndex-C.sortIndex;return W!==0?W:k.id-C.id}var q=[],ye=[],Vn=1,oe=null,ie=3,Mn=!1,se=!1,wn=!1;function g(k){for(var C=B(ye);C!==null;){if(C.callback===null)D(ye);else if(C.startTime<=k)D(ye),C.sortIndex=C.expirationTime,M(q,C);else break;C=B(ye)}}function A(k){if(wn=!1,g(k),!se)if(B(q)!==null)se=!0,a(K);else{var C=B(ye);C!==null&&t(A,C.startTime-k)}}function K(k,C){se=!1,wn&&(wn=!1,i()),Mn=!0;var W=ie;try{for(g(C),oe=B(q);oe!==null&&(!(oe.expirationTime>C)||k&&!n.unstable_shouldYield());){var U=oe.callback;if(typeof U=="function"){oe.callback=null,ie=oe.priorityLevel;var H=U(oe.expirationTime<=C);C=n.unstable_now(),typeof H=="function"?oe.callback=H:oe===B(q)&&D(q),g(C)}else D(q);oe=B(q)}if(oe!==null)var ee=!0;else{var Cn=B(ye);Cn!==null&&t(A,Cn.startTime-C),ee=!1}return ee}finally{oe=null,ie=W,Mn=!1}}var j=r;n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(k){k.callback=null},n.unstable_continueExecution=function(){se||Mn||(se=!0,a(K))},n.unstable_getCurrentPriorityLevel=function(){return ie},n.unstable_getFirstCallbackNode=function(){return B(q)},n.unstable_next=function(k){switch(ie){case 1:case 2:case 3:var C=3;break;default:C=ie}var W=ie;ie=C;try{return k()}finally{ie=W}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=j,n.unstable_runWithPriority=function(k,C){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var W=ie;ie=k;try{return C()}finally{ie=W}},n.unstable_scheduleCallback=function(k,C,W){var U=n.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?U+W:U):W=U,k){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=W+H,k={id:Vn++,callback:C,priorityLevel:k,startTime:W,expirationTime:H,sortIndex:-1},W>U?(k.sortIndex=W,M(ye,k),B(q)===null&&k===B(ye)&&(wn?i():wn=!0,t(A,W-U))):(k.sortIndex=H,M(q,k),se||Mn||(se=!0,a(K))),k},n.unstable_wrapCallback=function(k){var C=ie;return function(){var W=ie;ie=C;try{return k.apply(this,arguments)}finally{ie=W}}}}),ne=Xe(function(e){e.exports=Xd});function T(e){for(var n="https://reactjs.org/docs/error-decoder.html?invariant="+e,a=1;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!b)throw Error(T(227));var ys=new Set,Oa={};function On(e,n){Jn(e,n),Jn(e+"Capture",n)}function Jn(e,n){for(Oa[e]=n,e=0;e<n.length;e++)ys.add(n[e])}var Ve=!(typeof window=="undefined"||typeof window.document=="undefined"||typeof window.document.createElement=="undefined"),$d=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,ks=Object.prototype.hasOwnProperty,Is={},Ts={};function ec(e){return ks.call(Ts,e)?!0:ks.call(Is,e)?!1:$d.test(e)?Ts[e]=!0:(Is[e]=!0,!1)}function nc(e,n,a,t){if(a!==null&&a.type===0)return!1;switch(typeof n){case"function":case"symbol":return!0;case"boolean":return t?!1:a!==null?!a.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function ac(e,n,a,t){if(n===null||typeof n=="undefined"||nc(e,n,a,t))return!0;if(t)return!1;if(a!==null)switch(a.type){case 3:return!n;case 4:return n===!1;case 5:return isNaN(n);case 6:return isNaN(n)||1>n}return!1}function fe(e,n,a,t,i,r,o){this.acceptsBooleans=n===2||n===3||n===4,this.attributeName=t,this.attributeNamespace=i,this.mustUseProperty=a,this.propertyName=e,this.type=n,this.sanitizeURL=r,this.removeEmptyString=o}var le={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){le[e]=new fe(e,0,!1,e,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var n=e[0];le[n]=new fe(n,1,!1,e[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(e){le[e]=new fe(e,2,!1,e.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){le[e]=new fe(e,2,!1,e,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){le[e]=new fe(e,3,!1,e.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(e){le[e]=new fe(e,3,!0,e,null,!1,!1)});["capture","download"].forEach(function(e){le[e]=new fe(e,4,!1,e,null,!1,!1)});["cols","rows","size","span"].forEach(function(e){le[e]=new fe(e,6,!1,e,null,!1,!1)});["rowSpan","start"].forEach(function(e){le[e]=new fe(e,5,!1,e.toLowerCase(),null,!1,!1)});var Ji=/[\-:]([a-z])/g;function _i(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var n=e.replace(Ji,_i);le[n]=new fe(n,1,!1,e,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var n=e.replace(Ji,_i);le[n]=new fe(n,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var n=e.replace(Ji,_i);le[n]=new fe(n,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(e){le[e]=new fe(e,1,!1,e.toLowerCase(),null,!1,!1)});le.xlinkHref=new fe("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(e){le[e]=new fe(e,1,!1,e.toLowerCase(),null,!0,!0)});function Qi(e,n,a,t){var i=le.hasOwnProperty(n)?le[n]:null,r=i!==null?i.type===0:t?!1:!(!(2<n.length)||n[0]!=="o"&&n[0]!=="O"||n[1]!=="n"&&n[1]!=="N");r||(ac(n,a,i,t)&&(a=null),t||i===null?ec(n)&&(a===null?e.removeAttribute(n):e.setAttribute(n,""+a)):i.mustUseProperty?e[i.propertyName]=a===null?i.type===3?!1:"":a:(n=i.attributeName,t=i.attributeNamespace,a===null?e.removeAttribute(n):(i=i.type,a=i===3||i===4&&a===!0?"":""+a,t?e.setAttributeNS(t,n,a):e.setAttribute(n,a))))}var Nn=b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,Na=60103,Bn=60106,en=60107,qi=60108,Ba=60114,Zi=60109,Xi=60110,Nt=60112,Wa=60113,Bt=60120,Wt=60115,$i=60116,er=60121,nr=60128,As=60129,ar=60130,tr=60131;typeof Symbol=="function"&&Symbol.for&&(ae=Symbol.for,Na=ae("react.element"),Bn=ae("react.portal"),en=ae("react.fragment"),qi=ae("react.strict_mode"),Ba=ae("react.profiler"),Zi=ae("react.provider"),Xi=ae("react.context"),Nt=ae("react.forward_ref"),Wa=ae("react.suspense"),Bt=ae("react.suspense_list"),Wt=ae("react.memo"),$i=ae("react.lazy"),er=ae("react.block"),ae("react.scope"),nr=ae("react.opaque.id"),As=ae("react.debug_trace_mode"),ar=ae("react.offscreen"),tr=ae("react.legacy_hidden"));var ae,Es=typeof Symbol=="function"&&Symbol.iterator;function Ga(e){return e===null||typeof e!="object"?null:(e=Es&&e[Es]||e["@@iterator"],typeof e=="function"?e:null)}var ir;function Ra(e){if(ir===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);ir=n&&n[1]||""}return`
`+ir+e}var rr=!1;function Gt(e,n){if(!e||rr)return"";rr=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{if(n)if(n=function(){throw Error()},Object.defineProperty(n.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(n,[])}catch(l){var t=l}Reflect.construct(e,[],n)}else{try{n.call()}catch(l){t=l}e.call(n.prototype)}else{try{throw Error()}catch(l){t=l}e()}}catch(l){if(l&&t&&typeof l.stack=="string"){for(var i=l.stack.split(`
`),r=t.stack.split(`
`),o=i.length-1,s=r.length-1;1<=o&&0<=s&&i[o]!==r[s];)s--;for(;1<=o&&0<=s;o--,s--)if(i[o]!==r[s]){if(o!==1||s!==1)do if(o--,s--,0>s||i[o]!==r[s])return`
`+i[o].replace(" at new "," at ");while(1<=o&&0<=s);break}}}finally{rr=!1,Error.prepareStackTrace=a}return(e=e?e.displayName||e.name:"")?Ra(e):""}function tc(e){switch(e.tag){case 5:return Ra(e.type);case 16:return Ra("Lazy");case 13:return Ra("Suspense");case 19:return Ra("SuspenseList");case 0:case 2:case 15:return e=Gt(e.type,!1),e;case 11:return e=Gt(e.type.render,!1),e;case 22:return e=Gt(e.type._render,!1),e;case 1:return e=Gt(e.type,!0),e;default:return""}}function _n(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case en:return"Fragment";case Bn:return"Portal";case Ba:return"Profiler";case qi:return"StrictMode";case Wa:return"Suspense";case Bt:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case Xi:return(e.displayName||"Context")+".Consumer";case Zi:return(e._context.displayName||"Context")+".Provider";case Nt:var n=e.render;return n=n.displayName||n.name||"",e.displayName||(n!==""?"ForwardRef("+n+")":"ForwardRef");case Wt:return _n(e.type);case er:return _n(e._render);case $i:n=e._payload,e=e._init;try{return _n(e(n))}catch(a){}}return null}function nn(e){switch(typeof e){case"boolean":case"number":case"object":case"string":case"undefined":return e;default:return""}}function vs(e){var n=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(n==="checkbox"||n==="radio")}function ic(e){var n=vs(e)?"checked":"value",a=Object.getOwnPropertyDescriptor(e.constructor.prototype,n),t=""+e[n];if(!e.hasOwnProperty(n)&&typeof a!="undefined"&&typeof a.get=="function"&&typeof a.set=="function"){var i=a.get,r=a.set;return Object.defineProperty(e,n,{configurable:!0,get:function(){return i.call(this)},set:function(o){t=""+o,r.call(this,o)}}),Object.defineProperty(e,n,{enumerable:a.enumerable}),{getValue:function(){return t},setValue:function(o){t=""+o},stopTracking:function(){e._valueTracker=null,delete e[n]}}}}function Rt(e){e._valueTracker||(e._valueTracker=ic(e))}function Ms(e){if(!e)return!1;var n=e._valueTracker;if(!n)return!0;var a=n.getValue(),t="";return e&&(t=vs(e)?e.checked?"true":"false":e.value),e=t,e!==a?(n.setValue(e),!0):!1}function Lt(e){if(e=e||(typeof document!="undefined"?document:void 0),typeof e=="undefined")return null;try{return e.activeElement||e.body}catch(n){return e.body}}function or(e,n){var a=n.checked;return Y({},n,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:a!=null?a:e._wrapperState.initialChecked})}function ws(e,n){var a=n.defaultValue==null?"":n.defaultValue,t=n.checked!=null?n.checked:n.defaultChecked;a=nn(n.value!=null?n.value:a),e._wrapperState={initialChecked:t,initialValue:a,controlled:n.type==="checkbox"||n.type==="radio"?n.checked!=null:n.value!=null}}function Cs(e,n){n=n.checked,n!=null&&Qi(e,"checked",n,!1)}function lr(e,n){Cs(e,n);var a=nn(n.value),t=n.type;if(a!=null)t==="number"?(a===0&&e.value===""||e.value!=a)&&(e.value=""+a):e.value!==""+a&&(e.value=""+a);else if(t==="submit"||t==="reset"){e.removeAttribute("value");return}n.hasOwnProperty("value")?sr(e,n.type,a):n.hasOwnProperty("defaultValue")&&sr(e,n.type,nn(n.defaultValue)),n.checked==null&&n.defaultChecked!=null&&(e.defaultChecked=!!n.defaultChecked)}function Os(e,n,a){if(n.hasOwnProperty("value")||n.hasOwnProperty("defaultValue")){var t=n.type;if(!(t!=="submit"&&t!=="reset"||n.value!==void 0&&n.value!==null))return;n=""+e._wrapperState.initialValue,a||n===e.value||(e.value=n),e.defaultValue=n}a=e.name,a!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,a!==""&&(e.name=a)}function sr(e,n,a){(n!=="number"||Lt(e.ownerDocument)!==e)&&(a==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+a&&(e.defaultValue=""+a))}function rc(e){var n="";return b.Children.forEach(e,function(a){a!=null&&(n+=a)}),n}function ur(e,n){return e=Y({children:void 0},n),(n=rc(n.children))&&(e.children=n),e}function Qn(e,n,a,t){if(e=e.options,n){n={};for(var i=0;i<a.length;i++)n["$"+a[i]]=!0;for(a=0;a<e.length;a++)i=n.hasOwnProperty("$"+e[a].value),e[a].selected!==i&&(e[a].selected=i),i&&t&&(e[a].defaultSelected=!0)}else{for(a=""+nn(a),n=null,i=0;i<e.length;i++){if(e[i].value===a){e[i].selected=!0,t&&(e[i].defaultSelected=!0);return}n!==null||e[i].disabled||(n=e[i])}n!==null&&(n.selected=!0)}}function dr(e,n){if(n.dangerouslySetInnerHTML!=null)throw Error(T(91));return Y({},n,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function Ns(e,n){var a=n.value;if(a==null){if(a=n.children,n=n.defaultValue,a!=null){if(n!=null)throw Error(T(92));if(Array.isArray(a)){if(!(1>=a.length))throw Error(T(93));a=a[0]}n=a}n==null&&(n=""),a=n}e._wrapperState={initialValue:nn(a)}}function Bs(e,n){var a=nn(n.value),t=nn(n.defaultValue);a!=null&&(a=""+a,a!==e.value&&(e.value=a),n.defaultValue==null&&e.defaultValue!==a&&(e.defaultValue=a)),t!=null&&(e.defaultValue=""+t)}function Ws(e){var n=e.textContent;n===e._wrapperState.initialValue&&n!==""&&n!==null&&(e.value=n)}var cr={html:"http://www.w3.org/1999/xhtml",mathml:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg"};function Gs(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function hr(e,n){return e==null||e==="http://www.w3.org/1999/xhtml"?Gs(n):e==="http://www.w3.org/2000/svg"&&n==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var Dt,Rs=function(e){return typeof MSApp!="undefined"&&MSApp.execUnsafeLocalFunction?function(n,a,t,i){MSApp.execUnsafeLocalFunction(function(){return e(n,a,t,i)})}:e}(function(e,n){if(e.namespaceURI!==cr.svg||"innerHTML"in e)e.innerHTML=n;else{for(Dt=Dt||document.createElement("div"),Dt.innerHTML="<svg>"+n.valueOf().toString()+"</svg>",n=Dt.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;n.firstChild;)e.appendChild(n.firstChild)}});function La(e,n){if(n){var a=e.firstChild;if(a&&a===e.lastChild&&a.nodeType===3){a.nodeValue=n;return}}e.textContent=n}var Da={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},oc=["Webkit","ms","Moz","O"];Object.keys(Da).forEach(function(e){oc.forEach(function(n){n=n+e.charAt(0).toUpperCase()+e.substring(1),Da[n]=Da[e]})});function Ls(e,n,a){return n==null||typeof n=="boolean"||n===""?"":a||typeof n!="number"||n===0||Da.hasOwnProperty(e)&&Da[e]?(""+n).trim():n+"px"}function Ds(e,n){e=e.style;for(var a in n)if(n.hasOwnProperty(a)){var t=a.indexOf("--")===0,i=Ls(a,n[a],t);a==="float"&&(a="cssFloat"),t?e.setProperty(a,i):e[a]=i}}var sc=Y({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function gr(e,n){if(n){if(sc[e]&&(n.children!=null||n.dangerouslySetInnerHTML!=null))throw Error(T(137,e));if(n.dangerouslySetInnerHTML!=null){if(n.children!=null)throw Error(T(60));if(!(typeof n.dangerouslySetInnerHTML=="object"&&"__html"in n.dangerouslySetInnerHTML))throw Error(T(61))}if(n.style!=null&&typeof n.style!="object")throw Error(T(62))}}function mr(e,n){if(e.indexOf("-")===-1)return typeof n.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}function fr(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var pr=null,qn=null,Zn=null;function Ps(e){if(e=Pa(e)){if(typeof pr!="function")throw Error(T(280));var n=e.stateNode;n&&(n=Pt(n),pr(e.stateNode,e.type,n))}}function Us(e){qn?Zn?Zn.push(e):Zn=[e]:qn=e}function Fs(){if(qn){var e=qn,n=Zn;if(Zn=qn=null,Ps(e),n)for(e=0;e<n.length;e++)Ps(n[e])}}function Sr(e,n){return e(n)}function Hs(e,n,a,t,i){return e(n,a,t,i)}function yr(){}var Ks=Sr,Wn=!1,kr=!1;function Ir(){(qn!==null||Zn!==null)&&(yr(),Fs())}function lc(e,n,a){if(kr)return e(n,a);kr=!0;try{return Ks(e,n,a)}finally{kr=!1,Ir()}}function Ua(e,n){var a=e.stateNode;if(a===null)return null;var t=Pt(a);if(t===null)return null;a=t[n];e:switch(n){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(t=!t.disabled)||(e=e.type,t=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!t;break e;default:e=!1}if(e)return null;if(a&&typeof a!="function")throw Error(T(231,n,typeof a));return a}var Tr=!1;if(Ve)try{Xn={},Object.defineProperty(Xn,"passive",{get:function(){Tr=!0}}),window.addEventListener("test",Xn,Xn),window.removeEventListener("test",Xn,Xn)}catch(e){Tr=!1}var Xn;function uc(e,n,a,t,i,r,o,s,l){var c=Array.prototype.slice.call(arguments,3);try{n.apply(a,c)}catch(y){this.onError(y)}}var Fa=!1,Ut=null,Ft=!1,Ar=null,dc={onError:function(e){Fa=!0,Ut=e}};function cc(e,n,a,t,i,r,o,s,l){Fa=!1,Ut=null,uc.apply(dc,arguments)}function hc(e,n,a,t,i,r,o,s,l){if(cc.apply(this,arguments),Fa){if(Fa){var c=Ut;Fa=!1,Ut=null}else throw Error(T(198));Ft||(Ft=!0,Ar=c)}}function Gn(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&1026)!=0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function bs(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function xs(e){if(Gn(e)!==e)throw Error(T(188))}function gc(e){var n=e.alternate;if(!n){if(n=Gn(e),n===null)throw Error(T(188));return n!==e?null:e}for(var a=e,t=n;;){var i=a.return;if(i===null)break;var r=i.alternate;if(r===null){if(t=i.return,t!==null){a=t;continue}break}if(i.child===r.child){for(r=i.child;r;){if(r===a)return xs(i),e;if(r===t)return xs(i),n;r=r.sibling}throw Error(T(188))}if(a.return!==t.return)a=i,t=r;else{for(var o=!1,s=i.child;s;){if(s===a){o=!0,a=i,t=r;break}if(s===t){o=!0,t=i,a=r;break}s=s.sibling}if(!o){for(s=r.child;s;){if(s===a){o=!0,a=r,t=i;break}if(s===t){o=!0,t=r,a=i;break}s=s.sibling}if(!o)throw Error(T(189))}}if(a.alternate!==t)throw Error(T(190))}if(a.tag!==3)throw Error(T(188));return a.stateNode.current===a?e:n}function Ys(e){if(e=gc(e),!e)return null;for(var n=e;;){if(n.tag===5||n.tag===6)return n;if(n.child)n.child.return=n,n=n.child;else{if(n===e)break;for(;!n.sibling;){if(!n.return||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}}return null}function Vs(e,n){for(var a=e.alternate;n!==null;){if(n===e||n===a)return!0;n=n.return}return!1}var js,Er,zs,Js,vr=!1,De=[],an=null,tn=null,rn=null,Ha=new Map,Ka=new Map,ba=[],_s="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function Mr(e,n,a,t,i){return{blockedOn:e,domEventName:n,eventSystemFlags:a|16,nativeEvent:i,targetContainers:[t]}}function Qs(e,n){switch(e){case"focusin":case"focusout":an=null;break;case"dragenter":case"dragleave":tn=null;break;case"mouseover":case"mouseout":rn=null;break;case"pointerover":case"pointerout":Ha.delete(n.pointerId);break;case"gotpointercapture":case"lostpointercapture":Ka.delete(n.pointerId)}}function xa(e,n,a,t,i,r){return e===null||e.nativeEvent!==r?(e=Mr(n,a,t,i,r),n!==null&&(n=Pa(n),n!==null&&Er(n)),e):(e.eventSystemFlags|=t,n=e.targetContainers,i!==null&&n.indexOf(i)===-1&&n.push(i),e)}function mc(e,n,a,t,i){switch(n){case"focusin":return an=xa(an,e,n,a,t,i),!0;case"dragenter":return tn=xa(tn,e,n,a,t,i),!0;case"mouseover":return rn=xa(rn,e,n,a,t,i),!0;case"pointerover":var r=i.pointerId;return Ha.set(r,xa(Ha.get(r)||null,e,n,a,t,i)),!0;case"gotpointercapture":return r=i.pointerId,Ka.set(r,xa(Ka.get(r)||null,e,n,a,t,i)),!0}return!1}function fc(e){var n=Rn(e.target);if(n!==null){var a=Gn(n);if(a!==null){if(n=a.tag,n===13){if(n=bs(a),n!==null){e.blockedOn=n,Js(e.lanePriority,function(){ne.unstable_runWithPriority(e.priority,function(){zs(a)})});return}}else if(n===3&&a.stateNode.hydrate){e.blockedOn=a.tag===3?a.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Ht(e){if(e.blockedOn!==null)return!1;for(var n=e.targetContainers;0<n.length;){var a=wr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null)return n=Pa(a),n!==null&&Er(n),e.blockedOn=a,!1;n.shift()}return!0}function qs(e,n,a){Ht(e)&&a.delete(n)}function pc(){for(vr=!1;0<De.length;){var e=De[0];if(e.blockedOn!==null){e=Pa(e.blockedOn),e!==null&&js(e);break}for(var n=e.targetContainers;0<n.length;){var a=wr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null){e.blockedOn=a;break}n.shift()}e.blockedOn===null&&De.shift()}an!==null&&Ht(an)&&(an=null),tn!==null&&Ht(tn)&&(tn=null),rn!==null&&Ht(rn)&&(rn=null),Ha.forEach(qs),Ka.forEach(qs)}function Ya(e,n){e.blockedOn===n&&(e.blockedOn=null,vr||(vr=!0,ne.unstable_scheduleCallback(ne.unstable_NormalPriority,pc)))}function Zs(e){function n(i){return Ya(i,e)}if(0<De.length){Ya(De[0],e);for(var a=1;a<De.length;a++){var t=De[a];t.blockedOn===e&&(t.blockedOn=null)}}for(an!==null&&Ya(an,e),tn!==null&&Ya(tn,e),rn!==null&&Ya(rn,e),Ha.forEach(n),Ka.forEach(n),a=0;a<ba.length;a++)t=ba[a],t.blockedOn===e&&(t.blockedOn=null);for(;0<ba.length&&(a=ba[0],a.blockedOn===null);)fc(a),a.blockedOn===null&&ba.shift()}function Kt(e,n){var a={};return a[e.toLowerCase()]=n.toLowerCase(),a["Webkit"+e]="webkit"+n,a["Moz"+e]="moz"+n,a}var $n={animationend:Kt("Animation","AnimationEnd"),animationiteration:Kt("Animation","AnimationIteration"),animationstart:Kt("Animation","AnimationStart"),transitionend:Kt("Transition","TransitionEnd")},Cr={},Xs={};Ve&&(Xs=document.createElement("div").style,"AnimationEvent"in window||(delete $n.animationend.animation,delete $n.animationiteration.animation,delete $n.animationstart.animation),"TransitionEvent"in window||delete $n.transitionend.transition);function bt(e){if(Cr[e])return Cr[e];if(!$n[e])return e;var n=$n[e],a;for(a in n)if(n.hasOwnProperty(a)&&a in Xs)return Cr[e]=n[a];return e}var $s=bt("animationend"),el=bt("animationiteration"),nl=bt("animationstart"),al=bt("transitionend"),tl=new Map,Or=new Map,Sc=["abort","abort",$s,"animationEnd",el,"animationIteration",nl,"animationStart","canplay","canPlay","canplaythrough","canPlayThrough","durationchange","durationChange","emptied","emptied","encrypted","encrypted","ended","ended","error","error","gotpointercapture","gotPointerCapture","load","load","loadeddata","loadedData","loadedmetadata","loadedMetadata","loadstart","loadStart","lostpointercapture","lostPointerCapture","playing","playing","progress","progress","seeking","seeking","stalled","stalled","suspend","suspend","timeupdate","timeUpdate",al,"transitionEnd","waiting","waiting"];function Nr(e,n){for(var a=0;a<e.length;a+=2){var t=e[a],i=e[a+1];i="on"+(i[0].toUpperCase()+i.slice(1)),Or.set(t,n),tl.set(t,i),On(i,[t])}}var yc=ne.unstable_now;yc();var z=8;function ea(e){if((1&e)!=0)return z=15,1;if((2&e)!=0)return z=14,2;if((4&e)!=0)return z=13,4;var n=24&e;return n!==0?(z=12,n):(e&32)!=0?(z=11,32):(n=192&e,n!==0?(z=10,n):(e&256)!=0?(z=9,256):(n=3584&e,n!==0?(z=8,n):(e&4096)!=0?(z=7,4096):(n=4186112&e,n!==0?(z=6,n):(n=62914560&e,n!==0?(z=5,n):e&67108864?(z=4,67108864):(e&134217728)!=0?(z=3,134217728):(n=805306368&e,n!==0?(z=2,n):(1073741824&e)!=0?(z=1,1073741824):(z=8,e))))))}function kc(e){switch(e){case 99:return 15;case 98:return 10;case 97:case 96:return 8;case 95:return 2;default:return 0}}function Ic(e){switch(e){case 15:case 14:return 99;case 13:case 12:case 11:case 10:return 98;case 9:case 8:case 7:case 6:case 4:case 5:return 97;case 3:case 2:case 1:return 95;case 0:return 90;default:throw Error(T(358,e))}}function Va(e,n){var a=e.pendingLanes;if(a===0)return z=0;var t=0,i=0,r=e.expiredLanes,o=e.suspendedLanes,s=e.pingedLanes;if(r!==0)t=r,i=z=15;else if(r=a&134217727,r!==0){var l=r&~o;l!==0?(t=ea(l),i=z):(s&=r,s!==0&&(t=ea(s),i=z))}else r=a&~o,r!==0?(t=ea(r),i=z):s!==0&&(t=ea(s),i=z);if(t===0)return 0;if(t=31-on(t),t=a&((0>t?0:1<<t)<<1)-1,n!==0&&n!==t&&(n&o)==0){if(ea(n),i<=z)return n;z=i}if(n=e.entangledLanes,n!==0)for(e=e.entanglements,n&=t;0<n;)a=31-on(n),i=1<<a,t|=e[a],n&=~i;return t}function il(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function xt(e,n){switch(e){case 15:return 1;case 14:return 2;case 12:return e=na(24&~n),e===0?xt(10,n):e;case 10:return e=na(192&~n),e===0?xt(8,n):e;case 8:return e=na(3584&~n),e===0&&(e=na(4186112&~n),e===0&&(e=512)),e;case 2:return n=na(805306368&~n),n===0&&(n=268435456),n}throw Error(T(358,e))}function na(e){return e&-e}function Br(e){for(var n=[],a=0;31>a;a++)n.push(e);return n}function Yt(e,n,a){e.pendingLanes|=n;var t=n-1;e.suspendedLanes&=t,e.pingedLanes&=t,e=e.eventTimes,n=31-on(n),e[n]=a}var on=Math.clz32?Math.clz32:Tc,Ac=Math.log,Ec=Math.LN2;function Tc(e){return e===0?32:31-(Ac(e)/Ec|0)|0}var vc=ne.unstable_UserBlockingPriority,Mc=ne.unstable_runWithPriority,Vt=!0;function wc(e,n,a,t){Wn||yr();var i=Wr,r=Wn;Wn=!0;try{Hs(i,e,n,a,t)}finally{(Wn=r)||Ir()}}function Cc(e,n,a,t){Mc(vc,Wr.bind(null,e,n,a,t))}function Wr(e,n,a,t){if(Vt){var i;if((i=(n&4)==0)&&0<De.length&&-1<_s.indexOf(e))e=Mr(null,e,n,a,t),De.push(e);else{var r=wr(e,n,a,t);if(r===null)i&&Qs(e,t);else{if(i){if(-1<_s.indexOf(e)){e=Mr(r,e,n,a,t),De.push(e);return}if(mc(r,e,n,a,t))return;Qs(e,t)}rl(e,n,t,null,a)}}}}function wr(e,n,a,t){var i=fr(t);if(i=Rn(i),i!==null){var r=Gn(i);if(r===null)i=null;else{var o=r.tag;if(o===13){if(i=bs(r),i!==null)return i;i=null}else if(o===3){if(r.stateNode.hydrate)return r.tag===3?r.stateNode.containerInfo:null;i=null}else r!==i&&(i=null)}}return rl(e,n,t,i,a),null}var sn=null,Gr=null,jt=null;function ol(){if(jt)return jt;var e,n=Gr,a=n.length,t,i="value"in sn?sn.value:sn.textContent,r=i.length;for(e=0;e<a&&n[e]===i[e];e++);var o=a-e;for(t=1;t<=o&&n[a-t]===i[r-t];t++);return jt=i.slice(e,1<t?1-t:void 0)}function zt(e){var n=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&n===13&&(e=13)):e=n,e===10&&(e=13),32<=e||e===13?e:0}function Jt(){return!0}function sl(){return!1}function Ee(e){function n(a,t,i,r,o){this._reactName=a,this._targetInst=i,this.type=t,this.nativeEvent=r,this.target=o,this.currentTarget=null;for(var s in e)e.hasOwnProperty(s)&&(a=e[s],this[s]=a?a(r):r[s]);return this.isDefaultPrevented=(r.defaultPrevented!=null?r.defaultPrevented:r.returnValue===!1)?Jt:sl,this.isPropagationStopped=sl,this}return Y(n.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():typeof a.returnValue!="unknown"&&(a.returnValue=!1),this.isDefaultPrevented=Jt)},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():typeof a.cancelBubble!="unknown"&&(a.cancelBubble=!0),this.isPropagationStopped=Jt)},persist:function(){},isPersistent:Jt}),n}var aa={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Rr=Ee(aa),ja=Y({},aa,{view:0,detail:0}),Oc=Ee(ja),Lr,Dr,za,_t=Y({},ja,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Pr,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==za&&(za&&e.type==="mousemove"?(Lr=e.screenX-za.screenX,Dr=e.screenY-za.screenY):Dr=Lr=0,za=e),Lr)},movementY:function(e){return"movementY"in e?e.movementY:Dr}}),ll=Ee(_t),Nc=Y({},_t,{dataTransfer:0}),Bc=Ee(Nc),Wc=Y({},ja,{relatedTarget:0}),Ur=Ee(Wc),Gc=Y({},aa,{animationName:0,elapsedTime:0,pseudoElement:0}),Rc=Ee(Gc),Lc=Y({},aa,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),Dc=Ee(Lc),Pc=Y({},aa,{data:0}),ul=Ee(Pc),Uc={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},Fc={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},Hc={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function Kc(e){var n=this.nativeEvent;return n.getModifierState?n.getModifierState(e):(e=Hc[e])?!!n[e]:!1}function Pr(){return Kc}var bc=Y({},ja,{key:function(e){if(e.key){var n=Uc[e.key]||e.key;if(n!=="Unidentified")return n}return e.type==="keypress"?(e=zt(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?Fc[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Pr,charCode:function(e){return e.type==="keypress"?zt(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?zt(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),xc=Ee(bc),Yc=Y({},_t,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),dl=Ee(Yc),Vc=Y({},ja,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Pr}),jc=Ee(Vc),zc=Y({},aa,{propertyName:0,elapsedTime:0,pseudoElement:0}),Jc=Ee(zc),_c=Y({},_t,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),Qc=Ee(_c),qc=[9,13,27,32],Fr=Ve&&"CompositionEvent"in window,Ja=null;Ve&&"documentMode"in document&&(Ja=document.documentMode);var Zc=Ve&&"TextEvent"in window&&!Ja,cl=Ve&&(!Fr||Ja&&8<Ja&&11>=Ja),hl=String.fromCharCode(32),gl=!1;function ml(e,n){switch(e){case"keyup":return qc.indexOf(n.keyCode)!==-1;case"keydown":return n.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function fl(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var ta=!1;function Xc(e,n){switch(e){case"compositionend":return fl(n);case"keypress":return n.which!==32?null:(gl=!0,hl);case"textInput":return e=n.data,e===hl&&gl?null:e;default:return null}}function $c(e,n){if(ta)return e==="compositionend"||!Fr&&ml(e,n)?(e=ol(),jt=Gr=sn=null,ta=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(n.ctrlKey||n.altKey||n.metaKey)||n.ctrlKey&&n.altKey){if(n.char&&1<n.char.length)return n.char;if(n.which)return String.fromCharCode(n.which)}return null;case"compositionend":return cl&&n.locale!=="ko"?null:n.data;default:return null}}var eh={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function pl(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n==="input"?!!eh[e.type]:n==="textarea"}function Sl(e,n,a,t){Us(t),n=Qt(n,"onChange"),0<n.length&&(a=new Rr("onChange","change",null,a,t),e.push({event:a,listeners:n}))}var _a=null,Qa=null;function nh(e){yl(e,0)}function qt(e){var n=ia(e);if(Ms(n))return e}function ah(e,n){if(e==="change")return n}var kl=!1;Ve&&(Ve?(Xt="oninput"in document,Xt||(Hr=document.createElement("div"),Hr.setAttribute("oninput","return;"),Xt=typeof Hr.oninput=="function"),Zt=Xt):Zt=!1,kl=Zt&&(!document.documentMode||9<document.documentMode));var Zt,Xt,Hr;function Tl(){_a&&(_a.detachEvent("onpropertychange",Il),Qa=_a=null)}function Il(e){if(e.propertyName==="value"&&qt(Qa)){var n=[];if(Sl(n,Qa,e,fr(e)),e=nh,Wn)e(n);else{Wn=!0;try{Sr(e,n)}finally{Wn=!1,Ir()}}}}function th(e,n,a){e==="focusin"?(Tl(),_a=n,Qa=a,_a.attachEvent("onpropertychange",Il)):e==="focusout"&&Tl()}function ih(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return qt(Qa)}function rh(e,n){if(e==="click")return qt(n)}function oh(e,n){if(e==="input"||e==="change")return qt(n)}function sh(e,n){return e===n&&(e!==0||1/e==1/n)||e!==e&&n!==n}var Ce=typeof Object.is=="function"?Object.is:sh,lh=Object.prototype.hasOwnProperty;function qa(e,n){if(Ce(e,n))return!0;if(typeof e!="object"||e===null||typeof n!="object"||n===null)return!1;var a=Object.keys(e),t=Object.keys(n);if(a.length!==t.length)return!1;for(t=0;t<a.length;t++)if(!lh.call(n,a[t])||!Ce(e[a[t]],n[a[t]]))return!1;return!0}function Al(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function El(e,n){var a=Al(e);e=0;for(var t;a;){if(a.nodeType===3){if(t=e+a.textContent.length,e<=n&&t>=n)return{node:a,offset:n-e};e=t}e:{for(;a;){if(a.nextSibling){a=a.nextSibling;break e}a=a.parentNode}a=void 0}a=Al(a)}}function vl(e,n){return e&&n?e===n?!0:e&&e.nodeType===3?!1:n&&n.nodeType===3?vl(e,n.parentNode):"contains"in e?e.contains(n):e.compareDocumentPosition?!!(e.compareDocumentPosition(n)&16):!1:!1}function Ml(){for(var e=window,n=Lt();n instanceof e.HTMLIFrameElement;){try{var a=typeof n.contentWindow.location.href=="string"}catch(t){a=!1}if(a)e=n.contentWindow;else break;n=Lt(e.document)}return n}function Kr(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n&&(n==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||n==="textarea"||e.contentEditable==="true")}var uh=Ve&&"documentMode"in document&&11>=document.documentMode,ra=null,br=null,Za=null,xr=!1;function wl(e,n,a){var t=a.window===a?a.document:a.nodeType===9?a:a.ownerDocument;xr||ra==null||ra!==Lt(t)||(t=ra,"selectionStart"in t&&Kr(t)?t={start:t.selectionStart,end:t.selectionEnd}:(t=(t.ownerDocument&&t.ownerDocument.defaultView||window).getSelection(),t={anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}),Za&&qa(Za,t)||(Za=t,t=Qt(br,"onSelect"),0<t.length&&(n=new Rr("onSelect","select",null,n,a),e.push({event:n,listeners:t}),n.target=ra)))}Nr("cancel cancel click click close close contextmenu contextMenu copy copy cut cut auxclick auxClick dblclick doubleClick dragend dragEnd dragstart dragStart drop drop focusin focus focusout blur input input invalid invalid keydown keyDown keypress keyPress keyup keyUp mousedown mouseDown mouseup mouseUp paste paste pause pause play play pointercancel pointerCancel pointerdown pointerDown pointerup pointerUp ratechange rateChange reset reset seeked seeked submit submit touchcancel touchCancel touchend touchEnd touchstart touchStart volumechange volumeChange".split(" "),0);Nr("drag drag dragenter dragEnter dragexit dragExit dragleave dragLeave dragover dragOver mousemove mouseMove mouseout mouseOut mouseover mouseOver pointermove pointerMove pointerout pointerOut pointerover pointerOver scroll scroll toggle toggle touchmove touchMove wheel wheel".split(" "),1);Nr(Sc,2);for(var Cl="change selectionchange textInput compositionstart compositionend compositionupdate".split(" "),Yr=0;Yr<Cl.length;Yr++)Or.set(Cl[Yr],0);Jn("onMouseEnter",["mouseout","mouseover"]);Jn("onMouseLeave",["mouseout","mouseover"]);Jn("onPointerEnter",["pointerout","pointerover"]);Jn("onPointerLeave",["pointerout","pointerover"]);On("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));On("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));On("onBeforeInput",["compositionend","keypress","textInput","paste"]);On("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));On("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));On("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var Xa="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),Ol=new Set("cancel close invalid load scroll toggle".split(" ").concat(Xa));function Nl(e,n,a){var t=e.type||"unknown-event";e.currentTarget=a,hc(t,n,void 0,e),e.currentTarget=null}function yl(e,n){n=(n&4)!=0;for(var a=0;a<e.length;a++){var t=e[a],i=t.event;t=t.listeners;e:{var r=void 0;if(n)for(var o=t.length-1;0<=o;o--){var s=t[o],l=s.instance,c=s.currentTarget;if(s=s.listener,l!==r&&i.isPropagationStopped())break e;Nl(i,s,c),r=l}else for(o=0;o<t.length;o++){if(s=t[o],l=s.instance,c=s.currentTarget,s=s.listener,l!==r&&i.isPropagationStopped())break e;Nl(i,s,c),r=l}}}if(Ft)throw e=Ar,Ft=!1,Ar=null,e}function J(e,n){var a=Wl(n),t=e+"__bubble";a.has(t)||(Bl(n,e,2,!1),a.add(t))}var Gl="_reactListening"+Math.random().toString(36).slice(2);function Ll(e){e[Gl]||(e[Gl]=!0,ys.forEach(function(n){Ol.has(n)||Rl(n,!1,e,null),Rl(n,!0,e,null)}))}function Rl(e,n,a,t){var i=4<arguments.length&&arguments[4]!==void 0?arguments[4]:0,r=a;if(e==="selectionchange"&&a.nodeType!==9&&(r=a.ownerDocument),t!==null&&!n&&Ol.has(e)){if(e!=="scroll")return;i|=2,r=t}var o=Wl(r),s=e+"__"+(n?"capture":"bubble");o.has(s)||(n&&(i|=4),Bl(r,e,i,n),o.add(s))}function Bl(e,n,a,t){var i=Or.get(n);switch(i===void 0?2:i){case 0:i=wc;break;case 1:i=Cc;break;default:i=Wr}a=i.bind(null,n,a,e),i=void 0,!Tr||n!=="touchstart"&&n!=="touchmove"&&n!=="wheel"||(i=!0),t?i!==void 0?e.addEventListener(n,a,{capture:!0,passive:i}):e.addEventListener(n,a,!0):i!==void 0?e.addEventListener(n,a,{passive:i}):e.addEventListener(n,a,!1)}function rl(e,n,a,t,i){var r=t;if((n&1)==0&&(n&2)==0&&t!==null)e:for(;;){if(t===null)return;var o=t.tag;if(o===3||o===4){var s=t.stateNode.containerInfo;if(s===i||s.nodeType===8&&s.parentNode===i)break;if(o===4)for(o=t.return;o!==null;){var l=o.tag;if((l===3||l===4)&&(l=o.stateNode.containerInfo,l===i||l.nodeType===8&&l.parentNode===i))return;o=o.return}for(;s!==null;){if(o=Rn(s),o===null)return;if(l=o.tag,l===5||l===6){t=r=o;continue e}s=s.parentNode}}t=t.return}lc(function(){var c=r,y=fr(a),v=[];e:{var p=tl.get(e);if(p!==void 0){var w=Rr,G=e;switch(e){case"keypress":if(zt(a)===0)break e;case"keydown":case"keyup":w=xc;break;case"focusin":G="focus",w=Ur;break;case"focusout":G="blur",w=Ur;break;case"beforeblur":case"afterblur":w=Ur;break;case"click":if(a.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":w=ll;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":w=Bc;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":w=jc;break;case $s:case el:case nl:w=Rc;break;case al:w=Jc;break;case"scroll":w=Oc;break;case"wheel":w=Qc;break;case"copy":case"cut":case"paste":w=Dc;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":w=dl}var N=(n&4)!=0,h=!N&&e==="scroll",u=N?p!==null?p+"Capture":null:p;N=[];for(var d=c,f;d!==null;){f=d;var S=f.stateNode;if(f.tag===5&&S!==null&&(f=S,u!==null&&(S=Ua(d,u),S!=null&&N.push($a(d,S,f)))),h)break;d=d.return}0<N.length&&(p=new w(p,G,null,a,y),v.push({event:p,listeners:N}))}}if((n&7)==0){e:{if(p=e==="mouseover"||e==="pointerover",w=e==="mouseout"||e==="pointerout",p&&(n&16)==0&&(G=a.relatedTarget||a.fromElement)&&(Rn(G)||G[sa]))break e;if((w||p)&&(p=y.window===y?y:(p=y.ownerDocument)?p.defaultView||p.parentWindow:window,w?(G=a.relatedTarget||a.toElement,w=c,G=G?Rn(G):null,G!==null&&(h=Gn(G),G!==h||G.tag!==5&&G.tag!==6)&&(G=null)):(w=null,G=c),w!==G)){if(N=ll,S="onMouseLeave",u="onMouseEnter",d="mouse",(e==="pointerout"||e==="pointerover")&&(N=dl,S="onPointerLeave",u="onPointerEnter",d="pointer"),h=w==null?p:ia(w),f=G==null?p:ia(G),p=new N(S,d+"leave",w,a,y),p.target=h,p.relatedTarget=f,S=null,Rn(y)===c&&(N=new N(u,d+"enter",G,a,y),N.target=f,N.relatedTarget=h,S=N),h=S,w&&G)n:{for(N=w,u=G,d=0,f=N;f;f=oa(f))d++;for(f=0,S=u;S;S=oa(S))f++;for(;0<d-f;)N=oa(N),d--;for(;0<f-d;)u=oa(u),f--;for(;d--;){if(N===u||u!==null&&N===u.alternate)break n;N=oa(N),u=oa(u)}N=null}else N=null;w!==null&&Dl(v,p,w,N,!1),G!==null&&h!==null&&Dl(v,h,G,N,!0)}}e:{if(p=c?ia(c):window,w=p.nodeName&&p.nodeName.toLowerCase(),w==="select"||w==="input"&&p.type==="file")var R=ah;else if(pl(p))if(kl)R=oh;else{R=ih;var M=th}else(w=p.nodeName)&&w.toLowerCase()==="input"&&(p.type==="checkbox"||p.type==="radio")&&(R=rh);if(R&&(R=R(e,c))){Sl(v,R,a,y);break e}M&&M(e,p,c),e==="focusout"&&(M=p._wrapperState)&&M.controlled&&p.type==="number"&&sr(p,"number",p.value)}switch(M=c?ia(c):window,e){case"focusin":(pl(M)||M.contentEditable==="true")&&(ra=M,br=c,Za=null);break;case"focusout":Za=br=ra=null;break;case"mousedown":xr=!0;break;case"contextmenu":case"mouseup":case"dragend":xr=!1,wl(v,a,y);break;case"selectionchange":if(uh)break;case"keydown":case"keyup":wl(v,a,y)}var B;if(Fr)e:{switch(e){case"compositionstart":var D="onCompositionStart";break e;case"compositionend":D="onCompositionEnd";break e;case"compositionupdate":D="onCompositionUpdate";break e}D=void 0}else ta?ml(e,a)&&(D="onCompositionEnd"):e==="keydown"&&a.keyCode===229&&(D="onCompositionStart");D&&(cl&&a.locale!=="ko"&&(ta||D!=="onCompositionStart"?D==="onCompositionEnd"&&ta&&(B=ol()):(sn=y,Gr="value"in sn?sn.value:sn.textContent,ta=!0)),M=Qt(c,D),0<M.length&&(D=new ul(D,e,null,a,y),v.push({event:D,listeners:M}),B?D.data=B:(B=fl(a),B!==null&&(D.data=B)))),(B=Zc?Xc(e,a):$c(e,a))&&(c=Qt(c,"onBeforeInput"),0<c.length&&(y=new ul("onBeforeInput","beforeinput",null,a,y),v.push({event:y,listeners:c}),y.data=B))}yl(v,n)})}function $a(e,n,a){return{instance:e,listener:n,currentTarget:a}}function Qt(e,n){for(var a=n+"Capture",t=[];e!==null;){var i=e,r=i.stateNode;i.tag===5&&r!==null&&(i=r,r=Ua(e,a),r!=null&&t.unshift($a(e,r,i)),r=Ua(e,n),r!=null&&t.push($a(e,r,i))),e=e.return}return t}function oa(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function Dl(e,n,a,t,i){for(var r=n._reactName,o=[];a!==null&&a!==t;){var s=a,l=s.alternate,c=s.stateNode;if(l!==null&&l===t)break;s.tag===5&&c!==null&&(s=c,i?(l=Ua(a,r),l!=null&&o.unshift($a(a,l,s))):i||(l=Ua(a,r),l!=null&&o.push($a(a,l,s)))),a=a.return}o.length!==0&&e.push({event:n,listeners:o})}function $t(){}var Vr=null,jr=null;function Pl(e,n){switch(e){case"button":case"input":case"select":case"textarea":return!!n.autoFocus}return!1}function zr(e,n){return e==="textarea"||e==="option"||e==="noscript"||typeof n.children=="string"||typeof n.children=="number"||typeof n.dangerouslySetInnerHTML=="object"&&n.dangerouslySetInnerHTML!==null&&n.dangerouslySetInnerHTML.__html!=null}var Ul=typeof setTimeout=="function"?setTimeout:void 0,dh=typeof clearTimeout=="function"?clearTimeout:void 0;function Jr(e){e.nodeType===1?e.textContent="":e.nodeType===9&&(e=e.body,e!=null&&(e.textContent=""))}function la(e){for(;e!=null;e=e.nextSibling){var n=e.nodeType;if(n===1||n===3)break}return e}function Fl(e){e=e.previousSibling;for(var n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="$"||a==="$!"||a==="$?"){if(n===0)return e;n--}else a==="/$"&&n++}e=e.previousSibling}return null}var _r=0;function ch(e){return{$$typeof:nr,toString:e,valueOf:e}}var ei=Math.random().toString(36).slice(2),ln="__reactFiber$"+ei,ni="__reactProps$"+ei,sa="__reactContainer$"+ei,Hl="__reactEvents$"+ei;function Rn(e){var n=e[ln];if(n)return n;for(var a=e.parentNode;a;){if(n=a[sa]||a[ln]){if(a=n.alternate,n.child!==null||a!==null&&a.child!==null)for(e=Fl(e);e!==null;){if(a=e[ln])return a;e=Fl(e)}return n}e=a,a=e.parentNode}return null}function Pa(e){return e=e[ln]||e[sa],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function ia(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(T(33))}function Pt(e){return e[ni]||null}function Wl(e){var n=e[Hl];return n===void 0&&(n=e[Hl]=new Set),n}var Qr=[],ua=-1;function un(e){return{current:e}}function _(e){0>ua||(e.current=Qr[ua],Qr[ua]=null,ua--)}function Z(e,n){ua++,Qr[ua]=e.current,e.current=n}var dn={},ce=un(dn),ke=un(!1),Ln=dn;function da(e,n){var a=e.type.contextTypes;if(!a)return dn;var t=e.stateNode;if(t&&t.__reactInternalMemoizedUnmaskedChildContext===n)return t.__reactInternalMemoizedMaskedChildContext;var i={},r;for(r in a)i[r]=n[r];return t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=i),i}function Ie(e){return e=e.childContextTypes,e!=null}function ai(){_(ke),_(ce)}function Kl(e,n,a){if(ce.current!==dn)throw Error(T(168));Z(ce,n),Z(ke,a)}function bl(e,n,a){var t=e.stateNode;if(e=n.childContextTypes,typeof t.getChildContext!="function")return a;t=t.getChildContext();for(var i in t)if(!(i in e))throw Error(T(108,_n(n)||"Unknown",i));return Y({},a,t)}function ti(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||dn,Ln=ce.current,Z(ce,e),Z(ke,ke.current),!0}function xl(e,n,a){var t=e.stateNode;if(!t)throw Error(T(169));a?(e=bl(e,n,Ln),t.__reactInternalMemoizedMergedChildContext=e,_(ke),_(ce),Z(ce,e)):_(ke),Z(ke,a)}var qr=null,Dn=null,hh=ne.unstable_runWithPriority,Zr=ne.unstable_scheduleCallback,Xr=ne.unstable_cancelCallback,gh=ne.unstable_shouldYield,Yl=ne.unstable_requestPaint,$r=ne.unstable_now,mh=ne.unstable_getCurrentPriorityLevel,ii=ne.unstable_ImmediatePriority,Vl=ne.unstable_UserBlockingPriority,jl=ne.unstable_NormalPriority,zl=ne.unstable_LowPriority,Jl=ne.unstable_IdlePriority,eo={},fh=Yl!==void 0?Yl:function(){},je=null,ri=null,no=!1,_l=$r(),he=1e4>_l?$r:function(){return $r()-_l};function ca(){switch(mh()){case ii:return 99;case Vl:return 98;case jl:return 97;case zl:return 96;case Jl:return 95;default:throw Error(T(332))}}function Ql(e){switch(e){case 99:return ii;case 98:return Vl;case 97:return jl;case 96:return zl;case 95:return Jl;default:throw Error(T(332))}}function Pn(e,n){return e=Ql(e),hh(e,n)}function et(e,n,a){return e=Ql(e),Zr(e,n,a)}function Pe(){if(ri!==null){var e=ri;ri=null,Xr(e)}ql()}function ql(){if(!no&&je!==null){no=!0;var e=0;try{var n=je;Pn(99,function(){for(;e<n.length;e++){var a=n[e];do a=a(!0);while(a!==null)}}),je=null}catch(a){throw je!==null&&(je=je.slice(e+1)),Zr(ii,Pe),a}finally{no=!1}}}var ph=Nn.ReactCurrentBatchConfig;function Ge(e,n){if(e&&e.defaultProps){n=Y({},n),e=e.defaultProps;for(var a in e)n[a]===void 0&&(n[a]=e[a]);return n}return n}var oi=un(null),si=null,ha=null,li=null;function ao(){li=ha=si=null}function to(e){var n=oi.current;_(oi),e.type._context._currentValue=n}function Zl(e,n){for(;e!==null;){var a=e.alternate;if((e.childLanes&n)===n){if(a===null||(a.childLanes&n)===n)break;a.childLanes|=n}else e.childLanes|=n,a!==null&&(a.childLanes|=n);e=e.return}}function ga(e,n){si=e,li=ha=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&n)!=0&&(Re=!0),e.firstContext=null)}function Oe(e,n){if(li!==e&&n!==!1&&n!==0)if((typeof n!="number"||n===1073741823)&&(li=e,n=1073741823),n={context:e,observedBits:n,next:null},ha===null){if(si===null)throw Error(T(308));ha=n,si.dependencies={lanes:0,firstContext:n,responders:null}}else ha=ha.next=n;return e._currentValue}var cn=!1;function io(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null},effects:null}}function Xl(e,n){e=e.updateQueue,n.updateQueue===e&&(n.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function hn(e,n){return{eventTime:e,lane:n,tag:0,payload:null,callback:null,next:null}}function gn(e,n){if(e=e.updateQueue,e!==null){e=e.shared;var a=e.pending;a===null?n.next=n:(n.next=a.next,a.next=n),e.pending=n}}function $l(e,n){var a=e.updateQueue,t=e.alternate;if(t!==null&&(t=t.updateQueue,a===t)){var i=null,r=null;if(a=a.firstBaseUpdate,a!==null){do{var o={eventTime:a.eventTime,lane:a.lane,tag:a.tag,payload:a.payload,callback:a.callback,next:null};r===null?i=r=o:r=r.next=o,a=a.next}while(a!==null);r===null?i=r=n:r=r.next=n}else i=r=n;a={baseState:t.baseState,firstBaseUpdate:i,lastBaseUpdate:r,shared:t.shared,effects:t.effects},e.updateQueue=a;return}e=a.lastBaseUpdate,e===null?a.firstBaseUpdate=n:e.next=n,a.lastBaseUpdate=n}function at(e,n,a,t){var i=e.updateQueue;cn=!1;var r=i.firstBaseUpdate,o=i.lastBaseUpdate,s=i.shared.pending;if(s!==null){i.shared.pending=null;var l=s,c=l.next;l.next=null,o===null?r=c:o.next=c,o=l;var y=e.alternate;if(y!==null){y=y.updateQueue;var v=y.lastBaseUpdate;v!==o&&(v===null?y.firstBaseUpdate=c:v.next=c,y.lastBaseUpdate=l)}}if(r!==null){v=i.baseState,o=0,y=c=l=null;do{s=r.lane;var p=r.eventTime;if((t&s)===s){y!==null&&(y=y.next={eventTime:p,lane:0,tag:r.tag,payload:r.payload,callback:r.callback,next:null});e:{var w=e,G=r;switch(s=n,p=a,G.tag){case 1:if(w=G.payload,typeof w=="function"){v=w.call(p,v,s);break e}v=w;break e;case 3:w.flags=w.flags&-4097|64;case 0:if(w=G.payload,s=typeof w=="function"?w.call(p,v,s):w,s==null)break e;v=Y({},v,s);break e;case 2:cn=!0}}r.callback!==null&&(e.flags|=32,s=i.effects,s===null?i.effects=[r]:s.push(r))}else p={eventTime:p,lane:s,tag:r.tag,payload:r.payload,callback:r.callback,next:null},y===null?(c=y=p,l=v):y=y.next=p,o|=s;if(r=r.next,r===null){if(s=i.shared.pending,s===null)break;r=s.next,s.next=null,i.lastBaseUpdate=s,i.shared.pending=null}}while(1);y===null&&(l=v),i.baseState=l,i.firstBaseUpdate=c,i.lastBaseUpdate=y,nt|=o,e.lanes=o,e.memoizedState=v}}function eu(e,n,a){if(e=n.effects,n.effects=null,e!==null)for(n=0;n<e.length;n++){var t=e[n],i=t.callback;if(i!==null){if(t.callback=null,t=a,typeof i!="function")throw Error(T(191,i));i.call(t)}}}var nu=new b.Component().refs;function ui(e,n,a,t){n=e.memoizedState,a=a(t,n),a=a==null?n:Y({},n,a),e.memoizedState=a,e.lanes===0&&(e.updateQueue.baseState=a)}var di={isMounted:function(e){return(e=e._reactInternals)?Gn(e)===e:!1},enqueueSetState:function(e,n,a){e=e._reactInternals;var t=ve(),i=mn(e),r=hn(t,i);r.payload=n,a!=null&&(r.callback=a),gn(e,r),fn(e,i,t)},enqueueReplaceState:function(e,n,a){e=e._reactInternals;var t=ve(),i=mn(e),r=hn(t,i);r.tag=1,r.payload=n,a!=null&&(r.callback=a),gn(e,r),fn(e,i,t)},enqueueForceUpdate:function(e,n){e=e._reactInternals;var a=ve(),t=mn(e),i=hn(a,t);i.tag=2,n!=null&&(i.callback=n),gn(e,i),fn(e,t,a)}};function au(e,n,a,t,i,r,o){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(t,r,o):n.prototype&&n.prototype.isPureReactComponent?!qa(a,t)||!qa(i,r):!0}function tu(e,n,a){var t=!1,i=dn,r=n.contextType;return typeof r=="object"&&r!==null?r=Oe(r):(i=Ie(n)?Ln:ce.current,t=n.contextTypes,r=(t=t!=null)?da(e,i):dn),n=new n(a,r),e.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,n.updater=di,e.stateNode=n,n._reactInternals=e,t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=i,e.__reactInternalMemoizedMaskedChildContext=r),n}function iu(e,n,a,t){e=n.state,typeof n.componentWillReceiveProps=="function"&&n.componentWillReceiveProps(a,t),typeof n.UNSAFE_componentWillReceiveProps=="function"&&n.UNSAFE_componentWillReceiveProps(a,t),n.state!==e&&di.enqueueReplaceState(n,n.state,null)}function ro(e,n,a,t){var i=e.stateNode;i.props=a,i.state=e.memoizedState,i.refs=nu,io(e);var r=n.contextType;typeof r=="object"&&r!==null?i.context=Oe(r):(r=Ie(n)?Ln:ce.current,i.context=da(e,r)),at(e,a,i,t),i.state=e.memoizedState,r=n.getDerivedStateFromProps,typeof r=="function"&&(ui(e,n,r,a),i.state=e.memoizedState),typeof n.getDerivedStateFromProps=="function"||typeof i.getSnapshotBeforeUpdate=="function"||typeof i.UNSAFE_componentWillMount!="function"&&typeof i.componentWillMount!="function"||(n=i.state,typeof i.componentWillMount=="function"&&i.componentWillMount(),typeof i.UNSAFE_componentWillMount=="function"&&i.UNSAFE_componentWillMount(),n!==i.state&&di.enqueueReplaceState(i,i.state,null),at(e,a,i,t),i.state=e.memoizedState),typeof i.componentDidMount=="function"&&(e.flags|=4)}var ci=Array.isArray;function tt(e,n,a){if(e=a.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(a._owner){if(a=a._owner,a){if(a.tag!==1)throw Error(T(309));var t=a.stateNode}if(!t)throw Error(T(147,e));var i=""+e;return n!==null&&n.ref!==null&&typeof n.ref=="function"&&n.ref._stringRef===i?n.ref:(n=function(r){var o=t.refs;o===nu&&(o=t.refs={}),r===null?delete o[i]:o[i]=r},n._stringRef=i,n)}if(typeof e!="string")throw Error(T(284));if(!a._owner)throw Error(T(290,e))}return e}function hi(e,n){if(e.type!=="textarea")throw Error(T(31,Object.prototype.toString.call(n)==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":n))}function ru(e){function n(h,u){if(e){var d=h.lastEffect;d!==null?(d.nextEffect=u,h.lastEffect=u):h.firstEffect=h.lastEffect=u,u.nextEffect=null,u.flags=8}}function a(h,u){if(!e)return null;for(;u!==null;)n(h,u),u=u.sibling;return null}function t(h,u){for(h=new Map;u!==null;)u.key!==null?h.set(u.key,u):h.set(u.index,u),u=u.sibling;return h}function i(h,u){return h=pn(h,u),h.index=0,h.sibling=null,h}function r(h,u,d){return h.index=d,e?(d=h.alternate,d!==null?(d=d.index,d<u?(h.flags=2,u):d):(h.flags=2,u)):u}function o(h){return e&&h.alternate===null&&(h.flags=2),h}function s(h,u,d,f){return u===null||u.tag!==6?(u=oo(d,h.mode,f),u.return=h,u):(u=i(u,d),u.return=h,u)}function l(h,u,d,f){return u!==null&&u.elementType===d.type?(f=i(u,d.props),f.ref=tt(h,u,d),f.return=h,f):(f=gi(d.type,d.key,d.props,null,h.mode,f),f.ref=tt(h,u,d),f.return=h,f)}function c(h,u,d,f){return u===null||u.tag!==4||u.stateNode.containerInfo!==d.containerInfo||u.stateNode.implementation!==d.implementation?(u=so(d,h.mode,f),u.return=h,u):(u=i(u,d.children||[]),u.return=h,u)}function y(h,u,d,f,S){return u===null||u.tag!==7?(u=ma(d,h.mode,f,S),u.return=h,u):(u=i(u,d),u.return=h,u)}function v(h,u,d){if(typeof u=="string"||typeof u=="number")return u=oo(""+u,h.mode,d),u.return=h,u;if(typeof u=="object"&&u!==null){switch(u.$$typeof){case Na:return d=gi(u.type,u.key,u.props,null,h.mode,d),d.ref=tt(h,null,u),d.return=h,d;case Bn:return u=so(u,h.mode,d),u.return=h,u}if(ci(u)||Ga(u))return u=ma(u,h.mode,d,null),u.return=h,u;hi(h,u)}return null}function p(h,u,d,f){var S=u!==null?u.key:null;if(typeof d=="string"||typeof d=="number")return S!==null?null:s(h,u,""+d,f);if(typeof d=="object"&&d!==null){switch(d.$$typeof){case Na:return d.key===S?d.type===en?y(h,u,d.props.children,f,S):l(h,u,d,f):null;case Bn:return d.key===S?c(h,u,d,f):null}if(ci(d)||Ga(d))return S!==null?null:y(h,u,d,f,null);hi(h,d)}return null}function w(h,u,d,f,S){if(typeof f=="string"||typeof f=="number")return h=h.get(d)||null,s(u,h,""+f,S);if(typeof f=="object"&&f!==null){switch(f.$$typeof){case Na:return h=h.get(f.key===null?d:f.key)||null,f.type===en?y(u,h,f.props.children,S,f.key):l(u,h,f,S);case Bn:return h=h.get(f.key===null?d:f.key)||null,c(u,h,f,S)}if(ci(f)||Ga(f))return h=h.get(d)||null,y(u,h,f,S,null);hi(u,f)}return null}function G(h,u,d,f){for(var S=null,R=null,M=u,B=u=0,D=null;M!==null&&B<d.length;B++){M.index>B?(D=M,M=null):D=M.sibling;var L=p(h,M,d[B],f);if(L===null){M===null&&(M=D);break}e&&M&&L.alternate===null&&n(h,M),u=r(L,u,B),R===null?S=L:R.sibling=L,R=L,M=D}if(B===d.length)return a(h,M),S;if(M===null){for(;B<d.length;B++)M=v(h,d[B],f),M!==null&&(u=r(M,u,B),R===null?S=M:R.sibling=M,R=M);return S}for(M=t(h,M);B<d.length;B++)D=w(M,h,B,d[B],f),D!==null&&(e&&D.alternate!==null&&M.delete(D.key===null?B:D.key),u=r(D,u,B),R===null?S=D:R.sibling=D,R=D);return e&&M.forEach(function(q){return n(h,q)}),S}function N(h,u,d,f){var S=Ga(d);if(typeof S!="function")throw Error(T(150));if(d=S.call(d),d==null)throw Error(T(151));for(var R=S=null,M=u,B=u=0,D=null,L=d.next();M!==null&&!L.done;B++,L=d.next()){M.index>B?(D=M,M=null):D=M.sibling;var q=p(h,M,L.value,f);if(q===null){M===null&&(M=D);break}e&&M&&q.alternate===null&&n(h,M),u=r(q,u,B),R===null?S=q:R.sibling=q,R=q,M=D}if(L.done)return a(h,M),S;if(M===null){for(;!L.done;B++,L=d.next())L=v(h,L.value,f),L!==null&&(u=r(L,u,B),R===null?S=L:R.sibling=L,R=L);return S}for(M=t(h,M);!L.done;B++,L=d.next())L=w(M,h,B,L.value,f),L!==null&&(e&&L.alternate!==null&&M.delete(L.key===null?B:L.key),u=r(L,u,B),R===null?S=L:R.sibling=L,R=L);return e&&M.forEach(function(ye){return n(h,ye)}),S}return function(h,u,d,f){var S=typeof d=="object"&&d!==null&&d.type===en&&d.key===null;S&&(d=d.props.children);var R=typeof d=="object"&&d!==null;if(R)switch(d.$$typeof){case Na:e:{for(R=d.key,S=u;S!==null;){if(S.key===R){switch(S.tag){case 7:if(d.type===en){a(h,S.sibling),u=i(S,d.props.children),u.return=h,h=u;break e}break;default:if(S.elementType===d.type){a(h,S.sibling),u=i(S,d.props),u.ref=tt(h,S,d),u.return=h,h=u;break e}}a(h,S);break}else n(h,S);S=S.sibling}d.type===en?(u=ma(d.props.children,h.mode,f,d.key),u.return=h,h=u):(f=gi(d.type,d.key,d.props,null,h.mode,f),f.ref=tt(h,u,d),f.return=h,h=f)}return o(h);case Bn:e:{for(S=d.key;u!==null;){if(u.key===S)if(u.tag===4&&u.stateNode.containerInfo===d.containerInfo&&u.stateNode.implementation===d.implementation){a(h,u.sibling),u=i(u,d.children||[]),u.return=h,h=u;break e}else{a(h,u);break}else n(h,u);u=u.sibling}u=so(d,h.mode,f),u.return=h,h=u}return o(h)}if(typeof d=="string"||typeof d=="number")return d=""+d,u!==null&&u.tag===6?(a(h,u.sibling),u=i(u,d),u.return=h,h=u):(a(h,u),u=oo(d,h.mode,f),u.return=h,h=u),o(h);if(ci(d))return G(h,u,d,f);if(Ga(d))return N(h,u,d,f);if(R&&hi(h,d),typeof d=="undefined"&&!S)switch(h.tag){case 1:case 22:case 0:case 11:case 15:throw Error(T(152,_n(h.type)||"Component"))}return a(h,u)}}var mi=ru(!0),ou=ru(!1),it={},Ue=un(it),rt=un(it),ot=un(it);function Un(e){if(e===it)throw Error(T(174));return e}function lo(e,n){switch(Z(ot,n),Z(rt,e),Z(Ue,it),e=n.nodeType,e){case 9:case 11:n=(n=n.documentElement)?n.namespaceURI:hr(null,"");break;default:e=e===8?n.parentNode:n,n=e.namespaceURI||null,e=e.tagName,n=hr(n,e)}_(Ue),Z(Ue,n)}function fa(){_(Ue),_(rt),_(ot)}function su(e){Un(ot.current);var n=Un(Ue.current),a=hr(n,e.type);n!==a&&(Z(rt,e),Z(Ue,a))}function uo(e){rt.current===e&&(_(Ue),_(rt))}var X=un(0);function fi(e){for(var n=e;n!==null;){if(n.tag===13){var a=n.memoizedState;if(a!==null&&(a=a.dehydrated,a===null||a.data==="$?"||a.data==="$!"))return n}else if(n.tag===19&&n.memoizedProps.revealOrder!==void 0){if((n.flags&64)!=0)return n}else if(n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}return null}var ze=null,Sn=null,Fe=!1;function lu(e,n){var a=Ne(5,null,null,0);a.elementType="DELETED",a.type="DELETED",a.stateNode=n,a.return=e,a.flags=8,e.lastEffect!==null?(e.lastEffect.nextEffect=a,e.lastEffect=a):e.firstEffect=e.lastEffect=a}function uu(e,n){switch(e.tag){case 5:var a=e.type;return n=n.nodeType!==1||a.toLowerCase()!==n.nodeName.toLowerCase()?null:n,n!==null?(e.stateNode=n,!0):!1;case 6:return n=e.pendingProps===""||n.nodeType!==3?null:n,n!==null?(e.stateNode=n,!0):!1;case 13:return!1;default:return!1}}function co(e){if(Fe){var n=Sn;if(n){var a=n;if(!uu(e,n)){if(n=la(a.nextSibling),!n||!uu(e,n)){e.flags=e.flags&-1025|2,Fe=!1,ze=e;return}lu(ze,a)}ze=e,Sn=la(n.firstChild)}else e.flags=e.flags&-1025|2,Fe=!1,ze=e}}function du(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;ze=e}function pi(e){if(e!==ze)return!1;if(!Fe)return du(e),Fe=!0,!1;var n=e.type;if(e.tag!==5||n!=="head"&&n!=="body"&&!zr(n,e.memoizedProps))for(n=Sn;n;)lu(e,n),n=la(n.nextSibling);if(du(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(T(317));e:{for(e=e.nextSibling,n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="/$"){if(n===0){Sn=la(e.nextSibling);break e}n--}else a!=="$"&&a!=="$!"&&a!=="$?"||n++}e=e.nextSibling}Sn=null}}else Sn=ze?la(e.stateNode.nextSibling):null;return!0}function ho(){Sn=ze=null,Fe=!1}var pa=[];function go(){for(var e=0;e<pa.length;e++)pa[e]._workInProgressVersionPrimary=null;pa.length=0}var st=Nn.ReactCurrentDispatcher,Be=Nn.ReactCurrentBatchConfig,lt=0,$=null,ge=null,ue=null,Si=!1,ut=!1;function Te(){throw Error(T(321))}function mo(e,n){if(n===null)return!1;for(var a=0;a<n.length&&a<e.length;a++)if(!Ce(e[a],n[a]))return!1;return!0}function fo(e,n,a,t,i,r){if(lt=r,$=n,n.memoizedState=null,n.updateQueue=null,n.lanes=0,st.current=e===null||e.memoizedState===null?Sh:yh,e=a(t,i),ut){r=0;do{if(ut=!1,!(25>r))throw Error(T(301));r+=1,ue=ge=null,n.updateQueue=null,st.current=kh,e=a(t,i)}while(ut)}if(st.current=yi,n=ge!==null&&ge.next!==null,lt=0,ue=ge=$=null,Si=!1,n)throw Error(T(300));return e}function Fn(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return ue===null?$.memoizedState=ue=e:ue=ue.next=e,ue}function Hn(){if(ge===null){var e=$.alternate;e=e!==null?e.memoizedState:null}else e=ge.next;var n=ue===null?$.memoizedState:ue.next;if(n!==null)ue=n,ge=e;else{if(e===null)throw Error(T(310));ge=e,e={memoizedState:ge.memoizedState,baseState:ge.baseState,baseQueue:ge.baseQueue,queue:ge.queue,next:null},ue===null?$.memoizedState=ue=e:ue=ue.next=e}return ue}function He(e,n){return typeof n=="function"?n(e):n}function dt(e){var n=Hn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=ge,i=t.baseQueue,r=a.pending;if(r!==null){if(i!==null){var o=i.next;i.next=r.next,r.next=o}t.baseQueue=i=r,a.pending=null}if(i!==null){i=i.next,t=t.baseState;var s=o=r=null,l=i;do{var c=l.lane;if((lt&c)===c)s!==null&&(s=s.next={lane:0,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null}),t=l.eagerReducer===e?l.eagerState:e(t,l.action);else{var y={lane:c,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null};s===null?(o=s=y,r=t):s=s.next=y,$.lanes|=c,nt|=c}l=l.next}while(l!==null&&l!==i);s===null?r=t:s.next=o,Ce(t,n.memoizedState)||(Re=!0),n.memoizedState=t,n.baseState=r,n.baseQueue=s,a.lastRenderedState=t}return[n.memoizedState,a.dispatch]}function ct(e){var n=Hn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=a.dispatch,i=a.pending,r=n.memoizedState;if(i!==null){a.pending=null;var o=i=i.next;do r=e(r,o.action),o=o.next;while(o!==i);Ce(r,n.memoizedState)||(Re=!0),n.memoizedState=r,n.baseQueue===null&&(n.baseState=r),a.lastRenderedState=r}return[r,t]}function cu(e,n,a){var t=n._getVersion;t=t(n._source);var i=n._workInProgressVersionPrimary;if(i!==null?e=i===t:(e=e.mutableReadLanes,(e=(lt&e)===e)&&(n._workInProgressVersionPrimary=t,pa.push(n))),e)return a(n._source);throw pa.push(n),Error(T(350))}function hu(e,n,a,t){var i=pe;if(i===null)throw Error(T(349));var r=n._getVersion,o=r(n._source),s=st.current,l=s.useState(function(){return cu(i,n,a)}),c=l[1],y=l[0];l=ue;var v=e.memoizedState,p=v.refs,w=p.getSnapshot,G=v.source;v=v.subscribe;var N=$;return e.memoizedState={refs:p,source:n,subscribe:t},s.useEffect(function(){p.getSnapshot=a,p.setSnapshot=c;var h=r(n._source);if(!Ce(o,h)){h=a(n._source),Ce(y,h)||(c(h),h=mn(N),i.mutableReadLanes|=h&i.pendingLanes),h=i.mutableReadLanes,i.entangledLanes|=h;for(var u=i.entanglements,d=h;0<d;){var f=31-on(d),S=1<<f;u[f]|=h,d&=~S}}},[a,n,t]),s.useEffect(function(){return t(n._source,function(){var h=p.getSnapshot,u=p.setSnapshot;try{u(h(n._source));var d=mn(N);i.mutableReadLanes|=d&i.pendingLanes}catch(f){u(function(){throw f})}})},[n,t]),Ce(w,a)&&Ce(G,n)&&Ce(v,t)||(e={pending:null,dispatch:null,lastRenderedReducer:He,lastRenderedState:y},e.dispatch=c=po.bind(null,$,e),l.queue=e,l.baseQueue=null,y=cu(i,n,a),l.memoizedState=l.baseState=y),y}function gu(e,n,a){var t=Hn();return hu(t,e,n,a)}function ht(e){var n=Fn();return typeof e=="function"&&(e=e()),n.memoizedState=n.baseState=e,e=n.queue={pending:null,dispatch:null,lastRenderedReducer:He,lastRenderedState:e},e=e.dispatch=po.bind(null,$,e),[n.memoizedState,e]}function ki(e,n,a,t){return e={tag:e,create:n,destroy:a,deps:t,next:null},n=$.updateQueue,n===null?(n={lastEffect:null},$.updateQueue=n,n.lastEffect=e.next=e):(a=n.lastEffect,a===null?n.lastEffect=e.next=e:(t=a.next,a.next=e,e.next=t,n.lastEffect=e)),e}function mu(e){var n=Fn();return e={current:e},n.memoizedState=e}function Ii(){return Hn().memoizedState}function So(e,n,a,t){var i=Fn();$.flags|=e,i.memoizedState=ki(1|n,a,void 0,t===void 0?null:t)}function yo(e,n,a,t){var i=Hn();t=t===void 0?null:t;var r=void 0;if(ge!==null){var o=ge.memoizedState;if(r=o.destroy,t!==null&&mo(t,o.deps)){ki(n,a,r,t);return}}$.flags|=e,i.memoizedState=ki(1|n,a,r,t)}function fu(e,n){return So(516,4,e,n)}function Ti(e,n){return yo(516,4,e,n)}function pu(e,n){return yo(4,2,e,n)}function Su(e,n){if(typeof n=="function")return e=e(),n(e),function(){n(null)};if(n!=null)return e=e(),n.current=e,function(){n.current=null}}function yu(e,n,a){return a=a!=null?a.concat([e]):null,yo(4,2,Su.bind(null,n,e),a)}function ko(){}function ku(e,n){var a=Hn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&mo(n,t[1])?t[0]:(a.memoizedState=[e,n],e)}function Iu(e,n){var a=Hn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&mo(n,t[1])?t[0]:(e=e(),a.memoizedState=[e,n],e)}function Ih(e,n){var a=ca();Pn(98>a?98:a,function(){e(!0)}),Pn(97<a?97:a,function(){var t=Be.transition;Be.transition=1;try{e(!1),n()}finally{Be.transition=t}})}function po(e,n,a){var t=ve(),i=mn(e),r={lane:i,action:a,eagerReducer:null,eagerState:null,next:null},o=n.pending;if(o===null?r.next=r:(r.next=o.next,o.next=r),n.pending=r,o=e.alternate,e===$||o!==null&&o===$)ut=Si=!0;else{if(e.lanes===0&&(o===null||o.lanes===0)&&(o=n.lastRenderedReducer,o!==null))try{var s=n.lastRenderedState,l=o(s,a);if(r.eagerReducer=o,r.eagerState=l,Ce(l,s))return}catch(c){}finally{}fn(e,i,t)}}var yi={readContext:Oe,useCallback:Te,useContext:Te,useEffect:Te,useImperativeHandle:Te,useLayoutEffect:Te,useMemo:Te,useReducer:Te,useRef:Te,useState:Te,useDebugValue:Te,useDeferredValue:Te,useTransition:Te,useMutableSource:Te,useOpaqueIdentifier:Te,unstable_isNewReconciler:!1},Sh={readContext:Oe,useCallback:function(e,n){return Fn().memoizedState=[e,n===void 0?null:n],e},useContext:Oe,useEffect:fu,useImperativeHandle:function(e,n,a){return a=a!=null?a.concat([e]):null,So(4,2,Su.bind(null,n,e),a)},useLayoutEffect:function(e,n){return So(4,2,e,n)},useMemo:function(e,n){var a=Fn();return n=n===void 0?null:n,e=e(),a.memoizedState=[e,n],e},useReducer:function(e,n,a){var t=Fn();return n=a!==void 0?a(n):n,t.memoizedState=t.baseState=n,e=t.queue={pending:null,dispatch:null,lastRenderedReducer:e,lastRenderedState:n},e=e.dispatch=po.bind(null,$,e),[t.memoizedState,e]},useRef:mu,useState:ht,useDebugValue:ko,useDeferredValue:function(e){var n=ht(e),a=n[0],t=n[1];return fu(function(){var i=Be.transition;Be.transition=1;try{t(e)}finally{Be.transition=i}},[e]),a},useTransition:function(){var e=ht(!1),n=e[0];return e=Ih.bind(null,e[1]),mu(e),[e,n]},useMutableSource:function(e,n,a){var t=Fn();return t.memoizedState={refs:{getSnapshot:n,setSnapshot:null},source:e,subscribe:a},hu(t,e,n,a)},useOpaqueIdentifier:function(){if(Fe){var e=!1,n=ch(function(){throw e||(e=!0,a("r:"+(_r++).toString(36))),Error(T(355))}),a=ht(n)[1];return($.mode&2)==0&&($.flags|=516,ki(5,function(){a("r:"+(_r++).toString(36))},void 0,null)),n}return n="r:"+(_r++).toString(36),ht(n),n},unstable_isNewReconciler:!1},yh={readContext:Oe,useCallback:ku,useContext:Oe,useEffect:Ti,useImperativeHandle:yu,useLayoutEffect:pu,useMemo:Iu,useReducer:dt,useRef:Ii,useState:function(){return dt(He)},useDebugValue:ko,useDeferredValue:function(e){var n=dt(He),a=n[0],t=n[1];return Ti(function(){var i=Be.transition;Be.transition=1;try{t(e)}finally{Be.transition=i}},[e]),a},useTransition:function(){var e=dt(He)[0];return[Ii().current,e]},useMutableSource:gu,useOpaqueIdentifier:function(){return dt(He)[0]},unstable_isNewReconciler:!1},kh={readContext:Oe,useCallback:ku,useContext:Oe,useEffect:Ti,useImperativeHandle:yu,useLayoutEffect:pu,useMemo:Iu,useReducer:ct,useRef:Ii,useState:function(){return ct(He)},useDebugValue:ko,useDeferredValue:function(e){var n=ct(He),a=n[0],t=n[1];return Ti(function(){var i=Be.transition;Be.transition=1;try{t(e)}finally{Be.transition=i}},[e]),a},useTransition:function(){var e=ct(He)[0];return[Ii().current,e]},useMutableSource:gu,useOpaqueIdentifier:function(){return ct(He)[0]},unstable_isNewReconciler:!1},Th=Nn.ReactCurrentOwner,Re=!1;function Ae(e,n,a,t){n.child=e===null?ou(n,null,a,t):mi(n,e.child,a,t)}function Tu(e,n,a,t,i){a=a.render;var r=n.ref;return ga(n,i),t=fo(e,n,a,t,r,i),e!==null&&!Re?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,Je(e,n,i)):(n.flags|=1,Ae(e,n,t,i),n.child)}function Eu(e,n,a,t,i,r){if(e===null){var o=a.type;return typeof o=="function"&&!Io(o)&&o.defaultProps===void 0&&a.compare===null&&a.defaultProps===void 0?(n.tag=15,n.type=o,Au(e,n,o,t,i,r)):(e=gi(a.type,null,t,n,n.mode,r),e.ref=n.ref,e.return=n,n.child=e)}return o=e.child,(i&r)==0&&(i=o.memoizedProps,a=a.compare,a=a!==null?a:qa,a(i,t)&&e.ref===n.ref)?Je(e,n,r):(n.flags|=1,e=pn(o,t),e.ref=n.ref,e.return=n,n.child=e)}function Au(e,n,a,t,i,r){if(e!==null&&qa(e.memoizedProps,t)&&e.ref===n.ref)if(Re=!1,(r&i)!=0)(e.flags&16384)!=0&&(Re=!0);else return n.lanes=e.lanes,Je(e,n,r);return To(e,n,a,t,r)}function Ao(e,n,a){var t=n.pendingProps,i=t.children,r=e!==null?e.memoizedState:null;if(t.mode==="hidden"||t.mode==="unstable-defer-without-hiding")if((n.mode&4)==0)n.memoizedState={baseLanes:0},Ai(n,a);else if((a&1073741824)!=0)n.memoizedState={baseLanes:0},Ai(n,r!==null?r.baseLanes:a);else return e=r!==null?r.baseLanes|a:a,n.lanes=n.childLanes=1073741824,n.memoizedState={baseLanes:e},Ai(n,e),null;else r!==null?(t=r.baseLanes|a,n.memoizedState=null):t=a,Ai(n,t);return Ae(e,n,i,a),n.child}function vu(e,n){var a=n.ref;(e===null&&a!==null||e!==null&&e.ref!==a)&&(n.flags|=128)}function To(e,n,a,t,i){var r=Ie(a)?Ln:ce.current;return r=da(n,r),ga(n,i),a=fo(e,n,a,t,r,i),e!==null&&!Re?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,Je(e,n,i)):(n.flags|=1,Ae(e,n,a,i),n.child)}function Mu(e,n,a,t,i){if(Ie(a)){var r=!0;ti(n)}else r=!1;if(ga(n,i),n.stateNode===null)e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),tu(n,a,t),ro(n,a,t,i),t=!0;else if(e===null){var o=n.stateNode,s=n.memoizedProps;o.props=s;var l=o.context,c=a.contextType;typeof c=="object"&&c!==null?c=Oe(c):(c=Ie(a)?Ln:ce.current,c=da(n,c));var y=a.getDerivedStateFromProps,v=typeof y=="function"||typeof o.getSnapshotBeforeUpdate=="function";v||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==t||l!==c)&&iu(n,o,t,c),cn=!1;var p=n.memoizedState;o.state=p,at(n,t,o,i),l=n.memoizedState,s!==t||p!==l||ke.current||cn?(typeof y=="function"&&(ui(n,a,y,t),l=n.memoizedState),(s=cn||au(n,a,s,t,p,l,c))?(v||typeof o.UNSAFE_componentWillMount!="function"&&typeof o.componentWillMount!="function"||(typeof o.componentWillMount=="function"&&o.componentWillMount(),typeof o.UNSAFE_componentWillMount=="function"&&o.UNSAFE_componentWillMount()),typeof o.componentDidMount=="function"&&(n.flags|=4)):(typeof o.componentDidMount=="function"&&(n.flags|=4),n.memoizedProps=t,n.memoizedState=l),o.props=t,o.state=l,o.context=c,t=s):(typeof o.componentDidMount=="function"&&(n.flags|=4),t=!1)}else{o=n.stateNode,Xl(e,n),s=n.memoizedProps,c=n.type===n.elementType?s:Ge(n.type,s),o.props=c,v=n.pendingProps,p=o.context,l=a.contextType,typeof l=="object"&&l!==null?l=Oe(l):(l=Ie(a)?Ln:ce.current,l=da(n,l));var w=a.getDerivedStateFromProps;(y=typeof w=="function"||typeof o.getSnapshotBeforeUpdate=="function")||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==v||p!==l)&&iu(n,o,t,l),cn=!1,p=n.memoizedState,o.state=p,at(n,t,o,i);var G=n.memoizedState;s!==v||p!==G||ke.current||cn?(typeof w=="function"&&(ui(n,a,w,t),G=n.memoizedState),(c=cn||au(n,a,c,t,p,G,l))?(y||typeof o.UNSAFE_componentWillUpdate!="function"&&typeof o.componentWillUpdate!="function"||(typeof o.componentWillUpdate=="function"&&o.componentWillUpdate(t,G,l),typeof o.UNSAFE_componentWillUpdate=="function"&&o.UNSAFE_componentWillUpdate(t,G,l)),typeof o.componentDidUpdate=="function"&&(n.flags|=4),typeof o.getSnapshotBeforeUpdate=="function"&&(n.flags|=256)):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&p===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&p===e.memoizedState||(n.flags|=256),n.memoizedProps=t,n.memoizedState=G),o.props=t,o.state=G,o.context=l,t=c):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&p===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&p===e.memoizedState||(n.flags|=256),t=!1)}return Eo(e,n,a,t,r,i)}function Eo(e,n,a,t,i,r){vu(e,n);var o=(n.flags&64)!=0;if(!t&&!o)return i&&xl(n,a,!1),Je(e,n,r);t=n.stateNode,Th.current=n;var s=o&&typeof a.getDerivedStateFromError!="function"?null:t.render();return n.flags|=1,e!==null&&o?(n.child=mi(n,e.child,null,r),n.child=mi(n,null,s,r)):Ae(e,n,s,r),n.memoizedState=t.state,i&&xl(n,a,!0),n.child}function wu(e){var n=e.stateNode;n.pendingContext?Kl(e,n.pendingContext,n.pendingContext!==n.context):n.context&&Kl(e,n.context,!1),lo(e,n.containerInfo)}var Ei={dehydrated:null,retryLane:0};function Bu(e,n,a){var t=n.pendingProps,i=X.current,r=!1,o;return(o=(n.flags&64)!=0)||(o=e!==null&&e.memoizedState===null?!1:(i&2)!=0),o?(r=!0,n.flags&=-65):e!==null&&e.memoizedState===null||t.fallback===void 0||t.unstable_avoidThisFallback===!0||(i|=1),Z(X,i&1),e===null?(t.fallback!==void 0&&co(n),e=t.children,i=t.fallback,r?(e=Cu(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=Ei,e):typeof t.unstable_expectedLoadTime=="number"?(e=Cu(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=Ei,n.lanes=33554432,e):(a=vo({mode:"visible",children:e},n.mode,a,null),a.return=n,n.child=a)):e.memoizedState!==null?r?(t=Nu(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=Ei,t):(a=Ou(e,n,t.children,a),n.memoizedState=null,a):r?(t=Nu(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=Ei,t):(a=Ou(e,n,t.children,a),n.memoizedState=null,a)}function Cu(e,n,a,t){var i=e.mode,r=e.child;return n={mode:"hidden",children:n},(i&2)==0&&r!==null?(r.childLanes=0,r.pendingProps=n):r=vo(n,i,0,null),a=ma(a,i,t,null),r.return=e,a.return=e,r.sibling=a,e.child=r,a}function Ou(e,n,a,t){var i=e.child;return e=i.sibling,a=pn(i,{mode:"visible",children:a}),(n.mode&2)==0&&(a.lanes=t),a.return=n,a.sibling=null,e!==null&&(e.nextEffect=null,e.flags=8,n.firstEffect=n.lastEffect=e),n.child=a}function Nu(e,n,a,t,i){var r=n.mode,o=e.child;e=o.sibling;var s={mode:"hidden",children:a};return(r&2)==0&&n.child!==o?(a=n.child,a.childLanes=0,a.pendingProps=s,o=a.lastEffect,o!==null?(n.firstEffect=a.firstEffect,n.lastEffect=o,o.nextEffect=null):n.firstEffect=n.lastEffect=null):a=pn(o,s),e!==null?t=pn(e,t):(t=ma(t,r,i,null),t.flags|=2),t.return=n,a.return=n,a.sibling=t,n.child=a,t}function Wu(e,n){e.lanes|=n;var a=e.alternate;a!==null&&(a.lanes|=n),Zl(e.return,n)}function Mo(e,n,a,t,i,r){var o=e.memoizedState;o===null?e.memoizedState={isBackwards:n,rendering:null,renderingStartTime:0,last:t,tail:a,tailMode:i,lastEffect:r}:(o.isBackwards=n,o.rendering=null,o.renderingStartTime=0,o.last=t,o.tail=a,o.tailMode=i,o.lastEffect=r)}function Gu(e,n,a){var t=n.pendingProps,i=t.revealOrder,r=t.tail;if(Ae(e,n,t.children,a),t=X.current,(t&2)!=0)t=t&1|2,n.flags|=64;else{if(e!==null&&(e.flags&64)!=0)e:for(e=n.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&Wu(e,a);else if(e.tag===19)Wu(e,a);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===n)break e;for(;e.sibling===null;){if(e.return===null||e.return===n)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}t&=1}if(Z(X,t),(n.mode&2)==0)n.memoizedState=null;else switch(i){case"forwards":for(a=n.child,i=null;a!==null;)e=a.alternate,e!==null&&fi(e)===null&&(i=a),a=a.sibling;a=i,a===null?(i=n.child,n.child=null):(i=a.sibling,a.sibling=null),Mo(n,!1,i,a,r,n.lastEffect);break;case"backwards":for(a=null,i=n.child,n.child=null;i!==null;){if(e=i.alternate,e!==null&&fi(e)===null){n.child=i;break}e=i.sibling,i.sibling=a,a=i,i=e}Mo(n,!0,a,null,r,n.lastEffect);break;case"together":Mo(n,!1,null,null,void 0,n.lastEffect);break;default:n.memoizedState=null}return n.child}function Je(e,n,a){if(e!==null&&(n.dependencies=e.dependencies),nt|=n.lanes,(a&n.childLanes)!=0){if(e!==null&&n.child!==e.child)throw Error(T(153));if(n.child!==null){for(e=n.child,a=pn(e,e.pendingProps),n.child=a,a.return=n;e.sibling!==null;)e=e.sibling,a=a.sibling=pn(e,e.pendingProps),a.return=n;a.sibling=null}return n.child}return null}var Ru,wo,Lu,Du;Ru=function(e,n){for(var a=n.child;a!==null;){if(a.tag===5||a.tag===6)e.appendChild(a.stateNode);else if(a.tag!==4&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return}a.sibling.return=a.return,a=a.sibling}};wo=function(){};Lu=function(e,n,a,t){var i=e.memoizedProps;if(i!==t){e=n.stateNode,Un(Ue.current);var r=null;switch(a){case"input":i=or(e,i),t=or(e,t),r=[];break;case"option":i=ur(e,i),t=ur(e,t),r=[];break;case"select":i=Y({},i,{value:void 0}),t=Y({},t,{value:void 0}),r=[];break;case"textarea":i=dr(e,i),t=dr(e,t),r=[];break;default:typeof i.onClick!="function"&&typeof t.onClick=="function"&&(e.onclick=$t)}gr(a,t);var o;a=null;for(c in i)if(!t.hasOwnProperty(c)&&i.hasOwnProperty(c)&&i[c]!=null)if(c==="style"){var s=i[c];for(o in s)s.hasOwnProperty(o)&&(a||(a={}),a[o]="")}else c!=="dangerouslySetInnerHTML"&&c!=="children"&&c!=="suppressContentEditableWarning"&&c!=="suppressHydrationWarning"&&c!=="autoFocus"&&(Oa.hasOwnProperty(c)?r||(r=[]):(r=r||[]).push(c,null));for(c in t){var l=t[c];if(s=i!=null?i[c]:void 0,t.hasOwnProperty(c)&&l!==s&&(l!=null||s!=null))if(c==="style")if(s){for(o in s)!s.hasOwnProperty(o)||l&&l.hasOwnProperty(o)||(a||(a={}),a[o]="");for(o in l)l.hasOwnProperty(o)&&s[o]!==l[o]&&(a||(a={}),a[o]=l[o])}else a||(r||(r=[]),r.push(c,a)),a=l;else c==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,s=s?s.__html:void 0,l!=null&&s!==l&&(r=r||[]).push(c,l)):c==="children"?typeof l!="string"&&typeof l!="number"||(r=r||[]).push(c,""+l):c!=="suppressContentEditableWarning"&&c!=="suppressHydrationWarning"&&(Oa.hasOwnProperty(c)?(l!=null&&c==="onScroll"&&J("scroll",e),r||s===l||(r=[])):typeof l=="object"&&l!==null&&l.$$typeof===nr?l.toString():(r=r||[]).push(c,l))}a&&(r=r||[]).push("style",a);var c=r;(n.updateQueue=c)&&(n.flags|=4)}};Du=function(e,n,a,t){a!==t&&(n.flags|=4)};function gt(e,n){if(!Fe)switch(e.tailMode){case"hidden":n=e.tail;for(var a=null;n!==null;)n.alternate!==null&&(a=n),n=n.sibling;a===null?e.tail=null:a.sibling=null;break;case"collapsed":a=e.tail;for(var t=null;a!==null;)a.alternate!==null&&(t=a),a=a.sibling;t===null?n||e.tail===null?e.tail=null:e.tail.sibling=null:t.sibling=null}}function Ah(e,n,a){var t=n.pendingProps;switch(n.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return null;case 1:return Ie(n.type)&&ai(),null;case 3:return fa(),_(ke),_(ce),go(),t=n.stateNode,t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(e===null||e.child===null)&&(pi(n)?n.flags|=4:t.hydrate||(n.flags|=256)),wo(n),null;case 5:uo(n);var i=Un(ot.current);if(a=n.type,e!==null&&n.stateNode!=null)Lu(e,n,a,t,i),e.ref!==n.ref&&(n.flags|=128);else{if(!t){if(n.stateNode===null)throw Error(T(166));return null}if(e=Un(Ue.current),pi(n)){t=n.stateNode,a=n.type;var r=n.memoizedProps;switch(t[ln]=n,t[ni]=r,a){case"dialog":J("cancel",t),J("close",t);break;case"iframe":case"object":case"embed":J("load",t);break;case"video":case"audio":for(e=0;e<Xa.length;e++)J(Xa[e],t);break;case"source":J("error",t);break;case"img":case"image":case"link":J("error",t),J("load",t);break;case"details":J("toggle",t);break;case"input":ws(t,r),J("invalid",t);break;case"select":t._wrapperState={wasMultiple:!!r.multiple},J("invalid",t);break;case"textarea":Ns(t,r),J("invalid",t)}gr(a,r),e=null;for(var o in r)r.hasOwnProperty(o)&&(i=r[o],o==="children"?typeof i=="string"?t.textContent!==i&&(e=["children",i]):typeof i=="number"&&t.textContent!==""+i&&(e=["children",""+i]):Oa.hasOwnProperty(o)&&i!=null&&o==="onScroll"&&J("scroll",t));switch(a){case"input":Rt(t),Os(t,r,!0);break;case"textarea":Rt(t),Ws(t);break;case"select":case"option":break;default:typeof r.onClick=="function"&&(t.onclick=$t)}t=e,n.updateQueue=t,t!==null&&(n.flags|=4)}else{switch(o=i.nodeType===9?i:i.ownerDocument,e===cr.html&&(e=Gs(a)),e===cr.html?a==="script"?(e=o.createElement("div"),e.innerHTML="<script></script>",e=e.removeChild(e.firstChild)):typeof t.is=="string"?e=o.createElement(a,{is:t.is}):(e=o.createElement(a),a==="select"&&(o=e,t.multiple?o.multiple=!0:t.size&&(o.size=t.size))):e=o.createElementNS(e,a),e[ln]=n,e[ni]=t,Ru(e,n,!1,!1),n.stateNode=e,o=mr(a,t),a){case"dialog":J("cancel",e),J("close",e),i=t;break;case"iframe":case"object":case"embed":J("load",e),i=t;break;case"video":case"audio":for(i=0;i<Xa.length;i++)J(Xa[i],e);i=t;break;case"source":J("error",e),i=t;break;case"img":case"image":case"link":J("error",e),J("load",e),i=t;break;case"details":J("toggle",e),i=t;break;case"input":ws(e,t),i=or(e,t),J("invalid",e);break;case"option":i=ur(e,t);break;case"select":e._wrapperState={wasMultiple:!!t.multiple},i=Y({},t,{value:void 0}),J("invalid",e);break;case"textarea":Ns(e,t),i=dr(e,t),J("invalid",e);break;default:i=t}gr(a,i);var s=i;for(r in s)if(s.hasOwnProperty(r)){var l=s[r];r==="style"?Ds(e,l):r==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,l!=null&&Rs(e,l)):r==="children"?typeof l=="string"?(a!=="textarea"||l!=="")&&La(e,l):typeof l=="number"&&La(e,""+l):r!=="suppressContentEditableWarning"&&r!=="suppressHydrationWarning"&&r!=="autoFocus"&&(Oa.hasOwnProperty(r)?l!=null&&r==="onScroll"&&J("scroll",e):l!=null&&Qi(e,r,l,o))}switch(a){case"input":Rt(e),Os(e,t,!1);break;case"textarea":Rt(e),Ws(e);break;case"option":t.value!=null&&e.setAttribute("value",""+nn(t.value));break;case"select":e.multiple=!!t.multiple,r=t.value,r!=null?Qn(e,!!t.multiple,r,!1):t.defaultValue!=null&&Qn(e,!!t.multiple,t.defaultValue,!0);break;default:typeof i.onClick=="function"&&(e.onclick=$t)}Pl(a,t)&&(n.flags|=4)}n.ref!==null&&(n.flags|=128)}return null;case 6:if(e&&n.stateNode!=null)Du(e,n,e.memoizedProps,t);else{if(typeof t!="string"&&n.stateNode===null)throw Error(T(166));a=Un(ot.current),Un(Ue.current),pi(n)?(t=n.stateNode,a=n.memoizedProps,t[ln]=n,t.nodeValue!==a&&(n.flags|=4)):(t=(a.nodeType===9?a:a.ownerDocument).createTextNode(t),t[ln]=n,n.stateNode=t)}return null;case 13:return _(X),t=n.memoizedState,(n.flags&64)!=0?(n.lanes=a,n):(t=t!==null,a=!1,e===null?n.memoizedProps.fallback!==void 0&&pi(n):a=e.memoizedState!==null,t&&!a&&(n.mode&2)!=0&&(e===null&&n.memoizedProps.unstable_avoidThisFallback!==!0||(X.current&1)!=0?de===0&&(de=3):((de===0||de===3)&&(de=4),pe===null||(nt&134217727)==0&&(Sa&134217727)==0||ya(pe,me))),(t||a)&&(n.flags|=4),null);case 4:return fa(),wo(n),e===null&&Ll(n.stateNode.containerInfo),null;case 10:return to(n),null;case 17:return Ie(n.type)&&ai(),null;case 19:if(_(X),t=n.memoizedState,t===null)return null;if(r=(n.flags&64)!=0,o=t.rendering,o===null)if(r)gt(t,!1);else{if(de!==0||e!==null&&(e.flags&64)!=0)for(e=n.child;e!==null;){if(o=fi(e),o!==null){for(n.flags|=64,gt(t,!1),r=o.updateQueue,r!==null&&(n.updateQueue=r,n.flags|=4),t.lastEffect===null&&(n.firstEffect=null),n.lastEffect=t.lastEffect,t=a,a=n.child;a!==null;)r=a,e=t,r.flags&=2,r.nextEffect=null,r.firstEffect=null,r.lastEffect=null,o=r.alternate,o===null?(r.childLanes=0,r.lanes=e,r.child=null,r.memoizedProps=null,r.memoizedState=null,r.updateQueue=null,r.dependencies=null,r.stateNode=null):(r.childLanes=o.childLanes,r.lanes=o.lanes,r.child=o.child,r.memoizedProps=o.memoizedProps,r.memoizedState=o.memoizedState,r.updateQueue=o.updateQueue,r.type=o.type,e=o.dependencies,r.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),a=a.sibling;return Z(X,X.current&1|2),n.child}e=e.sibling}t.tail!==null&&he()>Co&&(n.flags|=64,r=!0,gt(t,!1),n.lanes=33554432)}else{if(!r)if(e=fi(o),e!==null){if(n.flags|=64,r=!0,a=e.updateQueue,a!==null&&(n.updateQueue=a,n.flags|=4),gt(t,!0),t.tail===null&&t.tailMode==="hidden"&&!o.alternate&&!Fe)return n=n.lastEffect=t.lastEffect,n!==null&&(n.nextEffect=null),null}else 2*he()-t.renderingStartTime>Co&&a!==1073741824&&(n.flags|=64,r=!0,gt(t,!1),n.lanes=33554432);t.isBackwards?(o.sibling=n.child,n.child=o):(a=t.last,a!==null?a.sibling=o:n.child=o,t.last=o)}return t.tail!==null?(a=t.tail,t.rendering=a,t.tail=a.sibling,t.lastEffect=n.lastEffect,t.renderingStartTime=he(),a.sibling=null,n=X.current,Z(X,r?n&1|2:n&1),a):null;case 23:case 24:return Oo(),e!==null&&e.memoizedState!==null!=(n.memoizedState!==null)&&t.mode!=="unstable-defer-without-hiding"&&(n.flags|=4),null}throw Error(T(156,n.tag))}function Eh(e){switch(e.tag){case 1:Ie(e.type)&&ai();var n=e.flags;return n&4096?(e.flags=n&-4097|64,e):null;case 3:if(fa(),_(ke),_(ce),go(),n=e.flags,(n&64)!=0)throw Error(T(285));return e.flags=n&-4097|64,e;case 5:return uo(e),null;case 13:return _(X),n=e.flags,n&4096?(e.flags=n&-4097|64,e):null;case 19:return _(X),null;case 4:return fa(),null;case 10:return to(e),null;case 23:case 24:return Oo(),null;default:return null}}function No(e,n){try{var a="",t=n;do a+=tc(t),t=t.return;while(t);var i=a}catch(r){i=`
Error generating stack: `+r.message+`
`+r.stack}return{value:e,source:n,stack:i}}function Bo(e,n){try{console.error(n.value)}catch(a){setTimeout(function(){throw a})}}var vh=typeof WeakMap=="function"?WeakMap:Map;function Pu(e,n,a){a=hn(-1,a),a.tag=3,a.payload={element:null};var t=n.value;return a.callback=function(){vi||(vi=!0,Wo=t),Bo(e,n)},a}function Uu(e,n,a){a=hn(-1,a),a.tag=3;var t=e.type.getDerivedStateFromError;if(typeof t=="function"){var i=n.value;a.payload=function(){return Bo(e,n),t(i)}}var r=e.stateNode;return r!==null&&typeof r.componentDidCatch=="function"&&(a.callback=function(){typeof t!="function"&&(Ke===null?Ke=new Set([this]):Ke.add(this),Bo(e,n));var o=n.stack;this.componentDidCatch(n.value,{componentStack:o!==null?o:""})}),a}var Mh=typeof WeakSet=="function"?WeakSet:Set;function Fu(e){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(a){yn(e,a)}else n.current=null}function wh(e,n){switch(n.tag){case 0:case 11:case 15:case 22:return;case 1:if(n.flags&256&&e!==null){var a=e.memoizedProps,t=e.memoizedState;e=n.stateNode,n=e.getSnapshotBeforeUpdate(n.elementType===n.type?a:Ge(n.type,a),t),e.__reactInternalSnapshotBeforeUpdate=n}return;case 3:n.flags&256&&Jr(n.stateNode.containerInfo);return;case 5:case 6:case 4:case 17:return}throw Error(T(163))}function Oh(e,n,a){switch(a.tag){case 0:case 11:case 15:case 22:if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{if((e.tag&3)==3){var t=e.create;e.destroy=t()}e=e.next}while(e!==n)}if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{var i=e;t=i.next,i=i.tag,(i&4)!=0&&(i&1)!=0&&(Hu(a,e),Ch(a,e)),e=t}while(e!==n)}return;case 1:e=a.stateNode,a.flags&4&&(n===null?e.componentDidMount():(t=a.elementType===a.type?n.memoizedProps:Ge(a.type,n.memoizedProps),e.componentDidUpdate(t,n.memoizedState,e.__reactInternalSnapshotBeforeUpdate))),n=a.updateQueue,n!==null&&eu(a,n,e);return;case 3:if(n=a.updateQueue,n!==null){if(e=null,a.child!==null)switch(a.child.tag){case 5:e=a.child.stateNode;break;case 1:e=a.child.stateNode}eu(a,n,e)}return;case 5:e=a.stateNode,n===null&&a.flags&4&&Pl(a.type,a.memoizedProps)&&e.focus();return;case 6:return;case 4:return;case 12:return;case 13:a.memoizedState===null&&(a=a.alternate,a!==null&&(a=a.memoizedState,a!==null&&(a=a.dehydrated,a!==null&&Zs(a))));return;case 19:case 17:case 20:case 21:case 23:case 24:return}throw Error(T(163))}function Ku(e,n){for(var a=e;;){if(a.tag===5){var t=a.stateNode;if(n)t=t.style,typeof t.setProperty=="function"?t.setProperty("display","none","important"):t.display="none";else{t=a.stateNode;var i=a.memoizedProps.style;i=i!=null&&i.hasOwnProperty("display")?i.display:null,t.style.display=Ls("display",i)}}else if(a.tag===6)a.stateNode.nodeValue=n?"":a.memoizedProps;else if((a.tag!==23&&a.tag!==24||a.memoizedState===null||a===e)&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===e)break;for(;a.sibling===null;){if(a.return===null||a.return===e)return;a=a.return}a.sibling.return=a.return,a=a.sibling}}function xu(e,n){if(Dn&&typeof Dn.onCommitFiberUnmount=="function")try{Dn.onCommitFiberUnmount(qr,n)}catch(r){}switch(n.tag){case 0:case 11:case 14:case 15:case 22:if(e=n.updateQueue,e!==null&&(e=e.lastEffect,e!==null)){var a=e=e.next;do{var t=a,i=t.destroy;if(t=t.tag,i!==void 0)if((t&4)!=0)Hu(n,a);else{t=n;try{i()}catch(r){yn(t,r)}}a=a.next}while(a!==e)}break;case 1:if(Fu(n),e=n.stateNode,typeof e.componentWillUnmount=="function")try{e.props=n.memoizedProps,e.state=n.memoizedState,e.componentWillUnmount()}catch(r){yn(n,r)}break;case 5:Fu(n);break;case 4:bu(e,n)}}function Yu(e){e.alternate=null,e.child=null,e.dependencies=null,e.firstEffect=null,e.lastEffect=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.return=null,e.updateQueue=null}function Vu(e){return e.tag===5||e.tag===3||e.tag===4}function ju(e){e:{for(var n=e.return;n!==null;){if(Vu(n))break e;n=n.return}throw Error(T(160))}var a=n;switch(n=a.stateNode,a.tag){case 5:var t=!1;break;case 3:n=n.containerInfo,t=!0;break;case 4:n=n.containerInfo,t=!0;break;default:throw Error(T(161))}a.flags&16&&(La(n,""),a.flags&=-17);e:n:for(a=e;;){for(;a.sibling===null;){if(a.return===null||Vu(a.return)){a=null;break e}a=a.return}for(a.sibling.return=a.return,a=a.sibling;a.tag!==5&&a.tag!==6&&a.tag!==18;){if(a.flags&2||a.child===null||a.tag===4)continue n;a.child.return=a,a=a.child}if(!(a.flags&2)){a=a.stateNode;break e}}t?Go(e,a,n):Ro(e,a,n)}function Go(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.nodeType===8?a.parentNode.insertBefore(e,n):a.insertBefore(e,n):(a.nodeType===8?(n=a.parentNode,n.insertBefore(e,a)):(n=a,n.appendChild(e)),a=a._reactRootContainer,a!=null||n.onclick!==null||(n.onclick=$t));else if(t!==4&&(e=e.child,e!==null))for(Go(e,n,a),e=e.sibling;e!==null;)Go(e,n,a),e=e.sibling}function Ro(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.insertBefore(e,n):a.appendChild(e);else if(t!==4&&(e=e.child,e!==null))for(Ro(e,n,a),e=e.sibling;e!==null;)Ro(e,n,a),e=e.sibling}function bu(e,n){for(var a=n,t=!1,i,r;;){if(!t){t=a.return;e:for(;;){if(t===null)throw Error(T(160));switch(i=t.stateNode,t.tag){case 5:r=!1;break e;case 3:i=i.containerInfo,r=!0;break e;case 4:i=i.containerInfo,r=!0;break e}t=t.return}t=!0}if(a.tag===5||a.tag===6){e:for(var o=e,s=a,l=s;;)if(xu(o,l),l.child!==null&&l.tag!==4)l.child.return=l,l=l.child;else{if(l===s)break e;for(;l.sibling===null;){if(l.return===null||l.return===s)break e;l=l.return}l.sibling.return=l.return,l=l.sibling}r?(o=i,s=a.stateNode,o.nodeType===8?o.parentNode.removeChild(s):o.removeChild(s)):i.removeChild(a.stateNode)}else if(a.tag===4){if(a.child!==null){i=a.stateNode.containerInfo,r=!0,a.child.return=a,a=a.child;continue}}else if(xu(e,a),a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return,a.tag===4&&(t=!1)}a.sibling.return=a.return,a=a.sibling}}function Do(e,n){switch(n.tag){case 0:case 11:case 14:case 15:case 22:var a=n.updateQueue;if(a=a!==null?a.lastEffect:null,a!==null){var t=a=a.next;do(t.tag&3)==3&&(e=t.destroy,t.destroy=void 0,e!==void 0&&e()),t=t.next;while(t!==a)}return;case 1:return;case 5:if(a=n.stateNode,a!=null){t=n.memoizedProps;var i=e!==null?e.memoizedProps:t;e=n.type;var r=n.updateQueue;if(n.updateQueue=null,r!==null){for(a[ni]=t,e==="input"&&t.type==="radio"&&t.name!=null&&Cs(a,t),mr(e,i),n=mr(e,t),i=0;i<r.length;i+=2){var o=r[i],s=r[i+1];o==="style"?Ds(a,s):o==="dangerouslySetInnerHTML"?Rs(a,s):o==="children"?La(a,s):Qi(a,o,s,n)}switch(e){case"input":lr(a,t);break;case"textarea":Bs(a,t);break;case"select":e=a._wrapperState.wasMultiple,a._wrapperState.wasMultiple=!!t.multiple,r=t.value,r!=null?Qn(a,!!t.multiple,r,!1):e!==!!t.multiple&&(t.defaultValue!=null?Qn(a,!!t.multiple,t.defaultValue,!0):Qn(a,!!t.multiple,t.multiple?[]:"",!1))}}}return;case 6:if(n.stateNode===null)throw Error(T(162));n.stateNode.nodeValue=n.memoizedProps;return;case 3:a=n.stateNode,a.hydrate&&(a.hydrate=!1,Zs(a.containerInfo));return;case 12:return;case 13:n.memoizedState!==null&&(Lo=he(),Ku(n.child,!0)),zu(n);return;case 19:zu(n);return;case 17:return;case 23:case 24:Ku(n,n.memoizedState!==null);return}throw Error(T(163))}function zu(e){var n=e.updateQueue;if(n!==null){e.updateQueue=null;var a=e.stateNode;a===null&&(a=e.stateNode=new Mh),n.forEach(function(t){var i=Nh.bind(null,e,t);a.has(t)||(a.add(t),t.then(i,i))})}}function Bh(e,n){return e!==null&&(e=e.memoizedState,e===null||e.dehydrated!==null)?(n=n.memoizedState,n!==null&&n.dehydrated===null):!1}var Wh=Math.ceil,Mi=Nn.ReactCurrentDispatcher,Po=Nn.ReactCurrentOwner,P=0,pe=null,te=null,me=0,Kn=0,Uo=un(0),de=0,wi=null,ka=0,nt=0,Sa=0,Fo=0,Ho=null,Lo=0,Co=Infinity;function Ia(){Co=he()+500}var O=null,vi=!1,Wo=null,Ke=null,kn=!1,mt=null,ft=90,Ko=[],bo=[],_e=null,pt=0,xo=null,Ci=-1,Qe=0,Oi=0,St=null,Ni=!1;function ve(){return(P&48)!=0?he():Ci!==-1?Ci:Ci=he()}function mn(e){if(e=e.mode,(e&2)==0)return 1;if((e&4)==0)return ca()===99?1:2;if(Qe===0&&(Qe=ka),ph.transition!==0){Oi!==0&&(Oi=Ho!==null?Ho.pendingLanes:0),e=Qe;var n=4186112&~Oi;return n&=-n,n===0&&(e=4186112&~e,n=e&-e,n===0&&(n=8192)),n}return e=ca(),(P&4)!=0&&e===98?e=xt(12,Qe):(e=kc(e),e=xt(e,Qe)),e}function fn(e,n,a){if(50<pt)throw pt=0,xo=null,Error(T(185));if(e=Bi(e,n),e===null)return null;Yt(e,n,a),e===pe&&(Sa|=n,de===4&&ya(e,me));var t=ca();n===1?(P&8)!=0&&(P&48)==0?Yo(e):(We(e,a),P===0&&(Ia(),Pe())):((P&4)==0||t!==98&&t!==99||(_e===null?_e=new Set([e]):_e.add(e)),We(e,a)),Ho=e}function Bi(e,n){e.lanes|=n;var a=e.alternate;for(a!==null&&(a.lanes|=n),a=e,e=e.return;e!==null;)e.childLanes|=n,a=e.alternate,a!==null&&(a.childLanes|=n),a=e,e=e.return;return a.tag===3?a.stateNode:null}function We(e,n){for(var a=e.callbackNode,t=e.suspendedLanes,i=e.pingedLanes,r=e.expirationTimes,o=e.pendingLanes;0<o;){var s=31-on(o),l=1<<s,c=r[s];if(c===-1){if((l&t)==0||(l&i)!=0){c=n,ea(l);var y=z;r[s]=10<=y?c+250:6<=y?c+5e3:-1}}else c<=n&&(e.expiredLanes|=l);o&=~l}if(t=Va(e,e===pe?me:0),n=z,t===0)a!==null&&(a!==eo&&Xr(a),e.callbackNode=null,e.callbackPriority=0);else{if(a!==null){if(e.callbackPriority===n)return;a!==eo&&Xr(a)}n===15?(a=Yo.bind(null,e),je===null?(je=[a],ri=Zr(ii,ql)):je.push(a),a=eo):n===14?a=et(99,Yo.bind(null,e)):(a=Ic(n),a=et(a,Ju.bind(null,e))),e.callbackPriority=n,e.callbackNode=a}}function Ju(e){if(Ci=-1,Oi=Qe=0,(P&48)!=0)throw Error(T(327));var n=e.callbackNode;if(In()&&e.callbackNode!==n)return null;var a=Va(e,e===pe?me:0);if(a===0)return null;var t=a,i=P;P|=16;var r=Qu();(pe!==e||me!==t)&&(Ia(),Ta(e,t));do try{Gh();break}catch(s){_u(e,s)}while(1);if(ao(),Mi.current=r,P=i,te!==null?t=0:(pe=null,me=0,t=de),(ka&Sa)!=0)Ta(e,0);else if(t!==0){if(t===2&&(P|=64,e.hydrate&&(e.hydrate=!1,Jr(e.containerInfo)),a=il(e),a!==0&&(t=yt(e,a))),t===1)throw n=wi,Ta(e,0),ya(e,a),We(e,he()),n;switch(e.finishedWork=e.current.alternate,e.finishedLanes=a,t){case 0:case 1:throw Error(T(345));case 2:bn(e);break;case 3:if(ya(e,a),(a&62914560)===a&&(t=Lo+500-he(),10<t)){if(Va(e,0)!==0)break;if(i=e.suspendedLanes,(i&a)!==a){ve(),e.pingedLanes|=e.suspendedLanes&i;break}e.timeoutHandle=Ul(bn.bind(null,e),t);break}bn(e);break;case 4:if(ya(e,a),(a&4186112)===a)break;for(t=e.eventTimes,i=-1;0<a;){var o=31-on(a);r=1<<o,o=t[o],o>i&&(i=o),a&=~r}if(a=i,a=he()-a,a=(120>a?120:480>a?480:1080>a?1080:1920>a?1920:3e3>a?3e3:4320>a?4320:1960*Wh(a/1960))-a,10<a){e.timeoutHandle=Ul(bn.bind(null,e),a);break}bn(e);break;case 5:bn(e);break;default:throw Error(T(329))}}return We(e,he()),e.callbackNode===n?Ju.bind(null,e):null}function ya(e,n){for(n&=~Fo,n&=~Sa,e.suspendedLanes|=n,e.pingedLanes&=~n,e=e.expirationTimes;0<n;){var a=31-on(n),t=1<<a;e[a]=-1,n&=~t}}function Yo(e){if((P&48)!=0)throw Error(T(327));if(In(),e===pe&&(e.expiredLanes&me)!=0){var n=me,a=yt(e,n);(ka&Sa)!=0&&(n=Va(e,n),a=yt(e,n))}else n=Va(e,0),a=yt(e,n);if(e.tag!==0&&a===2&&(P|=64,e.hydrate&&(e.hydrate=!1,Jr(e.containerInfo)),n=il(e),n!==0&&(a=yt(e,n))),a===1)throw a=wi,Ta(e,0),ya(e,n),We(e,he()),a;return e.finishedWork=e.current.alternate,e.finishedLanes=n,bn(e),We(e,he()),null}function Rh(){if(_e!==null){var e=_e;_e=null,e.forEach(function(n){n.expiredLanes|=24&n.pendingLanes,We(n,he())})}Pe()}function qu(e,n){var a=P;P|=1;try{return e(n)}finally{P=a,P===0&&(Ia(),Pe())}}function Zu(e,n){var a=P;P&=-2,P|=8;try{return e(n)}finally{P=a,P===0&&(Ia(),Pe())}}function Ai(e,n){Z(Uo,Kn),Kn|=n,ka|=n}function Oo(){Kn=Uo.current,_(Uo)}function Ta(e,n){e.finishedWork=null,e.finishedLanes=0;var a=e.timeoutHandle;if(a!==-1&&(e.timeoutHandle=-1,dh(a)),te!==null)for(a=te.return;a!==null;){var t=a;switch(t.tag){case 1:t=t.type.childContextTypes,t!=null&&ai();break;case 3:fa(),_(ke),_(ce),go();break;case 5:uo(t);break;case 4:fa();break;case 13:_(X);break;case 19:_(X);break;case 10:to(t);break;case 23:case 24:Oo()}a=a.return}pe=e,te=pn(e.current,null),me=Kn=ka=n,de=0,wi=null,Fo=Sa=nt=0}function _u(e,n){do{var a=te;try{if(ao(),st.current=yi,Si){for(var t=$.memoizedState;t!==null;){var i=t.queue;i!==null&&(i.pending=null),t=t.next}Si=!1}if(lt=0,ue=ge=$=null,ut=!1,Po.current=null,a===null||a.return===null){de=1,wi=n,te=null;break}e:{var r=e,o=a.return,s=a,l=n;if(n=me,s.flags|=2048,s.firstEffect=s.lastEffect=null,l!==null&&typeof l=="object"&&typeof l.then=="function"){var c=l;if((s.mode&2)==0){var y=s.alternate;y?(s.updateQueue=y.updateQueue,s.memoizedState=y.memoizedState,s.lanes=y.lanes):(s.updateQueue=null,s.memoizedState=null)}var v=(X.current&1)!=0,p=o;do{var w;if(w=p.tag===13){var G=p.memoizedState;if(G!==null)w=G.dehydrated!==null;else{var N=p.memoizedProps;w=N.fallback===void 0?!1:N.unstable_avoidThisFallback!==!0?!0:!v}}if(w){var h=p.updateQueue;if(h===null){var u=new Set;u.add(c),p.updateQueue=u}else h.add(c);if((p.mode&2)==0){if(p.flags|=64,s.flags|=16384,s.flags&=-2981,s.tag===1)if(s.alternate===null)s.tag=17;else{var d=hn(-1,1);d.tag=2,gn(s,d)}s.lanes|=1;break e}l=void 0,s=n;var f=r.pingCache;if(f===null?(f=r.pingCache=new vh,l=new Set,f.set(c,l)):(l=f.get(c),l===void 0&&(l=new Set,f.set(c,l))),!l.has(s)){l.add(s);var S=Lh.bind(null,r,c,s);c.then(S,S)}p.flags|=4096,p.lanes=n;break e}p=p.return}while(p!==null);l=Error((_n(s.type)||"A React component")+` suspended while rendering, but no fallback UI was specified.

Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.`)}de!==5&&(de=2),l=No(l,s),p=o;do{switch(p.tag){case 3:r=l,p.flags|=4096,n&=-n,p.lanes|=n;var R=Pu(p,r,n);$l(p,R);break e;case 1:r=l;var M=p.type,B=p.stateNode;if((p.flags&64)==0&&(typeof M.getDerivedStateFromError=="function"||B!==null&&typeof B.componentDidCatch=="function"&&(Ke===null||!Ke.has(B)))){p.flags|=4096,n&=-n,p.lanes|=n;var D=Uu(p,r,n);$l(p,D);break e}}p=p.return}while(p!==null)}Xu(a)}catch(L){n=L,te===a&&a!==null&&(te=a=a.return);continue}break}while(1)}function Qu(){var e=Mi.current;return Mi.current=yi,e===null?yi:e}function yt(e,n){var a=P;P|=16;var t=Qu();pe===e&&me===n||Ta(e,n);do try{Dh();break}catch(i){_u(e,i)}while(1);if(ao(),P=a,Mi.current=t,te!==null)throw Error(T(261));return pe=null,me=0,de}function Dh(){for(;te!==null;)$u(te)}function Gh(){for(;te!==null&&!gh();)$u(te)}function $u(e){var n=ed(e.alternate,e,Kn);e.memoizedProps=e.pendingProps,n===null?Xu(e):te=n,Po.current=null}function Xu(e){var n=e;do{var a=n.alternate;if(e=n.return,(n.flags&2048)==0){if(a=Ah(a,n,Kn),a!==null){te=a;return}if(a=n,a.tag!==24&&a.tag!==23||a.memoizedState===null||(Kn&1073741824)!=0||(a.mode&4)==0){for(var t=0,i=a.child;i!==null;)t|=i.lanes|i.childLanes,i=i.sibling;a.childLanes=t}e!==null&&(e.flags&2048)==0&&(e.firstEffect===null&&(e.firstEffect=n.firstEffect),n.lastEffect!==null&&(e.lastEffect!==null&&(e.lastEffect.nextEffect=n.firstEffect),e.lastEffect=n.lastEffect),1<n.flags&&(e.lastEffect!==null?e.lastEffect.nextEffect=n:e.firstEffect=n,e.lastEffect=n))}else{if(a=Eh(n),a!==null){a.flags&=2047,te=a;return}e!==null&&(e.firstEffect=e.lastEffect=null,e.flags|=2048)}if(n=n.sibling,n!==null){te=n;return}te=n=e}while(n!==null);de===0&&(de=5)}function bn(e){var n=ca();return Pn(99,Ph.bind(null,e,n)),null}function Ph(e,n){do In();while(mt!==null);if((P&48)!=0)throw Error(T(327));var a=e.finishedWork;if(a===null)return null;if(e.finishedWork=null,e.finishedLanes=0,a===e.current)throw Error(T(177));e.callbackNode=null;var t=a.lanes|a.childLanes,i=t,r=e.pendingLanes&~i;e.pendingLanes=i,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=i,e.mutableReadLanes&=i,e.entangledLanes&=i,i=e.entanglements;for(var o=e.eventTimes,s=e.expirationTimes;0<r;){var l=31-on(r),c=1<<l;i[l]=0,o[l]=-1,s[l]=-1,r&=~c}if(_e!==null&&(t&24)==0&&_e.has(e)&&_e.delete(e),e===pe&&(te=pe=null,me=0),1<a.flags?a.lastEffect!==null?(a.lastEffect.nextEffect=a,t=a.firstEffect):t=a:t=a.firstEffect,t!==null){if(i=P,P|=32,Po.current=null,Vr=Vt,o=Ml(),Kr(o)){if("selectionStart"in o)s={start:o.selectionStart,end:o.selectionEnd};else e:if(s=(s=o.ownerDocument)&&s.defaultView||window,(c=s.getSelection&&s.getSelection())&&c.rangeCount!==0){s=c.anchorNode,r=c.anchorOffset,l=c.focusNode,c=c.focusOffset;try{s.nodeType,l.nodeType}catch(L){s=null;break e}var y=0,v=-1,p=-1,w=0,G=0,N=o,h=null;n:for(;;){for(var u;N!==s||r!==0&&N.nodeType!==3||(v=y+r),N!==l||c!==0&&N.nodeType!==3||(p=y+c),N.nodeType===3&&(y+=N.nodeValue.length),(u=N.firstChild)!==null;)h=N,N=u;for(;;){if(N===o)break n;if(h===s&&++w===r&&(v=y),h===l&&++G===c&&(p=y),(u=N.nextSibling)!==null)break;N=h,h=N.parentNode}N=u}s=v===-1||p===-1?null:{start:v,end:p}}else s=null;s=s||{start:0,end:0}}else s=null;jr={focusedElem:o,selectionRange:s},Vt=!1,St=null,Ni=!1,O=t;do try{Uh()}catch(L){if(O===null)throw Error(T(330));yn(O,L),O=O.nextEffect}while(O!==null);St=null,O=t;do try{for(o=e;O!==null;){var d=O.flags;if(d&16&&La(O.stateNode,""),d&128){var f=O.alternate;if(f!==null){var S=f.ref;S!==null&&(typeof S=="function"?S(null):S.current=null)}}switch(d&1038){case 2:ju(O),O.flags&=-3;break;case 6:ju(O),O.flags&=-3,Do(O.alternate,O);break;case 1024:O.flags&=-1025;break;case 1028:O.flags&=-1025,Do(O.alternate,O);break;case 4:Do(O.alternate,O);break;case 8:s=O,bu(o,s);var R=s.alternate;Yu(s),R!==null&&Yu(R)}O=O.nextEffect}}catch(L){if(O===null)throw Error(T(330));yn(O,L),O=O.nextEffect}while(O!==null);if(S=jr,f=Ml(),d=S.focusedElem,o=S.selectionRange,f!==d&&d&&d.ownerDocument&&vl(d.ownerDocument.documentElement,d)){for(o!==null&&Kr(d)&&(f=o.start,S=o.end,S===void 0&&(S=f),"selectionStart"in d?(d.selectionStart=f,d.selectionEnd=Math.min(S,d.value.length)):(S=(f=d.ownerDocument||document)&&f.defaultView||window,S.getSelection&&(S=S.getSelection(),s=d.textContent.length,R=Math.min(o.start,s),o=o.end===void 0?R:Math.min(o.end,s),!S.extend&&R>o&&(s=o,o=R,R=s),s=El(d,R),r=El(d,o),s&&r&&(S.rangeCount!==1||S.anchorNode!==s.node||S.anchorOffset!==s.offset||S.focusNode!==r.node||S.focusOffset!==r.offset)&&(f=f.createRange(),f.setStart(s.node,s.offset),S.removeAllRanges(),R>o?(S.addRange(f),S.extend(r.node,r.offset)):(f.setEnd(r.node,r.offset),S.addRange(f)))))),f=[],S=d;S=S.parentNode;)S.nodeType===1&&f.push({element:S,left:S.scrollLeft,top:S.scrollTop});for(typeof d.focus=="function"&&d.focus(),d=0;d<f.length;d++)S=f[d],S.element.scrollLeft=S.left,S.element.scrollTop=S.top}Vt=!!Vr,jr=Vr=null,e.current=a,O=t;do try{for(d=e;O!==null;){var M=O.flags;if(M&36&&Oh(d,O.alternate,O),M&128){f=void 0;var B=O.ref;if(B!==null){var D=O.stateNode;switch(O.tag){case 5:f=D;break;default:f=D}typeof B=="function"?B(f):B.current=f}}O=O.nextEffect}}catch(L){if(O===null)throw Error(T(330));yn(O,L),O=O.nextEffect}while(O!==null);O=null,fh(),P=i}else e.current=a;if(kn)kn=!1,mt=e,ft=n;else for(O=t;O!==null;)n=O.nextEffect,O.nextEffect=null,O.flags&8&&(M=O,M.sibling=null,M.stateNode=null),O=n;if(t=e.pendingLanes,t===0&&(Ke=null),t===1?e===xo?pt++:(pt=0,xo=e):pt=0,a=a.stateNode,Dn&&typeof Dn.onCommitFiberRoot=="function")try{Dn.onCommitFiberRoot(qr,a,void 0,(a.current.flags&64)==64)}catch(L){}if(We(e,he()),vi)throw vi=!1,e=Wo,Wo=null,e;return(P&8)!=0||Pe(),null}function Uh(){for(;O!==null;){var e=O.alternate;Ni||St===null||((O.flags&8)!=0?Vs(O,St)&&(Ni=!0):O.tag===13&&Bh(e,O)&&Vs(O,St)&&(Ni=!0));var n=O.flags;(n&256)!=0&&wh(e,O),(n&512)==0||kn||(kn=!0,et(97,function(){return In(),null})),O=O.nextEffect}}function In(){if(ft!==90){var e=97<ft?97:ft;return ft=90,Pn(e,Fh)}return!1}function Ch(e,n){Ko.push(n,e),kn||(kn=!0,et(97,function(){return In(),null}))}function Hu(e,n){bo.push(n,e),kn||(kn=!0,et(97,function(){return In(),null}))}function Fh(){if(mt===null)return!1;var e=mt;if(mt=null,(P&48)!=0)throw Error(T(331));var n=P;P|=32;var a=bo;bo=[];for(var t=0;t<a.length;t+=2){var i=a[t],r=a[t+1],o=i.destroy;if(i.destroy=void 0,typeof o=="function")try{o()}catch(l){if(r===null)throw Error(T(330));yn(r,l)}}for(a=Ko,Ko=[],t=0;t<a.length;t+=2){i=a[t],r=a[t+1];try{var s=i.create;i.destroy=s()}catch(l){if(r===null)throw Error(T(330));yn(r,l)}}for(s=e.current.firstEffect;s!==null;)e=s.nextEffect,s.nextEffect=null,s.flags&8&&(s.sibling=null,s.stateNode=null),s=e;return P=n,Pe(),!0}function nd(e,n,a){n=No(a,n),n=Pu(e,n,1),gn(e,n),n=ve(),e=Bi(e,1),e!==null&&(Yt(e,1,n),We(e,n))}function yn(e,n){if(e.tag===3)nd(e,e,n);else for(var a=e.return;a!==null;){if(a.tag===3){nd(a,e,n);break}else if(a.tag===1){var t=a.stateNode;if(typeof a.type.getDerivedStateFromError=="function"||typeof t.componentDidCatch=="function"&&(Ke===null||!Ke.has(t))){e=No(n,e);var i=Uu(a,e,1);if(gn(a,i),i=ve(),a=Bi(a,1),a!==null)Yt(a,1,i),We(a,i);else if(typeof t.componentDidCatch=="function"&&(Ke===null||!Ke.has(t)))try{t.componentDidCatch(n,e)}catch(r){}break}}a=a.return}}function Lh(e,n,a){var t=e.pingCache;t!==null&&t.delete(n),n=ve(),e.pingedLanes|=e.suspendedLanes&a,pe===e&&(me&a)===a&&(de===4||de===3&&(me&62914560)===me&&500>he()-Lo?Ta(e,0):Fo|=a),We(e,n)}function Nh(e,n){var a=e.stateNode;a!==null&&a.delete(n),n=0,n===0&&(n=e.mode,(n&2)==0?n=1:(n&4)==0?n=ca()===99?1:2:(Qe===0&&(Qe=ka),n=na(62914560&~Qe),n===0&&(n=4194304))),a=ve(),e=Bi(e,n),e!==null&&(Yt(e,n,a),We(e,a))}var ed;ed=function(e,n,a){var t=n.lanes;if(e!==null)if(e.memoizedProps!==n.pendingProps||ke.current)Re=!0;else if((a&t)!=0)Re=(e.flags&16384)!=0;else{switch(Re=!1,n.tag){case 3:wu(n),ho();break;case 5:su(n);break;case 1:Ie(n.type)&&ti(n);break;case 4:lo(n,n.stateNode.containerInfo);break;case 10:t=n.memoizedProps.value;var i=n.type._context;Z(oi,i._currentValue),i._currentValue=t;break;case 13:if(n.memoizedState!==null)return(a&n.child.childLanes)!=0?Bu(e,n,a):(Z(X,X.current&1),n=Je(e,n,a),n!==null?n.sibling:null);Z(X,X.current&1);break;case 19:if(t=(a&n.childLanes)!=0,(e.flags&64)!=0){if(t)return Gu(e,n,a);n.flags|=64}if(i=n.memoizedState,i!==null&&(i.rendering=null,i.tail=null,i.lastEffect=null),Z(X,X.current),t)break;return null;case 23:case 24:return n.lanes=0,Ao(e,n,a)}return Je(e,n,a)}else Re=!1;switch(n.lanes=0,n.tag){case 2:if(t=n.type,e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,i=da(n,ce.current),ga(n,a),i=fo(null,n,t,e,i,a),n.flags|=1,typeof i=="object"&&i!==null&&typeof i.render=="function"&&i.$$typeof===void 0){if(n.tag=1,n.memoizedState=null,n.updateQueue=null,Ie(t)){var r=!0;ti(n)}else r=!1;n.memoizedState=i.state!==null&&i.state!==void 0?i.state:null,io(n);var o=t.getDerivedStateFromProps;typeof o=="function"&&ui(n,t,o,e),i.updater=di,n.stateNode=i,i._reactInternals=n,ro(n,t,e,a),n=Eo(null,n,t,!0,r,a)}else n.tag=0,Ae(null,n,i,a),n=n.child;return n;case 16:i=n.elementType;e:{switch(e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,r=i._init,i=r(i._payload),n.type=i,r=n.tag=Hh(i),e=Ge(i,e),r){case 0:n=To(null,n,i,e,a);break e;case 1:n=Mu(null,n,i,e,a);break e;case 11:n=Tu(null,n,i,e,a);break e;case 14:n=Eu(null,n,i,Ge(i.type,e),t,a);break e}throw Error(T(306,i,""))}return n;case 0:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ge(t,i),To(e,n,t,i,a);case 1:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ge(t,i),Mu(e,n,t,i,a);case 3:if(wu(n),t=n.updateQueue,e===null||t===null)throw Error(T(282));if(t=n.pendingProps,i=n.memoizedState,i=i!==null?i.element:null,Xl(e,n),at(n,t,null,a),t=n.memoizedState.element,t===i)ho(),n=Je(e,n,a);else{if(i=n.stateNode,(r=i.hydrate)&&(Sn=la(n.stateNode.containerInfo.firstChild),ze=n,r=Fe=!0),r){if(e=i.mutableSourceEagerHydrationData,e!=null)for(i=0;i<e.length;i+=2)r=e[i],r._workInProgressVersionPrimary=e[i+1],pa.push(r);for(a=ou(n,null,t,a),n.child=a;a;)a.flags=a.flags&-3|1024,a=a.sibling}else Ae(e,n,t,a),ho();n=n.child}return n;case 5:return su(n),e===null&&co(n),t=n.type,i=n.pendingProps,r=e!==null?e.memoizedProps:null,o=i.children,zr(t,i)?o=null:r!==null&&zr(t,r)&&(n.flags|=16),vu(e,n),Ae(e,n,o,a),n.child;case 6:return e===null&&co(n),null;case 13:return Bu(e,n,a);case 4:return lo(n,n.stateNode.containerInfo),t=n.pendingProps,e===null?n.child=mi(n,null,t,a):Ae(e,n,t,a),n.child;case 11:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ge(t,i),Tu(e,n,t,i,a);case 7:return Ae(e,n,n.pendingProps,a),n.child;case 8:return Ae(e,n,n.pendingProps.children,a),n.child;case 12:return Ae(e,n,n.pendingProps.children,a),n.child;case 10:e:{t=n.type._context,i=n.pendingProps,o=n.memoizedProps,r=i.value;var s=n.type._context;if(Z(oi,s._currentValue),s._currentValue=r,o!==null)if(s=o.value,r=Ce(s,r)?0:(typeof t._calculateChangedBits=="function"?t._calculateChangedBits(s,r):1073741823)|0,r===0){if(o.children===i.children&&!ke.current){n=Je(e,n,a);break e}}else for(s=n.child,s!==null&&(s.return=n);s!==null;){var l=s.dependencies;if(l!==null){o=s.child;for(var c=l.firstContext;c!==null;){if(c.context===t&&(c.observedBits&r)!=0){s.tag===1&&(c=hn(-1,a&-a),c.tag=2,gn(s,c)),s.lanes|=a,c=s.alternate,c!==null&&(c.lanes|=a),Zl(s.return,a),l.lanes|=a;break}c=c.next}}else o=s.tag===10&&s.type===n.type?null:s.child;if(o!==null)o.return=s;else for(o=s;o!==null;){if(o===n){o=null;break}if(s=o.sibling,s!==null){s.return=o.return,o=s;break}o=o.return}s=o}Ae(e,n,i.children,a),n=n.child}return n;case 9:return i=n.type,r=n.pendingProps,t=r.children,ga(n,a),i=Oe(i,r.unstable_observedBits),t=t(i),n.flags|=1,Ae(e,n,t,a),n.child;case 14:return i=n.type,r=Ge(i,n.pendingProps),r=Ge(i.type,r),Eu(e,n,i,r,t,a);case 15:return Au(e,n,n.type,n.pendingProps,t,a);case 17:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ge(t,i),e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),n.tag=1,Ie(t)?(e=!0,ti(n)):e=!1,ga(n,a),tu(n,t,i),ro(n,t,i,a),Eo(null,n,t,!0,e,a);case 19:return Gu(e,n,a);case 23:return Ao(e,n,a);case 24:return Ao(e,n,a)}throw Error(T(156,n.tag))};function Kh(e,n,a,t){this.tag=e,this.key=a,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=n,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=t,this.flags=0,this.lastEffect=this.firstEffect=this.nextEffect=null,this.childLanes=this.lanes=0,this.alternate=null}function Ne(e,n,a,t){return new Kh(e,n,a,t)}function Io(e){return e=e.prototype,!(!e||!e.isReactComponent)}function Hh(e){if(typeof e=="function")return Io(e)?1:0;if(e!=null){if(e=e.$$typeof,e===Nt)return 11;if(e===Wt)return 14}return 2}function pn(e,n){var a=e.alternate;return a===null?(a=Ne(e.tag,n,e.key,e.mode),a.elementType=e.elementType,a.type=e.type,a.stateNode=e.stateNode,a.alternate=e,e.alternate=a):(a.pendingProps=n,a.type=e.type,a.flags=0,a.nextEffect=null,a.firstEffect=null,a.lastEffect=null),a.childLanes=e.childLanes,a.lanes=e.lanes,a.child=e.child,a.memoizedProps=e.memoizedProps,a.memoizedState=e.memoizedState,a.updateQueue=e.updateQueue,n=e.dependencies,a.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext},a.sibling=e.sibling,a.index=e.index,a.ref=e.ref,a}function gi(e,n,a,t,i,r){var o=2;if(t=e,typeof e=="function")Io(e)&&(o=1);else if(typeof e=="string")o=5;else e:switch(e){case en:return ma(a.children,i,r,n);case As:o=8,i|=16;break;case qi:o=8,i|=1;break;case Ba:return e=Ne(12,a,n,i|8),e.elementType=Ba,e.type=Ba,e.lanes=r,e;case Wa:return e=Ne(13,a,n,i),e.type=Wa,e.elementType=Wa,e.lanes=r,e;case Bt:return e=Ne(19,a,n,i),e.elementType=Bt,e.lanes=r,e;case ar:return vo(a,i,r,n);case tr:return e=Ne(24,a,n,i),e.elementType=tr,e.lanes=r,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case Zi:o=10;break e;case Xi:o=9;break e;case Nt:o=11;break e;case Wt:o=14;break e;case $i:o=16,t=null;break e;case er:o=22;break e}throw Error(T(130,e==null?e:typeof e,""))}return n=Ne(o,a,n,i),n.elementType=e,n.type=t,n.lanes=r,n}function ma(e,n,a,t){return e=Ne(7,e,t,n),e.lanes=a,e}function vo(e,n,a,t){return e=Ne(23,e,t,n),e.elementType=ar,e.lanes=a,e}function oo(e,n,a){return e=Ne(6,e,null,n),e.lanes=a,e}function so(e,n,a){return n=Ne(4,e.children!==null?e.children:[],e.key,n),n.lanes=a,n.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},n}function bh(e,n,a){this.tag=n,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.pendingContext=this.context=null,this.hydrate=a,this.callbackNode=null,this.callbackPriority=0,this.eventTimes=Br(0),this.expirationTimes=Br(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Br(0),this.mutableSourceEagerHydrationData=null}function xh(e,n,a){var t=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:Bn,key:t==null?null:""+t,children:e,containerInfo:n,implementation:a}}function Wi(e,n,a,t){var i=n.current,r=ve(),o=mn(i);e:if(a){a=a._reactInternals;n:{if(Gn(a)!==a||a.tag!==1)throw Error(T(170));var s=a;do{switch(s.tag){case 3:s=s.stateNode.context;break n;case 1:if(Ie(s.type)){s=s.stateNode.__reactInternalMemoizedMergedChildContext;break n}}s=s.return}while(s!==null);throw Error(T(171))}if(a.tag===1){var l=a.type;if(Ie(l)){a=bl(a,l,s);break e}}a=s}else a=dn;return n.context===null?n.context=a:n.pendingContext=a,n=hn(r,o),n.payload={element:e},t=t===void 0?null:t,t!==null&&(n.callback=t),gn(i,n),fn(i,o,r),o}function Vo(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function ad(e,n){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var a=e.retryLane;e.retryLane=a!==0&&a<n?a:n}}function jo(e,n){ad(e,n),(e=e.alternate)&&ad(e,n)}function Yh(){return null}function zo(e,n,a){var t=a!=null&&a.hydrationOptions!=null&&a.hydrationOptions.mutableSources||null;if(a=new bh(e,n,a!=null&&a.hydrate===!0),n=Ne(3,null,null,n===2?7:n===1?3:0),a.current=n,n.stateNode=a,io(n),e[sa]=a.current,Ll(e.nodeType===8?e.parentNode:e),t)for(e=0;e<t.length;e++){n=t[e];var i=n._getVersion;i=i(n._source),a.mutableSourceEagerHydrationData==null?a.mutableSourceEagerHydrationData=[n,i]:a.mutableSourceEagerHydrationData.push(n,i)}this._internalRoot=a}zo.prototype.render=function(e){Wi(e,this._internalRoot,null,null)};zo.prototype.unmount=function(){var e=this._internalRoot,n=e.containerInfo;Wi(null,e,null,function(){n[sa]=null})};function kt(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function Vh(e,n){if(n||(n=e?e.nodeType===9?e.documentElement:e.firstChild:null,n=!(!n||n.nodeType!==1||!n.hasAttribute("data-reactroot"))),!n)for(var a;a=e.lastChild;)e.removeChild(a);return new zo(e,0,n?{hydrate:!0}:void 0)}function Gi(e,n,a,t,i){var r=a._reactRootContainer;if(r){var o=r._internalRoot;if(typeof i=="function"){var s=i;i=function(){var c=Vo(o);s.call(c)}}Wi(n,o,e,i)}else{if(r=a._reactRootContainer=Vh(a,t),o=r._internalRoot,typeof i=="function"){var l=i;i=function(){var c=Vo(o);l.call(c)}}Zu(function(){Wi(n,o,e,i)})}return Vo(o)}js=function(e){if(e.tag===13){var n=ve();fn(e,4,n),jo(e,4)}};Er=function(e){if(e.tag===13){var n=ve();fn(e,67108864,n),jo(e,67108864)}};zs=function(e){if(e.tag===13){var n=ve(),a=mn(e);fn(e,a,n),jo(e,a)}};Js=function(e,n){return n()};pr=function(e,n,a){switch(n){case"input":if(lr(e,a),n=a.name,a.type==="radio"&&n!=null){for(a=e;a.parentNode;)a=a.parentNode;for(a=a.querySelectorAll("input[name="+JSON.stringify(""+n)+'][type="radio"]'),n=0;n<a.length;n++){var t=a[n];if(t!==e&&t.form===e.form){var i=Pt(t);if(!i)throw Error(T(90));Ms(t),lr(t,i)}}}break;case"textarea":Bs(e,a);break;case"select":n=a.value,n!=null&&Qn(e,!!a.multiple,n,!1)}};Sr=qu;Hs=function(e,n,a,t,i){var r=P;P|=4;try{return Pn(98,e.bind(null,n,a,t,i))}finally{P=r,P===0&&(Ia(),Pe())}};yr=function(){(P&49)==0&&(Rh(),In())};Ks=function(e,n){var a=P;P|=2;try{return e(n)}finally{P=a,P===0&&(Ia(),Pe())}};function td(e,n){var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!kt(n))throw Error(T(200));return xh(e,n,null,a)}var jh={Events:[Pa,ia,Pt,Us,Fs,In,{current:!1}]},It={findFiberByHostInstance:Rn,bundleType:0,version:"17.0.2",rendererPackageName:"react-dom"},zh={bundleType:It.bundleType,version:It.version,rendererPackageName:It.rendererPackageName,rendererConfig:It.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:Nn.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=Ys(e),e===null?null:e.stateNode},findFiberByHostInstance:It.findFiberByHostInstance||Yh,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__!="undefined"&&(Tt=__REACT_DEVTOOLS_GLOBAL_HOOK__,!Tt.isDisabled&&Tt.supportsFiber))try{qr=Tt.inject(zh),Dn=Tt}catch(e){}var Tt,Jh=jh,_h=td,Qh=function(e){if(e==null)return null;if(e.nodeType===1)return e;var n=e._reactInternals;if(n===void 0)throw typeof e.render=="function"?Error(T(188)):Error(T(268,Object.keys(e)));return e=Ys(n),e=e===null?null:e.stateNode,e},qh=function(e,n){var a=P;if((a&48)!=0)return e(n);P|=1;try{if(e)return Pn(99,e.bind(null,n))}finally{P=a,Pe()}},Zh=function(e,n,a){if(!kt(n))throw Error(T(200));return Gi(null,e,n,!0,a)},Xh=function(e,n,a){if(!kt(n))throw Error(T(200));return Gi(null,e,n,!1,a)},$h=function(e){if(!kt(e))throw Error(T(40));return e._reactRootContainer?(Zu(function(){Gi(null,null,e,!1,function(){e._reactRootContainer=null,e[sa]=null})}),!0):!1},eg=qu,ng=function(e,n){return td(e,n,2<arguments.length&&arguments[2]!==void 0?arguments[2]:null)},ag=function(e,n,a,t){if(!kt(a))throw Error(T(200));if(e==null||e._reactInternals===void 0)throw Error(T(38));return Gi(e,n,a,!1,t)},tg="17.0.2",ig={__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:Jh,createPortal:_h,findDOMNode:Qh,flushSync:qh,hydrate:Zh,render:Xh,unmountComponentAtNode:$h,unstable_batchedUpdates:eg,unstable_createPortal:ng,unstable_renderSubtreeIntoContainer:ag,version:tg},rg=Xe(function(e){function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__=="undefined"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(a){console.error(a)}}n(),e.exports=ig}),Jo=rg.render;var _o=Symbol(),Qo=Symbol(),qo=Symbol(),Ri=Symbol();function xn(e,n){function a(...t){if(t.length>=e.length)return e(...t);{let i=(...r)=>a(...t,...r);return i[_o]=e,i[Qo]=a,i[qo]=t,i[Ri]=a[Ri],i}}return a[_o]=e,a[Qo]=a,a[qo]=[],a[Ri]=n||id(e),a}function Zo(e){return e[_o]}function og(e){return e[Qo]}function Li(e){return e[qo]||[]}function id(e){return e[Ri]||e.name}function lg(){let e=[];return{test:n,getAllTests:a};function n(t,i){e.push(...Object.entries(i).map(([r,o])=>sg(t,r,o)))}function a(){return e}}function m(e,n,...a){let t=n(...a,e);if(typeof t=="function")throw new Error("The matcher function `"+Xo(t)+"` returned a function instead of a boolean. You might need to pass another argument to it.");if(!t)throw new Di([e,n,...a])}function sg(e,n,a){return{subject:e,scenario:n,fn:a}}var Di=class extends Error{constructor(n){super("Expectation failed");this.expectArgs=n}};function ug(e){return e[e.length-1]}function rd(e){return e[0]}var Yn=xn(function(e,n){return e(n)},"which"),F=xn(function(e,n){var a,t;if(dg(e))return e(n);if(Array.isArray(e)&&Array.isArray(n))return e.length===n.length&&e.every((i,r)=>F(e[r],n[r]));if(e instanceof Function&&n instanceof Function)return Zo(e)&&Zo(e)===Zo(n)?F(Li(e),Li(n)):e===n;if(e instanceof Date&&n instanceof Date)return e.toISOString()===n.toISOString();if(e instanceof Set&&n instanceof Set)return e.size===n.size&&[...e.values()].every(i=>n.has(i));if(e instanceof Error&&n instanceof Error)return e.message===n.message&&e.__proto__.constructor===n.__proto__.constructor;if(od(e)&&od(n)){let i=Object.keys(e),r=Object.keys(n);return i.length===r.length&&i.every(o=>F(e[o],n[o]))&&((a=e.__proto__)==null?void 0:a.constructor)===((t=n.__proto__)==null?void 0:t.constructor)}return e===n},"equals"),I=xn(function(e,n){return e===n},"is"),$o=xn(function(e,n,...a){return!e(n,...a)},"not"),sd=xn(function(e){return/^\s*$/.test(e)},"isBlank");function od(e){return!!e&&typeof e=="object"}function dg(e){return e instanceof Function&&og(e)===Yn&&Li(e).length===1}function Xo(e){return id(e)||"<function>"}function ud(e){let n=[];return a(e);function a(l){var c;if(l===null)return"null";if(typeof l=="function")return t(l,i);if(typeof l=="string")return es(l);if(typeof l=="bigint")return`${l}n`;if(Array.isArray(l))return t(l,r);if(l instanceof Date)return`Date(${l.toISOString().replace("T"," ").replace("Z"," UTC")})`;if(l instanceof RegExp)return String(l);if(l instanceof Error)return`${ld(l)}(${es(l.message)})`;if(l instanceof Set)return t(l,s);if(typeof l=="object"){let y=(c=l==null?void 0:l.__proto__)==null?void 0:c.constructor;return y===Object||!y?t(l,o):`${ld(l)} ${t(l,o)}`}return String(l)}function t(l,c){if(n.indexOf(l)>-1)return"<circular reference>";n.push(l);let y=c(l);return n.pop(),y}function i(l){let c=Li(l).map(a),y=Xo(l);return c.length?At(y+"(",c,",",")"):y}function r(l){return At("[",l.map(a),",","]")}function o(l){let c=Object.entries(l).map(([y,v])=>`${cg(y)}: ${a(v)}`);return At("{",c,",","}")}function s(l){let c=[...l.values()].map(a);return At("Set {",c,",","}")}}function cg(e){return/^[a-zA-Z0-9_$]+$/.test(e)?e:es(e)}function ld(e){return Xo(e.__proto__.constructor)}function es(e){return'"'+String(e).replace(/\\/g,"\\\\").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/"/g,'\\"').replace(/[\x00-\x1f\x7f]/g,hg)+'"'}function hg(e){let n=e.charCodeAt(0).toString(16);return"\\x"+(n.length<2?"0"+n:n)}function Pi(e,n){return n.split(`
`).map(a=>a&&mg(gg(e," "))(a)).join(`
`)}function gg(e,n){return Array(e+1).join(n)}var mg=e=>n=>e+n,fg=xn(function(n,a){return a.slice(0,n.length)===n?a.slice(n.length):a});function pg(e){return String(e).split(/\r?\n/)}function Sg(e){let n=pg(e);sd(rd(n))&&n.shift(),sd(ug(n))&&n.pop();let a=/^[ \t]*/.exec(rd(n))[0];return n.map(fg(a)).join(`
`)}function At(e,n,a,t){return n.length<2?e+n.join("")+t:e+`
`+Pi(2,n.join(a+`
`))+`
`+t}function cd(e){return Ct(this,null,function*(){let n=[];for(let a of e){let t=yield yg(a.fn),i=dd.map(r=>({type:"debug",args:r}));dd.length=0,n.push({test:a,error:t,instrumentLog:i})}return{results:n}})}function yg(e){let n;try{let a=e();if(a instanceof Promise)return new Promise(t=>{a.then(()=>t()).catch(t)})}catch(a){n=a}return Promise.resolve(n)}var dd=[],nf=xn(function(n,a){return a instanceof Di&&F(n,a.expectArgs)}),Ui=`

`;function hd({results:e}){let n=!1,a=!1,t=[];for(let i of e){let r=!1;i.error&&(r=n=!0),i.instrumentLog.length&&(r=a=!0),r&&t.push(i)}return n?kg(t):a?Tg(e.length,t):Ig(e.length)}function kg(e){return e.map(gd).join(Ui)+Ui+"Tests failed."}function Ig(e){switch(e){case 0:return"No tests to run.";case 1:return"One test ran, and found no issues.";default:return`${e} tests ran, and found no issues.`}}function Tg(e,n){return n.map(gd).join(Ui)+Ui+Ag(e)+`, but debugging instrumentation is present.
Remove it before shipping.`}function Ag(e){switch(e){case 1:return"The test passed";case 2:return"Both tests passed";default:return`All ${e} tests passed`}}function gd({test:e,error:n,instrumentLog:a}){let i=[e.subject+" "+e.scenario];return a.length&&i.push(Pi(2,vg(a))),n&&i.push(Pi(2,Eg(n))),i.join(`
`)}function Eg(e){return e instanceof Di?Mg(e):wg(e)}function vg(e){return e.map(({args:n})=>md("debug",n)).join("")}function Mg(e){return md("expect",e.expectArgs)}function wg(e){return ud(e)+" thrown"+Pi(2,Cg(e.stack))}function md(e,n){return At(e+"(",n.map(ud),",",")")}function Cg(e){if(!e)return"";let n=Sg(e).split(`
`);return`
`+n.slice(0,Og(n)).map(a=>a.replace(/(file:\/\/|http:\/\/[^/]*)/,"").replace(/^([^@]*)@(.*)$/,"at $1 ($2)")).join(`
`)}function Og(e){let n=e.findIndex(a=>a.includes("errorFrom"));return n===-1?e.length:n}var af=Object.freeze({test:{subject:"a thing",scenario:"does something",fn(){}},error:void 0,instrumentLog:[]}),Ng=lg(),{getAllTests:fd}=Ng;function x(...e){}function Tn(){return(+new Date%1e6/1e3).toFixed(3)}function V(e,n=0){return isNaN(e)||e===Infinity||e===-Infinity?"--:--":e<0?"-"+pd(-e,n):pd(e,n)}function pd(e,n){function a(o,s=Bg){return(o<10?"0":"")+s(o)}let t=Math.floor(e/3600),i=Math.floor(e%3600/60),r=e%60;return t>0?`${t}:${a(i)}:${a(r,Sd(n))}`:`${i}:${a(r,Sd(n))}`}function qe(e){let[n,a]=(()=>{switch(!0){case e>86400:return["days",e/86400];case e>3600:return["hours",e/3600];case e>60:return["minutes",e/60];default:return["seconds",e]}})();return`${a.toFixed(1)} ${n}`}x("hoursMinutesSeconds",{"formats NaN"(){m(V(0/0),I,"--:--")},"formats Infinities"(){m(V(Infinity),I,"--:--"),m(V(-Infinity),I,"--:--")},"formats negative numbers"(){m(V(-1),I,"-0:01"),m(V(-3661.12,2),I,"-1:01:01.12")},"formats single-digit seconds with leading zero"(){m(V(0),I,"0:00"),m(V(1),I,"0:01"),m(V(9),I,"0:09")},"formats double-digit seconds"(){m(V(10),I,"0:10"),m(V(59),I,"0:59")},"formats minutes"(){m(V(60),I,"1:00"),m(V(61),I,"1:01"),m(V(119),I,"1:59"),m(V(120),I,"2:00"),m(V(3599),I,"59:59")},"formats hours"(){m(V(3600),I,"1:00:00"),m(V(7200),I,"2:00:00"),m(V(3661),I,"1:01:01"),m(V(3610),I,"1:00:10"),m(V(3600+600),I,"1:10:00"),m(V(36001),I,"10:00:01")},"adds decimal places"(){m(V(0,0),I,"0:00"),m(V(0,1),I,"0:00.0"),m(V(0,2),I,"0:00.00")},"formats fractional seconds"(){m(V(1.23,2),I,"0:01.23")},"rounds decimals"(){m(V(2.3456,2),I,"0:02.35")}});x("durationAsWords",{zero(){m(qe(0),I,"0.0 seconds")},"two seconds"(){m(qe(2),I,"2.0 seconds")},"two minutes"(){m(qe(120),I,"2.0 minutes")},"two and a half minutes"(){m(qe(150),I,"2.5 minutes")},"two and a third minutes"(){m(qe(140),I,"2.3 minutes")},"two hours"(){m(qe(7200),I,"2.0 hours")},"two days"(){m(qe(48*3600),I,"2.0 days")}});var Bg=e=>e,Sd=e=>n=>n.toFixed(e);function Aa(e){var n;return(n=/v=(.{11})/.exec(e))==null?void 0:n[1]}function yd(){return{getPlayerState(){return re.UNSTARTED},getCurrentTime(){return 0},getVideoUrl(){return""},cueVideoById(){},playVideo(){},seekTo(){},getDuration(){return 0},addEventListener(){},removeEventListener(){},setVolume(){}}}function kd(e){return{getPlayerState(){return e.getPlayerState()},getCurrentTime(){return e.getCurrentTime()},getVideoUrl(){return e.getVideoUrl()},cueVideoById(...n){return console.debug(Tn(),"player.cueVideoById",...n),e.cueVideoById(...n)},playVideo(...n){return console.debug(Tn(),"player.playVideo",...n),e.playVideo(...n)},seekTo(...n){return console.debug(Tn(),"player.seekTo",...n,Aa(e.getVideoUrl())),e.seekTo(...n)},getDuration(){return e.getDuration()},addEventListener(...n){return console.debug(Tn(),"player.addEventListener"),e.addEventListener(...n)},removeEventListener(...n){return console.debug(Tn(),"player.removeEventListener"),e.removeEventListener(...n)},setVolume(...n){e.setVolume(...n)}}}var re={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};function Id(e){return Ct(this,null,function*(){let n=yield Wg();return new Promise(a=>{let t=new n.Player(e,{height:450,width:800,videoId:null,playerVars:{controls:0,disablekb:1},events:{onReady(){a(t)}}})})})}function Wg(){return Td?Promise.resolve(window.YT):new Promise(e=>{var n;if(document.querySelector("script[src='https://www.youtube.com/iframe_api']")===null){let a=document.createElement("script");a.src="https://www.youtube.com/iframe_api";let t=document.getElementsByTagName("script")[0];(n=t.parentNode)==null||n.insertBefore(a,t)}ns.push(e)})}var Td=!1,ns=[];window.onYouTubeIframeAPIReady=()=>{Td=!0,ns.forEach(e=>e(window.YT)),ns.length=0};function Ad(e,n){let a=Ye(),t=Ye();t.current=e,$e(()=>(a.current=setInterval(()=>{var i;return(i=t.current)==null?void 0:i.call(t)},n),()=>clearInterval(a.current)),[n])}function Ed(){let[e,n]=we(!1);return[e,()=>n(!0)]}function Et(e){switch(e){case re.BUFFERING:return"buffering";case re.UNSTARTED:return"unstarted";case re.CUED:return"cued";case re.ENDED:return"ended";case re.PLAYING:return"playing";case re.PAUSED:return"paused";default:return""}}function vd(e){return e.channel.getName()+" "+Et(e.code)}function Md(e){return E(Ot,null,e.channels.map(n=>E("button",{key:n.getName(),onClick:()=>e.onChannelSelected(n)},n.getName())))}var Fi={};zn(Fi,{episodes:()=>Gg,videos:()=>Rg});var Gg=[`# Elif'in Hecesi
...
g8twezOz2h4 0:03 WGBH Boston | Title Card | 2003 | PBS Kids
g8twezOz2h4 0:03 WGBH Boston | Title Card | 2003 | PBS Kids
`;var as={};zn(as,{episodes:()=>Lg,videos:()=>Dg});var Lg=[`
...
`;var ts={};zn(ts,{episodes:()=>Ug,videos:()=>Pg});var Pg=`
# Full album videos
...
`;function vt(e){try{e()}catch(n){return n}}function Ea(e,n){if(e.length===0)throw new Error("can't pick element from an empty array");if(n>=1||n<0)throw new Error("fraction out of bounds: "+n);return e[Math.floor(n*e.length)]}x("pick",{"throws if the array is empty"(){m(vt(()=>Ea([],0)),F,new Error("can't pick element from an empty array"))},"throws if the fraction is 1"(){m(vt(()=>Ea([""],1)),F,new Error("fraction out of bounds: 1"))},"throws if the fraction is > 1"(){m(vt(()=>Ea([""],1.25)),F,new Error("fraction out of bounds: 1.25"))},"throws if the fraction is > 0"(){m(vt(()=>Ea([""],-.25)),F,new Error("fraction out of bounds: -0.25"))},"picks the first element of the array given 0"(){m(Ea([1,2],0),I,1)},"picks the last element of the array given 1 - epsilon"(){m(Ea([1,2],.99),I,2)}});function Hi(e){return e.length===0}var Ki=(...e)=>e.reduce(Vg);x("pipe",{"given one function"(){m(Ki(n=>n+1)(1),I,2)},"given two functions"(){let e=n=>n+1;m(Ki(e,e)(1),I,3)}});function Vg(e,n){return(...a)=>n(e(...a))}function wd(e){return n=>n.map(e)}function Cd(e){return e.trim()}function Le(e){return{videos:e}}function bi({start:e,end:n}){return n-e}function ss(e){return e.segments.map(bi).reduce(jg,0)}x("duration",{"is the difference between the segment's start and end"(){m(bi({start:50,end:99}),I,49)}});x("videoDuration",{"is the sum of the segment durations"(){m(ss({videoId:"",title:"",segments:[{start:1,end:5},{start:10,end:13}]}),I,7)}});var jg=(e,n)=>e+n;function xi({videos:e,episodes:n}){return[...zg(n),...Me(e).map(Jg)]}var zg=wd(Ki(Me,Le));function Me(e){return e.split(/\n+/).map(Cd).filter($o(_g)).filter($o(Hi)).map(va(/ +/,3)).flatMap(([n,a,t])=>a==="SHORTS"?[]:[{videoId:n,segments:Qg(a),title:t}])}function Jg(e){return Le([e])}function be(e){return{start:0,end:e}}function Ze(e,n){return{start:e,end:n}}function _g(e){return e.startsWith("#")}function Qg(e){return e.split(",").map(qg)}function qg(e){let n=e.split("-");return n.length===1?be(Se(n[0])):Ze(Se(n[0]),Se(n[1]))}function Se(e){let n=[1,60,3600,86400],a=e.split(":").map(t=>parseInt(t,10)).reverse();return Zg(a,n).map(([t,i])=>t*i).reduce(Xg,0)}var va=(e,n=Infinity)=>a=>{if(typeof e=="string"&&e.length===0)throw"split(): empty delimiter not supported";let t=0,i=0,r=[],o=a;for(;r.length<n-1&&o.length>0;){let s=o.match(e);if(s==null)break;r.push(o.slice(0,s.index)),o=o.slice(s.index+s[0].length)}return r.push(o),r};function Zg(e,n){let a=[];for(let t=0;t<e.length&&t<n.length;t++)a.push([e[t],n[t]]);return a}function Xg(e,n){return e+n}x("parseVideos",{"handles empty string"(){m(Me(""),F,[])},"ignores spaces"(){m(Me("  "),F,[])},"ignores blank links"(){m(Me(`
...
# bar`),F,[])},"strips spaces before comments"(){m(Me(`  #foo
  # bar`),F,[])},"parses actual data"(){m(Me(`
    ...
    `),F,[{videoId:"leb645Xu6uo",segments:[{start:1,end:180},{start:600,end:661}],title:"The Title"}])},"removes shorts"(){m(Me(`
      ...
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
    `),F,[{videoId:"leb645Xu6uo",segments:[{start:0,end:654}],title:"Captain Murderer - Emlyn Williams"}])}});x("parseDuration",{"0:00"(){m(Se("0:00"),I,0)},"00:00"(){m(Se("00:00"),I,0)},"1 second"(){m(Se("0:01"),I,1)},"10 seconds"(){m(Se("0:10"),I,10)},"1 minute"(){m(Se("1:00"),I,60)},"1 minute 10 seconds"(){m(Se("1:10"),I,70)},"10 minutes 10 seconds"(){m(Se("10:10"),I,610)},"1 hour"(){m(Se("1:00:00"),I,3600)},"1 hour 1 second"(){m(Se("1:00:01"),I,3601)},"10 hours 1 second"(){m(Se("10:00:01"),I,36001)},"1 day 1 second"(){m(Se("1:0:00:01"),I,86401)}});x("split",{"empty string"(){m(va(" ")(""),F,[""])},"no limit"(){m(va(" ")("a b c"),F,["a","b","c"])},limit(){m(va(" ",2)("a b c"),F,["a","b c"])},regex(){m(va(/ +/)("a b   c"),F,["a","b","c"])}});var Od=window.ENVIRONMENT==="development",Nd=[["Channel 1","shuffle",Fi],["Channel 2","shuffle",as],["Channel 3","shuffle",ts],["Channel 4","shuffle",is],["🎄","shuffle",rs],Od?["debug","shuffle",os]:null,Od?["segments","test-segment-boundaries",Fi]:null].filter(Boolean).map(([e,n,a])=>[e,n,xi(a)]);function Bd(){let[e,n]=we(+new Date);return Ad(()=>n(+new Date),250),e}function Wd(e=""){return{type:"nothing",nextVideoId:e}}var An=2;function Gd(e,n){let{state:a,videoId:t,time:i}=n;if(e.type==="nothing")switch(a){case re.ENDED:case re.CUED:case re.UNSTARTED:return e.nextVideoId?t!==e.nextVideoId?[{type:"cue",videoId:e.nextVideoId,timestamp:0}]:[{type:"seek",timestamp:0},{type:"play"}]:[];default:return[]}else{if(a===re.BUFFERING)return[];let{videoId:r,currentTime:o}=e;if(t!==r)return[{type:"cue",videoId:r,timestamp:o<An?0:o}];{let s=[];switch(a){case re.PAUSED:case re.CUED:case re.UNSTARTED:t&&s.push({type:"play"})}return i&&$g(i,o)>=An&&(console.debug("time is off; seeking",i,o),s.push({type:"seek",timestamp:o})),s}}}function $g(e,n){return Math.abs(e-n)}var em=0;function nm(){let[,e]=we(0);return()=>e(++em)}function Rd(e){let n=nm(),a=Ye(yd());return $e(()=>{Id(e).then(t=>{a.current=t,t.addEventListener("onStateChange",i=>{console.debug(Tn(),"player onStateChange",Et(i.data),Aa(t.getVideoUrl())),n()}),n()})},[e]),a.current}var Ld="javascript:(function()%7Bfunction%20last(e)%7Breturn%20e%5Be.length-1%5D%7Dfunction%20scrapeVideos()%7Breturn%2F%5C%2Fwatch%5C%3F%7C%5C%2Fembed%5C%2F%2F.test(window.location)%3F%5B%2Fv%3D(.%7B11%7D)%2F.exec(window.location)%3F.%5B1%5D%3F%3F%2Fembed%5C%2F(.%7B11%7D)%2F.exec(window.location)%3F.%5B1%5D%2Clast(document.querySelectorAll(%22.ytp-time-duration%22)).innerText.trim()%2Cdocument.querySelector(%22a.ytp-title-link%22).innerText.split(%22%5Cn%22)%5B0%5D.trim()%5D.join(%22%20%22)%3A%2F%5C%2Fplaylist%5C%3F%2F.test(window.location)%3F%5B...document.querySelectorAll(%22ytd-playlist-video-renderer%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22a%23video-title%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Cn%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Co%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bn%7D%20%24%7Bo%7D%60%7D)).join(%22%5Cn%22)%3A%5B...document.querySelectorAll(%22ytd-rich-grid-media%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22a%23thumbnail%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Cn%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Co%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bn%7D%20%24%7Bo%7D%60%7D)).join(%22%5Cn%22)%7Dconst%20videos%3DscrapeVideos()%3Bconsole.log(videos)%2Cnavigator.clipboard.writeText(videos).catch((e%3D%3Econsole.error(e)))%3B%7D)()";function am({broadcast:e,player:n}){var t;let a=i=>V(i,2);return{videoLink:e.type==="video"?{text:e.videoTitle,href:"https://youtube.com/watch?v="+e.videoId}:null,actual:{video:(t=n.videoId)!=null?t:"",playerState:Et(n.state),currentTime:n.time!=null?a(n.time):"-"},scheduled:{video:e.type==="video"?e.videoId:"-",playerState:e.type,currentTime:e.type==="video"?a(e.currentTime):"-"},secondsBehindSchedule:e.type==="video"&&n.time!=null?(e.currentTime-n.time).toFixed(2):"-",timeRemainingInVideo:n.duration!=null&&n.time!=null?a(n.duration-n.time):"-"}}function Dd(e){let{isOpen:n,broadcast:a,player:t,onClose:i}=e,r=am({broadcast:a,player:t}),o=Ye(null);return $e(()=>{var s;if(n){(s=o.current)==null||s.focus();let l=c=>{c.key==="Escape"&&i()};return document.addEventListener("keydown",l),()=>document.removeEventListener("keydown",l)}},[n]),E("div",{role:"dialog",className:"info-pane"},E("button",{ref:o,className:"close-button","aria-label":"close info pane",onClick:i},"close"),E("h1",null,"Culture Machine"),E("p",null,"Made by ",E("a",{href:"https://github.com/benchristel"},"Ben Christel"),"."," ",E("a",{href:"https://github.com/benchristel/tv"},"Source code here"),". Some rights reserved. See the"," ",E("a",{href:"https://www.gnu.org/licenses/gpl-3.0.en.html"},"license"),"."),E("p",null,E("span",{dangerouslySetInnerHTML:{__html:`
          <a href="${Ld}">
            Bookmarklet to scrape videos from YouTube
          </a>
        `}})," ","(",E("a",{href:"https://github.com/benchristel/tv#what-is-a-bookmarklet"},"What's this?"),")"),E("hr",null),E("h2",null,"Video Info"),E("p",{style:{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},"Now playing:"," ",r.videoLink?E("a",{href:r.videoLink.href},r.videoLink.text):"-"),E("table",null,E("thead",null,E("tr",null,E("td",null),E("th",{scope:"col"},"actual"),E("th",{scope:"col"},"scheduled"))),E("tbody",null,E("tr",null,E("th",{scope:"row"},"video"),E("td",null,r.actual.video),E("td",null,r.scheduled.video)),E("tr",null,E("th",{scope:"row"},"player state"),E("td",null,r.actual.playerState),E("td",null,r.scheduled.playerState)),E("tr",null,E("th",{scope:"row"},"current time"),E("td",null,r.actual.currentTime),E("td",null,r.scheduled.currentTime)))),E("p",null,"Seconds behind schedule: ",r.secondsBehindSchedule),E("p",null,"Time remaining in video: ",r.timeRemainingInVideo),E("h2",null,"Channel Stats"),E("table",null,E("thead",null,E("tr",null,E("th",{scope:"col"},"name"),E("th",{scope:"col"},"duration"))),E("tbody",null,e.channels.map(s=>E(tm,{channel:s})))),E("div",{style:{height:60}}))}function tm(e){return E("tr",null,E("td",null,e.channel.getName()),E("td",null,qe(e.channel.getTotalDuration())))}var ls=class extends Ss{componentDidUpdate(){let{player:n,volume:a,commands:t}=this.props;n.setVolume(Yi(a)),t.forEach(i=>{switch(i.type){case"play":n.playVideo();break;case"cue":n.cueVideoById(i.videoId,i.timestamp);break;case"seek":n.seekTo(i.timestamp);break;default:console.error("unexpected video command type",i.type,i)}})}render(){return null}};function Yi(e){return im(e/100)*100}x("fromPerceivedVolume",{"returns 0 given 0"(){m(Yi(0),I,0)},"returns 100 given 100"(){m(Yi(100),I,100)},"returns 25 given 50"(){m(Yi(50),I,25)}});function im(e){return e*e}function Pd(e){return{state:e.getPlayerState(),videoId:Aa(e.getVideoUrl()),time:e.getCurrentTime(),duration:e.getDuration()}}function Ma(e,n){let a={};return t=>(t in a||(Object.keys(a).length===e&&(a={}),a[t]=n(t)),a[t])}x("cache",{"caches a value"(){let e=0,n=Ma(1,()=>(e++,123));n("foo"),n("foo"),m(e,I,1)},"computes and caches values by key"(){let e=Ma(2,n=>n+"x");m(e("foo"),I,"foox"),m(e("bar"),I,"barx")},"caches multiple values"(){let e=0,n=Ma(2,a=>(e++,a+"x"));n("foo"),n("foo"),n("bar"),n("bar"),m(e,I,2),m(n("foo"),I,"foox"),m(n("bar"),I,"barx")},"a max size of 0 means no limit"(){let e=0,n=Ma(0,()=>(e++,123));n("a"),n("b"),n("c"),m(e,I,3)}});function Mt(e){let n=1779033703,a=3144134277,t=1013904242,i=2773480762;for(let r=0,o;r<e.length;r++)o=e.charCodeAt(r),n=a^Math.imul(n^o,597399067),a=t^Math.imul(a^o,2869860233),t=i^Math.imul(t^o,951274213),i=n^Math.imul(i^o,2716044179);return n=Math.imul(t^n>>>18,597399067),a=Math.imul(i^a>>>22,2869860233),t=Math.imul(n^t>>>17,951274213),i=Math.imul(a^i>>>19,2716044179),[(n^a^t^i)>>>0,(a^n)>>>0,(t^n)>>>0,(i^n)>>>0]}x("cyrb128_32",{"hashes unix timestamps to random-looking values"(){m(Mt("1661673600"),F,[1866196007,1194674827,898714046,497018642]),m(Mt("1661760000"),F,[3655929289,901600698,732811234,3355023249]),m(Mt("1661846400"),F,[2165297363,2940322590,3636107238,4143219755])}});function Vi(e,n,a,t){function i(){e|=0,n|=0,a|=0,t|=0;var r=(e+n|0)+t|0;return t=t+1|0,e=n^n>>>9,n=a+(a<<3)|0,a=a<<21|a>>>11,a=a+r|0,(r>>>0)/4294967296}for(let r=0;r<20;r++)i();return i}function ji(e,n,a){return e+Math.floor(a()*(n+1-e))}x("sfc32",{"flips coins fairly"(){let e=0,n=0,a=Vi(0,0,0,0);for(let t=0;t<200;t++)a()<.5?e++:n++;m(e-n,I,-8)},"generates a reasonably uniform distribution of numbers"(){let e=new Set,n=Vi(0,0,0,0);for(let a=0;a<100;a++)e.add(Math.floor(n()*1e4));m(e.size,I,99)}});x("randomIntInRange",{"when low and high are the same"(){m(ji(3,3,Math.random),I,3)},"when low and high are 1 apart"(){let e=new Set;for(let n=0;n<30;n++)e.add(ji(0,1,Math.random));m(e,F,new Set([0,1]))}});function Q(e,n){let a=-1,t=e.length-1;for(;a<t;){let i=rm(a,t);n(e[i])?a=i:t=i-1}return e[a]}function rm(e,n){return Math.ceil((e+n)/2)}x("binarySearch",{"returns undefined given an empty array"(){m(Q([],()=>!1),I,void 0)},"returns an element that is to the left of the target"(){m(Q([1],()=>!0),I,1)},"returns undefined when the only element is not left of the target"(){m(Q([1],()=>!1),I,void 0)},"returns the rightmost element that is left of the target"(){m(Q([1,2,3,4],e=>e<=2.5),I,2)},"works with duplicates"(){m(Q([0,1,2,3,0,0,0,0,0],e=>e>0),I,3)},"works with two elements"(){m(Q([1,2],e=>e<=1.5),I,1),m(Q([1,2],e=>e<=2),I,2)},"works with three elements"(){m(Q([1,2,3],e=>e<=1.5),I,1),m(Q([1,2,3],e=>e<=2),I,2),m(Q([1,2,3],e=>e<=3),I,3)},"works with four elements"(){m(Q([1,2,3,4],e=>e<=1.5),I,1),m(Q([1,2,3,4],e=>e<=2),I,2),m(Q([1,2,3,4],e=>e<=3),I,3),m(Q([1,2,3,4],e=>e<=4),I,4)},"works with five elements"(){m(Q([1,2,3,4,5],e=>e<=1.5),I,1),m(Q([1,2,3,4,5],e=>e<=2),I,2),m(Q([1,2,3,4,5],e=>e<=3),I,3),m(Q([1,2,3,4,5],e=>e<=4),I,4),m(Q([1,2,3,4,5],e=>e<=5),I,5)}});var us=8*3600,Ud=24*3600;function En(e,n){let a=Ma(1,wa(n)),t=null;return{getBroadcast:i,getTotalDuration:r,getName(){return e}};function i(o){var p;let s=o/1e3,l=(s-us)%Ud,c=s-l,y=a(String(c)),v=Q(y,w=>w.startSecondOfDay<=l);return(v==null?void 0:v.type)==="video"?{type:"video",videoId:v.videoId,videoTitle:v.videoTitle,currentTime:l-v.startSecondOfDay+v.startSecondOfVideo}:{type:"nothing",nextVideoId:(p=v==null?void 0:v.nextVideoId)!=null?p:""}}function r(){return t==null&&(t=n.flatMap(sm).map(ss).reduce(om,0)),t}}var wa=e=>n=>{if(Hi(e))return[];e=[...e];let a=Vi(...Mt(n)),t=0,i=[],r=0;for(;t<Ud;){r===e.length&&(r=0),lm(e,r,ji(r,e.length-1,a));let o=e[r++];for(let s of o.videos){i.push({type:"nothing",startSecondOfDay:t,nextVideoId:s.videoId}),t+=An;for(let l of s.segments)i.push({type:"video",videoId:s.videoId,videoTitle:s.title,startSecondOfDay:t,startSecondOfVideo:l.start}),t+=bi(l)}}return i};function lm(e,n,a){let t=e[n];e[n]=e[a],e[a]=t}function om(e,n){return e+n}function sm(e){return e.videos}function vn(...e){return{videoId:"",title:"",segments:e}}function wt(){return!0}var Fd=[];x("a Channel",{"broadcasts nothing given no episodes"(){let e=En("",Fd);m(e.getBroadcast(999),F,{type:"nothing",nextVideoId:""})},"starts a video when it's supposed to start"(){let e=[Le([vn(Ze(1e3,2e3))])],n=En("",e),a=(us+5)*1e3;m(n.getBroadcast(a),F,{type:"video",currentTime:1003,videoId:"",videoTitle:""})},"has a total duration of 0 given no videos"(){let e=En("",Fd);m(e.getTotalDuration(),I,0)},"sums the durations of its videos"(){let e=[Le([vn({start:0,end:1}),vn({start:0,end:2})]),Le([vn({start:0,end:3})])],n=En("",e);m(n.getTotalDuration(),I,6)}});x("ScheduleGenerator",{"schedules a single 24-hour video"(){let e=[Le([xe(xe({},vn(be(3600*24))),{videoId:"the-video-id"})])],n=wa(e);m(n(""),F,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:Yn(wt),startSecondOfDay:2,startSecondOfVideo:0}])},"schedules a 12-hour video twice"(){let e=[Le([xe(xe({},vn(be(3600*12))),{videoId:"the-video-id"})])],n=wa(e);m(n(""),F,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:Yn(wt),startSecondOfDay:2,startSecondOfVideo:0},{type:"nothing",startSecondOfDay:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:Yn(wt),startSecondOfDay:43204,startSecondOfVideo:0}])},"schedules a time window of a video"(){let e=[Le([xe(xe({},vn(Ze(3600,3600*13))),{videoId:"the-video-id"})])],n=wa(e);m(n(""),F,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:Yn(wt),startSecondOfDay:2,startSecondOfVideo:3600},{type:"nothing",startSecondOfDay:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:Yn(wt),startSecondOfDay:43204,startSecondOfVideo:3600}])},"picks the videos to show randomly"(){let e=["one","two","three"].map(a=>Le([xe(xe({},vn(be(3600*2))),{videoId:a})])),n=wa(e);m(n("asdfx").map(a=>a.videoId).filter(Boolean),F,["three","one","two","three","two","one","one","two","three","two","three","one"])}});function Hd(e,n){let a=ds(n.flatMap(s=>s.videos)),t=a.map(s=>s.duration).reduce(um,0);return{getName:i,getBroadcast:r,getTotalDuration:o};function i(){return e}function r(s){var v;let c=s/1e3%t,y=Q(a,p=>p.startSecondOfSchedule<=c);return(y==null?void 0:y.type)==="video"?{type:"video",videoId:y.videoId,videoTitle:y.videoTitle,currentTime:c-y.startSecondOfSchedule+y.startSecondOfVideo}:{type:"nothing",nextVideoId:(v=y==null?void 0:y.nextVideoId)!=null?v:""}}function o(){return 0}}function ds(e){let n=7,a=0,t=[];for(let i of e)if(i.segments.length!==1){t.push({type:"nothing",nextVideoId:i.videoId,duration:An,startSecondOfSchedule:a}),a+=An,t.push({type:"video",videoId:"TxJtoBAa2w0",videoTitle:"",duration:3,startSecondOfVideo:3,startSecondOfSchedule:a}),a+=3;for(let r=0;r<i.segments.length;r++){let o=i.segments[r];if(r!==0){let s=cm(o,n);t.push({type:"video",videoId:i.videoId,videoTitle:i.title,duration:s.duration,startSecondOfVideo:s.start,startSecondOfSchedule:a}),a+=s.duration}if(r!==dm(i.segments)){let s=hm(o,n);t.push({type:"video",videoId:i.videoId,videoTitle:i.title,duration:s.duration,startSecondOfVideo:s.start,startSecondOfSchedule:a}),a+=s.duration}}}return t}x("createSchedule",{"returns empty when each video has only one segment"(){let e=[cs("",be(60)),cs("",be(60))];m(ds(e),F,[])},"plays the end of the first segment and the beginning of the second"(){let e=[cs("id-1",Ze(0,60),Ze(120,999))];m(ds(e),F,[{type:"nothing",nextVideoId:"id-1",duration:2,startSecondOfSchedule:0},{type:"video",videoId:"TxJtoBAa2w0",videoTitle:"",duration:3,startSecondOfVideo:3,startSecondOfSchedule:2},{type:"video",videoId:"id-1",videoTitle:"",duration:7,startSecondOfVideo:53,startSecondOfSchedule:5},{type:"video",videoId:"id-1",videoTitle:"",duration:7,startSecondOfVideo:120,startSecondOfSchedule:12}])}});function dm(e){return e.length-1}function cm(e,n){return{start:e.start,duration:n}}function hm(e,n){return{start:e.end-n,duration:n}}var um=(e,n)=>e+n;function cs(e,...n){return{videoId:e,title:"",segments:n}}function Kd(e){return E("div",{className:"volume"},E("div",{className:"volume-icon"}),E("input",{"aria-label":"volume",type:"range",min:"0",max:"100",onChange:n=>e.onChange(n.target.value),value:e.volume}))}var hs=Nd.map(([e,n,a])=>{switch(n){case"shuffle":return En(e,a);case"test-segment-boundaries":return Hd(e,a)}});function bd(){let[e,n]=Ed(),[a,t]=we(!1),[i,r]=we(hs[0]),[o,s]=we(100),l=Bd(),c=e?i.getBroadcast(l):Wd(),y=kd(Rd("player-container")),v=Pd(y),p=v.state,w=p!==re.PLAYING,G=Gd(c,v),N=Ye(null),h=zi(()=>{var d;t(!1),(d=N.current)==null||d.focus()},[]),u=zi(()=>{t(!0)},[]);return E(gm,{effects:E(ls,{player:y,commands:G,volume:o}),screen:E("div",{className:a?"info-pane-open":""},E("div",{className:"player-assembly"},E("div",{id:"player-container"}),w&&E("div",{className:"black-screen"},E(vd,{code:p,channel:i})),!e&&E(mm,{onClick:n})),E(Dd,{isOpen:a,player:v,broadcast:c,channels:hs,onClose:h}),E("div",{className:"info-pane-close-overlay","aria-hidden":!0,onClick:h})),controlPanel:E(Ot,null,E(Md,{channels:hs,onChannelSelected:d=>{r(d),n()}}),E(Kd,{volume:o,onChange:s}),E("button",{className:a?"info-button info-button-info-pane-open":"info-button",onClick:()=>{(a?h:u)()},ref:N},"Info"))})}function gm(e){return E("div",{className:"App"},E("div",{className:"bezel"},E("div",{className:"screen"},e.screen),E("div",{style:{height:"12px"}}),E("div",{className:"controls"},e.controlPanel),e.effects))}function mm(e){return E("button",{id:"start",onClick:e.onClick},"▸ Play")}function xd(){let[e,n]=we("");return $e(()=>{cd(fd()).then(hd).then(n).catch(a=>n(a.message))},[]),/fail/i.test(e)?E("div",{className:"TestResults"},E("code",null,E("pre",null,e))):null}Jo(E(bd,null),document.getElementById("app"));Jo(E(xd,null),document.getElementById("test-results"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
