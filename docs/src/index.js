...
`;function cd({results:e}){let n=!1,a=!1,t=[];for(let i of e){let r=!1;i.error&&(r=n=!0),i.instrumentLog.length&&(r=a=!0),r&&t.push(i)}return n?yg(t):a?Tg(e.length,t):kg(e.length)}function yg(e){return e.map(hd).join(Ui)+Ui+"Tests failed."}function kg(e){switch(e){case 0:return"No tests to run.";case 1:return"One test ran, and found no issues.";default:return`${e} tests ran, and found no issues.`}}function Tg(e,n){return n.map(hd).join(Ui)+Ui+Ig(e)+`, but debugging instrumentation is present.
Remove it before shipping.`}function Ig(e){switch(e){case 1:return"The test passed";case 2:return"Both tests passed";default:return`All ${e} tests passed`}}function hd({test:e,error:n,instrumentLog:a}){let i=[e.subject+" "+e.scenario];return a.length&&i.push(Pi(2,vg(a))),n&&i.push(Pi(2,Ag(n))),i.join(`
`)}function Ag(e){return e instanceof Di?Eg(e):wg(e)}function vg(e){return e.map(({args:n})=>gd("debug",n)).join("")}function Eg(e){return gd("expect",e.expectArgs)}function wg(e){return ld(e)+" thrown"+Pi(2,Mg(e.stack))}function gd(e,n){return vt(e+"(",n.map(ld),",",")")}function Mg(e){if(!e)return"";let n=pg(e).split(`
`);return`
`+n.slice(0,Cg(n)).map(a=>a.replace(/(file:\/\/|http:\/\/[^/]*)/,"").replace(/^([^@]*)@(.*)$/,"at $1 ($2)")).join(`
`)}function Cg(e){let n=e.findIndex(a=>a.includes("errorFrom"));return n===-1?e.length:n}var af=Object.freeze({test:{subject:"a thing",scenario:"does something",fn(){}},error:void 0,instrumentLog:[]}),Og=sg(),{getAllTests:md}=Og;function x(...e){}function kn(){return(+new Date%1e6/1e3).toFixed(3)}function V(e,n=0){return isNaN(e)||e===Infinity||e===-Infinity?"--:--":e<0?"-"+fd(-e,n):fd(e,n)}function fd(e,n){function a(o,s=Ng){return(o<10?"0":"")+s(o)}let t=Math.floor(e/3600),i=Math.floor(e%3600/60),r=e%60;return t>0?`${t}:${a(i)}:${a(r,pd(n))}`:`${i}:${a(r,pd(n))}`}function Qe(e){let[n,a]=(()=>{switch(!0){case e>86400:return["days",e/86400];case e>3600:return["hours",e/3600];case e>60:return["minutes",e/60];default:return["seconds",e]}})();return`${a.toFixed(1)} ${n}`}x("hoursMinutesSeconds",{"formats NaN"(){m(V(0/0),T,"--:--")},"formats Infinities"(){m(V(Infinity),T,"--:--"),m(V(-Infinity),T,"--:--")},"formats negative numbers"(){m(V(-1),T,"-0:01"),m(V(-3661.12,2),T,"-1:01:01.12")},"formats single-digit seconds with leading zero"(){m(V(0),T,"0:00"),m(V(1),T,"0:01"),m(V(9),T,"0:09")},"formats double-digit seconds"(){m(V(10),T,"0:10"),m(V(59),T,"0:59")},"formats minutes"(){m(V(60),T,"1:00"),m(V(61),T,"1:01"),m(V(119),T,"1:59"),m(V(120),T,"2:00"),m(V(3599),T,"59:59")},"formats hours"(){m(V(3600),T,"1:00:00"),m(V(7200),T,"2:00:00"),m(V(3661),T,"1:01:01"),m(V(3610),T,"1:00:10"),m(V(3600+600),T,"1:10:00"),m(V(36001),T,"10:00:01")},"adds decimal places"(){m(V(0,0),T,"0:00"),m(V(0,1),T,"0:00.0"),m(V(0,2),T,"0:00.00")},"formats fractional seconds"(){m(V(1.23,2),T,"0:01.23")},"rounds decimals"(){m(V(2.3456,2),T,"0:02.35")}});x("durationAsWords",{zero(){m(Qe(0),T,"0.0 seconds")},"two seconds"(){m(Qe(2),T,"2.0 seconds")},"two minutes"(){m(Qe(120),T,"2.0 minutes")},"two and a half minutes"(){m(Qe(150),T,"2.5 minutes")},"two and a third minutes"(){m(Qe(140),T,"2.3 minutes")},"two hours"(){m(Qe(7200),T,"2.0 hours")},"two days"(){m(Qe(48*3600),T,"2.0 days")}});var Ng=e=>e,pd=e=>n=>n.toFixed(e);function Aa(e){var n;return(n=/v=(.{11})/.exec(e))==null?void 0:n[1]}function Sd(){return{getPlayerState(){return re.UNSTARTED},getCurrentTime(){return 0},getVideoUrl(){return""},cueVideoById(){},playVideo(){},seekTo(){},getDuration(){return 0},addEventListener(){},removeEventListener(){},setVolume(){}}}function yd(e){return{getPlayerState(){return e.getPlayerState()},getCurrentTime(){return e.getCurrentTime()},getVideoUrl(){return e.getVideoUrl()},cueVideoById(...n){return console.debug(kn(),"player.cueVideoById",...n),e.cueVideoById(...n)},playVideo(...n){return console.debug(kn(),"player.playVideo",...n),e.playVideo(...n)},seekTo(...n){return console.debug(kn(),"player.seekTo",...n,Aa(e.getVideoUrl())),e.seekTo(...n)},getDuration(){return e.getDuration()},addEventListener(...n){return console.debug(kn(),"player.addEventListener"),e.addEventListener(...n)},removeEventListener(...n){return console.debug(kn(),"player.removeEventListener"),e.removeEventListener(...n)},setVolume(...n){e.setVolume(...n)}}}var re={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};function kd(e){return Ot(this,null,function*(){let n=yield Bg();return new Promise(a=>{let t=new n.Player(e,{height:450,width:800,videoId:null,playerVars:{controls:0,disablekb:1},events:{onReady(){a(t)}}})})})}function Bg(){return Td?Promise.resolve(window.YT):new Promise(e=>{var n;if(document.querySelector("script[src='https://www.youtube.com/iframe_api']")===null){let a=document.createElement("script");a.src="https://www.youtube.com/iframe_api";let t=document.getElementsByTagName("script")[0];(n=t.parentNode)==null||n.insertBefore(a,t)}es.push(e)})}var Td=!1,es=[];window.onYouTubeIframeAPIReady=()=>{Td=!0,es.forEach(e=>e(window.YT)),es.length=0};function Id(e,n){let a=Oa(),t=Oa();t.current=e,zn(()=>(a.current=setInterval(()=>{var i;return(i=t.current)==null?void 0:i.call(t)},n),()=>clearInterval(a.current)),[n])}function Ad(){let[e,n]=Me(!1);return[e,()=>n(!0)]}function Et(e){switch(e){case re.BUFFERING:return"buffering";case re.UNSTARTED:return"unstarted";case re.CUED:return"cued";case re.ENDED:return"ended";case re.PLAYING:return"playing";case re.PAUSED:return"paused";default:return""}}function vd(e){return e.channel.getName()+" "+Et(e.code)}function Ed(e){return A(jn,null,e.channels.map(n=>A("button",{key:n.getName(),onClick:()=>e.onChannelSelected(n)},n.getName())))}var Fi={};Vn(Fi,{episodes:()=>Wg,videos:()=>Gg});var Wg=[`# Elif'in Hecesi
...
g8twezOz2h4 0:03 WGBH Boston | Title Card | 2003 | PBS Kids
g8twezOz2h4 0:03 WGBH Boston | Title Card | 2003 | PBS Kids
`;var ns={};Vn(ns,{episodes:()=>Rg,videos:()=>Lg});var Rg=[`
