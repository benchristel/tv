...
`)}function Vh(e){return e instanceof Ei?qh(e):Zh(e)}function _h(e){return e.map(({args:n})=>Qu("debug",n)).join("")}function qh(e){return Qu("expect",e.expectArgs)}function Zh(e){return Fu(e)+" thrown"+wi(2,Xh(e.stack))}function Qu(e,n){return ht(e+"(",n.map(Fu),",",")")}function Xh(e){if(!e)return"";let n=Yh(e).split(`
`);return`
