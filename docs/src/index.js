var ft=(e,n,a)=>new Promise((t,i)=>{var r=l=>{try{s(a.next(l))}catch(d){i(d)}},o=l=>{try{s(a.throw(l))}catch(d){i(d)}},s=l=>l.done?t(l.value):Promise.resolve(l.value).then(r,o);s((a=a.apply(e,n)).next())});function je(e,n,a){return a={path:n,exports:{},require:function(t,i){return ud(t,i==null?a.path:i)}},e(a,a.exports),a.exports}function ud(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var bo=Object.getOwnPropertySymbols,dd=Object.prototype.hasOwnProperty,cd=Object.prototype.propertyIsEnumerable;function hd(e){if(e==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(e)}function gd(){try{if(!Object.assign)return!1;var e=new String("abc");if(e[5]="de",Object.getOwnPropertyNames(e)[0]==="5")return!1;for(var n={},a=0;a<10;a++)n["_"+String.fromCharCode(a)]=a;var t=Object.getOwnPropertyNames(n).map(function(r){return n[r]});if(t.join("")!=="0123456789")return!1;var i={};return"abcdefghijklmnopqrst".split("").forEach(function(r){i[r]=r}),Object.keys(Object.assign({},i)).join("")==="abcdefghijklmnopqrst"}catch(r){return!1}}var md=gd()?Object.assign:function(e,n){for(var a,t=hd(e),i,r=1;r<arguments.length;r++){a=Object(arguments[r]);for(var o in a)dd.call(a,o)&&(t[o]=a[o]);if(bo){i=bo(a);for(var s=0;s<i.length;s++)cd.call(a,i[s])&&(t[i[s]]=a[i[s]])}}return t},b=md;var pd=je(function(e,n){var a=60103,t=60106;n.Fragment=60107,n.StrictMode=60108,n.Profiler=60114;var i=60109,r=60110,o=60112;n.Suspense=60113;var s=60115,l=60116;if(typeof Symbol=="function"&&Symbol.for){var d=Symbol.for;a=d("react.element"),t=d("react.portal"),n.Fragment=d("react.fragment"),n.StrictMode=d("react.strict_mode"),n.Profiler=d("react.profiler"),i=d("react.provider"),r=d("react.context"),o=d("react.forward_ref"),n.Suspense=d("react.suspense"),s=d("react.memo"),l=d("react.lazy")}var y=typeof Symbol=="function"&&Symbol.iterator;function N(g){return g===null||typeof g!="object"?null:(g=y&&g[y]||g["@@iterator"],typeof g=="function"?g:null)}function f(g){for(var k="https://reactjs.org/docs/error-decoder.html?invariant="+g,H=1;H<arguments.length;H++)k+="&args[]="+encodeURIComponent(arguments[H]);return"Minified React error #"+g+"; visit "+k+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var I={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},B={};function w(g,k,H){this.props=g,this.context=k,this.refs=B,this.updater=H||I}w.prototype.isReactComponent={},w.prototype.setState=function(g,k){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error(f(85));this.updater.enqueueSetState(this,g,k,"setState")},w.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function h(){}h.prototype=w.prototype;function u(g,k,H){this.props=g,this.context=k,this.refs=B,this.updater=H||I}var c=u.prototype=new h;c.constructor=u,b(c,w.prototype),c.isPureReactComponent=!0;var m={current:null},p=Object.prototype.hasOwnProperty,K={key:!0,ref:!0,__self:!0,__source:!0};function v(g,k,H){var x,S={},M=null,O=null;if(k!=null)for(x in k.ref!==void 0&&(O=k.ref),k.key!==void 0&&(M=""+k.key),k)p.call(k,x)&&!K.hasOwnProperty(x)&&(S[x]=k[x]);var R=arguments.length-2;if(R===1)S.children=H;else if(1<R){for(var L=Array(R),X=0;X<R;X++)L[X]=arguments[X+2];S.children=L}if(g&&g.defaultProps)for(x in R=g.defaultProps,R)S[x]===void 0&&(S[x]=R[x]);return{$$typeof:a,type:g,key:M,ref:O,props:S,_owner:m.current}}function P(g,k){return{$$typeof:a,type:g.type,key:k,ref:g.ref,props:g.props,_owner:g._owner}}function U(g){return typeof g=="object"&&g!==null&&g.$$typeof===a}function G(g){var k={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(H){return k[H]})}var V=/\/+/g;function fe(g,k){return typeof g=="object"&&g!==null&&g.key!=null?G(""+g.key):k.toString(36)}function Kn(g,k,H,x,S){var M=typeof g;(M==="undefined"||M==="boolean")&&(g=null);var O=!1;if(g===null)O=!0;else switch(M){case"string":case"number":O=!0;break;case"object":switch(g.$$typeof){case a:case t:O=!0}}if(O)return O=g,S=S(O),g=x===""?"."+fe(O,0):x,Array.isArray(S)?(H="",g!=null&&(H=g.replace(V,"$&/")+"/"),Kn(S,k,H,"",function(X){return X})):S!=null&&(U(S)&&(S=P(S,H+(!S.key||O&&O.key===S.key?"":(""+S.key).replace(V,"$&/")+"/")+g)),k.push(S)),1;if(O=0,x=x===""?".":x+":",Array.isArray(g))for(var R=0;R<g.length;R++){M=g[R];var L=x+fe(M,R);O+=Kn(M,k,H,L,S)}else if(L=N(g),typeof L=="function")for(g=L.call(g),R=0;!(M=g.next()).done;)M=M.value,L=x+fe(M,R++),O+=Kn(M,k,H,L,S);else if(M==="object")throw k=""+g,Error(f(31,k==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":k));return O}function re(g,k,H){if(g==null)return g;var x=[],S=0;return Kn(g,x,"","",function(M){return k.call(H,M,S++)}),x}function ae(g){if(g._status===-1){var k=g._result;k=k(),g._status=0,g._result=k,k.then(function(H){g._status===0&&(H=H.default,g._status=1,g._result=H)},function(H){g._status===0&&(g._status=2,g._result=H)})}if(g._status===1)return g._result;throw g._result}var pn={current:null};function oe(){var g=pn.current;if(g===null)throw Error(f(321));return g}var fn={ReactCurrentDispatcher:pn,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:m,IsSomeRendererActing:{current:!1},assign:b};n.Children={map:re,forEach:function(g,k,H){re(g,function(){k.apply(this,arguments)},H)},count:function(g){var k=0;return re(g,function(){k++}),k},toArray:function(g){return re(g,function(k){return k})||[]},only:function(g){if(!U(g))throw Error(f(143));return g}},n.Component=w,n.PureComponent=u,n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=fn,n.cloneElement=function(g,k,H){if(g==null)throw Error(f(267,g));var x=b({},g.props),S=g.key,M=g.ref,O=g._owner;if(k!=null){if(k.ref!==void 0&&(M=k.ref,O=m.current),k.key!==void 0&&(S=""+k.key),g.type&&g.type.defaultProps)var R=g.type.defaultProps;for(L in k)p.call(k,L)&&!K.hasOwnProperty(L)&&(x[L]=k[L]===void 0&&R!==void 0?R[L]:k[L])}var L=arguments.length-2;if(L===1)x.children=H;else if(1<L){R=Array(L);for(var X=0;X<L;X++)R[X]=arguments[X+2];x.children=R}return{$$typeof:a,type:g.type,key:S,ref:M,props:x,_owner:O}},n.createContext=function(g,k){return k===void 0&&(k=null),g={$$typeof:r,_calculateChangedBits:k,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider={$$typeof:i,_context:g},g.Consumer=g},n.createElement=v,n.createFactory=function(g){var k=v.bind(null,g);return k.type=g,k},n.createRef=function(){return{current:null}},n.forwardRef=function(g){return{$$typeof:o,render:g}},n.isValidElement=U,n.lazy=function(g){return{$$typeof:l,_payload:{_status:-1,_result:g},_init:ae}},n.memo=function(g,k){return{$$typeof:s,type:g,compare:k===void 0?null:k}},n.useCallback=function(g,k){return oe().useCallback(g,k)},n.useContext=function(g,k){return oe().useContext(g,k)},n.useDebugValue=function(){},n.useEffect=function(g,k){return oe().useEffect(g,k)},n.useImperativeHandle=function(g,k,H){return oe().useImperativeHandle(g,k,H)},n.useLayoutEffect=function(g,k){return oe().useLayoutEffect(g,k)},n.useMemo=function(g,k){return oe().useMemo(g,k)},n.useReducer=function(g,k,H){return oe().useReducer(g,k,H)},n.useRef=function(g){return oe().useRef(g)},n.useState=function(g){return oe().useState(g)},n.version="17.0.2"}),F=je(function(e){e.exports=pd});var Ag=F.Children,Yo=F.Component,Un=F.Fragment,vg=F.Profiler,Ig=F.PureComponent,Mg=F.StrictMode,Eg=F.Suspense,Cg=F.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,wg=F.cloneElement,Wg=F.createContext,C=F.createElement,Pg=F.createFactory,Og=F.createRef,Ng=F.forwardRef,Bg=F.isValidElement,Kg=F.lazy,Gg=F.memo,Ug=F.useCallback,Dg=F.useContext,Rg=F.useDebugValue,Dn=F.useEffect,Lg=F.useImperativeHandle,Hg=F.useLayoutEffect,Fg=F.useMemo,bg=F.useReducer,pa=F.useRef,Oe=F.useState,Yg=F.version;var fd=je(function(e,n){var a,t,i,r;if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;n.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();n.unstable_now=function(){return s.now()-l}}if(typeof window=="undefined"||typeof MessageChannel!="function"){var d=null,y=null,N=function(){if(d!==null)try{var S=n.unstable_now();d(!0,S),d=null}catch(M){throw setTimeout(N,0),M}};a=function(S){d!==null?setTimeout(a,0,S):(d=S,setTimeout(N,0))},t=function(S,M){y=setTimeout(S,M)},i=function(){clearTimeout(y)},n.unstable_shouldYield=function(){return!1},r=n.unstable_forceFrameRate=function(){}}else{var f=window.setTimeout,I=window.clearTimeout;if(typeof console!="undefined"){var B=window.cancelAnimationFrame;typeof window.requestAnimationFrame!="function"&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),typeof B!="function"&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var w=!1,h=null,u=-1,c=5,m=0;n.unstable_shouldYield=function(){return n.unstable_now()>=m},r=function(){},n.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):c=0<S?Math.floor(1e3/S):5};var p=new MessageChannel,K=p.port2;p.port1.onmessage=function(){if(h!==null){var S=n.unstable_now();m=S+c;try{h(!0,S)?K.postMessage(null):(w=!1,h=null)}catch(M){throw K.postMessage(null),M}}else w=!1},a=function(S){h=S,w||(w=!0,K.postMessage(null))},t=function(S,M){u=f(function(){S(n.unstable_now())},M)},i=function(){I(u),u=-1}}function v(S,M){var O=S.length;S.push(M);e:for(;;){var R=O-1>>>1,L=S[R];if(L!==void 0&&0<G(L,M))S[R]=M,S[O]=L,O=R;else break e}}function P(S){return S=S[0],S===void 0?null:S}function U(S){var M=S[0];if(M!==void 0){var O=S.pop();if(O!==M){S[0]=O;e:for(var R=0,L=S.length;R<L;){var X=2*(R+1)-1,Sn=S[X],ma=X+1,Gn=S[ma];if(Sn!==void 0&&0>G(Sn,O))Gn!==void 0&&0>G(Gn,Sn)?(S[R]=Gn,S[ma]=O,R=ma):(S[R]=Sn,S[X]=O,R=X);else if(Gn!==void 0&&0>G(Gn,O))S[R]=Gn,S[ma]=O,R=ma;else break e}}return M}return null}function G(S,M){var O=S.sortIndex-M.sortIndex;return O!==0?O:S.id-M.id}var V=[],fe=[],Kn=1,re=null,ae=3,pn=!1,oe=!1,fn=!1;function g(S){for(var M=P(fe);M!==null;){if(M.callback===null)U(fe);else if(M.startTime<=S)U(fe),M.sortIndex=M.expirationTime,v(V,M);else break;M=P(fe)}}function k(S){if(fn=!1,g(S),!oe)if(P(V)!==null)oe=!0,a(H);else{var M=P(fe);M!==null&&t(k,M.startTime-S)}}function H(S,M){oe=!1,fn&&(fn=!1,i()),pn=!0;var O=ae;try{for(g(M),re=P(V);re!==null&&(!(re.expirationTime>M)||S&&!n.unstable_shouldYield());){var R=re.callback;if(typeof R=="function"){re.callback=null,ae=re.priorityLevel;var L=R(re.expirationTime<=M);M=n.unstable_now(),typeof L=="function"?re.callback=L:re===P(V)&&U(V),g(M)}else U(V);re=P(V)}if(re!==null)var X=!0;else{var Sn=P(fe);Sn!==null&&t(k,Sn.startTime-M),X=!1}return X}finally{re=null,ae=O,pn=!1}}var x=r;n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(S){S.callback=null},n.unstable_continueExecution=function(){oe||pn||(oe=!0,a(H))},n.unstable_getCurrentPriorityLevel=function(){return ae},n.unstable_getFirstCallbackNode=function(){return P(V)},n.unstable_next=function(S){switch(ae){case 1:case 2:case 3:var M=3;break;default:M=ae}var O=ae;ae=M;try{return S()}finally{ae=O}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=x,n.unstable_runWithPriority=function(S,M){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var O=ae;ae=S;try{return M()}finally{ae=O}},n.unstable_scheduleCallback=function(S,M,O){var R=n.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?R+O:R):O=R,S){case 1:var L=-1;break;case 2:L=250;break;case 5:L=1073741823;break;case 4:L=1e4;break;default:L=5e3}return L=O+L,S={id:Kn++,callback:M,priorityLevel:S,startTime:O,expirationTime:L,sortIndex:-1},O>R?(S.sortIndex=O,v(fe,S),P(V)===null&&S===P(fe)&&(fn?i():fn=!0,t(k,O-R))):(S.sortIndex=L,v(V,S),oe||pn||(oe=!0,a(H))),S},n.unstable_wrapCallback=function(S){var M=ae;return function(){var O=ae;ae=M;try{return S.apply(this,arguments)}finally{ae=O}}}}),$=je(function(e){e.exports=fd});function T(e){for(var n="https://reactjs.org/docs/error-decoder.html?invariant="+e,a=1;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!F)throw Error(T(227));var xo=new Set,fa={};function yn(e,n){Rn(e,n),Rn(e+"Capture",n)}function Rn(e,n){for(fa[e]=n,e=0;e<n.length;e++)xo.add(n[e])}var He=!(typeof window=="undefined"||typeof window.document=="undefined"||typeof window.document.createElement=="undefined"),Sd=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,Qo=Object.prototype.hasOwnProperty,jo={},zo={};function yd(e){return Qo.call(zo,e)?!0:Qo.call(jo,e)?!1:Sd.test(e)?zo[e]=!0:(jo[e]=!0,!1)}function Td(e,n,a,t){if(a!==null&&a.type===0)return!1;switch(typeof n){case"function":case"symbol":return!0;case"boolean":return t?!1:a!==null?!a.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function kd(e,n,a,t){if(n===null||typeof n=="undefined"||Td(e,n,a,t))return!0;if(t)return!1;if(a!==null)switch(a.type){case 3:return!n;case 4:return n===!1;case 5:return isNaN(n);case 6:return isNaN(n)||1>n}return!1}function me(e,n,a,t,i,r,o){this.acceptsBooleans=n===2||n===3||n===4,this.attributeName=t,this.attributeNamespace=i,this.mustUseProperty=a,this.propertyName=e,this.type=n,this.sanitizeURL=r,this.removeEmptyString=o}var se={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){se[e]=new me(e,0,!1,e,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var n=e[0];se[n]=new me(n,1,!1,e[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(e){se[e]=new me(e,2,!1,e.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){se[e]=new me(e,2,!1,e,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){se[e]=new me(e,3,!1,e.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(e){se[e]=new me(e,3,!0,e,null,!1,!1)});["capture","download"].forEach(function(e){se[e]=new me(e,4,!1,e,null,!1,!1)});["cols","rows","size","span"].forEach(function(e){se[e]=new me(e,6,!1,e,null,!1,!1)});["rowSpan","start"].forEach(function(e){se[e]=new me(e,5,!1,e.toLowerCase(),null,!1,!1)});var Oi=/[\-:]([a-z])/g;function Ni(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var n=e.replace(Oi,Ni);se[n]=new me(n,1,!1,e,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var n=e.replace(Oi,Ni);se[n]=new me(n,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var n=e.replace(Oi,Ni);se[n]=new me(n,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(e){se[e]=new me(e,1,!1,e.toLowerCase(),null,!1,!1)});se.xlinkHref=new me("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(e){se[e]=new me(e,1,!1,e.toLowerCase(),null,!0,!0)});function Bi(e,n,a,t){var i=se.hasOwnProperty(n)?se[n]:null,r=i!==null?i.type===0:t?!1:!(!(2<n.length)||n[0]!=="o"&&n[0]!=="O"||n[1]!=="n"&&n[1]!=="N");r||(kd(n,a,i,t)&&(a=null),t||i===null?yd(n)&&(a===null?e.removeAttribute(n):e.setAttribute(n,""+a)):i.mustUseProperty?e[i.propertyName]=a===null?i.type===3?!1:"":a:(n=i.attributeName,t=i.attributeNamespace,a===null?e.removeAttribute(n):(i=i.type,a=i===3||i===4&&a===!0?"":""+a,t?e.setAttributeNS(t,n,a):e.setAttribute(n,a))))}var Tn=F.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,Sa=60103,kn=60106,ze=60107,Ki=60108,ya=60114,Gi=60109,Ui=60110,St=60112,Ta=60113,yt=60120,Tt=60115,Di=60116,Ri=60121,Li=60128,Jo=60129,Hi=60130,Fi=60131;typeof Symbol=="function"&&Symbol.for&&(ee=Symbol.for,Sa=ee("react.element"),kn=ee("react.portal"),ze=ee("react.fragment"),Ki=ee("react.strict_mode"),ya=ee("react.profiler"),Gi=ee("react.provider"),Ui=ee("react.context"),St=ee("react.forward_ref"),Ta=ee("react.suspense"),yt=ee("react.suspense_list"),Tt=ee("react.memo"),Di=ee("react.lazy"),Ri=ee("react.block"),ee("react.scope"),Li=ee("react.opaque.id"),Jo=ee("react.debug_trace_mode"),Hi=ee("react.offscreen"),Fi=ee("react.legacy_hidden"));var ee,Vo=typeof Symbol=="function"&&Symbol.iterator;function ka(e){return e===null||typeof e!="object"?null:(e=Vo&&e[Vo]||e["@@iterator"],typeof e=="function"?e:null)}var bi;function Aa(e){if(bi===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);bi=n&&n[1]||""}return`
`+bi+e}var Yi=!1;function kt(e,n){if(!e||Yi)return"";Yi=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{if(n)if(n=function(){throw Error()},Object.defineProperty(n.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(n,[])}catch(l){var t=l}Reflect.construct(e,[],n)}else{try{n.call()}catch(l){t=l}e.call(n.prototype)}else{try{throw Error()}catch(l){t=l}e()}}catch(l){if(l&&t&&typeof l.stack=="string"){for(var i=l.stack.split(`
`),r=t.stack.split(`
`),o=i.length-1,s=r.length-1;1<=o&&0<=s&&i[o]!==r[s];)s--;for(;1<=o&&0<=s;o--,s--)if(i[o]!==r[s]){if(o!==1||s!==1)do if(o--,s--,0>s||i[o]!==r[s])return`
`+i[o].replace(" at new "," at ");while(1<=o&&0<=s);break}}}finally{Yi=!1,Error.prepareStackTrace=a}return(e=e?e.displayName||e.name:"")?Aa(e):""}function Ad(e){switch(e.tag){case 5:return Aa(e.type);case 16:return Aa("Lazy");case 13:return Aa("Suspense");case 19:return Aa("SuspenseList");case 0:case 2:case 15:return e=kt(e.type,!1),e;case 11:return e=kt(e.type.render,!1),e;case 22:return e=kt(e.type._render,!1),e;case 1:return e=kt(e.type,!0),e;default:return""}}function Ln(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case ze:return"Fragment";case kn:return"Portal";case ya:return"Profiler";case Ki:return"StrictMode";case Ta:return"Suspense";case yt:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case Ui:return(e.displayName||"Context")+".Consumer";case Gi:return(e._context.displayName||"Context")+".Provider";case St:var n=e.render;return n=n.displayName||n.name||"",e.displayName||(n!==""?"ForwardRef("+n+")":"ForwardRef");case Tt:return Ln(e.type);case Ri:return Ln(e._render);case Di:n=e._payload,e=e._init;try{return Ln(e(n))}catch(a){}}return null}function Je(e){switch(typeof e){case"boolean":case"number":case"object":case"string":case"undefined":return e;default:return""}}function _o(e){var n=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(n==="checkbox"||n==="radio")}function vd(e){var n=_o(e)?"checked":"value",a=Object.getOwnPropertyDescriptor(e.constructor.prototype,n),t=""+e[n];if(!e.hasOwnProperty(n)&&typeof a!="undefined"&&typeof a.get=="function"&&typeof a.set=="function"){var i=a.get,r=a.set;return Object.defineProperty(e,n,{configurable:!0,get:function(){return i.call(this)},set:function(o){t=""+o,r.call(this,o)}}),Object.defineProperty(e,n,{enumerable:a.enumerable}),{getValue:function(){return t},setValue:function(o){t=""+o},stopTracking:function(){e._valueTracker=null,delete e[n]}}}}function At(e){e._valueTracker||(e._valueTracker=vd(e))}function Zo(e){if(!e)return!1;var n=e._valueTracker;if(!n)return!0;var a=n.getValue(),t="";return e&&(t=_o(e)?e.checked?"true":"false":e.value),e=t,e!==a?(n.setValue(e),!0):!1}function vt(e){if(e=e||(typeof document!="undefined"?document:void 0),typeof e=="undefined")return null;try{return e.activeElement||e.body}catch(n){return e.body}}function xi(e,n){var a=n.checked;return b({},n,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:a!=null?a:e._wrapperState.initialChecked})}function qo(e,n){var a=n.defaultValue==null?"":n.defaultValue,t=n.checked!=null?n.checked:n.defaultChecked;a=Je(n.value!=null?n.value:a),e._wrapperState={initialChecked:t,initialValue:a,controlled:n.type==="checkbox"||n.type==="radio"?n.checked!=null:n.value!=null}}function Xo(e,n){n=n.checked,n!=null&&Bi(e,"checked",n,!1)}function ji(e,n){Xo(e,n);var a=Je(n.value),t=n.type;if(a!=null)t==="number"?(a===0&&e.value===""||e.value!=a)&&(e.value=""+a):e.value!==""+a&&(e.value=""+a);else if(t==="submit"||t==="reset"){e.removeAttribute("value");return}n.hasOwnProperty("value")?Qi(e,n.type,a):n.hasOwnProperty("defaultValue")&&Qi(e,n.type,Je(n.defaultValue)),n.checked==null&&n.defaultChecked!=null&&(e.defaultChecked=!!n.defaultChecked)}function $o(e,n,a){if(n.hasOwnProperty("value")||n.hasOwnProperty("defaultValue")){var t=n.type;if(!(t!=="submit"&&t!=="reset"||n.value!==void 0&&n.value!==null))return;n=""+e._wrapperState.initialValue,a||n===e.value||(e.value=n),e.defaultValue=n}a=e.name,a!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,a!==""&&(e.name=a)}function Qi(e,n,a){(n!=="number"||vt(e.ownerDocument)!==e)&&(a==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+a&&(e.defaultValue=""+a))}function Id(e){var n="";return F.Children.forEach(e,function(a){a!=null&&(n+=a)}),n}function zi(e,n){return e=b({children:void 0},n),(n=Id(n.children))&&(e.children=n),e}function Hn(e,n,a,t){if(e=e.options,n){n={};for(var i=0;i<a.length;i++)n["$"+a[i]]=!0;for(a=0;a<e.length;a++)i=n.hasOwnProperty("$"+e[a].value),e[a].selected!==i&&(e[a].selected=i),i&&t&&(e[a].defaultSelected=!0)}else{for(a=""+Je(a),n=null,i=0;i<e.length;i++){if(e[i].value===a){e[i].selected=!0,t&&(e[i].defaultSelected=!0);return}n!==null||e[i].disabled||(n=e[i])}n!==null&&(n.selected=!0)}}function Ji(e,n){if(n.dangerouslySetInnerHTML!=null)throw Error(T(91));return b({},n,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function es(e,n){var a=n.value;if(a==null){if(a=n.children,n=n.defaultValue,a!=null){if(n!=null)throw Error(T(92));if(Array.isArray(a)){if(!(1>=a.length))throw Error(T(93));a=a[0]}n=a}n==null&&(n=""),a=n}e._wrapperState={initialValue:Je(a)}}function ns(e,n){var a=Je(n.value),t=Je(n.defaultValue);a!=null&&(a=""+a,a!==e.value&&(e.value=a),n.defaultValue==null&&e.defaultValue!==a&&(e.defaultValue=a)),t!=null&&(e.defaultValue=""+t)}function as(e){var n=e.textContent;n===e._wrapperState.initialValue&&n!==""&&n!==null&&(e.value=n)}var Vi={html:"http://www.w3.org/1999/xhtml",mathml:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg"};function ts(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function _i(e,n){return e==null||e==="http://www.w3.org/1999/xhtml"?ts(n):e==="http://www.w3.org/2000/svg"&&n==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var It,is=function(e){return typeof MSApp!="undefined"&&MSApp.execUnsafeLocalFunction?function(n,a,t,i){MSApp.execUnsafeLocalFunction(function(){return e(n,a,t,i)})}:e}(function(e,n){if(e.namespaceURI!==Vi.svg||"innerHTML"in e)e.innerHTML=n;else{for(It=It||document.createElement("div"),It.innerHTML="<svg>"+n.valueOf().toString()+"</svg>",n=It.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;n.firstChild;)e.appendChild(n.firstChild)}});function va(e,n){if(n){var a=e.firstChild;if(a&&a===e.lastChild&&a.nodeType===3){a.nodeValue=n;return}}e.textContent=n}var Ia={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Md=["Webkit","ms","Moz","O"];Object.keys(Ia).forEach(function(e){Md.forEach(function(n){n=n+e.charAt(0).toUpperCase()+e.substring(1),Ia[n]=Ia[e]})});function rs(e,n,a){return n==null||typeof n=="boolean"||n===""?"":a||typeof n!="number"||n===0||Ia.hasOwnProperty(e)&&Ia[e]?(""+n).trim():n+"px"}function os(e,n){e=e.style;for(var a in n)if(n.hasOwnProperty(a)){var t=a.indexOf("--")===0,i=rs(a,n[a],t);a==="float"&&(a="cssFloat"),t?e.setProperty(a,i):e[a]=i}}var Ed=b({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function Zi(e,n){if(n){if(Ed[e]&&(n.children!=null||n.dangerouslySetInnerHTML!=null))throw Error(T(137,e));if(n.dangerouslySetInnerHTML!=null){if(n.children!=null)throw Error(T(60));if(!(typeof n.dangerouslySetInnerHTML=="object"&&"__html"in n.dangerouslySetInnerHTML))throw Error(T(61))}if(n.style!=null&&typeof n.style!="object")throw Error(T(62))}}function qi(e,n){if(e.indexOf("-")===-1)return typeof n.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}function Xi(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var $i=null,Fn=null,bn=null;function ss(e){if(e=Ma(e)){if(typeof $i!="function")throw Error(T(280));var n=e.stateNode;n&&(n=Mt(n),$i(e.stateNode,e.type,n))}}function ls(e){Fn?bn?bn.push(e):bn=[e]:Fn=e}function us(){if(Fn){var e=Fn,n=bn;if(bn=Fn=null,ss(e),n)for(e=0;e<n.length;e++)ss(n[e])}}function er(e,n){return e(n)}function ds(e,n,a,t,i){return e(n,a,t,i)}function nr(){}var cs=er,An=!1,ar=!1;function tr(){(Fn!==null||bn!==null)&&(nr(),us())}function Cd(e,n,a){if(ar)return e(n,a);ar=!0;try{return cs(e,n,a)}finally{ar=!1,tr()}}function Ea(e,n){var a=e.stateNode;if(a===null)return null;var t=Mt(a);if(t===null)return null;a=t[n];e:switch(n){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(t=!t.disabled)||(e=e.type,t=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!t;break e;default:e=!1}if(e)return null;if(a&&typeof a!="function")throw Error(T(231,n,typeof a));return a}var ir=!1;if(He)try{Yn={},Object.defineProperty(Yn,"passive",{get:function(){ir=!0}}),window.addEventListener("test",Yn,Yn),window.removeEventListener("test",Yn,Yn)}catch(e){ir=!1}var Yn;function wd(e,n,a,t,i,r,o,s,l){var d=Array.prototype.slice.call(arguments,3);try{n.apply(a,d)}catch(y){this.onError(y)}}var Ca=!1,Et=null,Ct=!1,rr=null,Wd={onError:function(e){Ca=!0,Et=e}};function Pd(e,n,a,t,i,r,o,s,l){Ca=!1,Et=null,wd.apply(Wd,arguments)}function Od(e,n,a,t,i,r,o,s,l){if(Pd.apply(this,arguments),Ca){if(Ca){var d=Et;Ca=!1,Et=null}else throw Error(T(198));Ct||(Ct=!0,rr=d)}}function vn(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&1026)!=0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function hs(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function gs(e){if(vn(e)!==e)throw Error(T(188))}function Nd(e){var n=e.alternate;if(!n){if(n=vn(e),n===null)throw Error(T(188));return n!==e?null:e}for(var a=e,t=n;;){var i=a.return;if(i===null)break;var r=i.alternate;if(r===null){if(t=i.return,t!==null){a=t;continue}break}if(i.child===r.child){for(r=i.child;r;){if(r===a)return gs(i),e;if(r===t)return gs(i),n;r=r.sibling}throw Error(T(188))}if(a.return!==t.return)a=i,t=r;else{for(var o=!1,s=i.child;s;){if(s===a){o=!0,a=i,t=r;break}if(s===t){o=!0,t=i,a=r;break}s=s.sibling}if(!o){for(s=r.child;s;){if(s===a){o=!0,a=r,t=i;break}if(s===t){o=!0,t=r,a=i;break}s=s.sibling}if(!o)throw Error(T(189))}}if(a.alternate!==t)throw Error(T(190))}if(a.tag!==3)throw Error(T(188));return a.stateNode.current===a?e:n}function ms(e){if(e=Nd(e),!e)return null;for(var n=e;;){if(n.tag===5||n.tag===6)return n;if(n.child)n.child.return=n,n=n.child;else{if(n===e)break;for(;!n.sibling;){if(!n.return||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}}return null}function ps(e,n){for(var a=e.alternate;n!==null;){if(n===e||n===a)return!0;n=n.return}return!1}var fs,or,Ss,ys,sr=!1,Ke=[],Ve=null,_e=null,Ze=null,wa=new Map,Wa=new Map,Pa=[],Ts="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function lr(e,n,a,t,i){return{blockedOn:e,domEventName:n,eventSystemFlags:a|16,nativeEvent:i,targetContainers:[t]}}function ks(e,n){switch(e){case"focusin":case"focusout":Ve=null;break;case"dragenter":case"dragleave":_e=null;break;case"mouseover":case"mouseout":Ze=null;break;case"pointerover":case"pointerout":wa.delete(n.pointerId);break;case"gotpointercapture":case"lostpointercapture":Wa.delete(n.pointerId)}}function Oa(e,n,a,t,i,r){return e===null||e.nativeEvent!==r?(e=lr(n,a,t,i,r),n!==null&&(n=Ma(n),n!==null&&or(n)),e):(e.eventSystemFlags|=t,n=e.targetContainers,i!==null&&n.indexOf(i)===-1&&n.push(i),e)}function Bd(e,n,a,t,i){switch(n){case"focusin":return Ve=Oa(Ve,e,n,a,t,i),!0;case"dragenter":return _e=Oa(_e,e,n,a,t,i),!0;case"mouseover":return Ze=Oa(Ze,e,n,a,t,i),!0;case"pointerover":var r=i.pointerId;return wa.set(r,Oa(wa.get(r)||null,e,n,a,t,i)),!0;case"gotpointercapture":return r=i.pointerId,Wa.set(r,Oa(Wa.get(r)||null,e,n,a,t,i)),!0}return!1}function Kd(e){var n=In(e.target);if(n!==null){var a=vn(n);if(a!==null){if(n=a.tag,n===13){if(n=hs(a),n!==null){e.blockedOn=n,ys(e.lanePriority,function(){$.unstable_runWithPriority(e.priority,function(){Ss(a)})});return}}else if(n===3&&a.stateNode.hydrate){e.blockedOn=a.tag===3?a.stateNode.containerInfo:null;return}}}e.blockedOn=null}function wt(e){if(e.blockedOn!==null)return!1;for(var n=e.targetContainers;0<n.length;){var a=ur(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null)return n=Ma(a),n!==null&&or(n),e.blockedOn=a,!1;n.shift()}return!0}function As(e,n,a){wt(e)&&a.delete(n)}function Gd(){for(sr=!1;0<Ke.length;){var e=Ke[0];if(e.blockedOn!==null){e=Ma(e.blockedOn),e!==null&&fs(e);break}for(var n=e.targetContainers;0<n.length;){var a=ur(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null){e.blockedOn=a;break}n.shift()}e.blockedOn===null&&Ke.shift()}Ve!==null&&wt(Ve)&&(Ve=null),_e!==null&&wt(_e)&&(_e=null),Ze!==null&&wt(Ze)&&(Ze=null),wa.forEach(As),Wa.forEach(As)}function Na(e,n){e.blockedOn===n&&(e.blockedOn=null,sr||(sr=!0,$.unstable_scheduleCallback($.unstable_NormalPriority,Gd)))}function vs(e){function n(i){return Na(i,e)}if(0<Ke.length){Na(Ke[0],e);for(var a=1;a<Ke.length;a++){var t=Ke[a];t.blockedOn===e&&(t.blockedOn=null)}}for(Ve!==null&&Na(Ve,e),_e!==null&&Na(_e,e),Ze!==null&&Na(Ze,e),wa.forEach(n),Wa.forEach(n),a=0;a<Pa.length;a++)t=Pa[a],t.blockedOn===e&&(t.blockedOn=null);for(;0<Pa.length&&(a=Pa[0],a.blockedOn===null);)Kd(a),a.blockedOn===null&&Pa.shift()}function Wt(e,n){var a={};return a[e.toLowerCase()]=n.toLowerCase(),a["Webkit"+e]="webkit"+n,a["Moz"+e]="moz"+n,a}var xn={animationend:Wt("Animation","AnimationEnd"),animationiteration:Wt("Animation","AnimationIteration"),animationstart:Wt("Animation","AnimationStart"),transitionend:Wt("Transition","TransitionEnd")},dr={},Is={};He&&(Is=document.createElement("div").style,"AnimationEvent"in window||(delete xn.animationend.animation,delete xn.animationiteration.animation,delete xn.animationstart.animation),"TransitionEvent"in window||delete xn.transitionend.transition);function Pt(e){if(dr[e])return dr[e];if(!xn[e])return e;var n=xn[e],a;for(a in n)if(n.hasOwnProperty(a)&&a in Is)return dr[e]=n[a];return e}var Ms=Pt("animationend"),Es=Pt("animationiteration"),Cs=Pt("animationstart"),ws=Pt("transitionend"),Ws=new Map,cr=new Map,Ud=["abort","abort",Ms,"animationEnd",Es,"animationIteration",Cs,"animationStart","canplay","canPlay","canplaythrough","canPlayThrough","durationchange","durationChange","emptied","emptied","encrypted","encrypted","ended","ended","error","error","gotpointercapture","gotPointerCapture","load","load","loadeddata","loadedData","loadedmetadata","loadedMetadata","loadstart","loadStart","lostpointercapture","lostPointerCapture","playing","playing","progress","progress","seeking","seeking","stalled","stalled","suspend","suspend","timeupdate","timeUpdate",ws,"transitionEnd","waiting","waiting"];function hr(e,n){for(var a=0;a<e.length;a+=2){var t=e[a],i=e[a+1];i="on"+(i[0].toUpperCase()+i.slice(1)),cr.set(t,n),Ws.set(t,i),yn(i,[t])}}var Dd=$.unstable_now;Dd();var Q=8;function Qn(e){if((1&e)!=0)return Q=15,1;if((2&e)!=0)return Q=14,2;if((4&e)!=0)return Q=13,4;var n=24&e;return n!==0?(Q=12,n):(e&32)!=0?(Q=11,32):(n=192&e,n!==0?(Q=10,n):(e&256)!=0?(Q=9,256):(n=3584&e,n!==0?(Q=8,n):(e&4096)!=0?(Q=7,4096):(n=4186112&e,n!==0?(Q=6,n):(n=62914560&e,n!==0?(Q=5,n):e&67108864?(Q=4,67108864):(e&134217728)!=0?(Q=3,134217728):(n=805306368&e,n!==0?(Q=2,n):(1073741824&e)!=0?(Q=1,1073741824):(Q=8,e))))))}function Rd(e){switch(e){case 99:return 15;case 98:return 10;case 97:case 96:return 8;case 95:return 2;default:return 0}}function Ld(e){switch(e){case 15:case 14:return 99;case 13:case 12:case 11:case 10:return 98;case 9:case 8:case 7:case 6:case 4:case 5:return 97;case 3:case 2:case 1:return 95;case 0:return 90;default:throw Error(T(358,e))}}function Ba(e,n){var a=e.pendingLanes;if(a===0)return Q=0;var t=0,i=0,r=e.expiredLanes,o=e.suspendedLanes,s=e.pingedLanes;if(r!==0)t=r,i=Q=15;else if(r=a&134217727,r!==0){var l=r&~o;l!==0?(t=Qn(l),i=Q):(s&=r,s!==0&&(t=Qn(s),i=Q))}else r=a&~o,r!==0?(t=Qn(r),i=Q):s!==0&&(t=Qn(s),i=Q);if(t===0)return 0;if(t=31-qe(t),t=a&((0>t?0:1<<t)<<1)-1,n!==0&&n!==t&&(n&o)==0){if(Qn(n),i<=Q)return n;Q=i}if(n=e.entangledLanes,n!==0)for(e=e.entanglements,n&=t;0<n;)a=31-qe(n),i=1<<a,t|=e[a],n&=~i;return t}function Ps(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function Ot(e,n){switch(e){case 15:return 1;case 14:return 2;case 12:return e=jn(24&~n),e===0?Ot(10,n):e;case 10:return e=jn(192&~n),e===0?Ot(8,n):e;case 8:return e=jn(3584&~n),e===0&&(e=jn(4186112&~n),e===0&&(e=512)),e;case 2:return n=jn(805306368&~n),n===0&&(n=268435456),n}throw Error(T(358,e))}function jn(e){return e&-e}function gr(e){for(var n=[],a=0;31>a;a++)n.push(e);return n}function Nt(e,n,a){e.pendingLanes|=n;var t=n-1;e.suspendedLanes&=t,e.pingedLanes&=t,e=e.eventTimes,n=31-qe(n),e[n]=a}var qe=Math.clz32?Math.clz32:Hd,Fd=Math.log,bd=Math.LN2;function Hd(e){return e===0?32:31-(Fd(e)/bd|0)|0}var Yd=$.unstable_UserBlockingPriority,xd=$.unstable_runWithPriority,Bt=!0;function Qd(e,n,a,t){An||nr();var i=mr,r=An;An=!0;try{ds(i,e,n,a,t)}finally{(An=r)||tr()}}function jd(e,n,a,t){xd(Yd,mr.bind(null,e,n,a,t))}function mr(e,n,a,t){if(Bt){var i;if((i=(n&4)==0)&&0<Ke.length&&-1<Ts.indexOf(e))e=lr(null,e,n,a,t),Ke.push(e);else{var r=ur(e,n,a,t);if(r===null)i&&ks(e,t);else{if(i){if(-1<Ts.indexOf(e)){e=lr(r,e,n,a,t),Ke.push(e);return}if(Bd(r,e,n,a,t))return;ks(e,t)}Os(e,n,t,null,a)}}}}function ur(e,n,a,t){var i=Xi(t);if(i=In(i),i!==null){var r=vn(i);if(r===null)i=null;else{var o=r.tag;if(o===13){if(i=hs(r),i!==null)return i;i=null}else if(o===3){if(r.stateNode.hydrate)return r.tag===3?r.stateNode.containerInfo:null;i=null}else r!==i&&(i=null)}}return Os(e,n,t,i,a),null}var Xe=null,pr=null,Kt=null;function Ns(){if(Kt)return Kt;var e,n=pr,a=n.length,t,i="value"in Xe?Xe.value:Xe.textContent,r=i.length;for(e=0;e<a&&n[e]===i[e];e++);var o=a-e;for(t=1;t<=o&&n[a-t]===i[r-t];t++);return Kt=i.slice(e,1<t?1-t:void 0)}function Gt(e){var n=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&n===13&&(e=13)):e=n,e===10&&(e=13),32<=e||e===13?e:0}function Ut(){return!0}function Bs(){return!1}function ve(e){function n(a,t,i,r,o){this._reactName=a,this._targetInst=i,this.type=t,this.nativeEvent=r,this.target=o,this.currentTarget=null;for(var s in e)e.hasOwnProperty(s)&&(a=e[s],this[s]=a?a(r):r[s]);return this.isDefaultPrevented=(r.defaultPrevented!=null?r.defaultPrevented:r.returnValue===!1)?Ut:Bs,this.isPropagationStopped=Bs,this}return b(n.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():typeof a.returnValue!="unknown"&&(a.returnValue=!1),this.isDefaultPrevented=Ut)},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():typeof a.cancelBubble!="unknown"&&(a.cancelBubble=!0),this.isPropagationStopped=Ut)},persist:function(){},isPersistent:Ut}),n}var zn={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},fr=ve(zn),Ka=b({},zn,{view:0,detail:0}),zd=ve(Ka),Sr,yr,Ga,Dt=b({},Ka,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Tr,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==Ga&&(Ga&&e.type==="mousemove"?(Sr=e.screenX-Ga.screenX,yr=e.screenY-Ga.screenY):yr=Sr=0,Ga=e),Sr)},movementY:function(e){return"movementY"in e?e.movementY:yr}}),Ks=ve(Dt),Jd=b({},Dt,{dataTransfer:0}),Vd=ve(Jd),_d=b({},Ka,{relatedTarget:0}),kr=ve(_d),Zd=b({},zn,{animationName:0,elapsedTime:0,pseudoElement:0}),qd=ve(Zd),Xd=b({},zn,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),$d=ve(Xd),ec=b({},zn,{data:0}),Gs=ve(ec),nc={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},ac={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},tc={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function ic(e){var n=this.nativeEvent;return n.getModifierState?n.getModifierState(e):(e=tc[e])?!!n[e]:!1}function Tr(){return ic}var rc=b({},Ka,{key:function(e){if(e.key){var n=nc[e.key]||e.key;if(n!=="Unidentified")return n}return e.type==="keypress"?(e=Gt(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?ac[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Tr,charCode:function(e){return e.type==="keypress"?Gt(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Gt(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),oc=ve(rc),sc=b({},Dt,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),Us=ve(sc),lc=b({},Ka,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Tr}),uc=ve(lc),dc=b({},zn,{propertyName:0,elapsedTime:0,pseudoElement:0}),cc=ve(dc),hc=b({},Dt,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),gc=ve(hc),mc=[9,13,27,32],Ar=He&&"CompositionEvent"in window,Ua=null;He&&"documentMode"in document&&(Ua=document.documentMode);var pc=He&&"TextEvent"in window&&!Ua,Ds=He&&(!Ar||Ua&&8<Ua&&11>=Ua),Rs=String.fromCharCode(32),Ls=!1;function Hs(e,n){switch(e){case"keyup":return mc.indexOf(n.keyCode)!==-1;case"keydown":return n.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function Fs(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var Jn=!1;function fc(e,n){switch(e){case"compositionend":return Fs(n);case"keypress":return n.which!==32?null:(Ls=!0,Rs);case"textInput":return e=n.data,e===Rs&&Ls?null:e;default:return null}}function Sc(e,n){if(Jn)return e==="compositionend"||!Ar&&Hs(e,n)?(e=Ns(),Kt=pr=Xe=null,Jn=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(n.ctrlKey||n.altKey||n.metaKey)||n.ctrlKey&&n.altKey){if(n.char&&1<n.char.length)return n.char;if(n.which)return String.fromCharCode(n.which)}return null;case"compositionend":return Ds&&n.locale!=="ko"?null:n.data;default:return null}}var yc={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function bs(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n==="input"?!!yc[e.type]:n==="textarea"}function Ys(e,n,a,t){ls(t),n=Rt(n,"onChange"),0<n.length&&(a=new fr("onChange","change",null,a,t),e.push({event:a,listeners:n}))}var Da=null,Ra=null;function Tc(e){xs(e,0)}function Lt(e){var n=Vn(e);if(Zo(n))return e}function kc(e,n){if(e==="change")return n}var Qs=!1;He&&(He?(Ft="oninput"in document,Ft||(vr=document.createElement("div"),vr.setAttribute("oninput","return;"),Ft=typeof vr.oninput=="function"),Ht=Ft):Ht=!1,Qs=Ht&&(!document.documentMode||9<document.documentMode));var Ht,Ft,vr;function zs(){Da&&(Da.detachEvent("onpropertychange",js),Ra=Da=null)}function js(e){if(e.propertyName==="value"&&Lt(Ra)){var n=[];if(Ys(n,Ra,e,Xi(e)),e=Tc,An)e(n);else{An=!0;try{er(e,n)}finally{An=!1,tr()}}}}function Ac(e,n,a){e==="focusin"?(zs(),Da=n,Ra=a,Da.attachEvent("onpropertychange",js)):e==="focusout"&&zs()}function vc(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return Lt(Ra)}function Ic(e,n){if(e==="click")return Lt(n)}function Mc(e,n){if(e==="input"||e==="change")return Lt(n)}function Ec(e,n){return e===n&&(e!==0||1/e==1/n)||e!==e&&n!==n}var Me=typeof Object.is=="function"?Object.is:Ec,Cc=Object.prototype.hasOwnProperty;function La(e,n){if(Me(e,n))return!0;if(typeof e!="object"||e===null||typeof n!="object"||n===null)return!1;var a=Object.keys(e),t=Object.keys(n);if(a.length!==t.length)return!1;for(t=0;t<a.length;t++)if(!Cc.call(n,a[t])||!Me(e[a[t]],n[a[t]]))return!1;return!0}function Js(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function Vs(e,n){var a=Js(e);e=0;for(var t;a;){if(a.nodeType===3){if(t=e+a.textContent.length,e<=n&&t>=n)return{node:a,offset:n-e};e=t}e:{for(;a;){if(a.nextSibling){a=a.nextSibling;break e}a=a.parentNode}a=void 0}a=Js(a)}}function _s(e,n){return e&&n?e===n?!0:e&&e.nodeType===3?!1:n&&n.nodeType===3?_s(e,n.parentNode):"contains"in e?e.contains(n):e.compareDocumentPosition?!!(e.compareDocumentPosition(n)&16):!1:!1}function Zs(){for(var e=window,n=vt();n instanceof e.HTMLIFrameElement;){try{var a=typeof n.contentWindow.location.href=="string"}catch(t){a=!1}if(a)e=n.contentWindow;else break;n=vt(e.document)}return n}function Ir(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n&&(n==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||n==="textarea"||e.contentEditable==="true")}var wc=He&&"documentMode"in document&&11>=document.documentMode,_n=null,Mr=null,Ha=null,Er=!1;function qs(e,n,a){var t=a.window===a?a.document:a.nodeType===9?a:a.ownerDocument;Er||_n==null||_n!==vt(t)||(t=_n,"selectionStart"in t&&Ir(t)?t={start:t.selectionStart,end:t.selectionEnd}:(t=(t.ownerDocument&&t.ownerDocument.defaultView||window).getSelection(),t={anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}),Ha&&La(Ha,t)||(Ha=t,t=Rt(Mr,"onSelect"),0<t.length&&(n=new fr("onSelect","select",null,n,a),e.push({event:n,listeners:t}),n.target=_n)))}hr("cancel cancel click click close close contextmenu contextMenu copy copy cut cut auxclick auxClick dblclick doubleClick dragend dragEnd dragstart dragStart drop drop focusin focus focusout blur input input invalid invalid keydown keyDown keypress keyPress keyup keyUp mousedown mouseDown mouseup mouseUp paste paste pause pause play play pointercancel pointerCancel pointerdown pointerDown pointerup pointerUp ratechange rateChange reset reset seeked seeked submit submit touchcancel touchCancel touchend touchEnd touchstart touchStart volumechange volumeChange".split(" "),0);hr("drag drag dragenter dragEnter dragexit dragExit dragleave dragLeave dragover dragOver mousemove mouseMove mouseout mouseOut mouseover mouseOver pointermove pointerMove pointerout pointerOut pointerover pointerOver scroll scroll toggle toggle touchmove touchMove wheel wheel".split(" "),1);hr(Ud,2);for(var Xs="change selectionchange textInput compositionstart compositionend compositionupdate".split(" "),Cr=0;Cr<Xs.length;Cr++)cr.set(Xs[Cr],0);Rn("onMouseEnter",["mouseout","mouseover"]);Rn("onMouseLeave",["mouseout","mouseover"]);Rn("onPointerEnter",["pointerout","pointerover"]);Rn("onPointerLeave",["pointerout","pointerover"]);yn("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));yn("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));yn("onBeforeInput",["compositionend","keypress","textInput","paste"]);yn("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));yn("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));yn("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var Fa="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),$s=new Set("cancel close invalid load scroll toggle".split(" ").concat(Fa));function el(e,n,a){var t=e.type||"unknown-event";e.currentTarget=a,Od(t,n,void 0,e),e.currentTarget=null}function xs(e,n){n=(n&4)!=0;for(var a=0;a<e.length;a++){var t=e[a],i=t.event;t=t.listeners;e:{var r=void 0;if(n)for(var o=t.length-1;0<=o;o--){var s=t[o],l=s.instance,d=s.currentTarget;if(s=s.listener,l!==r&&i.isPropagationStopped())break e;el(i,s,d),r=l}else for(o=0;o<t.length;o++){if(s=t[o],l=s.instance,d=s.currentTarget,s=s.listener,l!==r&&i.isPropagationStopped())break e;el(i,s,d),r=l}}}if(Ct)throw e=rr,Ct=!1,rr=null,e}function z(e,n){var a=al(n),t=e+"__bubble";a.has(t)||(nl(n,e,2,!1),a.add(t))}var tl="_reactListening"+Math.random().toString(36).slice(2);function rl(e){e[tl]||(e[tl]=!0,xo.forEach(function(n){$s.has(n)||il(n,!1,e,null),il(n,!0,e,null)}))}function il(e,n,a,t){var i=4<arguments.length&&arguments[4]!==void 0?arguments[4]:0,r=a;if(e==="selectionchange"&&a.nodeType!==9&&(r=a.ownerDocument),t!==null&&!n&&$s.has(e)){if(e!=="scroll")return;i|=2,r=t}var o=al(r),s=e+"__"+(n?"capture":"bubble");o.has(s)||(n&&(i|=4),nl(r,e,i,n),o.add(s))}function nl(e,n,a,t){var i=cr.get(n);switch(i===void 0?2:i){case 0:i=Qd;break;case 1:i=jd;break;default:i=mr}a=i.bind(null,n,a,e),i=void 0,!ir||n!=="touchstart"&&n!=="touchmove"&&n!=="wheel"||(i=!0),t?i!==void 0?e.addEventListener(n,a,{capture:!0,passive:i}):e.addEventListener(n,a,!0):i!==void 0?e.addEventListener(n,a,{passive:i}):e.addEventListener(n,a,!1)}function Os(e,n,a,t,i){var r=t;if((n&1)==0&&(n&2)==0&&t!==null)e:for(;;){if(t===null)return;var o=t.tag;if(o===3||o===4){var s=t.stateNode.containerInfo;if(s===i||s.nodeType===8&&s.parentNode===i)break;if(o===4)for(o=t.return;o!==null;){var l=o.tag;if((l===3||l===4)&&(l=o.stateNode.containerInfo,l===i||l.nodeType===8&&l.parentNode===i))return;o=o.return}for(;s!==null;){if(o=In(s),o===null)return;if(l=o.tag,l===5||l===6){t=r=o;continue e}s=s.parentNode}}t=t.return}Cd(function(){var d=r,y=Xi(a),N=[];e:{var f=Ws.get(e);if(f!==void 0){var I=fr,B=e;switch(e){case"keypress":if(Gt(a)===0)break e;case"keydown":case"keyup":I=oc;break;case"focusin":B="focus",I=kr;break;case"focusout":B="blur",I=kr;break;case"beforeblur":case"afterblur":I=kr;break;case"click":if(a.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":I=Ks;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":I=Vd;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":I=uc;break;case Ms:case Es:case Cs:I=qd;break;case ws:I=cc;break;case"scroll":I=zd;break;case"wheel":I=gc;break;case"copy":case"cut":case"paste":I=$d;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":I=Us}var w=(n&4)!=0,h=!w&&e==="scroll",u=w?f!==null?f+"Capture":null:f;w=[];for(var c=d,m;c!==null;){m=c;var p=m.stateNode;if(m.tag===5&&p!==null&&(m=p,u!==null&&(p=Ea(c,u),p!=null&&w.push(ba(c,p,m)))),h)break;c=c.return}0<w.length&&(f=new I(f,B,null,a,y),N.push({event:f,listeners:w}))}}if((n&7)==0){e:{if(f=e==="mouseover"||e==="pointerover",I=e==="mouseout"||e==="pointerout",f&&(n&16)==0&&(B=a.relatedTarget||a.fromElement)&&(In(B)||B[qn]))break e;if((I||f)&&(f=y.window===y?y:(f=y.ownerDocument)?f.defaultView||f.parentWindow:window,I?(B=a.relatedTarget||a.toElement,I=d,B=B?In(B):null,B!==null&&(h=vn(B),B!==h||B.tag!==5&&B.tag!==6)&&(B=null)):(I=null,B=d),I!==B)){if(w=Ks,p="onMouseLeave",u="onMouseEnter",c="mouse",(e==="pointerout"||e==="pointerover")&&(w=Us,p="onPointerLeave",u="onPointerEnter",c="pointer"),h=I==null?f:Vn(I),m=B==null?f:Vn(B),f=new w(p,c+"leave",I,a,y),f.target=h,f.relatedTarget=m,p=null,In(y)===d&&(w=new w(u,c+"enter",B,a,y),w.target=m,w.relatedTarget=h,p=w),h=p,I&&B)n:{for(w=I,u=B,c=0,m=w;m;m=Zn(m))c++;for(m=0,p=u;p;p=Zn(p))m++;for(;0<c-m;)w=Zn(w),c--;for(;0<m-c;)u=Zn(u),m--;for(;c--;){if(w===u||u!==null&&w===u.alternate)break n;w=Zn(w),u=Zn(u)}w=null}else w=null;I!==null&&ol(N,f,I,w,!1),B!==null&&h!==null&&ol(N,h,B,w,!0)}}e:{if(f=d?Vn(d):window,I=f.nodeName&&f.nodeName.toLowerCase(),I==="select"||I==="input"&&f.type==="file")var K=kc;else if(bs(f))if(Qs)K=Mc;else{K=vc;var v=Ac}else(I=f.nodeName)&&I.toLowerCase()==="input"&&(f.type==="checkbox"||f.type==="radio")&&(K=Ic);if(K&&(K=K(e,d))){Ys(N,K,a,y);break e}v&&v(e,f,d),e==="focusout"&&(v=f._wrapperState)&&v.controlled&&f.type==="number"&&Qi(f,"number",f.value)}switch(v=d?Vn(d):window,e){case"focusin":(bs(v)||v.contentEditable==="true")&&(_n=v,Mr=d,Ha=null);break;case"focusout":Ha=Mr=_n=null;break;case"mousedown":Er=!0;break;case"contextmenu":case"mouseup":case"dragend":Er=!1,qs(N,a,y);break;case"selectionchange":if(wc)break;case"keydown":case"keyup":qs(N,a,y)}var P;if(Ar)e:{switch(e){case"compositionstart":var U="onCompositionStart";break e;case"compositionend":U="onCompositionEnd";break e;case"compositionupdate":U="onCompositionUpdate";break e}U=void 0}else Jn?Hs(e,a)&&(U="onCompositionEnd"):e==="keydown"&&a.keyCode===229&&(U="onCompositionStart");U&&(Ds&&a.locale!=="ko"&&(Jn||U!=="onCompositionStart"?U==="onCompositionEnd"&&Jn&&(P=Ns()):(Xe=y,pr="value"in Xe?Xe.value:Xe.textContent,Jn=!0)),v=Rt(d,U),0<v.length&&(U=new Gs(U,e,null,a,y),N.push({event:U,listeners:v}),P?U.data=P:(P=Fs(a),P!==null&&(U.data=P)))),(P=pc?fc(e,a):Sc(e,a))&&(d=Rt(d,"onBeforeInput"),0<d.length&&(y=new Gs("onBeforeInput","beforeinput",null,a,y),N.push({event:y,listeners:d}),y.data=P))}xs(N,n)})}function ba(e,n,a){return{instance:e,listener:n,currentTarget:a}}function Rt(e,n){for(var a=n+"Capture",t=[];e!==null;){var i=e,r=i.stateNode;i.tag===5&&r!==null&&(i=r,r=Ea(e,a),r!=null&&t.unshift(ba(e,r,i)),r=Ea(e,n),r!=null&&t.push(ba(e,r,i))),e=e.return}return t}function Zn(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function ol(e,n,a,t,i){for(var r=n._reactName,o=[];a!==null&&a!==t;){var s=a,l=s.alternate,d=s.stateNode;if(l!==null&&l===t)break;s.tag===5&&d!==null&&(s=d,i?(l=Ea(a,r),l!=null&&o.unshift(ba(a,l,s))):i||(l=Ea(a,r),l!=null&&o.push(ba(a,l,s)))),a=a.return}o.length!==0&&e.push({event:n,listeners:o})}function bt(){}var wr=null,Wr=null;function sl(e,n){switch(e){case"button":case"input":case"select":case"textarea":return!!n.autoFocus}return!1}function Pr(e,n){return e==="textarea"||e==="option"||e==="noscript"||typeof n.children=="string"||typeof n.children=="number"||typeof n.dangerouslySetInnerHTML=="object"&&n.dangerouslySetInnerHTML!==null&&n.dangerouslySetInnerHTML.__html!=null}var ll=typeof setTimeout=="function"?setTimeout:void 0,Wc=typeof clearTimeout=="function"?clearTimeout:void 0;function Or(e){e.nodeType===1?e.textContent="":e.nodeType===9&&(e=e.body,e!=null&&(e.textContent=""))}function Xn(e){for(;e!=null;e=e.nextSibling){var n=e.nodeType;if(n===1||n===3)break}return e}function ul(e){e=e.previousSibling;for(var n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="$"||a==="$!"||a==="$?"){if(n===0)return e;n--}else a==="/$"&&n++}e=e.previousSibling}return null}var Nr=0;function Pc(e){return{$$typeof:Li,toString:e,valueOf:e}}var Yt=Math.random().toString(36).slice(2),$e="__reactFiber$"+Yt,xt="__reactProps$"+Yt,qn="__reactContainer$"+Yt,dl="__reactEvents$"+Yt;function In(e){var n=e[$e];if(n)return n;for(var a=e.parentNode;a;){if(n=a[qn]||a[$e]){if(a=n.alternate,n.child!==null||a!==null&&a.child!==null)for(e=ul(e);e!==null;){if(a=e[$e])return a;e=ul(e)}return n}e=a,a=e.parentNode}return null}function Ma(e){return e=e[$e]||e[qn],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function Vn(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(T(33))}function Mt(e){return e[xt]||null}function al(e){var n=e[dl];return n===void 0&&(n=e[dl]=new Set),n}var Br=[],$n=-1;function en(e){return{current:e}}function J(e){0>$n||(e.current=Br[$n],Br[$n]=null,$n--)}function _(e,n){$n++,Br[$n]=e.current,e.current=n}var nn={},de=en(nn),Se=en(!1),Mn=nn;function ea(e,n){var a=e.type.contextTypes;if(!a)return nn;var t=e.stateNode;if(t&&t.__reactInternalMemoizedUnmaskedChildContext===n)return t.__reactInternalMemoizedMaskedChildContext;var i={},r;for(r in a)i[r]=n[r];return t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=i),i}function ye(e){return e=e.childContextTypes,e!=null}function Qt(){J(Se),J(de)}function cl(e,n,a){if(de.current!==nn)throw Error(T(168));_(de,n),_(Se,a)}function hl(e,n,a){var t=e.stateNode;if(e=n.childContextTypes,typeof t.getChildContext!="function")return a;t=t.getChildContext();for(var i in t)if(!(i in e))throw Error(T(108,Ln(n)||"Unknown",i));return b({},a,t)}function jt(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||nn,Mn=de.current,_(de,e),_(Se,Se.current),!0}function gl(e,n,a){var t=e.stateNode;if(!t)throw Error(T(169));a?(e=hl(e,n,Mn),t.__reactInternalMemoizedMergedChildContext=e,J(Se),J(de),_(de,e)):J(Se),_(Se,a)}var Kr=null,En=null,Oc=$.unstable_runWithPriority,Gr=$.unstable_scheduleCallback,Ur=$.unstable_cancelCallback,Nc=$.unstable_shouldYield,ml=$.unstable_requestPaint,Dr=$.unstable_now,Bc=$.unstable_getCurrentPriorityLevel,zt=$.unstable_ImmediatePriority,pl=$.unstable_UserBlockingPriority,fl=$.unstable_NormalPriority,Sl=$.unstable_LowPriority,yl=$.unstable_IdlePriority,Rr={},Kc=ml!==void 0?ml:function(){},Fe=null,Jt=null,Lr=!1,Tl=Dr(),ce=1e4>Tl?Dr:function(){return Dr()-Tl};function na(){switch(Bc()){case zt:return 99;case pl:return 98;case fl:return 97;case Sl:return 96;case yl:return 95;default:throw Error(T(332))}}function kl(e){switch(e){case 99:return zt;case 98:return pl;case 97:return fl;case 96:return Sl;case 95:return yl;default:throw Error(T(332))}}function Cn(e,n){return e=kl(e),Oc(e,n)}function Ya(e,n,a){return e=kl(e),Gr(e,n,a)}function Ge(){if(Jt!==null){var e=Jt;Jt=null,Ur(e)}Al()}function Al(){if(!Lr&&Fe!==null){Lr=!0;var e=0;try{var n=Fe;Cn(99,function(){for(;e<n.length;e++){var a=n[e];do a=a(!0);while(a!==null)}}),Fe=null}catch(a){throw Fe!==null&&(Fe=Fe.slice(e+1)),Gr(zt,Ge),a}finally{Lr=!1}}}var Gc=Tn.ReactCurrentBatchConfig;function Ne(e,n){if(e&&e.defaultProps){n=b({},n),e=e.defaultProps;for(var a in e)n[a]===void 0&&(n[a]=e[a]);return n}return n}var Vt=en(null),_t=null,aa=null,Zt=null;function Hr(){Zt=aa=_t=null}function Fr(e){var n=Vt.current;J(Vt),e.type._context._currentValue=n}function vl(e,n){for(;e!==null;){var a=e.alternate;if((e.childLanes&n)===n){if(a===null||(a.childLanes&n)===n)break;a.childLanes|=n}else e.childLanes|=n,a!==null&&(a.childLanes|=n);e=e.return}}function ta(e,n){_t=e,Zt=aa=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&n)!=0&&(Be=!0),e.firstContext=null)}function Ee(e,n){if(Zt!==e&&n!==!1&&n!==0)if((typeof n!="number"||n===1073741823)&&(Zt=e,n=1073741823),n={context:e,observedBits:n,next:null},aa===null){if(_t===null)throw Error(T(308));aa=n,_t.dependencies={lanes:0,firstContext:n,responders:null}}else aa=aa.next=n;return e._currentValue}var an=!1;function br(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null},effects:null}}function Il(e,n){e=e.updateQueue,n.updateQueue===e&&(n.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function tn(e,n){return{eventTime:e,lane:n,tag:0,payload:null,callback:null,next:null}}function rn(e,n){if(e=e.updateQueue,e!==null){e=e.shared;var a=e.pending;a===null?n.next=n:(n.next=a.next,a.next=n),e.pending=n}}function Ml(e,n){var a=e.updateQueue,t=e.alternate;if(t!==null&&(t=t.updateQueue,a===t)){var i=null,r=null;if(a=a.firstBaseUpdate,a!==null){do{var o={eventTime:a.eventTime,lane:a.lane,tag:a.tag,payload:a.payload,callback:a.callback,next:null};r===null?i=r=o:r=r.next=o,a=a.next}while(a!==null);r===null?i=r=n:r=r.next=n}else i=r=n;a={baseState:t.baseState,firstBaseUpdate:i,lastBaseUpdate:r,shared:t.shared,effects:t.effects},e.updateQueue=a;return}e=a.lastBaseUpdate,e===null?a.firstBaseUpdate=n:e.next=n,a.lastBaseUpdate=n}function Qa(e,n,a,t){var i=e.updateQueue;an=!1;var r=i.firstBaseUpdate,o=i.lastBaseUpdate,s=i.shared.pending;if(s!==null){i.shared.pending=null;var l=s,d=l.next;l.next=null,o===null?r=d:o.next=d,o=l;var y=e.alternate;if(y!==null){y=y.updateQueue;var N=y.lastBaseUpdate;N!==o&&(N===null?y.firstBaseUpdate=d:N.next=d,y.lastBaseUpdate=l)}}if(r!==null){N=i.baseState,o=0,y=d=l=null;do{s=r.lane;var f=r.eventTime;if((t&s)===s){y!==null&&(y=y.next={eventTime:f,lane:0,tag:r.tag,payload:r.payload,callback:r.callback,next:null});e:{var I=e,B=r;switch(s=n,f=a,B.tag){case 1:if(I=B.payload,typeof I=="function"){N=I.call(f,N,s);break e}N=I;break e;case 3:I.flags=I.flags&-4097|64;case 0:if(I=B.payload,s=typeof I=="function"?I.call(f,N,s):I,s==null)break e;N=b({},N,s);break e;case 2:an=!0}}r.callback!==null&&(e.flags|=32,s=i.effects,s===null?i.effects=[r]:s.push(r))}else f={eventTime:f,lane:s,tag:r.tag,payload:r.payload,callback:r.callback,next:null},y===null?(d=y=f,l=N):y=y.next=f,o|=s;if(r=r.next,r===null){if(s=i.shared.pending,s===null)break;r=s.next,s.next=null,i.lastBaseUpdate=s,i.shared.pending=null}}while(1);y===null&&(l=N),i.baseState=l,i.firstBaseUpdate=d,i.lastBaseUpdate=y,xa|=o,e.lanes=o,e.memoizedState=N}}function El(e,n,a){if(e=n.effects,n.effects=null,e!==null)for(n=0;n<e.length;n++){var t=e[n],i=t.callback;if(i!==null){if(t.callback=null,t=a,typeof i!="function")throw Error(T(191,i));i.call(t)}}}var Cl=new F.Component().refs;function qt(e,n,a,t){n=e.memoizedState,a=a(t,n),a=a==null?n:b({},n,a),e.memoizedState=a,e.lanes===0&&(e.updateQueue.baseState=a)}var Xt={isMounted:function(e){return(e=e._reactInternals)?vn(e)===e:!1},enqueueSetState:function(e,n,a){e=e._reactInternals;var t=Ie(),i=on(e),r=tn(t,i);r.payload=n,a!=null&&(r.callback=a),rn(e,r),sn(e,i,t)},enqueueReplaceState:function(e,n,a){e=e._reactInternals;var t=Ie(),i=on(e),r=tn(t,i);r.tag=1,r.payload=n,a!=null&&(r.callback=a),rn(e,r),sn(e,i,t)},enqueueForceUpdate:function(e,n){e=e._reactInternals;var a=Ie(),t=on(e),i=tn(a,t);i.tag=2,n!=null&&(i.callback=n),rn(e,i),sn(e,t,a)}};function wl(e,n,a,t,i,r,o){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(t,r,o):n.prototype&&n.prototype.isPureReactComponent?!La(a,t)||!La(i,r):!0}function Wl(e,n,a){var t=!1,i=nn,r=n.contextType;return typeof r=="object"&&r!==null?r=Ee(r):(i=ye(n)?Mn:de.current,t=n.contextTypes,r=(t=t!=null)?ea(e,i):nn),n=new n(a,r),e.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,n.updater=Xt,e.stateNode=n,n._reactInternals=e,t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=i,e.__reactInternalMemoizedMaskedChildContext=r),n}function Pl(e,n,a,t){e=n.state,typeof n.componentWillReceiveProps=="function"&&n.componentWillReceiveProps(a,t),typeof n.UNSAFE_componentWillReceiveProps=="function"&&n.UNSAFE_componentWillReceiveProps(a,t),n.state!==e&&Xt.enqueueReplaceState(n,n.state,null)}function Yr(e,n,a,t){var i=e.stateNode;i.props=a,i.state=e.memoizedState,i.refs=Cl,br(e);var r=n.contextType;typeof r=="object"&&r!==null?i.context=Ee(r):(r=ye(n)?Mn:de.current,i.context=ea(e,r)),Qa(e,a,i,t),i.state=e.memoizedState,r=n.getDerivedStateFromProps,typeof r=="function"&&(qt(e,n,r,a),i.state=e.memoizedState),typeof n.getDerivedStateFromProps=="function"||typeof i.getSnapshotBeforeUpdate=="function"||typeof i.UNSAFE_componentWillMount!="function"&&typeof i.componentWillMount!="function"||(n=i.state,typeof i.componentWillMount=="function"&&i.componentWillMount(),typeof i.UNSAFE_componentWillMount=="function"&&i.UNSAFE_componentWillMount(),n!==i.state&&Xt.enqueueReplaceState(i,i.state,null),Qa(e,a,i,t),i.state=e.memoizedState),typeof i.componentDidMount=="function"&&(e.flags|=4)}var $t=Array.isArray;function ja(e,n,a){if(e=a.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(a._owner){if(a=a._owner,a){if(a.tag!==1)throw Error(T(309));var t=a.stateNode}if(!t)throw Error(T(147,e));var i=""+e;return n!==null&&n.ref!==null&&typeof n.ref=="function"&&n.ref._stringRef===i?n.ref:(n=function(r){var o=t.refs;o===Cl&&(o=t.refs={}),r===null?delete o[i]:o[i]=r},n._stringRef=i,n)}if(typeof e!="string")throw Error(T(284));if(!a._owner)throw Error(T(290,e))}return e}function ei(e,n){if(e.type!=="textarea")throw Error(T(31,Object.prototype.toString.call(n)==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":n))}function Ol(e){function n(h,u){if(e){var c=h.lastEffect;c!==null?(c.nextEffect=u,h.lastEffect=u):h.firstEffect=h.lastEffect=u,u.nextEffect=null,u.flags=8}}function a(h,u){if(!e)return null;for(;u!==null;)n(h,u),u=u.sibling;return null}function t(h,u){for(h=new Map;u!==null;)u.key!==null?h.set(u.key,u):h.set(u.index,u),u=u.sibling;return h}function i(h,u){return h=ln(h,u),h.index=0,h.sibling=null,h}function r(h,u,c){return h.index=c,e?(c=h.alternate,c!==null?(c=c.index,c<u?(h.flags=2,u):c):(h.flags=2,u)):u}function o(h){return e&&h.alternate===null&&(h.flags=2),h}function s(h,u,c,m){return u===null||u.tag!==6?(u=xr(c,h.mode,m),u.return=h,u):(u=i(u,c),u.return=h,u)}function l(h,u,c,m){return u!==null&&u.elementType===c.type?(m=i(u,c.props),m.ref=ja(h,u,c),m.return=h,m):(m=ni(c.type,c.key,c.props,null,h.mode,m),m.ref=ja(h,u,c),m.return=h,m)}function d(h,u,c,m){return u===null||u.tag!==4||u.stateNode.containerInfo!==c.containerInfo||u.stateNode.implementation!==c.implementation?(u=Qr(c,h.mode,m),u.return=h,u):(u=i(u,c.children||[]),u.return=h,u)}function y(h,u,c,m,p){return u===null||u.tag!==7?(u=ia(c,h.mode,m,p),u.return=h,u):(u=i(u,c),u.return=h,u)}function N(h,u,c){if(typeof u=="string"||typeof u=="number")return u=xr(""+u,h.mode,c),u.return=h,u;if(typeof u=="object"&&u!==null){switch(u.$$typeof){case Sa:return c=ni(u.type,u.key,u.props,null,h.mode,c),c.ref=ja(h,null,u),c.return=h,c;case kn:return u=Qr(u,h.mode,c),u.return=h,u}if($t(u)||ka(u))return u=ia(u,h.mode,c,null),u.return=h,u;ei(h,u)}return null}function f(h,u,c,m){var p=u!==null?u.key:null;if(typeof c=="string"||typeof c=="number")return p!==null?null:s(h,u,""+c,m);if(typeof c=="object"&&c!==null){switch(c.$$typeof){case Sa:return c.key===p?c.type===ze?y(h,u,c.props.children,m,p):l(h,u,c,m):null;case kn:return c.key===p?d(h,u,c,m):null}if($t(c)||ka(c))return p!==null?null:y(h,u,c,m,null);ei(h,c)}return null}function I(h,u,c,m,p){if(typeof m=="string"||typeof m=="number")return h=h.get(c)||null,s(u,h,""+m,p);if(typeof m=="object"&&m!==null){switch(m.$$typeof){case Sa:return h=h.get(m.key===null?c:m.key)||null,m.type===ze?y(u,h,m.props.children,p,m.key):l(u,h,m,p);case kn:return h=h.get(m.key===null?c:m.key)||null,d(u,h,m,p)}if($t(m)||ka(m))return h=h.get(c)||null,y(u,h,m,p,null);ei(u,m)}return null}function B(h,u,c,m){for(var p=null,K=null,v=u,P=u=0,U=null;v!==null&&P<c.length;P++){v.index>P?(U=v,v=null):U=v.sibling;var G=f(h,v,c[P],m);if(G===null){v===null&&(v=U);break}e&&v&&G.alternate===null&&n(h,v),u=r(G,u,P),K===null?p=G:K.sibling=G,K=G,v=U}if(P===c.length)return a(h,v),p;if(v===null){for(;P<c.length;P++)v=N(h,c[P],m),v!==null&&(u=r(v,u,P),K===null?p=v:K.sibling=v,K=v);return p}for(v=t(h,v);P<c.length;P++)U=I(v,h,P,c[P],m),U!==null&&(e&&U.alternate!==null&&v.delete(U.key===null?P:U.key),u=r(U,u,P),K===null?p=U:K.sibling=U,K=U);return e&&v.forEach(function(V){return n(h,V)}),p}function w(h,u,c,m){var p=ka(c);if(typeof p!="function")throw Error(T(150));if(c=p.call(c),c==null)throw Error(T(151));for(var K=p=null,v=u,P=u=0,U=null,G=c.next();v!==null&&!G.done;P++,G=c.next()){v.index>P?(U=v,v=null):U=v.sibling;var V=f(h,v,G.value,m);if(V===null){v===null&&(v=U);break}e&&v&&V.alternate===null&&n(h,v),u=r(V,u,P),K===null?p=V:K.sibling=V,K=V,v=U}if(G.done)return a(h,v),p;if(v===null){for(;!G.done;P++,G=c.next())G=N(h,G.value,m),G!==null&&(u=r(G,u,P),K===null?p=G:K.sibling=G,K=G);return p}for(v=t(h,v);!G.done;P++,G=c.next())G=I(v,h,P,G.value,m),G!==null&&(e&&G.alternate!==null&&v.delete(G.key===null?P:G.key),u=r(G,u,P),K===null?p=G:K.sibling=G,K=G);return e&&v.forEach(function(fe){return n(h,fe)}),p}return function(h,u,c,m){var p=typeof c=="object"&&c!==null&&c.type===ze&&c.key===null;p&&(c=c.props.children);var K=typeof c=="object"&&c!==null;if(K)switch(c.$$typeof){case Sa:e:{for(K=c.key,p=u;p!==null;){if(p.key===K){switch(p.tag){case 7:if(c.type===ze){a(h,p.sibling),u=i(p,c.props.children),u.return=h,h=u;break e}break;default:if(p.elementType===c.type){a(h,p.sibling),u=i(p,c.props),u.ref=ja(h,p,c),u.return=h,h=u;break e}}a(h,p);break}else n(h,p);p=p.sibling}c.type===ze?(u=ia(c.props.children,h.mode,m,c.key),u.return=h,h=u):(m=ni(c.type,c.key,c.props,null,h.mode,m),m.ref=ja(h,u,c),m.return=h,h=m)}return o(h);case kn:e:{for(p=c.key;u!==null;){if(u.key===p)if(u.tag===4&&u.stateNode.containerInfo===c.containerInfo&&u.stateNode.implementation===c.implementation){a(h,u.sibling),u=i(u,c.children||[]),u.return=h,h=u;break e}else{a(h,u);break}else n(h,u);u=u.sibling}u=Qr(c,h.mode,m),u.return=h,h=u}return o(h)}if(typeof c=="string"||typeof c=="number")return c=""+c,u!==null&&u.tag===6?(a(h,u.sibling),u=i(u,c),u.return=h,h=u):(a(h,u),u=xr(c,h.mode,m),u.return=h,h=u),o(h);if($t(c))return B(h,u,c,m);if(ka(c))return w(h,u,c,m);if(K&&ei(h,c),typeof c=="undefined"&&!p)switch(h.tag){case 1:case 22:case 0:case 11:case 15:throw Error(T(152,Ln(h.type)||"Component"))}return a(h,u)}}var ai=Ol(!0),Nl=Ol(!1),za={},Ue=en(za),Ja=en(za),Va=en(za);function wn(e){if(e===za)throw Error(T(174));return e}function jr(e,n){switch(_(Va,n),_(Ja,e),_(Ue,za),e=n.nodeType,e){case 9:case 11:n=(n=n.documentElement)?n.namespaceURI:_i(null,"");break;default:e=e===8?n.parentNode:n,n=e.namespaceURI||null,e=e.tagName,n=_i(n,e)}J(Ue),_(Ue,n)}function ra(){J(Ue),J(Ja),J(Va)}function Bl(e){wn(Va.current);var n=wn(Ue.current),a=_i(n,e.type);n!==a&&(_(Ja,e),_(Ue,a))}function zr(e){Ja.current===e&&(J(Ue),J(Ja))}var Z=en(0);function ti(e){for(var n=e;n!==null;){if(n.tag===13){var a=n.memoizedState;if(a!==null&&(a=a.dehydrated,a===null||a.data==="$?"||a.data==="$!"))return n}else if(n.tag===19&&n.memoizedProps.revealOrder!==void 0){if((n.flags&64)!=0)return n}else if(n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}return null}var be=null,un=null,De=!1;function Kl(e,n){var a=Ce(5,null,null,0);a.elementType="DELETED",a.type="DELETED",a.stateNode=n,a.return=e,a.flags=8,e.lastEffect!==null?(e.lastEffect.nextEffect=a,e.lastEffect=a):e.firstEffect=e.lastEffect=a}function Gl(e,n){switch(e.tag){case 5:var a=e.type;return n=n.nodeType!==1||a.toLowerCase()!==n.nodeName.toLowerCase()?null:n,n!==null?(e.stateNode=n,!0):!1;case 6:return n=e.pendingProps===""||n.nodeType!==3?null:n,n!==null?(e.stateNode=n,!0):!1;case 13:return!1;default:return!1}}function Jr(e){if(De){var n=un;if(n){var a=n;if(!Gl(e,n)){if(n=Xn(a.nextSibling),!n||!Gl(e,n)){e.flags=e.flags&-1025|2,De=!1,be=e;return}Kl(be,a)}be=e,un=Xn(n.firstChild)}else e.flags=e.flags&-1025|2,De=!1,be=e}}function Ul(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;be=e}function ii(e){if(e!==be)return!1;if(!De)return Ul(e),De=!0,!1;var n=e.type;if(e.tag!==5||n!=="head"&&n!=="body"&&!Pr(n,e.memoizedProps))for(n=un;n;)Kl(e,n),n=Xn(n.nextSibling);if(Ul(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(T(317));e:{for(e=e.nextSibling,n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="/$"){if(n===0){un=Xn(e.nextSibling);break e}n--}else a!=="$"&&a!=="$!"&&a!=="$?"||n++}e=e.nextSibling}un=null}}else un=be?Xn(e.stateNode.nextSibling):null;return!0}function Vr(){un=be=null,De=!1}var oa=[];function _r(){for(var e=0;e<oa.length;e++)oa[e]._workInProgressVersionPrimary=null;oa.length=0}var _a=Tn.ReactCurrentDispatcher,we=Tn.ReactCurrentBatchConfig,Za=0,q=null,he=null,le=null,ri=!1,qa=!1;function Te(){throw Error(T(321))}function Zr(e,n){if(n===null)return!1;for(var a=0;a<n.length&&a<e.length;a++)if(!Me(e[a],n[a]))return!1;return!0}function qr(e,n,a,t,i,r){if(Za=r,q=n,n.memoizedState=null,n.updateQueue=null,n.lanes=0,_a.current=e===null||e.memoizedState===null?Uc:Dc,e=a(t,i),qa){r=0;do{if(qa=!1,!(25>r))throw Error(T(301));r+=1,le=he=null,n.updateQueue=null,_a.current=Rc,e=a(t,i)}while(qa)}if(_a.current=oi,n=he!==null&&he.next!==null,Za=0,le=he=q=null,ri=!1,n)throw Error(T(300));return e}function Wn(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return le===null?q.memoizedState=le=e:le=le.next=e,le}function Pn(){if(he===null){var e=q.alternate;e=e!==null?e.memoizedState:null}else e=he.next;var n=le===null?q.memoizedState:le.next;if(n!==null)le=n,he=e;else{if(e===null)throw Error(T(310));he=e,e={memoizedState:he.memoizedState,baseState:he.baseState,baseQueue:he.baseQueue,queue:he.queue,next:null},le===null?q.memoizedState=le=e:le=le.next=e}return le}function Re(e,n){return typeof n=="function"?n(e):n}function Xa(e){var n=Pn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=he,i=t.baseQueue,r=a.pending;if(r!==null){if(i!==null){var o=i.next;i.next=r.next,r.next=o}t.baseQueue=i=r,a.pending=null}if(i!==null){i=i.next,t=t.baseState;var s=o=r=null,l=i;do{var d=l.lane;if((Za&d)===d)s!==null&&(s=s.next={lane:0,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null}),t=l.eagerReducer===e?l.eagerState:e(t,l.action);else{var y={lane:d,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null};s===null?(o=s=y,r=t):s=s.next=y,q.lanes|=d,xa|=d}l=l.next}while(l!==null&&l!==i);s===null?r=t:s.next=o,Me(t,n.memoizedState)||(Be=!0),n.memoizedState=t,n.baseState=r,n.baseQueue=s,a.lastRenderedState=t}return[n.memoizedState,a.dispatch]}function $a(e){var n=Pn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=a.dispatch,i=a.pending,r=n.memoizedState;if(i!==null){a.pending=null;var o=i=i.next;do r=e(r,o.action),o=o.next;while(o!==i);Me(r,n.memoizedState)||(Be=!0),n.memoizedState=r,n.baseQueue===null&&(n.baseState=r),a.lastRenderedState=r}return[r,t]}function Dl(e,n,a){var t=n._getVersion;t=t(n._source);var i=n._workInProgressVersionPrimary;if(i!==null?e=i===t:(e=e.mutableReadLanes,(e=(Za&e)===e)&&(n._workInProgressVersionPrimary=t,oa.push(n))),e)return a(n._source);throw oa.push(n),Error(T(350))}function Rl(e,n,a,t){var i=pe;if(i===null)throw Error(T(349));var r=n._getVersion,o=r(n._source),s=_a.current,l=s.useState(function(){return Dl(i,n,a)}),d=l[1],y=l[0];l=le;var N=e.memoizedState,f=N.refs,I=f.getSnapshot,B=N.source;N=N.subscribe;var w=q;return e.memoizedState={refs:f,source:n,subscribe:t},s.useEffect(function(){f.getSnapshot=a,f.setSnapshot=d;var h=r(n._source);if(!Me(o,h)){h=a(n._source),Me(y,h)||(d(h),h=on(w),i.mutableReadLanes|=h&i.pendingLanes),h=i.mutableReadLanes,i.entangledLanes|=h;for(var u=i.entanglements,c=h;0<c;){var m=31-qe(c),p=1<<m;u[m]|=h,c&=~p}}},[a,n,t]),s.useEffect(function(){return t(n._source,function(){var h=f.getSnapshot,u=f.setSnapshot;try{u(h(n._source));var c=on(w);i.mutableReadLanes|=c&i.pendingLanes}catch(m){u(function(){throw m})}})},[n,t]),Me(I,a)&&Me(B,n)&&Me(N,t)||(e={pending:null,dispatch:null,lastRenderedReducer:Re,lastRenderedState:y},e.dispatch=d=Xr.bind(null,q,e),l.queue=e,l.baseQueue=null,y=Dl(i,n,a),l.memoizedState=l.baseState=y),y}function Ll(e,n,a){var t=Pn();return Rl(t,e,n,a)}function et(e){var n=Wn();return typeof e=="function"&&(e=e()),n.memoizedState=n.baseState=e,e=n.queue={pending:null,dispatch:null,lastRenderedReducer:Re,lastRenderedState:e},e=e.dispatch=Xr.bind(null,q,e),[n.memoizedState,e]}function si(e,n,a,t){return e={tag:e,create:n,destroy:a,deps:t,next:null},n=q.updateQueue,n===null?(n={lastEffect:null},q.updateQueue=n,n.lastEffect=e.next=e):(a=n.lastEffect,a===null?n.lastEffect=e.next=e:(t=a.next,a.next=e,e.next=t,n.lastEffect=e)),e}function Hl(e){var n=Wn();return e={current:e},n.memoizedState=e}function li(){return Pn().memoizedState}function $r(e,n,a,t){var i=Wn();q.flags|=e,i.memoizedState=si(1|n,a,void 0,t===void 0?null:t)}function eo(e,n,a,t){var i=Pn();t=t===void 0?null:t;var r=void 0;if(he!==null){var o=he.memoizedState;if(r=o.destroy,t!==null&&Zr(t,o.deps)){si(n,a,r,t);return}}q.flags|=e,i.memoizedState=si(1|n,a,r,t)}function Fl(e,n){return $r(516,4,e,n)}function ui(e,n){return eo(516,4,e,n)}function bl(e,n){return eo(4,2,e,n)}function Yl(e,n){if(typeof n=="function")return e=e(),n(e),function(){n(null)};if(n!=null)return e=e(),n.current=e,function(){n.current=null}}function xl(e,n,a){return a=a!=null?a.concat([e]):null,eo(4,2,Yl.bind(null,n,e),a)}function no(){}function Ql(e,n){var a=Pn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&Zr(n,t[1])?t[0]:(a.memoizedState=[e,n],e)}function jl(e,n){var a=Pn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&Zr(n,t[1])?t[0]:(e=e(),a.memoizedState=[e,n],e)}function Lc(e,n){var a=na();Cn(98>a?98:a,function(){e(!0)}),Cn(97<a?97:a,function(){var t=we.transition;we.transition=1;try{e(!1),n()}finally{we.transition=t}})}function Xr(e,n,a){var t=Ie(),i=on(e),r={lane:i,action:a,eagerReducer:null,eagerState:null,next:null},o=n.pending;if(o===null?r.next=r:(r.next=o.next,o.next=r),n.pending=r,o=e.alternate,e===q||o!==null&&o===q)qa=ri=!0;else{if(e.lanes===0&&(o===null||o.lanes===0)&&(o=n.lastRenderedReducer,o!==null))try{var s=n.lastRenderedState,l=o(s,a);if(r.eagerReducer=o,r.eagerState=l,Me(l,s))return}catch(d){}finally{}sn(e,i,t)}}var oi={readContext:Ee,useCallback:Te,useContext:Te,useEffect:Te,useImperativeHandle:Te,useLayoutEffect:Te,useMemo:Te,useReducer:Te,useRef:Te,useState:Te,useDebugValue:Te,useDeferredValue:Te,useTransition:Te,useMutableSource:Te,useOpaqueIdentifier:Te,unstable_isNewReconciler:!1},Uc={readContext:Ee,useCallback:function(e,n){return Wn().memoizedState=[e,n===void 0?null:n],e},useContext:Ee,useEffect:Fl,useImperativeHandle:function(e,n,a){return a=a!=null?a.concat([e]):null,$r(4,2,Yl.bind(null,n,e),a)},useLayoutEffect:function(e,n){return $r(4,2,e,n)},useMemo:function(e,n){var a=Wn();return n=n===void 0?null:n,e=e(),a.memoizedState=[e,n],e},useReducer:function(e,n,a){var t=Wn();return n=a!==void 0?a(n):n,t.memoizedState=t.baseState=n,e=t.queue={pending:null,dispatch:null,lastRenderedReducer:e,lastRenderedState:n},e=e.dispatch=Xr.bind(null,q,e),[t.memoizedState,e]},useRef:Hl,useState:et,useDebugValue:no,useDeferredValue:function(e){var n=et(e),a=n[0],t=n[1];return Fl(function(){var i=we.transition;we.transition=1;try{t(e)}finally{we.transition=i}},[e]),a},useTransition:function(){var e=et(!1),n=e[0];return e=Lc.bind(null,e[1]),Hl(e),[e,n]},useMutableSource:function(e,n,a){var t=Wn();return t.memoizedState={refs:{getSnapshot:n,setSnapshot:null},source:e,subscribe:a},Rl(t,e,n,a)},useOpaqueIdentifier:function(){if(De){var e=!1,n=Pc(function(){throw e||(e=!0,a("r:"+(Nr++).toString(36))),Error(T(355))}),a=et(n)[1];return(q.mode&2)==0&&(q.flags|=516,si(5,function(){a("r:"+(Nr++).toString(36))},void 0,null)),n}return n="r:"+(Nr++).toString(36),et(n),n},unstable_isNewReconciler:!1},Dc={readContext:Ee,useCallback:Ql,useContext:Ee,useEffect:ui,useImperativeHandle:xl,useLayoutEffect:bl,useMemo:jl,useReducer:Xa,useRef:li,useState:function(){return Xa(Re)},useDebugValue:no,useDeferredValue:function(e){var n=Xa(Re),a=n[0],t=n[1];return ui(function(){var i=we.transition;we.transition=1;try{t(e)}finally{we.transition=i}},[e]),a},useTransition:function(){var e=Xa(Re)[0];return[li().current,e]},useMutableSource:Ll,useOpaqueIdentifier:function(){return Xa(Re)[0]},unstable_isNewReconciler:!1},Rc={readContext:Ee,useCallback:Ql,useContext:Ee,useEffect:ui,useImperativeHandle:xl,useLayoutEffect:bl,useMemo:jl,useReducer:$a,useRef:li,useState:function(){return $a(Re)},useDebugValue:no,useDeferredValue:function(e){var n=$a(Re),a=n[0],t=n[1];return ui(function(){var i=we.transition;we.transition=1;try{t(e)}finally{we.transition=i}},[e]),a},useTransition:function(){var e=$a(Re)[0];return[li().current,e]},useMutableSource:Ll,useOpaqueIdentifier:function(){return $a(Re)[0]},unstable_isNewReconciler:!1},Hc=Tn.ReactCurrentOwner,Be=!1;function ke(e,n,a,t){n.child=e===null?Nl(n,null,a,t):ai(n,e.child,a,t)}function zl(e,n,a,t,i){a=a.render;var r=n.ref;return ta(n,i),t=qr(e,n,a,t,r,i),e!==null&&!Be?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,Ye(e,n,i)):(n.flags|=1,ke(e,n,t,i),n.child)}function Vl(e,n,a,t,i,r){if(e===null){var o=a.type;return typeof o=="function"&&!ao(o)&&o.defaultProps===void 0&&a.compare===null&&a.defaultProps===void 0?(n.tag=15,n.type=o,Jl(e,n,o,t,i,r)):(e=ni(a.type,null,t,n,n.mode,r),e.ref=n.ref,e.return=n,n.child=e)}return o=e.child,(i&r)==0&&(i=o.memoizedProps,a=a.compare,a=a!==null?a:La,a(i,t)&&e.ref===n.ref)?Ye(e,n,r):(n.flags|=1,e=ln(o,t),e.ref=n.ref,e.return=n,n.child=e)}function Jl(e,n,a,t,i,r){if(e!==null&&La(e.memoizedProps,t)&&e.ref===n.ref)if(Be=!1,(r&i)!=0)(e.flags&16384)!=0&&(Be=!0);else return n.lanes=e.lanes,Ye(e,n,r);return to(e,n,a,t,r)}function io(e,n,a){var t=n.pendingProps,i=t.children,r=e!==null?e.memoizedState:null;if(t.mode==="hidden"||t.mode==="unstable-defer-without-hiding")if((n.mode&4)==0)n.memoizedState={baseLanes:0},di(n,a);else if((a&1073741824)!=0)n.memoizedState={baseLanes:0},di(n,r!==null?r.baseLanes:a);else return e=r!==null?r.baseLanes|a:a,n.lanes=n.childLanes=1073741824,n.memoizedState={baseLanes:e},di(n,e),null;else r!==null?(t=r.baseLanes|a,n.memoizedState=null):t=a,di(n,t);return ke(e,n,i,a),n.child}function _l(e,n){var a=n.ref;(e===null&&a!==null||e!==null&&e.ref!==a)&&(n.flags|=128)}function to(e,n,a,t,i){var r=ye(a)?Mn:de.current;return r=ea(n,r),ta(n,i),a=qr(e,n,a,t,r,i),e!==null&&!Be?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,Ye(e,n,i)):(n.flags|=1,ke(e,n,a,i),n.child)}function Zl(e,n,a,t,i){if(ye(a)){var r=!0;jt(n)}else r=!1;if(ta(n,i),n.stateNode===null)e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),Wl(n,a,t),Yr(n,a,t,i),t=!0;else if(e===null){var o=n.stateNode,s=n.memoizedProps;o.props=s;var l=o.context,d=a.contextType;typeof d=="object"&&d!==null?d=Ee(d):(d=ye(a)?Mn:de.current,d=ea(n,d));var y=a.getDerivedStateFromProps,N=typeof y=="function"||typeof o.getSnapshotBeforeUpdate=="function";N||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==t||l!==d)&&Pl(n,o,t,d),an=!1;var f=n.memoizedState;o.state=f,Qa(n,t,o,i),l=n.memoizedState,s!==t||f!==l||Se.current||an?(typeof y=="function"&&(qt(n,a,y,t),l=n.memoizedState),(s=an||wl(n,a,s,t,f,l,d))?(N||typeof o.UNSAFE_componentWillMount!="function"&&typeof o.componentWillMount!="function"||(typeof o.componentWillMount=="function"&&o.componentWillMount(),typeof o.UNSAFE_componentWillMount=="function"&&o.UNSAFE_componentWillMount()),typeof o.componentDidMount=="function"&&(n.flags|=4)):(typeof o.componentDidMount=="function"&&(n.flags|=4),n.memoizedProps=t,n.memoizedState=l),o.props=t,o.state=l,o.context=d,t=s):(typeof o.componentDidMount=="function"&&(n.flags|=4),t=!1)}else{o=n.stateNode,Il(e,n),s=n.memoizedProps,d=n.type===n.elementType?s:Ne(n.type,s),o.props=d,N=n.pendingProps,f=o.context,l=a.contextType,typeof l=="object"&&l!==null?l=Ee(l):(l=ye(a)?Mn:de.current,l=ea(n,l));var I=a.getDerivedStateFromProps;(y=typeof I=="function"||typeof o.getSnapshotBeforeUpdate=="function")||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==N||f!==l)&&Pl(n,o,t,l),an=!1,f=n.memoizedState,o.state=f,Qa(n,t,o,i);var B=n.memoizedState;s!==N||f!==B||Se.current||an?(typeof I=="function"&&(qt(n,a,I,t),B=n.memoizedState),(d=an||wl(n,a,d,t,f,B,l))?(y||typeof o.UNSAFE_componentWillUpdate!="function"&&typeof o.componentWillUpdate!="function"||(typeof o.componentWillUpdate=="function"&&o.componentWillUpdate(t,B,l),typeof o.UNSAFE_componentWillUpdate=="function"&&o.UNSAFE_componentWillUpdate(t,B,l)),typeof o.componentDidUpdate=="function"&&(n.flags|=4),typeof o.getSnapshotBeforeUpdate=="function"&&(n.flags|=256)):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=256),n.memoizedProps=t,n.memoizedState=B),o.props=t,o.state=B,o.context=l,t=d):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=256),t=!1)}return ro(e,n,a,t,r,i)}function ro(e,n,a,t,i,r){_l(e,n);var o=(n.flags&64)!=0;if(!t&&!o)return i&&gl(n,a,!1),Ye(e,n,r);t=n.stateNode,Hc.current=n;var s=o&&typeof a.getDerivedStateFromError!="function"?null:t.render();return n.flags|=1,e!==null&&o?(n.child=ai(n,e.child,null,r),n.child=ai(n,null,s,r)):ke(e,n,s,r),n.memoizedState=t.state,i&&gl(n,a,!0),n.child}function ql(e){var n=e.stateNode;n.pendingContext?cl(e,n.pendingContext,n.pendingContext!==n.context):n.context&&cl(e,n.context,!1),jr(e,n.containerInfo)}var ci={dehydrated:null,retryLane:0};function nu(e,n,a){var t=n.pendingProps,i=Z.current,r=!1,o;return(o=(n.flags&64)!=0)||(o=e!==null&&e.memoizedState===null?!1:(i&2)!=0),o?(r=!0,n.flags&=-65):e!==null&&e.memoizedState===null||t.fallback===void 0||t.unstable_avoidThisFallback===!0||(i|=1),_(Z,i&1),e===null?(t.fallback!==void 0&&Jr(n),e=t.children,i=t.fallback,r?(e=Xl(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=ci,e):typeof t.unstable_expectedLoadTime=="number"?(e=Xl(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=ci,n.lanes=33554432,e):(a=oo({mode:"visible",children:e},n.mode,a,null),a.return=n,n.child=a)):e.memoizedState!==null?r?(t=eu(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=ci,t):(a=$l(e,n,t.children,a),n.memoizedState=null,a):r?(t=eu(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=ci,t):(a=$l(e,n,t.children,a),n.memoizedState=null,a)}function Xl(e,n,a,t){var i=e.mode,r=e.child;return n={mode:"hidden",children:n},(i&2)==0&&r!==null?(r.childLanes=0,r.pendingProps=n):r=oo(n,i,0,null),a=ia(a,i,t,null),r.return=e,a.return=e,r.sibling=a,e.child=r,a}function $l(e,n,a,t){var i=e.child;return e=i.sibling,a=ln(i,{mode:"visible",children:a}),(n.mode&2)==0&&(a.lanes=t),a.return=n,a.sibling=null,e!==null&&(e.nextEffect=null,e.flags=8,n.firstEffect=n.lastEffect=e),n.child=a}function eu(e,n,a,t,i){var r=n.mode,o=e.child;e=o.sibling;var s={mode:"hidden",children:a};return(r&2)==0&&n.child!==o?(a=n.child,a.childLanes=0,a.pendingProps=s,o=a.lastEffect,o!==null?(n.firstEffect=a.firstEffect,n.lastEffect=o,o.nextEffect=null):n.firstEffect=n.lastEffect=null):a=ln(o,s),e!==null?t=ln(e,t):(t=ia(t,r,i,null),t.flags|=2),t.return=n,a.return=n,a.sibling=t,n.child=a,t}function au(e,n){e.lanes|=n;var a=e.alternate;a!==null&&(a.lanes|=n),vl(e.return,n)}function so(e,n,a,t,i,r){var o=e.memoizedState;o===null?e.memoizedState={isBackwards:n,rendering:null,renderingStartTime:0,last:t,tail:a,tailMode:i,lastEffect:r}:(o.isBackwards=n,o.rendering=null,o.renderingStartTime=0,o.last=t,o.tail=a,o.tailMode=i,o.lastEffect=r)}function tu(e,n,a){var t=n.pendingProps,i=t.revealOrder,r=t.tail;if(ke(e,n,t.children,a),t=Z.current,(t&2)!=0)t=t&1|2,n.flags|=64;else{if(e!==null&&(e.flags&64)!=0)e:for(e=n.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&au(e,a);else if(e.tag===19)au(e,a);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===n)break e;for(;e.sibling===null;){if(e.return===null||e.return===n)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}t&=1}if(_(Z,t),(n.mode&2)==0)n.memoizedState=null;else switch(i){case"forwards":for(a=n.child,i=null;a!==null;)e=a.alternate,e!==null&&ti(e)===null&&(i=a),a=a.sibling;a=i,a===null?(i=n.child,n.child=null):(i=a.sibling,a.sibling=null),so(n,!1,i,a,r,n.lastEffect);break;case"backwards":for(a=null,i=n.child,n.child=null;i!==null;){if(e=i.alternate,e!==null&&ti(e)===null){n.child=i;break}e=i.sibling,i.sibling=a,a=i,i=e}so(n,!0,a,null,r,n.lastEffect);break;case"together":so(n,!1,null,null,void 0,n.lastEffect);break;default:n.memoizedState=null}return n.child}function Ye(e,n,a){if(e!==null&&(n.dependencies=e.dependencies),xa|=n.lanes,(a&n.childLanes)!=0){if(e!==null&&n.child!==e.child)throw Error(T(153));if(n.child!==null){for(e=n.child,a=ln(e,e.pendingProps),n.child=a,a.return=n;e.sibling!==null;)e=e.sibling,a=a.sibling=ln(e,e.pendingProps),a.return=n;a.sibling=null}return n.child}return null}var iu,lo,ru,ou;iu=function(e,n){for(var a=n.child;a!==null;){if(a.tag===5||a.tag===6)e.appendChild(a.stateNode);else if(a.tag!==4&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return}a.sibling.return=a.return,a=a.sibling}};lo=function(){};ru=function(e,n,a,t){var i=e.memoizedProps;if(i!==t){e=n.stateNode,wn(Ue.current);var r=null;switch(a){case"input":i=xi(e,i),t=xi(e,t),r=[];break;case"option":i=zi(e,i),t=zi(e,t),r=[];break;case"select":i=b({},i,{value:void 0}),t=b({},t,{value:void 0}),r=[];break;case"textarea":i=Ji(e,i),t=Ji(e,t),r=[];break;default:typeof i.onClick!="function"&&typeof t.onClick=="function"&&(e.onclick=bt)}Zi(a,t);var o;a=null;for(d in i)if(!t.hasOwnProperty(d)&&i.hasOwnProperty(d)&&i[d]!=null)if(d==="style"){var s=i[d];for(o in s)s.hasOwnProperty(o)&&(a||(a={}),a[o]="")}else d!=="dangerouslySetInnerHTML"&&d!=="children"&&d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&d!=="autoFocus"&&(fa.hasOwnProperty(d)?r||(r=[]):(r=r||[]).push(d,null));for(d in t){var l=t[d];if(s=i!=null?i[d]:void 0,t.hasOwnProperty(d)&&l!==s&&(l!=null||s!=null))if(d==="style")if(s){for(o in s)!s.hasOwnProperty(o)||l&&l.hasOwnProperty(o)||(a||(a={}),a[o]="");for(o in l)l.hasOwnProperty(o)&&s[o]!==l[o]&&(a||(a={}),a[o]=l[o])}else a||(r||(r=[]),r.push(d,a)),a=l;else d==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,s=s?s.__html:void 0,l!=null&&s!==l&&(r=r||[]).push(d,l)):d==="children"?typeof l!="string"&&typeof l!="number"||(r=r||[]).push(d,""+l):d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&(fa.hasOwnProperty(d)?(l!=null&&d==="onScroll"&&z("scroll",e),r||s===l||(r=[])):typeof l=="object"&&l!==null&&l.$$typeof===Li?l.toString():(r=r||[]).push(d,l))}a&&(r=r||[]).push("style",a);var d=r;(n.updateQueue=d)&&(n.flags|=4)}};ou=function(e,n,a,t){a!==t&&(n.flags|=4)};function nt(e,n){if(!De)switch(e.tailMode){case"hidden":n=e.tail;for(var a=null;n!==null;)n.alternate!==null&&(a=n),n=n.sibling;a===null?e.tail=null:a.sibling=null;break;case"collapsed":a=e.tail;for(var t=null;a!==null;)a.alternate!==null&&(t=a),a=a.sibling;t===null?n||e.tail===null?e.tail=null:e.tail.sibling=null:t.sibling=null}}function Fc(e,n,a){var t=n.pendingProps;switch(n.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return null;case 1:return ye(n.type)&&Qt(),null;case 3:return ra(),J(Se),J(de),_r(),t=n.stateNode,t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(e===null||e.child===null)&&(ii(n)?n.flags|=4:t.hydrate||(n.flags|=256)),lo(n),null;case 5:zr(n);var i=wn(Va.current);if(a=n.type,e!==null&&n.stateNode!=null)ru(e,n,a,t,i),e.ref!==n.ref&&(n.flags|=128);else{if(!t){if(n.stateNode===null)throw Error(T(166));return null}if(e=wn(Ue.current),ii(n)){t=n.stateNode,a=n.type;var r=n.memoizedProps;switch(t[$e]=n,t[xt]=r,a){case"dialog":z("cancel",t),z("close",t);break;case"iframe":case"object":case"embed":z("load",t);break;case"video":case"audio":for(e=0;e<Fa.length;e++)z(Fa[e],t);break;case"source":z("error",t);break;case"img":case"image":case"link":z("error",t),z("load",t);break;case"details":z("toggle",t);break;case"input":qo(t,r),z("invalid",t);break;case"select":t._wrapperState={wasMultiple:!!r.multiple},z("invalid",t);break;case"textarea":es(t,r),z("invalid",t)}Zi(a,r),e=null;for(var o in r)r.hasOwnProperty(o)&&(i=r[o],o==="children"?typeof i=="string"?t.textContent!==i&&(e=["children",i]):typeof i=="number"&&t.textContent!==""+i&&(e=["children",""+i]):fa.hasOwnProperty(o)&&i!=null&&o==="onScroll"&&z("scroll",t));switch(a){case"input":At(t),$o(t,r,!0);break;case"textarea":At(t),as(t);break;case"select":case"option":break;default:typeof r.onClick=="function"&&(t.onclick=bt)}t=e,n.updateQueue=t,t!==null&&(n.flags|=4)}else{switch(o=i.nodeType===9?i:i.ownerDocument,e===Vi.html&&(e=ts(a)),e===Vi.html?a==="script"?(e=o.createElement("div"),e.innerHTML="<script></script>",e=e.removeChild(e.firstChild)):typeof t.is=="string"?e=o.createElement(a,{is:t.is}):(e=o.createElement(a),a==="select"&&(o=e,t.multiple?o.multiple=!0:t.size&&(o.size=t.size))):e=o.createElementNS(e,a),e[$e]=n,e[xt]=t,iu(e,n,!1,!1),n.stateNode=e,o=qi(a,t),a){case"dialog":z("cancel",e),z("close",e),i=t;break;case"iframe":case"object":case"embed":z("load",e),i=t;break;case"video":case"audio":for(i=0;i<Fa.length;i++)z(Fa[i],e);i=t;break;case"source":z("error",e),i=t;break;case"img":case"image":case"link":z("error",e),z("load",e),i=t;break;case"details":z("toggle",e),i=t;break;case"input":qo(e,t),i=xi(e,t),z("invalid",e);break;case"option":i=zi(e,t);break;case"select":e._wrapperState={wasMultiple:!!t.multiple},i=b({},t,{value:void 0}),z("invalid",e);break;case"textarea":es(e,t),i=Ji(e,t),z("invalid",e);break;default:i=t}Zi(a,i);var s=i;for(r in s)if(s.hasOwnProperty(r)){var l=s[r];r==="style"?os(e,l):r==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,l!=null&&is(e,l)):r==="children"?typeof l=="string"?(a!=="textarea"||l!=="")&&va(e,l):typeof l=="number"&&va(e,""+l):r!=="suppressContentEditableWarning"&&r!=="suppressHydrationWarning"&&r!=="autoFocus"&&(fa.hasOwnProperty(r)?l!=null&&r==="onScroll"&&z("scroll",e):l!=null&&Bi(e,r,l,o))}switch(a){case"input":At(e),$o(e,t,!1);break;case"textarea":At(e),as(e);break;case"option":t.value!=null&&e.setAttribute("value",""+Je(t.value));break;case"select":e.multiple=!!t.multiple,r=t.value,r!=null?Hn(e,!!t.multiple,r,!1):t.defaultValue!=null&&Hn(e,!!t.multiple,t.defaultValue,!0);break;default:typeof i.onClick=="function"&&(e.onclick=bt)}sl(a,t)&&(n.flags|=4)}n.ref!==null&&(n.flags|=128)}return null;case 6:if(e&&n.stateNode!=null)ou(e,n,e.memoizedProps,t);else{if(typeof t!="string"&&n.stateNode===null)throw Error(T(166));a=wn(Va.current),wn(Ue.current),ii(n)?(t=n.stateNode,a=n.memoizedProps,t[$e]=n,t.nodeValue!==a&&(n.flags|=4)):(t=(a.nodeType===9?a:a.ownerDocument).createTextNode(t),t[$e]=n,n.stateNode=t)}return null;case 13:return J(Z),t=n.memoizedState,(n.flags&64)!=0?(n.lanes=a,n):(t=t!==null,a=!1,e===null?n.memoizedProps.fallback!==void 0&&ii(n):a=e.memoizedState!==null,t&&!a&&(n.mode&2)!=0&&(e===null&&n.memoizedProps.unstable_avoidThisFallback!==!0||(Z.current&1)!=0?ue===0&&(ue=3):((ue===0||ue===3)&&(ue=4),pe===null||(xa&134217727)==0&&(sa&134217727)==0||la(pe,ge))),(t||a)&&(n.flags|=4),null);case 4:return ra(),lo(n),e===null&&rl(n.stateNode.containerInfo),null;case 10:return Fr(n),null;case 17:return ye(n.type)&&Qt(),null;case 19:if(J(Z),t=n.memoizedState,t===null)return null;if(r=(n.flags&64)!=0,o=t.rendering,o===null)if(r)nt(t,!1);else{if(ue!==0||e!==null&&(e.flags&64)!=0)for(e=n.child;e!==null;){if(o=ti(e),o!==null){for(n.flags|=64,nt(t,!1),r=o.updateQueue,r!==null&&(n.updateQueue=r,n.flags|=4),t.lastEffect===null&&(n.firstEffect=null),n.lastEffect=t.lastEffect,t=a,a=n.child;a!==null;)r=a,e=t,r.flags&=2,r.nextEffect=null,r.firstEffect=null,r.lastEffect=null,o=r.alternate,o===null?(r.childLanes=0,r.lanes=e,r.child=null,r.memoizedProps=null,r.memoizedState=null,r.updateQueue=null,r.dependencies=null,r.stateNode=null):(r.childLanes=o.childLanes,r.lanes=o.lanes,r.child=o.child,r.memoizedProps=o.memoizedProps,r.memoizedState=o.memoizedState,r.updateQueue=o.updateQueue,r.type=o.type,e=o.dependencies,r.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),a=a.sibling;return _(Z,Z.current&1|2),n.child}e=e.sibling}t.tail!==null&&ce()>uo&&(n.flags|=64,r=!0,nt(t,!1),n.lanes=33554432)}else{if(!r)if(e=ti(o),e!==null){if(n.flags|=64,r=!0,a=e.updateQueue,a!==null&&(n.updateQueue=a,n.flags|=4),nt(t,!0),t.tail===null&&t.tailMode==="hidden"&&!o.alternate&&!De)return n=n.lastEffect=t.lastEffect,n!==null&&(n.nextEffect=null),null}else 2*ce()-t.renderingStartTime>uo&&a!==1073741824&&(n.flags|=64,r=!0,nt(t,!1),n.lanes=33554432);t.isBackwards?(o.sibling=n.child,n.child=o):(a=t.last,a!==null?a.sibling=o:n.child=o,t.last=o)}return t.tail!==null?(a=t.tail,t.rendering=a,t.tail=a.sibling,t.lastEffect=n.lastEffect,t.renderingStartTime=ce(),a.sibling=null,n=Z.current,_(Z,r?n&1|2:n&1),a):null;case 23:case 24:return co(),e!==null&&e.memoizedState!==null!=(n.memoizedState!==null)&&t.mode!=="unstable-defer-without-hiding"&&(n.flags|=4),null}throw Error(T(156,n.tag))}function bc(e){switch(e.tag){case 1:ye(e.type)&&Qt();var n=e.flags;return n&4096?(e.flags=n&-4097|64,e):null;case 3:if(ra(),J(Se),J(de),_r(),n=e.flags,(n&64)!=0)throw Error(T(285));return e.flags=n&-4097|64,e;case 5:return zr(e),null;case 13:return J(Z),n=e.flags,n&4096?(e.flags=n&-4097|64,e):null;case 19:return J(Z),null;case 4:return ra(),null;case 10:return Fr(e),null;case 23:case 24:return co(),null;default:return null}}function ho(e,n){try{var a="",t=n;do a+=Ad(t),t=t.return;while(t);var i=a}catch(r){i=`
Error generating stack: `+r.message+`
`+r.stack}return{value:e,source:n,stack:i}}function go(e,n){try{console.error(n.value)}catch(a){setTimeout(function(){throw a})}}var Yc=typeof WeakMap=="function"?WeakMap:Map;function su(e,n,a){a=tn(-1,a),a.tag=3,a.payload={element:null};var t=n.value;return a.callback=function(){hi||(hi=!0,mo=t),go(e,n)},a}function lu(e,n,a){a=tn(-1,a),a.tag=3;var t=e.type.getDerivedStateFromError;if(typeof t=="function"){var i=n.value;a.payload=function(){return go(e,n),t(i)}}var r=e.stateNode;return r!==null&&typeof r.componentDidCatch=="function"&&(a.callback=function(){typeof t!="function"&&(Le===null?Le=new Set([this]):Le.add(this),go(e,n));var o=n.stack;this.componentDidCatch(n.value,{componentStack:o!==null?o:""})}),a}var xc=typeof WeakSet=="function"?WeakSet:Set;function uu(e){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(a){dn(e,a)}else n.current=null}function Qc(e,n){switch(n.tag){case 0:case 11:case 15:case 22:return;case 1:if(n.flags&256&&e!==null){var a=e.memoizedProps,t=e.memoizedState;e=n.stateNode,n=e.getSnapshotBeforeUpdate(n.elementType===n.type?a:Ne(n.type,a),t),e.__reactInternalSnapshotBeforeUpdate=n}return;case 3:n.flags&256&&Or(n.stateNode.containerInfo);return;case 5:case 6:case 4:case 17:return}throw Error(T(163))}function zc(e,n,a){switch(a.tag){case 0:case 11:case 15:case 22:if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{if((e.tag&3)==3){var t=e.create;e.destroy=t()}e=e.next}while(e!==n)}if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{var i=e;t=i.next,i=i.tag,(i&4)!=0&&(i&1)!=0&&(du(a,e),jc(a,e)),e=t}while(e!==n)}return;case 1:e=a.stateNode,a.flags&4&&(n===null?e.componentDidMount():(t=a.elementType===a.type?n.memoizedProps:Ne(a.type,n.memoizedProps),e.componentDidUpdate(t,n.memoizedState,e.__reactInternalSnapshotBeforeUpdate))),n=a.updateQueue,n!==null&&El(a,n,e);return;case 3:if(n=a.updateQueue,n!==null){if(e=null,a.child!==null)switch(a.child.tag){case 5:e=a.child.stateNode;break;case 1:e=a.child.stateNode}El(a,n,e)}return;case 5:e=a.stateNode,n===null&&a.flags&4&&sl(a.type,a.memoizedProps)&&e.focus();return;case 6:return;case 4:return;case 12:return;case 13:a.memoizedState===null&&(a=a.alternate,a!==null&&(a=a.memoizedState,a!==null&&(a=a.dehydrated,a!==null&&vs(a))));return;case 19:case 17:case 20:case 21:case 23:case 24:return}throw Error(T(163))}function cu(e,n){for(var a=e;;){if(a.tag===5){var t=a.stateNode;if(n)t=t.style,typeof t.setProperty=="function"?t.setProperty("display","none","important"):t.display="none";else{t=a.stateNode;var i=a.memoizedProps.style;i=i!=null&&i.hasOwnProperty("display")?i.display:null,t.style.display=rs("display",i)}}else if(a.tag===6)a.stateNode.nodeValue=n?"":a.memoizedProps;else if((a.tag!==23&&a.tag!==24||a.memoizedState===null||a===e)&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===e)break;for(;a.sibling===null;){if(a.return===null||a.return===e)return;a=a.return}a.sibling.return=a.return,a=a.sibling}}function gu(e,n){if(En&&typeof En.onCommitFiberUnmount=="function")try{En.onCommitFiberUnmount(Kr,n)}catch(r){}switch(n.tag){case 0:case 11:case 14:case 15:case 22:if(e=n.updateQueue,e!==null&&(e=e.lastEffect,e!==null)){var a=e=e.next;do{var t=a,i=t.destroy;if(t=t.tag,i!==void 0)if((t&4)!=0)du(n,a);else{t=n;try{i()}catch(r){dn(t,r)}}a=a.next}while(a!==e)}break;case 1:if(uu(n),e=n.stateNode,typeof e.componentWillUnmount=="function")try{e.props=n.memoizedProps,e.state=n.memoizedState,e.componentWillUnmount()}catch(r){dn(n,r)}break;case 5:uu(n);break;case 4:hu(e,n)}}function mu(e){e.alternate=null,e.child=null,e.dependencies=null,e.firstEffect=null,e.lastEffect=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.return=null,e.updateQueue=null}function pu(e){return e.tag===5||e.tag===3||e.tag===4}function fu(e){e:{for(var n=e.return;n!==null;){if(pu(n))break e;n=n.return}throw Error(T(160))}var a=n;switch(n=a.stateNode,a.tag){case 5:var t=!1;break;case 3:n=n.containerInfo,t=!0;break;case 4:n=n.containerInfo,t=!0;break;default:throw Error(T(161))}a.flags&16&&(va(n,""),a.flags&=-17);e:n:for(a=e;;){for(;a.sibling===null;){if(a.return===null||pu(a.return)){a=null;break e}a=a.return}for(a.sibling.return=a.return,a=a.sibling;a.tag!==5&&a.tag!==6&&a.tag!==18;){if(a.flags&2||a.child===null||a.tag===4)continue n;a.child.return=a,a=a.child}if(!(a.flags&2)){a=a.stateNode;break e}}t?po(e,a,n):fo(e,a,n)}function po(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.nodeType===8?a.parentNode.insertBefore(e,n):a.insertBefore(e,n):(a.nodeType===8?(n=a.parentNode,n.insertBefore(e,a)):(n=a,n.appendChild(e)),a=a._reactRootContainer,a!=null||n.onclick!==null||(n.onclick=bt));else if(t!==4&&(e=e.child,e!==null))for(po(e,n,a),e=e.sibling;e!==null;)po(e,n,a),e=e.sibling}function fo(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.insertBefore(e,n):a.appendChild(e);else if(t!==4&&(e=e.child,e!==null))for(fo(e,n,a),e=e.sibling;e!==null;)fo(e,n,a),e=e.sibling}function hu(e,n){for(var a=n,t=!1,i,r;;){if(!t){t=a.return;e:for(;;){if(t===null)throw Error(T(160));switch(i=t.stateNode,t.tag){case 5:r=!1;break e;case 3:i=i.containerInfo,r=!0;break e;case 4:i=i.containerInfo,r=!0;break e}t=t.return}t=!0}if(a.tag===5||a.tag===6){e:for(var o=e,s=a,l=s;;)if(gu(o,l),l.child!==null&&l.tag!==4)l.child.return=l,l=l.child;else{if(l===s)break e;for(;l.sibling===null;){if(l.return===null||l.return===s)break e;l=l.return}l.sibling.return=l.return,l=l.sibling}r?(o=i,s=a.stateNode,o.nodeType===8?o.parentNode.removeChild(s):o.removeChild(s)):i.removeChild(a.stateNode)}else if(a.tag===4){if(a.child!==null){i=a.stateNode.containerInfo,r=!0,a.child.return=a,a=a.child;continue}}else if(gu(e,a),a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return,a.tag===4&&(t=!1)}a.sibling.return=a.return,a=a.sibling}}function yo(e,n){switch(n.tag){case 0:case 11:case 14:case 15:case 22:var a=n.updateQueue;if(a=a!==null?a.lastEffect:null,a!==null){var t=a=a.next;do(t.tag&3)==3&&(e=t.destroy,t.destroy=void 0,e!==void 0&&e()),t=t.next;while(t!==a)}return;case 1:return;case 5:if(a=n.stateNode,a!=null){t=n.memoizedProps;var i=e!==null?e.memoizedProps:t;e=n.type;var r=n.updateQueue;if(n.updateQueue=null,r!==null){for(a[xt]=t,e==="input"&&t.type==="radio"&&t.name!=null&&Xo(a,t),qi(e,i),n=qi(e,t),i=0;i<r.length;i+=2){var o=r[i],s=r[i+1];o==="style"?os(a,s):o==="dangerouslySetInnerHTML"?is(a,s):o==="children"?va(a,s):Bi(a,o,s,n)}switch(e){case"input":ji(a,t);break;case"textarea":ns(a,t);break;case"select":e=a._wrapperState.wasMultiple,a._wrapperState.wasMultiple=!!t.multiple,r=t.value,r!=null?Hn(a,!!t.multiple,r,!1):e!==!!t.multiple&&(t.defaultValue!=null?Hn(a,!!t.multiple,t.defaultValue,!0):Hn(a,!!t.multiple,t.multiple?[]:"",!1))}}}return;case 6:if(n.stateNode===null)throw Error(T(162));n.stateNode.nodeValue=n.memoizedProps;return;case 3:a=n.stateNode,a.hydrate&&(a.hydrate=!1,vs(a.containerInfo));return;case 12:return;case 13:n.memoizedState!==null&&(So=ce(),cu(n.child,!0)),Su(n);return;case 19:Su(n);return;case 17:return;case 23:case 24:cu(n,n.memoizedState!==null);return}throw Error(T(163))}function Su(e){var n=e.updateQueue;if(n!==null){e.updateQueue=null;var a=e.stateNode;a===null&&(a=e.stateNode=new xc),n.forEach(function(t){var i=Jc.bind(null,e,t);a.has(t)||(a.add(t),t.then(i,i))})}}function Vc(e,n){return e!==null&&(e=e.memoizedState,e===null||e.dehydrated!==null)?(n=n.memoizedState,n!==null&&n.dehydrated===null):!1}var _c=Math.ceil,gi=Tn.ReactCurrentDispatcher,To=Tn.ReactCurrentOwner,D=0,pe=null,ne=null,ge=0,On=0,ko=en(0),ue=0,mi=null,ua=0,xa=0,sa=0,Ao=0,vo=null,So=0,uo=Infinity;function da(){uo=ce()+500}var E=null,hi=!1,mo=null,Le=null,cn=!1,at=null,tt=90,Io=[],Mo=[],xe=null,it=0,Eo=null,pi=-1,Qe=0,fi=0,rt=null,Si=!1;function Ie(){return(D&48)!=0?ce():pi!==-1?pi:pi=ce()}function on(e){if(e=e.mode,(e&2)==0)return 1;if((e&4)==0)return na()===99?1:2;if(Qe===0&&(Qe=ua),Gc.transition!==0){fi!==0&&(fi=vo!==null?vo.pendingLanes:0),e=Qe;var n=4186112&~fi;return n&=-n,n===0&&(e=4186112&~e,n=e&-e,n===0&&(n=8192)),n}return e=na(),(D&4)!=0&&e===98?e=Ot(12,Qe):(e=Rd(e),e=Ot(e,Qe)),e}function sn(e,n,a){if(50<it)throw it=0,Eo=null,Error(T(185));if(e=yi(e,n),e===null)return null;Nt(e,n,a),e===pe&&(sa|=n,ue===4&&la(e,ge));var t=na();n===1?(D&8)!=0&&(D&48)==0?Co(e):(We(e,a),D===0&&(da(),Ge())):((D&4)==0||t!==98&&t!==99||(xe===null?xe=new Set([e]):xe.add(e)),We(e,a)),vo=e}function yi(e,n){e.lanes|=n;var a=e.alternate;for(a!==null&&(a.lanes|=n),a=e,e=e.return;e!==null;)e.childLanes|=n,a=e.alternate,a!==null&&(a.childLanes|=n),a=e,e=e.return;return a.tag===3?a.stateNode:null}function We(e,n){for(var a=e.callbackNode,t=e.suspendedLanes,i=e.pingedLanes,r=e.expirationTimes,o=e.pendingLanes;0<o;){var s=31-qe(o),l=1<<s,d=r[s];if(d===-1){if((l&t)==0||(l&i)!=0){d=n,Qn(l);var y=Q;r[s]=10<=y?d+250:6<=y?d+5e3:-1}}else d<=n&&(e.expiredLanes|=l);o&=~l}if(t=Ba(e,e===pe?ge:0),n=Q,t===0)a!==null&&(a!==Rr&&Ur(a),e.callbackNode=null,e.callbackPriority=0);else{if(a!==null){if(e.callbackPriority===n)return;a!==Rr&&Ur(a)}n===15?(a=Co.bind(null,e),Fe===null?(Fe=[a],Jt=Gr(zt,Al)):Fe.push(a),a=Rr):n===14?a=Ya(99,Co.bind(null,e)):(a=Ld(n),a=Ya(a,yu.bind(null,e))),e.callbackPriority=n,e.callbackNode=a}}function yu(e){if(pi=-1,fi=Qe=0,(D&48)!=0)throw Error(T(327));var n=e.callbackNode;if(hn()&&e.callbackNode!==n)return null;var a=Ba(e,e===pe?ge:0);if(a===0)return null;var t=a,i=D;D|=16;var r=ku();(pe!==e||ge!==t)&&(da(),ca(e,t));do try{Zc();break}catch(s){Tu(e,s)}while(1);if(Hr(),gi.current=r,D=i,ne!==null?t=0:(pe=null,ge=0,t=ue),(ua&sa)!=0)ca(e,0);else if(t!==0){if(t===2&&(D|=64,e.hydrate&&(e.hydrate=!1,Or(e.containerInfo)),a=Ps(e),a!==0&&(t=ot(e,a))),t===1)throw n=mi,ca(e,0),la(e,a),We(e,ce()),n;switch(e.finishedWork=e.current.alternate,e.finishedLanes=a,t){case 0:case 1:throw Error(T(345));case 2:Nn(e);break;case 3:if(la(e,a),(a&62914560)===a&&(t=So+500-ce(),10<t)){if(Ba(e,0)!==0)break;if(i=e.suspendedLanes,(i&a)!==a){Ie(),e.pingedLanes|=e.suspendedLanes&i;break}e.timeoutHandle=ll(Nn.bind(null,e),t);break}Nn(e);break;case 4:if(la(e,a),(a&4186112)===a)break;for(t=e.eventTimes,i=-1;0<a;){var o=31-qe(a);r=1<<o,o=t[o],o>i&&(i=o),a&=~r}if(a=i,a=ce()-a,a=(120>a?120:480>a?480:1080>a?1080:1920>a?1920:3e3>a?3e3:4320>a?4320:1960*_c(a/1960))-a,10<a){e.timeoutHandle=ll(Nn.bind(null,e),a);break}Nn(e);break;case 5:Nn(e);break;default:throw Error(T(329))}}return We(e,ce()),e.callbackNode===n?yu.bind(null,e):null}function la(e,n){for(n&=~Ao,n&=~sa,e.suspendedLanes|=n,e.pingedLanes&=~n,e=e.expirationTimes;0<n;){var a=31-qe(n),t=1<<a;e[a]=-1,n&=~t}}function Co(e){if((D&48)!=0)throw Error(T(327));if(hn(),e===pe&&(e.expiredLanes&ge)!=0){var n=ge,a=ot(e,n);(ua&sa)!=0&&(n=Ba(e,n),a=ot(e,n))}else n=Ba(e,0),a=ot(e,n);if(e.tag!==0&&a===2&&(D|=64,e.hydrate&&(e.hydrate=!1,Or(e.containerInfo)),n=Ps(e),n!==0&&(a=ot(e,n))),a===1)throw a=mi,ca(e,0),la(e,n),We(e,ce()),a;return e.finishedWork=e.current.alternate,e.finishedLanes=n,Nn(e),We(e,ce()),null}function qc(){if(xe!==null){var e=xe;xe=null,e.forEach(function(n){n.expiredLanes|=24&n.pendingLanes,We(n,ce())})}Ge()}function Au(e,n){var a=D;D|=1;try{return e(n)}finally{D=a,D===0&&(da(),Ge())}}function vu(e,n){var a=D;D&=-2,D|=8;try{return e(n)}finally{D=a,D===0&&(da(),Ge())}}function di(e,n){_(ko,On),On|=n,ua|=n}function co(){On=ko.current,J(ko)}function ca(e,n){e.finishedWork=null,e.finishedLanes=0;var a=e.timeoutHandle;if(a!==-1&&(e.timeoutHandle=-1,Wc(a)),ne!==null)for(a=ne.return;a!==null;){var t=a;switch(t.tag){case 1:t=t.type.childContextTypes,t!=null&&Qt();break;case 3:ra(),J(Se),J(de),_r();break;case 5:zr(t);break;case 4:ra();break;case 13:J(Z);break;case 19:J(Z);break;case 10:Fr(t);break;case 23:case 24:co()}a=a.return}pe=e,ne=ln(e.current,null),ge=On=ua=n,ue=0,mi=null,Ao=sa=xa=0}function Tu(e,n){do{var a=ne;try{if(Hr(),_a.current=oi,ri){for(var t=q.memoizedState;t!==null;){var i=t.queue;i!==null&&(i.pending=null),t=t.next}ri=!1}if(Za=0,le=he=q=null,qa=!1,To.current=null,a===null||a.return===null){ue=1,mi=n,ne=null;break}e:{var r=e,o=a.return,s=a,l=n;if(n=ge,s.flags|=2048,s.firstEffect=s.lastEffect=null,l!==null&&typeof l=="object"&&typeof l.then=="function"){var d=l;if((s.mode&2)==0){var y=s.alternate;y?(s.updateQueue=y.updateQueue,s.memoizedState=y.memoizedState,s.lanes=y.lanes):(s.updateQueue=null,s.memoizedState=null)}var N=(Z.current&1)!=0,f=o;do{var I;if(I=f.tag===13){var B=f.memoizedState;if(B!==null)I=B.dehydrated!==null;else{var w=f.memoizedProps;I=w.fallback===void 0?!1:w.unstable_avoidThisFallback!==!0?!0:!N}}if(I){var h=f.updateQueue;if(h===null){var u=new Set;u.add(d),f.updateQueue=u}else h.add(d);if((f.mode&2)==0){if(f.flags|=64,s.flags|=16384,s.flags&=-2981,s.tag===1)if(s.alternate===null)s.tag=17;else{var c=tn(-1,1);c.tag=2,rn(s,c)}s.lanes|=1;break e}l=void 0,s=n;var m=r.pingCache;if(m===null?(m=r.pingCache=new Yc,l=new Set,m.set(d,l)):(l=m.get(d),l===void 0&&(l=new Set,m.set(d,l))),!l.has(s)){l.add(s);var p=Xc.bind(null,r,d,s);d.then(p,p)}f.flags|=4096,f.lanes=n;break e}f=f.return}while(f!==null);l=Error((Ln(s.type)||"A React component")+` suspended while rendering, but no fallback UI was specified.

Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.`)}ue!==5&&(ue=2),l=ho(l,s),f=o;do{switch(f.tag){case 3:r=l,f.flags|=4096,n&=-n,f.lanes|=n;var K=su(f,r,n);Ml(f,K);break e;case 1:r=l;var v=f.type,P=f.stateNode;if((f.flags&64)==0&&(typeof v.getDerivedStateFromError=="function"||P!==null&&typeof P.componentDidCatch=="function"&&(Le===null||!Le.has(P)))){f.flags|=4096,n&=-n,f.lanes|=n;var U=lu(f,r,n);Ml(f,U);break e}}f=f.return}while(f!==null)}Iu(a)}catch(G){n=G,ne===a&&a!==null&&(ne=a=a.return);continue}break}while(1)}function ku(){var e=gi.current;return gi.current=oi,e===null?oi:e}function ot(e,n){var a=D;D|=16;var t=ku();pe===e&&ge===n||ca(e,n);do try{$c();break}catch(i){Tu(e,i)}while(1);if(Hr(),D=a,gi.current=t,ne!==null)throw Error(T(261));return pe=null,ge=0,ue}function $c(){for(;ne!==null;)Mu(ne)}function Zc(){for(;ne!==null&&!Nc();)Mu(ne)}function Mu(e){var n=Eu(e.alternate,e,On);e.memoizedProps=e.pendingProps,n===null?Iu(e):ne=n,To.current=null}function Iu(e){var n=e;do{var a=n.alternate;if(e=n.return,(n.flags&2048)==0){if(a=Fc(a,n,On),a!==null){ne=a;return}if(a=n,a.tag!==24&&a.tag!==23||a.memoizedState===null||(On&1073741824)!=0||(a.mode&4)==0){for(var t=0,i=a.child;i!==null;)t|=i.lanes|i.childLanes,i=i.sibling;a.childLanes=t}e!==null&&(e.flags&2048)==0&&(e.firstEffect===null&&(e.firstEffect=n.firstEffect),n.lastEffect!==null&&(e.lastEffect!==null&&(e.lastEffect.nextEffect=n.firstEffect),e.lastEffect=n.lastEffect),1<n.flags&&(e.lastEffect!==null?e.lastEffect.nextEffect=n:e.firstEffect=n,e.lastEffect=n))}else{if(a=bc(n),a!==null){a.flags&=2047,ne=a;return}e!==null&&(e.firstEffect=e.lastEffect=null,e.flags|=2048)}if(n=n.sibling,n!==null){ne=n;return}ne=n=e}while(n!==null);ue===0&&(ue=5)}function Nn(e){var n=na();return Cn(99,eh.bind(null,e,n)),null}function eh(e,n){do hn();while(at!==null);if((D&48)!=0)throw Error(T(327));var a=e.finishedWork;if(a===null)return null;if(e.finishedWork=null,e.finishedLanes=0,a===e.current)throw Error(T(177));e.callbackNode=null;var t=a.lanes|a.childLanes,i=t,r=e.pendingLanes&~i;e.pendingLanes=i,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=i,e.mutableReadLanes&=i,e.entangledLanes&=i,i=e.entanglements;for(var o=e.eventTimes,s=e.expirationTimes;0<r;){var l=31-qe(r),d=1<<l;i[l]=0,o[l]=-1,s[l]=-1,r&=~d}if(xe!==null&&(t&24)==0&&xe.has(e)&&xe.delete(e),e===pe&&(ne=pe=null,ge=0),1<a.flags?a.lastEffect!==null?(a.lastEffect.nextEffect=a,t=a.firstEffect):t=a:t=a.firstEffect,t!==null){if(i=D,D|=32,To.current=null,wr=Bt,o=Zs(),Ir(o)){if("selectionStart"in o)s={start:o.selectionStart,end:o.selectionEnd};else e:if(s=(s=o.ownerDocument)&&s.defaultView||window,(d=s.getSelection&&s.getSelection())&&d.rangeCount!==0){s=d.anchorNode,r=d.anchorOffset,l=d.focusNode,d=d.focusOffset;try{s.nodeType,l.nodeType}catch(G){s=null;break e}var y=0,N=-1,f=-1,I=0,B=0,w=o,h=null;n:for(;;){for(var u;w!==s||r!==0&&w.nodeType!==3||(N=y+r),w!==l||d!==0&&w.nodeType!==3||(f=y+d),w.nodeType===3&&(y+=w.nodeValue.length),(u=w.firstChild)!==null;)h=w,w=u;for(;;){if(w===o)break n;if(h===s&&++I===r&&(N=y),h===l&&++B===d&&(f=y),(u=w.nextSibling)!==null)break;w=h,h=w.parentNode}w=u}s=N===-1||f===-1?null:{start:N,end:f}}else s=null;s=s||{start:0,end:0}}else s=null;Wr={focusedElem:o,selectionRange:s},Bt=!1,rt=null,Si=!1,E=t;do try{nh()}catch(G){if(E===null)throw Error(T(330));dn(E,G),E=E.nextEffect}while(E!==null);rt=null,E=t;do try{for(o=e;E!==null;){var c=E.flags;if(c&16&&va(E.stateNode,""),c&128){var m=E.alternate;if(m!==null){var p=m.ref;p!==null&&(typeof p=="function"?p(null):p.current=null)}}switch(c&1038){case 2:fu(E),E.flags&=-3;break;case 6:fu(E),E.flags&=-3,yo(E.alternate,E);break;case 1024:E.flags&=-1025;break;case 1028:E.flags&=-1025,yo(E.alternate,E);break;case 4:yo(E.alternate,E);break;case 8:s=E,hu(o,s);var K=s.alternate;mu(s),K!==null&&mu(K)}E=E.nextEffect}}catch(G){if(E===null)throw Error(T(330));dn(E,G),E=E.nextEffect}while(E!==null);if(p=Wr,m=Zs(),c=p.focusedElem,o=p.selectionRange,m!==c&&c&&c.ownerDocument&&_s(c.ownerDocument.documentElement,c)){for(o!==null&&Ir(c)&&(m=o.start,p=o.end,p===void 0&&(p=m),"selectionStart"in c?(c.selectionStart=m,c.selectionEnd=Math.min(p,c.value.length)):(p=(m=c.ownerDocument||document)&&m.defaultView||window,p.getSelection&&(p=p.getSelection(),s=c.textContent.length,K=Math.min(o.start,s),o=o.end===void 0?K:Math.min(o.end,s),!p.extend&&K>o&&(s=o,o=K,K=s),s=Vs(c,K),r=Vs(c,o),s&&r&&(p.rangeCount!==1||p.anchorNode!==s.node||p.anchorOffset!==s.offset||p.focusNode!==r.node||p.focusOffset!==r.offset)&&(m=m.createRange(),m.setStart(s.node,s.offset),p.removeAllRanges(),K>o?(p.addRange(m),p.extend(r.node,r.offset)):(m.setEnd(r.node,r.offset),p.addRange(m)))))),m=[],p=c;p=p.parentNode;)p.nodeType===1&&m.push({element:p,left:p.scrollLeft,top:p.scrollTop});for(typeof c.focus=="function"&&c.focus(),c=0;c<m.length;c++)p=m[c],p.element.scrollLeft=p.left,p.element.scrollTop=p.top}Bt=!!wr,Wr=wr=null,e.current=a,E=t;do try{for(c=e;E!==null;){var v=E.flags;if(v&36&&zc(c,E.alternate,E),v&128){m=void 0;var P=E.ref;if(P!==null){var U=E.stateNode;switch(E.tag){case 5:m=U;break;default:m=U}typeof P=="function"?P(m):P.current=m}}E=E.nextEffect}}catch(G){if(E===null)throw Error(T(330));dn(E,G),E=E.nextEffect}while(E!==null);E=null,Kc(),D=i}else e.current=a;if(cn)cn=!1,at=e,tt=n;else for(E=t;E!==null;)n=E.nextEffect,E.nextEffect=null,E.flags&8&&(v=E,v.sibling=null,v.stateNode=null),E=n;if(t=e.pendingLanes,t===0&&(Le=null),t===1?e===Eo?it++:(it=0,Eo=e):it=0,a=a.stateNode,En&&typeof En.onCommitFiberRoot=="function")try{En.onCommitFiberRoot(Kr,a,void 0,(a.current.flags&64)==64)}catch(G){}if(We(e,ce()),hi)throw hi=!1,e=mo,mo=null,e;return(D&8)!=0||Ge(),null}function nh(){for(;E!==null;){var e=E.alternate;Si||rt===null||((E.flags&8)!=0?ps(E,rt)&&(Si=!0):E.tag===13&&Vc(e,E)&&ps(E,rt)&&(Si=!0));var n=E.flags;(n&256)!=0&&Qc(e,E),(n&512)==0||cn||(cn=!0,Ya(97,function(){return hn(),null})),E=E.nextEffect}}function hn(){if(tt!==90){var e=97<tt?97:tt;return tt=90,Cn(e,ah)}return!1}function jc(e,n){Io.push(n,e),cn||(cn=!0,Ya(97,function(){return hn(),null}))}function du(e,n){Mo.push(n,e),cn||(cn=!0,Ya(97,function(){return hn(),null}))}function ah(){if(at===null)return!1;var e=at;if(at=null,(D&48)!=0)throw Error(T(331));var n=D;D|=32;var a=Mo;Mo=[];for(var t=0;t<a.length;t+=2){var i=a[t],r=a[t+1],o=i.destroy;if(i.destroy=void 0,typeof o=="function")try{o()}catch(l){if(r===null)throw Error(T(330));dn(r,l)}}for(a=Io,Io=[],t=0;t<a.length;t+=2){i=a[t],r=a[t+1];try{var s=i.create;i.destroy=s()}catch(l){if(r===null)throw Error(T(330));dn(r,l)}}for(s=e.current.firstEffect;s!==null;)e=s.nextEffect,s.nextEffect=null,s.flags&8&&(s.sibling=null,s.stateNode=null),s=e;return D=n,Ge(),!0}function Cu(e,n,a){n=ho(a,n),n=su(e,n,1),rn(e,n),n=Ie(),e=yi(e,1),e!==null&&(Nt(e,1,n),We(e,n))}function dn(e,n){if(e.tag===3)Cu(e,e,n);else for(var a=e.return;a!==null;){if(a.tag===3){Cu(a,e,n);break}else if(a.tag===1){var t=a.stateNode;if(typeof a.type.getDerivedStateFromError=="function"||typeof t.componentDidCatch=="function"&&(Le===null||!Le.has(t))){e=ho(n,e);var i=lu(a,e,1);if(rn(a,i),i=Ie(),a=yi(a,1),a!==null)Nt(a,1,i),We(a,i);else if(typeof t.componentDidCatch=="function"&&(Le===null||!Le.has(t)))try{t.componentDidCatch(n,e)}catch(r){}break}}a=a.return}}function Xc(e,n,a){var t=e.pingCache;t!==null&&t.delete(n),n=Ie(),e.pingedLanes|=e.suspendedLanes&a,pe===e&&(ge&a)===a&&(ue===4||ue===3&&(ge&62914560)===ge&&500>ce()-So?ca(e,0):Ao|=a),We(e,n)}function Jc(e,n){var a=e.stateNode;a!==null&&a.delete(n),n=0,n===0&&(n=e.mode,(n&2)==0?n=1:(n&4)==0?n=na()===99?1:2:(Qe===0&&(Qe=ua),n=jn(62914560&~Qe),n===0&&(n=4194304))),a=Ie(),e=yi(e,n),e!==null&&(Nt(e,n,a),We(e,a))}var Eu;Eu=function(e,n,a){var t=n.lanes;if(e!==null)if(e.memoizedProps!==n.pendingProps||Se.current)Be=!0;else if((a&t)!=0)Be=(e.flags&16384)!=0;else{switch(Be=!1,n.tag){case 3:ql(n),Vr();break;case 5:Bl(n);break;case 1:ye(n.type)&&jt(n);break;case 4:jr(n,n.stateNode.containerInfo);break;case 10:t=n.memoizedProps.value;var i=n.type._context;_(Vt,i._currentValue),i._currentValue=t;break;case 13:if(n.memoizedState!==null)return(a&n.child.childLanes)!=0?nu(e,n,a):(_(Z,Z.current&1),n=Ye(e,n,a),n!==null?n.sibling:null);_(Z,Z.current&1);break;case 19:if(t=(a&n.childLanes)!=0,(e.flags&64)!=0){if(t)return tu(e,n,a);n.flags|=64}if(i=n.memoizedState,i!==null&&(i.rendering=null,i.tail=null,i.lastEffect=null),_(Z,Z.current),t)break;return null;case 23:case 24:return n.lanes=0,io(e,n,a)}return Ye(e,n,a)}else Be=!1;switch(n.lanes=0,n.tag){case 2:if(t=n.type,e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,i=ea(n,de.current),ta(n,a),i=qr(null,n,t,e,i,a),n.flags|=1,typeof i=="object"&&i!==null&&typeof i.render=="function"&&i.$$typeof===void 0){if(n.tag=1,n.memoizedState=null,n.updateQueue=null,ye(t)){var r=!0;jt(n)}else r=!1;n.memoizedState=i.state!==null&&i.state!==void 0?i.state:null,br(n);var o=t.getDerivedStateFromProps;typeof o=="function"&&qt(n,t,o,e),i.updater=Xt,n.stateNode=i,i._reactInternals=n,Yr(n,t,e,a),n=ro(null,n,t,!0,r,a)}else n.tag=0,ke(null,n,i,a),n=n.child;return n;case 16:i=n.elementType;e:{switch(e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,r=i._init,i=r(i._payload),n.type=i,r=n.tag=th(i),e=Ne(i,e),r){case 0:n=to(null,n,i,e,a);break e;case 1:n=Zl(null,n,i,e,a);break e;case 11:n=zl(null,n,i,e,a);break e;case 14:n=Vl(null,n,i,Ne(i.type,e),t,a);break e}throw Error(T(306,i,""))}return n;case 0:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ne(t,i),to(e,n,t,i,a);case 1:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ne(t,i),Zl(e,n,t,i,a);case 3:if(ql(n),t=n.updateQueue,e===null||t===null)throw Error(T(282));if(t=n.pendingProps,i=n.memoizedState,i=i!==null?i.element:null,Il(e,n),Qa(n,t,null,a),t=n.memoizedState.element,t===i)Vr(),n=Ye(e,n,a);else{if(i=n.stateNode,(r=i.hydrate)&&(un=Xn(n.stateNode.containerInfo.firstChild),be=n,r=De=!0),r){if(e=i.mutableSourceEagerHydrationData,e!=null)for(i=0;i<e.length;i+=2)r=e[i],r._workInProgressVersionPrimary=e[i+1],oa.push(r);for(a=Nl(n,null,t,a),n.child=a;a;)a.flags=a.flags&-3|1024,a=a.sibling}else ke(e,n,t,a),Vr();n=n.child}return n;case 5:return Bl(n),e===null&&Jr(n),t=n.type,i=n.pendingProps,r=e!==null?e.memoizedProps:null,o=i.children,Pr(t,i)?o=null:r!==null&&Pr(t,r)&&(n.flags|=16),_l(e,n),ke(e,n,o,a),n.child;case 6:return e===null&&Jr(n),null;case 13:return nu(e,n,a);case 4:return jr(n,n.stateNode.containerInfo),t=n.pendingProps,e===null?n.child=ai(n,null,t,a):ke(e,n,t,a),n.child;case 11:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ne(t,i),zl(e,n,t,i,a);case 7:return ke(e,n,n.pendingProps,a),n.child;case 8:return ke(e,n,n.pendingProps.children,a),n.child;case 12:return ke(e,n,n.pendingProps.children,a),n.child;case 10:e:{t=n.type._context,i=n.pendingProps,o=n.memoizedProps,r=i.value;var s=n.type._context;if(_(Vt,s._currentValue),s._currentValue=r,o!==null)if(s=o.value,r=Me(s,r)?0:(typeof t._calculateChangedBits=="function"?t._calculateChangedBits(s,r):1073741823)|0,r===0){if(o.children===i.children&&!Se.current){n=Ye(e,n,a);break e}}else for(s=n.child,s!==null&&(s.return=n);s!==null;){var l=s.dependencies;if(l!==null){o=s.child;for(var d=l.firstContext;d!==null;){if(d.context===t&&(d.observedBits&r)!=0){s.tag===1&&(d=tn(-1,a&-a),d.tag=2,rn(s,d)),s.lanes|=a,d=s.alternate,d!==null&&(d.lanes|=a),vl(s.return,a),l.lanes|=a;break}d=d.next}}else o=s.tag===10&&s.type===n.type?null:s.child;if(o!==null)o.return=s;else for(o=s;o!==null;){if(o===n){o=null;break}if(s=o.sibling,s!==null){s.return=o.return,o=s;break}o=o.return}s=o}ke(e,n,i.children,a),n=n.child}return n;case 9:return i=n.type,r=n.pendingProps,t=r.children,ta(n,a),i=Ee(i,r.unstable_observedBits),t=t(i),n.flags|=1,ke(e,n,t,a),n.child;case 14:return i=n.type,r=Ne(i,n.pendingProps),r=Ne(i.type,r),Vl(e,n,i,r,t,a);case 15:return Jl(e,n,n.type,n.pendingProps,t,a);case 17:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ne(t,i),e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),n.tag=1,ye(t)?(e=!0,jt(n)):e=!1,ta(n,a),Wl(n,t,i),Yr(n,t,i,a),ro(null,n,t,!0,e,a);case 19:return tu(e,n,a);case 23:return io(e,n,a);case 24:return io(e,n,a)}throw Error(T(156,n.tag))};function ih(e,n,a,t){this.tag=e,this.key=a,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=n,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=t,this.flags=0,this.lastEffect=this.firstEffect=this.nextEffect=null,this.childLanes=this.lanes=0,this.alternate=null}function Ce(e,n,a,t){return new ih(e,n,a,t)}function ao(e){return e=e.prototype,!(!e||!e.isReactComponent)}function th(e){if(typeof e=="function")return ao(e)?1:0;if(e!=null){if(e=e.$$typeof,e===St)return 11;if(e===Tt)return 14}return 2}function ln(e,n){var a=e.alternate;return a===null?(a=Ce(e.tag,n,e.key,e.mode),a.elementType=e.elementType,a.type=e.type,a.stateNode=e.stateNode,a.alternate=e,e.alternate=a):(a.pendingProps=n,a.type=e.type,a.flags=0,a.nextEffect=null,a.firstEffect=null,a.lastEffect=null),a.childLanes=e.childLanes,a.lanes=e.lanes,a.child=e.child,a.memoizedProps=e.memoizedProps,a.memoizedState=e.memoizedState,a.updateQueue=e.updateQueue,n=e.dependencies,a.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext},a.sibling=e.sibling,a.index=e.index,a.ref=e.ref,a}function ni(e,n,a,t,i,r){var o=2;if(t=e,typeof e=="function")ao(e)&&(o=1);else if(typeof e=="string")o=5;else e:switch(e){case ze:return ia(a.children,i,r,n);case Jo:o=8,i|=16;break;case Ki:o=8,i|=1;break;case ya:return e=Ce(12,a,n,i|8),e.elementType=ya,e.type=ya,e.lanes=r,e;case Ta:return e=Ce(13,a,n,i),e.type=Ta,e.elementType=Ta,e.lanes=r,e;case yt:return e=Ce(19,a,n,i),e.elementType=yt,e.lanes=r,e;case Hi:return oo(a,i,r,n);case Fi:return e=Ce(24,a,n,i),e.elementType=Fi,e.lanes=r,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case Gi:o=10;break e;case Ui:o=9;break e;case St:o=11;break e;case Tt:o=14;break e;case Di:o=16,t=null;break e;case Ri:o=22;break e}throw Error(T(130,e==null?e:typeof e,""))}return n=Ce(o,a,n,i),n.elementType=e,n.type=t,n.lanes=r,n}function ia(e,n,a,t){return e=Ce(7,e,t,n),e.lanes=a,e}function oo(e,n,a,t){return e=Ce(23,e,t,n),e.elementType=Hi,e.lanes=a,e}function xr(e,n,a){return e=Ce(6,e,null,n),e.lanes=a,e}function Qr(e,n,a){return n=Ce(4,e.children!==null?e.children:[],e.key,n),n.lanes=a,n.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},n}function rh(e,n,a){this.tag=n,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.pendingContext=this.context=null,this.hydrate=a,this.callbackNode=null,this.callbackPriority=0,this.eventTimes=gr(0),this.expirationTimes=gr(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=gr(0),this.mutableSourceEagerHydrationData=null}function oh(e,n,a){var t=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:kn,key:t==null?null:""+t,children:e,containerInfo:n,implementation:a}}function Ti(e,n,a,t){var i=n.current,r=Ie(),o=on(i);e:if(a){a=a._reactInternals;n:{if(vn(a)!==a||a.tag!==1)throw Error(T(170));var s=a;do{switch(s.tag){case 3:s=s.stateNode.context;break n;case 1:if(ye(s.type)){s=s.stateNode.__reactInternalMemoizedMergedChildContext;break n}}s=s.return}while(s!==null);throw Error(T(171))}if(a.tag===1){var l=a.type;if(ye(l)){a=hl(a,l,s);break e}}a=s}else a=nn;return n.context===null?n.context=a:n.pendingContext=a,n=tn(r,o),n.payload={element:e},t=t===void 0?null:t,t!==null&&(n.callback=t),rn(i,n),sn(i,o,r),o}function wo(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function wu(e,n){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var a=e.retryLane;e.retryLane=a!==0&&a<n?a:n}}function Wo(e,n){wu(e,n),(e=e.alternate)&&wu(e,n)}function sh(){return null}function Po(e,n,a){var t=a!=null&&a.hydrationOptions!=null&&a.hydrationOptions.mutableSources||null;if(a=new rh(e,n,a!=null&&a.hydrate===!0),n=Ce(3,null,null,n===2?7:n===1?3:0),a.current=n,n.stateNode=a,br(n),e[qn]=a.current,rl(e.nodeType===8?e.parentNode:e),t)for(e=0;e<t.length;e++){n=t[e];var i=n._getVersion;i=i(n._source),a.mutableSourceEagerHydrationData==null?a.mutableSourceEagerHydrationData=[n,i]:a.mutableSourceEagerHydrationData.push(n,i)}this._internalRoot=a}Po.prototype.render=function(e){Ti(e,this._internalRoot,null,null)};Po.prototype.unmount=function(){var e=this._internalRoot,n=e.containerInfo;Ti(null,e,null,function(){n[qn]=null})};function st(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function lh(e,n){if(n||(n=e?e.nodeType===9?e.documentElement:e.firstChild:null,n=!(!n||n.nodeType!==1||!n.hasAttribute("data-reactroot"))),!n)for(var a;a=e.lastChild;)e.removeChild(a);return new Po(e,0,n?{hydrate:!0}:void 0)}function ki(e,n,a,t,i){var r=a._reactRootContainer;if(r){var o=r._internalRoot;if(typeof i=="function"){var s=i;i=function(){var d=wo(o);s.call(d)}}Ti(n,o,e,i)}else{if(r=a._reactRootContainer=lh(a,t),o=r._internalRoot,typeof i=="function"){var l=i;i=function(){var d=wo(o);l.call(d)}}vu(function(){Ti(n,o,e,i)})}return wo(o)}fs=function(e){if(e.tag===13){var n=Ie();sn(e,4,n),Wo(e,4)}};or=function(e){if(e.tag===13){var n=Ie();sn(e,67108864,n),Wo(e,67108864)}};Ss=function(e){if(e.tag===13){var n=Ie(),a=on(e);sn(e,a,n),Wo(e,a)}};ys=function(e,n){return n()};$i=function(e,n,a){switch(n){case"input":if(ji(e,a),n=a.name,a.type==="radio"&&n!=null){for(a=e;a.parentNode;)a=a.parentNode;for(a=a.querySelectorAll("input[name="+JSON.stringify(""+n)+'][type="radio"]'),n=0;n<a.length;n++){var t=a[n];if(t!==e&&t.form===e.form){var i=Mt(t);if(!i)throw Error(T(90));Zo(t),ji(t,i)}}}break;case"textarea":ns(e,a);break;case"select":n=a.value,n!=null&&Hn(e,!!a.multiple,n,!1)}};er=Au;ds=function(e,n,a,t,i){var r=D;D|=4;try{return Cn(98,e.bind(null,n,a,t,i))}finally{D=r,D===0&&(da(),Ge())}};nr=function(){(D&49)==0&&(qc(),hn())};cs=function(e,n){var a=D;D|=2;try{return e(n)}finally{D=a,D===0&&(da(),Ge())}};function Wu(e,n){var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!st(n))throw Error(T(200));return oh(e,n,null,a)}var uh={Events:[Ma,Vn,Mt,ls,us,hn,{current:!1}]},lt={findFiberByHostInstance:In,bundleType:0,version:"17.0.2",rendererPackageName:"react-dom"},dh={bundleType:lt.bundleType,version:lt.version,rendererPackageName:lt.rendererPackageName,rendererConfig:lt.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:Tn.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=ms(e),e===null?null:e.stateNode},findFiberByHostInstance:lt.findFiberByHostInstance||sh,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__!="undefined"&&(ut=__REACT_DEVTOOLS_GLOBAL_HOOK__,!ut.isDisabled&&ut.supportsFiber))try{Kr=ut.inject(dh),En=ut}catch(e){}var ut,ch=uh,hh=Wu,gh=function(e){if(e==null)return null;if(e.nodeType===1)return e;var n=e._reactInternals;if(n===void 0)throw typeof e.render=="function"?Error(T(188)):Error(T(268,Object.keys(e)));return e=ms(n),e=e===null?null:e.stateNode,e},mh=function(e,n){var a=D;if((a&48)!=0)return e(n);D|=1;try{if(e)return Cn(99,e.bind(null,n))}finally{D=a,Ge()}},ph=function(e,n,a){if(!st(n))throw Error(T(200));return ki(null,e,n,!0,a)},fh=function(e,n,a){if(!st(n))throw Error(T(200));return ki(null,e,n,!1,a)},Sh=function(e){if(!st(e))throw Error(T(40));return e._reactRootContainer?(vu(function(){ki(null,null,e,!1,function(){e._reactRootContainer=null,e[qn]=null})}),!0):!1},yh=Au,Th=function(e,n){return Wu(e,n,2<arguments.length&&arguments[2]!==void 0?arguments[2]:null)},kh=function(e,n,a,t){if(!st(a))throw Error(T(200));if(e==null||e._reactInternals===void 0)throw Error(T(38));return ki(e,n,a,!1,t)},Ah="17.0.2",vh={__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:ch,createPortal:hh,findDOMNode:gh,flushSync:mh,hydrate:ph,render:fh,unmountComponentAtNode:Sh,unstable_batchedUpdates:yh,unstable_createPortal:Th,unstable_renderSubtreeIntoContainer:kh,version:Ah},Ih=je(function(e){function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__=="undefined"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(a){console.error(a)}}n(),e.exports=vh}),Oo=Ih.render;var No=Symbol(),Bo=Symbol(),Ko=Symbol(),Ai=Symbol();function Bn(e,n){function a(...t){if(t.length>=e.length)return e(...t);{let i=(...r)=>a(...t,...r);return i[No]=e,i[Bo]=a,i[Ko]=t,i[Ai]=a[Ai],i}}return a[No]=e,a[Bo]=a,a[Ko]=[],a[Ai]=n||Pu(e),a}function Go(e){return e[No]}function Mh(e){return e[Bo]}function vi(e){return e[Ko]||[]}function Pu(e){return e[Ai]||e.name}function Ch(){let e=[];return{test:n,getAllTests:a};function n(t,i){e.push(...Object.entries(i).map(([r,o])=>Eh(t,r,o)))}function a(){return e}}function A(e,n,...a){let t=n(...a,e);if(typeof t=="function")throw new Error("The matcher function `"+Uo(t)+"` returned a function instead of a boolean. You might need to pass another argument to it.");if(!t)throw new Ii([e,n,...a])}function Eh(e,n,a){return{subject:e,scenario:n,fn:a}}var Ii=class extends Error{constructor(n){super("Expectation failed");this.expectArgs=n}};function wh(e){return e[e.length-1]}function Ou(e){return e[0]}var Wh=Bn(function(e,n){return e(n)},"which"),j=Bn(function(e,n){var a,t;if(Ph(e))return e(n);if(Array.isArray(e)&&Array.isArray(n))return e.length===n.length&&e.every((i,r)=>j(e[r],n[r]));if(e instanceof Function&&n instanceof Function)return Go(e)&&Go(e)===Go(n)?j(vi(e),vi(n)):e===n;if(e instanceof Date&&n instanceof Date)return e.toISOString()===n.toISOString();if(e instanceof Set&&n instanceof Set)return e.size===n.size&&[...e.values()].every(i=>n.has(i));if(e instanceof Error&&n instanceof Error)return e.message===n.message&&e.__proto__.constructor===n.__proto__.constructor;if(Nu(e)&&Nu(n)){let i=Object.keys(e),r=Object.keys(n);return i.length===r.length&&i.every(o=>j(e[o],n[o]))&&((a=e.__proto__)==null?void 0:a.constructor)===((t=n.__proto__)==null?void 0:t.constructor)}return e===n},"equals"),W=Bn(function(e,n){return e===n},"is"),Do=Bn(function(e,n,...a){return!e(n,...a)},"not"),Bu=Bn(function(e){return/^\s*$/.test(e)},"isBlank");function Nu(e){return!!e&&typeof e=="object"}function Ph(e){return e instanceof Function&&Mh(e)===Wh&&vi(e).length===1}function Uo(e){return Pu(e)||"<function>"}function Gu(e){let n=[];return a(e);function a(l){var d;if(l===null)return"null";if(typeof l=="function")return t(l,i);if(typeof l=="string")return Ro(l);if(typeof l=="bigint")return`${l}n`;if(Array.isArray(l))return t(l,r);if(l instanceof Date)return`Date(${l.toISOString().replace("T"," ").replace("Z"," UTC")})`;if(l instanceof RegExp)return String(l);if(l instanceof Error)return`${Ku(l)}(${Ro(l.message)})`;if(l instanceof Set)return t(l,s);if(typeof l=="object"){let y=(d=l==null?void 0:l.__proto__)==null?void 0:d.constructor;return y===Object||!y?t(l,o):`${Ku(l)} ${t(l,o)}`}return String(l)}function t(l,d){if(n.indexOf(l)>-1)return"<circular reference>";n.push(l);let y=d(l);return n.pop(),y}function i(l){let d=vi(l).map(a),y=Uo(l);return d.length?dt(y+"(",d,",",")"):y}function r(l){return dt("[",l.map(a),",","]")}function o(l){let d=Object.entries(l).map(([y,N])=>`${Oh(y)}: ${a(N)}`);return dt("{",d,",","}")}function s(l){let d=[...l.values()].map(a);return dt("Set {",d,",","}")}}function Oh(e){return/^[a-zA-Z0-9_$]+$/.test(e)?e:Ro(e)}function Ku(e){return Uo(e.__proto__.constructor)}function Ro(e){return'"'+String(e).replace(/\\/g,"\\\\").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/"/g,'\\"').replace(/[\x00-\x1f\x7f]/g,Nh)+'"'}function Nh(e){let n=e.charCodeAt(0).toString(16);return"\\x"+(n.length<2?"0"+n:n)}function Mi(e,n){return n.split(`
`).map(a=>a&&Kh(Bh(e," "))(a)).join(`
`)}function Bh(e,n){return Array(e+1).join(n)}var Kh=e=>n=>e+n,Gh=Bn(function(n,a){return a.slice(0,n.length)===n?a.slice(n.length):a});function Uh(e){return String(e).split(/\r?\n/)}function Dh(e){let n=Uh(e);Bu(Ou(n))&&n.shift(),Bu(wh(n))&&n.pop();let a=/^[ \t]*/.exec(Ou(n))[0];return n.map(Gh(a)).join(`
`)}function dt(e,n,a,t){return n.length<2?e+n.join("")+t:e+`
`+Mi(2,n.join(a+`
`))+`
`+t}function Du(e){return ft(this,null,function*(){let n=[];for(let a of e){let t=yield Rh(a.fn),i=Uu.map(r=>({type:"debug",args:r}));Uu.length=0,n.push({test:a,error:t,instrumentLog:i})}return{results:n}})}function Rh(e){let n;try{let a=e();if(a instanceof Promise)return new Promise(t=>{a.then(()=>t()).catch(t)})}catch(a){n=a}return Promise.resolve(n)}var Uu=[],qg=Bn(function(n,a){return a instanceof Ii&&j(n,a.expectArgs)}),Ei=`

`;function Ru({results:e}){let n=!1,a=!1,t=[];for(let i of e){let r=!1;i.error&&(r=n=!0),i.instrumentLog.length&&(r=a=!0),r&&t.push(i)}return n?Lh(t):a?Fh(e.length,t):Hh(e.length)}function Lh(e){return e.map(Lu).join(Ei)+Ei+"Tests failed."}function Hh(e){switch(e){case 0:return"No tests to run.";case 1:return"One test ran, and found no issues.";default:return`${e} tests ran, and found no issues.`}}function Fh(e,n){return n.map(Lu).join(Ei)+Ei+bh(e)+`, but debugging instrumentation is present.
Remove it before shipping.`}function bh(e){switch(e){case 1:return"The test passed";case 2:return"Both tests passed";default:return`All ${e} tests passed`}}function Lu({test:e,error:n,instrumentLog:a}){let i=[e.subject+" "+e.scenario];return a.length&&i.push(Mi(2,xh(a))),n&&i.push(Mi(2,Yh(n))),i.join(`
`)}function Yh(e){return e instanceof Ii?Qh(e):jh(e)}function xh(e){return e.map(({args:n})=>Hu("debug",n)).join("")}function Qh(e){return Hu("expect",e.expectArgs)}function jh(e){return Gu(e)+" thrown"+Mi(2,zh(e.stack))}function Hu(e,n){return dt(e+"(",n.map(Gu),",",")")}function zh(e){if(!e)return"";let n=Dh(e).split(`
`);return`
`+n.slice(0,Jh(n)).map(a=>a.replace(/(file:\/\/|http:\/\/[^/]*)/,"").replace(/^([^@]*)@(.*)$/,"at $1 ($2)")).join(`
`)}function Jh(e){let n=e.findIndex(a=>a.includes("errorFrom"));return n===-1?e.length:n}var Xg=Object.freeze({test:{subject:"a thing",scenario:"does something",fn(){}},error:void 0,instrumentLog:[]}),Vh=Ch(),{getAllTests:Fu}=Vh;function te(...e){}function gn(){return(+new Date%1e6/1e3).toFixed(3)}function Y(e,n=0){return isNaN(e)||e===Infinity||e===-Infinity?"--:--":e<0?"-"+bu(-e,n):bu(e,n)}function bu(e,n){function a(o,s=_h){return(o<10?"0":"")+s(o)}let t=Math.floor(e/3600),i=Math.floor(e%3600/60),r=e%60;return t>0?`${t}:${a(i)}:${a(r,Yu(n))}`:`${i}:${a(r,Yu(n))}`}te("hoursMinutesSeconds",{"formats NaN"(){A(Y(0/0),W,"--:--")},"formats Infinities"(){A(Y(Infinity),W,"--:--"),A(Y(-Infinity),W,"--:--")},"formats negative numbers"(){A(Y(-1),W,"-0:01"),A(Y(-3661.12,2),W,"-1:01:01.12")},"formats single-digit seconds with leading zero"(){A(Y(0),W,"0:00"),A(Y(1),W,"0:01"),A(Y(9),W,"0:09")},"formats double-digit seconds"(){A(Y(10),W,"0:10"),A(Y(59),W,"0:59")},"formats minutes"(){A(Y(60),W,"1:00"),A(Y(61),W,"1:01"),A(Y(119),W,"1:59"),A(Y(120),W,"2:00"),A(Y(3599),W,"59:59")},"formats hours"(){A(Y(3600),W,"1:00:00"),A(Y(7200),W,"2:00:00"),A(Y(3661),W,"1:01:01"),A(Y(3610),W,"1:00:10"),A(Y(3600+600),W,"1:10:00"),A(Y(36001),W,"10:00:01")},"adds decimal places"(){A(Y(0,0),W,"0:00"),A(Y(0,1),W,"0:00.0"),A(Y(0,2),W,"0:00.00")},"formats fractional seconds"(){A(Y(1.23,2),W,"0:01.23")},"rounds decimals"(){A(Y(2.3456,2),W,"0:02.35")}});var _h=e=>e,Yu=e=>n=>n.toFixed(e);function ha(e){var n;return(n=/v=(.{11})/.exec(e))==null?void 0:n[1]}function xu(){return{getPlayerState(){return ie.UNSTARTED},getCurrentTime(){return 0},getVideoUrl(){return""},cueVideoById(){},playVideo(){},seekTo(){},getDuration(){return 0},addEventListener(){},removeEventListener(){}}}function Qu(e){return{getPlayerState(){return e.getPlayerState()},getCurrentTime(){return e.getCurrentTime()},getVideoUrl(){return e.getVideoUrl()},cueVideoById(...n){return console.debug(gn(),"player.cueVideoById",...n),e.cueVideoById(...n)},playVideo(...n){return console.debug(gn(),"player.playVideo",...n),e.playVideo(...n)},seekTo(...n){return console.debug(gn(),"player.seekTo",...n,ha(e.getVideoUrl())),e.seekTo(...n)},getDuration(){return e.getDuration()},addEventListener(...n){return console.debug(gn(),"player.addEventListener"),e.addEventListener(...n)},removeEventListener(...n){return console.debug(gn(),"player.removeEventListener"),e.removeEventListener(...n)}}}var ie={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};function ju(e){return ft(this,null,function*(){let n=yield Zh();return new Promise(a=>{let t=new n.Player(e,{height:450,width:800,videoId:null,playerVars:{controls:0,disablekb:1},events:{onReady(){a(t)}}})})})}function Zh(){return zu?Promise.resolve(window.YT):new Promise(e=>{var n;if(document.querySelector("script[src='https://www.youtube.com/iframe_api']")===null){let a=document.createElement("script");a.src="https://www.youtube.com/iframe_api";let t=document.getElementsByTagName("script")[0];(n=t.parentNode)==null||n.insertBefore(a,t)}Lo.push(e)})}var zu=!1,Lo=[];window.onYouTubeIframeAPIReady=()=>{zu=!0,Lo.forEach(e=>e(window.YT)),Lo.length=0};function Ju(e,n){let a=pa(),t=pa();t.current=e,Dn(()=>(a.current=setInterval(()=>{var i;return(i=t.current)==null?void 0:i.call(t)},n),()=>clearInterval(a.current)),[n])}function Vu(){let[e,n]=Oe(!1);return[e,()=>n(!0)]}function ct(e){switch(e){case ie.BUFFERING:return"buffering";case ie.UNSTARTED:return"unstarted";case ie.CUED:return"cued";case ie.ENDED:return"ended";case ie.PLAYING:return"playing";case ie.PAUSED:return"paused";default:return""}}function _u(e){return e.channel.getName()+" "+ct(e.code)}function ht(e){try{e()}catch(n){return n}}function mn(e,n){if(e.length===0)throw new Error("can't pick element from an empty array");if(n>=1||n<0)throw new Error("fraction out of bounds: "+n);return e[Math.floor(n*e.length)]}te("pick",{"throws if the array is empty"(){A(ht(()=>mn([],0)),j,new Error("can't pick element from an empty array"))},"throws if the fraction is 1"(){A(ht(()=>mn([""],1)),j,new Error("fraction out of bounds: 1"))},"throws if the fraction is > 1"(){A(ht(()=>mn([""],1.25)),j,new Error("fraction out of bounds: 1.25"))},"throws if the fraction is > 0"(){A(ht(()=>mn([""],-.25)),j,new Error("fraction out of bounds: -0.25"))},"picks the first element of the array given 0"(){A(mn([1,2],0),W,1)},"picks the last element of the array given 1 - epsilon"(){A(mn([1,2],.99),W,2)}});function ga(e,n){let a={};return t=>(t in a||(Object.keys(a).length===e&&(a={}),a[t]=n(t)),a[t])}te("cache",{"caches a value"(){let e=0,n=ga(1,()=>(e++,123));n("foo"),n("foo"),A(e,W,1)},"computes and caches values by key"(){let e=ga(2,n=>n+"x");A(e("foo"),W,"foox"),A(e("bar"),W,"barx")},"caches multiple values"(){let e=0,n=ga(2,a=>(e++,a+"x"));n("foo"),n("foo"),n("bar"),n("bar"),A(e,W,2),A(n("foo"),W,"foox"),A(n("bar"),W,"barx")},"a max size of 0 means no limit"(){let e=0,n=ga(0,()=>(e++,123));n("a"),n("b"),n("c"),A(e,W,3)}});function gt(e){let n=1779033703,a=3144134277,t=1013904242,i=2773480762;for(let r=0,o;r<e.length;r++)o=e.charCodeAt(r),n=a^Math.imul(n^o,597399067),a=t^Math.imul(a^o,2869860233),t=i^Math.imul(t^o,951274213),i=n^Math.imul(i^o,2716044179);return n=Math.imul(t^n>>>18,597399067),a=Math.imul(i^a>>>22,2869860233),t=Math.imul(n^t>>>17,951274213),i=Math.imul(a^i>>>19,2716044179),(n^a^t^i)>>>0}te("cyrb128_32",{"hashes unix timestamps to random-looking values"(){A(gt("1661673600"),W,1866196007),A(gt("1661760000"),W,3655929289),A(gt("1661846400"),W,2165297363)}});function Ci(e){return function(){var n=e+=1831565813;return n=Math.imul(n^n>>>15,n|1),n^=n+Math.imul(n^n>>>7,n|61),((n^n>>>14)>>>0)/4294967296}}te("mulberry32",{"flips coins fairly"(){let e=0,n=0,a=Ci(0);for(let t=0;t<200;t++)a()<.5?e++:n++;A(e-n,W,12)},"generates a reasonably uniform distribution of numbers"(){let e=new Set,n=Ci(0);for(let a=0;a<100;a++)e.add(Math.floor(n()*1e4));A(e.size,W,99)}});var mt=2;function Wi(e,n){let a=ga(1,wi(n));return{getBroadcast:t,getName(){return e}};function t(i){let r=i/1e3,o=(r-8*3600)%(24*3600),s=r-o,l=a(String(s)),d=0,y;for(y of l)if(d+=y.durationSeconds,d>=o)return y.type==="video"?{type:"video",videoId:y.videoId,videoTitle:y.videoTitle,currentTime:y.durationSeconds-(d-o)}:{type:"nothing",nextVideoId:y.nextVideoId};return{type:"nothing",nextVideoId:""}}}var wi=e=>n=>{let a=Ci(gt(n)),t=0,i=[];for(;t<24*3600;){let r=mn(e,a());for(let o of r.videos)i.push({type:"nothing",durationSeconds:mt,nextVideoId:o.videoId},{type:"video",videoId:o.videoId,videoTitle:o.title,durationSeconds:o.durationSeconds}),t+=o.durationSeconds+mt}return i};te("ScheduleGenerator",{"schedules a single 24-hour video"(){let e=[{videos:[{durationSeconds:3600*24,videoId:"the-video-id",title:"the-title"}]}],n=wi(e);A(n(""),j,[{type:"nothing",durationSeconds:2,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",durationSeconds:86400}])},"schedules a 12-hour video twice"(){let e=[{videos:[{durationSeconds:3600*12,videoId:"the-video-id",title:"the-title"}]}],n=wi(e);A(n(""),j,[{type:"nothing",durationSeconds:2,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",durationSeconds:43200},{type:"nothing",durationSeconds:2,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",durationSeconds:43200}])},"picks the videos to show randomly"(){let e=[{videos:[{durationSeconds:3600*2,videoId:"one",title:""}]},{videos:[{durationSeconds:3600*2,videoId:"two",title:""}]},{videos:[{durationSeconds:3600*2,videoId:"three",title:""}]}],n=wi(e);A(n("asdfx").map(a=>a.videoId).filter(Boolean),j,["three","one","three","two","two","three","one","three","two","two","one","one"])}});function Ae(e){return e.split(/\n+/).map(Xh).filter(Do(qh)).filter(Do($h)).map(pt(/ +/,3)).flatMap(([n,a,t])=>a==="SHORTS"?[]:[{videoId:n,durationSeconds:Pe(a),title:t}])}te("parseVideos",{"empty string"(){A(Ae(""),j,[])},spaces(){A(Ae("  "),j,[])},newlines(){A(Ae(`


`),j,[])},"newlines and spaces"(){A(Ae(` 
 
 
`),j,[])},comments(){A(Ae(`#foo
# bar`),j,[])},"strips spaces before comments"(){A(Ae(`  #foo
  # bar`),j,[])},"parses actual data"(){A(Ae(`
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
      Ga8tNxnHjt4 3:01 Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971
    `),j,[{videoId:"leb645Xu6uo",durationSeconds:654,title:"Captain Murderer - Emlyn Williams"},{videoId:"Ga8tNxnHjt4",durationSeconds:181,title:"Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971"}])},"removes shorts"(){A(Ae(`
      undefined SHORTS blah blah
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
    `),j,[{videoId:"leb645Xu6uo",durationSeconds:654,title:"Captain Murderer - Emlyn Williams"}])}});function qh(e){return e.startsWith("#")}function Pe(e){let n=[1,60,3600,86400],a=e.split(":").map(t=>parseInt(t,10)).reverse();return eg(a,n).map(([t,i])=>t*i).reduce(ng,0)}te("parseDuration",{"0:00"(){A(Pe("0:00"),W,0)},"00:00"(){A(Pe("00:00"),W,0)},"1 second"(){A(Pe("0:01"),W,1)},"10 seconds"(){A(Pe("0:10"),W,10)},"1 minute"(){A(Pe("1:00"),W,60)},"1 minute 10 seconds"(){A(Pe("1:10"),W,70)},"10 minutes 10 seconds"(){A(Pe("10:10"),W,610)},"1 hour"(){A(Pe("1:00:00"),W,3600)},"1 hour 1 second"(){A(Pe("1:00:01"),W,3601)},"10 hours 1 second"(){A(Pe("10:00:01"),W,36001)},"1 day 1 second"(){A(Pe("1:0:00:01"),W,86401)}});function Xh(e){return e.trim()}function $h(e){return e.length===0}var pt=(e,n=Infinity)=>a=>{if(typeof e=="string"&&e.length===0)throw"split(): empty delimiter not supported";let t=0,i=0,r=[],o=a;for(;r.length<n-1&&o.length>0;){let s=o.match(e);if(s==null)break;r.push(o.slice(0,s.index)),o=o.slice(s.index+s[0].length)}return r.push(o),r};te("split",{"empty string"(){A(pt(" ")(""),j,[""])},"no limit"(){A(pt(" ")("a b c"),j,["a","b","c"])},limit(){A(pt(" ",2)("a b c"),j,["a","b c"])},regex(){A(pt(/ +/)("a b   c"),j,["a","b","c"])}});function eg(e,n){let a=[];for(let t=0;t<e.length&&t<n.length;t++)a.push([e[t],n[t]]);return a}function ng(e,n){return e+n}var Ho=(...e)=>e.reduce(ag),Zu=tg(Ho(Ae,e=>({videos:e})))(["BecZdQvjGrY 54:49 In Gowan Ring - Compendium (Full Album)","B3oAx9VmAdA 43:52 In Gowan Ring - Hazel Steps Through A Weathered Home",`
  ...
  `]);te("pipe",{"given one function"(){A(Ho(n=>n+1)(1),W,2)},"given two functions"(){let e=n=>n+1;A(Ho(e,e)(1),W,3)}});function ag(e,n){return(...a)=>n(e(...a))}function tg(e){return n=>n.map(e)}var F1=Ae(`
...
`);var Pi=[Wi("Channel 1",qu.map($u)),Wi("Channel 2",Xu.map($u)),Wi("Channel 3",Zu)];function $u(e){return{videos:[e]}}function ed(e){return C(Un,null,Pi.map(n=>C("button",{key:n.getName(),onClick:()=>e.onChannelSelected(n)},n.getName())))}function nd(){let[e,n]=Oe(+new Date);return Ju(()=>n(+new Date),250),e}function ad(e=""){return{type:"nothing",nextVideoId:e}}function td(e,n){let{state:a,videoId:t,time:i}=n;if(e.type==="nothing")switch(a){case ie.ENDED:case ie.CUED:case ie.UNSTARTED:return e.nextVideoId?t!==e.nextVideoId?[{type:"cue",videoId:e.nextVideoId,timestamp:0}]:[{type:"seek",timestamp:0},{type:"play"}]:[];default:return[]}else{if(a===ie.BUFFERING)return[];let{videoId:r,currentTime:o}=e;if(t!==r)return[{type:"cue",videoId:r,timestamp:o<mt?0:o}];{let s=[];switch(a){case ie.PAUSED:case ie.CUED:case ie.UNSTARTED:t&&s.push({type:"play"})}return i&&ig(i,o)>=mt&&(console.debug("time is off; seeking",i,o),s.push({type:"seek",timestamp:o})),s}}}function ig(e,n){return Math.abs(e-n)}var rg=0;function og(){let[,e]=Oe(0);return()=>e(++rg)}function id(e){let n=og(),a=pa(xu());return Dn(()=>{ju(e).then(t=>{a.current=t,t.addEventListener("onStateChange",i=>{console.debug(gn(),"player onStateChange",ct(i.data),ha(t.getVideoUrl())),n()}),n()})},[e]),a.current}function sg({broadcast:e,player:n}){var t;let a=i=>Y(i,2);return{videoLink:e.type==="video"?{text:e.videoTitle,href:"https://youtube.com/watch?v="+e.videoId}:null,actual:{video:(t=n.videoId)!=null?t:"",playerState:ct(n.state),currentTime:n.time!=null?a(n.time):"-"},scheduled:{video:e.type==="video"?e.videoId:"-",playerState:e.type,currentTime:e.type==="video"?a(e.currentTime):"-"},secondsBehindSchedule:e.type==="video"&&n.time!=null?(e.currentTime-n.time).toFixed(2):"-",timeRemainingInVideo:n.duration!=null&&n.time!=null?a(n.duration-n.time):"-"}}function rd(e){let{broadcast:n,player:a,onClose:t}=e,i=sg({broadcast:n,player:a});return C(Un,null,C("button",{class:"close-button",onClick:t},"close"),C("h1",null,"Culture Machine"),C("p",null,"Mainly tended by"," ",C("a",{href:"https://github.com/benchristel"},"Ben Christel"),"."," ",C("a",{href:"https://github.com/benchristel/tv"},"Source code here"),". Some rights reserved. See the"," ",C("a",{href:"https://www.gnu.org/licenses/gpl-3.0.en.html"},"license"),"."),C("hr",null),C("h2",null,"Video Info"),C("p",{style:{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},"Now playing:"," ",i.videoLink?C("a",{href:i.videoLink.href},i.videoLink.text):"-"),C("table",null,C("thead",null,C("tr",null,C("td",null),C("th",{scope:"col"},"actual"),C("th",{scope:"col"},"scheduled"))),C("tbody",null,C("tr",null,C("th",{scope:"row"},"video"),C("td",null,i.actual.video),C("td",null,i.scheduled.video)),C("tr",null,C("th",{scope:"row"},"player state"),C("td",null,i.actual.playerState),C("td",null,i.scheduled.playerState)),C("tr",null,C("th",{scope:"row"},"current time"),C("td",null,i.actual.currentTime),C("td",null,i.scheduled.currentTime)))),C("p",null,"Seconds behind schedule: ",i.secondsBehindSchedule),C("p",null,"Time remaining in video: ",i.timeRemainingInVideo))}var Fo=class extends Yo{componentDidUpdate(){let{player:n,commands:a}=this.props;a.forEach(t=>{switch(t.type){case"play":n.playVideo();break;case"cue":n.cueVideoById(t.videoId,t.timestamp);break;case"seek":n.seekTo(t.timestamp);break;default:console.error("unexpected video command type",t.type,t)}})}render(){return null}};function od(e){return{state:e.getPlayerState(),videoId:ha(e.getVideoUrl()),time:e.getCurrentTime(),duration:e.getDuration()}}function sd(){let[e,n]=Vu(),[a,t]=Oe(!1),[i,r]=Oe(Pi[0]),o=nd(),s=e?i.getBroadcast(o):ad(),l=Qu(id("player-container")),d=od(l),y=d.state,N=y!==ie.PLAYING,f=td(s,d);return C(lg,{effects:C(Fo,{commands:f,player:l}),screen:C("div",{className:a?"info-pane-open":""},C("div",{className:"player-assembly"},C("div",{id:"player-container"}),N&&C("div",{className:"black-screen"},C(_u,{code:y,channel:i})),!e&&C(ug,{onClick:n})),C("div",{className:"info-pane"},C(rd,{player:d,broadcast:s,onClose:()=>t(!1)})),C("div",{className:"info-pane-close-overlay","aria-hidden":!0,onClick:()=>t(!1)})),controlPanel:C(Un,null,C(ed,{onChannelSelected:I=>{r(I),n()}}),C("button",{className:a?"info-button info-button-info-pane-open":"info-button",onClick:()=>t(!a)},"Info"))})}function lg(e){return C("div",{className:"App"},C("div",{className:"bezel"},C("div",{className:"screen"},e.screen),C("div",{style:{height:"12px"}}),C("div",{className:"controls"},e.controlPanel),e.effects))}function ug(e){return C("button",{id:"start",onClick:e.onClick},"▸ Play")}function ld(){let[e,n]=Oe("");return Dn(()=>{Du(Fu()).then(Ru).then(n).catch(a=>n(a.message))},[]),/fail/i.test(e)?C("div",{className:"TestResults"},C("code",null,C("pre",null,e))):null}Oo(C(sd,null),document.getElementById("app"));Oo(C(ld,null),document.getElementById("test-results"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
