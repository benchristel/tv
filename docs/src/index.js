var kt=(e,n,a)=>new Promise((t,i)=>{var r=l=>{try{s(a.next(l))}catch(d){i(d)}},o=l=>{try{s(a.throw(l))}catch(d){i(d)}},s=l=>l.done?t(l.value):Promise.resolve(l.value).then(r,o);s((a=a.apply(e,n)).next())});function Ve(e,n,a){return a={path:n,exports:{},require:function(t,i){return Id(t,i==null?a.path:i)}},e(a,a.exports),a.exports}function Id(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var zo=Object.getOwnPropertySymbols,Ed=Object.prototype.hasOwnProperty,vd=Object.prototype.propertyIsEnumerable;function Cd(e){if(e==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(e)}function wd(){try{if(!Object.assign)return!1;var e=new String("abc");if(e[5]="de",Object.getOwnPropertyNames(e)[0]==="5")return!1;for(var n={},a=0;a<10;a++)n["_"+String.fromCharCode(a)]=a;var t=Object.getOwnPropertyNames(n).map(function(r){return n[r]});if(t.join("")!=="0123456789")return!1;var i={};return"abcdefghijklmnopqrst".split("").forEach(function(r){i[r]=r}),Object.keys(Object.assign({},i)).join("")==="abcdefghijklmnopqrst"}catch(r){return!1}}var Md=wd()?Object.assign:function(e,n){for(var a,t=Cd(e),i,r=1;r<arguments.length;r++){a=Object(arguments[r]);for(var o in a)Ed.call(a,o)&&(t[o]=a[o]);if(zo){i=zo(a);for(var s=0;s<i.length;s++)vd.call(a,i[s])&&(t[i[s]]=a[i[s]])}}return t},Y=Md;var Od=Ve(function(e,n){var a=60103,t=60106;n.Fragment=60107,n.StrictMode=60108,n.Profiler=60114;var i=60109,r=60110,o=60112;n.Suspense=60113;var s=60115,l=60116;if(typeof Symbol=="function"&&Symbol.for){var d=Symbol.for;a=d("react.element"),t=d("react.portal"),n.Fragment=d("react.fragment"),n.StrictMode=d("react.strict_mode"),n.Profiler=d("react.profiler"),i=d("react.provider"),r=d("react.context"),o=d("react.forward_ref"),n.Suspense=d("react.suspense"),s=d("react.memo"),l=d("react.lazy")}var k=typeof Symbol=="function"&&Symbol.iterator;function N(g){return g===null||typeof g!="object"?null:(g=k&&g[k]||g["@@iterator"],typeof g=="function"?g:null)}function f(g){for(var A="https://reactjs.org/docs/error-decoder.html?invariant="+g,H=1;H<arguments.length;H++)A+="&args[]="+encodeURIComponent(arguments[H]);return"Minified React error #"+g+"; visit "+A+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var C={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},P={};function O(g,A,H){this.props=g,this.context=A,this.refs=P,this.updater=H||C}O.prototype.isReactComponent={},O.prototype.setState=function(g,A){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error(f(85));this.updater.enqueueSetState(this,g,A,"setState")},O.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function c(){}c.prototype=O.prototype;function u(g,A,H){this.props=g,this.context=A,this.refs=P,this.updater=H||C}var h=u.prototype=new c;h.constructor=u,Y(h,O.prototype),h.isPureReactComponent=!0;var m={current:null},p=Object.prototype.hasOwnProperty,G={key:!0,ref:!0,__self:!0,__source:!0};function E(g,A,H){var Q,y={},w=null,W=null;if(A!=null)for(Q in A.ref!==void 0&&(W=A.ref),A.key!==void 0&&(w=""+A.key),A)p.call(A,Q)&&!G.hasOwnProperty(Q)&&(y[Q]=A[Q]);var L=arguments.length-2;if(L===1)y.children=H;else if(1<L){for(var F=Array(L),ee=0;ee<L;ee++)F[ee]=arguments[ee+2];y.children=F}if(g&&g.defaultProps)for(Q in L=g.defaultProps,L)y[Q]===void 0&&(y[Q]=L[Q]);return{$$typeof:a,type:g,key:w,ref:W,props:y,_owner:m.current}}function B(g,A){return{$$typeof:a,type:g.type,key:A,ref:g.ref,props:g.props,_owner:g._owner}}function D(g){return typeof g=="object"&&g!==null&&g.$$typeof===a}function R(g){var A={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(H){return A[H]})}var z=/\/+/g;function ye(g,A){return typeof g=="object"&&g!==null&&g.key!=null?R(""+g.key):A.toString(36)}function Rn(g,A,H,Q,y){var w=typeof g;(w==="undefined"||w==="boolean")&&(g=null);var W=!1;if(g===null)W=!0;else switch(w){case"string":case"number":W=!0;break;case"object":switch(g.$$typeof){case a:case t:W=!0}}if(W)return W=g,y=y(W),g=Q===""?"."+ye(W,0):Q,Array.isArray(y)?(H="",g!=null&&(H=g.replace(z,"$&/")+"/"),Rn(y,A,H,"",function(ee){return ee})):y!=null&&(D(y)&&(y=B(y,H+(!y.key||W&&W.key===y.key?"":(""+y.key).replace(z,"$&/")+"/")+g)),A.push(y)),1;if(W=0,Q=Q===""?".":Q+":",Array.isArray(g))for(var L=0;L<g.length;L++){w=g[L];var F=Q+ye(w,L);W+=Rn(w,A,H,F,y)}else if(F=N(g),typeof F=="function")for(g=F.call(g),L=0;!(w=g.next()).done;)w=w.value,F=Q+ye(w,L++),W+=Rn(w,A,H,F,y);else if(w==="object")throw A=""+g,Error(f(31,A==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":A));return W}function oe(g,A,H){if(g==null)return g;var Q=[],y=0;return Rn(g,Q,"","",function(w){return A.call(H,w,y++)}),Q}function ie(g){if(g._status===-1){var A=g._result;A=A(),g._status=0,g._result=A,A.then(function(H){g._status===0&&(H=H.default,g._status=1,g._result=H)},function(H){g._status===0&&(g._status=2,g._result=H)})}if(g._status===1)return g._result;throw g._result}var pn={current:null};function se(){var g=pn.current;if(g===null)throw Error(f(321));return g}var fn={ReactCurrentDispatcher:pn,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:m,IsSomeRendererActing:{current:!1},assign:Y};n.Children={map:oe,forEach:function(g,A,H){oe(g,function(){A.apply(this,arguments)},H)},count:function(g){var A=0;return oe(g,function(){A++}),A},toArray:function(g){return oe(g,function(A){return A})||[]},only:function(g){if(!D(g))throw Error(f(143));return g}},n.Component=O,n.PureComponent=u,n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=fn,n.cloneElement=function(g,A,H){if(g==null)throw Error(f(267,g));var Q=Y({},g.props),y=g.key,w=g.ref,W=g._owner;if(A!=null){if(A.ref!==void 0&&(w=A.ref,W=m.current),A.key!==void 0&&(y=""+A.key),g.type&&g.type.defaultProps)var L=g.type.defaultProps;for(F in A)p.call(A,F)&&!G.hasOwnProperty(F)&&(Q[F]=A[F]===void 0&&L!==void 0?L[F]:A[F])}var F=arguments.length-2;if(F===1)Q.children=H;else if(1<F){L=Array(F);for(var ee=0;ee<F;ee++)L[ee]=arguments[ee+2];Q.children=L}return{$$typeof:a,type:g.type,key:y,ref:w,props:Q,_owner:W}},n.createContext=function(g,A){return A===void 0&&(A=null),g={$$typeof:r,_calculateChangedBits:A,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider={$$typeof:i,_context:g},g.Consumer=g},n.createElement=E,n.createFactory=function(g){var A=E.bind(null,g);return A.type=g,A},n.createRef=function(){return{current:null}},n.forwardRef=function(g){return{$$typeof:o,render:g}},n.isValidElement=D,n.lazy=function(g){return{$$typeof:l,_payload:{_status:-1,_result:g},_init:ie}},n.memo=function(g,A){return{$$typeof:s,type:g,compare:A===void 0?null:A}},n.useCallback=function(g,A){return se().useCallback(g,A)},n.useContext=function(g,A){return se().useContext(g,A)},n.useDebugValue=function(){},n.useEffect=function(g,A){return se().useEffect(g,A)},n.useImperativeHandle=function(g,A,H){return se().useImperativeHandle(g,A,H)},n.useLayoutEffect=function(g,A){return se().useLayoutEffect(g,A)},n.useMemo=function(g,A){return se().useMemo(g,A)},n.useReducer=function(g,A,H){return se().useReducer(g,A,H)},n.useRef=function(g){return se().useRef(g)},n.useState=function(g){return se().useState(g)},n.version="17.0.2"}),b=Ve(function(e){e.exports=Od});var Rg=b.Children,_o=b.Component,Un=b.Fragment,Dg=b.Profiler,Ug=b.PureComponent,Lg=b.StrictMode,Fg=b.Suspense,Hg=b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,bg=b.cloneElement,Kg=b.createContext,v=b.createElement,Yg=b.createFactory,xg=b.createRef,Qg=b.forwardRef,jg=b.isValidElement,Vg=b.lazy,Jg=b.memo,zg=b.useCallback,_g=b.useContext,qg=b.useDebugValue,Ln=b.useEffect,Zg=b.useImperativeHandle,Xg=b.useLayoutEffect,$g=b.useMemo,em=b.useReducer,ya=b.useRef,Ne=b.useState,nm=b.version;var Bd=Ve(function(e,n){var a,t,i,r;if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;n.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();n.unstable_now=function(){return s.now()-l}}if(typeof window=="undefined"||typeof MessageChannel!="function"){var d=null,k=null,N=function(){if(d!==null)try{var y=n.unstable_now();d(!0,y),d=null}catch(w){throw setTimeout(N,0),w}};a=function(y){d!==null?setTimeout(a,0,y):(d=y,setTimeout(N,0))},t=function(y,w){k=setTimeout(y,w)},i=function(){clearTimeout(k)},n.unstable_shouldYield=function(){return!1},r=n.unstable_forceFrameRate=function(){}}else{var f=window.setTimeout,C=window.clearTimeout;if(typeof console!="undefined"){var P=window.cancelAnimationFrame;typeof window.requestAnimationFrame!="function"&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),typeof P!="function"&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var O=!1,c=null,u=-1,h=5,m=0;n.unstable_shouldYield=function(){return n.unstable_now()>=m},r=function(){},n.unstable_forceFrameRate=function(y){0>y||125<y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):h=0<y?Math.floor(1e3/y):5};var p=new MessageChannel,G=p.port2;p.port1.onmessage=function(){if(c!==null){var y=n.unstable_now();m=y+h;try{c(!0,y)?G.postMessage(null):(O=!1,c=null)}catch(w){throw G.postMessage(null),w}}else O=!1},a=function(y){c=y,O||(O=!0,G.postMessage(null))},t=function(y,w){u=f(function(){y(n.unstable_now())},w)},i=function(){C(u),u=-1}}function E(y,w){var W=y.length;y.push(w);e:for(;;){var L=W-1>>>1,F=y[L];if(F!==void 0&&0<R(F,w))y[L]=w,y[W]=F,W=L;else break e}}function B(y){return y=y[0],y===void 0?null:y}function D(y){var w=y[0];if(w!==void 0){var W=y.pop();if(W!==w){y[0]=W;e:for(var L=0,F=y.length;L<F;){var ee=2*(L+1)-1,Sn=y[ee],Sa=ee+1,Dn=y[Sa];if(Sn!==void 0&&0>R(Sn,W))Dn!==void 0&&0>R(Dn,Sn)?(y[L]=Dn,y[Sa]=W,L=Sa):(y[L]=Sn,y[ee]=W,L=ee);else if(Dn!==void 0&&0>R(Dn,W))y[L]=Dn,y[Sa]=W,L=Sa;else break e}}return w}return null}function R(y,w){var W=y.sortIndex-w.sortIndex;return W!==0?W:y.id-w.id}var z=[],ye=[],Rn=1,oe=null,ie=3,pn=!1,se=!1,fn=!1;function g(y){for(var w=B(ye);w!==null;){if(w.callback===null)D(ye);else if(w.startTime<=y)D(ye),w.sortIndex=w.expirationTime,E(z,w);else break;w=B(ye)}}function A(y){if(fn=!1,g(y),!se)if(B(z)!==null)se=!0,a(H);else{var w=B(ye);w!==null&&t(A,w.startTime-y)}}function H(y,w){se=!1,fn&&(fn=!1,i()),pn=!0;var W=ie;try{for(g(w),oe=B(z);oe!==null&&(!(oe.expirationTime>w)||y&&!n.unstable_shouldYield());){var L=oe.callback;if(typeof L=="function"){oe.callback=null,ie=oe.priorityLevel;var F=L(oe.expirationTime<=w);w=n.unstable_now(),typeof F=="function"?oe.callback=F:oe===B(z)&&D(z),g(w)}else D(z);oe=B(z)}if(oe!==null)var ee=!0;else{var Sn=B(ye);Sn!==null&&t(A,Sn.startTime-w),ee=!1}return ee}finally{oe=null,ie=W,pn=!1}}var Q=r;n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(y){y.callback=null},n.unstable_continueExecution=function(){se||pn||(se=!0,a(H))},n.unstable_getCurrentPriorityLevel=function(){return ie},n.unstable_getFirstCallbackNode=function(){return B(z)},n.unstable_next=function(y){switch(ie){case 1:case 2:case 3:var w=3;break;default:w=ie}var W=ie;ie=w;try{return y()}finally{ie=W}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=Q,n.unstable_runWithPriority=function(y,w){switch(y){case 1:case 2:case 3:case 4:case 5:break;default:y=3}var W=ie;ie=y;try{return w()}finally{ie=W}},n.unstable_scheduleCallback=function(y,w,W){var L=n.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?L+W:L):W=L,y){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=W+F,y={id:Rn++,callback:w,priorityLevel:y,startTime:W,expirationTime:F,sortIndex:-1},W>L?(y.sortIndex=W,E(ye,y),B(z)===null&&y===B(ye)&&(fn?i():fn=!0,t(A,W-L))):(y.sortIndex=F,E(z,y),se||pn||(se=!0,a(H))),y},n.unstable_wrapCallback=function(y){var w=ie;return function(){var W=ie;ie=w;try{return y.apply(this,arguments)}finally{ie=W}}}}),ne=Ve(function(e){e.exports=Bd});function T(e){for(var n="https://reactjs.org/docs/error-decoder.html?invariant="+e,a=1;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!b)throw Error(T(227));var qo=new Set,ka={};function yn(e,n){Fn(e,n),Fn(e+"Capture",n)}function Fn(e,n){for(ka[e]=n,e=0;e<n.length;e++)qo.add(n[e])}var be=!(typeof window=="undefined"||typeof window.document=="undefined"||typeof window.document.createElement=="undefined"),Wd=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,Zo=Object.prototype.hasOwnProperty,Xo={},$o={};function Nd(e){return Zo.call($o,e)?!0:Zo.call(Xo,e)?!1:Wd.test(e)?$o[e]=!0:(Xo[e]=!0,!1)}function Pd(e,n,a,t){if(a!==null&&a.type===0)return!1;switch(typeof n){case"function":case"symbol":return!0;case"boolean":return t?!1:a!==null?!a.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function Gd(e,n,a,t){if(n===null||typeof n=="undefined"||Pd(e,n,a,t))return!0;if(t)return!1;if(a!==null)switch(a.type){case 3:return!n;case 4:return n===!1;case 5:return isNaN(n);case 6:return isNaN(n)||1>n}return!1}function fe(e,n,a,t,i,r,o){this.acceptsBooleans=n===2||n===3||n===4,this.attributeName=t,this.attributeNamespace=i,this.mustUseProperty=a,this.propertyName=e,this.type=n,this.sanitizeURL=r,this.removeEmptyString=o}var le={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){le[e]=new fe(e,0,!1,e,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var n=e[0];le[n]=new fe(n,1,!1,e[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(e){le[e]=new fe(e,2,!1,e.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){le[e]=new fe(e,2,!1,e,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){le[e]=new fe(e,3,!1,e.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(e){le[e]=new fe(e,3,!0,e,null,!1,!1)});["capture","download"].forEach(function(e){le[e]=new fe(e,4,!1,e,null,!1,!1)});["cols","rows","size","span"].forEach(function(e){le[e]=new fe(e,6,!1,e,null,!1,!1)});["rowSpan","start"].forEach(function(e){le[e]=new fe(e,5,!1,e.toLowerCase(),null,!1,!1)});var Ui=/[\-:]([a-z])/g;function Li(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var n=e.replace(Ui,Li);le[n]=new fe(n,1,!1,e,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var n=e.replace(Ui,Li);le[n]=new fe(n,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var n=e.replace(Ui,Li);le[n]=new fe(n,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(e){le[e]=new fe(e,1,!1,e.toLowerCase(),null,!1,!1)});le.xlinkHref=new fe("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(e){le[e]=new fe(e,1,!1,e.toLowerCase(),null,!0,!0)});function Fi(e,n,a,t){var i=le.hasOwnProperty(n)?le[n]:null,r=i!==null?i.type===0:t?!1:!(!(2<n.length)||n[0]!=="o"&&n[0]!=="O"||n[1]!=="n"&&n[1]!=="N");r||(Gd(n,a,i,t)&&(a=null),t||i===null?Nd(n)&&(a===null?e.removeAttribute(n):e.setAttribute(n,""+a)):i.mustUseProperty?e[i.propertyName]=a===null?i.type===3?!1:"":a:(n=i.attributeName,t=i.attributeNamespace,a===null?e.removeAttribute(n):(i=i.type,a=i===3||i===4&&a===!0?"":""+a,t?e.setAttributeNS(t,n,a):e.setAttribute(n,a))))}var kn=b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,Ta=60103,Tn=60106,Je=60107,Hi=60108,Aa=60114,bi=60109,Ki=60110,Tt=60112,Ia=60113,At=60120,It=60115,Yi=60116,xi=60121,Qi=60128,es=60129,ji=60130,Vi=60131;typeof Symbol=="function"&&Symbol.for&&(ae=Symbol.for,Ta=ae("react.element"),Tn=ae("react.portal"),Je=ae("react.fragment"),Hi=ae("react.strict_mode"),Aa=ae("react.profiler"),bi=ae("react.provider"),Ki=ae("react.context"),Tt=ae("react.forward_ref"),Ia=ae("react.suspense"),At=ae("react.suspense_list"),It=ae("react.memo"),Yi=ae("react.lazy"),xi=ae("react.block"),ae("react.scope"),Qi=ae("react.opaque.id"),es=ae("react.debug_trace_mode"),ji=ae("react.offscreen"),Vi=ae("react.legacy_hidden"));var ae,ns=typeof Symbol=="function"&&Symbol.iterator;function Ea(e){return e===null||typeof e!="object"?null:(e=ns&&e[ns]||e["@@iterator"],typeof e=="function"?e:null)}var Ji;function va(e){if(Ji===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Ji=n&&n[1]||""}return`
`+Ji+e}var zi=!1;function Et(e,n){if(!e||zi)return"";zi=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{if(n)if(n=function(){throw Error()},Object.defineProperty(n.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(n,[])}catch(l){var t=l}Reflect.construct(e,[],n)}else{try{n.call()}catch(l){t=l}e.call(n.prototype)}else{try{throw Error()}catch(l){t=l}e()}}catch(l){if(l&&t&&typeof l.stack=="string"){for(var i=l.stack.split(`
`),r=t.stack.split(`
`),o=i.length-1,s=r.length-1;1<=o&&0<=s&&i[o]!==r[s];)s--;for(;1<=o&&0<=s;o--,s--)if(i[o]!==r[s]){if(o!==1||s!==1)do if(o--,s--,0>s||i[o]!==r[s])return`
`+i[o].replace(" at new "," at ");while(1<=o&&0<=s);break}}}finally{zi=!1,Error.prepareStackTrace=a}return(e=e?e.displayName||e.name:"")?va(e):""}function Rd(e){switch(e.tag){case 5:return va(e.type);case 16:return va("Lazy");case 13:return va("Suspense");case 19:return va("SuspenseList");case 0:case 2:case 15:return e=Et(e.type,!1),e;case 11:return e=Et(e.type.render,!1),e;case 22:return e=Et(e.type._render,!1),e;case 1:return e=Et(e.type,!0),e;default:return""}}function Hn(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Je:return"Fragment";case Tn:return"Portal";case Aa:return"Profiler";case Hi:return"StrictMode";case Ia:return"Suspense";case At:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case Ki:return(e.displayName||"Context")+".Consumer";case bi:return(e._context.displayName||"Context")+".Provider";case Tt:var n=e.render;return n=n.displayName||n.name||"",e.displayName||(n!==""?"ForwardRef("+n+")":"ForwardRef");case It:return Hn(e.type);case xi:return Hn(e._render);case Yi:n=e._payload,e=e._init;try{return Hn(e(n))}catch(a){}}return null}function ze(e){switch(typeof e){case"boolean":case"number":case"object":case"string":case"undefined":return e;default:return""}}function as(e){var n=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(n==="checkbox"||n==="radio")}function Dd(e){var n=as(e)?"checked":"value",a=Object.getOwnPropertyDescriptor(e.constructor.prototype,n),t=""+e[n];if(!e.hasOwnProperty(n)&&typeof a!="undefined"&&typeof a.get=="function"&&typeof a.set=="function"){var i=a.get,r=a.set;return Object.defineProperty(e,n,{configurable:!0,get:function(){return i.call(this)},set:function(o){t=""+o,r.call(this,o)}}),Object.defineProperty(e,n,{enumerable:a.enumerable}),{getValue:function(){return t},setValue:function(o){t=""+o},stopTracking:function(){e._valueTracker=null,delete e[n]}}}}function vt(e){e._valueTracker||(e._valueTracker=Dd(e))}function ts(e){if(!e)return!1;var n=e._valueTracker;if(!n)return!0;var a=n.getValue(),t="";return e&&(t=as(e)?e.checked?"true":"false":e.value),e=t,e!==a?(n.setValue(e),!0):!1}function Ct(e){if(e=e||(typeof document!="undefined"?document:void 0),typeof e=="undefined")return null;try{return e.activeElement||e.body}catch(n){return e.body}}function _i(e,n){var a=n.checked;return Y({},n,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:a!=null?a:e._wrapperState.initialChecked})}function is(e,n){var a=n.defaultValue==null?"":n.defaultValue,t=n.checked!=null?n.checked:n.defaultChecked;a=ze(n.value!=null?n.value:a),e._wrapperState={initialChecked:t,initialValue:a,controlled:n.type==="checkbox"||n.type==="radio"?n.checked!=null:n.value!=null}}function rs(e,n){n=n.checked,n!=null&&Fi(e,"checked",n,!1)}function Zi(e,n){rs(e,n);var a=ze(n.value),t=n.type;if(a!=null)t==="number"?(a===0&&e.value===""||e.value!=a)&&(e.value=""+a):e.value!==""+a&&(e.value=""+a);else if(t==="submit"||t==="reset"){e.removeAttribute("value");return}n.hasOwnProperty("value")?qi(e,n.type,a):n.hasOwnProperty("defaultValue")&&qi(e,n.type,ze(n.defaultValue)),n.checked==null&&n.defaultChecked!=null&&(e.defaultChecked=!!n.defaultChecked)}function os(e,n,a){if(n.hasOwnProperty("value")||n.hasOwnProperty("defaultValue")){var t=n.type;if(!(t!=="submit"&&t!=="reset"||n.value!==void 0&&n.value!==null))return;n=""+e._wrapperState.initialValue,a||n===e.value||(e.value=n),e.defaultValue=n}a=e.name,a!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,a!==""&&(e.name=a)}function qi(e,n,a){(n!=="number"||Ct(e.ownerDocument)!==e)&&(a==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+a&&(e.defaultValue=""+a))}function Ud(e){var n="";return b.Children.forEach(e,function(a){a!=null&&(n+=a)}),n}function Xi(e,n){return e=Y({children:void 0},n),(n=Ud(n.children))&&(e.children=n),e}function bn(e,n,a,t){if(e=e.options,n){n={};for(var i=0;i<a.length;i++)n["$"+a[i]]=!0;for(a=0;a<e.length;a++)i=n.hasOwnProperty("$"+e[a].value),e[a].selected!==i&&(e[a].selected=i),i&&t&&(e[a].defaultSelected=!0)}else{for(a=""+ze(a),n=null,i=0;i<e.length;i++){if(e[i].value===a){e[i].selected=!0,t&&(e[i].defaultSelected=!0);return}n!==null||e[i].disabled||(n=e[i])}n!==null&&(n.selected=!0)}}function $i(e,n){if(n.dangerouslySetInnerHTML!=null)throw Error(T(91));return Y({},n,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function ss(e,n){var a=n.value;if(a==null){if(a=n.children,n=n.defaultValue,a!=null){if(n!=null)throw Error(T(92));if(Array.isArray(a)){if(!(1>=a.length))throw Error(T(93));a=a[0]}n=a}n==null&&(n=""),a=n}e._wrapperState={initialValue:ze(a)}}function ls(e,n){var a=ze(n.value),t=ze(n.defaultValue);a!=null&&(a=""+a,a!==e.value&&(e.value=a),n.defaultValue==null&&e.defaultValue!==a&&(e.defaultValue=a)),t!=null&&(e.defaultValue=""+t)}function us(e){var n=e.textContent;n===e._wrapperState.initialValue&&n!==""&&n!==null&&(e.value=n)}var er={html:"http://www.w3.org/1999/xhtml",mathml:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg"};function ds(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function nr(e,n){return e==null||e==="http://www.w3.org/1999/xhtml"?ds(n):e==="http://www.w3.org/2000/svg"&&n==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var wt,hs=function(e){return typeof MSApp!="undefined"&&MSApp.execUnsafeLocalFunction?function(n,a,t,i){MSApp.execUnsafeLocalFunction(function(){return e(n,a,t,i)})}:e}(function(e,n){if(e.namespaceURI!==er.svg||"innerHTML"in e)e.innerHTML=n;else{for(wt=wt||document.createElement("div"),wt.innerHTML="<svg>"+n.valueOf().toString()+"</svg>",n=wt.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;n.firstChild;)e.appendChild(n.firstChild)}});function Ca(e,n){if(n){var a=e.firstChild;if(a&&a===e.lastChild&&a.nodeType===3){a.nodeValue=n;return}}e.textContent=n}var wa={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Ld=["Webkit","ms","Moz","O"];Object.keys(wa).forEach(function(e){Ld.forEach(function(n){n=n+e.charAt(0).toUpperCase()+e.substring(1),wa[n]=wa[e]})});function cs(e,n,a){return n==null||typeof n=="boolean"||n===""?"":a||typeof n!="number"||n===0||wa.hasOwnProperty(e)&&wa[e]?(""+n).trim():n+"px"}function gs(e,n){e=e.style;for(var a in n)if(n.hasOwnProperty(a)){var t=a.indexOf("--")===0,i=cs(a,n[a],t);a==="float"&&(a="cssFloat"),t?e.setProperty(a,i):e[a]=i}}var Fd=Y({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function ar(e,n){if(n){if(Fd[e]&&(n.children!=null||n.dangerouslySetInnerHTML!=null))throw Error(T(137,e));if(n.dangerouslySetInnerHTML!=null){if(n.children!=null)throw Error(T(60));if(!(typeof n.dangerouslySetInnerHTML=="object"&&"__html"in n.dangerouslySetInnerHTML))throw Error(T(61))}if(n.style!=null&&typeof n.style!="object")throw Error(T(62))}}function tr(e,n){if(e.indexOf("-")===-1)return typeof n.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}function ir(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var rr=null,Kn=null,Yn=null;function ms(e){if(e=Ma(e)){if(typeof rr!="function")throw Error(T(280));var n=e.stateNode;n&&(n=Mt(n),rr(e.stateNode,e.type,n))}}function ps(e){Kn?Yn?Yn.push(e):Yn=[e]:Kn=e}function fs(){if(Kn){var e=Kn,n=Yn;if(Yn=Kn=null,ms(e),n)for(e=0;e<n.length;e++)ms(n[e])}}function or(e,n){return e(n)}function Ss(e,n,a,t,i){return e(n,a,t,i)}function sr(){}var ys=or,An=!1,lr=!1;function ur(){(Kn!==null||Yn!==null)&&(sr(),fs())}function Hd(e,n,a){if(lr)return e(n,a);lr=!0;try{return ys(e,n,a)}finally{lr=!1,ur()}}function Oa(e,n){var a=e.stateNode;if(a===null)return null;var t=Mt(a);if(t===null)return null;a=t[n];e:switch(n){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(t=!t.disabled)||(e=e.type,t=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!t;break e;default:e=!1}if(e)return null;if(a&&typeof a!="function")throw Error(T(231,n,typeof a));return a}var dr=!1;if(be)try{xn={},Object.defineProperty(xn,"passive",{get:function(){dr=!0}}),window.addEventListener("test",xn,xn),window.removeEventListener("test",xn,xn)}catch(e){dr=!1}var xn;function bd(e,n,a,t,i,r,o,s,l){var d=Array.prototype.slice.call(arguments,3);try{n.apply(a,d)}catch(k){this.onError(k)}}var Ba=!1,Ot=null,Bt=!1,hr=null,Kd={onError:function(e){Ba=!0,Ot=e}};function Yd(e,n,a,t,i,r,o,s,l){Ba=!1,Ot=null,bd.apply(Kd,arguments)}function xd(e,n,a,t,i,r,o,s,l){if(Yd.apply(this,arguments),Ba){if(Ba){var d=Ot;Ba=!1,Ot=null}else throw Error(T(198));Bt||(Bt=!0,hr=d)}}function In(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&1026)!=0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function ks(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function Ts(e){if(In(e)!==e)throw Error(T(188))}function Qd(e){var n=e.alternate;if(!n){if(n=In(e),n===null)throw Error(T(188));return n!==e?null:e}for(var a=e,t=n;;){var i=a.return;if(i===null)break;var r=i.alternate;if(r===null){if(t=i.return,t!==null){a=t;continue}break}if(i.child===r.child){for(r=i.child;r;){if(r===a)return Ts(i),e;if(r===t)return Ts(i),n;r=r.sibling}throw Error(T(188))}if(a.return!==t.return)a=i,t=r;else{for(var o=!1,s=i.child;s;){if(s===a){o=!0,a=i,t=r;break}if(s===t){o=!0,t=i,a=r;break}s=s.sibling}if(!o){for(s=r.child;s;){if(s===a){o=!0,a=r,t=i;break}if(s===t){o=!0,t=r,a=i;break}s=s.sibling}if(!o)throw Error(T(189))}}if(a.alternate!==t)throw Error(T(190))}if(a.tag!==3)throw Error(T(188));return a.stateNode.current===a?e:n}function As(e){if(e=Qd(e),!e)return null;for(var n=e;;){if(n.tag===5||n.tag===6)return n;if(n.child)n.child.return=n,n=n.child;else{if(n===e)break;for(;!n.sibling;){if(!n.return||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}}return null}function Is(e,n){for(var a=e.alternate;n!==null;){if(n===e||n===a)return!0;n=n.return}return!1}var Es,cr,vs,Cs,gr=!1,Re=[],_e=null,qe=null,Ze=null,Wa=new Map,Na=new Map,Pa=[],ws="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function mr(e,n,a,t,i){return{blockedOn:e,domEventName:n,eventSystemFlags:a|16,nativeEvent:i,targetContainers:[t]}}function Ms(e,n){switch(e){case"focusin":case"focusout":_e=null;break;case"dragenter":case"dragleave":qe=null;break;case"mouseover":case"mouseout":Ze=null;break;case"pointerover":case"pointerout":Wa.delete(n.pointerId);break;case"gotpointercapture":case"lostpointercapture":Na.delete(n.pointerId)}}function Ga(e,n,a,t,i,r){return e===null||e.nativeEvent!==r?(e=mr(n,a,t,i,r),n!==null&&(n=Ma(n),n!==null&&cr(n)),e):(e.eventSystemFlags|=t,n=e.targetContainers,i!==null&&n.indexOf(i)===-1&&n.push(i),e)}function jd(e,n,a,t,i){switch(n){case"focusin":return _e=Ga(_e,e,n,a,t,i),!0;case"dragenter":return qe=Ga(qe,e,n,a,t,i),!0;case"mouseover":return Ze=Ga(Ze,e,n,a,t,i),!0;case"pointerover":var r=i.pointerId;return Wa.set(r,Ga(Wa.get(r)||null,e,n,a,t,i)),!0;case"gotpointercapture":return r=i.pointerId,Na.set(r,Ga(Na.get(r)||null,e,n,a,t,i)),!0}return!1}function Vd(e){var n=En(e.target);if(n!==null){var a=In(n);if(a!==null){if(n=a.tag,n===13){if(n=ks(a),n!==null){e.blockedOn=n,Cs(e.lanePriority,function(){ne.unstable_runWithPriority(e.priority,function(){vs(a)})});return}}else if(n===3&&a.stateNode.hydrate){e.blockedOn=a.tag===3?a.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Wt(e){if(e.blockedOn!==null)return!1;for(var n=e.targetContainers;0<n.length;){var a=pr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null)return n=Ma(a),n!==null&&cr(n),e.blockedOn=a,!1;n.shift()}return!0}function Os(e,n,a){Wt(e)&&a.delete(n)}function Jd(){for(gr=!1;0<Re.length;){var e=Re[0];if(e.blockedOn!==null){e=Ma(e.blockedOn),e!==null&&Es(e);break}for(var n=e.targetContainers;0<n.length;){var a=pr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null){e.blockedOn=a;break}n.shift()}e.blockedOn===null&&Re.shift()}_e!==null&&Wt(_e)&&(_e=null),qe!==null&&Wt(qe)&&(qe=null),Ze!==null&&Wt(Ze)&&(Ze=null),Wa.forEach(Os),Na.forEach(Os)}function Ra(e,n){e.blockedOn===n&&(e.blockedOn=null,gr||(gr=!0,ne.unstable_scheduleCallback(ne.unstable_NormalPriority,Jd)))}function Bs(e){function n(i){return Ra(i,e)}if(0<Re.length){Ra(Re[0],e);for(var a=1;a<Re.length;a++){var t=Re[a];t.blockedOn===e&&(t.blockedOn=null)}}for(_e!==null&&Ra(_e,e),qe!==null&&Ra(qe,e),Ze!==null&&Ra(Ze,e),Wa.forEach(n),Na.forEach(n),a=0;a<Pa.length;a++)t=Pa[a],t.blockedOn===e&&(t.blockedOn=null);for(;0<Pa.length&&(a=Pa[0],a.blockedOn===null);)Vd(a),a.blockedOn===null&&Pa.shift()}function Nt(e,n){var a={};return a[e.toLowerCase()]=n.toLowerCase(),a["Webkit"+e]="webkit"+n,a["Moz"+e]="moz"+n,a}var Qn={animationend:Nt("Animation","AnimationEnd"),animationiteration:Nt("Animation","AnimationIteration"),animationstart:Nt("Animation","AnimationStart"),transitionend:Nt("Transition","TransitionEnd")},fr={},Ws={};be&&(Ws=document.createElement("div").style,"AnimationEvent"in window||(delete Qn.animationend.animation,delete Qn.animationiteration.animation,delete Qn.animationstart.animation),"TransitionEvent"in window||delete Qn.transitionend.transition);function Pt(e){if(fr[e])return fr[e];if(!Qn[e])return e;var n=Qn[e],a;for(a in n)if(n.hasOwnProperty(a)&&a in Ws)return fr[e]=n[a];return e}var Ns=Pt("animationend"),Ps=Pt("animationiteration"),Gs=Pt("animationstart"),Rs=Pt("transitionend"),Ds=new Map,Sr=new Map,zd=["abort","abort",Ns,"animationEnd",Ps,"animationIteration",Gs,"animationStart","canplay","canPlay","canplaythrough","canPlayThrough","durationchange","durationChange","emptied","emptied","encrypted","encrypted","ended","ended","error","error","gotpointercapture","gotPointerCapture","load","load","loadeddata","loadedData","loadedmetadata","loadedMetadata","loadstart","loadStart","lostpointercapture","lostPointerCapture","playing","playing","progress","progress","seeking","seeking","stalled","stalled","suspend","suspend","timeupdate","timeUpdate",Rs,"transitionEnd","waiting","waiting"];function yr(e,n){for(var a=0;a<e.length;a+=2){var t=e[a],i=e[a+1];i="on"+(i[0].toUpperCase()+i.slice(1)),Sr.set(t,n),Ds.set(t,i),yn(i,[t])}}var _d=ne.unstable_now;_d();var j=8;function jn(e){if((1&e)!=0)return j=15,1;if((2&e)!=0)return j=14,2;if((4&e)!=0)return j=13,4;var n=24&e;return n!==0?(j=12,n):(e&32)!=0?(j=11,32):(n=192&e,n!==0?(j=10,n):(e&256)!=0?(j=9,256):(n=3584&e,n!==0?(j=8,n):(e&4096)!=0?(j=7,4096):(n=4186112&e,n!==0?(j=6,n):(n=62914560&e,n!==0?(j=5,n):e&67108864?(j=4,67108864):(e&134217728)!=0?(j=3,134217728):(n=805306368&e,n!==0?(j=2,n):(1073741824&e)!=0?(j=1,1073741824):(j=8,e))))))}function qd(e){switch(e){case 99:return 15;case 98:return 10;case 97:case 96:return 8;case 95:return 2;default:return 0}}function Zd(e){switch(e){case 15:case 14:return 99;case 13:case 12:case 11:case 10:return 98;case 9:case 8:case 7:case 6:case 4:case 5:return 97;case 3:case 2:case 1:return 95;case 0:return 90;default:throw Error(T(358,e))}}function Da(e,n){var a=e.pendingLanes;if(a===0)return j=0;var t=0,i=0,r=e.expiredLanes,o=e.suspendedLanes,s=e.pingedLanes;if(r!==0)t=r,i=j=15;else if(r=a&134217727,r!==0){var l=r&~o;l!==0?(t=jn(l),i=j):(s&=r,s!==0&&(t=jn(s),i=j))}else r=a&~o,r!==0?(t=jn(r),i=j):s!==0&&(t=jn(s),i=j);if(t===0)return 0;if(t=31-Xe(t),t=a&((0>t?0:1<<t)<<1)-1,n!==0&&n!==t&&(n&o)==0){if(jn(n),i<=j)return n;j=i}if(n=e.entangledLanes,n!==0)for(e=e.entanglements,n&=t;0<n;)a=31-Xe(n),i=1<<a,t|=e[a],n&=~i;return t}function Us(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function Gt(e,n){switch(e){case 15:return 1;case 14:return 2;case 12:return e=Vn(24&~n),e===0?Gt(10,n):e;case 10:return e=Vn(192&~n),e===0?Gt(8,n):e;case 8:return e=Vn(3584&~n),e===0&&(e=Vn(4186112&~n),e===0&&(e=512)),e;case 2:return n=Vn(805306368&~n),n===0&&(n=268435456),n}throw Error(T(358,e))}function Vn(e){return e&-e}function kr(e){for(var n=[],a=0;31>a;a++)n.push(e);return n}function Rt(e,n,a){e.pendingLanes|=n;var t=n-1;e.suspendedLanes&=t,e.pingedLanes&=t,e=e.eventTimes,n=31-Xe(n),e[n]=a}var Xe=Math.clz32?Math.clz32:Xd,$d=Math.log,eh=Math.LN2;function Xd(e){return e===0?32:31-($d(e)/eh|0)|0}var nh=ne.unstable_UserBlockingPriority,ah=ne.unstable_runWithPriority,Dt=!0;function th(e,n,a,t){An||sr();var i=Tr,r=An;An=!0;try{Ss(i,e,n,a,t)}finally{(An=r)||ur()}}function ih(e,n,a,t){ah(nh,Tr.bind(null,e,n,a,t))}function Tr(e,n,a,t){if(Dt){var i;if((i=(n&4)==0)&&0<Re.length&&-1<ws.indexOf(e))e=mr(null,e,n,a,t),Re.push(e);else{var r=pr(e,n,a,t);if(r===null)i&&Ms(e,t);else{if(i){if(-1<ws.indexOf(e)){e=mr(r,e,n,a,t),Re.push(e);return}if(jd(r,e,n,a,t))return;Ms(e,t)}Ls(e,n,t,null,a)}}}}function pr(e,n,a,t){var i=ir(t);if(i=En(i),i!==null){var r=In(i);if(r===null)i=null;else{var o=r.tag;if(o===13){if(i=ks(r),i!==null)return i;i=null}else if(o===3){if(r.stateNode.hydrate)return r.tag===3?r.stateNode.containerInfo:null;i=null}else r!==i&&(i=null)}}return Ls(e,n,t,i,a),null}var $e=null,Ar=null,Ut=null;function Fs(){if(Ut)return Ut;var e,n=Ar,a=n.length,t,i="value"in $e?$e.value:$e.textContent,r=i.length;for(e=0;e<a&&n[e]===i[e];e++);var o=a-e;for(t=1;t<=o&&n[a-t]===i[r-t];t++);return Ut=i.slice(e,1<t?1-t:void 0)}function Lt(e){var n=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&n===13&&(e=13)):e=n,e===10&&(e=13),32<=e||e===13?e:0}function Ft(){return!0}function Hs(){return!1}function Ee(e){function n(a,t,i,r,o){this._reactName=a,this._targetInst=i,this.type=t,this.nativeEvent=r,this.target=o,this.currentTarget=null;for(var s in e)e.hasOwnProperty(s)&&(a=e[s],this[s]=a?a(r):r[s]);return this.isDefaultPrevented=(r.defaultPrevented!=null?r.defaultPrevented:r.returnValue===!1)?Ft:Hs,this.isPropagationStopped=Hs,this}return Y(n.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():typeof a.returnValue!="unknown"&&(a.returnValue=!1),this.isDefaultPrevented=Ft)},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():typeof a.cancelBubble!="unknown"&&(a.cancelBubble=!0),this.isPropagationStopped=Ft)},persist:function(){},isPersistent:Ft}),n}var Jn={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Ir=Ee(Jn),Ua=Y({},Jn,{view:0,detail:0}),rh=Ee(Ua),Er,vr,La,Ht=Y({},Ua,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Cr,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==La&&(La&&e.type==="mousemove"?(Er=e.screenX-La.screenX,vr=e.screenY-La.screenY):vr=Er=0,La=e),Er)},movementY:function(e){return"movementY"in e?e.movementY:vr}}),bs=Ee(Ht),oh=Y({},Ht,{dataTransfer:0}),sh=Ee(oh),lh=Y({},Ua,{relatedTarget:0}),wr=Ee(lh),uh=Y({},Jn,{animationName:0,elapsedTime:0,pseudoElement:0}),dh=Ee(uh),hh=Y({},Jn,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),ch=Ee(hh),gh=Y({},Jn,{data:0}),Ks=Ee(gh),mh={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},ph={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},fh={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function Sh(e){var n=this.nativeEvent;return n.getModifierState?n.getModifierState(e):(e=fh[e])?!!n[e]:!1}function Cr(){return Sh}var yh=Y({},Ua,{key:function(e){if(e.key){var n=mh[e.key]||e.key;if(n!=="Unidentified")return n}return e.type==="keypress"?(e=Lt(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?ph[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Cr,charCode:function(e){return e.type==="keypress"?Lt(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Lt(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),kh=Ee(yh),Th=Y({},Ht,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),Ys=Ee(Th),Ah=Y({},Ua,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Cr}),Ih=Ee(Ah),Eh=Y({},Jn,{propertyName:0,elapsedTime:0,pseudoElement:0}),vh=Ee(Eh),Ch=Y({},Ht,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),wh=Ee(Ch),Mh=[9,13,27,32],Mr=be&&"CompositionEvent"in window,Fa=null;be&&"documentMode"in document&&(Fa=document.documentMode);var Oh=be&&"TextEvent"in window&&!Fa,xs=be&&(!Mr||Fa&&8<Fa&&11>=Fa),Qs=String.fromCharCode(32),js=!1;function Vs(e,n){switch(e){case"keyup":return Mh.indexOf(n.keyCode)!==-1;case"keydown":return n.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function Js(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var zn=!1;function Bh(e,n){switch(e){case"compositionend":return Js(n);case"keypress":return n.which!==32?null:(js=!0,Qs);case"textInput":return e=n.data,e===Qs&&js?null:e;default:return null}}function Wh(e,n){if(zn)return e==="compositionend"||!Mr&&Vs(e,n)?(e=Fs(),Ut=Ar=$e=null,zn=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(n.ctrlKey||n.altKey||n.metaKey)||n.ctrlKey&&n.altKey){if(n.char&&1<n.char.length)return n.char;if(n.which)return String.fromCharCode(n.which)}return null;case"compositionend":return xs&&n.locale!=="ko"?null:n.data;default:return null}}var Nh={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function zs(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n==="input"?!!Nh[e.type]:n==="textarea"}function _s(e,n,a,t){ps(t),n=bt(n,"onChange"),0<n.length&&(a=new Ir("onChange","change",null,a,t),e.push({event:a,listeners:n}))}var Ha=null,ba=null;function Ph(e){qs(e,0)}function Kt(e){var n=_n(e);if(ts(n))return e}function Gh(e,n){if(e==="change")return n}var Zs=!1;be&&(be?(xt="oninput"in document,xt||(Or=document.createElement("div"),Or.setAttribute("oninput","return;"),xt=typeof Or.oninput=="function"),Yt=xt):Yt=!1,Zs=Yt&&(!document.documentMode||9<document.documentMode));var Yt,xt,Or;function $s(){Ha&&(Ha.detachEvent("onpropertychange",Xs),ba=Ha=null)}function Xs(e){if(e.propertyName==="value"&&Kt(ba)){var n=[];if(_s(n,ba,e,ir(e)),e=Ph,An)e(n);else{An=!0;try{or(e,n)}finally{An=!1,ur()}}}}function Rh(e,n,a){e==="focusin"?($s(),Ha=n,ba=a,Ha.attachEvent("onpropertychange",Xs)):e==="focusout"&&$s()}function Dh(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return Kt(ba)}function Uh(e,n){if(e==="click")return Kt(n)}function Lh(e,n){if(e==="input"||e==="change")return Kt(n)}function Fh(e,n){return e===n&&(e!==0||1/e==1/n)||e!==e&&n!==n}var Ce=typeof Object.is=="function"?Object.is:Fh,Hh=Object.prototype.hasOwnProperty;function Ka(e,n){if(Ce(e,n))return!0;if(typeof e!="object"||e===null||typeof n!="object"||n===null)return!1;var a=Object.keys(e),t=Object.keys(n);if(a.length!==t.length)return!1;for(t=0;t<a.length;t++)if(!Hh.call(n,a[t])||!Ce(e[a[t]],n[a[t]]))return!1;return!0}function el(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function nl(e,n){var a=el(e);e=0;for(var t;a;){if(a.nodeType===3){if(t=e+a.textContent.length,e<=n&&t>=n)return{node:a,offset:n-e};e=t}e:{for(;a;){if(a.nextSibling){a=a.nextSibling;break e}a=a.parentNode}a=void 0}a=el(a)}}function al(e,n){return e&&n?e===n?!0:e&&e.nodeType===3?!1:n&&n.nodeType===3?al(e,n.parentNode):"contains"in e?e.contains(n):e.compareDocumentPosition?!!(e.compareDocumentPosition(n)&16):!1:!1}function tl(){for(var e=window,n=Ct();n instanceof e.HTMLIFrameElement;){try{var a=typeof n.contentWindow.location.href=="string"}catch(t){a=!1}if(a)e=n.contentWindow;else break;n=Ct(e.document)}return n}function Br(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n&&(n==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||n==="textarea"||e.contentEditable==="true")}var bh=be&&"documentMode"in document&&11>=document.documentMode,qn=null,Wr=null,Ya=null,Nr=!1;function il(e,n,a){var t=a.window===a?a.document:a.nodeType===9?a:a.ownerDocument;Nr||qn==null||qn!==Ct(t)||(t=qn,"selectionStart"in t&&Br(t)?t={start:t.selectionStart,end:t.selectionEnd}:(t=(t.ownerDocument&&t.ownerDocument.defaultView||window).getSelection(),t={anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}),Ya&&Ka(Ya,t)||(Ya=t,t=bt(Wr,"onSelect"),0<t.length&&(n=new Ir("onSelect","select",null,n,a),e.push({event:n,listeners:t}),n.target=qn)))}yr("cancel cancel click click close close contextmenu contextMenu copy copy cut cut auxclick auxClick dblclick doubleClick dragend dragEnd dragstart dragStart drop drop focusin focus focusout blur input input invalid invalid keydown keyDown keypress keyPress keyup keyUp mousedown mouseDown mouseup mouseUp paste paste pause pause play play pointercancel pointerCancel pointerdown pointerDown pointerup pointerUp ratechange rateChange reset reset seeked seeked submit submit touchcancel touchCancel touchend touchEnd touchstart touchStart volumechange volumeChange".split(" "),0);yr("drag drag dragenter dragEnter dragexit dragExit dragleave dragLeave dragover dragOver mousemove mouseMove mouseout mouseOut mouseover mouseOver pointermove pointerMove pointerout pointerOut pointerover pointerOver scroll scroll toggle toggle touchmove touchMove wheel wheel".split(" "),1);yr(zd,2);for(var rl="change selectionchange textInput compositionstart compositionend compositionupdate".split(" "),Pr=0;Pr<rl.length;Pr++)Sr.set(rl[Pr],0);Fn("onMouseEnter",["mouseout","mouseover"]);Fn("onMouseLeave",["mouseout","mouseover"]);Fn("onPointerEnter",["pointerout","pointerover"]);Fn("onPointerLeave",["pointerout","pointerover"]);yn("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));yn("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));yn("onBeforeInput",["compositionend","keypress","textInput","paste"]);yn("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));yn("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));yn("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var xa="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),ol=new Set("cancel close invalid load scroll toggle".split(" ").concat(xa));function sl(e,n,a){var t=e.type||"unknown-event";e.currentTarget=a,xd(t,n,void 0,e),e.currentTarget=null}function qs(e,n){n=(n&4)!=0;for(var a=0;a<e.length;a++){var t=e[a],i=t.event;t=t.listeners;e:{var r=void 0;if(n)for(var o=t.length-1;0<=o;o--){var s=t[o],l=s.instance,d=s.currentTarget;if(s=s.listener,l!==r&&i.isPropagationStopped())break e;sl(i,s,d),r=l}else for(o=0;o<t.length;o++){if(s=t[o],l=s.instance,d=s.currentTarget,s=s.listener,l!==r&&i.isPropagationStopped())break e;sl(i,s,d),r=l}}}if(Bt)throw e=hr,Bt=!1,hr=null,e}function V(e,n){var a=ul(n),t=e+"__bubble";a.has(t)||(ll(n,e,2,!1),a.add(t))}var dl="_reactListening"+Math.random().toString(36).slice(2);function cl(e){e[dl]||(e[dl]=!0,qo.forEach(function(n){ol.has(n)||hl(n,!1,e,null),hl(n,!0,e,null)}))}function hl(e,n,a,t){var i=4<arguments.length&&arguments[4]!==void 0?arguments[4]:0,r=a;if(e==="selectionchange"&&a.nodeType!==9&&(r=a.ownerDocument),t!==null&&!n&&ol.has(e)){if(e!=="scroll")return;i|=2,r=t}var o=ul(r),s=e+"__"+(n?"capture":"bubble");o.has(s)||(n&&(i|=4),ll(r,e,i,n),o.add(s))}function ll(e,n,a,t){var i=Sr.get(n);switch(i===void 0?2:i){case 0:i=th;break;case 1:i=ih;break;default:i=Tr}a=i.bind(null,n,a,e),i=void 0,!dr||n!=="touchstart"&&n!=="touchmove"&&n!=="wheel"||(i=!0),t?i!==void 0?e.addEventListener(n,a,{capture:!0,passive:i}):e.addEventListener(n,a,!0):i!==void 0?e.addEventListener(n,a,{passive:i}):e.addEventListener(n,a,!1)}function Ls(e,n,a,t,i){var r=t;if((n&1)==0&&(n&2)==0&&t!==null)e:for(;;){if(t===null)return;var o=t.tag;if(o===3||o===4){var s=t.stateNode.containerInfo;if(s===i||s.nodeType===8&&s.parentNode===i)break;if(o===4)for(o=t.return;o!==null;){var l=o.tag;if((l===3||l===4)&&(l=o.stateNode.containerInfo,l===i||l.nodeType===8&&l.parentNode===i))return;o=o.return}for(;s!==null;){if(o=En(s),o===null)return;if(l=o.tag,l===5||l===6){t=r=o;continue e}s=s.parentNode}}t=t.return}Hd(function(){var d=r,k=ir(a),N=[];e:{var f=Ds.get(e);if(f!==void 0){var C=Ir,P=e;switch(e){case"keypress":if(Lt(a)===0)break e;case"keydown":case"keyup":C=kh;break;case"focusin":P="focus",C=wr;break;case"focusout":P="blur",C=wr;break;case"beforeblur":case"afterblur":C=wr;break;case"click":if(a.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":C=bs;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":C=sh;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":C=Ih;break;case Ns:case Ps:case Gs:C=dh;break;case Rs:C=vh;break;case"scroll":C=rh;break;case"wheel":C=wh;break;case"copy":case"cut":case"paste":C=ch;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":C=Ys}var O=(n&4)!=0,c=!O&&e==="scroll",u=O?f!==null?f+"Capture":null:f;O=[];for(var h=d,m;h!==null;){m=h;var p=m.stateNode;if(m.tag===5&&p!==null&&(m=p,u!==null&&(p=Oa(h,u),p!=null&&O.push(Qa(h,p,m)))),c)break;h=h.return}0<O.length&&(f=new C(f,P,null,a,k),N.push({event:f,listeners:O}))}}if((n&7)==0){e:{if(f=e==="mouseover"||e==="pointerover",C=e==="mouseout"||e==="pointerout",f&&(n&16)==0&&(P=a.relatedTarget||a.fromElement)&&(En(P)||P[Xn]))break e;if((C||f)&&(f=k.window===k?k:(f=k.ownerDocument)?f.defaultView||f.parentWindow:window,C?(P=a.relatedTarget||a.toElement,C=d,P=P?En(P):null,P!==null&&(c=In(P),P!==c||P.tag!==5&&P.tag!==6)&&(P=null)):(C=null,P=d),C!==P)){if(O=bs,p="onMouseLeave",u="onMouseEnter",h="mouse",(e==="pointerout"||e==="pointerover")&&(O=Ys,p="onPointerLeave",u="onPointerEnter",h="pointer"),c=C==null?f:_n(C),m=P==null?f:_n(P),f=new O(p,h+"leave",C,a,k),f.target=c,f.relatedTarget=m,p=null,En(k)===d&&(O=new O(u,h+"enter",P,a,k),O.target=m,O.relatedTarget=c,p=O),c=p,C&&P)n:{for(O=C,u=P,h=0,m=O;m;m=Zn(m))h++;for(m=0,p=u;p;p=Zn(p))m++;for(;0<h-m;)O=Zn(O),h--;for(;0<m-h;)u=Zn(u),m--;for(;h--;){if(O===u||u!==null&&O===u.alternate)break n;O=Zn(O),u=Zn(u)}O=null}else O=null;C!==null&&gl(N,f,C,O,!1),P!==null&&c!==null&&gl(N,c,P,O,!0)}}e:{if(f=d?_n(d):window,C=f.nodeName&&f.nodeName.toLowerCase(),C==="select"||C==="input"&&f.type==="file")var G=Gh;else if(zs(f))if(Zs)G=Lh;else{G=Dh;var E=Rh}else(C=f.nodeName)&&C.toLowerCase()==="input"&&(f.type==="checkbox"||f.type==="radio")&&(G=Uh);if(G&&(G=G(e,d))){_s(N,G,a,k);break e}E&&E(e,f,d),e==="focusout"&&(E=f._wrapperState)&&E.controlled&&f.type==="number"&&qi(f,"number",f.value)}switch(E=d?_n(d):window,e){case"focusin":(zs(E)||E.contentEditable==="true")&&(qn=E,Wr=d,Ya=null);break;case"focusout":Ya=Wr=qn=null;break;case"mousedown":Nr=!0;break;case"contextmenu":case"mouseup":case"dragend":Nr=!1,il(N,a,k);break;case"selectionchange":if(bh)break;case"keydown":case"keyup":il(N,a,k)}var B;if(Mr)e:{switch(e){case"compositionstart":var D="onCompositionStart";break e;case"compositionend":D="onCompositionEnd";break e;case"compositionupdate":D="onCompositionUpdate";break e}D=void 0}else zn?Vs(e,a)&&(D="onCompositionEnd"):e==="keydown"&&a.keyCode===229&&(D="onCompositionStart");D&&(xs&&a.locale!=="ko"&&(zn||D!=="onCompositionStart"?D==="onCompositionEnd"&&zn&&(B=Fs()):($e=k,Ar="value"in $e?$e.value:$e.textContent,zn=!0)),E=bt(d,D),0<E.length&&(D=new Ks(D,e,null,a,k),N.push({event:D,listeners:E}),B?D.data=B:(B=Js(a),B!==null&&(D.data=B)))),(B=Oh?Bh(e,a):Wh(e,a))&&(d=bt(d,"onBeforeInput"),0<d.length&&(k=new Ks("onBeforeInput","beforeinput",null,a,k),N.push({event:k,listeners:d}),k.data=B))}qs(N,n)})}function Qa(e,n,a){return{instance:e,listener:n,currentTarget:a}}function bt(e,n){for(var a=n+"Capture",t=[];e!==null;){var i=e,r=i.stateNode;i.tag===5&&r!==null&&(i=r,r=Oa(e,a),r!=null&&t.unshift(Qa(e,r,i)),r=Oa(e,n),r!=null&&t.push(Qa(e,r,i))),e=e.return}return t}function Zn(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function gl(e,n,a,t,i){for(var r=n._reactName,o=[];a!==null&&a!==t;){var s=a,l=s.alternate,d=s.stateNode;if(l!==null&&l===t)break;s.tag===5&&d!==null&&(s=d,i?(l=Oa(a,r),l!=null&&o.unshift(Qa(a,l,s))):i||(l=Oa(a,r),l!=null&&o.push(Qa(a,l,s)))),a=a.return}o.length!==0&&e.push({event:n,listeners:o})}function Qt(){}var Gr=null,Rr=null;function ml(e,n){switch(e){case"button":case"input":case"select":case"textarea":return!!n.autoFocus}return!1}function Dr(e,n){return e==="textarea"||e==="option"||e==="noscript"||typeof n.children=="string"||typeof n.children=="number"||typeof n.dangerouslySetInnerHTML=="object"&&n.dangerouslySetInnerHTML!==null&&n.dangerouslySetInnerHTML.__html!=null}var pl=typeof setTimeout=="function"?setTimeout:void 0,Kh=typeof clearTimeout=="function"?clearTimeout:void 0;function Ur(e){e.nodeType===1?e.textContent="":e.nodeType===9&&(e=e.body,e!=null&&(e.textContent=""))}function $n(e){for(;e!=null;e=e.nextSibling){var n=e.nodeType;if(n===1||n===3)break}return e}function fl(e){e=e.previousSibling;for(var n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="$"||a==="$!"||a==="$?"){if(n===0)return e;n--}else a==="/$"&&n++}e=e.previousSibling}return null}var Lr=0;function Yh(e){return{$$typeof:Qi,toString:e,valueOf:e}}var jt=Math.random().toString(36).slice(2),en="__reactFiber$"+jt,Vt="__reactProps$"+jt,Xn="__reactContainer$"+jt,Sl="__reactEvents$"+jt;function En(e){var n=e[en];if(n)return n;for(var a=e.parentNode;a;){if(n=a[Xn]||a[en]){if(a=n.alternate,n.child!==null||a!==null&&a.child!==null)for(e=fl(e);e!==null;){if(a=e[en])return a;e=fl(e)}return n}e=a,a=e.parentNode}return null}function Ma(e){return e=e[en]||e[Xn],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function _n(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(T(33))}function Mt(e){return e[Vt]||null}function ul(e){var n=e[Sl];return n===void 0&&(n=e[Sl]=new Set),n}var Fr=[],ea=-1;function nn(e){return{current:e}}function J(e){0>ea||(e.current=Fr[ea],Fr[ea]=null,ea--)}function _(e,n){ea++,Fr[ea]=e.current,e.current=n}var an={},ce=nn(an),ke=nn(!1),vn=an;function na(e,n){var a=e.type.contextTypes;if(!a)return an;var t=e.stateNode;if(t&&t.__reactInternalMemoizedUnmaskedChildContext===n)return t.__reactInternalMemoizedMaskedChildContext;var i={},r;for(r in a)i[r]=n[r];return t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=i),i}function Te(e){return e=e.childContextTypes,e!=null}function Jt(){J(ke),J(ce)}function yl(e,n,a){if(ce.current!==an)throw Error(T(168));_(ce,n),_(ke,a)}function kl(e,n,a){var t=e.stateNode;if(e=n.childContextTypes,typeof t.getChildContext!="function")return a;t=t.getChildContext();for(var i in t)if(!(i in e))throw Error(T(108,Hn(n)||"Unknown",i));return Y({},a,t)}function zt(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||an,vn=ce.current,_(ce,e),_(ke,ke.current),!0}function Tl(e,n,a){var t=e.stateNode;if(!t)throw Error(T(169));a?(e=kl(e,n,vn),t.__reactInternalMemoizedMergedChildContext=e,J(ke),J(ce),_(ce,e)):J(ke),_(ke,a)}var Hr=null,Cn=null,xh=ne.unstable_runWithPriority,br=ne.unstable_scheduleCallback,Kr=ne.unstable_cancelCallback,Qh=ne.unstable_shouldYield,Al=ne.unstable_requestPaint,Yr=ne.unstable_now,jh=ne.unstable_getCurrentPriorityLevel,_t=ne.unstable_ImmediatePriority,Il=ne.unstable_UserBlockingPriority,El=ne.unstable_NormalPriority,vl=ne.unstable_LowPriority,Cl=ne.unstable_IdlePriority,xr={},Vh=Al!==void 0?Al:function(){},Ke=null,qt=null,Qr=!1,wl=Yr(),ge=1e4>wl?Yr:function(){return Yr()-wl};function aa(){switch(jh()){case _t:return 99;case Il:return 98;case El:return 97;case vl:return 96;case Cl:return 95;default:throw Error(T(332))}}function Ml(e){switch(e){case 99:return _t;case 98:return Il;case 97:return El;case 96:return vl;case 95:return Cl;default:throw Error(T(332))}}function wn(e,n){return e=Ml(e),xh(e,n)}function ja(e,n,a){return e=Ml(e),br(e,n,a)}function De(){if(qt!==null){var e=qt;qt=null,Kr(e)}Ol()}function Ol(){if(!Qr&&Ke!==null){Qr=!0;var e=0;try{var n=Ke;wn(99,function(){for(;e<n.length;e++){var a=n[e];do a=a(!0);while(a!==null)}}),Ke=null}catch(a){throw Ke!==null&&(Ke=Ke.slice(e+1)),br(_t,De),a}finally{Qr=!1}}}var Jh=kn.ReactCurrentBatchConfig;function Pe(e,n){if(e&&e.defaultProps){n=Y({},n),e=e.defaultProps;for(var a in e)n[a]===void 0&&(n[a]=e[a]);return n}return n}var Zt=nn(null),Xt=null,ta=null,$t=null;function jr(){$t=ta=Xt=null}function Vr(e){var n=Zt.current;J(Zt),e.type._context._currentValue=n}function Bl(e,n){for(;e!==null;){var a=e.alternate;if((e.childLanes&n)===n){if(a===null||(a.childLanes&n)===n)break;a.childLanes|=n}else e.childLanes|=n,a!==null&&(a.childLanes|=n);e=e.return}}function ia(e,n){Xt=e,$t=ta=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&n)!=0&&(Ge=!0),e.firstContext=null)}function we(e,n){if($t!==e&&n!==!1&&n!==0)if((typeof n!="number"||n===1073741823)&&($t=e,n=1073741823),n={context:e,observedBits:n,next:null},ta===null){if(Xt===null)throw Error(T(308));ta=n,Xt.dependencies={lanes:0,firstContext:n,responders:null}}else ta=ta.next=n;return e._currentValue}var tn=!1;function Jr(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null},effects:null}}function Wl(e,n){e=e.updateQueue,n.updateQueue===e&&(n.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function rn(e,n){return{eventTime:e,lane:n,tag:0,payload:null,callback:null,next:null}}function on(e,n){if(e=e.updateQueue,e!==null){e=e.shared;var a=e.pending;a===null?n.next=n:(n.next=a.next,a.next=n),e.pending=n}}function Nl(e,n){var a=e.updateQueue,t=e.alternate;if(t!==null&&(t=t.updateQueue,a===t)){var i=null,r=null;if(a=a.firstBaseUpdate,a!==null){do{var o={eventTime:a.eventTime,lane:a.lane,tag:a.tag,payload:a.payload,callback:a.callback,next:null};r===null?i=r=o:r=r.next=o,a=a.next}while(a!==null);r===null?i=r=n:r=r.next=n}else i=r=n;a={baseState:t.baseState,firstBaseUpdate:i,lastBaseUpdate:r,shared:t.shared,effects:t.effects},e.updateQueue=a;return}e=a.lastBaseUpdate,e===null?a.firstBaseUpdate=n:e.next=n,a.lastBaseUpdate=n}function Ja(e,n,a,t){var i=e.updateQueue;tn=!1;var r=i.firstBaseUpdate,o=i.lastBaseUpdate,s=i.shared.pending;if(s!==null){i.shared.pending=null;var l=s,d=l.next;l.next=null,o===null?r=d:o.next=d,o=l;var k=e.alternate;if(k!==null){k=k.updateQueue;var N=k.lastBaseUpdate;N!==o&&(N===null?k.firstBaseUpdate=d:N.next=d,k.lastBaseUpdate=l)}}if(r!==null){N=i.baseState,o=0,k=d=l=null;do{s=r.lane;var f=r.eventTime;if((t&s)===s){k!==null&&(k=k.next={eventTime:f,lane:0,tag:r.tag,payload:r.payload,callback:r.callback,next:null});e:{var C=e,P=r;switch(s=n,f=a,P.tag){case 1:if(C=P.payload,typeof C=="function"){N=C.call(f,N,s);break e}N=C;break e;case 3:C.flags=C.flags&-4097|64;case 0:if(C=P.payload,s=typeof C=="function"?C.call(f,N,s):C,s==null)break e;N=Y({},N,s);break e;case 2:tn=!0}}r.callback!==null&&(e.flags|=32,s=i.effects,s===null?i.effects=[r]:s.push(r))}else f={eventTime:f,lane:s,tag:r.tag,payload:r.payload,callback:r.callback,next:null},k===null?(d=k=f,l=N):k=k.next=f,o|=s;if(r=r.next,r===null){if(s=i.shared.pending,s===null)break;r=s.next,s.next=null,i.lastBaseUpdate=s,i.shared.pending=null}}while(1);k===null&&(l=N),i.baseState=l,i.firstBaseUpdate=d,i.lastBaseUpdate=k,Va|=o,e.lanes=o,e.memoizedState=N}}function Pl(e,n,a){if(e=n.effects,n.effects=null,e!==null)for(n=0;n<e.length;n++){var t=e[n],i=t.callback;if(i!==null){if(t.callback=null,t=a,typeof i!="function")throw Error(T(191,i));i.call(t)}}}var Gl=new b.Component().refs;function ei(e,n,a,t){n=e.memoizedState,a=a(t,n),a=a==null?n:Y({},n,a),e.memoizedState=a,e.lanes===0&&(e.updateQueue.baseState=a)}var ni={isMounted:function(e){return(e=e._reactInternals)?In(e)===e:!1},enqueueSetState:function(e,n,a){e=e._reactInternals;var t=ve(),i=sn(e),r=rn(t,i);r.payload=n,a!=null&&(r.callback=a),on(e,r),ln(e,i,t)},enqueueReplaceState:function(e,n,a){e=e._reactInternals;var t=ve(),i=sn(e),r=rn(t,i);r.tag=1,r.payload=n,a!=null&&(r.callback=a),on(e,r),ln(e,i,t)},enqueueForceUpdate:function(e,n){e=e._reactInternals;var a=ve(),t=sn(e),i=rn(a,t);i.tag=2,n!=null&&(i.callback=n),on(e,i),ln(e,t,a)}};function Rl(e,n,a,t,i,r,o){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(t,r,o):n.prototype&&n.prototype.isPureReactComponent?!Ka(a,t)||!Ka(i,r):!0}function Dl(e,n,a){var t=!1,i=an,r=n.contextType;return typeof r=="object"&&r!==null?r=we(r):(i=Te(n)?vn:ce.current,t=n.contextTypes,r=(t=t!=null)?na(e,i):an),n=new n(a,r),e.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,n.updater=ni,e.stateNode=n,n._reactInternals=e,t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=i,e.__reactInternalMemoizedMaskedChildContext=r),n}function Ul(e,n,a,t){e=n.state,typeof n.componentWillReceiveProps=="function"&&n.componentWillReceiveProps(a,t),typeof n.UNSAFE_componentWillReceiveProps=="function"&&n.UNSAFE_componentWillReceiveProps(a,t),n.state!==e&&ni.enqueueReplaceState(n,n.state,null)}function zr(e,n,a,t){var i=e.stateNode;i.props=a,i.state=e.memoizedState,i.refs=Gl,Jr(e);var r=n.contextType;typeof r=="object"&&r!==null?i.context=we(r):(r=Te(n)?vn:ce.current,i.context=na(e,r)),Ja(e,a,i,t),i.state=e.memoizedState,r=n.getDerivedStateFromProps,typeof r=="function"&&(ei(e,n,r,a),i.state=e.memoizedState),typeof n.getDerivedStateFromProps=="function"||typeof i.getSnapshotBeforeUpdate=="function"||typeof i.UNSAFE_componentWillMount!="function"&&typeof i.componentWillMount!="function"||(n=i.state,typeof i.componentWillMount=="function"&&i.componentWillMount(),typeof i.UNSAFE_componentWillMount=="function"&&i.UNSAFE_componentWillMount(),n!==i.state&&ni.enqueueReplaceState(i,i.state,null),Ja(e,a,i,t),i.state=e.memoizedState),typeof i.componentDidMount=="function"&&(e.flags|=4)}var ai=Array.isArray;function za(e,n,a){if(e=a.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(a._owner){if(a=a._owner,a){if(a.tag!==1)throw Error(T(309));var t=a.stateNode}if(!t)throw Error(T(147,e));var i=""+e;return n!==null&&n.ref!==null&&typeof n.ref=="function"&&n.ref._stringRef===i?n.ref:(n=function(r){var o=t.refs;o===Gl&&(o=t.refs={}),r===null?delete o[i]:o[i]=r},n._stringRef=i,n)}if(typeof e!="string")throw Error(T(284));if(!a._owner)throw Error(T(290,e))}return e}function ti(e,n){if(e.type!=="textarea")throw Error(T(31,Object.prototype.toString.call(n)==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":n))}function Ll(e){function n(c,u){if(e){var h=c.lastEffect;h!==null?(h.nextEffect=u,c.lastEffect=u):c.firstEffect=c.lastEffect=u,u.nextEffect=null,u.flags=8}}function a(c,u){if(!e)return null;for(;u!==null;)n(c,u),u=u.sibling;return null}function t(c,u){for(c=new Map;u!==null;)u.key!==null?c.set(u.key,u):c.set(u.index,u),u=u.sibling;return c}function i(c,u){return c=un(c,u),c.index=0,c.sibling=null,c}function r(c,u,h){return c.index=h,e?(h=c.alternate,h!==null?(h=h.index,h<u?(c.flags=2,u):h):(c.flags=2,u)):u}function o(c){return e&&c.alternate===null&&(c.flags=2),c}function s(c,u,h,m){return u===null||u.tag!==6?(u=_r(h,c.mode,m),u.return=c,u):(u=i(u,h),u.return=c,u)}function l(c,u,h,m){return u!==null&&u.elementType===h.type?(m=i(u,h.props),m.ref=za(c,u,h),m.return=c,m):(m=ii(h.type,h.key,h.props,null,c.mode,m),m.ref=za(c,u,h),m.return=c,m)}function d(c,u,h,m){return u===null||u.tag!==4||u.stateNode.containerInfo!==h.containerInfo||u.stateNode.implementation!==h.implementation?(u=qr(h,c.mode,m),u.return=c,u):(u=i(u,h.children||[]),u.return=c,u)}function k(c,u,h,m,p){return u===null||u.tag!==7?(u=ra(h,c.mode,m,p),u.return=c,u):(u=i(u,h),u.return=c,u)}function N(c,u,h){if(typeof u=="string"||typeof u=="number")return u=_r(""+u,c.mode,h),u.return=c,u;if(typeof u=="object"&&u!==null){switch(u.$$typeof){case Ta:return h=ii(u.type,u.key,u.props,null,c.mode,h),h.ref=za(c,null,u),h.return=c,h;case Tn:return u=qr(u,c.mode,h),u.return=c,u}if(ai(u)||Ea(u))return u=ra(u,c.mode,h,null),u.return=c,u;ti(c,u)}return null}function f(c,u,h,m){var p=u!==null?u.key:null;if(typeof h=="string"||typeof h=="number")return p!==null?null:s(c,u,""+h,m);if(typeof h=="object"&&h!==null){switch(h.$$typeof){case Ta:return h.key===p?h.type===Je?k(c,u,h.props.children,m,p):l(c,u,h,m):null;case Tn:return h.key===p?d(c,u,h,m):null}if(ai(h)||Ea(h))return p!==null?null:k(c,u,h,m,null);ti(c,h)}return null}function C(c,u,h,m,p){if(typeof m=="string"||typeof m=="number")return c=c.get(h)||null,s(u,c,""+m,p);if(typeof m=="object"&&m!==null){switch(m.$$typeof){case Ta:return c=c.get(m.key===null?h:m.key)||null,m.type===Je?k(u,c,m.props.children,p,m.key):l(u,c,m,p);case Tn:return c=c.get(m.key===null?h:m.key)||null,d(u,c,m,p)}if(ai(m)||Ea(m))return c=c.get(h)||null,k(u,c,m,p,null);ti(u,m)}return null}function P(c,u,h,m){for(var p=null,G=null,E=u,B=u=0,D=null;E!==null&&B<h.length;B++){E.index>B?(D=E,E=null):D=E.sibling;var R=f(c,E,h[B],m);if(R===null){E===null&&(E=D);break}e&&E&&R.alternate===null&&n(c,E),u=r(R,u,B),G===null?p=R:G.sibling=R,G=R,E=D}if(B===h.length)return a(c,E),p;if(E===null){for(;B<h.length;B++)E=N(c,h[B],m),E!==null&&(u=r(E,u,B),G===null?p=E:G.sibling=E,G=E);return p}for(E=t(c,E);B<h.length;B++)D=C(E,c,B,h[B],m),D!==null&&(e&&D.alternate!==null&&E.delete(D.key===null?B:D.key),u=r(D,u,B),G===null?p=D:G.sibling=D,G=D);return e&&E.forEach(function(z){return n(c,z)}),p}function O(c,u,h,m){var p=Ea(h);if(typeof p!="function")throw Error(T(150));if(h=p.call(h),h==null)throw Error(T(151));for(var G=p=null,E=u,B=u=0,D=null,R=h.next();E!==null&&!R.done;B++,R=h.next()){E.index>B?(D=E,E=null):D=E.sibling;var z=f(c,E,R.value,m);if(z===null){E===null&&(E=D);break}e&&E&&z.alternate===null&&n(c,E),u=r(z,u,B),G===null?p=z:G.sibling=z,G=z,E=D}if(R.done)return a(c,E),p;if(E===null){for(;!R.done;B++,R=h.next())R=N(c,R.value,m),R!==null&&(u=r(R,u,B),G===null?p=R:G.sibling=R,G=R);return p}for(E=t(c,E);!R.done;B++,R=h.next())R=C(E,c,B,R.value,m),R!==null&&(e&&R.alternate!==null&&E.delete(R.key===null?B:R.key),u=r(R,u,B),G===null?p=R:G.sibling=R,G=R);return e&&E.forEach(function(ye){return n(c,ye)}),p}return function(c,u,h,m){var p=typeof h=="object"&&h!==null&&h.type===Je&&h.key===null;p&&(h=h.props.children);var G=typeof h=="object"&&h!==null;if(G)switch(h.$$typeof){case Ta:e:{for(G=h.key,p=u;p!==null;){if(p.key===G){switch(p.tag){case 7:if(h.type===Je){a(c,p.sibling),u=i(p,h.props.children),u.return=c,c=u;break e}break;default:if(p.elementType===h.type){a(c,p.sibling),u=i(p,h.props),u.ref=za(c,p,h),u.return=c,c=u;break e}}a(c,p);break}else n(c,p);p=p.sibling}h.type===Je?(u=ra(h.props.children,c.mode,m,h.key),u.return=c,c=u):(m=ii(h.type,h.key,h.props,null,c.mode,m),m.ref=za(c,u,h),m.return=c,c=m)}return o(c);case Tn:e:{for(p=h.key;u!==null;){if(u.key===p)if(u.tag===4&&u.stateNode.containerInfo===h.containerInfo&&u.stateNode.implementation===h.implementation){a(c,u.sibling),u=i(u,h.children||[]),u.return=c,c=u;break e}else{a(c,u);break}else n(c,u);u=u.sibling}u=qr(h,c.mode,m),u.return=c,c=u}return o(c)}if(typeof h=="string"||typeof h=="number")return h=""+h,u!==null&&u.tag===6?(a(c,u.sibling),u=i(u,h),u.return=c,c=u):(a(c,u),u=_r(h,c.mode,m),u.return=c,c=u),o(c);if(ai(h))return P(c,u,h,m);if(Ea(h))return O(c,u,h,m);if(G&&ti(c,h),typeof h=="undefined"&&!p)switch(c.tag){case 1:case 22:case 0:case 11:case 15:throw Error(T(152,Hn(c.type)||"Component"))}return a(c,u)}}var ri=Ll(!0),Fl=Ll(!1),_a={},Ue=nn(_a),qa=nn(_a),Za=nn(_a);function Mn(e){if(e===_a)throw Error(T(174));return e}function Zr(e,n){switch(_(Za,n),_(qa,e),_(Ue,_a),e=n.nodeType,e){case 9:case 11:n=(n=n.documentElement)?n.namespaceURI:nr(null,"");break;default:e=e===8?n.parentNode:n,n=e.namespaceURI||null,e=e.tagName,n=nr(n,e)}J(Ue),_(Ue,n)}function oa(){J(Ue),J(qa),J(Za)}function Hl(e){Mn(Za.current);var n=Mn(Ue.current),a=nr(n,e.type);n!==a&&(_(qa,e),_(Ue,a))}function Xr(e){qa.current===e&&(J(Ue),J(qa))}var q=nn(0);function oi(e){for(var n=e;n!==null;){if(n.tag===13){var a=n.memoizedState;if(a!==null&&(a=a.dehydrated,a===null||a.data==="$?"||a.data==="$!"))return n}else if(n.tag===19&&n.memoizedProps.revealOrder!==void 0){if((n.flags&64)!=0)return n}else if(n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}return null}var Ye=null,dn=null,Le=!1;function bl(e,n){var a=Me(5,null,null,0);a.elementType="DELETED",a.type="DELETED",a.stateNode=n,a.return=e,a.flags=8,e.lastEffect!==null?(e.lastEffect.nextEffect=a,e.lastEffect=a):e.firstEffect=e.lastEffect=a}function Kl(e,n){switch(e.tag){case 5:var a=e.type;return n=n.nodeType!==1||a.toLowerCase()!==n.nodeName.toLowerCase()?null:n,n!==null?(e.stateNode=n,!0):!1;case 6:return n=e.pendingProps===""||n.nodeType!==3?null:n,n!==null?(e.stateNode=n,!0):!1;case 13:return!1;default:return!1}}function $r(e){if(Le){var n=dn;if(n){var a=n;if(!Kl(e,n)){if(n=$n(a.nextSibling),!n||!Kl(e,n)){e.flags=e.flags&-1025|2,Le=!1,Ye=e;return}bl(Ye,a)}Ye=e,dn=$n(n.firstChild)}else e.flags=e.flags&-1025|2,Le=!1,Ye=e}}function Yl(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;Ye=e}function si(e){if(e!==Ye)return!1;if(!Le)return Yl(e),Le=!0,!1;var n=e.type;if(e.tag!==5||n!=="head"&&n!=="body"&&!Dr(n,e.memoizedProps))for(n=dn;n;)bl(e,n),n=$n(n.nextSibling);if(Yl(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(T(317));e:{for(e=e.nextSibling,n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="/$"){if(n===0){dn=$n(e.nextSibling);break e}n--}else a!=="$"&&a!=="$!"&&a!=="$?"||n++}e=e.nextSibling}dn=null}}else dn=Ye?$n(e.stateNode.nextSibling):null;return!0}function eo(){dn=Ye=null,Le=!1}var sa=[];function no(){for(var e=0;e<sa.length;e++)sa[e]._workInProgressVersionPrimary=null;sa.length=0}var Xa=kn.ReactCurrentDispatcher,Oe=kn.ReactCurrentBatchConfig,$a=0,X=null,me=null,ue=null,li=!1,et=!1;function Ae(){throw Error(T(321))}function ao(e,n){if(n===null)return!1;for(var a=0;a<n.length&&a<e.length;a++)if(!Ce(e[a],n[a]))return!1;return!0}function to(e,n,a,t,i,r){if($a=r,X=n,n.memoizedState=null,n.updateQueue=null,n.lanes=0,Xa.current=e===null||e.memoizedState===null?zh:_h,e=a(t,i),et){r=0;do{if(et=!1,!(25>r))throw Error(T(301));r+=1,ue=me=null,n.updateQueue=null,Xa.current=qh,e=a(t,i)}while(et)}if(Xa.current=ui,n=me!==null&&me.next!==null,$a=0,ue=me=X=null,li=!1,n)throw Error(T(300));return e}function On(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return ue===null?X.memoizedState=ue=e:ue=ue.next=e,ue}function Bn(){if(me===null){var e=X.alternate;e=e!==null?e.memoizedState:null}else e=me.next;var n=ue===null?X.memoizedState:ue.next;if(n!==null)ue=n,me=e;else{if(e===null)throw Error(T(310));me=e,e={memoizedState:me.memoizedState,baseState:me.baseState,baseQueue:me.baseQueue,queue:me.queue,next:null},ue===null?X.memoizedState=ue=e:ue=ue.next=e}return ue}function Fe(e,n){return typeof n=="function"?n(e):n}function nt(e){var n=Bn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=me,i=t.baseQueue,r=a.pending;if(r!==null){if(i!==null){var o=i.next;i.next=r.next,r.next=o}t.baseQueue=i=r,a.pending=null}if(i!==null){i=i.next,t=t.baseState;var s=o=r=null,l=i;do{var d=l.lane;if(($a&d)===d)s!==null&&(s=s.next={lane:0,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null}),t=l.eagerReducer===e?l.eagerState:e(t,l.action);else{var k={lane:d,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null};s===null?(o=s=k,r=t):s=s.next=k,X.lanes|=d,Va|=d}l=l.next}while(l!==null&&l!==i);s===null?r=t:s.next=o,Ce(t,n.memoizedState)||(Ge=!0),n.memoizedState=t,n.baseState=r,n.baseQueue=s,a.lastRenderedState=t}return[n.memoizedState,a.dispatch]}function at(e){var n=Bn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=a.dispatch,i=a.pending,r=n.memoizedState;if(i!==null){a.pending=null;var o=i=i.next;do r=e(r,o.action),o=o.next;while(o!==i);Ce(r,n.memoizedState)||(Ge=!0),n.memoizedState=r,n.baseQueue===null&&(n.baseState=r),a.lastRenderedState=r}return[r,t]}function xl(e,n,a){var t=n._getVersion;t=t(n._source);var i=n._workInProgressVersionPrimary;if(i!==null?e=i===t:(e=e.mutableReadLanes,(e=($a&e)===e)&&(n._workInProgressVersionPrimary=t,sa.push(n))),e)return a(n._source);throw sa.push(n),Error(T(350))}function Ql(e,n,a,t){var i=Se;if(i===null)throw Error(T(349));var r=n._getVersion,o=r(n._source),s=Xa.current,l=s.useState(function(){return xl(i,n,a)}),d=l[1],k=l[0];l=ue;var N=e.memoizedState,f=N.refs,C=f.getSnapshot,P=N.source;N=N.subscribe;var O=X;return e.memoizedState={refs:f,source:n,subscribe:t},s.useEffect(function(){f.getSnapshot=a,f.setSnapshot=d;var c=r(n._source);if(!Ce(o,c)){c=a(n._source),Ce(k,c)||(d(c),c=sn(O),i.mutableReadLanes|=c&i.pendingLanes),c=i.mutableReadLanes,i.entangledLanes|=c;for(var u=i.entanglements,h=c;0<h;){var m=31-Xe(h),p=1<<m;u[m]|=c,h&=~p}}},[a,n,t]),s.useEffect(function(){return t(n._source,function(){var c=f.getSnapshot,u=f.setSnapshot;try{u(c(n._source));var h=sn(O);i.mutableReadLanes|=h&i.pendingLanes}catch(m){u(function(){throw m})}})},[n,t]),Ce(C,a)&&Ce(P,n)&&Ce(N,t)||(e={pending:null,dispatch:null,lastRenderedReducer:Fe,lastRenderedState:k},e.dispatch=d=io.bind(null,X,e),l.queue=e,l.baseQueue=null,k=xl(i,n,a),l.memoizedState=l.baseState=k),k}function jl(e,n,a){var t=Bn();return Ql(t,e,n,a)}function tt(e){var n=On();return typeof e=="function"&&(e=e()),n.memoizedState=n.baseState=e,e=n.queue={pending:null,dispatch:null,lastRenderedReducer:Fe,lastRenderedState:e},e=e.dispatch=io.bind(null,X,e),[n.memoizedState,e]}function di(e,n,a,t){return e={tag:e,create:n,destroy:a,deps:t,next:null},n=X.updateQueue,n===null?(n={lastEffect:null},X.updateQueue=n,n.lastEffect=e.next=e):(a=n.lastEffect,a===null?n.lastEffect=e.next=e:(t=a.next,a.next=e,e.next=t,n.lastEffect=e)),e}function Vl(e){var n=On();return e={current:e},n.memoizedState=e}function hi(){return Bn().memoizedState}function ro(e,n,a,t){var i=On();X.flags|=e,i.memoizedState=di(1|n,a,void 0,t===void 0?null:t)}function oo(e,n,a,t){var i=Bn();t=t===void 0?null:t;var r=void 0;if(me!==null){var o=me.memoizedState;if(r=o.destroy,t!==null&&ao(t,o.deps)){di(n,a,r,t);return}}X.flags|=e,i.memoizedState=di(1|n,a,r,t)}function Jl(e,n){return ro(516,4,e,n)}function ci(e,n){return oo(516,4,e,n)}function zl(e,n){return oo(4,2,e,n)}function _l(e,n){if(typeof n=="function")return e=e(),n(e),function(){n(null)};if(n!=null)return e=e(),n.current=e,function(){n.current=null}}function ql(e,n,a){return a=a!=null?a.concat([e]):null,oo(4,2,_l.bind(null,n,e),a)}function so(){}function Zl(e,n){var a=Bn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&ao(n,t[1])?t[0]:(a.memoizedState=[e,n],e)}function Xl(e,n){var a=Bn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&ao(n,t[1])?t[0]:(e=e(),a.memoizedState=[e,n],e)}function Zh(e,n){var a=aa();wn(98>a?98:a,function(){e(!0)}),wn(97<a?97:a,function(){var t=Oe.transition;Oe.transition=1;try{e(!1),n()}finally{Oe.transition=t}})}function io(e,n,a){var t=ve(),i=sn(e),r={lane:i,action:a,eagerReducer:null,eagerState:null,next:null},o=n.pending;if(o===null?r.next=r:(r.next=o.next,o.next=r),n.pending=r,o=e.alternate,e===X||o!==null&&o===X)et=li=!0;else{if(e.lanes===0&&(o===null||o.lanes===0)&&(o=n.lastRenderedReducer,o!==null))try{var s=n.lastRenderedState,l=o(s,a);if(r.eagerReducer=o,r.eagerState=l,Ce(l,s))return}catch(d){}finally{}ln(e,i,t)}}var ui={readContext:we,useCallback:Ae,useContext:Ae,useEffect:Ae,useImperativeHandle:Ae,useLayoutEffect:Ae,useMemo:Ae,useReducer:Ae,useRef:Ae,useState:Ae,useDebugValue:Ae,useDeferredValue:Ae,useTransition:Ae,useMutableSource:Ae,useOpaqueIdentifier:Ae,unstable_isNewReconciler:!1},zh={readContext:we,useCallback:function(e,n){return On().memoizedState=[e,n===void 0?null:n],e},useContext:we,useEffect:Jl,useImperativeHandle:function(e,n,a){return a=a!=null?a.concat([e]):null,ro(4,2,_l.bind(null,n,e),a)},useLayoutEffect:function(e,n){return ro(4,2,e,n)},useMemo:function(e,n){var a=On();return n=n===void 0?null:n,e=e(),a.memoizedState=[e,n],e},useReducer:function(e,n,a){var t=On();return n=a!==void 0?a(n):n,t.memoizedState=t.baseState=n,e=t.queue={pending:null,dispatch:null,lastRenderedReducer:e,lastRenderedState:n},e=e.dispatch=io.bind(null,X,e),[t.memoizedState,e]},useRef:Vl,useState:tt,useDebugValue:so,useDeferredValue:function(e){var n=tt(e),a=n[0],t=n[1];return Jl(function(){var i=Oe.transition;Oe.transition=1;try{t(e)}finally{Oe.transition=i}},[e]),a},useTransition:function(){var e=tt(!1),n=e[0];return e=Zh.bind(null,e[1]),Vl(e),[e,n]},useMutableSource:function(e,n,a){var t=On();return t.memoizedState={refs:{getSnapshot:n,setSnapshot:null},source:e,subscribe:a},Ql(t,e,n,a)},useOpaqueIdentifier:function(){if(Le){var e=!1,n=Yh(function(){throw e||(e=!0,a("r:"+(Lr++).toString(36))),Error(T(355))}),a=tt(n)[1];return(X.mode&2)==0&&(X.flags|=516,di(5,function(){a("r:"+(Lr++).toString(36))},void 0,null)),n}return n="r:"+(Lr++).toString(36),tt(n),n},unstable_isNewReconciler:!1},_h={readContext:we,useCallback:Zl,useContext:we,useEffect:ci,useImperativeHandle:ql,useLayoutEffect:zl,useMemo:Xl,useReducer:nt,useRef:hi,useState:function(){return nt(Fe)},useDebugValue:so,useDeferredValue:function(e){var n=nt(Fe),a=n[0],t=n[1];return ci(function(){var i=Oe.transition;Oe.transition=1;try{t(e)}finally{Oe.transition=i}},[e]),a},useTransition:function(){var e=nt(Fe)[0];return[hi().current,e]},useMutableSource:jl,useOpaqueIdentifier:function(){return nt(Fe)[0]},unstable_isNewReconciler:!1},qh={readContext:we,useCallback:Zl,useContext:we,useEffect:ci,useImperativeHandle:ql,useLayoutEffect:zl,useMemo:Xl,useReducer:at,useRef:hi,useState:function(){return at(Fe)},useDebugValue:so,useDeferredValue:function(e){var n=at(Fe),a=n[0],t=n[1];return ci(function(){var i=Oe.transition;Oe.transition=1;try{t(e)}finally{Oe.transition=i}},[e]),a},useTransition:function(){var e=at(Fe)[0];return[hi().current,e]},useMutableSource:jl,useOpaqueIdentifier:function(){return at(Fe)[0]},unstable_isNewReconciler:!1},Xh=kn.ReactCurrentOwner,Ge=!1;function Ie(e,n,a,t){n.child=e===null?Fl(n,null,a,t):ri(n,e.child,a,t)}function $l(e,n,a,t,i){a=a.render;var r=n.ref;return ia(n,i),t=to(e,n,a,t,r,i),e!==null&&!Ge?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,xe(e,n,i)):(n.flags|=1,Ie(e,n,t,i),n.child)}function nu(e,n,a,t,i,r){if(e===null){var o=a.type;return typeof o=="function"&&!lo(o)&&o.defaultProps===void 0&&a.compare===null&&a.defaultProps===void 0?(n.tag=15,n.type=o,eu(e,n,o,t,i,r)):(e=ii(a.type,null,t,n,n.mode,r),e.ref=n.ref,e.return=n,n.child=e)}return o=e.child,(i&r)==0&&(i=o.memoizedProps,a=a.compare,a=a!==null?a:Ka,a(i,t)&&e.ref===n.ref)?xe(e,n,r):(n.flags|=1,e=un(o,t),e.ref=n.ref,e.return=n,n.child=e)}function eu(e,n,a,t,i,r){if(e!==null&&Ka(e.memoizedProps,t)&&e.ref===n.ref)if(Ge=!1,(r&i)!=0)(e.flags&16384)!=0&&(Ge=!0);else return n.lanes=e.lanes,xe(e,n,r);return uo(e,n,a,t,r)}function ho(e,n,a){var t=n.pendingProps,i=t.children,r=e!==null?e.memoizedState:null;if(t.mode==="hidden"||t.mode==="unstable-defer-without-hiding")if((n.mode&4)==0)n.memoizedState={baseLanes:0},gi(n,a);else if((a&1073741824)!=0)n.memoizedState={baseLanes:0},gi(n,r!==null?r.baseLanes:a);else return e=r!==null?r.baseLanes|a:a,n.lanes=n.childLanes=1073741824,n.memoizedState={baseLanes:e},gi(n,e),null;else r!==null?(t=r.baseLanes|a,n.memoizedState=null):t=a,gi(n,t);return Ie(e,n,i,a),n.child}function au(e,n){var a=n.ref;(e===null&&a!==null||e!==null&&e.ref!==a)&&(n.flags|=128)}function uo(e,n,a,t,i){var r=Te(a)?vn:ce.current;return r=na(n,r),ia(n,i),a=to(e,n,a,t,r,i),e!==null&&!Ge?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,xe(e,n,i)):(n.flags|=1,Ie(e,n,a,i),n.child)}function tu(e,n,a,t,i){if(Te(a)){var r=!0;zt(n)}else r=!1;if(ia(n,i),n.stateNode===null)e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),Dl(n,a,t),zr(n,a,t,i),t=!0;else if(e===null){var o=n.stateNode,s=n.memoizedProps;o.props=s;var l=o.context,d=a.contextType;typeof d=="object"&&d!==null?d=we(d):(d=Te(a)?vn:ce.current,d=na(n,d));var k=a.getDerivedStateFromProps,N=typeof k=="function"||typeof o.getSnapshotBeforeUpdate=="function";N||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==t||l!==d)&&Ul(n,o,t,d),tn=!1;var f=n.memoizedState;o.state=f,Ja(n,t,o,i),l=n.memoizedState,s!==t||f!==l||ke.current||tn?(typeof k=="function"&&(ei(n,a,k,t),l=n.memoizedState),(s=tn||Rl(n,a,s,t,f,l,d))?(N||typeof o.UNSAFE_componentWillMount!="function"&&typeof o.componentWillMount!="function"||(typeof o.componentWillMount=="function"&&o.componentWillMount(),typeof o.UNSAFE_componentWillMount=="function"&&o.UNSAFE_componentWillMount()),typeof o.componentDidMount=="function"&&(n.flags|=4)):(typeof o.componentDidMount=="function"&&(n.flags|=4),n.memoizedProps=t,n.memoizedState=l),o.props=t,o.state=l,o.context=d,t=s):(typeof o.componentDidMount=="function"&&(n.flags|=4),t=!1)}else{o=n.stateNode,Wl(e,n),s=n.memoizedProps,d=n.type===n.elementType?s:Pe(n.type,s),o.props=d,N=n.pendingProps,f=o.context,l=a.contextType,typeof l=="object"&&l!==null?l=we(l):(l=Te(a)?vn:ce.current,l=na(n,l));var C=a.getDerivedStateFromProps;(k=typeof C=="function"||typeof o.getSnapshotBeforeUpdate=="function")||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==N||f!==l)&&Ul(n,o,t,l),tn=!1,f=n.memoizedState,o.state=f,Ja(n,t,o,i);var P=n.memoizedState;s!==N||f!==P||ke.current||tn?(typeof C=="function"&&(ei(n,a,C,t),P=n.memoizedState),(d=tn||Rl(n,a,d,t,f,P,l))?(k||typeof o.UNSAFE_componentWillUpdate!="function"&&typeof o.componentWillUpdate!="function"||(typeof o.componentWillUpdate=="function"&&o.componentWillUpdate(t,P,l),typeof o.UNSAFE_componentWillUpdate=="function"&&o.UNSAFE_componentWillUpdate(t,P,l)),typeof o.componentDidUpdate=="function"&&(n.flags|=4),typeof o.getSnapshotBeforeUpdate=="function"&&(n.flags|=256)):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=256),n.memoizedProps=t,n.memoizedState=P),o.props=t,o.state=P,o.context=l,t=d):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=256),t=!1)}return co(e,n,a,t,r,i)}function co(e,n,a,t,i,r){au(e,n);var o=(n.flags&64)!=0;if(!t&&!o)return i&&Tl(n,a,!1),xe(e,n,r);t=n.stateNode,Xh.current=n;var s=o&&typeof a.getDerivedStateFromError!="function"?null:t.render();return n.flags|=1,e!==null&&o?(n.child=ri(n,e.child,null,r),n.child=ri(n,null,s,r)):Ie(e,n,s,r),n.memoizedState=t.state,i&&Tl(n,a,!0),n.child}function iu(e){var n=e.stateNode;n.pendingContext?yl(e,n.pendingContext,n.pendingContext!==n.context):n.context&&yl(e,n.context,!1),Zr(e,n.containerInfo)}var mi={dehydrated:null,retryLane:0};function lu(e,n,a){var t=n.pendingProps,i=q.current,r=!1,o;return(o=(n.flags&64)!=0)||(o=e!==null&&e.memoizedState===null?!1:(i&2)!=0),o?(r=!0,n.flags&=-65):e!==null&&e.memoizedState===null||t.fallback===void 0||t.unstable_avoidThisFallback===!0||(i|=1),_(q,i&1),e===null?(t.fallback!==void 0&&$r(n),e=t.children,i=t.fallback,r?(e=ru(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=mi,e):typeof t.unstable_expectedLoadTime=="number"?(e=ru(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=mi,n.lanes=33554432,e):(a=go({mode:"visible",children:e},n.mode,a,null),a.return=n,n.child=a)):e.memoizedState!==null?r?(t=su(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=mi,t):(a=ou(e,n,t.children,a),n.memoizedState=null,a):r?(t=su(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=mi,t):(a=ou(e,n,t.children,a),n.memoizedState=null,a)}function ru(e,n,a,t){var i=e.mode,r=e.child;return n={mode:"hidden",children:n},(i&2)==0&&r!==null?(r.childLanes=0,r.pendingProps=n):r=go(n,i,0,null),a=ra(a,i,t,null),r.return=e,a.return=e,r.sibling=a,e.child=r,a}function ou(e,n,a,t){var i=e.child;return e=i.sibling,a=un(i,{mode:"visible",children:a}),(n.mode&2)==0&&(a.lanes=t),a.return=n,a.sibling=null,e!==null&&(e.nextEffect=null,e.flags=8,n.firstEffect=n.lastEffect=e),n.child=a}function su(e,n,a,t,i){var r=n.mode,o=e.child;e=o.sibling;var s={mode:"hidden",children:a};return(r&2)==0&&n.child!==o?(a=n.child,a.childLanes=0,a.pendingProps=s,o=a.lastEffect,o!==null?(n.firstEffect=a.firstEffect,n.lastEffect=o,o.nextEffect=null):n.firstEffect=n.lastEffect=null):a=un(o,s),e!==null?t=un(e,t):(t=ra(t,r,i,null),t.flags|=2),t.return=n,a.return=n,a.sibling=t,n.child=a,t}function uu(e,n){e.lanes|=n;var a=e.alternate;a!==null&&(a.lanes|=n),Bl(e.return,n)}function mo(e,n,a,t,i,r){var o=e.memoizedState;o===null?e.memoizedState={isBackwards:n,rendering:null,renderingStartTime:0,last:t,tail:a,tailMode:i,lastEffect:r}:(o.isBackwards=n,o.rendering=null,o.renderingStartTime=0,o.last=t,o.tail=a,o.tailMode=i,o.lastEffect=r)}function du(e,n,a){var t=n.pendingProps,i=t.revealOrder,r=t.tail;if(Ie(e,n,t.children,a),t=q.current,(t&2)!=0)t=t&1|2,n.flags|=64;else{if(e!==null&&(e.flags&64)!=0)e:for(e=n.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&uu(e,a);else if(e.tag===19)uu(e,a);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===n)break e;for(;e.sibling===null;){if(e.return===null||e.return===n)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}t&=1}if(_(q,t),(n.mode&2)==0)n.memoizedState=null;else switch(i){case"forwards":for(a=n.child,i=null;a!==null;)e=a.alternate,e!==null&&oi(e)===null&&(i=a),a=a.sibling;a=i,a===null?(i=n.child,n.child=null):(i=a.sibling,a.sibling=null),mo(n,!1,i,a,r,n.lastEffect);break;case"backwards":for(a=null,i=n.child,n.child=null;i!==null;){if(e=i.alternate,e!==null&&oi(e)===null){n.child=i;break}e=i.sibling,i.sibling=a,a=i,i=e}mo(n,!0,a,null,r,n.lastEffect);break;case"together":mo(n,!1,null,null,void 0,n.lastEffect);break;default:n.memoizedState=null}return n.child}function xe(e,n,a){if(e!==null&&(n.dependencies=e.dependencies),Va|=n.lanes,(a&n.childLanes)!=0){if(e!==null&&n.child!==e.child)throw Error(T(153));if(n.child!==null){for(e=n.child,a=un(e,e.pendingProps),n.child=a,a.return=n;e.sibling!==null;)e=e.sibling,a=a.sibling=un(e,e.pendingProps),a.return=n;a.sibling=null}return n.child}return null}var hu,po,cu,gu;hu=function(e,n){for(var a=n.child;a!==null;){if(a.tag===5||a.tag===6)e.appendChild(a.stateNode);else if(a.tag!==4&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return}a.sibling.return=a.return,a=a.sibling}};po=function(){};cu=function(e,n,a,t){var i=e.memoizedProps;if(i!==t){e=n.stateNode,Mn(Ue.current);var r=null;switch(a){case"input":i=_i(e,i),t=_i(e,t),r=[];break;case"option":i=Xi(e,i),t=Xi(e,t),r=[];break;case"select":i=Y({},i,{value:void 0}),t=Y({},t,{value:void 0}),r=[];break;case"textarea":i=$i(e,i),t=$i(e,t),r=[];break;default:typeof i.onClick!="function"&&typeof t.onClick=="function"&&(e.onclick=Qt)}ar(a,t);var o;a=null;for(d in i)if(!t.hasOwnProperty(d)&&i.hasOwnProperty(d)&&i[d]!=null)if(d==="style"){var s=i[d];for(o in s)s.hasOwnProperty(o)&&(a||(a={}),a[o]="")}else d!=="dangerouslySetInnerHTML"&&d!=="children"&&d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&d!=="autoFocus"&&(ka.hasOwnProperty(d)?r||(r=[]):(r=r||[]).push(d,null));for(d in t){var l=t[d];if(s=i!=null?i[d]:void 0,t.hasOwnProperty(d)&&l!==s&&(l!=null||s!=null))if(d==="style")if(s){for(o in s)!s.hasOwnProperty(o)||l&&l.hasOwnProperty(o)||(a||(a={}),a[o]="");for(o in l)l.hasOwnProperty(o)&&s[o]!==l[o]&&(a||(a={}),a[o]=l[o])}else a||(r||(r=[]),r.push(d,a)),a=l;else d==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,s=s?s.__html:void 0,l!=null&&s!==l&&(r=r||[]).push(d,l)):d==="children"?typeof l!="string"&&typeof l!="number"||(r=r||[]).push(d,""+l):d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&(ka.hasOwnProperty(d)?(l!=null&&d==="onScroll"&&V("scroll",e),r||s===l||(r=[])):typeof l=="object"&&l!==null&&l.$$typeof===Qi?l.toString():(r=r||[]).push(d,l))}a&&(r=r||[]).push("style",a);var d=r;(n.updateQueue=d)&&(n.flags|=4)}};gu=function(e,n,a,t){a!==t&&(n.flags|=4)};function it(e,n){if(!Le)switch(e.tailMode){case"hidden":n=e.tail;for(var a=null;n!==null;)n.alternate!==null&&(a=n),n=n.sibling;a===null?e.tail=null:a.sibling=null;break;case"collapsed":a=e.tail;for(var t=null;a!==null;)a.alternate!==null&&(t=a),a=a.sibling;t===null?n||e.tail===null?e.tail=null:e.tail.sibling=null:t.sibling=null}}function $h(e,n,a){var t=n.pendingProps;switch(n.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return null;case 1:return Te(n.type)&&Jt(),null;case 3:return oa(),J(ke),J(ce),no(),t=n.stateNode,t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(e===null||e.child===null)&&(si(n)?n.flags|=4:t.hydrate||(n.flags|=256)),po(n),null;case 5:Xr(n);var i=Mn(Za.current);if(a=n.type,e!==null&&n.stateNode!=null)cu(e,n,a,t,i),e.ref!==n.ref&&(n.flags|=128);else{if(!t){if(n.stateNode===null)throw Error(T(166));return null}if(e=Mn(Ue.current),si(n)){t=n.stateNode,a=n.type;var r=n.memoizedProps;switch(t[en]=n,t[Vt]=r,a){case"dialog":V("cancel",t),V("close",t);break;case"iframe":case"object":case"embed":V("load",t);break;case"video":case"audio":for(e=0;e<xa.length;e++)V(xa[e],t);break;case"source":V("error",t);break;case"img":case"image":case"link":V("error",t),V("load",t);break;case"details":V("toggle",t);break;case"input":is(t,r),V("invalid",t);break;case"select":t._wrapperState={wasMultiple:!!r.multiple},V("invalid",t);break;case"textarea":ss(t,r),V("invalid",t)}ar(a,r),e=null;for(var o in r)r.hasOwnProperty(o)&&(i=r[o],o==="children"?typeof i=="string"?t.textContent!==i&&(e=["children",i]):typeof i=="number"&&t.textContent!==""+i&&(e=["children",""+i]):ka.hasOwnProperty(o)&&i!=null&&o==="onScroll"&&V("scroll",t));switch(a){case"input":vt(t),os(t,r,!0);break;case"textarea":vt(t),us(t);break;case"select":case"option":break;default:typeof r.onClick=="function"&&(t.onclick=Qt)}t=e,n.updateQueue=t,t!==null&&(n.flags|=4)}else{switch(o=i.nodeType===9?i:i.ownerDocument,e===er.html&&(e=ds(a)),e===er.html?a==="script"?(e=o.createElement("div"),e.innerHTML="<script></script>",e=e.removeChild(e.firstChild)):typeof t.is=="string"?e=o.createElement(a,{is:t.is}):(e=o.createElement(a),a==="select"&&(o=e,t.multiple?o.multiple=!0:t.size&&(o.size=t.size))):e=o.createElementNS(e,a),e[en]=n,e[Vt]=t,hu(e,n,!1,!1),n.stateNode=e,o=tr(a,t),a){case"dialog":V("cancel",e),V("close",e),i=t;break;case"iframe":case"object":case"embed":V("load",e),i=t;break;case"video":case"audio":for(i=0;i<xa.length;i++)V(xa[i],e);i=t;break;case"source":V("error",e),i=t;break;case"img":case"image":case"link":V("error",e),V("load",e),i=t;break;case"details":V("toggle",e),i=t;break;case"input":is(e,t),i=_i(e,t),V("invalid",e);break;case"option":i=Xi(e,t);break;case"select":e._wrapperState={wasMultiple:!!t.multiple},i=Y({},t,{value:void 0}),V("invalid",e);break;case"textarea":ss(e,t),i=$i(e,t),V("invalid",e);break;default:i=t}ar(a,i);var s=i;for(r in s)if(s.hasOwnProperty(r)){var l=s[r];r==="style"?gs(e,l):r==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,l!=null&&hs(e,l)):r==="children"?typeof l=="string"?(a!=="textarea"||l!=="")&&Ca(e,l):typeof l=="number"&&Ca(e,""+l):r!=="suppressContentEditableWarning"&&r!=="suppressHydrationWarning"&&r!=="autoFocus"&&(ka.hasOwnProperty(r)?l!=null&&r==="onScroll"&&V("scroll",e):l!=null&&Fi(e,r,l,o))}switch(a){case"input":vt(e),os(e,t,!1);break;case"textarea":vt(e),us(e);break;case"option":t.value!=null&&e.setAttribute("value",""+ze(t.value));break;case"select":e.multiple=!!t.multiple,r=t.value,r!=null?bn(e,!!t.multiple,r,!1):t.defaultValue!=null&&bn(e,!!t.multiple,t.defaultValue,!0);break;default:typeof i.onClick=="function"&&(e.onclick=Qt)}ml(a,t)&&(n.flags|=4)}n.ref!==null&&(n.flags|=128)}return null;case 6:if(e&&n.stateNode!=null)gu(e,n,e.memoizedProps,t);else{if(typeof t!="string"&&n.stateNode===null)throw Error(T(166));a=Mn(Za.current),Mn(Ue.current),si(n)?(t=n.stateNode,a=n.memoizedProps,t[en]=n,t.nodeValue!==a&&(n.flags|=4)):(t=(a.nodeType===9?a:a.ownerDocument).createTextNode(t),t[en]=n,n.stateNode=t)}return null;case 13:return J(q),t=n.memoizedState,(n.flags&64)!=0?(n.lanes=a,n):(t=t!==null,a=!1,e===null?n.memoizedProps.fallback!==void 0&&si(n):a=e.memoizedState!==null,t&&!a&&(n.mode&2)!=0&&(e===null&&n.memoizedProps.unstable_avoidThisFallback!==!0||(q.current&1)!=0?de===0&&(de=3):((de===0||de===3)&&(de=4),Se===null||(Va&134217727)==0&&(la&134217727)==0||ua(Se,pe))),(t||a)&&(n.flags|=4),null);case 4:return oa(),po(n),e===null&&cl(n.stateNode.containerInfo),null;case 10:return Vr(n),null;case 17:return Te(n.type)&&Jt(),null;case 19:if(J(q),t=n.memoizedState,t===null)return null;if(r=(n.flags&64)!=0,o=t.rendering,o===null)if(r)it(t,!1);else{if(de!==0||e!==null&&(e.flags&64)!=0)for(e=n.child;e!==null;){if(o=oi(e),o!==null){for(n.flags|=64,it(t,!1),r=o.updateQueue,r!==null&&(n.updateQueue=r,n.flags|=4),t.lastEffect===null&&(n.firstEffect=null),n.lastEffect=t.lastEffect,t=a,a=n.child;a!==null;)r=a,e=t,r.flags&=2,r.nextEffect=null,r.firstEffect=null,r.lastEffect=null,o=r.alternate,o===null?(r.childLanes=0,r.lanes=e,r.child=null,r.memoizedProps=null,r.memoizedState=null,r.updateQueue=null,r.dependencies=null,r.stateNode=null):(r.childLanes=o.childLanes,r.lanes=o.lanes,r.child=o.child,r.memoizedProps=o.memoizedProps,r.memoizedState=o.memoizedState,r.updateQueue=o.updateQueue,r.type=o.type,e=o.dependencies,r.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),a=a.sibling;return _(q,q.current&1|2),n.child}e=e.sibling}t.tail!==null&&ge()>fo&&(n.flags|=64,r=!0,it(t,!1),n.lanes=33554432)}else{if(!r)if(e=oi(o),e!==null){if(n.flags|=64,r=!0,a=e.updateQueue,a!==null&&(n.updateQueue=a,n.flags|=4),it(t,!0),t.tail===null&&t.tailMode==="hidden"&&!o.alternate&&!Le)return n=n.lastEffect=t.lastEffect,n!==null&&(n.nextEffect=null),null}else 2*ge()-t.renderingStartTime>fo&&a!==1073741824&&(n.flags|=64,r=!0,it(t,!1),n.lanes=33554432);t.isBackwards?(o.sibling=n.child,n.child=o):(a=t.last,a!==null?a.sibling=o:n.child=o,t.last=o)}return t.tail!==null?(a=t.tail,t.rendering=a,t.tail=a.sibling,t.lastEffect=n.lastEffect,t.renderingStartTime=ge(),a.sibling=null,n=q.current,_(q,r?n&1|2:n&1),a):null;case 23:case 24:return So(),e!==null&&e.memoizedState!==null!=(n.memoizedState!==null)&&t.mode!=="unstable-defer-without-hiding"&&(n.flags|=4),null}throw Error(T(156,n.tag))}function ec(e){switch(e.tag){case 1:Te(e.type)&&Jt();var n=e.flags;return n&4096?(e.flags=n&-4097|64,e):null;case 3:if(oa(),J(ke),J(ce),no(),n=e.flags,(n&64)!=0)throw Error(T(285));return e.flags=n&-4097|64,e;case 5:return Xr(e),null;case 13:return J(q),n=e.flags,n&4096?(e.flags=n&-4097|64,e):null;case 19:return J(q),null;case 4:return oa(),null;case 10:return Vr(e),null;case 23:case 24:return So(),null;default:return null}}function yo(e,n){try{var a="",t=n;do a+=Rd(t),t=t.return;while(t);var i=a}catch(r){i=`
Error generating stack: `+r.message+`
`+r.stack}return{value:e,source:n,stack:i}}function ko(e,n){try{console.error(n.value)}catch(a){setTimeout(function(){throw a})}}var nc=typeof WeakMap=="function"?WeakMap:Map;function mu(e,n,a){a=rn(-1,a),a.tag=3,a.payload={element:null};var t=n.value;return a.callback=function(){pi||(pi=!0,To=t),ko(e,n)},a}function pu(e,n,a){a=rn(-1,a),a.tag=3;var t=e.type.getDerivedStateFromError;if(typeof t=="function"){var i=n.value;a.payload=function(){return ko(e,n),t(i)}}var r=e.stateNode;return r!==null&&typeof r.componentDidCatch=="function"&&(a.callback=function(){typeof t!="function"&&(He===null?He=new Set([this]):He.add(this),ko(e,n));var o=n.stack;this.componentDidCatch(n.value,{componentStack:o!==null?o:""})}),a}var ac=typeof WeakSet=="function"?WeakSet:Set;function fu(e){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(a){hn(e,a)}else n.current=null}function tc(e,n){switch(n.tag){case 0:case 11:case 15:case 22:return;case 1:if(n.flags&256&&e!==null){var a=e.memoizedProps,t=e.memoizedState;e=n.stateNode,n=e.getSnapshotBeforeUpdate(n.elementType===n.type?a:Pe(n.type,a),t),e.__reactInternalSnapshotBeforeUpdate=n}return;case 3:n.flags&256&&Ur(n.stateNode.containerInfo);return;case 5:case 6:case 4:case 17:return}throw Error(T(163))}function rc(e,n,a){switch(a.tag){case 0:case 11:case 15:case 22:if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{if((e.tag&3)==3){var t=e.create;e.destroy=t()}e=e.next}while(e!==n)}if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{var i=e;t=i.next,i=i.tag,(i&4)!=0&&(i&1)!=0&&(Su(a,e),ic(a,e)),e=t}while(e!==n)}return;case 1:e=a.stateNode,a.flags&4&&(n===null?e.componentDidMount():(t=a.elementType===a.type?n.memoizedProps:Pe(a.type,n.memoizedProps),e.componentDidUpdate(t,n.memoizedState,e.__reactInternalSnapshotBeforeUpdate))),n=a.updateQueue,n!==null&&Pl(a,n,e);return;case 3:if(n=a.updateQueue,n!==null){if(e=null,a.child!==null)switch(a.child.tag){case 5:e=a.child.stateNode;break;case 1:e=a.child.stateNode}Pl(a,n,e)}return;case 5:e=a.stateNode,n===null&&a.flags&4&&ml(a.type,a.memoizedProps)&&e.focus();return;case 6:return;case 4:return;case 12:return;case 13:a.memoizedState===null&&(a=a.alternate,a!==null&&(a=a.memoizedState,a!==null&&(a=a.dehydrated,a!==null&&Bs(a))));return;case 19:case 17:case 20:case 21:case 23:case 24:return}throw Error(T(163))}function yu(e,n){for(var a=e;;){if(a.tag===5){var t=a.stateNode;if(n)t=t.style,typeof t.setProperty=="function"?t.setProperty("display","none","important"):t.display="none";else{t=a.stateNode;var i=a.memoizedProps.style;i=i!=null&&i.hasOwnProperty("display")?i.display:null,t.style.display=cs("display",i)}}else if(a.tag===6)a.stateNode.nodeValue=n?"":a.memoizedProps;else if((a.tag!==23&&a.tag!==24||a.memoizedState===null||a===e)&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===e)break;for(;a.sibling===null;){if(a.return===null||a.return===e)return;a=a.return}a.sibling.return=a.return,a=a.sibling}}function Tu(e,n){if(Cn&&typeof Cn.onCommitFiberUnmount=="function")try{Cn.onCommitFiberUnmount(Hr,n)}catch(r){}switch(n.tag){case 0:case 11:case 14:case 15:case 22:if(e=n.updateQueue,e!==null&&(e=e.lastEffect,e!==null)){var a=e=e.next;do{var t=a,i=t.destroy;if(t=t.tag,i!==void 0)if((t&4)!=0)Su(n,a);else{t=n;try{i()}catch(r){hn(t,r)}}a=a.next}while(a!==e)}break;case 1:if(fu(n),e=n.stateNode,typeof e.componentWillUnmount=="function")try{e.props=n.memoizedProps,e.state=n.memoizedState,e.componentWillUnmount()}catch(r){hn(n,r)}break;case 5:fu(n);break;case 4:ku(e,n)}}function Au(e){e.alternate=null,e.child=null,e.dependencies=null,e.firstEffect=null,e.lastEffect=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.return=null,e.updateQueue=null}function Iu(e){return e.tag===5||e.tag===3||e.tag===4}function Eu(e){e:{for(var n=e.return;n!==null;){if(Iu(n))break e;n=n.return}throw Error(T(160))}var a=n;switch(n=a.stateNode,a.tag){case 5:var t=!1;break;case 3:n=n.containerInfo,t=!0;break;case 4:n=n.containerInfo,t=!0;break;default:throw Error(T(161))}a.flags&16&&(Ca(n,""),a.flags&=-17);e:n:for(a=e;;){for(;a.sibling===null;){if(a.return===null||Iu(a.return)){a=null;break e}a=a.return}for(a.sibling.return=a.return,a=a.sibling;a.tag!==5&&a.tag!==6&&a.tag!==18;){if(a.flags&2||a.child===null||a.tag===4)continue n;a.child.return=a,a=a.child}if(!(a.flags&2)){a=a.stateNode;break e}}t?Ao(e,a,n):Io(e,a,n)}function Ao(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.nodeType===8?a.parentNode.insertBefore(e,n):a.insertBefore(e,n):(a.nodeType===8?(n=a.parentNode,n.insertBefore(e,a)):(n=a,n.appendChild(e)),a=a._reactRootContainer,a!=null||n.onclick!==null||(n.onclick=Qt));else if(t!==4&&(e=e.child,e!==null))for(Ao(e,n,a),e=e.sibling;e!==null;)Ao(e,n,a),e=e.sibling}function Io(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.insertBefore(e,n):a.appendChild(e);else if(t!==4&&(e=e.child,e!==null))for(Io(e,n,a),e=e.sibling;e!==null;)Io(e,n,a),e=e.sibling}function ku(e,n){for(var a=n,t=!1,i,r;;){if(!t){t=a.return;e:for(;;){if(t===null)throw Error(T(160));switch(i=t.stateNode,t.tag){case 5:r=!1;break e;case 3:i=i.containerInfo,r=!0;break e;case 4:i=i.containerInfo,r=!0;break e}t=t.return}t=!0}if(a.tag===5||a.tag===6){e:for(var o=e,s=a,l=s;;)if(Tu(o,l),l.child!==null&&l.tag!==4)l.child.return=l,l=l.child;else{if(l===s)break e;for(;l.sibling===null;){if(l.return===null||l.return===s)break e;l=l.return}l.sibling.return=l.return,l=l.sibling}r?(o=i,s=a.stateNode,o.nodeType===8?o.parentNode.removeChild(s):o.removeChild(s)):i.removeChild(a.stateNode)}else if(a.tag===4){if(a.child!==null){i=a.stateNode.containerInfo,r=!0,a.child.return=a,a=a.child;continue}}else if(Tu(e,a),a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return,a.tag===4&&(t=!1)}a.sibling.return=a.return,a=a.sibling}}function vo(e,n){switch(n.tag){case 0:case 11:case 14:case 15:case 22:var a=n.updateQueue;if(a=a!==null?a.lastEffect:null,a!==null){var t=a=a.next;do(t.tag&3)==3&&(e=t.destroy,t.destroy=void 0,e!==void 0&&e()),t=t.next;while(t!==a)}return;case 1:return;case 5:if(a=n.stateNode,a!=null){t=n.memoizedProps;var i=e!==null?e.memoizedProps:t;e=n.type;var r=n.updateQueue;if(n.updateQueue=null,r!==null){for(a[Vt]=t,e==="input"&&t.type==="radio"&&t.name!=null&&rs(a,t),tr(e,i),n=tr(e,t),i=0;i<r.length;i+=2){var o=r[i],s=r[i+1];o==="style"?gs(a,s):o==="dangerouslySetInnerHTML"?hs(a,s):o==="children"?Ca(a,s):Fi(a,o,s,n)}switch(e){case"input":Zi(a,t);break;case"textarea":ls(a,t);break;case"select":e=a._wrapperState.wasMultiple,a._wrapperState.wasMultiple=!!t.multiple,r=t.value,r!=null?bn(a,!!t.multiple,r,!1):e!==!!t.multiple&&(t.defaultValue!=null?bn(a,!!t.multiple,t.defaultValue,!0):bn(a,!!t.multiple,t.multiple?[]:"",!1))}}}return;case 6:if(n.stateNode===null)throw Error(T(162));n.stateNode.nodeValue=n.memoizedProps;return;case 3:a=n.stateNode,a.hydrate&&(a.hydrate=!1,Bs(a.containerInfo));return;case 12:return;case 13:n.memoizedState!==null&&(Eo=ge(),yu(n.child,!0)),vu(n);return;case 19:vu(n);return;case 17:return;case 23:case 24:yu(n,n.memoizedState!==null);return}throw Error(T(163))}function vu(e){var n=e.updateQueue;if(n!==null){e.updateQueue=null;var a=e.stateNode;a===null&&(a=e.stateNode=new ac),n.forEach(function(t){var i=oc.bind(null,e,t);a.has(t)||(a.add(t),t.then(i,i))})}}function sc(e,n){return e!==null&&(e=e.memoizedState,e===null||e.dehydrated!==null)?(n=n.memoizedState,n!==null&&n.dehydrated===null):!1}var lc=Math.ceil,fi=kn.ReactCurrentDispatcher,Co=kn.ReactCurrentOwner,U=0,Se=null,te=null,pe=0,Wn=0,wo=nn(0),de=0,Si=null,da=0,Va=0,la=0,Mo=0,Oo=null,Eo=0,fo=Infinity;function ha(){fo=ge()+500}var M=null,pi=!1,To=null,He=null,cn=!1,rt=null,ot=90,Bo=[],Wo=[],Qe=null,st=0,No=null,yi=-1,je=0,ki=0,lt=null,Ti=!1;function ve(){return(U&48)!=0?ge():yi!==-1?yi:yi=ge()}function sn(e){if(e=e.mode,(e&2)==0)return 1;if((e&4)==0)return aa()===99?1:2;if(je===0&&(je=da),Jh.transition!==0){ki!==0&&(ki=Oo!==null?Oo.pendingLanes:0),e=je;var n=4186112&~ki;return n&=-n,n===0&&(e=4186112&~e,n=e&-e,n===0&&(n=8192)),n}return e=aa(),(U&4)!=0&&e===98?e=Gt(12,je):(e=qd(e),e=Gt(e,je)),e}function ln(e,n,a){if(50<st)throw st=0,No=null,Error(T(185));if(e=Ai(e,n),e===null)return null;Rt(e,n,a),e===Se&&(la|=n,de===4&&ua(e,pe));var t=aa();n===1?(U&8)!=0&&(U&48)==0?Po(e):(Be(e,a),U===0&&(ha(),De())):((U&4)==0||t!==98&&t!==99||(Qe===null?Qe=new Set([e]):Qe.add(e)),Be(e,a)),Oo=e}function Ai(e,n){e.lanes|=n;var a=e.alternate;for(a!==null&&(a.lanes|=n),a=e,e=e.return;e!==null;)e.childLanes|=n,a=e.alternate,a!==null&&(a.childLanes|=n),a=e,e=e.return;return a.tag===3?a.stateNode:null}function Be(e,n){for(var a=e.callbackNode,t=e.suspendedLanes,i=e.pingedLanes,r=e.expirationTimes,o=e.pendingLanes;0<o;){var s=31-Xe(o),l=1<<s,d=r[s];if(d===-1){if((l&t)==0||(l&i)!=0){d=n,jn(l);var k=j;r[s]=10<=k?d+250:6<=k?d+5e3:-1}}else d<=n&&(e.expiredLanes|=l);o&=~l}if(t=Da(e,e===Se?pe:0),n=j,t===0)a!==null&&(a!==xr&&Kr(a),e.callbackNode=null,e.callbackPriority=0);else{if(a!==null){if(e.callbackPriority===n)return;a!==xr&&Kr(a)}n===15?(a=Po.bind(null,e),Ke===null?(Ke=[a],qt=br(_t,Ol)):Ke.push(a),a=xr):n===14?a=ja(99,Po.bind(null,e)):(a=Zd(n),a=ja(a,Cu.bind(null,e))),e.callbackPriority=n,e.callbackNode=a}}function Cu(e){if(yi=-1,ki=je=0,(U&48)!=0)throw Error(T(327));var n=e.callbackNode;if(gn()&&e.callbackNode!==n)return null;var a=Da(e,e===Se?pe:0);if(a===0)return null;var t=a,i=U;U|=16;var r=Mu();(Se!==e||pe!==t)&&(ha(),ca(e,t));do try{uc();break}catch(s){wu(e,s)}while(1);if(jr(),fi.current=r,U=i,te!==null?t=0:(Se=null,pe=0,t=de),(da&la)!=0)ca(e,0);else if(t!==0){if(t===2&&(U|=64,e.hydrate&&(e.hydrate=!1,Ur(e.containerInfo)),a=Us(e),a!==0&&(t=ut(e,a))),t===1)throw n=Si,ca(e,0),ua(e,a),Be(e,ge()),n;switch(e.finishedWork=e.current.alternate,e.finishedLanes=a,t){case 0:case 1:throw Error(T(345));case 2:Nn(e);break;case 3:if(ua(e,a),(a&62914560)===a&&(t=Eo+500-ge(),10<t)){if(Da(e,0)!==0)break;if(i=e.suspendedLanes,(i&a)!==a){ve(),e.pingedLanes|=e.suspendedLanes&i;break}e.timeoutHandle=pl(Nn.bind(null,e),t);break}Nn(e);break;case 4:if(ua(e,a),(a&4186112)===a)break;for(t=e.eventTimes,i=-1;0<a;){var o=31-Xe(a);r=1<<o,o=t[o],o>i&&(i=o),a&=~r}if(a=i,a=ge()-a,a=(120>a?120:480>a?480:1080>a?1080:1920>a?1920:3e3>a?3e3:4320>a?4320:1960*lc(a/1960))-a,10<a){e.timeoutHandle=pl(Nn.bind(null,e),a);break}Nn(e);break;case 5:Nn(e);break;default:throw Error(T(329))}}return Be(e,ge()),e.callbackNode===n?Cu.bind(null,e):null}function ua(e,n){for(n&=~Mo,n&=~la,e.suspendedLanes|=n,e.pingedLanes&=~n,e=e.expirationTimes;0<n;){var a=31-Xe(n),t=1<<a;e[a]=-1,n&=~t}}function Po(e){if((U&48)!=0)throw Error(T(327));if(gn(),e===Se&&(e.expiredLanes&pe)!=0){var n=pe,a=ut(e,n);(da&la)!=0&&(n=Da(e,n),a=ut(e,n))}else n=Da(e,0),a=ut(e,n);if(e.tag!==0&&a===2&&(U|=64,e.hydrate&&(e.hydrate=!1,Ur(e.containerInfo)),n=Us(e),n!==0&&(a=ut(e,n))),a===1)throw a=Si,ca(e,0),ua(e,n),Be(e,ge()),a;return e.finishedWork=e.current.alternate,e.finishedLanes=n,Nn(e),Be(e,ge()),null}function dc(){if(Qe!==null){var e=Qe;Qe=null,e.forEach(function(n){n.expiredLanes|=24&n.pendingLanes,Be(n,ge())})}De()}function Ou(e,n){var a=U;U|=1;try{return e(n)}finally{U=a,U===0&&(ha(),De())}}function Bu(e,n){var a=U;U&=-2,U|=8;try{return e(n)}finally{U=a,U===0&&(ha(),De())}}function gi(e,n){_(wo,Wn),Wn|=n,da|=n}function So(){Wn=wo.current,J(wo)}function ca(e,n){e.finishedWork=null,e.finishedLanes=0;var a=e.timeoutHandle;if(a!==-1&&(e.timeoutHandle=-1,Kh(a)),te!==null)for(a=te.return;a!==null;){var t=a;switch(t.tag){case 1:t=t.type.childContextTypes,t!=null&&Jt();break;case 3:oa(),J(ke),J(ce),no();break;case 5:Xr(t);break;case 4:oa();break;case 13:J(q);break;case 19:J(q);break;case 10:Vr(t);break;case 23:case 24:So()}a=a.return}Se=e,te=un(e.current,null),pe=Wn=da=n,de=0,Si=null,Mo=la=Va=0}function wu(e,n){do{var a=te;try{if(jr(),Xa.current=ui,li){for(var t=X.memoizedState;t!==null;){var i=t.queue;i!==null&&(i.pending=null),t=t.next}li=!1}if($a=0,ue=me=X=null,et=!1,Co.current=null,a===null||a.return===null){de=1,Si=n,te=null;break}e:{var r=e,o=a.return,s=a,l=n;if(n=pe,s.flags|=2048,s.firstEffect=s.lastEffect=null,l!==null&&typeof l=="object"&&typeof l.then=="function"){var d=l;if((s.mode&2)==0){var k=s.alternate;k?(s.updateQueue=k.updateQueue,s.memoizedState=k.memoizedState,s.lanes=k.lanes):(s.updateQueue=null,s.memoizedState=null)}var N=(q.current&1)!=0,f=o;do{var C;if(C=f.tag===13){var P=f.memoizedState;if(P!==null)C=P.dehydrated!==null;else{var O=f.memoizedProps;C=O.fallback===void 0?!1:O.unstable_avoidThisFallback!==!0?!0:!N}}if(C){var c=f.updateQueue;if(c===null){var u=new Set;u.add(d),f.updateQueue=u}else c.add(d);if((f.mode&2)==0){if(f.flags|=64,s.flags|=16384,s.flags&=-2981,s.tag===1)if(s.alternate===null)s.tag=17;else{var h=rn(-1,1);h.tag=2,on(s,h)}s.lanes|=1;break e}l=void 0,s=n;var m=r.pingCache;if(m===null?(m=r.pingCache=new nc,l=new Set,m.set(d,l)):(l=m.get(d),l===void 0&&(l=new Set,m.set(d,l))),!l.has(s)){l.add(s);var p=hc.bind(null,r,d,s);d.then(p,p)}f.flags|=4096,f.lanes=n;break e}f=f.return}while(f!==null);l=Error((Hn(s.type)||"A React component")+` suspended while rendering, but no fallback UI was specified.

Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.`)}de!==5&&(de=2),l=yo(l,s),f=o;do{switch(f.tag){case 3:r=l,f.flags|=4096,n&=-n,f.lanes|=n;var G=mu(f,r,n);Nl(f,G);break e;case 1:r=l;var E=f.type,B=f.stateNode;if((f.flags&64)==0&&(typeof E.getDerivedStateFromError=="function"||B!==null&&typeof B.componentDidCatch=="function"&&(He===null||!He.has(B)))){f.flags|=4096,n&=-n,f.lanes|=n;var D=pu(f,r,n);Nl(f,D);break e}}f=f.return}while(f!==null)}Wu(a)}catch(R){n=R,te===a&&a!==null&&(te=a=a.return);continue}break}while(1)}function Mu(){var e=fi.current;return fi.current=ui,e===null?ui:e}function ut(e,n){var a=U;U|=16;var t=Mu();Se===e&&pe===n||ca(e,n);do try{cc();break}catch(i){wu(e,i)}while(1);if(jr(),U=a,fi.current=t,te!==null)throw Error(T(261));return Se=null,pe=0,de}function cc(){for(;te!==null;)Nu(te)}function uc(){for(;te!==null&&!Qh();)Nu(te)}function Nu(e){var n=Pu(e.alternate,e,Wn);e.memoizedProps=e.pendingProps,n===null?Wu(e):te=n,Co.current=null}function Wu(e){var n=e;do{var a=n.alternate;if(e=n.return,(n.flags&2048)==0){if(a=$h(a,n,Wn),a!==null){te=a;return}if(a=n,a.tag!==24&&a.tag!==23||a.memoizedState===null||(Wn&1073741824)!=0||(a.mode&4)==0){for(var t=0,i=a.child;i!==null;)t|=i.lanes|i.childLanes,i=i.sibling;a.childLanes=t}e!==null&&(e.flags&2048)==0&&(e.firstEffect===null&&(e.firstEffect=n.firstEffect),n.lastEffect!==null&&(e.lastEffect!==null&&(e.lastEffect.nextEffect=n.firstEffect),e.lastEffect=n.lastEffect),1<n.flags&&(e.lastEffect!==null?e.lastEffect.nextEffect=n:e.firstEffect=n,e.lastEffect=n))}else{if(a=ec(n),a!==null){a.flags&=2047,te=a;return}e!==null&&(e.firstEffect=e.lastEffect=null,e.flags|=2048)}if(n=n.sibling,n!==null){te=n;return}te=n=e}while(n!==null);de===0&&(de=5)}function Nn(e){var n=aa();return wn(99,gc.bind(null,e,n)),null}function gc(e,n){do gn();while(rt!==null);if((U&48)!=0)throw Error(T(327));var a=e.finishedWork;if(a===null)return null;if(e.finishedWork=null,e.finishedLanes=0,a===e.current)throw Error(T(177));e.callbackNode=null;var t=a.lanes|a.childLanes,i=t,r=e.pendingLanes&~i;e.pendingLanes=i,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=i,e.mutableReadLanes&=i,e.entangledLanes&=i,i=e.entanglements;for(var o=e.eventTimes,s=e.expirationTimes;0<r;){var l=31-Xe(r),d=1<<l;i[l]=0,o[l]=-1,s[l]=-1,r&=~d}if(Qe!==null&&(t&24)==0&&Qe.has(e)&&Qe.delete(e),e===Se&&(te=Se=null,pe=0),1<a.flags?a.lastEffect!==null?(a.lastEffect.nextEffect=a,t=a.firstEffect):t=a:t=a.firstEffect,t!==null){if(i=U,U|=32,Co.current=null,Gr=Dt,o=tl(),Br(o)){if("selectionStart"in o)s={start:o.selectionStart,end:o.selectionEnd};else e:if(s=(s=o.ownerDocument)&&s.defaultView||window,(d=s.getSelection&&s.getSelection())&&d.rangeCount!==0){s=d.anchorNode,r=d.anchorOffset,l=d.focusNode,d=d.focusOffset;try{s.nodeType,l.nodeType}catch(R){s=null;break e}var k=0,N=-1,f=-1,C=0,P=0,O=o,c=null;n:for(;;){for(var u;O!==s||r!==0&&O.nodeType!==3||(N=k+r),O!==l||d!==0&&O.nodeType!==3||(f=k+d),O.nodeType===3&&(k+=O.nodeValue.length),(u=O.firstChild)!==null;)c=O,O=u;for(;;){if(O===o)break n;if(c===s&&++C===r&&(N=k),c===l&&++P===d&&(f=k),(u=O.nextSibling)!==null)break;O=c,c=O.parentNode}O=u}s=N===-1||f===-1?null:{start:N,end:f}}else s=null;s=s||{start:0,end:0}}else s=null;Rr={focusedElem:o,selectionRange:s},Dt=!1,lt=null,Ti=!1,M=t;do try{mc()}catch(R){if(M===null)throw Error(T(330));hn(M,R),M=M.nextEffect}while(M!==null);lt=null,M=t;do try{for(o=e;M!==null;){var h=M.flags;if(h&16&&Ca(M.stateNode,""),h&128){var m=M.alternate;if(m!==null){var p=m.ref;p!==null&&(typeof p=="function"?p(null):p.current=null)}}switch(h&1038){case 2:Eu(M),M.flags&=-3;break;case 6:Eu(M),M.flags&=-3,vo(M.alternate,M);break;case 1024:M.flags&=-1025;break;case 1028:M.flags&=-1025,vo(M.alternate,M);break;case 4:vo(M.alternate,M);break;case 8:s=M,ku(o,s);var G=s.alternate;Au(s),G!==null&&Au(G)}M=M.nextEffect}}catch(R){if(M===null)throw Error(T(330));hn(M,R),M=M.nextEffect}while(M!==null);if(p=Rr,m=tl(),h=p.focusedElem,o=p.selectionRange,m!==h&&h&&h.ownerDocument&&al(h.ownerDocument.documentElement,h)){for(o!==null&&Br(h)&&(m=o.start,p=o.end,p===void 0&&(p=m),"selectionStart"in h?(h.selectionStart=m,h.selectionEnd=Math.min(p,h.value.length)):(p=(m=h.ownerDocument||document)&&m.defaultView||window,p.getSelection&&(p=p.getSelection(),s=h.textContent.length,G=Math.min(o.start,s),o=o.end===void 0?G:Math.min(o.end,s),!p.extend&&G>o&&(s=o,o=G,G=s),s=nl(h,G),r=nl(h,o),s&&r&&(p.rangeCount!==1||p.anchorNode!==s.node||p.anchorOffset!==s.offset||p.focusNode!==r.node||p.focusOffset!==r.offset)&&(m=m.createRange(),m.setStart(s.node,s.offset),p.removeAllRanges(),G>o?(p.addRange(m),p.extend(r.node,r.offset)):(m.setEnd(r.node,r.offset),p.addRange(m)))))),m=[],p=h;p=p.parentNode;)p.nodeType===1&&m.push({element:p,left:p.scrollLeft,top:p.scrollTop});for(typeof h.focus=="function"&&h.focus(),h=0;h<m.length;h++)p=m[h],p.element.scrollLeft=p.left,p.element.scrollTop=p.top}Dt=!!Gr,Rr=Gr=null,e.current=a,M=t;do try{for(h=e;M!==null;){var E=M.flags;if(E&36&&rc(h,M.alternate,M),E&128){m=void 0;var B=M.ref;if(B!==null){var D=M.stateNode;switch(M.tag){case 5:m=D;break;default:m=D}typeof B=="function"?B(m):B.current=m}}M=M.nextEffect}}catch(R){if(M===null)throw Error(T(330));hn(M,R),M=M.nextEffect}while(M!==null);M=null,Vh(),U=i}else e.current=a;if(cn)cn=!1,rt=e,ot=n;else for(M=t;M!==null;)n=M.nextEffect,M.nextEffect=null,M.flags&8&&(E=M,E.sibling=null,E.stateNode=null),M=n;if(t=e.pendingLanes,t===0&&(He=null),t===1?e===No?st++:(st=0,No=e):st=0,a=a.stateNode,Cn&&typeof Cn.onCommitFiberRoot=="function")try{Cn.onCommitFiberRoot(Hr,a,void 0,(a.current.flags&64)==64)}catch(R){}if(Be(e,ge()),pi)throw pi=!1,e=To,To=null,e;return(U&8)!=0||De(),null}function mc(){for(;M!==null;){var e=M.alternate;Ti||lt===null||((M.flags&8)!=0?Is(M,lt)&&(Ti=!0):M.tag===13&&sc(e,M)&&Is(M,lt)&&(Ti=!0));var n=M.flags;(n&256)!=0&&tc(e,M),(n&512)==0||cn||(cn=!0,ja(97,function(){return gn(),null})),M=M.nextEffect}}function gn(){if(ot!==90){var e=97<ot?97:ot;return ot=90,wn(e,pc)}return!1}function ic(e,n){Bo.push(n,e),cn||(cn=!0,ja(97,function(){return gn(),null}))}function Su(e,n){Wo.push(n,e),cn||(cn=!0,ja(97,function(){return gn(),null}))}function pc(){if(rt===null)return!1;var e=rt;if(rt=null,(U&48)!=0)throw Error(T(331));var n=U;U|=32;var a=Wo;Wo=[];for(var t=0;t<a.length;t+=2){var i=a[t],r=a[t+1],o=i.destroy;if(i.destroy=void 0,typeof o=="function")try{o()}catch(l){if(r===null)throw Error(T(330));hn(r,l)}}for(a=Bo,Bo=[],t=0;t<a.length;t+=2){i=a[t],r=a[t+1];try{var s=i.create;i.destroy=s()}catch(l){if(r===null)throw Error(T(330));hn(r,l)}}for(s=e.current.firstEffect;s!==null;)e=s.nextEffect,s.nextEffect=null,s.flags&8&&(s.sibling=null,s.stateNode=null),s=e;return U=n,De(),!0}function Gu(e,n,a){n=yo(a,n),n=mu(e,n,1),on(e,n),n=ve(),e=Ai(e,1),e!==null&&(Rt(e,1,n),Be(e,n))}function hn(e,n){if(e.tag===3)Gu(e,e,n);else for(var a=e.return;a!==null;){if(a.tag===3){Gu(a,e,n);break}else if(a.tag===1){var t=a.stateNode;if(typeof a.type.getDerivedStateFromError=="function"||typeof t.componentDidCatch=="function"&&(He===null||!He.has(t))){e=yo(n,e);var i=pu(a,e,1);if(on(a,i),i=ve(),a=Ai(a,1),a!==null)Rt(a,1,i),Be(a,i);else if(typeof t.componentDidCatch=="function"&&(He===null||!He.has(t)))try{t.componentDidCatch(n,e)}catch(r){}break}}a=a.return}}function hc(e,n,a){var t=e.pingCache;t!==null&&t.delete(n),n=ve(),e.pingedLanes|=e.suspendedLanes&a,Se===e&&(pe&a)===a&&(de===4||de===3&&(pe&62914560)===pe&&500>ge()-Eo?ca(e,0):Mo|=a),Be(e,n)}function oc(e,n){var a=e.stateNode;a!==null&&a.delete(n),n=0,n===0&&(n=e.mode,(n&2)==0?n=1:(n&4)==0?n=aa()===99?1:2:(je===0&&(je=da),n=Vn(62914560&~je),n===0&&(n=4194304))),a=ve(),e=Ai(e,n),e!==null&&(Rt(e,n,a),Be(e,a))}var Pu;Pu=function(e,n,a){var t=n.lanes;if(e!==null)if(e.memoizedProps!==n.pendingProps||ke.current)Ge=!0;else if((a&t)!=0)Ge=(e.flags&16384)!=0;else{switch(Ge=!1,n.tag){case 3:iu(n),eo();break;case 5:Hl(n);break;case 1:Te(n.type)&&zt(n);break;case 4:Zr(n,n.stateNode.containerInfo);break;case 10:t=n.memoizedProps.value;var i=n.type._context;_(Zt,i._currentValue),i._currentValue=t;break;case 13:if(n.memoizedState!==null)return(a&n.child.childLanes)!=0?lu(e,n,a):(_(q,q.current&1),n=xe(e,n,a),n!==null?n.sibling:null);_(q,q.current&1);break;case 19:if(t=(a&n.childLanes)!=0,(e.flags&64)!=0){if(t)return du(e,n,a);n.flags|=64}if(i=n.memoizedState,i!==null&&(i.rendering=null,i.tail=null,i.lastEffect=null),_(q,q.current),t)break;return null;case 23:case 24:return n.lanes=0,ho(e,n,a)}return xe(e,n,a)}else Ge=!1;switch(n.lanes=0,n.tag){case 2:if(t=n.type,e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,i=na(n,ce.current),ia(n,a),i=to(null,n,t,e,i,a),n.flags|=1,typeof i=="object"&&i!==null&&typeof i.render=="function"&&i.$$typeof===void 0){if(n.tag=1,n.memoizedState=null,n.updateQueue=null,Te(t)){var r=!0;zt(n)}else r=!1;n.memoizedState=i.state!==null&&i.state!==void 0?i.state:null,Jr(n);var o=t.getDerivedStateFromProps;typeof o=="function"&&ei(n,t,o,e),i.updater=ni,n.stateNode=i,i._reactInternals=n,zr(n,t,e,a),n=co(null,n,t,!0,r,a)}else n.tag=0,Ie(null,n,i,a),n=n.child;return n;case 16:i=n.elementType;e:{switch(e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,r=i._init,i=r(i._payload),n.type=i,r=n.tag=fc(i),e=Pe(i,e),r){case 0:n=uo(null,n,i,e,a);break e;case 1:n=tu(null,n,i,e,a);break e;case 11:n=$l(null,n,i,e,a);break e;case 14:n=nu(null,n,i,Pe(i.type,e),t,a);break e}throw Error(T(306,i,""))}return n;case 0:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Pe(t,i),uo(e,n,t,i,a);case 1:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Pe(t,i),tu(e,n,t,i,a);case 3:if(iu(n),t=n.updateQueue,e===null||t===null)throw Error(T(282));if(t=n.pendingProps,i=n.memoizedState,i=i!==null?i.element:null,Wl(e,n),Ja(n,t,null,a),t=n.memoizedState.element,t===i)eo(),n=xe(e,n,a);else{if(i=n.stateNode,(r=i.hydrate)&&(dn=$n(n.stateNode.containerInfo.firstChild),Ye=n,r=Le=!0),r){if(e=i.mutableSourceEagerHydrationData,e!=null)for(i=0;i<e.length;i+=2)r=e[i],r._workInProgressVersionPrimary=e[i+1],sa.push(r);for(a=Fl(n,null,t,a),n.child=a;a;)a.flags=a.flags&-3|1024,a=a.sibling}else Ie(e,n,t,a),eo();n=n.child}return n;case 5:return Hl(n),e===null&&$r(n),t=n.type,i=n.pendingProps,r=e!==null?e.memoizedProps:null,o=i.children,Dr(t,i)?o=null:r!==null&&Dr(t,r)&&(n.flags|=16),au(e,n),Ie(e,n,o,a),n.child;case 6:return e===null&&$r(n),null;case 13:return lu(e,n,a);case 4:return Zr(n,n.stateNode.containerInfo),t=n.pendingProps,e===null?n.child=ri(n,null,t,a):Ie(e,n,t,a),n.child;case 11:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Pe(t,i),$l(e,n,t,i,a);case 7:return Ie(e,n,n.pendingProps,a),n.child;case 8:return Ie(e,n,n.pendingProps.children,a),n.child;case 12:return Ie(e,n,n.pendingProps.children,a),n.child;case 10:e:{t=n.type._context,i=n.pendingProps,o=n.memoizedProps,r=i.value;var s=n.type._context;if(_(Zt,s._currentValue),s._currentValue=r,o!==null)if(s=o.value,r=Ce(s,r)?0:(typeof t._calculateChangedBits=="function"?t._calculateChangedBits(s,r):1073741823)|0,r===0){if(o.children===i.children&&!ke.current){n=xe(e,n,a);break e}}else for(s=n.child,s!==null&&(s.return=n);s!==null;){var l=s.dependencies;if(l!==null){o=s.child;for(var d=l.firstContext;d!==null;){if(d.context===t&&(d.observedBits&r)!=0){s.tag===1&&(d=rn(-1,a&-a),d.tag=2,on(s,d)),s.lanes|=a,d=s.alternate,d!==null&&(d.lanes|=a),Bl(s.return,a),l.lanes|=a;break}d=d.next}}else o=s.tag===10&&s.type===n.type?null:s.child;if(o!==null)o.return=s;else for(o=s;o!==null;){if(o===n){o=null;break}if(s=o.sibling,s!==null){s.return=o.return,o=s;break}o=o.return}s=o}Ie(e,n,i.children,a),n=n.child}return n;case 9:return i=n.type,r=n.pendingProps,t=r.children,ia(n,a),i=we(i,r.unstable_observedBits),t=t(i),n.flags|=1,Ie(e,n,t,a),n.child;case 14:return i=n.type,r=Pe(i,n.pendingProps),r=Pe(i.type,r),nu(e,n,i,r,t,a);case 15:return eu(e,n,n.type,n.pendingProps,t,a);case 17:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Pe(t,i),e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),n.tag=1,Te(t)?(e=!0,zt(n)):e=!1,ia(n,a),Dl(n,t,i),zr(n,t,i,a),co(null,n,t,!0,e,a);case 19:return du(e,n,a);case 23:return ho(e,n,a);case 24:return ho(e,n,a)}throw Error(T(156,n.tag))};function Sc(e,n,a,t){this.tag=e,this.key=a,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=n,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=t,this.flags=0,this.lastEffect=this.firstEffect=this.nextEffect=null,this.childLanes=this.lanes=0,this.alternate=null}function Me(e,n,a,t){return new Sc(e,n,a,t)}function lo(e){return e=e.prototype,!(!e||!e.isReactComponent)}function fc(e){if(typeof e=="function")return lo(e)?1:0;if(e!=null){if(e=e.$$typeof,e===Tt)return 11;if(e===It)return 14}return 2}function un(e,n){var a=e.alternate;return a===null?(a=Me(e.tag,n,e.key,e.mode),a.elementType=e.elementType,a.type=e.type,a.stateNode=e.stateNode,a.alternate=e,e.alternate=a):(a.pendingProps=n,a.type=e.type,a.flags=0,a.nextEffect=null,a.firstEffect=null,a.lastEffect=null),a.childLanes=e.childLanes,a.lanes=e.lanes,a.child=e.child,a.memoizedProps=e.memoizedProps,a.memoizedState=e.memoizedState,a.updateQueue=e.updateQueue,n=e.dependencies,a.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext},a.sibling=e.sibling,a.index=e.index,a.ref=e.ref,a}function ii(e,n,a,t,i,r){var o=2;if(t=e,typeof e=="function")lo(e)&&(o=1);else if(typeof e=="string")o=5;else e:switch(e){case Je:return ra(a.children,i,r,n);case es:o=8,i|=16;break;case Hi:o=8,i|=1;break;case Aa:return e=Me(12,a,n,i|8),e.elementType=Aa,e.type=Aa,e.lanes=r,e;case Ia:return e=Me(13,a,n,i),e.type=Ia,e.elementType=Ia,e.lanes=r,e;case At:return e=Me(19,a,n,i),e.elementType=At,e.lanes=r,e;case ji:return go(a,i,r,n);case Vi:return e=Me(24,a,n,i),e.elementType=Vi,e.lanes=r,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case bi:o=10;break e;case Ki:o=9;break e;case Tt:o=11;break e;case It:o=14;break e;case Yi:o=16,t=null;break e;case xi:o=22;break e}throw Error(T(130,e==null?e:typeof e,""))}return n=Me(o,a,n,i),n.elementType=e,n.type=t,n.lanes=r,n}function ra(e,n,a,t){return e=Me(7,e,t,n),e.lanes=a,e}function go(e,n,a,t){return e=Me(23,e,t,n),e.elementType=ji,e.lanes=a,e}function _r(e,n,a){return e=Me(6,e,null,n),e.lanes=a,e}function qr(e,n,a){return n=Me(4,e.children!==null?e.children:[],e.key,n),n.lanes=a,n.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},n}function yc(e,n,a){this.tag=n,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.pendingContext=this.context=null,this.hydrate=a,this.callbackNode=null,this.callbackPriority=0,this.eventTimes=kr(0),this.expirationTimes=kr(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=kr(0),this.mutableSourceEagerHydrationData=null}function kc(e,n,a){var t=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:Tn,key:t==null?null:""+t,children:e,containerInfo:n,implementation:a}}function Ii(e,n,a,t){var i=n.current,r=ve(),o=sn(i);e:if(a){a=a._reactInternals;n:{if(In(a)!==a||a.tag!==1)throw Error(T(170));var s=a;do{switch(s.tag){case 3:s=s.stateNode.context;break n;case 1:if(Te(s.type)){s=s.stateNode.__reactInternalMemoizedMergedChildContext;break n}}s=s.return}while(s!==null);throw Error(T(171))}if(a.tag===1){var l=a.type;if(Te(l)){a=kl(a,l,s);break e}}a=s}else a=an;return n.context===null?n.context=a:n.pendingContext=a,n=rn(r,o),n.payload={element:e},t=t===void 0?null:t,t!==null&&(n.callback=t),on(i,n),ln(i,o,r),o}function Go(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function Ru(e,n){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var a=e.retryLane;e.retryLane=a!==0&&a<n?a:n}}function Ro(e,n){Ru(e,n),(e=e.alternate)&&Ru(e,n)}function Tc(){return null}function Do(e,n,a){var t=a!=null&&a.hydrationOptions!=null&&a.hydrationOptions.mutableSources||null;if(a=new yc(e,n,a!=null&&a.hydrate===!0),n=Me(3,null,null,n===2?7:n===1?3:0),a.current=n,n.stateNode=a,Jr(n),e[Xn]=a.current,cl(e.nodeType===8?e.parentNode:e),t)for(e=0;e<t.length;e++){n=t[e];var i=n._getVersion;i=i(n._source),a.mutableSourceEagerHydrationData==null?a.mutableSourceEagerHydrationData=[n,i]:a.mutableSourceEagerHydrationData.push(n,i)}this._internalRoot=a}Do.prototype.render=function(e){Ii(e,this._internalRoot,null,null)};Do.prototype.unmount=function(){var e=this._internalRoot,n=e.containerInfo;Ii(null,e,null,function(){n[Xn]=null})};function dt(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function Ac(e,n){if(n||(n=e?e.nodeType===9?e.documentElement:e.firstChild:null,n=!(!n||n.nodeType!==1||!n.hasAttribute("data-reactroot"))),!n)for(var a;a=e.lastChild;)e.removeChild(a);return new Do(e,0,n?{hydrate:!0}:void 0)}function Ei(e,n,a,t,i){var r=a._reactRootContainer;if(r){var o=r._internalRoot;if(typeof i=="function"){var s=i;i=function(){var d=Go(o);s.call(d)}}Ii(n,o,e,i)}else{if(r=a._reactRootContainer=Ac(a,t),o=r._internalRoot,typeof i=="function"){var l=i;i=function(){var d=Go(o);l.call(d)}}Bu(function(){Ii(n,o,e,i)})}return Go(o)}Es=function(e){if(e.tag===13){var n=ve();ln(e,4,n),Ro(e,4)}};cr=function(e){if(e.tag===13){var n=ve();ln(e,67108864,n),Ro(e,67108864)}};vs=function(e){if(e.tag===13){var n=ve(),a=sn(e);ln(e,a,n),Ro(e,a)}};Cs=function(e,n){return n()};rr=function(e,n,a){switch(n){case"input":if(Zi(e,a),n=a.name,a.type==="radio"&&n!=null){for(a=e;a.parentNode;)a=a.parentNode;for(a=a.querySelectorAll("input[name="+JSON.stringify(""+n)+'][type="radio"]'),n=0;n<a.length;n++){var t=a[n];if(t!==e&&t.form===e.form){var i=Mt(t);if(!i)throw Error(T(90));ts(t),Zi(t,i)}}}break;case"textarea":ls(e,a);break;case"select":n=a.value,n!=null&&bn(e,!!a.multiple,n,!1)}};or=Ou;Ss=function(e,n,a,t,i){var r=U;U|=4;try{return wn(98,e.bind(null,n,a,t,i))}finally{U=r,U===0&&(ha(),De())}};sr=function(){(U&49)==0&&(dc(),gn())};ys=function(e,n){var a=U;U|=2;try{return e(n)}finally{U=a,U===0&&(ha(),De())}};function Du(e,n){var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!dt(n))throw Error(T(200));return kc(e,n,null,a)}var Ic={Events:[Ma,_n,Mt,ps,fs,gn,{current:!1}]},ht={findFiberByHostInstance:En,bundleType:0,version:"17.0.2",rendererPackageName:"react-dom"},Ec={bundleType:ht.bundleType,version:ht.version,rendererPackageName:ht.rendererPackageName,rendererConfig:ht.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:kn.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=As(e),e===null?null:e.stateNode},findFiberByHostInstance:ht.findFiberByHostInstance||Tc,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__!="undefined"&&(ct=__REACT_DEVTOOLS_GLOBAL_HOOK__,!ct.isDisabled&&ct.supportsFiber))try{Hr=ct.inject(Ec),Cn=ct}catch(e){}var ct,vc=Ic,Cc=Du,wc=function(e){if(e==null)return null;if(e.nodeType===1)return e;var n=e._reactInternals;if(n===void 0)throw typeof e.render=="function"?Error(T(188)):Error(T(268,Object.keys(e)));return e=As(n),e=e===null?null:e.stateNode,e},Mc=function(e,n){var a=U;if((a&48)!=0)return e(n);U|=1;try{if(e)return wn(99,e.bind(null,n))}finally{U=a,De()}},Oc=function(e,n,a){if(!dt(n))throw Error(T(200));return Ei(null,e,n,!0,a)},Bc=function(e,n,a){if(!dt(n))throw Error(T(200));return Ei(null,e,n,!1,a)},Wc=function(e){if(!dt(e))throw Error(T(40));return e._reactRootContainer?(Bu(function(){Ei(null,null,e,!1,function(){e._reactRootContainer=null,e[Xn]=null})}),!0):!1},Nc=Ou,Pc=function(e,n){return Du(e,n,2<arguments.length&&arguments[2]!==void 0?arguments[2]:null)},Gc=function(e,n,a,t){if(!dt(a))throw Error(T(200));if(e==null||e._reactInternals===void 0)throw Error(T(38));return Ei(e,n,a,!1,t)},Rc="17.0.2",Dc={__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:vc,createPortal:Cc,findDOMNode:wc,flushSync:Mc,hydrate:Oc,render:Bc,unmountComponentAtNode:Wc,unstable_batchedUpdates:Nc,unstable_createPortal:Pc,unstable_renderSubtreeIntoContainer:Gc,version:Rc},Uc=Ve(function(e){function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__=="undefined"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(a){console.error(a)}}n(),e.exports=Dc}),Uo=Uc.render;var Lo=Symbol(),Fo=Symbol(),Ho=Symbol(),vi=Symbol();function Pn(e,n){function a(...t){if(t.length>=e.length)return e(...t);{let i=(...r)=>a(...t,...r);return i[Lo]=e,i[Fo]=a,i[Ho]=t,i[vi]=a[vi],i}}return a[Lo]=e,a[Fo]=a,a[Ho]=[],a[vi]=n||Uu(e),a}function bo(e){return e[Lo]}function Lc(e){return e[Fo]}function Ci(e){return e[Ho]||[]}function Uu(e){return e[vi]||e.name}function Hc(){let e=[];return{test:n,getAllTests:a};function n(t,i){e.push(...Object.entries(i).map(([r,o])=>Fc(t,r,o)))}function a(){return e}}function S(e,n,...a){let t=n(...a,e);if(typeof t=="function")throw new Error("The matcher function `"+Ko(t)+"` returned a function instead of a boolean. You might need to pass another argument to it.");if(!t)throw new wi([e,n,...a])}function Fc(e,n,a){return{subject:e,scenario:n,fn:a}}var wi=class extends Error{constructor(n){super("Expectation failed");this.expectArgs=n}};function bc(e){return e[e.length-1]}function Lu(e){return e[0]}var Kc=Pn(function(e,n){return e(n)},"which"),K=Pn(function(e,n){var a,t;if(Yc(e))return e(n);if(Array.isArray(e)&&Array.isArray(n))return e.length===n.length&&e.every((i,r)=>K(e[r],n[r]));if(e instanceof Function&&n instanceof Function)return bo(e)&&bo(e)===bo(n)?K(Ci(e),Ci(n)):e===n;if(e instanceof Date&&n instanceof Date)return e.toISOString()===n.toISOString();if(e instanceof Set&&n instanceof Set)return e.size===n.size&&[...e.values()].every(i=>n.has(i));if(e instanceof Error&&n instanceof Error)return e.message===n.message&&e.__proto__.constructor===n.__proto__.constructor;if(Fu(e)&&Fu(n)){let i=Object.keys(e),r=Object.keys(n);return i.length===r.length&&i.every(o=>K(e[o],n[o]))&&((a=e.__proto__)==null?void 0:a.constructor)===((t=n.__proto__)==null?void 0:t.constructor)}return e===n},"equals"),I=Pn(function(e,n){return e===n},"is"),Yo=Pn(function(e,n,...a){return!e(n,...a)},"not"),Hu=Pn(function(e){return/^\s*$/.test(e)},"isBlank");function Fu(e){return!!e&&typeof e=="object"}function Yc(e){return e instanceof Function&&Lc(e)===Kc&&Ci(e).length===1}function Ko(e){return Uu(e)||"<function>"}function Ku(e){let n=[];return a(e);function a(l){var d;if(l===null)return"null";if(typeof l=="function")return t(l,i);if(typeof l=="string")return xo(l);if(typeof l=="bigint")return`${l}n`;if(Array.isArray(l))return t(l,r);if(l instanceof Date)return`Date(${l.toISOString().replace("T"," ").replace("Z"," UTC")})`;if(l instanceof RegExp)return String(l);if(l instanceof Error)return`${bu(l)}(${xo(l.message)})`;if(l instanceof Set)return t(l,s);if(typeof l=="object"){let k=(d=l==null?void 0:l.__proto__)==null?void 0:d.constructor;return k===Object||!k?t(l,o):`${bu(l)} ${t(l,o)}`}return String(l)}function t(l,d){if(n.indexOf(l)>-1)return"<circular reference>";n.push(l);let k=d(l);return n.pop(),k}function i(l){let d=Ci(l).map(a),k=Ko(l);return d.length?gt(k+"(",d,",",")"):k}function r(l){return gt("[",l.map(a),",","]")}function o(l){let d=Object.entries(l).map(([k,N])=>`${xc(k)}: ${a(N)}`);return gt("{",d,",","}")}function s(l){let d=[...l.values()].map(a);return gt("Set {",d,",","}")}}function xc(e){return/^[a-zA-Z0-9_$]+$/.test(e)?e:xo(e)}function bu(e){return Ko(e.__proto__.constructor)}function xo(e){return'"'+String(e).replace(/\\/g,"\\\\").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/"/g,'\\"').replace(/[\x00-\x1f\x7f]/g,Qc)+'"'}function Qc(e){let n=e.charCodeAt(0).toString(16);return"\\x"+(n.length<2?"0"+n:n)}function Mi(e,n){return n.split(`
`).map(a=>a&&Vc(jc(e," "))(a)).join(`
`)}function jc(e,n){return Array(e+1).join(n)}var Vc=e=>n=>e+n,Jc=Pn(function(n,a){return a.slice(0,n.length)===n?a.slice(n.length):a});function zc(e){return String(e).split(/\r?\n/)}function _c(e){let n=zc(e);Hu(Lu(n))&&n.shift(),Hu(bc(n))&&n.pop();let a=/^[ \t]*/.exec(Lu(n))[0];return n.map(Jc(a)).join(`
`)}function gt(e,n,a,t){return n.length<2?e+n.join("")+t:e+`
`+Mi(2,n.join(a+`
`))+`
`+t}function xu(e){return kt(this,null,function*(){let n=[];for(let a of e){let t=yield qc(a.fn),i=Yu.map(r=>({type:"debug",args:r}));Yu.length=0,n.push({test:a,error:t,instrumentLog:i})}return{results:n}})}function qc(e){let n;try{let a=e();if(a instanceof Promise)return new Promise(t=>{a.then(()=>t()).catch(t)})}catch(a){n=a}return Promise.resolve(n)}var Yu=[],dm=Pn(function(n,a){return a instanceof wi&&K(n,a.expectArgs)}),Oi=`

`;function Qu({results:e}){let n=!1,a=!1,t=[];for(let i of e){let r=!1;i.error&&(r=n=!0),i.instrumentLog.length&&(r=a=!0),r&&t.push(i)}return n?Zc(t):a?$c(e.length,t):Xc(e.length)}function Zc(e){return e.map(ju).join(Oi)+Oi+"Tests failed."}function Xc(e){switch(e){case 0:return"No tests to run.";case 1:return"One test ran, and found no issues.";default:return`${e} tests ran, and found no issues.`}}function $c(e,n){return n.map(ju).join(Oi)+Oi+eg(e)+`, but debugging instrumentation is present.
Remove it before shipping.`}function eg(e){switch(e){case 1:return"The test passed";case 2:return"Both tests passed";default:return`All ${e} tests passed`}}function ju({test:e,error:n,instrumentLog:a}){let i=[e.subject+" "+e.scenario];return a.length&&i.push(Mi(2,ag(a))),n&&i.push(Mi(2,ng(n))),i.join(`
`)}function ng(e){return e instanceof wi?tg(e):ig(e)}function ag(e){return e.map(({args:n})=>Vu("debug",n)).join("")}function tg(e){return Vu("expect",e.expectArgs)}function ig(e){return Ku(e)+" thrown"+Mi(2,rg(e.stack))}function Vu(e,n){return gt(e+"(",n.map(Ku),",",")")}function rg(e){if(!e)return"";let n=_c(e).split(`
`);return`
`+n.slice(0,og(n)).map(a=>a.replace(/(file:\/\/|http:\/\/[^/]*)/,"").replace(/^([^@]*)@(.*)$/,"at $1 ($2)")).join(`
`)}function og(e){let n=e.findIndex(a=>a.includes("errorFrom"));return n===-1?e.length:n}var hm=Object.freeze({test:{subject:"a thing",scenario:"does something",fn(){}},error:void 0,instrumentLog:[]}),sg=Hc(),{getAllTests:Ju}=sg;function Z(...e){}function mn(){return(+new Date%1e6/1e3).toFixed(3)}function x(e,n=0){return isNaN(e)||e===Infinity||e===-Infinity?"--:--":e<0?"-"+zu(-e,n):zu(e,n)}function zu(e,n){function a(o,s=lg){return(o<10?"0":"")+s(o)}let t=Math.floor(e/3600),i=Math.floor(e%3600/60),r=e%60;return t>0?`${t}:${a(i)}:${a(r,_u(n))}`:`${i}:${a(r,_u(n))}`}Z("hoursMinutesSeconds",{"formats NaN"(){S(x(0/0),I,"--:--")},"formats Infinities"(){S(x(Infinity),I,"--:--"),S(x(-Infinity),I,"--:--")},"formats negative numbers"(){S(x(-1),I,"-0:01"),S(x(-3661.12,2),I,"-1:01:01.12")},"formats single-digit seconds with leading zero"(){S(x(0),I,"0:00"),S(x(1),I,"0:01"),S(x(9),I,"0:09")},"formats double-digit seconds"(){S(x(10),I,"0:10"),S(x(59),I,"0:59")},"formats minutes"(){S(x(60),I,"1:00"),S(x(61),I,"1:01"),S(x(119),I,"1:59"),S(x(120),I,"2:00"),S(x(3599),I,"59:59")},"formats hours"(){S(x(3600),I,"1:00:00"),S(x(7200),I,"2:00:00"),S(x(3661),I,"1:01:01"),S(x(3610),I,"1:00:10"),S(x(3600+600),I,"1:10:00"),S(x(36001),I,"10:00:01")},"adds decimal places"(){S(x(0,0),I,"0:00"),S(x(0,1),I,"0:00.0"),S(x(0,2),I,"0:00.00")},"formats fractional seconds"(){S(x(1.23,2),I,"0:01.23")},"rounds decimals"(){S(x(2.3456,2),I,"0:02.35")}});var lg=e=>e,_u=e=>n=>n.toFixed(e);function ga(e){var n;return(n=/v=(.{11})/.exec(e))==null?void 0:n[1]}function qu(){return{getPlayerState(){return re.UNSTARTED},getCurrentTime(){return 0},getVideoUrl(){return""},cueVideoById(){},playVideo(){},seekTo(){},getDuration(){return 0},addEventListener(){},removeEventListener(){}}}function Zu(e){return{getPlayerState(){return e.getPlayerState()},getCurrentTime(){return e.getCurrentTime()},getVideoUrl(){return e.getVideoUrl()},cueVideoById(...n){return console.debug(mn(),"player.cueVideoById",...n),e.cueVideoById(...n)},playVideo(...n){return console.debug(mn(),"player.playVideo",...n),e.playVideo(...n)},seekTo(...n){return console.debug(mn(),"player.seekTo",...n,ga(e.getVideoUrl())),e.seekTo(...n)},getDuration(){return e.getDuration()},addEventListener(...n){return console.debug(mn(),"player.addEventListener"),e.addEventListener(...n)},removeEventListener(...n){return console.debug(mn(),"player.removeEventListener"),e.removeEventListener(...n)}}}var re={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};function Xu(e){return kt(this,null,function*(){let n=yield ug();return new Promise(a=>{let t=new n.Player(e,{height:450,width:800,videoId:null,playerVars:{controls:0,disablekb:1},events:{onReady(){a(t)}}})})})}function ug(){return $u?Promise.resolve(window.YT):new Promise(e=>{var n;if(document.querySelector("script[src='https://www.youtube.com/iframe_api']")===null){let a=document.createElement("script");a.src="https://www.youtube.com/iframe_api";let t=document.getElementsByTagName("script")[0];(n=t.parentNode)==null||n.insertBefore(a,t)}Qo.push(e)})}var $u=!1,Qo=[];window.onYouTubeIframeAPIReady=()=>{$u=!0,Qo.forEach(e=>e(window.YT)),Qo.length=0};function ed(e,n){let a=ya(),t=ya();t.current=e,Ln(()=>(a.current=setInterval(()=>{var i;return(i=t.current)==null?void 0:i.call(t)},n),()=>clearInterval(a.current)),[n])}function nd(){let[e,n]=Ne(!1);return[e,()=>n(!0)]}function mt(e){switch(e){case re.BUFFERING:return"buffering";case re.UNSTARTED:return"unstarted";case re.CUED:return"cued";case re.ENDED:return"ended";case re.PLAYING:return"playing";case re.PAUSED:return"paused";default:return""}}function ad(e){return e.channel.getName()+" "+mt(e.code)}function pt(e){try{e()}catch(n){return n}}function ma(e,n){if(e.length===0)throw new Error("can't pick element from an empty array");if(n>=1||n<0)throw new Error("fraction out of bounds: "+n);return e[Math.floor(n*e.length)]}Z("pick",{"throws if the array is empty"(){S(pt(()=>ma([],0)),K,new Error("can't pick element from an empty array"))},"throws if the fraction is 1"(){S(pt(()=>ma([""],1)),K,new Error("fraction out of bounds: 1"))},"throws if the fraction is > 1"(){S(pt(()=>ma([""],1.25)),K,new Error("fraction out of bounds: 1.25"))},"throws if the fraction is > 0"(){S(pt(()=>ma([""],-.25)),K,new Error("fraction out of bounds: -0.25"))},"picks the first element of the array given 0"(){S(ma([1,2],0),I,1)},"picks the last element of the array given 1 - epsilon"(){S(ma([1,2],.99),I,2)}});function Bi(e){return e.length===0}function pa(e,n){let a={};return t=>(t in a||(Object.keys(a).length===e&&(a={}),a[t]=n(t)),a[t])}Z("cache",{"caches a value"(){let e=0,n=pa(1,()=>(e++,123));n("foo"),n("foo"),S(e,I,1)},"computes and caches values by key"(){let e=pa(2,n=>n+"x");S(e("foo"),I,"foox"),S(e("bar"),I,"barx")},"caches multiple values"(){let e=0,n=pa(2,a=>(e++,a+"x"));n("foo"),n("foo"),n("bar"),n("bar"),S(e,I,2),S(n("foo"),I,"foox"),S(n("bar"),I,"barx")},"a max size of 0 means no limit"(){let e=0,n=pa(0,()=>(e++,123));n("a"),n("b"),n("c"),S(e,I,3)}});function ft(e){let n=1779033703,a=3144134277,t=1013904242,i=2773480762;for(let r=0,o;r<e.length;r++)o=e.charCodeAt(r),n=a^Math.imul(n^o,597399067),a=t^Math.imul(a^o,2869860233),t=i^Math.imul(t^o,951274213),i=n^Math.imul(i^o,2716044179);return n=Math.imul(t^n>>>18,597399067),a=Math.imul(i^a>>>22,2869860233),t=Math.imul(n^t>>>17,951274213),i=Math.imul(a^i>>>19,2716044179),[(n^a^t^i)>>>0,(a^n)>>>0,(t^n)>>>0,(i^n)>>>0]}Z("cyrb128_32",{"hashes unix timestamps to random-looking values"(){S(ft("1661673600"),K,[1866196007,1194674827,898714046,497018642]),S(ft("1661760000"),K,[3655929289,901600698,732811234,3355023249]),S(ft("1661846400"),K,[2165297363,2940322590,3636107238,4143219755])}});function Wi(e,n,a,t){function i(){e|=0,n|=0,a|=0,t|=0;var r=(e+n|0)+t|0;return t=t+1|0,e=n^n>>>9,n=a+(a<<3)|0,a=a<<21|a>>>11,a=a+r|0,(r>>>0)/4294967296}for(let r=0;r<20;r++)i();return i}Z("sfc32",{"flips coins fairly"(){let e=0,n=0,a=Wi(0,0,0,0);for(let t=0;t<200;t++)a()<.5?e++:n++;S(e-n,I,-8)},"generates a reasonably uniform distribution of numbers"(){let e=new Set,n=Wi(0,0,0,0);for(let a=0;a<100;a++)e.add(Math.floor(n()*1e4));S(e.size,I,99)}});function $(e,n){let a=-1,t=e.length-1;for(;a<t;){let i=dg(a,t);n(e[i])?a=i:t=i-1}return e[a]}function dg(e,n){return Math.ceil((e+n)/2)}Z("binarySearch",{"returns undefined given an empty array"(){S($([],()=>!1),I,void 0)},"returns an element that is to the left of the target"(){S($([1],()=>!0),I,1)},"returns undefined when the only element is not left of the target"(){S($([1],()=>!1),I,void 0)},"returns the rightmost element that is left of the target"(){S($([1,2,3,4],e=>e<=2.5),I,2)},"works with duplicates"(){S($([0,1,2,3,0,0,0,0,0],e=>e>0),I,3)},"works with two elements"(){S($([1,2],e=>e<=1.5),I,1),S($([1,2],e=>e<=2),I,2)},"works with three elements"(){S($([1,2,3],e=>e<=1.5),I,1),S($([1,2,3],e=>e<=2),I,2),S($([1,2,3],e=>e<=3),I,3)},"works with four elements"(){S($([1,2,3,4],e=>e<=1.5),I,1),S($([1,2,3,4],e=>e<=2),I,2),S($([1,2,3,4],e=>e<=3),I,3),S($([1,2,3,4],e=>e<=4),I,4)},"works with five elements"(){S($([1,2,3,4,5],e=>e<=1.5),I,1),S($([1,2,3,4,5],e=>e<=2),I,2),S($([1,2,3,4,5],e=>e<=3),I,3),S($([1,2,3,4,5],e=>e<=4),I,4),S($([1,2,3,4,5],e=>e<=5),I,5)}});var St=2,td=24*3600,hg=8*3600;function Gn(e,n){let a=pa(1,Ni(n));return{getBroadcast:t,getName(){return e}};function t(i){var k;let r=i/1e3,o=(r-hg)%td,s=r-o,l=a(String(s)),d=$(l,N=>N.startAt<=o);return(d==null?void 0:d.type)==="video"?{type:"video",videoId:d.videoId,videoTitle:d.videoTitle,currentTime:o-d.startAt}:{type:"nothing",nextVideoId:(k=d==null?void 0:d.nextVideoId)!=null?k:""}}}var Ni=e=>n=>{if(Bi(e))return[];e=[...e];let a=Wi(...ft(n)),t=0,i=[],r=0;for(;t<td;){r===e.length&&(r=0),cg(e,r,jo(r,e.length-1,a));let o=e[r++];for(let s of o.videos)i.push({type:"nothing",startAt:t,nextVideoId:s.videoId},{type:"video",videoId:s.videoId,videoTitle:s.title,startAt:t+St}),t+=s.durationSeconds+St}return i};function cg(e,n,a){let t=e[n];e[n]=e[a],e[a]=t}function jo(e,n,a){return e+Math.floor(a()*(n+1-e))}Z("a Channel",{"broadcasts nothing given no episodes"(){let n=Gn("",[]);S(n.getBroadcast(999),K,{type:"nothing",nextVideoId:""})}});Z("randomIntInRange",{"when low and high are the same"(){S(jo(3,3,Math.random),I,3)},"when low and high are 1 apart"(){let e=new Set;for(let n=0;n<30;n++)e.add(jo(0,1,Math.random));S(e,K,new Set([0,1]))}});Z("ScheduleGenerator",{"schedules a single 24-hour video"(){let e=[{videos:[{durationSeconds:3600*24,videoId:"the-video-id",title:"the-title"}]}],n=Ni(e);S(n(""),K,[{type:"nothing",startAt:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startAt:2}])},"schedules a 12-hour video twice"(){let e=[{videos:[{durationSeconds:3600*12,videoId:"the-video-id",title:"the-title"}]}],n=Ni(e);S(n(""),K,[{type:"nothing",startAt:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startAt:2},{type:"nothing",startAt:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startAt:43204}])},"picks the videos to show randomly"(){let e=[{videos:[{durationSeconds:3600*2,videoId:"one",title:""}]},{videos:[{durationSeconds:3600*2,videoId:"two",title:""}]},{videos:[{durationSeconds:3600*2,videoId:"three",title:""}]}],n=Ni(e);S(n("asdfx").map(a=>a.videoId).filter(Boolean),K,["three","one","two","three","two","one","one","two","three","two","three","one"])}});var fa=(...e)=>e.reduce(gg);Z("pipe",{"given one function"(){S(fa(n=>n+1)(1),I,2)},"given two functions"(){let e=n=>n+1;S(fa(e,e)(1),I,3)}});function gg(e,n){return(...a)=>n(e(...a))}function Pi(e){return n=>n.map(e)}function id(e){return e.trim()}var Gi=Pi(fa(he,Vo));function Vo(e){return{videos:e}}function he(e){return e.split(/\n+/).map(id).filter(Yo(mg)).filter(Yo(Bi)).map(yt(/ +/,3)).flatMap(([n,a,t])=>a==="SHORTS"?[]:[{videoId:n,durationSeconds:We(a),title:t}])}Z("parseVideos",{"empty string"(){S(he(""),K,[])},spaces(){S(he("  "),K,[])},newlines(){S(he(`
...
# bar`),K,[])},"strips spaces before comments"(){S(he(`  #foo
  ...
  `,"Gf1RHyuuLnI 4:59 Kirsten Bråten Berg - Heiemo og Nykkjen(folkesang)","Tt8p5AxJn18 4:14 Sinéad O'Connor - Mna na h Eireann (Women of Ireland)","HgwypQ_9_DE 4:25 Ripoff Raskolnikov - Azt gondoltam eső esik (Live at Paks)","apE1n63ZhMQ 18:34 Muzsikás: Repülj madár, repülj (Fly Bird, fly) + pics of Hollókő (read the info)","8n5u_IfVLd0 5:45 Cirque Du Soleil O, Gamelan"]);var h1=he(`
...
`),hd=Pi(fa(he,Vo))([`
  ...
  `]);var Di=[Gn("Channel 1",[...sd,...od.map(Ri)]),Gn("Channel 2",ld.map(Ri)),Gn("Channel 3",rd),Gn("Channel 4",ud.map(Ri)),Gn("🎄",[...hd,...dd.map(Ri)])];function Ri(e){return{videos:[e]}}function cd(e){return v(Un,null,Di.map(n=>v("button",{key:n.getName(),onClick:()=>e.onChannelSelected(n)},n.getName())))}function gd(){let[e,n]=Ne(+new Date);return ed(()=>n(+new Date),250),e}function md(e=""){return{type:"nothing",nextVideoId:e}}function pd(e,n){let{state:a,videoId:t,time:i}=n;if(e.type==="nothing")switch(a){case re.ENDED:case re.CUED:case re.UNSTARTED:return e.nextVideoId?t!==e.nextVideoId?[{type:"cue",videoId:e.nextVideoId,timestamp:0}]:[{type:"seek",timestamp:0},{type:"play"}]:[];default:return[]}else{if(a===re.BUFFERING)return[];let{videoId:r,currentTime:o}=e;if(t!==r)return[{type:"cue",videoId:r,timestamp:o<St?0:o}];{let s=[];switch(a){case re.PAUSED:case re.CUED:case re.UNSTARTED:t&&s.push({type:"play"})}return i&&Sg(i,o)>=St&&(console.debug("time is off; seeking",i,o),s.push({type:"seek",timestamp:o})),s}}}function Sg(e,n){return Math.abs(e-n)}var yg=0;function kg(){let[,e]=Ne(0);return()=>e(++yg)}function fd(e){let n=kg(),a=ya(qu());return Ln(()=>{Xu(e).then(t=>{a.current=t,t.addEventListener("onStateChange",i=>{console.debug(mn(),"player onStateChange",mt(i.data),ga(t.getVideoUrl())),n()}),n()})},[e]),a.current}var Sd="javascript:(function()%7Bfunction%20last(e)%7Breturn%20e%5Be.length-1%5D%7Dvideos%3D%2F%5C%2Fwatch%5C%3F%2F.test(window.location)%3F%5B%2Fv%3D(.%7B11%7D)%2F.exec(window.location)%3F.%5B1%5D%2Clast(document.querySelectorAll(%22.ytp-time-duration%22)).innerText.trim()%2Cdocument.querySelector(%22.title%20.ytd-video-primary-info-renderer%22).innerText.split(%22%5Cn%22)%5B0%5D.trim()%5D.join(%22%20%22)%3A%2F%5C%2Fplaylist%5C%3F%2F.test(window.location)%3F%5B...document.querySelectorAll(%22ytd-playlist-video-renderer%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22a%23video-title%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Ci%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Cn%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bi%7D%20%24%7Bn%7D%60%7D)).join(%22%5Cn%22)%3A%5B...document.querySelectorAll(%22ytd-rich-grid-media%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22%23thumbnail%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Ci%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Cn%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bi%7D%20%24%7Bn%7D%60%7D)).join(%22%5Cn%22)%2Cconsole.log(videos)%2Cnavigator.clipboard.writeText(videos).catch((e%3D%3Econsole.error(e)))%3B%7D)()";function Tg({broadcast:e,player:n}){var t;let a=i=>x(i,2);return{videoLink:e.type==="video"?{text:e.videoTitle,href:"https://youtube.com/watch?v="+e.videoId}:null,actual:{video:(t=n.videoId)!=null?t:"",playerState:mt(n.state),currentTime:n.time!=null?a(n.time):"-"},scheduled:{video:e.type==="video"?e.videoId:"-",playerState:e.type,currentTime:e.type==="video"?a(e.currentTime):"-"},secondsBehindSchedule:e.type==="video"&&n.time!=null?(e.currentTime-n.time).toFixed(2):"-",timeRemainingInVideo:n.duration!=null&&n.time!=null?a(n.duration-n.time):"-"}}function yd(e){let{broadcast:n,player:a,onClose:t}=e,i=Tg({broadcast:n,player:a});return v(Un,null,v("button",{className:"close-button",onClick:t},"close"),v("h1",null,"Culture Machine"),v("p",null,"Made by ",v("a",{href:"https://github.com/benchristel"},"Ben Christel"),"."," ",v("a",{href:"https://github.com/benchristel/tv"},"Source code here"),". Some rights reserved. See the"," ",v("a",{href:"https://www.gnu.org/licenses/gpl-3.0.en.html"},"license"),"."),v("p",null,v("a",{href:Sd},"Bookmarklet to scrape videos from YouTube")," ","(",v("a",{href:"https://github.com/benchristel/tv#what-is-a-bookmarklet"},"What's this?"),")"),v("hr",null),v("h2",null,"Video Info"),v("p",{style:{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},"Now playing:"," ",i.videoLink?v("a",{href:i.videoLink.href},i.videoLink.text):"-"),v("table",null,v("thead",null,v("tr",null,v("td",null),v("th",{scope:"col"},"actual"),v("th",{scope:"col"},"scheduled"))),v("tbody",null,v("tr",null,v("th",{scope:"row"},"video"),v("td",null,i.actual.video),v("td",null,i.scheduled.video)),v("tr",null,v("th",{scope:"row"},"player state"),v("td",null,i.actual.playerState),v("td",null,i.scheduled.playerState)),v("tr",null,v("th",{scope:"row"},"current time"),v("td",null,i.actual.currentTime),v("td",null,i.scheduled.currentTime)))),v("p",null,"Seconds behind schedule: ",i.secondsBehindSchedule),v("p",null,"Time remaining in video: ",i.timeRemainingInVideo))}var Jo=class extends _o{componentDidUpdate(){let{player:n,commands:a}=this.props;a.forEach(t=>{switch(t.type){case"play":n.playVideo();break;case"cue":n.cueVideoById(t.videoId,t.timestamp);break;case"seek":n.seekTo(t.timestamp);break;default:console.error("unexpected video command type",t.type,t)}})}render(){return null}};function kd(e){return{state:e.getPlayerState(),videoId:ga(e.getVideoUrl()),time:e.getCurrentTime(),duration:e.getDuration()}}function Td(){let[e,n]=nd(),[a,t]=Ne(!1),[i,r]=Ne(Di[0]),o=gd(),s=e?i.getBroadcast(o):md(),l=Zu(fd("player-container")),d=kd(l),k=d.state,N=k!==re.PLAYING,f=pd(s,d);return v(Ag,{effects:v(Jo,{commands:f,player:l}),screen:v("div",{className:a?"info-pane-open":""},v("div",{className:"player-assembly"},v("div",{id:"player-container"}),N&&v("div",{className:"black-screen"},v(ad,{code:k,channel:i})),!e&&v(Ig,{onClick:n})),v("div",{className:"info-pane"},v(yd,{player:d,broadcast:s,onClose:()=>t(!1)})),v("div",{className:"info-pane-close-overlay","aria-hidden":!0,onClick:()=>t(!1)})),controlPanel:v(Un,null,v(cd,{onChannelSelected:C=>{r(C),n()}}),v("button",{className:a?"info-button info-button-info-pane-open":"info-button",onClick:()=>t(!a)},"Info"))})}function Ag(e){return v("div",{className:"App"},v("div",{className:"bezel"},v("div",{className:"screen"},e.screen),v("div",{style:{height:"12px"}}),v("div",{className:"controls"},e.controlPanel),e.effects))}function Ig(e){return v("button",{id:"start",onClick:e.onClick},"▸ Play")}function Ad(){let[e,n]=Ne("");return Ln(()=>{xu(Ju()).then(Qu).then(n).catch(a=>n(a.message))},[]),/fail/i.test(e)?v("div",{className:"TestResults"},v("code",null,v("pre",null,e))):null}Uo(v(Td,null),document.getElementById("app"));Uo(v(Ad,null),document.getElementById("test-results"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
