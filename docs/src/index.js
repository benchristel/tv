...
`;function cd({results:e}){let n=!1,a=!1,t=[];for(let i of e){let r=!1;i.error&&(r=n=!0),i.instrumentLog.length&&(r=a=!0),r&&t.push(i)}return n?Sg(t):a?kg(e.length,t):yg(e.length)}function Sg(e){return e.map(hd).join(Pi)+Pi+"Tests failed."}function yg(e){switch(e){case 0:return"No tests to run.";case 1:return"One test ran, and found no issues.";default:return`${e} tests ran, and found no issues.`}}function kg(e,n){return n.map(hd).join(Pi)+Pi+Ig(e)+`, but debugging instrumentation is present.
