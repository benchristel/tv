...
`;var ns={};Mn(ns,{episodes:()=>Pg,videos:()=>Lg});var Lg=`
...
`,Pg=["BecZdQvjGrY 54:49 In Gowan Ring - Compendium (Full Album)","B3oAx9VmAdA 43:52 In Gowan Ring - Hazel Steps Through A Weathered Home",`
  ...
  `,"Gf1RHyuuLnI 4:59 Kirsten Bråten Berg - Heiemo og Nykkjen(folkesang)","Tt8p5AxJn18 4:14 Sinéad O'Connor - Mna na h Eireann (Women of Ireland)","Dhgi3wb_GB8 4:25 Ripoff Raskolnikov - Azt gondoltam eso esik","apE1n63ZhMQ 3:39 Muzsikás: Repülj madár, repülj (Fly Bird, fly) + pics of Hollókő (read the info)","8n5u_IfVLd0 5:45 Cirque Du Soleil O, Gamelan"];var as={};Mn(as,{episodes:()=>Ug,videos:()=>Dg});var Ug=[],Dg=`
if6iWVgR8h4 19:58 Silent Meditations (20 min) | 4 intervals
`;var ts={};Mn(ts,{episodes:()=>Fg,videos:()=>Kg});var Fg=[`
...
# bar`),F,[])},"strips spaces before comments"(){m(we(`  #foo
  # bar`),F,[])},"parses actual data"(){m(we(`
    ...
    `),F,[{videoId:"leb645Xu6uo",segments:[{start:1,end:180},{start:600,end:661}],title:"The Title"}])},"removes shorts"(){m(we(`
      ...
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
    `),F,[{videoId:"leb645Xu6uo",segments:[{start:0,end:654}],title:"Captain Murderer - Emlyn Williams"}])}});Y("parseDuration",{"0:00"(){m(Se("0:00"),I,0)},"00:00"(){m(Se("00:00"),I,0)},"1 second"(){m(Se("0:01"),I,1)},"10 seconds"(){m(Se("0:10"),I,10)},"1 minute"(){m(Se("1:00"),I,60)},"1 minute 10 seconds"(){m(Se("1:10"),I,70)},"10 minutes 10 seconds"(){m(Se("10:10"),I,610)},"1 hour"(){m(Se("1:00:00"),I,3600)},"1 hour 1 second"(){m(Se("1:00:01"),I,3601)},"10 hours 1 second"(){m(Se("10:00:01"),I,36001)},"1 day 1 second"(){m(Se("1:0:00:01"),I,86401)}});Y("split",{"empty string"(){m(Ea(" ")(""),F,[""])},"no limit"(){m(Ea(" ")("a b c"),F,["a","b","c"])},limit(){m(Ea(" ",2)("a b c"),F,["a","b c"])},regex(){m(Ea(/ +/)("a b   c"),F,["a","b","c"])}});var Cd=window.ENVIRONMENT==="development",Od=[["Channel 1","shuffle",$o],["Channel 2","shuffle",es],["Channel 3","shuffle",ns],["Channel 4","shuffle",as],["🎄","shuffle",ts],Cd?["debug","shuffle",is]:null,Cd?["test segments","test-segment-boundaries",rs]:null].filter(Boolean).map(([e,n,a])=>[e,n,bi(a)]);function Nd(){let[e,n]=We(+new Date);return Td(()=>n(+new Date),250),e}function Bd(e=""){return{type:"nothing",nextVideoId:e}}var In=2;function Wd(e,n){let{state:a,videoId:t,time:i}=n;if(e.type==="nothing")switch(a){case re.ENDED:case re.CUED:case re.UNSTARTED:return e.nextVideoId?t!==e.nextVideoId?[{type:"cue",videoId:e.nextVideoId,timestamp:0}]:[{type:"seek",timestamp:0},{type:"play"}]:[];default:return[]}else{if(a===re.BUFFERING)return[];let{videoId:r,currentTime:o}=e;if(t!==r)return[{type:"cue",videoId:r,timestamp:o<In?0:o}];{let s=[];switch(a){case re.PAUSED:case re.CUED:case re.UNSTARTED:t&&s.push({type:"play"})}return i&&$g(i,o)>=In&&(console.debug("time is off; seeking",i,o),s.push({type:"seek",timestamp:o})),s}}}function $g(e,n){return Math.abs(e-n)}var em=0;function nm(){let[,e]=We(0);return()=>e(++em)}function Gd(e){let n=nm(),a=Oa(Sd());return zn(()=>{kd(e).then(t=>{a.current=t,t.addEventListener("onStateChange",i=>{console.debug(kn(),"player onStateChange",Et(i.data),Aa(t.getVideoUrl())),n()}),n()})},[e]),a.current}var Rd="javascript:(function()%7Bfunction%20last(e)%7Breturn%20e%5Be.length-1%5D%7Dvideos%3D%2F%5C%2Fwatch%5C%3F%2F.test(window.location)%3F%5B%2Fv%3D(.%7B11%7D)%2F.exec(window.location)%3F.%5B1%5D%2Clast(document.querySelectorAll(%22.ytp-time-duration%22)).innerText.trim()%2Cdocument.querySelector(%22.title%20.ytd-video-primary-info-renderer%22).innerText.split(%22%5Cn%22)%5B0%5D.trim()%5D.join(%22%20%22)%3A%2F%5C%2Fplaylist%5C%3F%2F.test(window.location)%3F%5B...document.querySelectorAll(%22ytd-playlist-video-renderer%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22a%23video-title%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Ci%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Cn%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bi%7D%20%24%7Bn%7D%60%7D)).join(%22%5Cn%22)%3A%5B...document.querySelectorAll(%22ytd-rich-grid-media%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22a%23thumbnail%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Ci%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Cn%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bi%7D%20%24%7Bn%7D%60%7D)).join(%22%5Cn%22)%2Cconsole.log(videos)%2Cnavigator.clipboard.writeText(videos).catch((e%3D%3Econsole.error(e)))%3B%7D)()";function am({broadcast:e,player:n}){var t;let a=i=>V(i,2);return{videoLink:e.type==="video"?{text:e.videoTitle,href:"https://youtube.com/watch?v="+e.videoId}:null,actual:{video:(t=n.videoId)!=null?t:"",playerState:Et(n.state),currentTime:n.time!=null?a(n.time):"-"},scheduled:{video:e.type==="video"?e.videoId:"-",playerState:e.type,currentTime:e.type==="video"?a(e.currentTime):"-"},secondsBehindSchedule:e.type==="video"&&n.time!=null?(e.currentTime-n.time).toFixed(2):"-",timeRemainingInVideo:n.duration!=null&&n.time!=null?a(n.duration-n.time):"-"}}function Ld(e){let{broadcast:n,player:a,onClose:t}=e,i=am({broadcast:n,player:a});return v(jn,null,v("button",{className:"close-button",onClick:t},"close"),v("h1",null,"Culture Machine"),v("p",null,"Made by ",v("a",{href:"https://github.com/benchristel"},"Ben Christel"),"."," ",v("a",{href:"https://github.com/benchristel/tv"},"Source code here"),". Some rights reserved. See the"," ",v("a",{href:"https://www.gnu.org/licenses/gpl-3.0.en.html"},"license"),"."),v("p",null,v("span",{dangerouslySetInnerHTML:{__html:`
          <a href="${Rd}">
            Bookmarklet to scrape videos from YouTube
          </a>
        `}})," ","(",v("a",{href:"https://github.com/benchristel/tv#what-is-a-bookmarklet"},"What's this?"),")"),v("hr",null),v("h2",null,"Video Info"),v("p",{style:{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},"Now playing:"," ",i.videoLink?v("a",{href:i.videoLink.href},i.videoLink.text):"-"),v("table",null,v("thead",null,v("tr",null,v("td",null),v("th",{scope:"col"},"actual"),v("th",{scope:"col"},"scheduled"))),v("tbody",null,v("tr",null,v("th",{scope:"row"},"video"),v("td",null,i.actual.video),v("td",null,i.scheduled.video)),v("tr",null,v("th",{scope:"row"},"player state"),v("td",null,i.actual.playerState),v("td",null,i.scheduled.playerState)),v("tr",null,v("th",{scope:"row"},"current time"),v("td",null,i.actual.currentTime),v("td",null,i.scheduled.currentTime)))),v("p",null,"Seconds behind schedule: ",i.secondsBehindSchedule),v("p",null,"Time remaining in video: ",i.timeRemainingInVideo),v("h2",null,"Channel Stats"),v("table",null,v("thead",null,v("tr",null,v("th",{scope:"col"},"name"),v("th",{scope:"col"},"duration"))),v("tbody",null,e.channels.map(r=>v(tm,{channel:r})))),v("div",{style:{height:60}}))}function tm(e){return v("tr",null,v("td",null,e.channel.getName()),v("td",null,Qe(e.channel.getTotalDuration())))}var ss=class extends ps{componentDidUpdate(){let{player:n,commands:a}=this.props;a.forEach(t=>{switch(t.type){case"play":n.playVideo();break;case"cue":n.cueVideoById(t.videoId,t.timestamp);break;case"seek":n.seekTo(t.timestamp);break;default:console.error("unexpected video command type",t.type,t)}})}render(){return null}};function Pd(e){return{state:e.getPlayerState(),videoId:Aa(e.getVideoUrl()),time:e.getCurrentTime(),duration:e.getDuration()}}function wa(e,n){let a={};return t=>(t in a||(Object.keys(a).length===e&&(a={}),a[t]=n(t)),a[t])}Y("cache",{"caches a value"(){let e=0,n=wa(1,()=>(e++,123));n("foo"),n("foo"),m(e,I,1)},"computes and caches values by key"(){let e=wa(2,n=>n+"x");m(e("foo"),I,"foox"),m(e("bar"),I,"barx")},"caches multiple values"(){let e=0,n=wa(2,a=>(e++,a+"x"));n("foo"),n("foo"),n("bar"),n("bar"),m(e,I,2),m(n("foo"),I,"foox"),m(n("bar"),I,"barx")},"a max size of 0 means no limit"(){let e=0,n=wa(0,()=>(e++,123));n("a"),n("b"),n("c"),m(e,I,3)}});function Mt(e){let n=1779033703,a=3144134277,t=1013904242,i=2773480762;for(let r=0,o;r<e.length;r++)o=e.charCodeAt(r),n=a^Math.imul(n^o,597399067),a=t^Math.imul(a^o,2869860233),t=i^Math.imul(t^o,951274213),i=n^Math.imul(i^o,2716044179);return n=Math.imul(t^n>>>18,597399067),a=Math.imul(i^a>>>22,2869860233),t=Math.imul(n^t>>>17,951274213),i=Math.imul(a^i>>>19,2716044179),[(n^a^t^i)>>>0,(a^n)>>>0,(t^n)>>>0,(i^n)>>>0]}Y("cyrb128_32",{"hashes unix timestamps to random-looking values"(){m(Mt("1661673600"),F,[1866196007,1194674827,898714046,497018642]),m(Mt("1661760000"),F,[3655929289,901600698,732811234,3355023249]),m(Mt("1661846400"),F,[2165297363,2940322590,3636107238,4143219755])}});function xi(e,n,a,t){function i(){e|=0,n|=0,a|=0,t|=0;var r=(e+n|0)+t|0;return t=t+1|0,e=n^n>>>9,n=a+(a<<3)|0,a=a<<21|a>>>11,a=a+r|0,(r>>>0)/4294967296}for(let r=0;r<20;r++)i();return i}function Yi(e,n,a){return e+Math.floor(a()*(n+1-e))}Y("sfc32",{"flips coins fairly"(){let e=0,n=0,a=xi(0,0,0,0);for(let t=0;t<200;t++)a()<.5?e++:n++;m(e-n,I,-8)},"generates a reasonably uniform distribution of numbers"(){let e=new Set,n=xi(0,0,0,0);for(let a=0;a<100;a++)e.add(Math.floor(n()*1e4));m(e.size,I,99)}});Y("randomIntInRange",{"when low and high are the same"(){m(Yi(3,3,Math.random),I,3)},"when low and high are 1 apart"(){let e=new Set;for(let n=0;n<30;n++)e.add(Yi(0,1,Math.random));m(e,F,new Set([0,1]))}});function Q(e,n){let a=-1,t=e.length-1;for(;a<t;){let i=im(a,t);n(e[i])?a=i:t=i-1}return e[a]}function im(e,n){return Math.ceil((e+n)/2)}Y("binarySearch",{"returns undefined given an empty array"(){m(Q([],()=>!1),I,void 0)},"returns an element that is to the left of the target"(){m(Q([1],()=>!0),I,1)},"returns undefined when the only element is not left of the target"(){m(Q([1],()=>!1),I,void 0)},"returns the rightmost element that is left of the target"(){m(Q([1,2,3,4],e=>e<=2.5),I,2)},"works with duplicates"(){m(Q([0,1,2,3,0,0,0,0,0],e=>e>0),I,3)},"works with two elements"(){m(Q([1,2],e=>e<=1.5),I,1),m(Q([1,2],e=>e<=2),I,2)},"works with three elements"(){m(Q([1,2,3],e=>e<=1.5),I,1),m(Q([1,2,3],e=>e<=2),I,2),m(Q([1,2,3],e=>e<=3),I,3)},"works with four elements"(){m(Q([1,2,3,4],e=>e<=1.5),I,1),m(Q([1,2,3,4],e=>e<=2),I,2),m(Q([1,2,3,4],e=>e<=3),I,3),m(Q([1,2,3,4],e=>e<=4),I,4)},"works with five elements"(){m(Q([1,2,3,4,5],e=>e<=1.5),I,1),m(Q([1,2,3,4,5],e=>e<=2),I,2),m(Q([1,2,3,4,5],e=>e<=3),I,3),m(Q([1,2,3,4,5],e=>e<=4),I,4),m(Q([1,2,3,4,5],e=>e<=5),I,5)}});var ls=8*3600,Ud=24*3600;function Tn(e,n){let a=wa(1,Ma(n)),t=null;return{getBroadcast:i,getTotalDuration:r,getName(){return e}};function i(o){var p;let s=o/1e3,l=(s-ls)%Ud,d=s-l,y=a(String(d)),w=Q(y,M=>M.startSecondOfDay<=l);return(w==null?void 0:w.type)==="video"?{type:"video",videoId:w.videoId,videoTitle:w.videoTitle,currentTime:l-w.startSecondOfDay+w.startSecondOfVideo}:{type:"nothing",nextVideoId:(p=w==null?void 0:w.nextVideoId)!=null?p:""}}function r(){return t==null&&(t=n.flatMap(om).map(os).reduce(rm,0)),t}}var Ma=e=>n=>{if(Fi(e))return[];e=[...e];let a=xi(...Mt(n)),t=0,i=[],r=0;for(;t<Ud;){r===e.length&&(r=0),sm(e,r,Yi(r,e.length-1,a));let o=e[r++];for(let s of o.videos){i.push({type:"nothing",startSecondOfDay:t,nextVideoId:s.videoId}),t+=In;for(let l of s.segments)i.push({type:"video",videoId:s.videoId,videoTitle:s.title,startSecondOfDay:t,startSecondOfVideo:l.start}),t+=Hi(l)}}return i};function sm(e,n,a){let t=e[n];e[n]=e[a],e[a]=t}function rm(e,n){return e+n}function om(e){return e.videos}function An(...e){return{videoId:"",title:"",segments:e}}function Ct(){return!0}var Dd=[];Y("a Channel",{"broadcasts nothing given no episodes"(){let e=Tn("",Dd);m(e.getBroadcast(999),F,{type:"nothing",nextVideoId:""})},"starts a video when it's supposed to start"(){let e=[Le([An(qe(1e3,2e3))])],n=Tn("",e),a=(ls+5)*1e3;m(n.getBroadcast(a),F,{type:"video",currentTime:1003,videoId:"",videoTitle:""})},"has a total duration of 0 given no videos"(){let e=Tn("",Dd);m(e.getTotalDuration(),I,0)},"sums the durations of its videos"(){let e=[Le([An({start:0,end:1}),An({start:0,end:2})]),Le([An({start:0,end:3})])],n=Tn("",e);m(n.getTotalDuration(),I,6)}});Y("ScheduleGenerator",{"schedules a single 24-hour video"(){let e=[Le([xe(xe({},An(be(3600*24))),{videoId:"the-video-id"})])],n=Ma(e);m(n(""),F,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:xn(Ct),startSecondOfDay:2,startSecondOfVideo:0}])},"schedules a 12-hour video twice"(){let e=[Le([xe(xe({},An(be(3600*12))),{videoId:"the-video-id"})])],n=Ma(e);m(n(""),F,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:xn(Ct),startSecondOfDay:2,startSecondOfVideo:0},{type:"nothing",startSecondOfDay:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:xn(Ct),startSecondOfDay:43204,startSecondOfVideo:0}])},"schedules a time window of a video"(){let e=[Le([xe(xe({},An(qe(3600,3600*13))),{videoId:"the-video-id"})])],n=Ma(e);m(n(""),F,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:xn(Ct),startSecondOfDay:2,startSecondOfVideo:3600},{type:"nothing",startSecondOfDay:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:xn(Ct),startSecondOfDay:43204,startSecondOfVideo:3600}])},"picks the videos to show randomly"(){let e=["one","two","three"].map(a=>Le([xe(xe({},An(be(3600*2))),{videoId:a})])),n=Ma(e);m(n("asdfx").map(a=>a.videoId).filter(Boolean),F,["three","one","two","three","two","one","one","two","three","two","three","one"])}});function Fd(e,n){let a=us(n.flatMap(s=>s.videos)),t=a.map(s=>s.duration).reduce(lm,0);return{getName:i,getBroadcast:r,getTotalDuration:o};function i(){return e}function r(s){var w;let d=s/1e3%t,y=Q(a,p=>p.startSecondOfSchedule<=d);return(y==null?void 0:y.type)==="video"?{type:"video",videoId:y.videoId,videoTitle:y.videoTitle,currentTime:d-y.startSecondOfSchedule+y.startSecondOfVideo}:{type:"nothing",nextVideoId:(w=y==null?void 0:y.nextVideoId)!=null?w:""}}function o(){return 0}}function us(e){let n=7,a=0,t=[];for(let i of e)if(i.segments.length!==1){t.push({type:"nothing",nextVideoId:i.videoId,duration:In,startSecondOfSchedule:a}),a+=In,t.push({type:"video",videoId:"TxJtoBAa2w0",videoTitle:"",duration:3,startSecondOfVideo:3,startSecondOfSchedule:a}),a+=3;for(let r=0;r<i.segments.length;r++){let o=i.segments[r];if(r!==0){let s=dm(o,n);t.push({type:"video",videoId:i.videoId,videoTitle:i.title,duration:s.duration,startSecondOfVideo:s.start,startSecondOfSchedule:a}),a+=s.duration}if(r!==um(i.segments)){let s=cm(o,n);t.push({type:"video",videoId:i.videoId,videoTitle:i.title,duration:s.duration,startSecondOfVideo:s.start,startSecondOfSchedule:a}),a+=s.duration}}}return t}Y("createSchedule",{"returns empty when each video has only one segment"(){let e=[ds("",be(60)),ds("",be(60))];m(us(e),F,[])},"plays the end of the first segment and the beginning of the second"(){let e=[ds("id-1",qe(0,60),qe(120,999))];m(us(e),F,[{type:"nothing",nextVideoId:"id-1",duration:2,startSecondOfSchedule:0},{type:"video",videoId:"TxJtoBAa2w0",videoTitle:"",duration:3,startSecondOfVideo:3,startSecondOfSchedule:2},{type:"video",videoId:"id-1",videoTitle:"",duration:7,startSecondOfVideo:53,startSecondOfSchedule:5},{type:"video",videoId:"id-1",videoTitle:"",duration:7,startSecondOfVideo:120,startSecondOfSchedule:12}])}});function um(e){return e.length-1}function dm(e,n){return{start:e.start,duration:n}}function cm(e,n){return{start:e.end-n,duration:n}}var lm=(e,n)=>e+n;function ds(e,...n){return{videoId:e,title:"",segments:n}}var cs=Od.map(([e,n,a])=>{switch(n){case"shuffle":return Tn(e,a);case"test-segment-boundaries":return Fd(e,a)}});function Kd(){let[e,n]=Ad(),[a,t]=We(!1),[i,r]=We(cs[0]),o=Nd(),s=e?i.getBroadcast(o):Bd(),l=yd(Gd("player-container")),d=Pd(l),y=d.state,w=y!==re.PLAYING,p=Wd(s,d);return v(hm,{effects:v(ss,{commands:p,player:l}),screen:v("div",{className:a?"info-pane-open":""},v("div",{className:"player-assembly"},v("div",{id:"player-container"}),w&&v("div",{className:"black-screen"},v(vd,{code:y,channel:i})),!e&&v(gm,{onClick:n})),v("div",{className:"info-pane"},v(Ld,{player:d,broadcast:s,channels:cs,onClose:()=>t(!1)})),v("div",{className:"info-pane-close-overlay","aria-hidden":!0,onClick:()=>t(!1)})),controlPanel:v(jn,null,v(Ed,{channels:cs,onChannelSelected:M=>{r(M),n()}}),v("button",{className:a?"info-button info-button-info-pane-open":"info-button",onClick:()=>t(!a)},"Info"))})}function hm(e){return v("div",{className:"App"},v("div",{className:"bezel"},v("div",{className:"screen"},e.screen),v("div",{style:{height:"12px"}}),v("div",{className:"controls"},e.controlPanel),e.effects))}function gm(e){return v("button",{id:"start",onClick:e.onClick},"▸ Play")}function Hd(){let[e,n]=We("");return zn(()=>{dd(md()).then(cd).then(n).catch(a=>n(a.message))},[]),/fail/i.test(e)?v("div",{className:"TestResults"},v("code",null,v("pre",null,e))):null}Vo(v(Kd,null),document.getElementById("app"));Vo(v(Hd,null),document.getElementById("test-results"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
