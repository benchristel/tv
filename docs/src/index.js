var dt=(e,n,a)=>new Promise((t,i)=>{var r=l=>{try{s(a.next(l))}catch(d){i(d)}},o=l=>{try{s(a.throw(l))}catch(d){i(d)}},s=l=>l.done?t(l.value):Promise.resolve(l.value).then(r,o);s((a=a.apply(e,n)).next())});function Qe(e,n,a){return a={path:n,exports:{},require:function(t,i){return Xu(t,i==null?a.path:i)}},e(a,a.exports),a.exports}function Xu(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var Ko=Object.getOwnPropertySymbols,$u=Object.prototype.hasOwnProperty,ed=Object.prototype.propertyIsEnumerable;function nd(e){if(e==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(e)}function ad(){try{if(!Object.assign)return!1;var e=new String("abc");if(e[5]="de",Object.getOwnPropertyNames(e)[0]==="5")return!1;for(var n={},a=0;a<10;a++)n["_"+String.fromCharCode(a)]=a;var t=Object.getOwnPropertyNames(n).map(function(r){return n[r]});if(t.join("")!=="0123456789")return!1;var i={};return"abcdefghijklmnopqrst".split("").forEach(function(r){i[r]=r}),Object.keys(Object.assign({},i)).join("")==="abcdefghijklmnopqrst"}catch(r){return!1}}var td=ad()?Object.assign:function(e,n){for(var a,t=nd(e),i,r=1;r<arguments.length;r++){a=Object(arguments[r]);for(var o in a)$u.call(a,o)&&(t[o]=a[o]);if(Ko){i=Ko(a);for(var s=0;s<i.length;s++)ed.call(a,i[s])&&(t[i[s]]=a[i[s]])}}return t},H=td;var id=Qe(function(e,n){var a=60103,t=60106;n.Fragment=60107,n.StrictMode=60108,n.Profiler=60114;var i=60109,r=60110,o=60112;n.Suspense=60113;var s=60115,l=60116;if(typeof Symbol=="function"&&Symbol.for){var d=Symbol.for;a=d("react.element"),t=d("react.portal"),n.Fragment=d("react.fragment"),n.StrictMode=d("react.strict_mode"),n.Profiler=d("react.profiler"),i=d("react.provider"),r=d("react.context"),o=d("react.forward_ref"),n.Suspense=d("react.suspense"),s=d("react.memo"),l=d("react.lazy")}var k=typeof Symbol=="function"&&Symbol.iterator;function w(h){return h===null||typeof h!="object"?null:(h=k&&h[k]||h["@@iterator"],typeof h=="function"?h:null)}function m(h){for(var y="https://reactjs.org/docs/error-decoder.html?invariant="+h,R=1;R<arguments.length;R++)y+="&args[]="+encodeURIComponent(arguments[R]);return"Minified React error #"+h+"; visit "+y+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var M={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},P={};function E(h,y,R){this.props=h,this.context=y,this.refs=P,this.updater=R||M}E.prototype.isReactComponent={},E.prototype.setState=function(h,y){if(typeof h!="object"&&typeof h!="function"&&h!=null)throw Error(m(85));this.updater.enqueueSetState(this,h,y,"setState")},E.prototype.forceUpdate=function(h){this.updater.enqueueForceUpdate(this,h,"forceUpdate")};function g(){}g.prototype=E.prototype;function u(h,y,R){this.props=h,this.context=y,this.refs=P,this.updater=R||M}var c=u.prototype=new g;c.constructor=u,H(c,E.prototype),c.isPureReactComponent=!0;var p={current:null},f=Object.prototype.hasOwnProperty,O={key:!0,ref:!0,__self:!0,__source:!0};function A(h,y,R){var F,S={},I=null,W=null;if(y!=null)for(F in y.ref!==void 0&&(W=y.ref),y.key!==void 0&&(I=""+y.key),y)f.call(y,F)&&!O.hasOwnProperty(F)&&(S[F]=y[F]);var G=arguments.length-2;if(G===1)S.children=R;else if(1<G){for(var D=Array(G),q=0;q<G;q++)D[q]=arguments[q+2];S.children=D}if(h&&h.defaultProps)for(F in G=h.defaultProps,G)S[F]===void 0&&(S[F]=G[F]);return{$$typeof:a,type:h,key:I,ref:W,props:S,_owner:p.current}}function C(h,y){return{$$typeof:a,type:h.type,key:y,ref:h.ref,props:h.props,_owner:h._owner}}function B(h){return typeof h=="object"&&h!==null&&h.$$typeof===a}function N(h){var y={"=":"=0",":":"=2"};return"$"+h.replace(/[=:]/g,function(R){return y[R]})}var z=/\/+/g;function pe(h,y){return typeof h=="object"&&h!==null&&h.key!=null?N(""+h.key):y.toString(36)}function Nn(h,y,R,F,S){var I=typeof h;(I==="undefined"||I==="boolean")&&(h=null);var W=!1;if(h===null)W=!0;else switch(I){case"string":case"number":W=!0;break;case"object":switch(h.$$typeof){case a:case t:W=!0}}if(W)return W=h,S=S(W),h=F===""?"."+pe(W,0):F,Array.isArray(S)?(R="",h!=null&&(R=h.replace(z,"$&/")+"/"),Nn(S,y,R,"",function(q){return q})):S!=null&&(B(S)&&(S=C(S,R+(!S.key||W&&W.key===S.key?"":(""+S.key).replace(z,"$&/")+"/")+h)),y.push(S)),1;if(W=0,F=F===""?".":F+":",Array.isArray(h))for(var G=0;G<h.length;G++){I=h[G];var D=F+pe(I,G);W+=Nn(I,y,R,D,S)}else if(D=w(h),typeof D=="function")for(h=D.call(h),G=0;!(I=h.next()).done;)I=I.value,D=F+pe(I,G++),W+=Nn(I,y,R,D,S);else if(I==="object")throw y=""+h,Error(m(31,y==="[object Object]"?"object with keys {"+Object.keys(h).join(", ")+"}":y));return W}function te(h,y,R){if(h==null)return h;var F=[],S=0;return Nn(h,F,"","",function(I){return y.call(R,I,S++)}),F}function ne(h){if(h._status===-1){var y=h._result;y=y(),h._status=0,h._result=y,y.then(function(R){h._status===0&&(R=R.default,h._status=1,h._result=R)},function(R){h._status===0&&(h._status=2,h._result=R)})}if(h._status===1)return h._result;throw h._result}var hn={current:null};function ie(){var h=hn.current;if(h===null)throw Error(m(321));return h}var pn={ReactCurrentDispatcher:hn,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:p,IsSomeRendererActing:{current:!1},assign:H};n.Children={map:te,forEach:function(h,y,R){te(h,function(){y.apply(this,arguments)},R)},count:function(h){var y=0;return te(h,function(){y++}),y},toArray:function(h){return te(h,function(y){return y})||[]},only:function(h){if(!B(h))throw Error(m(143));return h}},n.Component=E,n.PureComponent=u,n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=pn,n.cloneElement=function(h,y,R){if(h==null)throw Error(m(267,h));var F=H({},h.props),S=h.key,I=h.ref,W=h._owner;if(y!=null){if(y.ref!==void 0&&(I=y.ref,W=p.current),y.key!==void 0&&(S=""+y.key),h.type&&h.type.defaultProps)var G=h.type.defaultProps;for(D in y)f.call(y,D)&&!O.hasOwnProperty(D)&&(F[D]=y[D]===void 0&&G!==void 0?G[D]:y[D])}var D=arguments.length-2;if(D===1)F.children=R;else if(1<D){G=Array(D);for(var q=0;q<D;q++)G[q]=arguments[q+2];F.children=G}return{$$typeof:a,type:h.type,key:S,ref:I,props:F,_owner:W}},n.createContext=function(h,y){return y===void 0&&(y=null),h={$$typeof:r,_calculateChangedBits:y,_currentValue:h,_currentValue2:h,_threadCount:0,Provider:null,Consumer:null},h.Provider={$$typeof:i,_context:h},h.Consumer=h},n.createElement=A,n.createFactory=function(h){var y=A.bind(null,h);return y.type=h,y},n.createRef=function(){return{current:null}},n.forwardRef=function(h){return{$$typeof:o,render:h}},n.isValidElement=B,n.lazy=function(h){return{$$typeof:l,_payload:{_status:-1,_result:h},_init:ne}},n.memo=function(h,y){return{$$typeof:s,type:h,compare:y===void 0?null:y}},n.useCallback=function(h,y){return ie().useCallback(h,y)},n.useContext=function(h,y){return ie().useContext(h,y)},n.useDebugValue=function(){},n.useEffect=function(h,y){return ie().useEffect(h,y)},n.useImperativeHandle=function(h,y,R){return ie().useImperativeHandle(h,y,R)},n.useLayoutEffect=function(h,y){return ie().useLayoutEffect(h,y)},n.useMemo=function(h,y){return ie().useMemo(h,y)},n.useReducer=function(h,y,R){return ie().useReducer(h,y,R)},n.useRef=function(h){return ie().useRef(h)},n.useState=function(h){return ie().useState(h)},n.version="17.0.2"}),L=Qe(function(e){e.exports=id});var uh=L.Children,dh=L.Component,ct=L.Fragment,ch=L.Profiler,gh=L.PureComponent,hh=L.StrictMode,ph=L.Suspense,fh=L.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,mh=L.cloneElement,Sh=L.createContext,j=L.createElement,kh=L.createFactory,Th=L.createRef,yh=L.forwardRef,Ah=L.isValidElement,Ih=L.lazy,vh=L.memo,Mh=L.useCallback,Eh=L.useContext,Ch=L.useDebugValue,Kn=L.useEffect,wh=L.useImperativeHandle,Wh=L.useLayoutEffect,Ph=L.useMemo,Oh=L.useReducer,ca=L.useRef,Oe=L.useState,Nh=L.version;var rd=Qe(function(e,n){var a,t,i,r;if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;n.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();n.unstable_now=function(){return s.now()-l}}if(typeof window=="undefined"||typeof MessageChannel!="function"){var d=null,k=null,w=function(){if(d!==null)try{var S=n.unstable_now();d(!0,S),d=null}catch(I){throw setTimeout(w,0),I}};a=function(S){d!==null?setTimeout(a,0,S):(d=S,setTimeout(w,0))},t=function(S,I){k=setTimeout(S,I)},i=function(){clearTimeout(k)},n.unstable_shouldYield=function(){return!1},r=n.unstable_forceFrameRate=function(){}}else{var m=window.setTimeout,M=window.clearTimeout;if(typeof console!="undefined"){var P=window.cancelAnimationFrame;typeof window.requestAnimationFrame!="function"&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),typeof P!="function"&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var E=!1,g=null,u=-1,c=5,p=0;n.unstable_shouldYield=function(){return n.unstable_now()>=p},r=function(){},n.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):c=0<S?Math.floor(1e3/S):5};var f=new MessageChannel,O=f.port2;f.port1.onmessage=function(){if(g!==null){var S=n.unstable_now();p=S+c;try{g(!0,S)?O.postMessage(null):(E=!1,g=null)}catch(I){throw O.postMessage(null),I}}else E=!1},a=function(S){g=S,E||(E=!0,O.postMessage(null))},t=function(S,I){u=m(function(){S(n.unstable_now())},I)},i=function(){M(u),u=-1}}function A(S,I){var W=S.length;S.push(I);e:for(;;){var G=W-1>>>1,D=S[G];if(D!==void 0&&0<N(D,I))S[G]=I,S[W]=D,W=G;else break e}}function C(S){return S=S[0],S===void 0?null:S}function B(S){var I=S[0];if(I!==void 0){var W=S.pop();if(W!==I){S[0]=W;e:for(var G=0,D=S.length;G<D;){var q=2*(G+1)-1,fn=S[q],da=q+1,Bn=S[da];if(fn!==void 0&&0>N(fn,W))Bn!==void 0&&0>N(Bn,fn)?(S[G]=Bn,S[da]=W,G=da):(S[G]=fn,S[q]=W,G=q);else if(Bn!==void 0&&0>N(Bn,W))S[G]=Bn,S[da]=W,G=da;else break e}}return I}return null}function N(S,I){var W=S.sortIndex-I.sortIndex;return W!==0?W:S.id-I.id}var z=[],pe=[],Nn=1,te=null,ne=3,hn=!1,ie=!1,pn=!1;function h(S){for(var I=C(pe);I!==null;){if(I.callback===null)B(pe);else if(I.startTime<=S)B(pe),I.sortIndex=I.expirationTime,A(z,I);else break;I=C(pe)}}function y(S){if(pn=!1,h(S),!ie)if(C(z)!==null)ie=!0,a(R);else{var I=C(pe);I!==null&&t(y,I.startTime-S)}}function R(S,I){ie=!1,pn&&(pn=!1,i()),hn=!0;var W=ne;try{for(h(I),te=C(z);te!==null&&(!(te.expirationTime>I)||S&&!n.unstable_shouldYield());){var G=te.callback;if(typeof G=="function"){te.callback=null,ne=te.priorityLevel;var D=G(te.expirationTime<=I);I=n.unstable_now(),typeof D=="function"?te.callback=D:te===C(z)&&B(z),h(I)}else B(z);te=C(z)}if(te!==null)var q=!0;else{var fn=C(pe);fn!==null&&t(y,fn.startTime-I),q=!1}return q}finally{te=null,ne=W,hn=!1}}var F=r;n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(S){S.callback=null},n.unstable_continueExecution=function(){ie||hn||(ie=!0,a(R))},n.unstable_getCurrentPriorityLevel=function(){return ne},n.unstable_getFirstCallbackNode=function(){return C(z)},n.unstable_next=function(S){switch(ne){case 1:case 2:case 3:var I=3;break;default:I=ne}var W=ne;ne=I;try{return S()}finally{ne=W}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=F,n.unstable_runWithPriority=function(S,I){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var W=ne;ne=S;try{return I()}finally{ne=W}},n.unstable_scheduleCallback=function(S,I,W){var G=n.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?G+W:G):W=G,S){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=W+D,S={id:Nn++,callback:I,priorityLevel:S,startTime:W,expirationTime:D,sortIndex:-1},W>G?(S.sortIndex=W,A(pe,S),C(z)===null&&S===C(pe)&&(pn?i():pn=!0,t(y,W-G))):(S.sortIndex=D,A(z,S),ie||hn||(ie=!0,a(R))),S},n.unstable_wrapCallback=function(S){var I=ne;return function(){var W=ne;ne=I;try{return S.apply(this,arguments)}finally{ne=W}}}}),X=Qe(function(e){e.exports=rd});function T(e){for(var n="https://reactjs.org/docs/error-decoder.html?invariant="+e,a=1;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!L)throw Error(T(227));var Go=new Set,ga={};function mn(e,n){Gn(e,n),Gn(e+"Capture",n)}function Gn(e,n){for(ga[e]=n,e=0;e<n.length;e++)Go.add(n[e])}var Le=!(typeof window=="undefined"||typeof window.document=="undefined"||typeof window.document.createElement=="undefined"),od=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,Uo=Object.prototype.hasOwnProperty,Do={},Ro={};function sd(e){return Uo.call(Ro,e)?!0:Uo.call(Do,e)?!1:od.test(e)?Ro[e]=!0:(Do[e]=!0,!1)}function ld(e,n,a,t){if(a!==null&&a.type===0)return!1;switch(typeof n){case"function":case"symbol":return!0;case"boolean":return t?!1:a!==null?!a.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function ud(e,n,a,t){if(n===null||typeof n=="undefined"||ld(e,n,a,t))return!0;if(t)return!1;if(a!==null)switch(a.type){case 3:return!n;case 4:return n===!1;case 5:return isNaN(n);case 6:return isNaN(n)||1>n}return!1}function ge(e,n,a,t,i,r,o){this.acceptsBooleans=n===2||n===3||n===4,this.attributeName=t,this.attributeNamespace=i,this.mustUseProperty=a,this.propertyName=e,this.type=n,this.sanitizeURL=r,this.removeEmptyString=o}var re={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){re[e]=new ge(e,0,!1,e,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var n=e[0];re[n]=new ge(n,1,!1,e[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(e){re[e]=new ge(e,2,!1,e.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){re[e]=new ge(e,2,!1,e,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){re[e]=new ge(e,3,!1,e.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(e){re[e]=new ge(e,3,!0,e,null,!1,!1)});["capture","download"].forEach(function(e){re[e]=new ge(e,4,!1,e,null,!1,!1)});["cols","rows","size","span"].forEach(function(e){re[e]=new ge(e,6,!1,e,null,!1,!1)});["rowSpan","start"].forEach(function(e){re[e]=new ge(e,5,!1,e.toLowerCase(),null,!1,!1)});var vi=/[\-:]([a-z])/g;function Mi(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var n=e.replace(vi,Mi);re[n]=new ge(n,1,!1,e,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var n=e.replace(vi,Mi);re[n]=new ge(n,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var n=e.replace(vi,Mi);re[n]=new ge(n,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(e){re[e]=new ge(e,1,!1,e.toLowerCase(),null,!1,!1)});re.xlinkHref=new ge("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(e){re[e]=new ge(e,1,!1,e.toLowerCase(),null,!0,!0)});function Ei(e,n,a,t){var i=re.hasOwnProperty(n)?re[n]:null,r=i!==null?i.type===0:t?!1:!(!(2<n.length)||n[0]!=="o"&&n[0]!=="O"||n[1]!=="n"&&n[1]!=="N");r||(ud(n,a,i,t)&&(a=null),t||i===null?sd(n)&&(a===null?e.removeAttribute(n):e.setAttribute(n,""+a)):i.mustUseProperty?e[i.propertyName]=a===null?i.type===3?!1:"":a:(n=i.attributeName,t=i.attributeNamespace,a===null?e.removeAttribute(n):(i=i.type,a=i===3||i===4&&a===!0?"":""+a,t?e.setAttributeNS(t,n,a):e.setAttribute(n,a))))}var Sn=L.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,ha=60103,kn=60106,je=60107,Ci=60108,pa=60114,wi=60109,Wi=60110,gt=60112,fa=60113,ht=60120,pt=60115,Pi=60116,Oi=60121,Ni=60128,Lo=60129,Bi=60130,Ki=60131;typeof Symbol=="function"&&Symbol.for&&($=Symbol.for,ha=$("react.element"),kn=$("react.portal"),je=$("react.fragment"),Ci=$("react.strict_mode"),pa=$("react.profiler"),wi=$("react.provider"),Wi=$("react.context"),gt=$("react.forward_ref"),fa=$("react.suspense"),ht=$("react.suspense_list"),pt=$("react.memo"),Pi=$("react.lazy"),Oi=$("react.block"),$("react.scope"),Ni=$("react.opaque.id"),Lo=$("react.debug_trace_mode"),Bi=$("react.offscreen"),Ki=$("react.legacy_hidden"));var $,Ho=typeof Symbol=="function"&&Symbol.iterator;function ma(e){return e===null||typeof e!="object"?null:(e=Ho&&e[Ho]||e["@@iterator"],typeof e=="function"?e:null)}var Gi;function Sa(e){if(Gi===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Gi=n&&n[1]||""}return`
...
`+i[o].replace(" at new "," at ");while(1<=o&&0<=s);break}}}finally{Ui=!1,Error.prepareStackTrace=a}return(e=e?e.displayName||e.name:"")?Sa(e):""}function dd(e){switch(e.tag){case 5:return Sa(e.type);case 16:return Sa("Lazy");case 13:return Sa("Suspense");case 19:return Sa("SuspenseList");case 0:case 2:case 15:return e=ft(e.type,!1),e;case 11:return e=ft(e.type.render,!1),e;case 22:return e=ft(e.type._render,!1),e;case 1:return e=ft(e.type,!0),e;default:return""}}function Un(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case je:return"Fragment";case kn:return"Portal";case pa:return"Profiler";case Ci:return"StrictMode";case fa:return"Suspense";case ht:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case Wi:return(e.displayName||"Context")+".Consumer";case wi:return(e._context.displayName||"Context")+".Provider";case gt:var n=e.render;return n=n.displayName||n.name||"",e.displayName||(n!==""?"ForwardRef("+n+")":"ForwardRef");case pt:return Un(e.type);case Oi:return Un(e._render);case Pi:n=e._payload,e=e._init;try{return Un(e(n))}catch(a){}}return null}function ze(e){switch(typeof e){case"boolean":case"number":case"object":case"string":case"undefined":return e;default:return""}}function Fo(e){var n=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(n==="checkbox"||n==="radio")}function cd(e){var n=Fo(e)?"checked":"value",a=Object.getOwnPropertyDescriptor(e.constructor.prototype,n),t=""+e[n];if(!e.hasOwnProperty(n)&&typeof a!="undefined"&&typeof a.get=="function"&&typeof a.set=="function"){var i=a.get,r=a.set;return Object.defineProperty(e,n,{configurable:!0,get:function(){return i.call(this)},set:function(o){t=""+o,r.call(this,o)}}),Object.defineProperty(e,n,{enumerable:a.enumerable}),{getValue:function(){return t},setValue:function(o){t=""+o},stopTracking:function(){e._valueTracker=null,delete e[n]}}}}function mt(e){e._valueTracker||(e._valueTracker=cd(e))}function bo(e){if(!e)return!1;var n=e._valueTracker;if(!n)return!0;var a=n.getValue(),t="";return e&&(t=Fo(e)?e.checked?"true":"false":e.value),e=t,e!==a?(n.setValue(e),!0):!1}function St(e){if(e=e||(typeof document!="undefined"?document:void 0),typeof e=="undefined")return null;try{return e.activeElement||e.body}catch(n){return e.body}}function Di(e,n){var a=n.checked;return H({},n,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:a!=null?a:e._wrapperState.initialChecked})}function Yo(e,n){var a=n.defaultValue==null?"":n.defaultValue,t=n.checked!=null?n.checked:n.defaultChecked;a=ze(n.value!=null?n.value:a),e._wrapperState={initialChecked:t,initialValue:a,controlled:n.type==="checkbox"||n.type==="radio"?n.checked!=null:n.value!=null}}function xo(e,n){n=n.checked,n!=null&&Ei(e,"checked",n,!1)}function Li(e,n){xo(e,n);var a=ze(n.value),t=n.type;if(a!=null)t==="number"?(a===0&&e.value===""||e.value!=a)&&(e.value=""+a):e.value!==""+a&&(e.value=""+a);else if(t==="submit"||t==="reset"){e.removeAttribute("value");return}n.hasOwnProperty("value")?Ri(e,n.type,a):n.hasOwnProperty("defaultValue")&&Ri(e,n.type,ze(n.defaultValue)),n.checked==null&&n.defaultChecked!=null&&(e.defaultChecked=!!n.defaultChecked)}function Qo(e,n,a){if(n.hasOwnProperty("value")||n.hasOwnProperty("defaultValue")){var t=n.type;if(!(t!=="submit"&&t!=="reset"||n.value!==void 0&&n.value!==null))return;n=""+e._wrapperState.initialValue,a||n===e.value||(e.value=n),e.defaultValue=n}a=e.name,a!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,a!==""&&(e.name=a)}function Ri(e,n,a){(n!=="number"||St(e.ownerDocument)!==e)&&(a==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+a&&(e.defaultValue=""+a))}function gd(e){var n="";return L.Children.forEach(e,function(a){a!=null&&(n+=a)}),n}function Hi(e,n){return e=H({children:void 0},n),(n=gd(n.children))&&(e.children=n),e}function Dn(e,n,a,t){if(e=e.options,n){n={};for(var i=0;i<a.length;i++)n["$"+a[i]]=!0;for(a=0;a<e.length;a++)i=n.hasOwnProperty("$"+e[a].value),e[a].selected!==i&&(e[a].selected=i),i&&t&&(e[a].defaultSelected=!0)}else{for(a=""+ze(a),n=null,i=0;i<e.length;i++){if(e[i].value===a){e[i].selected=!0,t&&(e[i].defaultSelected=!0);return}n!==null||e[i].disabled||(n=e[i])}n!==null&&(n.selected=!0)}}function Fi(e,n){if(n.dangerouslySetInnerHTML!=null)throw Error(T(91));return H({},n,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function jo(e,n){var a=n.value;if(a==null){if(a=n.children,n=n.defaultValue,a!=null){if(n!=null)throw Error(T(92));if(Array.isArray(a)){if(!(1>=a.length))throw Error(T(93));a=a[0]}n=a}n==null&&(n=""),a=n}e._wrapperState={initialValue:ze(a)}}function zo(e,n){var a=ze(n.value),t=ze(n.defaultValue);a!=null&&(a=""+a,a!==e.value&&(e.value=a),n.defaultValue==null&&e.defaultValue!==a&&(e.defaultValue=a)),t!=null&&(e.defaultValue=""+t)}function Jo(e){var n=e.textContent;n===e._wrapperState.initialValue&&n!==""&&n!==null&&(e.value=n)}var bi={html:"http://www.w3.org/1999/xhtml",mathml:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg"};function _o(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function Yi(e,n){return e==null||e==="http://www.w3.org/1999/xhtml"?_o(n):e==="http://www.w3.org/2000/svg"&&n==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var kt,Vo=function(e){return typeof MSApp!="undefined"&&MSApp.execUnsafeLocalFunction?function(n,a,t,i){MSApp.execUnsafeLocalFunction(function(){return e(n,a,t,i)})}:e}(function(e,n){if(e.namespaceURI!==bi.svg||"innerHTML"in e)e.innerHTML=n;else{for(kt=kt||document.createElement("div"),kt.innerHTML="<svg>"+n.valueOf().toString()+"</svg>",n=kt.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;n.firstChild;)e.appendChild(n.firstChild)}});function ka(e,n){if(n){var a=e.firstChild;if(a&&a===e.lastChild&&a.nodeType===3){a.nodeValue=n;return}}e.textContent=n}var Ta={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},hd=["Webkit","ms","Moz","O"];Object.keys(Ta).forEach(function(e){hd.forEach(function(n){n=n+e.charAt(0).toUpperCase()+e.substring(1),Ta[n]=Ta[e]})});function Zo(e,n,a){return n==null||typeof n=="boolean"||n===""?"":a||typeof n!="number"||n===0||Ta.hasOwnProperty(e)&&Ta[e]?(""+n).trim():n+"px"}function qo(e,n){e=e.style;for(var a in n)if(n.hasOwnProperty(a)){var t=a.indexOf("--")===0,i=Zo(a,n[a],t);a==="float"&&(a="cssFloat"),t?e.setProperty(a,i):e[a]=i}}var pd=H({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function xi(e,n){if(n){if(pd[e]&&(n.children!=null||n.dangerouslySetInnerHTML!=null))throw Error(T(137,e));if(n.dangerouslySetInnerHTML!=null){if(n.children!=null)throw Error(T(60));if(!(typeof n.dangerouslySetInnerHTML=="object"&&"__html"in n.dangerouslySetInnerHTML))throw Error(T(61))}if(n.style!=null&&typeof n.style!="object")throw Error(T(62))}}function Qi(e,n){if(e.indexOf("-")===-1)return typeof n.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}function ji(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var zi=null,Rn=null,Ln=null;function Xo(e){if(e=ya(e)){if(typeof zi!="function")throw Error(T(280));var n=e.stateNode;n&&(n=Tt(n),zi(e.stateNode,e.type,n))}}function $o(e){Rn?Ln?Ln.push(e):Ln=[e]:Rn=e}function es(){if(Rn){var e=Rn,n=Ln;if(Ln=Rn=null,Xo(e),n)for(e=0;e<n.length;e++)Xo(n[e])}}function Ji(e,n){return e(n)}function ns(e,n,a,t,i){return e(n,a,t,i)}function _i(){}var as=Ji,Tn=!1,Vi=!1;function Zi(){(Rn!==null||Ln!==null)&&(_i(),es())}function fd(e,n,a){if(Vi)return e(n,a);Vi=!0;try{return as(e,n,a)}finally{Vi=!1,Zi()}}function Aa(e,n){var a=e.stateNode;if(a===null)return null;var t=Tt(a);if(t===null)return null;a=t[n];e:switch(n){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(t=!t.disabled)||(e=e.type,t=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!t;break e;default:e=!1}if(e)return null;if(a&&typeof a!="function")throw Error(T(231,n,typeof a));return a}var qi=!1;if(Le)try{Hn={},Object.defineProperty(Hn,"passive",{get:function(){qi=!0}}),window.addEventListener("test",Hn,Hn),window.removeEventListener("test",Hn,Hn)}catch(e){qi=!1}var Hn;function md(e,n,a,t,i,r,o,s,l){var d=Array.prototype.slice.call(arguments,3);try{n.apply(a,d)}catch(k){this.onError(k)}}var Ia=!1,yt=null,At=!1,Xi=null,Sd={onError:function(e){Ia=!0,yt=e}};function kd(e,n,a,t,i,r,o,s,l){Ia=!1,yt=null,md.apply(Sd,arguments)}function Td(e,n,a,t,i,r,o,s,l){if(kd.apply(this,arguments),Ia){if(Ia){var d=yt;Ia=!1,yt=null}else throw Error(T(198));At||(At=!0,Xi=d)}}function yn(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&1026)!=0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function ts(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function is(e){if(yn(e)!==e)throw Error(T(188))}function yd(e){var n=e.alternate;if(!n){if(n=yn(e),n===null)throw Error(T(188));return n!==e?null:e}for(var a=e,t=n;;){var i=a.return;if(i===null)break;var r=i.alternate;if(r===null){if(t=i.return,t!==null){a=t;continue}break}if(i.child===r.child){for(r=i.child;r;){if(r===a)return is(i),e;if(r===t)return is(i),n;r=r.sibling}throw Error(T(188))}if(a.return!==t.return)a=i,t=r;else{for(var o=!1,s=i.child;s;){if(s===a){o=!0,a=i,t=r;break}if(s===t){o=!0,t=i,a=r;break}s=s.sibling}if(!o){for(s=r.child;s;){if(s===a){o=!0,a=r,t=i;break}if(s===t){o=!0,t=r,a=i;break}s=s.sibling}if(!o)throw Error(T(189))}}if(a.alternate!==t)throw Error(T(190))}if(a.tag!==3)throw Error(T(188));return a.stateNode.current===a?e:n}function rs(e){if(e=yd(e),!e)return null;for(var n=e;;){if(n.tag===5||n.tag===6)return n;if(n.child)n.child.return=n,n=n.child;else{if(n===e)break;for(;!n.sibling;){if(!n.return||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}}return null}function os(e,n){for(var a=e.alternate;n!==null;){if(n===e||n===a)return!0;n=n.return}return!1}var ss,$i,ls,us,er=!1,Ne=[],Je=null,_e=null,Ve=null,va=new Map,Ma=new Map,Ea=[],ds="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function nr(e,n,a,t,i){return{blockedOn:e,domEventName:n,eventSystemFlags:a|16,nativeEvent:i,targetContainers:[t]}}function cs(e,n){switch(e){case"focusin":case"focusout":Je=null;break;case"dragenter":case"dragleave":_e=null;break;case"mouseover":case"mouseout":Ve=null;break;case"pointerover":case"pointerout":va.delete(n.pointerId);break;case"gotpointercapture":case"lostpointercapture":Ma.delete(n.pointerId)}}function Ca(e,n,a,t,i,r){return e===null||e.nativeEvent!==r?(e=nr(n,a,t,i,r),n!==null&&(n=ya(n),n!==null&&$i(n)),e):(e.eventSystemFlags|=t,n=e.targetContainers,i!==null&&n.indexOf(i)===-1&&n.push(i),e)}function Ad(e,n,a,t,i){switch(n){case"focusin":return Je=Ca(Je,e,n,a,t,i),!0;case"dragenter":return _e=Ca(_e,e,n,a,t,i),!0;case"mouseover":return Ve=Ca(Ve,e,n,a,t,i),!0;case"pointerover":var r=i.pointerId;return va.set(r,Ca(va.get(r)||null,e,n,a,t,i)),!0;case"gotpointercapture":return r=i.pointerId,Ma.set(r,Ca(Ma.get(r)||null,e,n,a,t,i)),!0}return!1}function Id(e){var n=An(e.target);if(n!==null){var a=yn(n);if(a!==null){if(n=a.tag,n===13){if(n=ts(a),n!==null){e.blockedOn=n,us(e.lanePriority,function(){X.unstable_runWithPriority(e.priority,function(){ls(a)})});return}}else if(n===3&&a.stateNode.hydrate){e.blockedOn=a.tag===3?a.stateNode.containerInfo:null;return}}}e.blockedOn=null}function It(e){if(e.blockedOn!==null)return!1;for(var n=e.targetContainers;0<n.length;){var a=ar(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null)return n=ya(a),n!==null&&$i(n),e.blockedOn=a,!1;n.shift()}return!0}function gs(e,n,a){It(e)&&a.delete(n)}function vd(){for(er=!1;0<Ne.length;){var e=Ne[0];if(e.blockedOn!==null){e=ya(e.blockedOn),e!==null&&ss(e);break}for(var n=e.targetContainers;0<n.length;){var a=ar(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null){e.blockedOn=a;break}n.shift()}e.blockedOn===null&&Ne.shift()}Je!==null&&It(Je)&&(Je=null),_e!==null&&It(_e)&&(_e=null),Ve!==null&&It(Ve)&&(Ve=null),va.forEach(gs),Ma.forEach(gs)}function wa(e,n){e.blockedOn===n&&(e.blockedOn=null,er||(er=!0,X.unstable_scheduleCallback(X.unstable_NormalPriority,vd)))}function hs(e){function n(i){return wa(i,e)}if(0<Ne.length){wa(Ne[0],e);for(var a=1;a<Ne.length;a++){var t=Ne[a];t.blockedOn===e&&(t.blockedOn=null)}}for(Je!==null&&wa(Je,e),_e!==null&&wa(_e,e),Ve!==null&&wa(Ve,e),va.forEach(n),Ma.forEach(n),a=0;a<Ea.length;a++)t=Ea[a],t.blockedOn===e&&(t.blockedOn=null);for(;0<Ea.length&&(a=Ea[0],a.blockedOn===null);)Id(a),a.blockedOn===null&&Ea.shift()}function vt(e,n){var a={};return a[e.toLowerCase()]=n.toLowerCase(),a["Webkit"+e]="webkit"+n,a["Moz"+e]="moz"+n,a}var Fn={animationend:vt("Animation","AnimationEnd"),animationiteration:vt("Animation","AnimationIteration"),animationstart:vt("Animation","AnimationStart"),transitionend:vt("Transition","TransitionEnd")},tr={},ps={};Le&&(ps=document.createElement("div").style,"AnimationEvent"in window||(delete Fn.animationend.animation,delete Fn.animationiteration.animation,delete Fn.animationstart.animation),"TransitionEvent"in window||delete Fn.transitionend.transition);function Mt(e){if(tr[e])return tr[e];if(!Fn[e])return e;var n=Fn[e],a;for(a in n)if(n.hasOwnProperty(a)&&a in ps)return tr[e]=n[a];return e}var fs=Mt("animationend"),ms=Mt("animationiteration"),Ss=Mt("animationstart"),ks=Mt("transitionend"),Ts=new Map,ir=new Map,Md=["abort","abort",fs,"animationEnd",ms,"animationIteration",Ss,"animationStart","canplay","canPlay","canplaythrough","canPlayThrough","durationchange","durationChange","emptied","emptied","encrypted","encrypted","ended","ended","error","error","gotpointercapture","gotPointerCapture","load","load","loadeddata","loadedData","loadedmetadata","loadedMetadata","loadstart","loadStart","lostpointercapture","lostPointerCapture","playing","playing","progress","progress","seeking","seeking","stalled","stalled","suspend","suspend","timeupdate","timeUpdate",ks,"transitionEnd","waiting","waiting"];function rr(e,n){for(var a=0;a<e.length;a+=2){var t=e[a],i=e[a+1];i="on"+(i[0].toUpperCase()+i.slice(1)),ir.set(t,n),Ts.set(t,i),mn(i,[t])}}var Ed=X.unstable_now;Ed();var b=8;function bn(e){if((1&e)!=0)return b=15,1;if((2&e)!=0)return b=14,2;if((4&e)!=0)return b=13,4;var n=24&e;return n!==0?(b=12,n):(e&32)!=0?(b=11,32):(n=192&e,n!==0?(b=10,n):(e&256)!=0?(b=9,256):(n=3584&e,n!==0?(b=8,n):(e&4096)!=0?(b=7,4096):(n=4186112&e,n!==0?(b=6,n):(n=62914560&e,n!==0?(b=5,n):e&67108864?(b=4,67108864):(e&134217728)!=0?(b=3,134217728):(n=805306368&e,n!==0?(b=2,n):(1073741824&e)!=0?(b=1,1073741824):(b=8,e))))))}function Cd(e){switch(e){case 99:return 15;case 98:return 10;case 97:case 96:return 8;case 95:return 2;default:return 0}}function wd(e){switch(e){case 15:case 14:return 99;case 13:case 12:case 11:case 10:return 98;case 9:case 8:case 7:case 6:case 4:case 5:return 97;case 3:case 2:case 1:return 95;case 0:return 90;default:throw Error(T(358,e))}}function Wa(e,n){var a=e.pendingLanes;if(a===0)return b=0;var t=0,i=0,r=e.expiredLanes,o=e.suspendedLanes,s=e.pingedLanes;if(r!==0)t=r,i=b=15;else if(r=a&134217727,r!==0){var l=r&~o;l!==0?(t=bn(l),i=b):(s&=r,s!==0&&(t=bn(s),i=b))}else r=a&~o,r!==0?(t=bn(r),i=b):s!==0&&(t=bn(s),i=b);if(t===0)return 0;if(t=31-Ze(t),t=a&((0>t?0:1<<t)<<1)-1,n!==0&&n!==t&&(n&o)==0){if(bn(n),i<=b)return n;b=i}if(n=e.entangledLanes,n!==0)for(e=e.entanglements,n&=t;0<n;)a=31-Ze(n),i=1<<a,t|=e[a],n&=~i;return t}function ys(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function Et(e,n){switch(e){case 15:return 1;case 14:return 2;case 12:return e=Yn(24&~n),e===0?Et(10,n):e;case 10:return e=Yn(192&~n),e===0?Et(8,n):e;case 8:return e=Yn(3584&~n),e===0&&(e=Yn(4186112&~n),e===0&&(e=512)),e;case 2:return n=Yn(805306368&~n),n===0&&(n=268435456),n}throw Error(T(358,e))}function Yn(e){return e&-e}function or(e){for(var n=[],a=0;31>a;a++)n.push(e);return n}function Ct(e,n,a){e.pendingLanes|=n;var t=n-1;e.suspendedLanes&=t,e.pingedLanes&=t,e=e.eventTimes,n=31-Ze(n),e[n]=a}var Ze=Math.clz32?Math.clz32:Wd,Pd=Math.log,Od=Math.LN2;function Wd(e){return e===0?32:31-(Pd(e)/Od|0)|0}var Nd=X.unstable_UserBlockingPriority,Bd=X.unstable_runWithPriority,wt=!0;function Kd(e,n,a,t){Tn||_i();var i=sr,r=Tn;Tn=!0;try{ns(i,e,n,a,t)}finally{(Tn=r)||Zi()}}function Gd(e,n,a,t){Bd(Nd,sr.bind(null,e,n,a,t))}function sr(e,n,a,t){if(wt){var i;if((i=(n&4)==0)&&0<Ne.length&&-1<ds.indexOf(e))e=nr(null,e,n,a,t),Ne.push(e);else{var r=ar(e,n,a,t);if(r===null)i&&cs(e,t);else{if(i){if(-1<ds.indexOf(e)){e=nr(r,e,n,a,t),Ne.push(e);return}if(Ad(r,e,n,a,t))return;cs(e,t)}As(e,n,t,null,a)}}}}function ar(e,n,a,t){var i=ji(t);if(i=An(i),i!==null){var r=yn(i);if(r===null)i=null;else{var o=r.tag;if(o===13){if(i=ts(r),i!==null)return i;i=null}else if(o===3){if(r.stateNode.hydrate)return r.tag===3?r.stateNode.containerInfo:null;i=null}else r!==i&&(i=null)}}return As(e,n,t,i,a),null}var qe=null,lr=null,Wt=null;function Is(){if(Wt)return Wt;var e,n=lr,a=n.length,t,i="value"in qe?qe.value:qe.textContent,r=i.length;for(e=0;e<a&&n[e]===i[e];e++);var o=a-e;for(t=1;t<=o&&n[a-t]===i[r-t];t++);return Wt=i.slice(e,1<t?1-t:void 0)}function Pt(e){var n=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&n===13&&(e=13)):e=n,e===10&&(e=13),32<=e||e===13?e:0}function Ot(){return!0}function vs(){return!1}function ye(e){function n(a,t,i,r,o){this._reactName=a,this._targetInst=i,this.type=t,this.nativeEvent=r,this.target=o,this.currentTarget=null;for(var s in e)e.hasOwnProperty(s)&&(a=e[s],this[s]=a?a(r):r[s]);return this.isDefaultPrevented=(r.defaultPrevented!=null?r.defaultPrevented:r.returnValue===!1)?Ot:vs,this.isPropagationStopped=vs,this}return H(n.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():typeof a.returnValue!="unknown"&&(a.returnValue=!1),this.isDefaultPrevented=Ot)},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():typeof a.cancelBubble!="unknown"&&(a.cancelBubble=!0),this.isPropagationStopped=Ot)},persist:function(){},isPersistent:Ot}),n}var xn={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},ur=ye(xn),Pa=H({},xn,{view:0,detail:0}),Ud=ye(Pa),dr,cr,Oa,Nt=H({},Pa,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:gr,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==Oa&&(Oa&&e.type==="mousemove"?(dr=e.screenX-Oa.screenX,cr=e.screenY-Oa.screenY):cr=dr=0,Oa=e),dr)},movementY:function(e){return"movementY"in e?e.movementY:cr}}),Ms=ye(Nt),Dd=H({},Nt,{dataTransfer:0}),Rd=ye(Dd),Ld=H({},Pa,{relatedTarget:0}),hr=ye(Ld),Hd=H({},xn,{animationName:0,elapsedTime:0,pseudoElement:0}),Fd=ye(Hd),bd=H({},xn,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),Yd=ye(bd),xd=H({},xn,{data:0}),Es=ye(xd),Qd={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},jd={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},zd={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function Jd(e){var n=this.nativeEvent;return n.getModifierState?n.getModifierState(e):(e=zd[e])?!!n[e]:!1}function gr(){return Jd}var _d=H({},Pa,{key:function(e){if(e.key){var n=Qd[e.key]||e.key;if(n!=="Unidentified")return n}return e.type==="keypress"?(e=Pt(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?jd[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:gr,charCode:function(e){return e.type==="keypress"?Pt(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Pt(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),Vd=ye(_d),Zd=H({},Nt,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),Cs=ye(Zd),qd=H({},Pa,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:gr}),Xd=ye(qd),$d=H({},xn,{propertyName:0,elapsedTime:0,pseudoElement:0}),ec=ye($d),nc=H({},Nt,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),ac=ye(nc),tc=[9,13,27,32],pr=Le&&"CompositionEvent"in window,Na=null;Le&&"documentMode"in document&&(Na=document.documentMode);var ic=Le&&"TextEvent"in window&&!Na,ws=Le&&(!pr||Na&&8<Na&&11>=Na),Ws=String.fromCharCode(32),Ps=!1;function Os(e,n){switch(e){case"keyup":return tc.indexOf(n.keyCode)!==-1;case"keydown":return n.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function Ns(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var Qn=!1;function rc(e,n){switch(e){case"compositionend":return Ns(n);case"keypress":return n.which!==32?null:(Ps=!0,Ws);case"textInput":return e=n.data,e===Ws&&Ps?null:e;default:return null}}function oc(e,n){if(Qn)return e==="compositionend"||!pr&&Os(e,n)?(e=Is(),Wt=lr=qe=null,Qn=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(n.ctrlKey||n.altKey||n.metaKey)||n.ctrlKey&&n.altKey){if(n.char&&1<n.char.length)return n.char;if(n.which)return String.fromCharCode(n.which)}return null;case"compositionend":return ws&&n.locale!=="ko"?null:n.data;default:return null}}var sc={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Bs(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n==="input"?!!sc[e.type]:n==="textarea"}function Ks(e,n,a,t){$o(t),n=Bt(n,"onChange"),0<n.length&&(a=new ur("onChange","change",null,a,t),e.push({event:a,listeners:n}))}var Ba=null,Ka=null;function lc(e){Gs(e,0)}function Kt(e){var n=jn(e);if(bo(n))return e}function uc(e,n){if(e==="change")return n}var Us=!1;Le&&(Le?(Ut="oninput"in document,Ut||(fr=document.createElement("div"),fr.setAttribute("oninput","return;"),Ut=typeof fr.oninput=="function"),Gt=Ut):Gt=!1,Us=Gt&&(!document.documentMode||9<document.documentMode));var Gt,Ut,fr;function Rs(){Ba&&(Ba.detachEvent("onpropertychange",Ds),Ka=Ba=null)}function Ds(e){if(e.propertyName==="value"&&Kt(Ka)){var n=[];if(Ks(n,Ka,e,ji(e)),e=lc,Tn)e(n);else{Tn=!0;try{Ji(e,n)}finally{Tn=!1,Zi()}}}}function dc(e,n,a){e==="focusin"?(Rs(),Ba=n,Ka=a,Ba.attachEvent("onpropertychange",Ds)):e==="focusout"&&Rs()}function cc(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return Kt(Ka)}function gc(e,n){if(e==="click")return Kt(n)}function hc(e,n){if(e==="input"||e==="change")return Kt(n)}function pc(e,n){return e===n&&(e!==0||1/e==1/n)||e!==e&&n!==n}var Ie=typeof Object.is=="function"?Object.is:pc,fc=Object.prototype.hasOwnProperty;function Ga(e,n){if(Ie(e,n))return!0;if(typeof e!="object"||e===null||typeof n!="object"||n===null)return!1;var a=Object.keys(e),t=Object.keys(n);if(a.length!==t.length)return!1;for(t=0;t<a.length;t++)if(!fc.call(n,a[t])||!Ie(e[a[t]],n[a[t]]))return!1;return!0}function Ls(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function Hs(e,n){var a=Ls(e);e=0;for(var t;a;){if(a.nodeType===3){if(t=e+a.textContent.length,e<=n&&t>=n)return{node:a,offset:n-e};e=t}e:{for(;a;){if(a.nextSibling){a=a.nextSibling;break e}a=a.parentNode}a=void 0}a=Ls(a)}}function Fs(e,n){return e&&n?e===n?!0:e&&e.nodeType===3?!1:n&&n.nodeType===3?Fs(e,n.parentNode):"contains"in e?e.contains(n):e.compareDocumentPosition?!!(e.compareDocumentPosition(n)&16):!1:!1}function bs(){for(var e=window,n=St();n instanceof e.HTMLIFrameElement;){try{var a=typeof n.contentWindow.location.href=="string"}catch(t){a=!1}if(a)e=n.contentWindow;else break;n=St(e.document)}return n}function mr(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n&&(n==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||n==="textarea"||e.contentEditable==="true")}var mc=Le&&"documentMode"in document&&11>=document.documentMode,zn=null,Sr=null,Ua=null,kr=!1;function Ys(e,n,a){var t=a.window===a?a.document:a.nodeType===9?a:a.ownerDocument;kr||zn==null||zn!==St(t)||(t=zn,"selectionStart"in t&&mr(t)?t={start:t.selectionStart,end:t.selectionEnd}:(t=(t.ownerDocument&&t.ownerDocument.defaultView||window).getSelection(),t={anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}),Ua&&Ga(Ua,t)||(Ua=t,t=Bt(Sr,"onSelect"),0<t.length&&(n=new ur("onSelect","select",null,n,a),e.push({event:n,listeners:t}),n.target=zn)))}rr("cancel cancel click click close close contextmenu contextMenu copy copy cut cut auxclick auxClick dblclick doubleClick dragend dragEnd dragstart dragStart drop drop focusin focus focusout blur input input invalid invalid keydown keyDown keypress keyPress keyup keyUp mousedown mouseDown mouseup mouseUp paste paste pause pause play play pointercancel pointerCancel pointerdown pointerDown pointerup pointerUp ratechange rateChange reset reset seeked seeked submit submit touchcancel touchCancel touchend touchEnd touchstart touchStart volumechange volumeChange".split(" "),0);rr("drag drag dragenter dragEnter dragexit dragExit dragleave dragLeave dragover dragOver mousemove mouseMove mouseout mouseOut mouseover mouseOver pointermove pointerMove pointerout pointerOut pointerover pointerOver scroll scroll toggle toggle touchmove touchMove wheel wheel".split(" "),1);rr(Md,2);for(var xs="change selectionchange textInput compositionstart compositionend compositionupdate".split(" "),Tr=0;Tr<xs.length;Tr++)ir.set(xs[Tr],0);Gn("onMouseEnter",["mouseout","mouseover"]);Gn("onMouseLeave",["mouseout","mouseover"]);Gn("onPointerEnter",["pointerout","pointerover"]);Gn("onPointerLeave",["pointerout","pointerover"]);mn("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));mn("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));mn("onBeforeInput",["compositionend","keypress","textInput","paste"]);mn("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));mn("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));mn("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var Da="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),Qs=new Set("cancel close invalid load scroll toggle".split(" ").concat(Da));function js(e,n,a){var t=e.type||"unknown-event";e.currentTarget=a,Td(t,n,void 0,e),e.currentTarget=null}function Gs(e,n){n=(n&4)!=0;for(var a=0;a<e.length;a++){var t=e[a],i=t.event;t=t.listeners;e:{var r=void 0;if(n)for(var o=t.length-1;0<=o;o--){var s=t[o],l=s.instance,d=s.currentTarget;if(s=s.listener,l!==r&&i.isPropagationStopped())break e;js(i,s,d),r=l}else for(o=0;o<t.length;o++){if(s=t[o],l=s.instance,d=s.currentTarget,s=s.listener,l!==r&&i.isPropagationStopped())break e;js(i,s,d),r=l}}}if(At)throw e=Xi,At=!1,Xi=null,e}function x(e,n){var a=Js(n),t=e+"__bubble";a.has(t)||(zs(n,e,2,!1),a.add(t))}var _s="_reactListening"+Math.random().toString(36).slice(2);function Zs(e){e[_s]||(e[_s]=!0,Go.forEach(function(n){Qs.has(n)||Vs(n,!1,e,null),Vs(n,!0,e,null)}))}function Vs(e,n,a,t){var i=4<arguments.length&&arguments[4]!==void 0?arguments[4]:0,r=a;if(e==="selectionchange"&&a.nodeType!==9&&(r=a.ownerDocument),t!==null&&!n&&Qs.has(e)){if(e!=="scroll")return;i|=2,r=t}var o=Js(r),s=e+"__"+(n?"capture":"bubble");o.has(s)||(n&&(i|=4),zs(r,e,i,n),o.add(s))}function zs(e,n,a,t){var i=ir.get(n);switch(i===void 0?2:i){case 0:i=Kd;break;case 1:i=Gd;break;default:i=sr}a=i.bind(null,n,a,e),i=void 0,!qi||n!=="touchstart"&&n!=="touchmove"&&n!=="wheel"||(i=!0),t?i!==void 0?e.addEventListener(n,a,{capture:!0,passive:i}):e.addEventListener(n,a,!0):i!==void 0?e.addEventListener(n,a,{passive:i}):e.addEventListener(n,a,!1)}function As(e,n,a,t,i){var r=t;if((n&1)==0&&(n&2)==0&&t!==null)e:for(;;){if(t===null)return;var o=t.tag;if(o===3||o===4){var s=t.stateNode.containerInfo;if(s===i||s.nodeType===8&&s.parentNode===i)break;if(o===4)for(o=t.return;o!==null;){var l=o.tag;if((l===3||l===4)&&(l=o.stateNode.containerInfo,l===i||l.nodeType===8&&l.parentNode===i))return;o=o.return}for(;s!==null;){if(o=An(s),o===null)return;if(l=o.tag,l===5||l===6){t=r=o;continue e}s=s.parentNode}}t=t.return}fd(function(){var d=r,k=ji(a),w=[];e:{var m=Ts.get(e);if(m!==void 0){var M=ur,P=e;switch(e){case"keypress":if(Pt(a)===0)break e;case"keydown":case"keyup":M=Vd;break;case"focusin":P="focus",M=hr;break;case"focusout":P="blur",M=hr;break;case"beforeblur":case"afterblur":M=hr;break;case"click":if(a.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":M=Ms;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":M=Rd;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":M=Xd;break;case fs:case ms:case Ss:M=Fd;break;case ks:M=ec;break;case"scroll":M=Ud;break;case"wheel":M=ac;break;case"copy":case"cut":case"paste":M=Yd;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":M=Cs}var E=(n&4)!=0,g=!E&&e==="scroll",u=E?m!==null?m+"Capture":null:m;E=[];for(var c=d,p;c!==null;){p=c;var f=p.stateNode;if(p.tag===5&&f!==null&&(p=f,u!==null&&(f=Aa(c,u),f!=null&&E.push(Ra(c,f,p)))),g)break;c=c.return}0<E.length&&(m=new M(m,P,null,a,k),w.push({event:m,listeners:E}))}}if((n&7)==0){e:{if(m=e==="mouseover"||e==="pointerover",M=e==="mouseout"||e==="pointerout",m&&(n&16)==0&&(P=a.relatedTarget||a.fromElement)&&(An(P)||P[_n]))break e;if((M||m)&&(m=k.window===k?k:(m=k.ownerDocument)?m.defaultView||m.parentWindow:window,M?(P=a.relatedTarget||a.toElement,M=d,P=P?An(P):null,P!==null&&(g=yn(P),P!==g||P.tag!==5&&P.tag!==6)&&(P=null)):(M=null,P=d),M!==P)){if(E=Ms,f="onMouseLeave",u="onMouseEnter",c="mouse",(e==="pointerout"||e==="pointerover")&&(E=Cs,f="onPointerLeave",u="onPointerEnter",c="pointer"),g=M==null?m:jn(M),p=P==null?m:jn(P),m=new E(f,c+"leave",M,a,k),m.target=g,m.relatedTarget=p,f=null,An(k)===d&&(E=new E(u,c+"enter",P,a,k),E.target=p,E.relatedTarget=g,f=E),g=f,M&&P)n:{for(E=M,u=P,c=0,p=E;p;p=Jn(p))c++;for(p=0,f=u;f;f=Jn(f))p++;for(;0<c-p;)E=Jn(E),c--;for(;0<p-c;)u=Jn(u),p--;for(;c--;){if(E===u||u!==null&&E===u.alternate)break n;E=Jn(E),u=Jn(u)}E=null}else E=null;M!==null&&qs(w,m,M,E,!1),P!==null&&g!==null&&qs(w,g,P,E,!0)}}e:{if(m=d?jn(d):window,M=m.nodeName&&m.nodeName.toLowerCase(),M==="select"||M==="input"&&m.type==="file")var O=uc;else if(Bs(m))if(Us)O=hc;else{O=cc;var A=dc}else(M=m.nodeName)&&M.toLowerCase()==="input"&&(m.type==="checkbox"||m.type==="radio")&&(O=gc);if(O&&(O=O(e,d))){Ks(w,O,a,k);break e}A&&A(e,m,d),e==="focusout"&&(A=m._wrapperState)&&A.controlled&&m.type==="number"&&Ri(m,"number",m.value)}switch(A=d?jn(d):window,e){case"focusin":(Bs(A)||A.contentEditable==="true")&&(zn=A,Sr=d,Ua=null);break;case"focusout":Ua=Sr=zn=null;break;case"mousedown":kr=!0;break;case"contextmenu":case"mouseup":case"dragend":kr=!1,Ys(w,a,k);break;case"selectionchange":if(mc)break;case"keydown":case"keyup":Ys(w,a,k)}var C;if(pr)e:{switch(e){case"compositionstart":var B="onCompositionStart";break e;case"compositionend":B="onCompositionEnd";break e;case"compositionupdate":B="onCompositionUpdate";break e}B=void 0}else Qn?Os(e,a)&&(B="onCompositionEnd"):e==="keydown"&&a.keyCode===229&&(B="onCompositionStart");B&&(ws&&a.locale!=="ko"&&(Qn||B!=="onCompositionStart"?B==="onCompositionEnd"&&Qn&&(C=Is()):(qe=k,lr="value"in qe?qe.value:qe.textContent,Qn=!0)),A=Bt(d,B),0<A.length&&(B=new Es(B,e,null,a,k),w.push({event:B,listeners:A}),C?B.data=C:(C=Ns(a),C!==null&&(B.data=C)))),(C=ic?rc(e,a):oc(e,a))&&(d=Bt(d,"onBeforeInput"),0<d.length&&(k=new Es("onBeforeInput","beforeinput",null,a,k),w.push({event:k,listeners:d}),k.data=C))}Gs(w,n)})}function Ra(e,n,a){return{instance:e,listener:n,currentTarget:a}}function Bt(e,n){for(var a=n+"Capture",t=[];e!==null;){var i=e,r=i.stateNode;i.tag===5&&r!==null&&(i=r,r=Aa(e,a),r!=null&&t.unshift(Ra(e,r,i)),r=Aa(e,n),r!=null&&t.push(Ra(e,r,i))),e=e.return}return t}function Jn(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function qs(e,n,a,t,i){for(var r=n._reactName,o=[];a!==null&&a!==t;){var s=a,l=s.alternate,d=s.stateNode;if(l!==null&&l===t)break;s.tag===5&&d!==null&&(s=d,i?(l=Aa(a,r),l!=null&&o.unshift(Ra(a,l,s))):i||(l=Aa(a,r),l!=null&&o.push(Ra(a,l,s)))),a=a.return}o.length!==0&&e.push({event:n,listeners:o})}function Dt(){}var yr=null,Ar=null;function Xs(e,n){switch(e){case"button":case"input":case"select":case"textarea":return!!n.autoFocus}return!1}function Ir(e,n){return e==="textarea"||e==="option"||e==="noscript"||typeof n.children=="string"||typeof n.children=="number"||typeof n.dangerouslySetInnerHTML=="object"&&n.dangerouslySetInnerHTML!==null&&n.dangerouslySetInnerHTML.__html!=null}var $s=typeof setTimeout=="function"?setTimeout:void 0,Sc=typeof clearTimeout=="function"?clearTimeout:void 0;function vr(e){e.nodeType===1?e.textContent="":e.nodeType===9&&(e=e.body,e!=null&&(e.textContent=""))}function Vn(e){for(;e!=null;e=e.nextSibling){var n=e.nodeType;if(n===1||n===3)break}return e}function el(e){e=e.previousSibling;for(var n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="$"||a==="$!"||a==="$?"){if(n===0)return e;n--}else a==="/$"&&n++}e=e.previousSibling}return null}var Mr=0;function kc(e){return{$$typeof:Ni,toString:e,valueOf:e}}var Rt=Math.random().toString(36).slice(2),Xe="__reactFiber$"+Rt,Lt="__reactProps$"+Rt,_n="__reactContainer$"+Rt,nl="__reactEvents$"+Rt;function An(e){var n=e[Xe];if(n)return n;for(var a=e.parentNode;a;){if(n=a[_n]||a[Xe]){if(a=n.alternate,n.child!==null||a!==null&&a.child!==null)for(e=el(e);e!==null;){if(a=e[Xe])return a;e=el(e)}return n}e=a,a=e.parentNode}return null}function ya(e){return e=e[Xe]||e[_n],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function jn(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(T(33))}function Tt(e){return e[Lt]||null}function Js(e){var n=e[nl];return n===void 0&&(n=e[nl]=new Set),n}var Er=[],Zn=-1;function $e(e){return{current:e}}function Q(e){0>Zn||(e.current=Er[Zn],Er[Zn]=null,Zn--)}function J(e,n){Zn++,Er[Zn]=e.current,e.current=n}var en={},le=$e(en),fe=$e(!1),In=en;function qn(e,n){var a=e.type.contextTypes;if(!a)return en;var t=e.stateNode;if(t&&t.__reactInternalMemoizedUnmaskedChildContext===n)return t.__reactInternalMemoizedMaskedChildContext;var i={},r;for(r in a)i[r]=n[r];return t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=i),i}function me(e){return e=e.childContextTypes,e!=null}function Ht(){Q(fe),Q(le)}function al(e,n,a){if(le.current!==en)throw Error(T(168));J(le,n),J(fe,a)}function tl(e,n,a){var t=e.stateNode;if(e=n.childContextTypes,typeof t.getChildContext!="function")return a;t=t.getChildContext();for(var i in t)if(!(i in e))throw Error(T(108,Un(n)||"Unknown",i));return H({},a,t)}function Ft(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||en,In=le.current,J(le,e),J(fe,fe.current),!0}function il(e,n,a){var t=e.stateNode;if(!t)throw Error(T(169));a?(e=tl(e,n,In),t.__reactInternalMemoizedMergedChildContext=e,Q(fe),Q(le),J(le,e)):Q(fe),J(fe,a)}var Cr=null,vn=null,Tc=X.unstable_runWithPriority,wr=X.unstable_scheduleCallback,Wr=X.unstable_cancelCallback,yc=X.unstable_shouldYield,rl=X.unstable_requestPaint,Pr=X.unstable_now,Ac=X.unstable_getCurrentPriorityLevel,bt=X.unstable_ImmediatePriority,ol=X.unstable_UserBlockingPriority,sl=X.unstable_NormalPriority,ll=X.unstable_LowPriority,ul=X.unstable_IdlePriority,Or={},Ic=rl!==void 0?rl:function(){},He=null,Yt=null,Nr=!1,dl=Pr(),ue=1e4>dl?Pr:function(){return Pr()-dl};function Xn(){switch(Ac()){case bt:return 99;case ol:return 98;case sl:return 97;case ll:return 96;case ul:return 95;default:throw Error(T(332))}}function cl(e){switch(e){case 99:return bt;case 98:return ol;case 97:return sl;case 96:return ll;case 95:return ul;default:throw Error(T(332))}}function Mn(e,n){return e=cl(e),Tc(e,n)}function La(e,n,a){return e=cl(e),wr(e,n,a)}function Be(){if(Yt!==null){var e=Yt;Yt=null,Wr(e)}gl()}function gl(){if(!Nr&&He!==null){Nr=!0;var e=0;try{var n=He;Mn(99,function(){for(;e<n.length;e++){var a=n[e];do a=a(!0);while(a!==null)}}),He=null}catch(a){throw He!==null&&(He=He.slice(e+1)),wr(bt,Be),a}finally{Nr=!1}}}var vc=Sn.ReactCurrentBatchConfig;function We(e,n){if(e&&e.defaultProps){n=H({},n),e=e.defaultProps;for(var a in e)n[a]===void 0&&(n[a]=e[a]);return n}return n}var xt=$e(null),Qt=null,$n=null,jt=null;function Br(){jt=$n=Qt=null}function Kr(e){var n=xt.current;Q(xt),e.type._context._currentValue=n}function hl(e,n){for(;e!==null;){var a=e.alternate;if((e.childLanes&n)===n){if(a===null||(a.childLanes&n)===n)break;a.childLanes|=n}else e.childLanes|=n,a!==null&&(a.childLanes|=n);e=e.return}}function ea(e,n){Qt=e,jt=$n=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&n)!=0&&(Pe=!0),e.firstContext=null)}function ve(e,n){if(jt!==e&&n!==!1&&n!==0)if((typeof n!="number"||n===1073741823)&&(jt=e,n=1073741823),n={context:e,observedBits:n,next:null},$n===null){if(Qt===null)throw Error(T(308));$n=n,Qt.dependencies={lanes:0,firstContext:n,responders:null}}else $n=$n.next=n;return e._currentValue}var nn=!1;function Gr(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null},effects:null}}function pl(e,n){e=e.updateQueue,n.updateQueue===e&&(n.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function an(e,n){return{eventTime:e,lane:n,tag:0,payload:null,callback:null,next:null}}function tn(e,n){if(e=e.updateQueue,e!==null){e=e.shared;var a=e.pending;a===null?n.next=n:(n.next=a.next,a.next=n),e.pending=n}}function fl(e,n){var a=e.updateQueue,t=e.alternate;if(t!==null&&(t=t.updateQueue,a===t)){var i=null,r=null;if(a=a.firstBaseUpdate,a!==null){do{var o={eventTime:a.eventTime,lane:a.lane,tag:a.tag,payload:a.payload,callback:a.callback,next:null};r===null?i=r=o:r=r.next=o,a=a.next}while(a!==null);r===null?i=r=n:r=r.next=n}else i=r=n;a={baseState:t.baseState,firstBaseUpdate:i,lastBaseUpdate:r,shared:t.shared,effects:t.effects},e.updateQueue=a;return}e=a.lastBaseUpdate,e===null?a.firstBaseUpdate=n:e.next=n,a.lastBaseUpdate=n}function Fa(e,n,a,t){var i=e.updateQueue;nn=!1;var r=i.firstBaseUpdate,o=i.lastBaseUpdate,s=i.shared.pending;if(s!==null){i.shared.pending=null;var l=s,d=l.next;l.next=null,o===null?r=d:o.next=d,o=l;var k=e.alternate;if(k!==null){k=k.updateQueue;var w=k.lastBaseUpdate;w!==o&&(w===null?k.firstBaseUpdate=d:w.next=d,k.lastBaseUpdate=l)}}if(r!==null){w=i.baseState,o=0,k=d=l=null;do{s=r.lane;var m=r.eventTime;if((t&s)===s){k!==null&&(k=k.next={eventTime:m,lane:0,tag:r.tag,payload:r.payload,callback:r.callback,next:null});e:{var M=e,P=r;switch(s=n,m=a,P.tag){case 1:if(M=P.payload,typeof M=="function"){w=M.call(m,w,s);break e}w=M;break e;case 3:M.flags=M.flags&-4097|64;case 0:if(M=P.payload,s=typeof M=="function"?M.call(m,w,s):M,s==null)break e;w=H({},w,s);break e;case 2:nn=!0}}r.callback!==null&&(e.flags|=32,s=i.effects,s===null?i.effects=[r]:s.push(r))}else m={eventTime:m,lane:s,tag:r.tag,payload:r.payload,callback:r.callback,next:null},k===null?(d=k=m,l=w):k=k.next=m,o|=s;if(r=r.next,r===null){if(s=i.shared.pending,s===null)break;r=s.next,s.next=null,i.lastBaseUpdate=s,i.shared.pending=null}}while(1);k===null&&(l=w),i.baseState=l,i.firstBaseUpdate=d,i.lastBaseUpdate=k,Ha|=o,e.lanes=o,e.memoizedState=w}}function ml(e,n,a){if(e=n.effects,n.effects=null,e!==null)for(n=0;n<e.length;n++){var t=e[n],i=t.callback;if(i!==null){if(t.callback=null,t=a,typeof i!="function")throw Error(T(191,i));i.call(t)}}}var Sl=new L.Component().refs;function zt(e,n,a,t){n=e.memoizedState,a=a(t,n),a=a==null?n:H({},n,a),e.memoizedState=a,e.lanes===0&&(e.updateQueue.baseState=a)}var Jt={isMounted:function(e){return(e=e._reactInternals)?yn(e)===e:!1},enqueueSetState:function(e,n,a){e=e._reactInternals;var t=Ae(),i=rn(e),r=an(t,i);r.payload=n,a!=null&&(r.callback=a),tn(e,r),on(e,i,t)},enqueueReplaceState:function(e,n,a){e=e._reactInternals;var t=Ae(),i=rn(e),r=an(t,i);r.tag=1,r.payload=n,a!=null&&(r.callback=a),tn(e,r),on(e,i,t)},enqueueForceUpdate:function(e,n){e=e._reactInternals;var a=Ae(),t=rn(e),i=an(a,t);i.tag=2,n!=null&&(i.callback=n),tn(e,i),on(e,t,a)}};function kl(e,n,a,t,i,r,o){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(t,r,o):n.prototype&&n.prototype.isPureReactComponent?!Ga(a,t)||!Ga(i,r):!0}function Tl(e,n,a){var t=!1,i=en,r=n.contextType;return typeof r=="object"&&r!==null?r=ve(r):(i=me(n)?In:le.current,t=n.contextTypes,r=(t=t!=null)?qn(e,i):en),n=new n(a,r),e.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,n.updater=Jt,e.stateNode=n,n._reactInternals=e,t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=i,e.__reactInternalMemoizedMaskedChildContext=r),n}function yl(e,n,a,t){e=n.state,typeof n.componentWillReceiveProps=="function"&&n.componentWillReceiveProps(a,t),typeof n.UNSAFE_componentWillReceiveProps=="function"&&n.UNSAFE_componentWillReceiveProps(a,t),n.state!==e&&Jt.enqueueReplaceState(n,n.state,null)}function Ur(e,n,a,t){var i=e.stateNode;i.props=a,i.state=e.memoizedState,i.refs=Sl,Gr(e);var r=n.contextType;typeof r=="object"&&r!==null?i.context=ve(r):(r=me(n)?In:le.current,i.context=qn(e,r)),Fa(e,a,i,t),i.state=e.memoizedState,r=n.getDerivedStateFromProps,typeof r=="function"&&(zt(e,n,r,a),i.state=e.memoizedState),typeof n.getDerivedStateFromProps=="function"||typeof i.getSnapshotBeforeUpdate=="function"||typeof i.UNSAFE_componentWillMount!="function"&&typeof i.componentWillMount!="function"||(n=i.state,typeof i.componentWillMount=="function"&&i.componentWillMount(),typeof i.UNSAFE_componentWillMount=="function"&&i.UNSAFE_componentWillMount(),n!==i.state&&Jt.enqueueReplaceState(i,i.state,null),Fa(e,a,i,t),i.state=e.memoizedState),typeof i.componentDidMount=="function"&&(e.flags|=4)}var _t=Array.isArray;function ba(e,n,a){if(e=a.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(a._owner){if(a=a._owner,a){if(a.tag!==1)throw Error(T(309));var t=a.stateNode}if(!t)throw Error(T(147,e));var i=""+e;return n!==null&&n.ref!==null&&typeof n.ref=="function"&&n.ref._stringRef===i?n.ref:(n=function(r){var o=t.refs;o===Sl&&(o=t.refs={}),r===null?delete o[i]:o[i]=r},n._stringRef=i,n)}if(typeof e!="string")throw Error(T(284));if(!a._owner)throw Error(T(290,e))}return e}function Vt(e,n){if(e.type!=="textarea")throw Error(T(31,Object.prototype.toString.call(n)==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":n))}function Al(e){function n(g,u){if(e){var c=g.lastEffect;c!==null?(c.nextEffect=u,g.lastEffect=u):g.firstEffect=g.lastEffect=u,u.nextEffect=null,u.flags=8}}function a(g,u){if(!e)return null;for(;u!==null;)n(g,u),u=u.sibling;return null}function t(g,u){for(g=new Map;u!==null;)u.key!==null?g.set(u.key,u):g.set(u.index,u),u=u.sibling;return g}function i(g,u){return g=sn(g,u),g.index=0,g.sibling=null,g}function r(g,u,c){return g.index=c,e?(c=g.alternate,c!==null?(c=c.index,c<u?(g.flags=2,u):c):(g.flags=2,u)):u}function o(g){return e&&g.alternate===null&&(g.flags=2),g}function s(g,u,c,p){return u===null||u.tag!==6?(u=Dr(c,g.mode,p),u.return=g,u):(u=i(u,c),u.return=g,u)}function l(g,u,c,p){return u!==null&&u.elementType===c.type?(p=i(u,c.props),p.ref=ba(g,u,c),p.return=g,p):(p=Zt(c.type,c.key,c.props,null,g.mode,p),p.ref=ba(g,u,c),p.return=g,p)}function d(g,u,c,p){return u===null||u.tag!==4||u.stateNode.containerInfo!==c.containerInfo||u.stateNode.implementation!==c.implementation?(u=Rr(c,g.mode,p),u.return=g,u):(u=i(u,c.children||[]),u.return=g,u)}function k(g,u,c,p,f){return u===null||u.tag!==7?(u=na(c,g.mode,p,f),u.return=g,u):(u=i(u,c),u.return=g,u)}function w(g,u,c){if(typeof u=="string"||typeof u=="number")return u=Dr(""+u,g.mode,c),u.return=g,u;if(typeof u=="object"&&u!==null){switch(u.$$typeof){case ha:return c=Zt(u.type,u.key,u.props,null,g.mode,c),c.ref=ba(g,null,u),c.return=g,c;case kn:return u=Rr(u,g.mode,c),u.return=g,u}if(_t(u)||ma(u))return u=na(u,g.mode,c,null),u.return=g,u;Vt(g,u)}return null}function m(g,u,c,p){var f=u!==null?u.key:null;if(typeof c=="string"||typeof c=="number")return f!==null?null:s(g,u,""+c,p);if(typeof c=="object"&&c!==null){switch(c.$$typeof){case ha:return c.key===f?c.type===je?k(g,u,c.props.children,p,f):l(g,u,c,p):null;case kn:return c.key===f?d(g,u,c,p):null}if(_t(c)||ma(c))return f!==null?null:k(g,u,c,p,null);Vt(g,c)}return null}function M(g,u,c,p,f){if(typeof p=="string"||typeof p=="number")return g=g.get(c)||null,s(u,g,""+p,f);if(typeof p=="object"&&p!==null){switch(p.$$typeof){case ha:return g=g.get(p.key===null?c:p.key)||null,p.type===je?k(u,g,p.props.children,f,p.key):l(u,g,p,f);case kn:return g=g.get(p.key===null?c:p.key)||null,d(u,g,p,f)}if(_t(p)||ma(p))return g=g.get(c)||null,k(u,g,p,f,null);Vt(u,p)}return null}function P(g,u,c,p){for(var f=null,O=null,A=u,C=u=0,B=null;A!==null&&C<c.length;C++){A.index>C?(B=A,A=null):B=A.sibling;var N=m(g,A,c[C],p);if(N===null){A===null&&(A=B);break}e&&A&&N.alternate===null&&n(g,A),u=r(N,u,C),O===null?f=N:O.sibling=N,O=N,A=B}if(C===c.length)return a(g,A),f;if(A===null){for(;C<c.length;C++)A=w(g,c[C],p),A!==null&&(u=r(A,u,C),O===null?f=A:O.sibling=A,O=A);return f}for(A=t(g,A);C<c.length;C++)B=M(A,g,C,c[C],p),B!==null&&(e&&B.alternate!==null&&A.delete(B.key===null?C:B.key),u=r(B,u,C),O===null?f=B:O.sibling=B,O=B);return e&&A.forEach(function(z){return n(g,z)}),f}function E(g,u,c,p){var f=ma(c);if(typeof f!="function")throw Error(T(150));if(c=f.call(c),c==null)throw Error(T(151));for(var O=f=null,A=u,C=u=0,B=null,N=c.next();A!==null&&!N.done;C++,N=c.next()){A.index>C?(B=A,A=null):B=A.sibling;var z=m(g,A,N.value,p);if(z===null){A===null&&(A=B);break}e&&A&&z.alternate===null&&n(g,A),u=r(z,u,C),O===null?f=z:O.sibling=z,O=z,A=B}if(N.done)return a(g,A),f;if(A===null){for(;!N.done;C++,N=c.next())N=w(g,N.value,p),N!==null&&(u=r(N,u,C),O===null?f=N:O.sibling=N,O=N);return f}for(A=t(g,A);!N.done;C++,N=c.next())N=M(A,g,C,N.value,p),N!==null&&(e&&N.alternate!==null&&A.delete(N.key===null?C:N.key),u=r(N,u,C),O===null?f=N:O.sibling=N,O=N);return e&&A.forEach(function(pe){return n(g,pe)}),f}return function(g,u,c,p){var f=typeof c=="object"&&c!==null&&c.type===je&&c.key===null;f&&(c=c.props.children);var O=typeof c=="object"&&c!==null;if(O)switch(c.$$typeof){case ha:e:{for(O=c.key,f=u;f!==null;){if(f.key===O){switch(f.tag){case 7:if(c.type===je){a(g,f.sibling),u=i(f,c.props.children),u.return=g,g=u;break e}break;default:if(f.elementType===c.type){a(g,f.sibling),u=i(f,c.props),u.ref=ba(g,f,c),u.return=g,g=u;break e}}a(g,f);break}else n(g,f);f=f.sibling}c.type===je?(u=na(c.props.children,g.mode,p,c.key),u.return=g,g=u):(p=Zt(c.type,c.key,c.props,null,g.mode,p),p.ref=ba(g,u,c),p.return=g,g=p)}return o(g);case kn:e:{for(f=c.key;u!==null;){if(u.key===f)if(u.tag===4&&u.stateNode.containerInfo===c.containerInfo&&u.stateNode.implementation===c.implementation){a(g,u.sibling),u=i(u,c.children||[]),u.return=g,g=u;break e}else{a(g,u);break}else n(g,u);u=u.sibling}u=Rr(c,g.mode,p),u.return=g,g=u}return o(g)}if(typeof c=="string"||typeof c=="number")return c=""+c,u!==null&&u.tag===6?(a(g,u.sibling),u=i(u,c),u.return=g,g=u):(a(g,u),u=Dr(c,g.mode,p),u.return=g,g=u),o(g);if(_t(c))return P(g,u,c,p);if(ma(c))return E(g,u,c,p);if(O&&Vt(g,c),typeof c=="undefined"&&!f)switch(g.tag){case 1:case 22:case 0:case 11:case 15:throw Error(T(152,Un(g.type)||"Component"))}return a(g,u)}}var qt=Al(!0),Il=Al(!1),Ya={},Ke=$e(Ya),xa=$e(Ya),Qa=$e(Ya);function En(e){if(e===Ya)throw Error(T(174));return e}function Lr(e,n){switch(J(Qa,n),J(xa,e),J(Ke,Ya),e=n.nodeType,e){case 9:case 11:n=(n=n.documentElement)?n.namespaceURI:Yi(null,"");break;default:e=e===8?n.parentNode:n,n=e.namespaceURI||null,e=e.tagName,n=Yi(n,e)}Q(Ke),J(Ke,n)}function aa(){Q(Ke),Q(xa),Q(Qa)}function vl(e){En(Qa.current);var n=En(Ke.current),a=Yi(n,e.type);n!==a&&(J(xa,e),J(Ke,a))}function Hr(e){xa.current===e&&(Q(Ke),Q(xa))}var _=$e(0);function Xt(e){for(var n=e;n!==null;){if(n.tag===13){var a=n.memoizedState;if(a!==null&&(a=a.dehydrated,a===null||a.data==="$?"||a.data==="$!"))return n}else if(n.tag===19&&n.memoizedProps.revealOrder!==void 0){if((n.flags&64)!=0)return n}else if(n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}return null}var Fe=null,ln=null,Ge=!1;function Ml(e,n){var a=Me(5,null,null,0);a.elementType="DELETED",a.type="DELETED",a.stateNode=n,a.return=e,a.flags=8,e.lastEffect!==null?(e.lastEffect.nextEffect=a,e.lastEffect=a):e.firstEffect=e.lastEffect=a}function El(e,n){switch(e.tag){case 5:var a=e.type;return n=n.nodeType!==1||a.toLowerCase()!==n.nodeName.toLowerCase()?null:n,n!==null?(e.stateNode=n,!0):!1;case 6:return n=e.pendingProps===""||n.nodeType!==3?null:n,n!==null?(e.stateNode=n,!0):!1;case 13:return!1;default:return!1}}function Fr(e){if(Ge){var n=ln;if(n){var a=n;if(!El(e,n)){if(n=Vn(a.nextSibling),!n||!El(e,n)){e.flags=e.flags&-1025|2,Ge=!1,Fe=e;return}Ml(Fe,a)}Fe=e,ln=Vn(n.firstChild)}else e.flags=e.flags&-1025|2,Ge=!1,Fe=e}}function Cl(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;Fe=e}function $t(e){if(e!==Fe)return!1;if(!Ge)return Cl(e),Ge=!0,!1;var n=e.type;if(e.tag!==5||n!=="head"&&n!=="body"&&!Ir(n,e.memoizedProps))for(n=ln;n;)Ml(e,n),n=Vn(n.nextSibling);if(Cl(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(T(317));e:{for(e=e.nextSibling,n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="/$"){if(n===0){ln=Vn(e.nextSibling);break e}n--}else a!=="$"&&a!=="$!"&&a!=="$?"||n++}e=e.nextSibling}ln=null}}else ln=Fe?Vn(e.stateNode.nextSibling):null;return!0}function br(){ln=Fe=null,Ge=!1}var ta=[];function Yr(){for(var e=0;e<ta.length;e++)ta[e]._workInProgressVersionPrimary=null;ta.length=0}var ja=Sn.ReactCurrentDispatcher,Ee=Sn.ReactCurrentBatchConfig,za=0,Z=null,de=null,oe=null,ei=!1,Ja=!1;function Se(){throw Error(T(321))}function xr(e,n){if(n===null)return!1;for(var a=0;a<n.length&&a<e.length;a++)if(!Ie(e[a],n[a]))return!1;return!0}function Qr(e,n,a,t,i,r){if(za=r,Z=n,n.memoizedState=null,n.updateQueue=null,n.lanes=0,ja.current=e===null||e.memoizedState===null?Mc:Ec,e=a(t,i),Ja){r=0;do{if(Ja=!1,!(25>r))throw Error(T(301));r+=1,oe=de=null,n.updateQueue=null,ja.current=Cc,e=a(t,i)}while(Ja)}if(ja.current=ni,n=de!==null&&de.next!==null,za=0,oe=de=Z=null,ei=!1,n)throw Error(T(300));return e}function Cn(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return oe===null?Z.memoizedState=oe=e:oe=oe.next=e,oe}function wn(){if(de===null){var e=Z.alternate;e=e!==null?e.memoizedState:null}else e=de.next;var n=oe===null?Z.memoizedState:oe.next;if(n!==null)oe=n,de=e;else{if(e===null)throw Error(T(310));de=e,e={memoizedState:de.memoizedState,baseState:de.baseState,baseQueue:de.baseQueue,queue:de.queue,next:null},oe===null?Z.memoizedState=oe=e:oe=oe.next=e}return oe}function Ue(e,n){return typeof n=="function"?n(e):n}function _a(e){var n=wn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=de,i=t.baseQueue,r=a.pending;if(r!==null){if(i!==null){var o=i.next;i.next=r.next,r.next=o}t.baseQueue=i=r,a.pending=null}if(i!==null){i=i.next,t=t.baseState;var s=o=r=null,l=i;do{var d=l.lane;if((za&d)===d)s!==null&&(s=s.next={lane:0,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null}),t=l.eagerReducer===e?l.eagerState:e(t,l.action);else{var k={lane:d,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null};s===null?(o=s=k,r=t):s=s.next=k,Z.lanes|=d,Ha|=d}l=l.next}while(l!==null&&l!==i);s===null?r=t:s.next=o,Ie(t,n.memoizedState)||(Pe=!0),n.memoizedState=t,n.baseState=r,n.baseQueue=s,a.lastRenderedState=t}return[n.memoizedState,a.dispatch]}function Va(e){var n=wn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var t=a.dispatch,i=a.pending,r=n.memoizedState;if(i!==null){a.pending=null;var o=i=i.next;do r=e(r,o.action),o=o.next;while(o!==i);Ie(r,n.memoizedState)||(Pe=!0),n.memoizedState=r,n.baseQueue===null&&(n.baseState=r),a.lastRenderedState=r}return[r,t]}function wl(e,n,a){var t=n._getVersion;t=t(n._source);var i=n._workInProgressVersionPrimary;if(i!==null?e=i===t:(e=e.mutableReadLanes,(e=(za&e)===e)&&(n._workInProgressVersionPrimary=t,ta.push(n))),e)return a(n._source);throw ta.push(n),Error(T(350))}function Wl(e,n,a,t){var i=he;if(i===null)throw Error(T(349));var r=n._getVersion,o=r(n._source),s=ja.current,l=s.useState(function(){return wl(i,n,a)}),d=l[1],k=l[0];l=oe;var w=e.memoizedState,m=w.refs,M=m.getSnapshot,P=w.source;w=w.subscribe;var E=Z;return e.memoizedState={refs:m,source:n,subscribe:t},s.useEffect(function(){m.getSnapshot=a,m.setSnapshot=d;var g=r(n._source);if(!Ie(o,g)){g=a(n._source),Ie(k,g)||(d(g),g=rn(E),i.mutableReadLanes|=g&i.pendingLanes),g=i.mutableReadLanes,i.entangledLanes|=g;for(var u=i.entanglements,c=g;0<c;){var p=31-Ze(c),f=1<<p;u[p]|=g,c&=~f}}},[a,n,t]),s.useEffect(function(){return t(n._source,function(){var g=m.getSnapshot,u=m.setSnapshot;try{u(g(n._source));var c=rn(E);i.mutableReadLanes|=c&i.pendingLanes}catch(p){u(function(){throw p})}})},[n,t]),Ie(M,a)&&Ie(P,n)&&Ie(w,t)||(e={pending:null,dispatch:null,lastRenderedReducer:Ue,lastRenderedState:k},e.dispatch=d=jr.bind(null,Z,e),l.queue=e,l.baseQueue=null,k=wl(i,n,a),l.memoizedState=l.baseState=k),k}function Pl(e,n,a){var t=wn();return Wl(t,e,n,a)}function Za(e){var n=Cn();return typeof e=="function"&&(e=e()),n.memoizedState=n.baseState=e,e=n.queue={pending:null,dispatch:null,lastRenderedReducer:Ue,lastRenderedState:e},e=e.dispatch=jr.bind(null,Z,e),[n.memoizedState,e]}function ai(e,n,a,t){return e={tag:e,create:n,destroy:a,deps:t,next:null},n=Z.updateQueue,n===null?(n={lastEffect:null},Z.updateQueue=n,n.lastEffect=e.next=e):(a=n.lastEffect,a===null?n.lastEffect=e.next=e:(t=a.next,a.next=e,e.next=t,n.lastEffect=e)),e}function Ol(e){var n=Cn();return e={current:e},n.memoizedState=e}function ti(){return wn().memoizedState}function zr(e,n,a,t){var i=Cn();Z.flags|=e,i.memoizedState=ai(1|n,a,void 0,t===void 0?null:t)}function Jr(e,n,a,t){var i=wn();t=t===void 0?null:t;var r=void 0;if(de!==null){var o=de.memoizedState;if(r=o.destroy,t!==null&&xr(t,o.deps)){ai(n,a,r,t);return}}Z.flags|=e,i.memoizedState=ai(1|n,a,r,t)}function Nl(e,n){return zr(516,4,e,n)}function ii(e,n){return Jr(516,4,e,n)}function Bl(e,n){return Jr(4,2,e,n)}function Kl(e,n){if(typeof n=="function")return e=e(),n(e),function(){n(null)};if(n!=null)return e=e(),n.current=e,function(){n.current=null}}function Gl(e,n,a){return a=a!=null?a.concat([e]):null,Jr(4,2,Kl.bind(null,n,e),a)}function _r(){}function Ul(e,n){var a=wn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&xr(n,t[1])?t[0]:(a.memoizedState=[e,n],e)}function Dl(e,n){var a=wn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&xr(n,t[1])?t[0]:(e=e(),a.memoizedState=[e,n],e)}function wc(e,n){var a=Xn();Mn(98>a?98:a,function(){e(!0)}),Mn(97<a?97:a,function(){var t=Ee.transition;Ee.transition=1;try{e(!1),n()}finally{Ee.transition=t}})}function jr(e,n,a){var t=Ae(),i=rn(e),r={lane:i,action:a,eagerReducer:null,eagerState:null,next:null},o=n.pending;if(o===null?r.next=r:(r.next=o.next,o.next=r),n.pending=r,o=e.alternate,e===Z||o!==null&&o===Z)Ja=ei=!0;else{if(e.lanes===0&&(o===null||o.lanes===0)&&(o=n.lastRenderedReducer,o!==null))try{var s=n.lastRenderedState,l=o(s,a);if(r.eagerReducer=o,r.eagerState=l,Ie(l,s))return}catch(d){}finally{}on(e,i,t)}}var ni={readContext:ve,useCallback:Se,useContext:Se,useEffect:Se,useImperativeHandle:Se,useLayoutEffect:Se,useMemo:Se,useReducer:Se,useRef:Se,useState:Se,useDebugValue:Se,useDeferredValue:Se,useTransition:Se,useMutableSource:Se,useOpaqueIdentifier:Se,unstable_isNewReconciler:!1},Mc={readContext:ve,useCallback:function(e,n){return Cn().memoizedState=[e,n===void 0?null:n],e},useContext:ve,useEffect:Nl,useImperativeHandle:function(e,n,a){return a=a!=null?a.concat([e]):null,zr(4,2,Kl.bind(null,n,e),a)},useLayoutEffect:function(e,n){return zr(4,2,e,n)},useMemo:function(e,n){var a=Cn();return n=n===void 0?null:n,e=e(),a.memoizedState=[e,n],e},useReducer:function(e,n,a){var t=Cn();return n=a!==void 0?a(n):n,t.memoizedState=t.baseState=n,e=t.queue={pending:null,dispatch:null,lastRenderedReducer:e,lastRenderedState:n},e=e.dispatch=jr.bind(null,Z,e),[t.memoizedState,e]},useRef:Ol,useState:Za,useDebugValue:_r,useDeferredValue:function(e){var n=Za(e),a=n[0],t=n[1];return Nl(function(){var i=Ee.transition;Ee.transition=1;try{t(e)}finally{Ee.transition=i}},[e]),a},useTransition:function(){var e=Za(!1),n=e[0];return e=wc.bind(null,e[1]),Ol(e),[e,n]},useMutableSource:function(e,n,a){var t=Cn();return t.memoizedState={refs:{getSnapshot:n,setSnapshot:null},source:e,subscribe:a},Wl(t,e,n,a)},useOpaqueIdentifier:function(){if(Ge){var e=!1,n=kc(function(){throw e||(e=!0,a("r:"+(Mr++).toString(36))),Error(T(355))}),a=Za(n)[1];return(Z.mode&2)==0&&(Z.flags|=516,ai(5,function(){a("r:"+(Mr++).toString(36))},void 0,null)),n}return n="r:"+(Mr++).toString(36),Za(n),n},unstable_isNewReconciler:!1},Ec={readContext:ve,useCallback:Ul,useContext:ve,useEffect:ii,useImperativeHandle:Gl,useLayoutEffect:Bl,useMemo:Dl,useReducer:_a,useRef:ti,useState:function(){return _a(Ue)},useDebugValue:_r,useDeferredValue:function(e){var n=_a(Ue),a=n[0],t=n[1];return ii(function(){var i=Ee.transition;Ee.transition=1;try{t(e)}finally{Ee.transition=i}},[e]),a},useTransition:function(){var e=_a(Ue)[0];return[ti().current,e]},useMutableSource:Pl,useOpaqueIdentifier:function(){return _a(Ue)[0]},unstable_isNewReconciler:!1},Cc={readContext:ve,useCallback:Ul,useContext:ve,useEffect:ii,useImperativeHandle:Gl,useLayoutEffect:Bl,useMemo:Dl,useReducer:Va,useRef:ti,useState:function(){return Va(Ue)},useDebugValue:_r,useDeferredValue:function(e){var n=Va(Ue),a=n[0],t=n[1];return ii(function(){var i=Ee.transition;Ee.transition=1;try{t(e)}finally{Ee.transition=i}},[e]),a},useTransition:function(){var e=Va(Ue)[0];return[ti().current,e]},useMutableSource:Pl,useOpaqueIdentifier:function(){return Va(Ue)[0]},unstable_isNewReconciler:!1},Wc=Sn.ReactCurrentOwner,Pe=!1;function ke(e,n,a,t){n.child=e===null?Il(n,null,a,t):qt(n,e.child,a,t)}function Rl(e,n,a,t,i){a=a.render;var r=n.ref;return ea(n,i),t=Qr(e,n,a,t,r,i),e!==null&&!Pe?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,be(e,n,i)):(n.flags|=1,ke(e,n,t,i),n.child)}function Hl(e,n,a,t,i,r){if(e===null){var o=a.type;return typeof o=="function"&&!Vr(o)&&o.defaultProps===void 0&&a.compare===null&&a.defaultProps===void 0?(n.tag=15,n.type=o,Ll(e,n,o,t,i,r)):(e=Zt(a.type,null,t,n,n.mode,r),e.ref=n.ref,e.return=n,n.child=e)}return o=e.child,(i&r)==0&&(i=o.memoizedProps,a=a.compare,a=a!==null?a:Ga,a(i,t)&&e.ref===n.ref)?be(e,n,r):(n.flags|=1,e=sn(o,t),e.ref=n.ref,e.return=n,n.child=e)}function Ll(e,n,a,t,i,r){if(e!==null&&Ga(e.memoizedProps,t)&&e.ref===n.ref)if(Pe=!1,(r&i)!=0)(e.flags&16384)!=0&&(Pe=!0);else return n.lanes=e.lanes,be(e,n,r);return Zr(e,n,a,t,r)}function qr(e,n,a){var t=n.pendingProps,i=t.children,r=e!==null?e.memoizedState:null;if(t.mode==="hidden"||t.mode==="unstable-defer-without-hiding")if((n.mode&4)==0)n.memoizedState={baseLanes:0},ri(n,a);else if((a&1073741824)!=0)n.memoizedState={baseLanes:0},ri(n,r!==null?r.baseLanes:a);else return e=r!==null?r.baseLanes|a:a,n.lanes=n.childLanes=1073741824,n.memoizedState={baseLanes:e},ri(n,e),null;else r!==null?(t=r.baseLanes|a,n.memoizedState=null):t=a,ri(n,t);return ke(e,n,i,a),n.child}function Fl(e,n){var a=n.ref;(e===null&&a!==null||e!==null&&e.ref!==a)&&(n.flags|=128)}function Zr(e,n,a,t,i){var r=me(a)?In:le.current;return r=qn(n,r),ea(n,i),a=Qr(e,n,a,t,r,i),e!==null&&!Pe?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,be(e,n,i)):(n.flags|=1,ke(e,n,a,i),n.child)}function bl(e,n,a,t,i){if(me(a)){var r=!0;Ft(n)}else r=!1;if(ea(n,i),n.stateNode===null)e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),Tl(n,a,t),Ur(n,a,t,i),t=!0;else if(e===null){var o=n.stateNode,s=n.memoizedProps;o.props=s;var l=o.context,d=a.contextType;typeof d=="object"&&d!==null?d=ve(d):(d=me(a)?In:le.current,d=qn(n,d));var k=a.getDerivedStateFromProps,w=typeof k=="function"||typeof o.getSnapshotBeforeUpdate=="function";w||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==t||l!==d)&&yl(n,o,t,d),nn=!1;var m=n.memoizedState;o.state=m,Fa(n,t,o,i),l=n.memoizedState,s!==t||m!==l||fe.current||nn?(typeof k=="function"&&(zt(n,a,k,t),l=n.memoizedState),(s=nn||kl(n,a,s,t,m,l,d))?(w||typeof o.UNSAFE_componentWillMount!="function"&&typeof o.componentWillMount!="function"||(typeof o.componentWillMount=="function"&&o.componentWillMount(),typeof o.UNSAFE_componentWillMount=="function"&&o.UNSAFE_componentWillMount()),typeof o.componentDidMount=="function"&&(n.flags|=4)):(typeof o.componentDidMount=="function"&&(n.flags|=4),n.memoizedProps=t,n.memoizedState=l),o.props=t,o.state=l,o.context=d,t=s):(typeof o.componentDidMount=="function"&&(n.flags|=4),t=!1)}else{o=n.stateNode,pl(e,n),s=n.memoizedProps,d=n.type===n.elementType?s:We(n.type,s),o.props=d,w=n.pendingProps,m=o.context,l=a.contextType,typeof l=="object"&&l!==null?l=ve(l):(l=me(a)?In:le.current,l=qn(n,l));var M=a.getDerivedStateFromProps;(k=typeof M=="function"||typeof o.getSnapshotBeforeUpdate=="function")||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==w||m!==l)&&yl(n,o,t,l),nn=!1,m=n.memoizedState,o.state=m,Fa(n,t,o,i);var P=n.memoizedState;s!==w||m!==P||fe.current||nn?(typeof M=="function"&&(zt(n,a,M,t),P=n.memoizedState),(d=nn||kl(n,a,d,t,m,P,l))?(k||typeof o.UNSAFE_componentWillUpdate!="function"&&typeof o.componentWillUpdate!="function"||(typeof o.componentWillUpdate=="function"&&o.componentWillUpdate(t,P,l),typeof o.UNSAFE_componentWillUpdate=="function"&&o.UNSAFE_componentWillUpdate(t,P,l)),typeof o.componentDidUpdate=="function"&&(n.flags|=4),typeof o.getSnapshotBeforeUpdate=="function"&&(n.flags|=256)):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&m===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&m===e.memoizedState||(n.flags|=256),n.memoizedProps=t,n.memoizedState=P),o.props=t,o.state=P,o.context=l,t=d):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&m===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&m===e.memoizedState||(n.flags|=256),t=!1)}return Xr(e,n,a,t,r,i)}function Xr(e,n,a,t,i,r){Fl(e,n);var o=(n.flags&64)!=0;if(!t&&!o)return i&&il(n,a,!1),be(e,n,r);t=n.stateNode,Wc.current=n;var s=o&&typeof a.getDerivedStateFromError!="function"?null:t.render();return n.flags|=1,e!==null&&o?(n.child=qt(n,e.child,null,r),n.child=qt(n,null,s,r)):ke(e,n,s,r),n.memoizedState=t.state,i&&il(n,a,!0),n.child}function Yl(e){var n=e.stateNode;n.pendingContext?al(e,n.pendingContext,n.pendingContext!==n.context):n.context&&al(e,n.context,!1),Lr(e,n.containerInfo)}var oi={dehydrated:null,retryLane:0};function zl(e,n,a){var t=n.pendingProps,i=_.current,r=!1,o;return(o=(n.flags&64)!=0)||(o=e!==null&&e.memoizedState===null?!1:(i&2)!=0),o?(r=!0,n.flags&=-65):e!==null&&e.memoizedState===null||t.fallback===void 0||t.unstable_avoidThisFallback===!0||(i|=1),J(_,i&1),e===null?(t.fallback!==void 0&&Fr(n),e=t.children,i=t.fallback,r?(e=xl(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=oi,e):typeof t.unstable_expectedLoadTime=="number"?(e=xl(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=oi,n.lanes=33554432,e):(a=$r({mode:"visible",children:e},n.mode,a,null),a.return=n,n.child=a)):e.memoizedState!==null?r?(t=jl(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=oi,t):(a=Ql(e,n,t.children,a),n.memoizedState=null,a):r?(t=jl(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=oi,t):(a=Ql(e,n,t.children,a),n.memoizedState=null,a)}function xl(e,n,a,t){var i=e.mode,r=e.child;return n={mode:"hidden",children:n},(i&2)==0&&r!==null?(r.childLanes=0,r.pendingProps=n):r=$r(n,i,0,null),a=na(a,i,t,null),r.return=e,a.return=e,r.sibling=a,e.child=r,a}function Ql(e,n,a,t){var i=e.child;return e=i.sibling,a=sn(i,{mode:"visible",children:a}),(n.mode&2)==0&&(a.lanes=t),a.return=n,a.sibling=null,e!==null&&(e.nextEffect=null,e.flags=8,n.firstEffect=n.lastEffect=e),n.child=a}function jl(e,n,a,t,i){var r=n.mode,o=e.child;e=o.sibling;var s={mode:"hidden",children:a};return(r&2)==0&&n.child!==o?(a=n.child,a.childLanes=0,a.pendingProps=s,o=a.lastEffect,o!==null?(n.firstEffect=a.firstEffect,n.lastEffect=o,o.nextEffect=null):n.firstEffect=n.lastEffect=null):a=sn(o,s),e!==null?t=sn(e,t):(t=na(t,r,i,null),t.flags|=2),t.return=n,a.return=n,a.sibling=t,n.child=a,t}function Jl(e,n){e.lanes|=n;var a=e.alternate;a!==null&&(a.lanes|=n),hl(e.return,n)}function eo(e,n,a,t,i,r){var o=e.memoizedState;o===null?e.memoizedState={isBackwards:n,rendering:null,renderingStartTime:0,last:t,tail:a,tailMode:i,lastEffect:r}:(o.isBackwards=n,o.rendering=null,o.renderingStartTime=0,o.last=t,o.tail=a,o.tailMode=i,o.lastEffect=r)}function _l(e,n,a){var t=n.pendingProps,i=t.revealOrder,r=t.tail;if(ke(e,n,t.children,a),t=_.current,(t&2)!=0)t=t&1|2,n.flags|=64;else{if(e!==null&&(e.flags&64)!=0)e:for(e=n.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&Jl(e,a);else if(e.tag===19)Jl(e,a);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===n)break e;for(;e.sibling===null;){if(e.return===null||e.return===n)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}t&=1}if(J(_,t),(n.mode&2)==0)n.memoizedState=null;else switch(i){case"forwards":for(a=n.child,i=null;a!==null;)e=a.alternate,e!==null&&Xt(e)===null&&(i=a),a=a.sibling;a=i,a===null?(i=n.child,n.child=null):(i=a.sibling,a.sibling=null),eo(n,!1,i,a,r,n.lastEffect);break;case"backwards":for(a=null,i=n.child,n.child=null;i!==null;){if(e=i.alternate,e!==null&&Xt(e)===null){n.child=i;break}e=i.sibling,i.sibling=a,a=i,i=e}eo(n,!0,a,null,r,n.lastEffect);break;case"together":eo(n,!1,null,null,void 0,n.lastEffect);break;default:n.memoizedState=null}return n.child}function be(e,n,a){if(e!==null&&(n.dependencies=e.dependencies),Ha|=n.lanes,(a&n.childLanes)!=0){if(e!==null&&n.child!==e.child)throw Error(T(153));if(n.child!==null){for(e=n.child,a=sn(e,e.pendingProps),n.child=a,a.return=n;e.sibling!==null;)e=e.sibling,a=a.sibling=sn(e,e.pendingProps),a.return=n;a.sibling=null}return n.child}return null}var Vl,no,Zl,ql;Vl=function(e,n){for(var a=n.child;a!==null;){if(a.tag===5||a.tag===6)e.appendChild(a.stateNode);else if(a.tag!==4&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return}a.sibling.return=a.return,a=a.sibling}};no=function(){};Zl=function(e,n,a,t){var i=e.memoizedProps;if(i!==t){e=n.stateNode,En(Ke.current);var r=null;switch(a){case"input":i=Di(e,i),t=Di(e,t),r=[];break;case"option":i=Hi(e,i),t=Hi(e,t),r=[];break;case"select":i=H({},i,{value:void 0}),t=H({},t,{value:void 0}),r=[];break;case"textarea":i=Fi(e,i),t=Fi(e,t),r=[];break;default:typeof i.onClick!="function"&&typeof t.onClick=="function"&&(e.onclick=Dt)}xi(a,t);var o;a=null;for(d in i)if(!t.hasOwnProperty(d)&&i.hasOwnProperty(d)&&i[d]!=null)if(d==="style"){var s=i[d];for(o in s)s.hasOwnProperty(o)&&(a||(a={}),a[o]="")}else d!=="dangerouslySetInnerHTML"&&d!=="children"&&d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&d!=="autoFocus"&&(ga.hasOwnProperty(d)?r||(r=[]):(r=r||[]).push(d,null));for(d in t){var l=t[d];if(s=i!=null?i[d]:void 0,t.hasOwnProperty(d)&&l!==s&&(l!=null||s!=null))if(d==="style")if(s){for(o in s)!s.hasOwnProperty(o)||l&&l.hasOwnProperty(o)||(a||(a={}),a[o]="");for(o in l)l.hasOwnProperty(o)&&s[o]!==l[o]&&(a||(a={}),a[o]=l[o])}else a||(r||(r=[]),r.push(d,a)),a=l;else d==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,s=s?s.__html:void 0,l!=null&&s!==l&&(r=r||[]).push(d,l)):d==="children"?typeof l!="string"&&typeof l!="number"||(r=r||[]).push(d,""+l):d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&(ga.hasOwnProperty(d)?(l!=null&&d==="onScroll"&&x("scroll",e),r||s===l||(r=[])):typeof l=="object"&&l!==null&&l.$$typeof===Ni?l.toString():(r=r||[]).push(d,l))}a&&(r=r||[]).push("style",a);var d=r;(n.updateQueue=d)&&(n.flags|=4)}};ql=function(e,n,a,t){a!==t&&(n.flags|=4)};function qa(e,n){if(!Ge)switch(e.tailMode){case"hidden":n=e.tail;for(var a=null;n!==null;)n.alternate!==null&&(a=n),n=n.sibling;a===null?e.tail=null:a.sibling=null;break;case"collapsed":a=e.tail;for(var t=null;a!==null;)a.alternate!==null&&(t=a),a=a.sibling;t===null?n||e.tail===null?e.tail=null:e.tail.sibling=null:t.sibling=null}}function Pc(e,n,a){var t=n.pendingProps;switch(n.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return null;case 1:return me(n.type)&&Ht(),null;case 3:return aa(),Q(fe),Q(le),Yr(),t=n.stateNode,t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(e===null||e.child===null)&&($t(n)?n.flags|=4:t.hydrate||(n.flags|=256)),no(n),null;case 5:Hr(n);var i=En(Qa.current);if(a=n.type,e!==null&&n.stateNode!=null)Zl(e,n,a,t,i),e.ref!==n.ref&&(n.flags|=128);else{if(!t){if(n.stateNode===null)throw Error(T(166));return null}if(e=En(Ke.current),$t(n)){t=n.stateNode,a=n.type;var r=n.memoizedProps;switch(t[Xe]=n,t[Lt]=r,a){case"dialog":x("cancel",t),x("close",t);break;case"iframe":case"object":case"embed":x("load",t);break;case"video":case"audio":for(e=0;e<Da.length;e++)x(Da[e],t);break;case"source":x("error",t);break;case"img":case"image":case"link":x("error",t),x("load",t);break;case"details":x("toggle",t);break;case"input":Yo(t,r),x("invalid",t);break;case"select":t._wrapperState={wasMultiple:!!r.multiple},x("invalid",t);break;case"textarea":jo(t,r),x("invalid",t)}xi(a,r),e=null;for(var o in r)r.hasOwnProperty(o)&&(i=r[o],o==="children"?typeof i=="string"?t.textContent!==i&&(e=["children",i]):typeof i=="number"&&t.textContent!==""+i&&(e=["children",""+i]):ga.hasOwnProperty(o)&&i!=null&&o==="onScroll"&&x("scroll",t));switch(a){case"input":mt(t),Qo(t,r,!0);break;case"textarea":mt(t),Jo(t);break;case"select":case"option":break;default:typeof r.onClick=="function"&&(t.onclick=Dt)}t=e,n.updateQueue=t,t!==null&&(n.flags|=4)}else{switch(o=i.nodeType===9?i:i.ownerDocument,e===bi.html&&(e=_o(a)),e===bi.html?a==="script"?(e=o.createElement("div"),e.innerHTML="<script></script>",e=e.removeChild(e.firstChild)):typeof t.is=="string"?e=o.createElement(a,{is:t.is}):(e=o.createElement(a),a==="select"&&(o=e,t.multiple?o.multiple=!0:t.size&&(o.size=t.size))):e=o.createElementNS(e,a),e[Xe]=n,e[Lt]=t,Vl(e,n,!1,!1),n.stateNode=e,o=Qi(a,t),a){case"dialog":x("cancel",e),x("close",e),i=t;break;case"iframe":case"object":case"embed":x("load",e),i=t;break;case"video":case"audio":for(i=0;i<Da.length;i++)x(Da[i],e);i=t;break;case"source":x("error",e),i=t;break;case"img":case"image":case"link":x("error",e),x("load",e),i=t;break;case"details":x("toggle",e),i=t;break;case"input":Yo(e,t),i=Di(e,t),x("invalid",e);break;case"option":i=Hi(e,t);break;case"select":e._wrapperState={wasMultiple:!!t.multiple},i=H({},t,{value:void 0}),x("invalid",e);break;case"textarea":jo(e,t),i=Fi(e,t),x("invalid",e);break;default:i=t}xi(a,i);var s=i;for(r in s)if(s.hasOwnProperty(r)){var l=s[r];r==="style"?qo(e,l):r==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,l!=null&&Vo(e,l)):r==="children"?typeof l=="string"?(a!=="textarea"||l!=="")&&ka(e,l):typeof l=="number"&&ka(e,""+l):r!=="suppressContentEditableWarning"&&r!=="suppressHydrationWarning"&&r!=="autoFocus"&&(ga.hasOwnProperty(r)?l!=null&&r==="onScroll"&&x("scroll",e):l!=null&&Ei(e,r,l,o))}switch(a){case"input":mt(e),Qo(e,t,!1);break;case"textarea":mt(e),Jo(e);break;case"option":t.value!=null&&e.setAttribute("value",""+ze(t.value));break;case"select":e.multiple=!!t.multiple,r=t.value,r!=null?Dn(e,!!t.multiple,r,!1):t.defaultValue!=null&&Dn(e,!!t.multiple,t.defaultValue,!0);break;default:typeof i.onClick=="function"&&(e.onclick=Dt)}Xs(a,t)&&(n.flags|=4)}n.ref!==null&&(n.flags|=128)}return null;case 6:if(e&&n.stateNode!=null)ql(e,n,e.memoizedProps,t);else{if(typeof t!="string"&&n.stateNode===null)throw Error(T(166));a=En(Qa.current),En(Ke.current),$t(n)?(t=n.stateNode,a=n.memoizedProps,t[Xe]=n,t.nodeValue!==a&&(n.flags|=4)):(t=(a.nodeType===9?a:a.ownerDocument).createTextNode(t),t[Xe]=n,n.stateNode=t)}return null;case 13:return Q(_),t=n.memoizedState,(n.flags&64)!=0?(n.lanes=a,n):(t=t!==null,a=!1,e===null?n.memoizedProps.fallback!==void 0&&$t(n):a=e.memoizedState!==null,t&&!a&&(n.mode&2)!=0&&(e===null&&n.memoizedProps.unstable_avoidThisFallback!==!0||(_.current&1)!=0?se===0&&(se=3):((se===0||se===3)&&(se=4),he===null||(Ha&134217727)==0&&(ia&134217727)==0||ra(he,ce))),(t||a)&&(n.flags|=4),null);case 4:return aa(),no(n),e===null&&Zs(n.stateNode.containerInfo),null;case 10:return Kr(n),null;case 17:return me(n.type)&&Ht(),null;case 19:if(Q(_),t=n.memoizedState,t===null)return null;if(r=(n.flags&64)!=0,o=t.rendering,o===null)if(r)qa(t,!1);else{if(se!==0||e!==null&&(e.flags&64)!=0)for(e=n.child;e!==null;){if(o=Xt(e),o!==null){for(n.flags|=64,qa(t,!1),r=o.updateQueue,r!==null&&(n.updateQueue=r,n.flags|=4),t.lastEffect===null&&(n.firstEffect=null),n.lastEffect=t.lastEffect,t=a,a=n.child;a!==null;)r=a,e=t,r.flags&=2,r.nextEffect=null,r.firstEffect=null,r.lastEffect=null,o=r.alternate,o===null?(r.childLanes=0,r.lanes=e,r.child=null,r.memoizedProps=null,r.memoizedState=null,r.updateQueue=null,r.dependencies=null,r.stateNode=null):(r.childLanes=o.childLanes,r.lanes=o.lanes,r.child=o.child,r.memoizedProps=o.memoizedProps,r.memoizedState=o.memoizedState,r.updateQueue=o.updateQueue,r.type=o.type,e=o.dependencies,r.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),a=a.sibling;return J(_,_.current&1|2),n.child}e=e.sibling}t.tail!==null&&ue()>ao&&(n.flags|=64,r=!0,qa(t,!1),n.lanes=33554432)}else{if(!r)if(e=Xt(o),e!==null){if(n.flags|=64,r=!0,a=e.updateQueue,a!==null&&(n.updateQueue=a,n.flags|=4),qa(t,!0),t.tail===null&&t.tailMode==="hidden"&&!o.alternate&&!Ge)return n=n.lastEffect=t.lastEffect,n!==null&&(n.nextEffect=null),null}else 2*ue()-t.renderingStartTime>ao&&a!==1073741824&&(n.flags|=64,r=!0,qa(t,!1),n.lanes=33554432);t.isBackwards?(o.sibling=n.child,n.child=o):(a=t.last,a!==null?a.sibling=o:n.child=o,t.last=o)}return t.tail!==null?(a=t.tail,t.rendering=a,t.tail=a.sibling,t.lastEffect=n.lastEffect,t.renderingStartTime=ue(),a.sibling=null,n=_.current,J(_,r?n&1|2:n&1),a):null;case 23:case 24:return to(),e!==null&&e.memoizedState!==null!=(n.memoizedState!==null)&&t.mode!=="unstable-defer-without-hiding"&&(n.flags|=4),null}throw Error(T(156,n.tag))}function Oc(e){switch(e.tag){case 1:me(e.type)&&Ht();var n=e.flags;return n&4096?(e.flags=n&-4097|64,e):null;case 3:if(aa(),Q(fe),Q(le),Yr(),n=e.flags,(n&64)!=0)throw Error(T(285));return e.flags=n&-4097|64,e;case 5:return Hr(e),null;case 13:return Q(_),n=e.flags,n&4096?(e.flags=n&-4097|64,e):null;case 19:return Q(_),null;case 4:return aa(),null;case 10:return Kr(e),null;case 23:case 24:return to(),null;default:return null}}function io(e,n){try{var a="",t=n;do a+=dd(t),t=t.return;while(t);var i=a}catch(r){i=`
Error generating stack: `+r.message+`
`+r.stack}return{value:e,source:n,stack:i}}function ro(e,n){try{console.error(n.value)}catch(a){setTimeout(function(){throw a})}}var Nc=typeof WeakMap=="function"?WeakMap:Map;function Xl(e,n,a){a=an(-1,a),a.tag=3,a.payload={element:null};var t=n.value;return a.callback=function(){si||(si=!0,oo=t),ro(e,n)},a}function $l(e,n,a){a=an(-1,a),a.tag=3;var t=e.type.getDerivedStateFromError;if(typeof t=="function"){var i=n.value;a.payload=function(){return ro(e,n),t(i)}}var r=e.stateNode;return r!==null&&typeof r.componentDidCatch=="function"&&(a.callback=function(){typeof t!="function"&&(De===null?De=new Set([this]):De.add(this),ro(e,n));var o=n.stack;this.componentDidCatch(n.value,{componentStack:o!==null?o:""})}),a}var Bc=typeof WeakSet=="function"?WeakSet:Set;function eu(e){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(a){un(e,a)}else n.current=null}function Kc(e,n){switch(n.tag){case 0:case 11:case 15:case 22:return;case 1:if(n.flags&256&&e!==null){var a=e.memoizedProps,t=e.memoizedState;e=n.stateNode,n=e.getSnapshotBeforeUpdate(n.elementType===n.type?a:We(n.type,a),t),e.__reactInternalSnapshotBeforeUpdate=n}return;case 3:n.flags&256&&vr(n.stateNode.containerInfo);return;case 5:case 6:case 4:case 17:return}throw Error(T(163))}function Uc(e,n,a){switch(a.tag){case 0:case 11:case 15:case 22:if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{if((e.tag&3)==3){var t=e.create;e.destroy=t()}e=e.next}while(e!==n)}if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{var i=e;t=i.next,i=i.tag,(i&4)!=0&&(i&1)!=0&&(nu(a,e),Gc(a,e)),e=t}while(e!==n)}return;case 1:e=a.stateNode,a.flags&4&&(n===null?e.componentDidMount():(t=a.elementType===a.type?n.memoizedProps:We(a.type,n.memoizedProps),e.componentDidUpdate(t,n.memoizedState,e.__reactInternalSnapshotBeforeUpdate))),n=a.updateQueue,n!==null&&ml(a,n,e);return;case 3:if(n=a.updateQueue,n!==null){if(e=null,a.child!==null)switch(a.child.tag){case 5:e=a.child.stateNode;break;case 1:e=a.child.stateNode}ml(a,n,e)}return;case 5:e=a.stateNode,n===null&&a.flags&4&&Xs(a.type,a.memoizedProps)&&e.focus();return;case 6:return;case 4:return;case 12:return;case 13:a.memoizedState===null&&(a=a.alternate,a!==null&&(a=a.memoizedState,a!==null&&(a=a.dehydrated,a!==null&&hs(a))));return;case 19:case 17:case 20:case 21:case 23:case 24:return}throw Error(T(163))}function au(e,n){for(var a=e;;){if(a.tag===5){var t=a.stateNode;if(n)t=t.style,typeof t.setProperty=="function"?t.setProperty("display","none","important"):t.display="none";else{t=a.stateNode;var i=a.memoizedProps.style;i=i!=null&&i.hasOwnProperty("display")?i.display:null,t.style.display=Zo("display",i)}}else if(a.tag===6)a.stateNode.nodeValue=n?"":a.memoizedProps;else if((a.tag!==23&&a.tag!==24||a.memoizedState===null||a===e)&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===e)break;for(;a.sibling===null;){if(a.return===null||a.return===e)return;a=a.return}a.sibling.return=a.return,a=a.sibling}}function iu(e,n){if(vn&&typeof vn.onCommitFiberUnmount=="function")try{vn.onCommitFiberUnmount(Cr,n)}catch(r){}switch(n.tag){case 0:case 11:case 14:case 15:case 22:if(e=n.updateQueue,e!==null&&(e=e.lastEffect,e!==null)){var a=e=e.next;do{var t=a,i=t.destroy;if(t=t.tag,i!==void 0)if((t&4)!=0)nu(n,a);else{t=n;try{i()}catch(r){un(t,r)}}a=a.next}while(a!==e)}break;case 1:if(eu(n),e=n.stateNode,typeof e.componentWillUnmount=="function")try{e.props=n.memoizedProps,e.state=n.memoizedState,e.componentWillUnmount()}catch(r){un(n,r)}break;case 5:eu(n);break;case 4:tu(e,n)}}function ru(e){e.alternate=null,e.child=null,e.dependencies=null,e.firstEffect=null,e.lastEffect=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.return=null,e.updateQueue=null}function ou(e){return e.tag===5||e.tag===3||e.tag===4}function su(e){e:{for(var n=e.return;n!==null;){if(ou(n))break e;n=n.return}throw Error(T(160))}var a=n;switch(n=a.stateNode,a.tag){case 5:var t=!1;break;case 3:n=n.containerInfo,t=!0;break;case 4:n=n.containerInfo,t=!0;break;default:throw Error(T(161))}a.flags&16&&(ka(n,""),a.flags&=-17);e:n:for(a=e;;){for(;a.sibling===null;){if(a.return===null||ou(a.return)){a=null;break e}a=a.return}for(a.sibling.return=a.return,a=a.sibling;a.tag!==5&&a.tag!==6&&a.tag!==18;){if(a.flags&2||a.child===null||a.tag===4)continue n;a.child.return=a,a=a.child}if(!(a.flags&2)){a=a.stateNode;break e}}t?so(e,a,n):lo(e,a,n)}function so(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.nodeType===8?a.parentNode.insertBefore(e,n):a.insertBefore(e,n):(a.nodeType===8?(n=a.parentNode,n.insertBefore(e,a)):(n=a,n.appendChild(e)),a=a._reactRootContainer,a!=null||n.onclick!==null||(n.onclick=Dt));else if(t!==4&&(e=e.child,e!==null))for(so(e,n,a),e=e.sibling;e!==null;)so(e,n,a),e=e.sibling}function lo(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.insertBefore(e,n):a.appendChild(e);else if(t!==4&&(e=e.child,e!==null))for(lo(e,n,a),e=e.sibling;e!==null;)lo(e,n,a),e=e.sibling}function tu(e,n){for(var a=n,t=!1,i,r;;){if(!t){t=a.return;e:for(;;){if(t===null)throw Error(T(160));switch(i=t.stateNode,t.tag){case 5:r=!1;break e;case 3:i=i.containerInfo,r=!0;break e;case 4:i=i.containerInfo,r=!0;break e}t=t.return}t=!0}if(a.tag===5||a.tag===6){e:for(var o=e,s=a,l=s;;)if(iu(o,l),l.child!==null&&l.tag!==4)l.child.return=l,l=l.child;else{if(l===s)break e;for(;l.sibling===null;){if(l.return===null||l.return===s)break e;l=l.return}l.sibling.return=l.return,l=l.sibling}r?(o=i,s=a.stateNode,o.nodeType===8?o.parentNode.removeChild(s):o.removeChild(s)):i.removeChild(a.stateNode)}else if(a.tag===4){if(a.child!==null){i=a.stateNode.containerInfo,r=!0,a.child.return=a,a=a.child;continue}}else if(iu(e,a),a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return,a.tag===4&&(t=!1)}a.sibling.return=a.return,a=a.sibling}}function co(e,n){switch(n.tag){case 0:case 11:case 14:case 15:case 22:var a=n.updateQueue;if(a=a!==null?a.lastEffect:null,a!==null){var t=a=a.next;do(t.tag&3)==3&&(e=t.destroy,t.destroy=void 0,e!==void 0&&e()),t=t.next;while(t!==a)}return;case 1:return;case 5:if(a=n.stateNode,a!=null){t=n.memoizedProps;var i=e!==null?e.memoizedProps:t;e=n.type;var r=n.updateQueue;if(n.updateQueue=null,r!==null){for(a[Lt]=t,e==="input"&&t.type==="radio"&&t.name!=null&&xo(a,t),Qi(e,i),n=Qi(e,t),i=0;i<r.length;i+=2){var o=r[i],s=r[i+1];o==="style"?qo(a,s):o==="dangerouslySetInnerHTML"?Vo(a,s):o==="children"?ka(a,s):Ei(a,o,s,n)}switch(e){case"input":Li(a,t);break;case"textarea":zo(a,t);break;case"select":e=a._wrapperState.wasMultiple,a._wrapperState.wasMultiple=!!t.multiple,r=t.value,r!=null?Dn(a,!!t.multiple,r,!1):e!==!!t.multiple&&(t.defaultValue!=null?Dn(a,!!t.multiple,t.defaultValue,!0):Dn(a,!!t.multiple,t.multiple?[]:"",!1))}}}return;case 6:if(n.stateNode===null)throw Error(T(162));n.stateNode.nodeValue=n.memoizedProps;return;case 3:a=n.stateNode,a.hydrate&&(a.hydrate=!1,hs(a.containerInfo));return;case 12:return;case 13:n.memoizedState!==null&&(uo=ue(),au(n.child,!0)),lu(n);return;case 19:lu(n);return;case 17:return;case 23:case 24:au(n,n.memoizedState!==null);return}throw Error(T(163))}function lu(e){var n=e.updateQueue;if(n!==null){e.updateQueue=null;var a=e.stateNode;a===null&&(a=e.stateNode=new Bc),n.forEach(function(t){var i=Dc.bind(null,e,t);a.has(t)||(a.add(t),t.then(i,i))})}}function Rc(e,n){return e!==null&&(e=e.memoizedState,e===null||e.dehydrated!==null)?(n=n.memoizedState,n!==null&&n.dehydrated===null):!1}var Lc=Math.ceil,li=Sn.ReactCurrentDispatcher,go=Sn.ReactCurrentOwner,K=0,he=null,ee=null,ce=0,Wn=0,ho=$e(0),se=0,ui=null,oa=0,Ha=0,ia=0,po=0,fo=null,uo=0,ao=Infinity;function sa(){ao=ue()+500}var v=null,si=!1,oo=null,De=null,dn=!1,Xa=null,$a=90,mo=[],So=[],Ye=null,et=0,ko=null,di=-1,xe=0,ci=0,nt=null,gi=!1;function Ae(){return(K&48)!=0?ue():di!==-1?di:di=ue()}function rn(e){if(e=e.mode,(e&2)==0)return 1;if((e&4)==0)return Xn()===99?1:2;if(xe===0&&(xe=oa),vc.transition!==0){ci!==0&&(ci=fo!==null?fo.pendingLanes:0),e=xe;var n=4186112&~ci;return n&=-n,n===0&&(e=4186112&~e,n=e&-e,n===0&&(n=8192)),n}return e=Xn(),(K&4)!=0&&e===98?e=Et(12,xe):(e=Cd(e),e=Et(e,xe)),e}function on(e,n,a){if(50<et)throw et=0,ko=null,Error(T(185));if(e=hi(e,n),e===null)return null;Ct(e,n,a),e===he&&(ia|=n,se===4&&ra(e,ce));var t=Xn();n===1?(K&8)!=0&&(K&48)==0?To(e):(Ce(e,a),K===0&&(sa(),Be())):((K&4)==0||t!==98&&t!==99||(Ye===null?Ye=new Set([e]):Ye.add(e)),Ce(e,a)),fo=e}function hi(e,n){e.lanes|=n;var a=e.alternate;for(a!==null&&(a.lanes|=n),a=e,e=e.return;e!==null;)e.childLanes|=n,a=e.alternate,a!==null&&(a.childLanes|=n),a=e,e=e.return;return a.tag===3?a.stateNode:null}function Ce(e,n){for(var a=e.callbackNode,t=e.suspendedLanes,i=e.pingedLanes,r=e.expirationTimes,o=e.pendingLanes;0<o;){var s=31-Ze(o),l=1<<s,d=r[s];if(d===-1){if((l&t)==0||(l&i)!=0){d=n,bn(l);var k=b;r[s]=10<=k?d+250:6<=k?d+5e3:-1}}else d<=n&&(e.expiredLanes|=l);o&=~l}if(t=Wa(e,e===he?ce:0),n=b,t===0)a!==null&&(a!==Or&&Wr(a),e.callbackNode=null,e.callbackPriority=0);else{if(a!==null){if(e.callbackPriority===n)return;a!==Or&&Wr(a)}n===15?(a=To.bind(null,e),He===null?(He=[a],Yt=wr(bt,gl)):He.push(a),a=Or):n===14?a=La(99,To.bind(null,e)):(a=wd(n),a=La(a,uu.bind(null,e))),e.callbackPriority=n,e.callbackNode=a}}function uu(e){if(di=-1,ci=xe=0,(K&48)!=0)throw Error(T(327));var n=e.callbackNode;if(cn()&&e.callbackNode!==n)return null;var a=Wa(e,e===he?ce:0);if(a===0)return null;var t=a,i=K;K|=16;var r=cu();(he!==e||ce!==t)&&(sa(),la(e,t));do try{Hc();break}catch(s){du(e,s)}while(1);if(Br(),li.current=r,K=i,ee!==null?t=0:(he=null,ce=0,t=se),(oa&ia)!=0)la(e,0);else if(t!==0){if(t===2&&(K|=64,e.hydrate&&(e.hydrate=!1,vr(e.containerInfo)),a=ys(e),a!==0&&(t=at(e,a))),t===1)throw n=ui,la(e,0),ra(e,a),Ce(e,ue()),n;switch(e.finishedWork=e.current.alternate,e.finishedLanes=a,t){case 0:case 1:throw Error(T(345));case 2:Pn(e);break;case 3:if(ra(e,a),(a&62914560)===a&&(t=uo+500-ue(),10<t)){if(Wa(e,0)!==0)break;if(i=e.suspendedLanes,(i&a)!==a){Ae(),e.pingedLanes|=e.suspendedLanes&i;break}e.timeoutHandle=$s(Pn.bind(null,e),t);break}Pn(e);break;case 4:if(ra(e,a),(a&4186112)===a)break;for(t=e.eventTimes,i=-1;0<a;){var o=31-Ze(a);r=1<<o,o=t[o],o>i&&(i=o),a&=~r}if(a=i,a=ue()-a,a=(120>a?120:480>a?480:1080>a?1080:1920>a?1920:3e3>a?3e3:4320>a?4320:1960*Lc(a/1960))-a,10<a){e.timeoutHandle=$s(Pn.bind(null,e),a);break}Pn(e);break;case 5:Pn(e);break;default:throw Error(T(329))}}return Ce(e,ue()),e.callbackNode===n?uu.bind(null,e):null}function ra(e,n){for(n&=~po,n&=~ia,e.suspendedLanes|=n,e.pingedLanes&=~n,e=e.expirationTimes;0<n;){var a=31-Ze(n),t=1<<a;e[a]=-1,n&=~t}}function To(e){if((K&48)!=0)throw Error(T(327));if(cn(),e===he&&(e.expiredLanes&ce)!=0){var n=ce,a=at(e,n);(oa&ia)!=0&&(n=Wa(e,n),a=at(e,n))}else n=Wa(e,0),a=at(e,n);if(e.tag!==0&&a===2&&(K|=64,e.hydrate&&(e.hydrate=!1,vr(e.containerInfo)),n=ys(e),n!==0&&(a=at(e,n))),a===1)throw a=ui,la(e,0),ra(e,n),Ce(e,ue()),a;return e.finishedWork=e.current.alternate,e.finishedLanes=n,Pn(e),Ce(e,ue()),null}function Fc(){if(Ye!==null){var e=Ye;Ye=null,e.forEach(function(n){n.expiredLanes|=24&n.pendingLanes,Ce(n,ue())})}Be()}function gu(e,n){var a=K;K|=1;try{return e(n)}finally{K=a,K===0&&(sa(),Be())}}function hu(e,n){var a=K;K&=-2,K|=8;try{return e(n)}finally{K=a,K===0&&(sa(),Be())}}function ri(e,n){J(ho,Wn),Wn|=n,oa|=n}function to(){Wn=ho.current,Q(ho)}function la(e,n){e.finishedWork=null,e.finishedLanes=0;var a=e.timeoutHandle;if(a!==-1&&(e.timeoutHandle=-1,Sc(a)),ee!==null)for(a=ee.return;a!==null;){var t=a;switch(t.tag){case 1:t=t.type.childContextTypes,t!=null&&Ht();break;case 3:aa(),Q(fe),Q(le),Yr();break;case 5:Hr(t);break;case 4:aa();break;case 13:Q(_);break;case 19:Q(_);break;case 10:Kr(t);break;case 23:case 24:to()}a=a.return}he=e,ee=sn(e.current,null),ce=Wn=oa=n,se=0,ui=null,po=ia=Ha=0}function du(e,n){do{var a=ee;try{if(Br(),ja.current=ni,ei){for(var t=Z.memoizedState;t!==null;){var i=t.queue;i!==null&&(i.pending=null),t=t.next}ei=!1}if(za=0,oe=de=Z=null,Ja=!1,go.current=null,a===null||a.return===null){se=1,ui=n,ee=null;break}e:{var r=e,o=a.return,s=a,l=n;if(n=ce,s.flags|=2048,s.firstEffect=s.lastEffect=null,l!==null&&typeof l=="object"&&typeof l.then=="function"){var d=l;if((s.mode&2)==0){var k=s.alternate;k?(s.updateQueue=k.updateQueue,s.memoizedState=k.memoizedState,s.lanes=k.lanes):(s.updateQueue=null,s.memoizedState=null)}var w=(_.current&1)!=0,m=o;do{var M;if(M=m.tag===13){var P=m.memoizedState;if(P!==null)M=P.dehydrated!==null;else{var E=m.memoizedProps;M=E.fallback===void 0?!1:E.unstable_avoidThisFallback!==!0?!0:!w}}if(M){var g=m.updateQueue;if(g===null){var u=new Set;u.add(d),m.updateQueue=u}else g.add(d);if((m.mode&2)==0){if(m.flags|=64,s.flags|=16384,s.flags&=-2981,s.tag===1)if(s.alternate===null)s.tag=17;else{var c=an(-1,1);c.tag=2,tn(s,c)}s.lanes|=1;break e}l=void 0,s=n;var p=r.pingCache;if(p===null?(p=r.pingCache=new Nc,l=new Set,p.set(d,l)):(l=p.get(d),l===void 0&&(l=new Set,p.set(d,l))),!l.has(s)){l.add(s);var f=bc.bind(null,r,d,s);d.then(f,f)}m.flags|=4096,m.lanes=n;break e}m=m.return}while(m!==null);l=Error((Un(s.type)||"A React component")+` suspended while rendering, but no fallback UI was specified.

Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.`)}se!==5&&(se=2),l=io(l,s),m=o;do{switch(m.tag){case 3:r=l,m.flags|=4096,n&=-n,m.lanes|=n;var O=Xl(m,r,n);fl(m,O);break e;case 1:r=l;var A=m.type,C=m.stateNode;if((m.flags&64)==0&&(typeof A.getDerivedStateFromError=="function"||C!==null&&typeof C.componentDidCatch=="function"&&(De===null||!De.has(C)))){m.flags|=4096,n&=-n,m.lanes|=n;var B=$l(m,r,n);fl(m,B);break e}}m=m.return}while(m!==null)}pu(a)}catch(N){n=N,ee===a&&a!==null&&(ee=a=a.return);continue}break}while(1)}function cu(){var e=li.current;return li.current=ni,e===null?ni:e}function at(e,n){var a=K;K|=16;var t=cu();he===e&&ce===n||la(e,n);do try{Yc();break}catch(i){du(e,i)}while(1);if(Br(),K=a,li.current=t,ee!==null)throw Error(T(261));return he=null,ce=0,se}function Yc(){for(;ee!==null;)fu(ee)}function Hc(){for(;ee!==null&&!yc();)fu(ee)}function fu(e){var n=mu(e.alternate,e,Wn);e.memoizedProps=e.pendingProps,n===null?pu(e):ee=n,go.current=null}function pu(e){var n=e;do{var a=n.alternate;if(e=n.return,(n.flags&2048)==0){if(a=Pc(a,n,Wn),a!==null){ee=a;return}if(a=n,a.tag!==24&&a.tag!==23||a.memoizedState===null||(Wn&1073741824)!=0||(a.mode&4)==0){for(var t=0,i=a.child;i!==null;)t|=i.lanes|i.childLanes,i=i.sibling;a.childLanes=t}e!==null&&(e.flags&2048)==0&&(e.firstEffect===null&&(e.firstEffect=n.firstEffect),n.lastEffect!==null&&(e.lastEffect!==null&&(e.lastEffect.nextEffect=n.firstEffect),e.lastEffect=n.lastEffect),1<n.flags&&(e.lastEffect!==null?e.lastEffect.nextEffect=n:e.firstEffect=n,e.lastEffect=n))}else{if(a=Oc(n),a!==null){a.flags&=2047,ee=a;return}e!==null&&(e.firstEffect=e.lastEffect=null,e.flags|=2048)}if(n=n.sibling,n!==null){ee=n;return}ee=n=e}while(n!==null);se===0&&(se=5)}function Pn(e){var n=Xn();return Mn(99,xc.bind(null,e,n)),null}function xc(e,n){do cn();while(Xa!==null);if((K&48)!=0)throw Error(T(327));var a=e.finishedWork;if(a===null)return null;if(e.finishedWork=null,e.finishedLanes=0,a===e.current)throw Error(T(177));e.callbackNode=null;var t=a.lanes|a.childLanes,i=t,r=e.pendingLanes&~i;e.pendingLanes=i,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=i,e.mutableReadLanes&=i,e.entangledLanes&=i,i=e.entanglements;for(var o=e.eventTimes,s=e.expirationTimes;0<r;){var l=31-Ze(r),d=1<<l;i[l]=0,o[l]=-1,s[l]=-1,r&=~d}if(Ye!==null&&(t&24)==0&&Ye.has(e)&&Ye.delete(e),e===he&&(ee=he=null,ce=0),1<a.flags?a.lastEffect!==null?(a.lastEffect.nextEffect=a,t=a.firstEffect):t=a:t=a.firstEffect,t!==null){if(i=K,K|=32,go.current=null,yr=wt,o=bs(),mr(o)){if("selectionStart"in o)s={start:o.selectionStart,end:o.selectionEnd};else e:if(s=(s=o.ownerDocument)&&s.defaultView||window,(d=s.getSelection&&s.getSelection())&&d.rangeCount!==0){s=d.anchorNode,r=d.anchorOffset,l=d.focusNode,d=d.focusOffset;try{s.nodeType,l.nodeType}catch(N){s=null;break e}var k=0,w=-1,m=-1,M=0,P=0,E=o,g=null;n:for(;;){for(var u;E!==s||r!==0&&E.nodeType!==3||(w=k+r),E!==l||d!==0&&E.nodeType!==3||(m=k+d),E.nodeType===3&&(k+=E.nodeValue.length),(u=E.firstChild)!==null;)g=E,E=u;for(;;){if(E===o)break n;if(g===s&&++M===r&&(w=k),g===l&&++P===d&&(m=k),(u=E.nextSibling)!==null)break;E=g,g=E.parentNode}E=u}s=w===-1||m===-1?null:{start:w,end:m}}else s=null;s=s||{start:0,end:0}}else s=null;Ar={focusedElem:o,selectionRange:s},wt=!1,nt=null,gi=!1,v=t;do try{Qc()}catch(N){if(v===null)throw Error(T(330));un(v,N),v=v.nextEffect}while(v!==null);nt=null,v=t;do try{for(o=e;v!==null;){var c=v.flags;if(c&16&&ka(v.stateNode,""),c&128){var p=v.alternate;if(p!==null){var f=p.ref;f!==null&&(typeof f=="function"?f(null):f.current=null)}}switch(c&1038){case 2:su(v),v.flags&=-3;break;case 6:su(v),v.flags&=-3,co(v.alternate,v);break;case 1024:v.flags&=-1025;break;case 1028:v.flags&=-1025,co(v.alternate,v);break;case 4:co(v.alternate,v);break;case 8:s=v,tu(o,s);var O=s.alternate;ru(s),O!==null&&ru(O)}v=v.nextEffect}}catch(N){if(v===null)throw Error(T(330));un(v,N),v=v.nextEffect}while(v!==null);if(f=Ar,p=bs(),c=f.focusedElem,o=f.selectionRange,p!==c&&c&&c.ownerDocument&&Fs(c.ownerDocument.documentElement,c)){for(o!==null&&mr(c)&&(p=o.start,f=o.end,f===void 0&&(f=p),"selectionStart"in c?(c.selectionStart=p,c.selectionEnd=Math.min(f,c.value.length)):(f=(p=c.ownerDocument||document)&&p.defaultView||window,f.getSelection&&(f=f.getSelection(),s=c.textContent.length,O=Math.min(o.start,s),o=o.end===void 0?O:Math.min(o.end,s),!f.extend&&O>o&&(s=o,o=O,O=s),s=Hs(c,O),r=Hs(c,o),s&&r&&(f.rangeCount!==1||f.anchorNode!==s.node||f.anchorOffset!==s.offset||f.focusNode!==r.node||f.focusOffset!==r.offset)&&(p=p.createRange(),p.setStart(s.node,s.offset),f.removeAllRanges(),O>o?(f.addRange(p),f.extend(r.node,r.offset)):(p.setEnd(r.node,r.offset),f.addRange(p)))))),p=[],f=c;f=f.parentNode;)f.nodeType===1&&p.push({element:f,left:f.scrollLeft,top:f.scrollTop});for(typeof c.focus=="function"&&c.focus(),c=0;c<p.length;c++)f=p[c],f.element.scrollLeft=f.left,f.element.scrollTop=f.top}wt=!!yr,Ar=yr=null,e.current=a,v=t;do try{for(c=e;v!==null;){var A=v.flags;if(A&36&&Uc(c,v.alternate,v),A&128){p=void 0;var C=v.ref;if(C!==null){var B=v.stateNode;switch(v.tag){case 5:p=B;break;default:p=B}typeof C=="function"?C(p):C.current=p}}v=v.nextEffect}}catch(N){if(v===null)throw Error(T(330));un(v,N),v=v.nextEffect}while(v!==null);v=null,Ic(),K=i}else e.current=a;if(dn)dn=!1,Xa=e,$a=n;else for(v=t;v!==null;)n=v.nextEffect,v.nextEffect=null,v.flags&8&&(A=v,A.sibling=null,A.stateNode=null),v=n;if(t=e.pendingLanes,t===0&&(De=null),t===1?e===ko?et++:(et=0,ko=e):et=0,a=a.stateNode,vn&&typeof vn.onCommitFiberRoot=="function")try{vn.onCommitFiberRoot(Cr,a,void 0,(a.current.flags&64)==64)}catch(N){}if(Ce(e,ue()),si)throw si=!1,e=oo,oo=null,e;return(K&8)!=0||Be(),null}function Qc(){for(;v!==null;){var e=v.alternate;gi||nt===null||((v.flags&8)!=0?os(v,nt)&&(gi=!0):v.tag===13&&Rc(e,v)&&os(v,nt)&&(gi=!0));var n=v.flags;(n&256)!=0&&Kc(e,v),(n&512)==0||dn||(dn=!0,La(97,function(){return cn(),null})),v=v.nextEffect}}function cn(){if($a!==90){var e=97<$a?97:$a;return $a=90,Mn(e,jc)}return!1}function Gc(e,n){mo.push(n,e),dn||(dn=!0,La(97,function(){return cn(),null}))}function nu(e,n){So.push(n,e),dn||(dn=!0,La(97,function(){return cn(),null}))}function jc(){if(Xa===null)return!1;var e=Xa;if(Xa=null,(K&48)!=0)throw Error(T(331));var n=K;K|=32;var a=So;So=[];for(var t=0;t<a.length;t+=2){var i=a[t],r=a[t+1],o=i.destroy;if(i.destroy=void 0,typeof o=="function")try{o()}catch(l){if(r===null)throw Error(T(330));un(r,l)}}for(a=mo,mo=[],t=0;t<a.length;t+=2){i=a[t],r=a[t+1];try{var s=i.create;i.destroy=s()}catch(l){if(r===null)throw Error(T(330));un(r,l)}}for(s=e.current.firstEffect;s!==null;)e=s.nextEffect,s.nextEffect=null,s.flags&8&&(s.sibling=null,s.stateNode=null),s=e;return K=n,Be(),!0}function Su(e,n,a){n=io(a,n),n=Xl(e,n,1),tn(e,n),n=Ae(),e=hi(e,1),e!==null&&(Ct(e,1,n),Ce(e,n))}function un(e,n){if(e.tag===3)Su(e,e,n);else for(var a=e.return;a!==null;){if(a.tag===3){Su(a,e,n);break}else if(a.tag===1){var t=a.stateNode;if(typeof a.type.getDerivedStateFromError=="function"||typeof t.componentDidCatch=="function"&&(De===null||!De.has(t))){e=io(n,e);var i=$l(a,e,1);if(tn(a,i),i=Ae(),a=hi(a,1),a!==null)Ct(a,1,i),Ce(a,i);else if(typeof t.componentDidCatch=="function"&&(De===null||!De.has(t)))try{t.componentDidCatch(n,e)}catch(r){}break}}a=a.return}}function bc(e,n,a){var t=e.pingCache;t!==null&&t.delete(n),n=Ae(),e.pingedLanes|=e.suspendedLanes&a,he===e&&(ce&a)===a&&(se===4||se===3&&(ce&62914560)===ce&&500>ue()-uo?la(e,0):po|=a),Ce(e,n)}function Dc(e,n){var a=e.stateNode;a!==null&&a.delete(n),n=0,n===0&&(n=e.mode,(n&2)==0?n=1:(n&4)==0?n=Xn()===99?1:2:(xe===0&&(xe=oa),n=Yn(62914560&~xe),n===0&&(n=4194304))),a=Ae(),e=hi(e,n),e!==null&&(Ct(e,n,a),Ce(e,a))}var mu;mu=function(e,n,a){var t=n.lanes;if(e!==null)if(e.memoizedProps!==n.pendingProps||fe.current)Pe=!0;else if((a&t)!=0)Pe=(e.flags&16384)!=0;else{switch(Pe=!1,n.tag){case 3:Yl(n),br();break;case 5:vl(n);break;case 1:me(n.type)&&Ft(n);break;case 4:Lr(n,n.stateNode.containerInfo);break;case 10:t=n.memoizedProps.value;var i=n.type._context;J(xt,i._currentValue),i._currentValue=t;break;case 13:if(n.memoizedState!==null)return(a&n.child.childLanes)!=0?zl(e,n,a):(J(_,_.current&1),n=be(e,n,a),n!==null?n.sibling:null);J(_,_.current&1);break;case 19:if(t=(a&n.childLanes)!=0,(e.flags&64)!=0){if(t)return _l(e,n,a);n.flags|=64}if(i=n.memoizedState,i!==null&&(i.rendering=null,i.tail=null,i.lastEffect=null),J(_,_.current),t)break;return null;case 23:case 24:return n.lanes=0,qr(e,n,a)}return be(e,n,a)}else Pe=!1;switch(n.lanes=0,n.tag){case 2:if(t=n.type,e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,i=qn(n,le.current),ea(n,a),i=Qr(null,n,t,e,i,a),n.flags|=1,typeof i=="object"&&i!==null&&typeof i.render=="function"&&i.$$typeof===void 0){if(n.tag=1,n.memoizedState=null,n.updateQueue=null,me(t)){var r=!0;Ft(n)}else r=!1;n.memoizedState=i.state!==null&&i.state!==void 0?i.state:null,Gr(n);var o=t.getDerivedStateFromProps;typeof o=="function"&&zt(n,t,o,e),i.updater=Jt,n.stateNode=i,i._reactInternals=n,Ur(n,t,e,a),n=Xr(null,n,t,!0,r,a)}else n.tag=0,ke(null,n,i,a),n=n.child;return n;case 16:i=n.elementType;e:{switch(e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,r=i._init,i=r(i._payload),n.type=i,r=n.tag=zc(i),e=We(i,e),r){case 0:n=Zr(null,n,i,e,a);break e;case 1:n=bl(null,n,i,e,a);break e;case 11:n=Rl(null,n,i,e,a);break e;case 14:n=Hl(null,n,i,We(i.type,e),t,a);break e}throw Error(T(306,i,""))}return n;case 0:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:We(t,i),Zr(e,n,t,i,a);case 1:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:We(t,i),bl(e,n,t,i,a);case 3:if(Yl(n),t=n.updateQueue,e===null||t===null)throw Error(T(282));if(t=n.pendingProps,i=n.memoizedState,i=i!==null?i.element:null,pl(e,n),Fa(n,t,null,a),t=n.memoizedState.element,t===i)br(),n=be(e,n,a);else{if(i=n.stateNode,(r=i.hydrate)&&(ln=Vn(n.stateNode.containerInfo.firstChild),Fe=n,r=Ge=!0),r){if(e=i.mutableSourceEagerHydrationData,e!=null)for(i=0;i<e.length;i+=2)r=e[i],r._workInProgressVersionPrimary=e[i+1],ta.push(r);for(a=Il(n,null,t,a),n.child=a;a;)a.flags=a.flags&-3|1024,a=a.sibling}else ke(e,n,t,a),br();n=n.child}return n;case 5:return vl(n),e===null&&Fr(n),t=n.type,i=n.pendingProps,r=e!==null?e.memoizedProps:null,o=i.children,Ir(t,i)?o=null:r!==null&&Ir(t,r)&&(n.flags|=16),Fl(e,n),ke(e,n,o,a),n.child;case 6:return e===null&&Fr(n),null;case 13:return zl(e,n,a);case 4:return Lr(n,n.stateNode.containerInfo),t=n.pendingProps,e===null?n.child=qt(n,null,t,a):ke(e,n,t,a),n.child;case 11:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:We(t,i),Rl(e,n,t,i,a);case 7:return ke(e,n,n.pendingProps,a),n.child;case 8:return ke(e,n,n.pendingProps.children,a),n.child;case 12:return ke(e,n,n.pendingProps.children,a),n.child;case 10:e:{t=n.type._context,i=n.pendingProps,o=n.memoizedProps,r=i.value;var s=n.type._context;if(J(xt,s._currentValue),s._currentValue=r,o!==null)if(s=o.value,r=Ie(s,r)?0:(typeof t._calculateChangedBits=="function"?t._calculateChangedBits(s,r):1073741823)|0,r===0){if(o.children===i.children&&!fe.current){n=be(e,n,a);break e}}else for(s=n.child,s!==null&&(s.return=n);s!==null;){var l=s.dependencies;if(l!==null){o=s.child;for(var d=l.firstContext;d!==null;){if(d.context===t&&(d.observedBits&r)!=0){s.tag===1&&(d=an(-1,a&-a),d.tag=2,tn(s,d)),s.lanes|=a,d=s.alternate,d!==null&&(d.lanes|=a),hl(s.return,a),l.lanes|=a;break}d=d.next}}else o=s.tag===10&&s.type===n.type?null:s.child;if(o!==null)o.return=s;else for(o=s;o!==null;){if(o===n){o=null;break}if(s=o.sibling,s!==null){s.return=o.return,o=s;break}o=o.return}s=o}ke(e,n,i.children,a),n=n.child}return n;case 9:return i=n.type,r=n.pendingProps,t=r.children,ea(n,a),i=ve(i,r.unstable_observedBits),t=t(i),n.flags|=1,ke(e,n,t,a),n.child;case 14:return i=n.type,r=We(i,n.pendingProps),r=We(i.type,r),Hl(e,n,i,r,t,a);case 15:return Ll(e,n,n.type,n.pendingProps,t,a);case 17:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:We(t,i),e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),n.tag=1,me(t)?(e=!0,Ft(n)):e=!1,ea(n,a),Tl(n,t,i),Ur(n,t,i,a),Xr(null,n,t,!0,e,a);case 19:return _l(e,n,a);case 23:return qr(e,n,a);case 24:return qr(e,n,a)}throw Error(T(156,n.tag))};function Jc(e,n,a,t){this.tag=e,this.key=a,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=n,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=t,this.flags=0,this.lastEffect=this.firstEffect=this.nextEffect=null,this.childLanes=this.lanes=0,this.alternate=null}function Me(e,n,a,t){return new Jc(e,n,a,t)}function Vr(e){return e=e.prototype,!(!e||!e.isReactComponent)}function zc(e){if(typeof e=="function")return Vr(e)?1:0;if(e!=null){if(e=e.$$typeof,e===gt)return 11;if(e===pt)return 14}return 2}function sn(e,n){var a=e.alternate;return a===null?(a=Me(e.tag,n,e.key,e.mode),a.elementType=e.elementType,a.type=e.type,a.stateNode=e.stateNode,a.alternate=e,e.alternate=a):(a.pendingProps=n,a.type=e.type,a.flags=0,a.nextEffect=null,a.firstEffect=null,a.lastEffect=null),a.childLanes=e.childLanes,a.lanes=e.lanes,a.child=e.child,a.memoizedProps=e.memoizedProps,a.memoizedState=e.memoizedState,a.updateQueue=e.updateQueue,n=e.dependencies,a.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext},a.sibling=e.sibling,a.index=e.index,a.ref=e.ref,a}function Zt(e,n,a,t,i,r){var o=2;if(t=e,typeof e=="function")Vr(e)&&(o=1);else if(typeof e=="string")o=5;else e:switch(e){case je:return na(a.children,i,r,n);case Lo:o=8,i|=16;break;case Ci:o=8,i|=1;break;case pa:return e=Me(12,a,n,i|8),e.elementType=pa,e.type=pa,e.lanes=r,e;case fa:return e=Me(13,a,n,i),e.type=fa,e.elementType=fa,e.lanes=r,e;case ht:return e=Me(19,a,n,i),e.elementType=ht,e.lanes=r,e;case Bi:return $r(a,i,r,n);case Ki:return e=Me(24,a,n,i),e.elementType=Ki,e.lanes=r,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case wi:o=10;break e;case Wi:o=9;break e;case gt:o=11;break e;case pt:o=14;break e;case Pi:o=16,t=null;break e;case Oi:o=22;break e}throw Error(T(130,e==null?e:typeof e,""))}return n=Me(o,a,n,i),n.elementType=e,n.type=t,n.lanes=r,n}function na(e,n,a,t){return e=Me(7,e,t,n),e.lanes=a,e}function $r(e,n,a,t){return e=Me(23,e,t,n),e.elementType=Bi,e.lanes=a,e}function Dr(e,n,a){return e=Me(6,e,null,n),e.lanes=a,e}function Rr(e,n,a){return n=Me(4,e.children!==null?e.children:[],e.key,n),n.lanes=a,n.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},n}function _c(e,n,a){this.tag=n,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.pendingContext=this.context=null,this.hydrate=a,this.callbackNode=null,this.callbackPriority=0,this.eventTimes=or(0),this.expirationTimes=or(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=or(0),this.mutableSourceEagerHydrationData=null}function Vc(e,n,a){var t=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:kn,key:t==null?null:""+t,children:e,containerInfo:n,implementation:a}}function pi(e,n,a,t){var i=n.current,r=Ae(),o=rn(i);e:if(a){a=a._reactInternals;n:{if(yn(a)!==a||a.tag!==1)throw Error(T(170));var s=a;do{switch(s.tag){case 3:s=s.stateNode.context;break n;case 1:if(me(s.type)){s=s.stateNode.__reactInternalMemoizedMergedChildContext;break n}}s=s.return}while(s!==null);throw Error(T(171))}if(a.tag===1){var l=a.type;if(me(l)){a=tl(a,l,s);break e}}a=s}else a=en;return n.context===null?n.context=a:n.pendingContext=a,n=an(r,o),n.payload={element:e},t=t===void 0?null:t,t!==null&&(n.callback=t),tn(i,n),on(i,o,r),o}function yo(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function ku(e,n){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var a=e.retryLane;e.retryLane=a!==0&&a<n?a:n}}function Ao(e,n){ku(e,n),(e=e.alternate)&&ku(e,n)}function Zc(){return null}function Io(e,n,a){var t=a!=null&&a.hydrationOptions!=null&&a.hydrationOptions.mutableSources||null;if(a=new _c(e,n,a!=null&&a.hydrate===!0),n=Me(3,null,null,n===2?7:n===1?3:0),a.current=n,n.stateNode=a,Gr(n),e[_n]=a.current,Zs(e.nodeType===8?e.parentNode:e),t)for(e=0;e<t.length;e++){n=t[e];var i=n._getVersion;i=i(n._source),a.mutableSourceEagerHydrationData==null?a.mutableSourceEagerHydrationData=[n,i]:a.mutableSourceEagerHydrationData.push(n,i)}this._internalRoot=a}Io.prototype.render=function(e){pi(e,this._internalRoot,null,null)};Io.prototype.unmount=function(){var e=this._internalRoot,n=e.containerInfo;pi(null,e,null,function(){n[_n]=null})};function tt(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function qc(e,n){if(n||(n=e?e.nodeType===9?e.documentElement:e.firstChild:null,n=!(!n||n.nodeType!==1||!n.hasAttribute("data-reactroot"))),!n)for(var a;a=e.lastChild;)e.removeChild(a);return new Io(e,0,n?{hydrate:!0}:void 0)}function fi(e,n,a,t,i){var r=a._reactRootContainer;if(r){var o=r._internalRoot;if(typeof i=="function"){var s=i;i=function(){var d=yo(o);s.call(d)}}pi(n,o,e,i)}else{if(r=a._reactRootContainer=qc(a,t),o=r._internalRoot,typeof i=="function"){var l=i;i=function(){var d=yo(o);l.call(d)}}hu(function(){pi(n,o,e,i)})}return yo(o)}ss=function(e){if(e.tag===13){var n=Ae();on(e,4,n),Ao(e,4)}};$i=function(e){if(e.tag===13){var n=Ae();on(e,67108864,n),Ao(e,67108864)}};ls=function(e){if(e.tag===13){var n=Ae(),a=rn(e);on(e,a,n),Ao(e,a)}};us=function(e,n){return n()};zi=function(e,n,a){switch(n){case"input":if(Li(e,a),n=a.name,a.type==="radio"&&n!=null){for(a=e;a.parentNode;)a=a.parentNode;for(a=a.querySelectorAll("input[name="+JSON.stringify(""+n)+'][type="radio"]'),n=0;n<a.length;n++){var t=a[n];if(t!==e&&t.form===e.form){var i=Tt(t);if(!i)throw Error(T(90));bo(t),Li(t,i)}}}break;case"textarea":zo(e,a);break;case"select":n=a.value,n!=null&&Dn(e,!!a.multiple,n,!1)}};Ji=gu;ns=function(e,n,a,t,i){var r=K;K|=4;try{return Mn(98,e.bind(null,n,a,t,i))}finally{K=r,K===0&&(sa(),Be())}};_i=function(){(K&49)==0&&(Fc(),cn())};as=function(e,n){var a=K;K|=2;try{return e(n)}finally{K=a,K===0&&(sa(),Be())}};function Tu(e,n){var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!tt(n))throw Error(T(200));return Vc(e,n,null,a)}var Xc={Events:[ya,jn,Tt,$o,es,cn,{current:!1}]},it={findFiberByHostInstance:An,bundleType:0,version:"17.0.2",rendererPackageName:"react-dom"},$c={bundleType:it.bundleType,version:it.version,rendererPackageName:it.rendererPackageName,rendererConfig:it.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:Sn.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=rs(e),e===null?null:e.stateNode},findFiberByHostInstance:it.findFiberByHostInstance||Zc,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__!="undefined"&&(rt=__REACT_DEVTOOLS_GLOBAL_HOOK__,!rt.isDisabled&&rt.supportsFiber))try{Cr=rt.inject($c),vn=rt}catch(e){}var rt,eg=Xc,ng=Tu,ag=function(e){if(e==null)return null;if(e.nodeType===1)return e;var n=e._reactInternals;if(n===void 0)throw typeof e.render=="function"?Error(T(188)):Error(T(268,Object.keys(e)));return e=rs(n),e=e===null?null:e.stateNode,e},tg=function(e,n){var a=K;if((a&48)!=0)return e(n);K|=1;try{if(e)return Mn(99,e.bind(null,n))}finally{K=a,Be()}},ig=function(e,n,a){if(!tt(n))throw Error(T(200));return fi(null,e,n,!0,a)},rg=function(e,n,a){if(!tt(n))throw Error(T(200));return fi(null,e,n,!1,a)},og=function(e){if(!tt(e))throw Error(T(40));return e._reactRootContainer?(hu(function(){fi(null,null,e,!1,function(){e._reactRootContainer=null,e[_n]=null})}),!0):!1},sg=gu,lg=function(e,n){return Tu(e,n,2<arguments.length&&arguments[2]!==void 0?arguments[2]:null)},ug=function(e,n,a,t){if(!tt(a))throw Error(T(200));if(e==null||e._reactInternals===void 0)throw Error(T(38));return fi(e,n,a,!1,t)},dg="17.0.2",cg={__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:eg,createPortal:ng,findDOMNode:ag,flushSync:tg,hydrate:ig,render:rg,unmountComponentAtNode:og,unstable_batchedUpdates:sg,unstable_createPortal:lg,unstable_renderSubtreeIntoContainer:ug,version:dg},gg=Qe(function(e){function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__=="undefined"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(a){console.error(a)}}n(),e.exports=cg}),vo=gg.render;function yu(){return{getPlayerState(){return ae.UNSTARTED},getCurrentTime(){return 0},getVideoUrl(){return""},cueVideoById(){},playVideo(){},seekTo(){},addEventListener(){},removeEventListener(){}}}var ae={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};function Au(e){return dt(this,null,function*(){let n=yield hg();return new Promise(a=>{let t=new n.Player(e,{height:450,width:800,videoId:null,playerVars:{controls:0,disablekb:1},events:{onReady(){a(t)}}})})})}function hg(){return Iu?Promise.resolve(window.YT):new Promise(e=>{var n;if(document.querySelector("script[src='https://www.youtube.com/iframe_api']")===null){let a=document.createElement("script");a.src="https://www.youtube.com/iframe_api";let t=document.getElementsByTagName("script")[0];(n=t.parentNode)==null||n.insertBefore(a,t)}Mo.push(e)})}var Iu=!1,Mo=[];window.onYouTubeIframeAPIReady=()=>{Iu=!0,Mo.forEach(e=>e(window.YT)),Mo.length=0};function vu(e,n){let a=ca(),t=ca();t.current=e,Kn(()=>(a.current=setInterval(()=>{var i;return(i=t.current)==null?void 0:i.call(t)},n),()=>clearInterval(a.current)),[n])}function Mu(){let[e,n]=Oe(!1);return[e,()=>n(!0)]}function pg(e){switch(e){case ae.BUFFERING:return"buffering";case ae.UNSTARTED:return"unstarted";case ae.CUED:return"cued";case ae.ENDED:return"ended";case ae.PLAYING:return"playing";case ae.PAUSED:return"paused";default:return""}}function Eu(e){return e.channel.getName()+" "+pg(e.code)}function ot(e){try{e()}catch(n){return n}}var Eo=Symbol(),Co=Symbol(),wo=Symbol(),mi=Symbol();function On(e,n){function a(...t){if(t.length>=e.length)return e(...t);{let i=(...r)=>a(...t,...r);return i[Eo]=e,i[Co]=a,i[wo]=t,i[mi]=a[mi],i}}return a[Eo]=e,a[Co]=a,a[wo]=[],a[mi]=n||Cu(e),a}function Wo(e){return e[Eo]}function fg(e){return e[Co]}function Si(e){return e[wo]||[]}function Cu(e){return e[mi]||e.name}function Sg(){let e=[];return{test:n,getAllTests:a};function n(t,i){e.push(...Object.entries(i).map(([r,o])=>mg(t,r,o)))}function a(){return e}}function U(e,n,...a){let t=n(...a,e);if(typeof t=="function")throw new Error("The matcher function `"+Po(t)+"` returned a function instead of a boolean. You might need to pass another argument to it.");if(!t)throw new ki([e,n,...a])}function mg(e,n,a){return{subject:e,scenario:n,fn:a}}var ki=class extends Error{constructor(n){super("Expectation failed");this.expectArgs=n}};function kg(e){return e[e.length-1]}function wu(e){return e[0]}var Tg=On(function(e,n){return e(n)},"which"),V=On(function(e,n){var a,t;if(yg(e))return e(n);if(Array.isArray(e)&&Array.isArray(n))return e.length===n.length&&e.every((i,r)=>V(e[r],n[r]));if(e instanceof Function&&n instanceof Function)return Wo(e)&&Wo(e)===Wo(n)?V(Si(e),Si(n)):e===n;if(e instanceof Date&&n instanceof Date)return e.toISOString()===n.toISOString();if(e instanceof Set&&n instanceof Set)return e.size===n.size&&[...e.values()].every(i=>n.has(i));if(e instanceof Error&&n instanceof Error)return e.message===n.message&&e.__proto__.constructor===n.__proto__.constructor;if(Wu(e)&&Wu(n)){let i=Object.keys(e),r=Object.keys(n);return i.length===r.length&&i.every(o=>V(e[o],n[o]))&&((a=e.__proto__)==null?void 0:a.constructor)===((t=n.__proto__)==null?void 0:t.constructor)}return e===n},"equals"),Y=On(function(e,n){return e===n},"is"),Oo=On(function(e,n,...a){return!e(n,...a)},"not"),Pu=On(function(e){return/^\s*$/.test(e)},"isBlank");function Wu(e){return!!e&&typeof e=="object"}function yg(e){return e instanceof Function&&fg(e)===Tg&&Si(e).length===1}function Po(e){return Cu(e)||"<function>"}function Nu(e){let n=[];return a(e);function a(l){var d;if(l===null)return"null";if(typeof l=="function")return t(l,i);if(typeof l=="string")return No(l);if(typeof l=="bigint")return`${l}n`;if(Array.isArray(l))return t(l,r);if(l instanceof Date)return`Date(${l.toISOString().replace("T"," ").replace("Z"," UTC")})`;if(l instanceof RegExp)return String(l);if(l instanceof Error)return`${Ou(l)}(${No(l.message)})`;if(l instanceof Set)return t(l,s);if(typeof l=="object"){let k=(d=l==null?void 0:l.__proto__)==null?void 0:d.constructor;return k===Object||!k?t(l,o):`${Ou(l)} ${t(l,o)}`}return String(l)}function t(l,d){if(n.indexOf(l)>-1)return"<circular reference>";n.push(l);let k=d(l);return n.pop(),k}function i(l){let d=Si(l).map(a),k=Po(l);return d.length?st(k+"(",d,",",")"):k}function r(l){return st("[",l.map(a),",","]")}function o(l){let d=Object.entries(l).map(([k,w])=>`${Ag(k)}: ${a(w)}`);return st("{",d,",","}")}function s(l){let d=[...l.values()].map(a);return st("Set {",d,",","}")}}function Ag(e){return/^[a-zA-Z0-9_$]+$/.test(e)?e:No(e)}function Ou(e){return Po(e.__proto__.constructor)}function No(e){return'"'+String(e).replace(/\\/g,"\\\\").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/"/g,'\\"').replace(/[\x00-\x1f\x7f]/g,Ig)+'"'}function Ig(e){let n=e.charCodeAt(0).toString(16);return"\\x"+(n.length<2?"0"+n:n)}function Ti(e,n){return n.split(`
`).map(a=>a&&Mg(vg(e," "))(a)).join(`
`)}function vg(e,n){return Array(e+1).join(n)}var Mg=e=>n=>e+n,Eg=On(function(n,a){return a.slice(0,n.length)===n?a.slice(n.length):a});function Cg(e){return String(e).split(/\r?\n/)}function wg(e){let n=Cg(e);Pu(wu(n))&&n.shift(),Pu(kg(n))&&n.pop();let a=/^[ \t]*/.exec(wu(n))[0];return n.map(Eg(a)).join(`
`)}function st(e,n,a,t){return n.length<2?e+n.join("")+t:e+`
`+Ti(2,n.join(a+`
`))+`
`+t}function Ku(e){return dt(this,null,function*(){let n=[];for(let a of e){let t=yield Wg(a.fn),i=Bu.map(r=>({type:"debug",args:r}));Bu.length=0,n.push({test:a,error:t,instrumentLog:i})}return{results:n}})}function Wg(e){let n;try{let a=e();if(a instanceof Promise)return new Promise(t=>{a.then(()=>t()).catch(t)})}catch(a){n=a}return Promise.resolve(n)}var Bu=[],e1=On(function(n,a){return a instanceof ki&&V(n,a.expectArgs)}),yi=`

`;function Gu({results:e}){let n=!1,a=!1,t=[];for(let i of e){let r=!1;i.error&&(r=n=!0),i.instrumentLog.length&&(r=a=!0),r&&t.push(i)}return n?Pg(t):a?Ng(e.length,t):Og(e.length)}function Pg(e){return e.map(Uu).join(yi)+yi+"Tests failed."}function Og(e){switch(e){case 0:return"No tests to run.";case 1:return"One test ran, and found no issues.";default:return`${e} tests ran, and found no issues.`}}function Ng(e,n){return n.map(Uu).join(yi)+yi+Bg(e)+`, but debugging instrumentation is present.
Remove it before shipping.`}function Bg(e){switch(e){case 1:return"The test passed";case 2:return"Both tests passed";default:return`All ${e} tests passed`}}function Uu({test:e,error:n,instrumentLog:a}){let i=[e.subject+" "+e.scenario];return a.length&&i.push(Ti(2,Gg(a))),n&&i.push(Ti(2,Kg(n))),i.join(`
`)}function Kg(e){return e instanceof ki?Ug(e):Dg(e)}function Gg(e){return e.map(({args:n})=>Du("debug",n)).join("")}function Ug(e){return Du("expect",e.expectArgs)}function Dg(e){return Nu(e)+" thrown"+Ti(2,Rg(e.stack))}function Du(e,n){return st(e+"(",n.map(Nu),",",")")}function Rg(e){if(!e)return"";let n=wg(e).split(`
`);return`
`+n.slice(0,Lg(n)).map(a=>a.replace(/(file:\/\/|http:\/\/[^/]*)/,"").replace(/^([^@]*)@(.*)$/,"at $1 ($2)")).join(`
`)}function Lg(e){let n=e.findIndex(a=>a.includes("errorFrom"));return n===-1?e.length:n}var n1=Object.freeze({test:{subject:"a thing",scenario:"does something",fn(){}},error:void 0,instrumentLog:[]}),Hg=Sg(),{getAllTests:Ru}=Hg;function Re(...e){}function gn(e,n){if(e.length===0)throw new Error("can't pick element from an empty array");if(n>=1||n<0)throw new Error("fraction out of bounds: "+n);return e[Math.floor(n*e.length)]}Re("pick",{"throws if the array is empty"(){U(ot(()=>gn([],0)),V,new Error("can't pick element from an empty array"))},"throws if the fraction is 1"(){U(ot(()=>gn([""],1)),V,new Error("fraction out of bounds: 1"))},"throws if the fraction is > 1"(){U(ot(()=>gn([""],1.25)),V,new Error("fraction out of bounds: 1.25"))},"throws if the fraction is > 0"(){U(ot(()=>gn([""],-.25)),V,new Error("fraction out of bounds: -0.25"))},"picks the first element of the array given 0"(){U(gn([1,2],0),Y,1)},"picks the last element of the array given 1 - epsilon"(){U(gn([1,2],.99),Y,2)}});function ua(e,n){let a={};return t=>(t in a||(Object.keys(a).length===e&&(a={}),a[t]=n(t)),a[t])}Re("cache",{"caches a value"(){let e=0,n=ua(1,()=>(e++,123));n("foo"),n("foo"),U(e,Y,1)},"computes and caches values by key"(){let e=ua(2,n=>n+"x");U(e("foo"),Y,"foox"),U(e("bar"),Y,"barx")},"caches multiple values"(){let e=0,n=ua(2,a=>(e++,a+"x"));n("foo"),n("foo"),n("bar"),n("bar"),U(e,Y,2),U(n("foo"),Y,"foox"),U(n("bar"),Y,"barx")},"a max size of 0 means no limit"(){let e=0,n=ua(0,()=>(e++,123));n("a"),n("b"),n("c"),U(e,Y,3)}});function Lu(e){let n=1779033703,a=3144134277,t=1013904242,i=2773480762;for(let r=0,o;r<e.length;r++)o=e.charCodeAt(r),n=a^Math.imul(n^o,597399067),a=t^Math.imul(a^o,2869860233),t=i^Math.imul(t^o,951274213),i=n^Math.imul(i^o,2716044179);return n=Math.imul(t^n>>>18,597399067),a=Math.imul(i^a>>>22,2869860233),t=Math.imul(n^t>>>17,951274213),i=Math.imul(a^i>>>19,2716044179),(n^a^t^i)>>>0}function Hu(e){return function(){var n=e+=1831565813;return n=Math.imul(n^n>>>15,n|1),n^=n+Math.imul(n^n>>>7,n|61),((n^n>>>14)>>>0)/4294967296}}var lt=2;function Ai(e,n){let a=ua(1,i=>{let r=Hu(Lu(i)),o=0,s=[];for(;o<24*3600;){let l=gn(n,r());for(let d=0;d<l.videos.length;d++){let k=s[s.length-1],w=l.videos[d];(k==null?void 0:k.type)==="nothing"&&(k.nextVideoId=w.videoId),s.push({type:"video",videoId:w.videoId,durationSeconds:w.durationSeconds}),o+=w.durationSeconds,s.push({type:"nothing",durationSeconds:lt,nextVideoId:""}),o+=lt}}return s});return{getBroadcast:t,getName(){return e}};function t(i){let r=Math.floor(i/1e3),o=(r-8*3600)%(24*3600),s=r-o,l=a(String(s)),d=0,k;for(k of l)if(d+=k.durationSeconds,d>=o)return k.type==="video"?{type:"video",videoId:k.videoId,currentTime:k.durationSeconds-(d-o)}:{type:"nothing",nextVideoId:k.nextVideoId};return{type:"nothing",nextVideoId:""}}}function Te(e){return e.split(/\n+/).map(bg).filter(Oo(Fg)).filter(Oo(Yg)).map(ut(/ +/,3)).flatMap(([n,a,t])=>a==="SHORTS"?[]:[{videoId:n,durationSeconds:we(a),title:t}])}Re("parseVideos",{"empty string"(){U(Te(""),V,[])},spaces(){U(Te("  "),V,[])},newlines(){U(Te(`


`),V,[])},"newlines and spaces"(){U(Te(` 
 
 
`),V,[])},comments(){U(Te(`#foo
# bar`),V,[])},"strips spaces before comments"(){U(Te(`  #foo
  # bar`),V,[])},"parses actual data"(){U(Te(`
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
      Ga8tNxnHjt4 3:01 Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971
    `),V,[{videoId:"leb645Xu6uo",durationSeconds:654,title:"Captain Murderer - Emlyn Williams"},{videoId:"Ga8tNxnHjt4",durationSeconds:181,title:"Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971"}])},"removes shorts"(){U(Te(`
      undefined SHORTS blah blah
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
    `),V,[{videoId:"leb645Xu6uo",durationSeconds:654,title:"Captain Murderer - Emlyn Williams"}])}});function Fg(e){return e.startsWith("#")}function we(e){let n=[1,60,3600,86400],a=e.split(":").map(t=>parseInt(t,10)).reverse();return xg(a,n).map(([t,i])=>t*i).reduce(Qg,0)}Re("parseDuration",{"0:00"(){U(we("0:00"),Y,0)},"00:00"(){U(we("00:00"),Y,0)},"1 second"(){U(we("0:01"),Y,1)},"10 seconds"(){U(we("0:10"),Y,10)},"1 minute"(){U(we("1:00"),Y,60)},"1 minute 10 seconds"(){U(we("1:10"),Y,70)},"10 minutes 10 seconds"(){U(we("10:10"),Y,610)},"1 hour"(){U(we("1:00:00"),Y,3600)},"1 hour 1 second"(){U(we("1:00:01"),Y,3601)},"10 hours 1 second"(){U(we("10:00:01"),Y,36001)},"1 day 1 second"(){U(we("1:0:00:01"),Y,86401)}});function bg(e){return e.trim()}function Yg(e){return e.length===0}var ut=(e,n=Infinity)=>a=>{if(typeof e=="string"&&e.length===0)throw"split(): empty delimiter not supported";let t=0,i=0,r=[],o=a;for(;r.length<n-1&&o.length>0;){let s=o.match(e);if(s==null)break;r.push(o.slice(0,s.index)),o=o.slice(s.index+s[0].length)}return r.push(o),r};Re("split",{"empty string"(){U(ut(" ")(""),V,[""])},"no limit"(){U(ut(" ")("a b c"),V,["a","b","c"])},limit(){U(ut(" ",2)("a b c"),V,["a","b c"])},regex(){U(ut(/ +/)("a b   c"),V,["a","b","c"])}});function xg(e,n){let a=[];for(let t=0;t<e.length&&t<n.length;t++)a.push([e[t],n[t]]);return a}function Qg(e,n){return e+n}var Bo=(...e)=>e.reduce(jg),Fu=zg(Bo(Te,e=>({videos:e})))(["BecZdQvjGrY 54:49 In Gowan Ring - Compendium (Full Album)","B3oAx9VmAdA 43:52 In Gowan Ring - Hazel Steps Through A Weathered Home",`
  ...
  `,"bnaTLcFpQnE 45:45 Manu Chao - Clandestino (Full Album)"]);Re("pipe",{"given one function"(){U(Bo(n=>n+1)(1),Y,2)},"given two functions"(){let e=n=>n+1;U(Bo(e,e)(1),Y,3)}});function jg(e,n){return(...a)=>n(e(...a))}function zg(e){return n=>n.map(e)}var A1=Te(`
...
`);var Ii=[Ai("Channel 1",bu.map(xu)),Ai("Channel 2",Yu.map(xu)),Ai("Channel 3",Fu)];function xu(e){return{videos:[e]}}function Qu(e){return j(ct,null,Ii.map(n=>j("button",{key:n.getName(),onClick:()=>e.onChannelSelected(n)},n.getName())))}function ju(){let[e,n]=Oe(+new Date);return vu(()=>n(+new Date),250),e}function zu(e=""){return{type:"nothing",nextVideoId:e}}function Ju(e){var n;return(n=/v=(.{11})/.exec(e))==null?void 0:n[1]}function _u(e,n){let a=n.getPlayerState(),t=Ju(n.getVideoUrl());if(e.type==="nothing")switch(a){case ae.ENDED:case ae.CUED:case ae.UNSTARTED:t!==e.nextVideoId?n.cueVideoById(e.nextVideoId,0):n.seekTo(0),n.playVideo()}else if(a!==ae.BUFFERING){let{videoId:i,currentTime:r}=e;switch(t!==i&&n.cueVideoById(i,r<lt?0:r),a){case ae.PAUSED:case ae.CUED:case ae.UNSTARTED:t&&n.playVideo()}let o=n.getCurrentTime();Jg(o,r)>=lt&&(console.debug("time is off; seeking",o,r),n.seekTo(r))}}function Jg(e,n){return Math.abs(e-n)}var _g=0;function Vg(){let[,e]=Oe(0);return()=>e(++_g)}function Vu(e){let n=Vg(),a=ca(yu());return Kn(()=>{Au(e).then(t=>{a.current=t,t.addEventListener("onStateChange",n),n()})},[e]),a.current}function Zu(){let[e,n]=Mu(),[a,t]=Oe(Ii[0]),i=ju(),r=e?a.getBroadcast(i):zu(),o=Vu("player-container"),s=o.getPlayerState(),l=s!==ae.PLAYING;return _u(r,o),j(Zg,{screen:j(ct,null,j("div",{id:"player-container"}),l&&j("div",{className:"black-screen"},j(Eu,{code:s,channel:a})),!e&&j(qg,{onClick:n})),controlPanel:j(Qu,{onChannelSelected:d=>{t(d),n()}})})}function Zg(e){return j("div",{className:"App"},j("div",{className:"bezel"},j("div",{className:"screen"},e.screen),j("div",{style:{height:"12px"}}),j("div",{className:"controls"},e.controlPanel)))}function qg(e){return j("button",{id:"start",onClick:e.onClick},"▸ Play")}function qu(){let[e,n]=Oe("");return Kn(()=>{Ku(Ru()).then(Gu).then(n).catch(a=>n(a.message))},[]),/fail/i.test(e)?j("div",{className:"TestResults"},j("code",null,j("pre",null,e))):null}vo(j(Zu,null),document.getElementById("app"));vo(j(qu,null),document.getElementById("test-results"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
