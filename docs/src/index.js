var Ii=(e,n,a)=>new Promise((i,t)=>{var r=l=>{try{s(a.next(l))}catch(d){t(d)}},o=l=>{try{s(a.throw(l))}catch(d){t(d)}},s=l=>l.done?i(l.value):Promise.resolve(l.value).then(r,o);s((a=a.apply(e,n)).next())});function Ve(e,n,a){return a={path:n,exports:{},require:function(i,t){return Md(i,t==null?a.path:t)}},e(a,a.exports),a.exports}function Md(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var Zo=Object.getOwnPropertySymbols,Od=Object.prototype.hasOwnProperty,Wd=Object.prototype.propertyIsEnumerable;function Bd(e){if(e==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(e)}function Nd(){try{if(!Object.assign)return!1;var e=new String("abc");if(e[5]="de",Object.getOwnPropertyNames(e)[0]==="5")return!1;for(var n={},a=0;a<10;a++)n["_"+String.fromCharCode(a)]=a;var i=Object.getOwnPropertyNames(n).map(function(r){return n[r]});if(i.join("")!=="0123456789")return!1;var t={};return"abcdefghijklmnopqrst".split("").forEach(function(r){t[r]=r}),Object.keys(Object.assign({},t)).join("")==="abcdefghijklmnopqrst"}catch(r){return!1}}var Pd=Nd()?Object.assign:function(e,n){for(var a,i=Bd(e),t,r=1;r<arguments.length;r++){a=Object(arguments[r]);for(var o in a)Od.call(a,o)&&(i[o]=a[o]);if(Zo){t=Zo(a);for(var s=0;s<t.length;s++)Wd.call(a,t[s])&&(i[t[s]]=a[t[s]])}}return i},Y=Pd;var Gd=Ve(function(e,n){var a=60103,i=60106;n.Fragment=60107,n.StrictMode=60108,n.Profiler=60114;var t=60109,r=60110,o=60112;n.Suspense=60113;var s=60115,l=60116;if(typeof Symbol=="function"&&Symbol.for){var d=Symbol.for;a=d("react.element"),i=d("react.portal"),n.Fragment=d("react.fragment"),n.StrictMode=d("react.strict_mode"),n.Profiler=d("react.profiler"),t=d("react.provider"),r=d("react.context"),o=d("react.forward_ref"),n.Suspense=d("react.suspense"),s=d("react.memo"),l=d("react.lazy")}var k=typeof Symbol=="function"&&Symbol.iterator;function N(g){return g===null||typeof g!="object"?null:(g=k&&g[k]||g["@@iterator"],typeof g=="function"?g:null)}function f(g){for(var A="https://reactjs.org/docs/error-decoder.html?invariant="+g,H=1;H<arguments.length;H++)A+="&args[]="+encodeURIComponent(arguments[H]);return"Minified React error #"+g+"; visit "+A+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var w={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},P={};function O(g,A,H){this.props=g,this.context=A,this.refs=P,this.updater=H||w}O.prototype.isReactComponent={},O.prototype.setState=function(g,A){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error(f(85));this.updater.enqueueSetState(this,g,A,"setState")},O.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function c(){}c.prototype=O.prototype;function u(g,A,H){this.props=g,this.context=A,this.refs=P,this.updater=H||w}var h=u.prototype=new c;h.constructor=u,Y(h,O.prototype),h.isPureReactComponent=!0;var m={current:null},p=Object.prototype.hasOwnProperty,G={key:!0,ref:!0,__self:!0,__source:!0};function v(g,A,H){var Q,y={},C=null,B=null;if(A!=null)for(Q in A.ref!==void 0&&(B=A.ref),A.key!==void 0&&(C=""+A.key),A)p.call(A,Q)&&!G.hasOwnProperty(Q)&&(y[Q]=A[Q]);var L=arguments.length-2;if(L===1)y.children=H;else if(1<L){for(var F=Array(L),ee=0;ee<L;ee++)F[ee]=arguments[ee+2];y.children=F}if(g&&g.defaultProps)for(Q in L=g.defaultProps,L)y[Q]===void 0&&(y[Q]=L[Q]);return{$$typeof:a,type:g,key:C,ref:B,props:y,_owner:m.current}}function W(g,A){return{$$typeof:a,type:g.type,key:A,ref:g.ref,props:g.props,_owner:g._owner}}function D(g){return typeof g=="object"&&g!==null&&g.$$typeof===a}function R(g){var A={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(H){return A[H]})}var _=/\/+/g;function ye(g,A){return typeof g=="object"&&g!==null&&g.key!=null?R(""+g.key):A.toString(36)}function Dn(g,A,H,Q,y){var C=typeof g;(C==="undefined"||C==="boolean")&&(g=null);var B=!1;if(g===null)B=!0;else switch(C){case"string":case"number":B=!0;break;case"object":switch(g.$$typeof){case a:case i:B=!0}}if(B)return B=g,y=y(B),g=Q===""?"."+ye(B,0):Q,Array.isArray(y)?(H="",g!=null&&(H=g.replace(_,"$&/")+"/"),Dn(y,A,H,"",function(ee){return ee})):y!=null&&(D(y)&&(y=W(y,H+(!y.key||B&&B.key===y.key?"":(""+y.key).replace(_,"$&/")+"/")+g)),A.push(y)),1;if(B=0,Q=Q===""?".":Q+":",Array.isArray(g))for(var L=0;L<g.length;L++){C=g[L];var F=Q+ye(C,L);B+=Dn(C,A,H,F,y)}else if(F=N(g),typeof F=="function")for(g=F.call(g),L=0;!(C=g.next()).done;)C=C.value,F=Q+ye(C,L++),B+=Dn(C,A,H,F,y);else if(C==="object")throw A=""+g,Error(f(31,A==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":A));return B}function se(g,A,H){if(g==null)return g;var Q=[],y=0;return Dn(g,Q,"","",function(C){return A.call(H,C,y++)}),Q}function te(g){if(g._status===-1){var A=g._result;A=A(),g._status=0,g._result=A,A.then(function(H){g._status===0&&(H=H.default,g._status=1,g._result=H)},function(H){g._status===0&&(g._status=2,g._result=H)})}if(g._status===1)return g._result;throw g._result}var fn={current:null};function le(){var g=fn.current;if(g===null)throw Error(f(321));return g}var Sn={ReactCurrentDispatcher:fn,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:m,IsSomeRendererActing:{current:!1},assign:Y};n.Children={map:se,forEach:function(g,A,H){se(g,function(){A.apply(this,arguments)},H)},count:function(g){var A=0;return se(g,function(){A++}),A},toArray:function(g){return se(g,function(A){return A})||[]},only:function(g){if(!D(g))throw Error(f(143));return g}},n.Component=O,n.PureComponent=u,n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Sn,n.cloneElement=function(g,A,H){if(g==null)throw Error(f(267,g));var Q=Y({},g.props),y=g.key,C=g.ref,B=g._owner;if(A!=null){if(A.ref!==void 0&&(C=A.ref,B=m.current),A.key!==void 0&&(y=""+A.key),g.type&&g.type.defaultProps)var L=g.type.defaultProps;for(F in A)p.call(A,F)&&!G.hasOwnProperty(F)&&(Q[F]=A[F]===void 0&&L!==void 0?L[F]:A[F])}var F=arguments.length-2;if(F===1)Q.children=H;else if(1<F){L=Array(F);for(var ee=0;ee<F;ee++)L[ee]=arguments[ee+2];Q.children=L}return{$$typeof:a,type:g.type,key:y,ref:C,props:Q,_owner:B}},n.createContext=function(g,A){return A===void 0&&(A=null),g={$$typeof:r,_calculateChangedBits:A,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider={$$typeof:t,_context:g},g.Consumer=g},n.createElement=v,n.createFactory=function(g){var A=v.bind(null,g);return A.type=g,A},n.createRef=function(){return{current:null}},n.forwardRef=function(g){return{$$typeof:o,render:g}},n.isValidElement=D,n.lazy=function(g){return{$$typeof:l,_payload:{_status:-1,_result:g},_init:te}},n.memo=function(g,A){return{$$typeof:s,type:g,compare:A===void 0?null:A}},n.useCallback=function(g,A){return le().useCallback(g,A)},n.useContext=function(g,A){return le().useContext(g,A)},n.useDebugValue=function(){},n.useEffect=function(g,A){return le().useEffect(g,A)},n.useImperativeHandle=function(g,A,H){return le().useImperativeHandle(g,A,H)},n.useLayoutEffect=function(g,A){return le().useLayoutEffect(g,A)},n.useMemo=function(g,A){return le().useMemo(g,A)},n.useReducer=function(g,A,H){return le().useReducer(g,A,H)},n.useRef=function(g){return le().useRef(g)},n.useState=function(g){return le().useState(g)},n.version="17.0.2"}),b=Ve(function(e){e.exports=Gd});var Hg=b.Children,Xo=b.Component,Ln=b.Fragment,bg=b.Profiler,Kg=b.PureComponent,Yg=b.StrictMode,xg=b.Suspense,Qg=b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,jg=b.cloneElement,Vg=b.createContext,E=b.createElement,Jg=b.createFactory,zg=b.createRef,_g=b.forwardRef,qg=b.isValidElement,Zg=b.lazy,Xg=b.memo,$g=b.useCallback,em=b.useContext,nm=b.useDebugValue,Fn=b.useEffect,am=b.useImperativeHandle,im=b.useLayoutEffect,tm=b.useMemo,rm=b.useReducer,Ta=b.useRef,Ne=b.useState,om=b.version;var Rd=Ve(function(e,n){var a,i,t,r;if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;n.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();n.unstable_now=function(){return s.now()-l}}if(typeof window=="undefined"||typeof MessageChannel!="function"){var d=null,k=null,N=function(){if(d!==null)try{var y=n.unstable_now();d(!0,y),d=null}catch(C){throw setTimeout(N,0),C}};a=function(y){d!==null?setTimeout(a,0,y):(d=y,setTimeout(N,0))},i=function(y,C){k=setTimeout(y,C)},t=function(){clearTimeout(k)},n.unstable_shouldYield=function(){return!1},r=n.unstable_forceFrameRate=function(){}}else{var f=window.setTimeout,w=window.clearTimeout;if(typeof console!="undefined"){var P=window.cancelAnimationFrame;typeof window.requestAnimationFrame!="function"&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),typeof P!="function"&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var O=!1,c=null,u=-1,h=5,m=0;n.unstable_shouldYield=function(){return n.unstable_now()>=m},r=function(){},n.unstable_forceFrameRate=function(y){0>y||125<y?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):h=0<y?Math.floor(1e3/y):5};var p=new MessageChannel,G=p.port2;p.port1.onmessage=function(){if(c!==null){var y=n.unstable_now();m=y+h;try{c(!0,y)?G.postMessage(null):(O=!1,c=null)}catch(C){throw G.postMessage(null),C}}else O=!1},a=function(y){c=y,O||(O=!0,G.postMessage(null))},i=function(y,C){u=f(function(){y(n.unstable_now())},C)},t=function(){w(u),u=-1}}function v(y,C){var B=y.length;y.push(C);e:for(;;){var L=B-1>>>1,F=y[L];if(F!==void 0&&0<R(F,C))y[L]=C,y[B]=F,B=L;else break e}}function W(y){return y=y[0],y===void 0?null:y}function D(y){var C=y[0];if(C!==void 0){var B=y.pop();if(B!==C){y[0]=B;e:for(var L=0,F=y.length;L<F;){var ee=2*(L+1)-1,yn=y[ee],ka=ee+1,Un=y[ka];if(yn!==void 0&&0>R(yn,B))Un!==void 0&&0>R(Un,yn)?(y[L]=Un,y[ka]=B,L=ka):(y[L]=yn,y[ee]=B,L=ee);else if(Un!==void 0&&0>R(Un,B))y[L]=Un,y[ka]=B,L=ka;else break e}}return C}return null}function R(y,C){var B=y.sortIndex-C.sortIndex;return B!==0?B:y.id-C.id}var _=[],ye=[],Dn=1,se=null,te=3,fn=!1,le=!1,Sn=!1;function g(y){for(var C=W(ye);C!==null;){if(C.callback===null)D(ye);else if(C.startTime<=y)D(ye),C.sortIndex=C.expirationTime,v(_,C);else break;C=W(ye)}}function A(y){if(Sn=!1,g(y),!le)if(W(_)!==null)le=!0,a(H);else{var C=W(ye);C!==null&&i(A,C.startTime-y)}}function H(y,C){le=!1,Sn&&(Sn=!1,t()),fn=!0;var B=te;try{for(g(C),se=W(_);se!==null&&(!(se.expirationTime>C)||y&&!n.unstable_shouldYield());){var L=se.callback;if(typeof L=="function"){se.callback=null,te=se.priorityLevel;var F=L(se.expirationTime<=C);C=n.unstable_now(),typeof F=="function"?se.callback=F:se===W(_)&&D(_),g(C)}else D(_);se=W(_)}if(se!==null)var ee=!0;else{var yn=W(ye);yn!==null&&i(A,yn.startTime-C),ee=!1}return ee}finally{se=null,te=B,fn=!1}}var Q=r;n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(y){y.callback=null},n.unstable_continueExecution=function(){le||fn||(le=!0,a(H))},n.unstable_getCurrentPriorityLevel=function(){return te},n.unstable_getFirstCallbackNode=function(){return W(_)},n.unstable_next=function(y){switch(te){case 1:case 2:case 3:var C=3;break;default:C=te}var B=te;te=C;try{return y()}finally{te=B}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=Q,n.unstable_runWithPriority=function(y,C){switch(y){case 1:case 2:case 3:case 4:case 5:break;default:y=3}var B=te;te=y;try{return C()}finally{te=B}},n.unstable_scheduleCallback=function(y,C,B){var L=n.unstable_now();switch(typeof B=="object"&&B!==null?(B=B.delay,B=typeof B=="number"&&0<B?L+B:L):B=L,y){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=B+F,y={id:Dn++,callback:C,priorityLevel:y,startTime:B,expirationTime:F,sortIndex:-1},B>L?(y.sortIndex=B,v(ye,y),W(_)===null&&y===W(ye)&&(Sn?t():Sn=!0,i(A,B-L))):(y.sortIndex=F,v(_,y),le||fn||(le=!0,a(H))),y},n.unstable_wrapCallback=function(y){var C=te;return function(){var B=te;te=C;try{return y.apply(this,arguments)}finally{te=B}}}}),ne=Ve(function(e){e.exports=Rd});function T(e){for(var n="https://reactjs.org/docs/error-decoder.html?invariant="+e,a=1;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!b)throw Error(T(227));var $o=new Set,Aa={};function kn(e,n){Hn(e,n),Hn(e+"Capture",n)}function Hn(e,n){for(Aa[e]=n,e=0;e<n.length;e++)$o.add(n[e])}var be=!(typeof window=="undefined"||typeof window.document=="undefined"||typeof window.document.createElement=="undefined"),Dd=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,es=Object.prototype.hasOwnProperty,ns={},as={};function Ud(e){return es.call(as,e)?!0:es.call(ns,e)?!1:Dd.test(e)?as[e]=!0:(ns[e]=!0,!1)}function Ld(e,n,a,i){if(a!==null&&a.type===0)return!1;switch(typeof n){case"function":case"symbol":return!0;case"boolean":return i?!1:a!==null?!a.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function Fd(e,n,a,i){if(n===null||typeof n=="undefined"||Ld(e,n,a,i))return!0;if(i)return!1;if(a!==null)switch(a.type){case 3:return!n;case 4:return n===!1;case 5:return isNaN(n);case 6:return isNaN(n)||1>n}return!1}function fe(e,n,a,i,t,r,o){this.acceptsBooleans=n===2||n===3||n===4,this.attributeName=i,this.attributeNamespace=t,this.mustUseProperty=a,this.propertyName=e,this.type=n,this.sanitizeURL=r,this.removeEmptyString=o}var ue={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){ue[e]=new fe(e,0,!1,e,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var n=e[0];ue[n]=new fe(n,1,!1,e[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(e){ue[e]=new fe(e,2,!1,e.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){ue[e]=new fe(e,2,!1,e,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){ue[e]=new fe(e,3,!1,e.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(e){ue[e]=new fe(e,3,!0,e,null,!1,!1)});["capture","download"].forEach(function(e){ue[e]=new fe(e,4,!1,e,null,!1,!1)});["cols","rows","size","span"].forEach(function(e){ue[e]=new fe(e,6,!1,e,null,!1,!1)});["rowSpan","start"].forEach(function(e){ue[e]=new fe(e,5,!1,e.toLowerCase(),null,!1,!1)});var Ft=/[\-:]([a-z])/g;function Ht(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var n=e.replace(Ft,Ht);ue[n]=new fe(n,1,!1,e,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var n=e.replace(Ft,Ht);ue[n]=new fe(n,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var n=e.replace(Ft,Ht);ue[n]=new fe(n,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(e){ue[e]=new fe(e,1,!1,e.toLowerCase(),null,!1,!1)});ue.xlinkHref=new fe("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(e){ue[e]=new fe(e,1,!1,e.toLowerCase(),null,!0,!0)});function bt(e,n,a,i){var t=ue.hasOwnProperty(n)?ue[n]:null,r=t!==null?t.type===0:i?!1:!(!(2<n.length)||n[0]!=="o"&&n[0]!=="O"||n[1]!=="n"&&n[1]!=="N");r||(Fd(n,a,t,i)&&(a=null),i||t===null?Ud(n)&&(a===null?e.removeAttribute(n):e.setAttribute(n,""+a)):t.mustUseProperty?e[t.propertyName]=a===null?t.type===3?!1:"":a:(n=t.attributeName,i=t.attributeNamespace,a===null?e.removeAttribute(n):(t=t.type,a=t===3||t===4&&a===!0?"":""+a,i?e.setAttributeNS(i,n,a):e.setAttribute(n,a))))}var Tn=b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,Ia=60103,An=60106,Je=60107,Kt=60108,va=60114,Yt=60109,xt=60110,vi=60112,Ea=60113,Ei=60120,wi=60115,Qt=60116,jt=60121,Vt=60128,is=60129,Jt=60130,zt=60131;typeof Symbol=="function"&&Symbol.for&&(ae=Symbol.for,Ia=ae("react.element"),An=ae("react.portal"),Je=ae("react.fragment"),Kt=ae("react.strict_mode"),va=ae("react.profiler"),Yt=ae("react.provider"),xt=ae("react.context"),vi=ae("react.forward_ref"),Ea=ae("react.suspense"),Ei=ae("react.suspense_list"),wi=ae("react.memo"),Qt=ae("react.lazy"),jt=ae("react.block"),ae("react.scope"),Vt=ae("react.opaque.id"),is=ae("react.debug_trace_mode"),Jt=ae("react.offscreen"),zt=ae("react.legacy_hidden"));var ae,ts=typeof Symbol=="function"&&Symbol.iterator;function wa(e){return e===null||typeof e!="object"?null:(e=ts&&e[ts]||e["@@iterator"],typeof e=="function"?e:null)}var _t;function Ca(e){if(_t===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);_t=n&&n[1]||""}return`
`+_t+e}var qt=!1;function Ci(e,n){if(!e||qt)return"";qt=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{if(n)if(n=function(){throw Error()},Object.defineProperty(n.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(n,[])}catch(l){var i=l}Reflect.construct(e,[],n)}else{try{n.call()}catch(l){i=l}e.call(n.prototype)}else{try{throw Error()}catch(l){i=l}e()}}catch(l){if(l&&i&&typeof l.stack=="string"){for(var t=l.stack.split(`
`),r=i.stack.split(`
`),o=t.length-1,s=r.length-1;1<=o&&0<=s&&t[o]!==r[s];)s--;for(;1<=o&&0<=s;o--,s--)if(t[o]!==r[s]){if(o!==1||s!==1)do if(o--,s--,0>s||t[o]!==r[s])return`
`+t[o].replace(" at new "," at ");while(1<=o&&0<=s);break}}}finally{qt=!1,Error.prepareStackTrace=a}return(e=e?e.displayName||e.name:"")?Ca(e):""}function Hd(e){switch(e.tag){case 5:return Ca(e.type);case 16:return Ca("Lazy");case 13:return Ca("Suspense");case 19:return Ca("SuspenseList");case 0:case 2:case 15:return e=Ci(e.type,!1),e;case 11:return e=Ci(e.type.render,!1),e;case 22:return e=Ci(e.type._render,!1),e;case 1:return e=Ci(e.type,!0),e;default:return""}}function bn(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Je:return"Fragment";case An:return"Portal";case va:return"Profiler";case Kt:return"StrictMode";case Ea:return"Suspense";case Ei:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case xt:return(e.displayName||"Context")+".Consumer";case Yt:return(e._context.displayName||"Context")+".Provider";case vi:var n=e.render;return n=n.displayName||n.name||"",e.displayName||(n!==""?"ForwardRef("+n+")":"ForwardRef");case wi:return bn(e.type);case jt:return bn(e._render);case Qt:n=e._payload,e=e._init;try{return bn(e(n))}catch(a){}}return null}function ze(e){switch(typeof e){case"boolean":case"number":case"object":case"string":case"undefined":return e;default:return""}}function rs(e){var n=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(n==="checkbox"||n==="radio")}function bd(e){var n=rs(e)?"checked":"value",a=Object.getOwnPropertyDescriptor(e.constructor.prototype,n),i=""+e[n];if(!e.hasOwnProperty(n)&&typeof a!="undefined"&&typeof a.get=="function"&&typeof a.set=="function"){var t=a.get,r=a.set;return Object.defineProperty(e,n,{configurable:!0,get:function(){return t.call(this)},set:function(o){i=""+o,r.call(this,o)}}),Object.defineProperty(e,n,{enumerable:a.enumerable}),{getValue:function(){return i},setValue:function(o){i=""+o},stopTracking:function(){e._valueTracker=null,delete e[n]}}}}function Mi(e){e._valueTracker||(e._valueTracker=bd(e))}function os(e){if(!e)return!1;var n=e._valueTracker;if(!n)return!0;var a=n.getValue(),i="";return e&&(i=rs(e)?e.checked?"true":"false":e.value),e=i,e!==a?(n.setValue(e),!0):!1}function Oi(e){if(e=e||(typeof document!="undefined"?document:void 0),typeof e=="undefined")return null;try{return e.activeElement||e.body}catch(n){return e.body}}function Zt(e,n){var a=n.checked;return Y({},n,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:a!=null?a:e._wrapperState.initialChecked})}function ss(e,n){var a=n.defaultValue==null?"":n.defaultValue,i=n.checked!=null?n.checked:n.defaultChecked;a=ze(n.value!=null?n.value:a),e._wrapperState={initialChecked:i,initialValue:a,controlled:n.type==="checkbox"||n.type==="radio"?n.checked!=null:n.value!=null}}function ls(e,n){n=n.checked,n!=null&&bt(e,"checked",n,!1)}function $t(e,n){ls(e,n);var a=ze(n.value),i=n.type;if(a!=null)i==="number"?(a===0&&e.value===""||e.value!=a)&&(e.value=""+a):e.value!==""+a&&(e.value=""+a);else if(i==="submit"||i==="reset"){e.removeAttribute("value");return}n.hasOwnProperty("value")?Xt(e,n.type,a):n.hasOwnProperty("defaultValue")&&Xt(e,n.type,ze(n.defaultValue)),n.checked==null&&n.defaultChecked!=null&&(e.defaultChecked=!!n.defaultChecked)}function us(e,n,a){if(n.hasOwnProperty("value")||n.hasOwnProperty("defaultValue")){var i=n.type;if(!(i!=="submit"&&i!=="reset"||n.value!==void 0&&n.value!==null))return;n=""+e._wrapperState.initialValue,a||n===e.value||(e.value=n),e.defaultValue=n}a=e.name,a!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,a!==""&&(e.name=a)}function Xt(e,n,a){(n!=="number"||Oi(e.ownerDocument)!==e)&&(a==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+a&&(e.defaultValue=""+a))}function Kd(e){var n="";return b.Children.forEach(e,function(a){a!=null&&(n+=a)}),n}function er(e,n){return e=Y({children:void 0},n),(n=Kd(n.children))&&(e.children=n),e}function Kn(e,n,a,i){if(e=e.options,n){n={};for(var t=0;t<a.length;t++)n["$"+a[t]]=!0;for(a=0;a<e.length;a++)t=n.hasOwnProperty("$"+e[a].value),e[a].selected!==t&&(e[a].selected=t),t&&i&&(e[a].defaultSelected=!0)}else{for(a=""+ze(a),n=null,t=0;t<e.length;t++){if(e[t].value===a){e[t].selected=!0,i&&(e[t].defaultSelected=!0);return}n!==null||e[t].disabled||(n=e[t])}n!==null&&(n.selected=!0)}}function nr(e,n){if(n.dangerouslySetInnerHTML!=null)throw Error(T(91));return Y({},n,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function ds(e,n){var a=n.value;if(a==null){if(a=n.children,n=n.defaultValue,a!=null){if(n!=null)throw Error(T(92));if(Array.isArray(a)){if(!(1>=a.length))throw Error(T(93));a=a[0]}n=a}n==null&&(n=""),a=n}e._wrapperState={initialValue:ze(a)}}function hs(e,n){var a=ze(n.value),i=ze(n.defaultValue);a!=null&&(a=""+a,a!==e.value&&(e.value=a),n.defaultValue==null&&e.defaultValue!==a&&(e.defaultValue=a)),i!=null&&(e.defaultValue=""+i)}function cs(e){var n=e.textContent;n===e._wrapperState.initialValue&&n!==""&&n!==null&&(e.value=n)}var ar={html:"http://www.w3.org/1999/xhtml",mathml:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg"};function gs(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function ir(e,n){return e==null||e==="http://www.w3.org/1999/xhtml"?gs(n):e==="http://www.w3.org/2000/svg"&&n==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var Wi,ms=function(e){return typeof MSApp!="undefined"&&MSApp.execUnsafeLocalFunction?function(n,a,i,t){MSApp.execUnsafeLocalFunction(function(){return e(n,a,i,t)})}:e}(function(e,n){if(e.namespaceURI!==ar.svg||"innerHTML"in e)e.innerHTML=n;else{for(Wi=Wi||document.createElement("div"),Wi.innerHTML="<svg>"+n.valueOf().toString()+"</svg>",n=Wi.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;n.firstChild;)e.appendChild(n.firstChild)}});function Ma(e,n){if(n){var a=e.firstChild;if(a&&a===e.lastChild&&a.nodeType===3){a.nodeValue=n;return}}e.textContent=n}var Oa={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Yd=["Webkit","ms","Moz","O"];Object.keys(Oa).forEach(function(e){Yd.forEach(function(n){n=n+e.charAt(0).toUpperCase()+e.substring(1),Oa[n]=Oa[e]})});function ps(e,n,a){return n==null||typeof n=="boolean"||n===""?"":a||typeof n!="number"||n===0||Oa.hasOwnProperty(e)&&Oa[e]?(""+n).trim():n+"px"}function fs(e,n){e=e.style;for(var a in n)if(n.hasOwnProperty(a)){var i=a.indexOf("--")===0,t=ps(a,n[a],i);a==="float"&&(a="cssFloat"),i?e.setProperty(a,t):e[a]=t}}var xd=Y({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function tr(e,n){if(n){if(xd[e]&&(n.children!=null||n.dangerouslySetInnerHTML!=null))throw Error(T(137,e));if(n.dangerouslySetInnerHTML!=null){if(n.children!=null)throw Error(T(60));if(!(typeof n.dangerouslySetInnerHTML=="object"&&"__html"in n.dangerouslySetInnerHTML))throw Error(T(61))}if(n.style!=null&&typeof n.style!="object")throw Error(T(62))}}function rr(e,n){if(e.indexOf("-")===-1)return typeof n.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}function or(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var sr=null,Yn=null,xn=null;function Ss(e){if(e=Wa(e)){if(typeof sr!="function")throw Error(T(280));var n=e.stateNode;n&&(n=Bi(n),sr(e.stateNode,e.type,n))}}function ys(e){Yn?xn?xn.push(e):xn=[e]:Yn=e}function ks(){if(Yn){var e=Yn,n=xn;if(xn=Yn=null,Ss(e),n)for(e=0;e<n.length;e++)Ss(n[e])}}function lr(e,n){return e(n)}function Ts(e,n,a,i,t){return e(n,a,i,t)}function ur(){}var As=lr,In=!1,dr=!1;function hr(){(Yn!==null||xn!==null)&&(ur(),ks())}function Qd(e,n,a){if(dr)return e(n,a);dr=!0;try{return As(e,n,a)}finally{dr=!1,hr()}}function Ba(e,n){var a=e.stateNode;if(a===null)return null;var i=Bi(a);if(i===null)return null;a=i[n];e:switch(n){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(i=!i.disabled)||(e=e.type,i=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!i;break e;default:e=!1}if(e)return null;if(a&&typeof a!="function")throw Error(T(231,n,typeof a));return a}var cr=!1;if(be)try{Qn={},Object.defineProperty(Qn,"passive",{get:function(){cr=!0}}),window.addEventListener("test",Qn,Qn),window.removeEventListener("test",Qn,Qn)}catch(e){cr=!1}var Qn;function jd(e,n,a,i,t,r,o,s,l){var d=Array.prototype.slice.call(arguments,3);try{n.apply(a,d)}catch(k){this.onError(k)}}var Na=!1,Ni=null,Pi=!1,gr=null,Vd={onError:function(e){Na=!0,Ni=e}};function Jd(e,n,a,i,t,r,o,s,l){Na=!1,Ni=null,jd.apply(Vd,arguments)}function zd(e,n,a,i,t,r,o,s,l){if(Jd.apply(this,arguments),Na){if(Na){var d=Ni;Na=!1,Ni=null}else throw Error(T(198));Pi||(Pi=!0,gr=d)}}function vn(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&1026)!=0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function Is(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function vs(e){if(vn(e)!==e)throw Error(T(188))}function _d(e){var n=e.alternate;if(!n){if(n=vn(e),n===null)throw Error(T(188));return n!==e?null:e}for(var a=e,i=n;;){var t=a.return;if(t===null)break;var r=t.alternate;if(r===null){if(i=t.return,i!==null){a=i;continue}break}if(t.child===r.child){for(r=t.child;r;){if(r===a)return vs(t),e;if(r===i)return vs(t),n;r=r.sibling}throw Error(T(188))}if(a.return!==i.return)a=t,i=r;else{for(var o=!1,s=t.child;s;){if(s===a){o=!0,a=t,i=r;break}if(s===i){o=!0,i=t,a=r;break}s=s.sibling}if(!o){for(s=r.child;s;){if(s===a){o=!0,a=r,i=t;break}if(s===i){o=!0,i=r,a=t;break}s=s.sibling}if(!o)throw Error(T(189))}}if(a.alternate!==i)throw Error(T(190))}if(a.tag!==3)throw Error(T(188));return a.stateNode.current===a?e:n}function Es(e){if(e=_d(e),!e)return null;for(var n=e;;){if(n.tag===5||n.tag===6)return n;if(n.child)n.child.return=n,n=n.child;else{if(n===e)break;for(;!n.sibling;){if(!n.return||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}}return null}function ws(e,n){for(var a=e.alternate;n!==null;){if(n===e||n===a)return!0;n=n.return}return!1}var Cs,mr,Ms,Os,pr=!1,Re=[],_e=null,qe=null,Ze=null,Pa=new Map,Ga=new Map,Ra=[],Ws="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function fr(e,n,a,i,t){return{blockedOn:e,domEventName:n,eventSystemFlags:a|16,nativeEvent:t,targetContainers:[i]}}function Bs(e,n){switch(e){case"focusin":case"focusout":_e=null;break;case"dragenter":case"dragleave":qe=null;break;case"mouseover":case"mouseout":Ze=null;break;case"pointerover":case"pointerout":Pa.delete(n.pointerId);break;case"gotpointercapture":case"lostpointercapture":Ga.delete(n.pointerId)}}function Da(e,n,a,i,t,r){return e===null||e.nativeEvent!==r?(e=fr(n,a,i,t,r),n!==null&&(n=Wa(n),n!==null&&mr(n)),e):(e.eventSystemFlags|=i,n=e.targetContainers,t!==null&&n.indexOf(t)===-1&&n.push(t),e)}function qd(e,n,a,i,t){switch(n){case"focusin":return _e=Da(_e,e,n,a,i,t),!0;case"dragenter":return qe=Da(qe,e,n,a,i,t),!0;case"mouseover":return Ze=Da(Ze,e,n,a,i,t),!0;case"pointerover":var r=t.pointerId;return Pa.set(r,Da(Pa.get(r)||null,e,n,a,i,t)),!0;case"gotpointercapture":return r=t.pointerId,Ga.set(r,Da(Ga.get(r)||null,e,n,a,i,t)),!0}return!1}function Zd(e){var n=En(e.target);if(n!==null){var a=vn(n);if(a!==null){if(n=a.tag,n===13){if(n=Is(a),n!==null){e.blockedOn=n,Os(e.lanePriority,function(){ne.unstable_runWithPriority(e.priority,function(){Ms(a)})});return}}else if(n===3&&a.stateNode.hydrate){e.blockedOn=a.tag===3?a.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Gi(e){if(e.blockedOn!==null)return!1;for(var n=e.targetContainers;0<n.length;){var a=Sr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null)return n=Wa(a),n!==null&&mr(n),e.blockedOn=a,!1;n.shift()}return!0}function Ns(e,n,a){Gi(e)&&a.delete(n)}function Xd(){for(pr=!1;0<Re.length;){var e=Re[0];if(e.blockedOn!==null){e=Wa(e.blockedOn),e!==null&&Cs(e);break}for(var n=e.targetContainers;0<n.length;){var a=Sr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null){e.blockedOn=a;break}n.shift()}e.blockedOn===null&&Re.shift()}_e!==null&&Gi(_e)&&(_e=null),qe!==null&&Gi(qe)&&(qe=null),Ze!==null&&Gi(Ze)&&(Ze=null),Pa.forEach(Ns),Ga.forEach(Ns)}function Ua(e,n){e.blockedOn===n&&(e.blockedOn=null,pr||(pr=!0,ne.unstable_scheduleCallback(ne.unstable_NormalPriority,Xd)))}function Ps(e){function n(t){return Ua(t,e)}if(0<Re.length){Ua(Re[0],e);for(var a=1;a<Re.length;a++){var i=Re[a];i.blockedOn===e&&(i.blockedOn=null)}}for(_e!==null&&Ua(_e,e),qe!==null&&Ua(qe,e),Ze!==null&&Ua(Ze,e),Pa.forEach(n),Ga.forEach(n),a=0;a<Ra.length;a++)i=Ra[a],i.blockedOn===e&&(i.blockedOn=null);for(;0<Ra.length&&(a=Ra[0],a.blockedOn===null);)Zd(a),a.blockedOn===null&&Ra.shift()}function Ri(e,n){var a={};return a[e.toLowerCase()]=n.toLowerCase(),a["Webkit"+e]="webkit"+n,a["Moz"+e]="moz"+n,a}var jn={animationend:Ri("Animation","AnimationEnd"),animationiteration:Ri("Animation","AnimationIteration"),animationstart:Ri("Animation","AnimationStart"),transitionend:Ri("Transition","TransitionEnd")},yr={},Gs={};be&&(Gs=document.createElement("div").style,"AnimationEvent"in window||(delete jn.animationend.animation,delete jn.animationiteration.animation,delete jn.animationstart.animation),"TransitionEvent"in window||delete jn.transitionend.transition);function Di(e){if(yr[e])return yr[e];if(!jn[e])return e;var n=jn[e],a;for(a in n)if(n.hasOwnProperty(a)&&a in Gs)return yr[e]=n[a];return e}var Rs=Di("animationend"),Ds=Di("animationiteration"),Us=Di("animationstart"),Ls=Di("transitionend"),Fs=new Map,kr=new Map,$d=["abort","abort",Rs,"animationEnd",Ds,"animationIteration",Us,"animationStart","canplay","canPlay","canplaythrough","canPlayThrough","durationchange","durationChange","emptied","emptied","encrypted","encrypted","ended","ended","error","error","gotpointercapture","gotPointerCapture","load","load","loadeddata","loadedData","loadedmetadata","loadedMetadata","loadstart","loadStart","lostpointercapture","lostPointerCapture","playing","playing","progress","progress","seeking","seeking","stalled","stalled","suspend","suspend","timeupdate","timeUpdate",Ls,"transitionEnd","waiting","waiting"];function Tr(e,n){for(var a=0;a<e.length;a+=2){var i=e[a],t=e[a+1];t="on"+(t[0].toUpperCase()+t.slice(1)),kr.set(i,n),Fs.set(i,t),kn(t,[i])}}var eh=ne.unstable_now;eh();var j=8;function Vn(e){if((1&e)!=0)return j=15,1;if((2&e)!=0)return j=14,2;if((4&e)!=0)return j=13,4;var n=24&e;return n!==0?(j=12,n):(e&32)!=0?(j=11,32):(n=192&e,n!==0?(j=10,n):(e&256)!=0?(j=9,256):(n=3584&e,n!==0?(j=8,n):(e&4096)!=0?(j=7,4096):(n=4186112&e,n!==0?(j=6,n):(n=62914560&e,n!==0?(j=5,n):e&67108864?(j=4,67108864):(e&134217728)!=0?(j=3,134217728):(n=805306368&e,n!==0?(j=2,n):(1073741824&e)!=0?(j=1,1073741824):(j=8,e))))))}function nh(e){switch(e){case 99:return 15;case 98:return 10;case 97:case 96:return 8;case 95:return 2;default:return 0}}function ah(e){switch(e){case 15:case 14:return 99;case 13:case 12:case 11:case 10:return 98;case 9:case 8:case 7:case 6:case 4:case 5:return 97;case 3:case 2:case 1:return 95;case 0:return 90;default:throw Error(T(358,e))}}function La(e,n){var a=e.pendingLanes;if(a===0)return j=0;var i=0,t=0,r=e.expiredLanes,o=e.suspendedLanes,s=e.pingedLanes;if(r!==0)i=r,t=j=15;else if(r=a&134217727,r!==0){var l=r&~o;l!==0?(i=Vn(l),t=j):(s&=r,s!==0&&(i=Vn(s),t=j))}else r=a&~o,r!==0?(i=Vn(r),t=j):s!==0&&(i=Vn(s),t=j);if(i===0)return 0;if(i=31-Xe(i),i=a&((0>i?0:1<<i)<<1)-1,n!==0&&n!==i&&(n&o)==0){if(Vn(n),t<=j)return n;j=t}if(n=e.entangledLanes,n!==0)for(e=e.entanglements,n&=i;0<n;)a=31-Xe(n),t=1<<a,i|=e[a],n&=~t;return i}function Hs(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function Ui(e,n){switch(e){case 15:return 1;case 14:return 2;case 12:return e=Jn(24&~n),e===0?Ui(10,n):e;case 10:return e=Jn(192&~n),e===0?Ui(8,n):e;case 8:return e=Jn(3584&~n),e===0&&(e=Jn(4186112&~n),e===0&&(e=512)),e;case 2:return n=Jn(805306368&~n),n===0&&(n=268435456),n}throw Error(T(358,e))}function Jn(e){return e&-e}function Ar(e){for(var n=[],a=0;31>a;a++)n.push(e);return n}function Li(e,n,a){e.pendingLanes|=n;var i=n-1;e.suspendedLanes&=i,e.pingedLanes&=i,e=e.eventTimes,n=31-Xe(n),e[n]=a}var Xe=Math.clz32?Math.clz32:ih,th=Math.log,rh=Math.LN2;function ih(e){return e===0?32:31-(th(e)/rh|0)|0}var oh=ne.unstable_UserBlockingPriority,sh=ne.unstable_runWithPriority,Fi=!0;function lh(e,n,a,i){In||ur();var t=Ir,r=In;In=!0;try{Ts(t,e,n,a,i)}finally{(In=r)||hr()}}function uh(e,n,a,i){sh(oh,Ir.bind(null,e,n,a,i))}function Ir(e,n,a,i){if(Fi){var t;if((t=(n&4)==0)&&0<Re.length&&-1<Ws.indexOf(e))e=fr(null,e,n,a,i),Re.push(e);else{var r=Sr(e,n,a,i);if(r===null)t&&Bs(e,i);else{if(t){if(-1<Ws.indexOf(e)){e=fr(r,e,n,a,i),Re.push(e);return}if(qd(r,e,n,a,i))return;Bs(e,i)}bs(e,n,i,null,a)}}}}function Sr(e,n,a,i){var t=or(i);if(t=En(t),t!==null){var r=vn(t);if(r===null)t=null;else{var o=r.tag;if(o===13){if(t=Is(r),t!==null)return t;t=null}else if(o===3){if(r.stateNode.hydrate)return r.tag===3?r.stateNode.containerInfo:null;t=null}else r!==t&&(t=null)}}return bs(e,n,i,t,a),null}var $e=null,vr=null,Hi=null;function Ks(){if(Hi)return Hi;var e,n=vr,a=n.length,i,t="value"in $e?$e.value:$e.textContent,r=t.length;for(e=0;e<a&&n[e]===t[e];e++);var o=a-e;for(i=1;i<=o&&n[a-i]===t[r-i];i++);return Hi=t.slice(e,1<i?1-i:void 0)}function bi(e){var n=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&n===13&&(e=13)):e=n,e===10&&(e=13),32<=e||e===13?e:0}function Ki(){return!0}function Ys(){return!1}function Ee(e){function n(a,i,t,r,o){this._reactName=a,this._targetInst=t,this.type=i,this.nativeEvent=r,this.target=o,this.currentTarget=null;for(var s in e)e.hasOwnProperty(s)&&(a=e[s],this[s]=a?a(r):r[s]);return this.isDefaultPrevented=(r.defaultPrevented!=null?r.defaultPrevented:r.returnValue===!1)?Ki:Ys,this.isPropagationStopped=Ys,this}return Y(n.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():typeof a.returnValue!="unknown"&&(a.returnValue=!1),this.isDefaultPrevented=Ki)},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():typeof a.cancelBubble!="unknown"&&(a.cancelBubble=!0),this.isPropagationStopped=Ki)},persist:function(){},isPersistent:Ki}),n}var zn={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Er=Ee(zn),Fa=Y({},zn,{view:0,detail:0}),dh=Ee(Fa),wr,Cr,Ha,Yi=Y({},Fa,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Mr,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==Ha&&(Ha&&e.type==="mousemove"?(wr=e.screenX-Ha.screenX,Cr=e.screenY-Ha.screenY):Cr=wr=0,Ha=e),wr)},movementY:function(e){return"movementY"in e?e.movementY:Cr}}),xs=Ee(Yi),hh=Y({},Yi,{dataTransfer:0}),ch=Ee(hh),gh=Y({},Fa,{relatedTarget:0}),Or=Ee(gh),mh=Y({},zn,{animationName:0,elapsedTime:0,pseudoElement:0}),ph=Ee(mh),fh=Y({},zn,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),Sh=Ee(fh),yh=Y({},zn,{data:0}),Qs=Ee(yh),kh={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},Th={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},Ah={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function Ih(e){var n=this.nativeEvent;return n.getModifierState?n.getModifierState(e):(e=Ah[e])?!!n[e]:!1}function Mr(){return Ih}var vh=Y({},Fa,{key:function(e){if(e.key){var n=kh[e.key]||e.key;if(n!=="Unidentified")return n}return e.type==="keypress"?(e=bi(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?Th[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Mr,charCode:function(e){return e.type==="keypress"?bi(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?bi(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),Eh=Ee(vh),wh=Y({},Yi,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),js=Ee(wh),Ch=Y({},Fa,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Mr}),Mh=Ee(Ch),Oh=Y({},zn,{propertyName:0,elapsedTime:0,pseudoElement:0}),Wh=Ee(Oh),Bh=Y({},Yi,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),Nh=Ee(Bh),Ph=[9,13,27,32],Wr=be&&"CompositionEvent"in window,ba=null;be&&"documentMode"in document&&(ba=document.documentMode);var Gh=be&&"TextEvent"in window&&!ba,Vs=be&&(!Wr||ba&&8<ba&&11>=ba),Js=String.fromCharCode(32),zs=!1;function _s(e,n){switch(e){case"keyup":return Ph.indexOf(n.keyCode)!==-1;case"keydown":return n.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function qs(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var _n=!1;function Rh(e,n){switch(e){case"compositionend":return qs(n);case"keypress":return n.which!==32?null:(zs=!0,Js);case"textInput":return e=n.data,e===Js&&zs?null:e;default:return null}}function Dh(e,n){if(_n)return e==="compositionend"||!Wr&&_s(e,n)?(e=Ks(),Hi=vr=$e=null,_n=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(n.ctrlKey||n.altKey||n.metaKey)||n.ctrlKey&&n.altKey){if(n.char&&1<n.char.length)return n.char;if(n.which)return String.fromCharCode(n.which)}return null;case"compositionend":return Vs&&n.locale!=="ko"?null:n.data;default:return null}}var Uh={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Zs(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n==="input"?!!Uh[e.type]:n==="textarea"}function Xs(e,n,a,i){ys(i),n=xi(n,"onChange"),0<n.length&&(a=new Er("onChange","change",null,a,i),e.push({event:a,listeners:n}))}var Ka=null,Ya=null;function Lh(e){$s(e,0)}function Qi(e){var n=qn(e);if(os(n))return e}function Fh(e,n){if(e==="change")return n}var el=!1;be&&(be?(Vi="oninput"in document,Vi||(Br=document.createElement("div"),Br.setAttribute("oninput","return;"),Vi=typeof Br.oninput=="function"),ji=Vi):ji=!1,el=ji&&(!document.documentMode||9<document.documentMode));var ji,Vi,Br;function al(){Ka&&(Ka.detachEvent("onpropertychange",nl),Ya=Ka=null)}function nl(e){if(e.propertyName==="value"&&Qi(Ya)){var n=[];if(Xs(n,Ya,e,or(e)),e=Lh,In)e(n);else{In=!0;try{lr(e,n)}finally{In=!1,hr()}}}}function Hh(e,n,a){e==="focusin"?(al(),Ka=n,Ya=a,Ka.attachEvent("onpropertychange",nl)):e==="focusout"&&al()}function bh(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return Qi(Ya)}function Kh(e,n){if(e==="click")return Qi(n)}function Yh(e,n){if(e==="input"||e==="change")return Qi(n)}function xh(e,n){return e===n&&(e!==0||1/e==1/n)||e!==e&&n!==n}var Ce=typeof Object.is=="function"?Object.is:xh,Qh=Object.prototype.hasOwnProperty;function xa(e,n){if(Ce(e,n))return!0;if(typeof e!="object"||e===null||typeof n!="object"||n===null)return!1;var a=Object.keys(e),i=Object.keys(n);if(a.length!==i.length)return!1;for(i=0;i<a.length;i++)if(!Qh.call(n,a[i])||!Ce(e[a[i]],n[a[i]]))return!1;return!0}function il(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function tl(e,n){var a=il(e);e=0;for(var i;a;){if(a.nodeType===3){if(i=e+a.textContent.length,e<=n&&i>=n)return{node:a,offset:n-e};e=i}e:{for(;a;){if(a.nextSibling){a=a.nextSibling;break e}a=a.parentNode}a=void 0}a=il(a)}}function rl(e,n){return e&&n?e===n?!0:e&&e.nodeType===3?!1:n&&n.nodeType===3?rl(e,n.parentNode):"contains"in e?e.contains(n):e.compareDocumentPosition?!!(e.compareDocumentPosition(n)&16):!1:!1}function ol(){for(var e=window,n=Oi();n instanceof e.HTMLIFrameElement;){try{var a=typeof n.contentWindow.location.href=="string"}catch(i){a=!1}if(a)e=n.contentWindow;else break;n=Oi(e.document)}return n}function Nr(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n&&(n==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||n==="textarea"||e.contentEditable==="true")}var jh=be&&"documentMode"in document&&11>=document.documentMode,Zn=null,Pr=null,Qa=null,Gr=!1;function sl(e,n,a){var i=a.window===a?a.document:a.nodeType===9?a:a.ownerDocument;Gr||Zn==null||Zn!==Oi(i)||(i=Zn,"selectionStart"in i&&Nr(i)?i={start:i.selectionStart,end:i.selectionEnd}:(i=(i.ownerDocument&&i.ownerDocument.defaultView||window).getSelection(),i={anchorNode:i.anchorNode,anchorOffset:i.anchorOffset,focusNode:i.focusNode,focusOffset:i.focusOffset}),Qa&&xa(Qa,i)||(Qa=i,i=xi(Pr,"onSelect"),0<i.length&&(n=new Er("onSelect","select",null,n,a),e.push({event:n,listeners:i}),n.target=Zn)))}Tr("cancel cancel click click close close contextmenu contextMenu copy copy cut cut auxclick auxClick dblclick doubleClick dragend dragEnd dragstart dragStart drop drop focusin focus focusout blur input input invalid invalid keydown keyDown keypress keyPress keyup keyUp mousedown mouseDown mouseup mouseUp paste paste pause pause play play pointercancel pointerCancel pointerdown pointerDown pointerup pointerUp ratechange rateChange reset reset seeked seeked submit submit touchcancel touchCancel touchend touchEnd touchstart touchStart volumechange volumeChange".split(" "),0);Tr("drag drag dragenter dragEnter dragexit dragExit dragleave dragLeave dragover dragOver mousemove mouseMove mouseout mouseOut mouseover mouseOver pointermove pointerMove pointerout pointerOut pointerover pointerOver scroll scroll toggle toggle touchmove touchMove wheel wheel".split(" "),1);Tr($d,2);for(var ll="change selectionchange textInput compositionstart compositionend compositionupdate".split(" "),Rr=0;Rr<ll.length;Rr++)kr.set(ll[Rr],0);Hn("onMouseEnter",["mouseout","mouseover"]);Hn("onMouseLeave",["mouseout","mouseover"]);Hn("onPointerEnter",["pointerout","pointerover"]);Hn("onPointerLeave",["pointerout","pointerover"]);kn("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));kn("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));kn("onBeforeInput",["compositionend","keypress","textInput","paste"]);kn("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));kn("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));kn("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var ja="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),ul=new Set("cancel close invalid load scroll toggle".split(" ").concat(ja));function dl(e,n,a){var i=e.type||"unknown-event";e.currentTarget=a,zd(i,n,void 0,e),e.currentTarget=null}function $s(e,n){n=(n&4)!=0;for(var a=0;a<e.length;a++){var i=e[a],t=i.event;i=i.listeners;e:{var r=void 0;if(n)for(var o=i.length-1;0<=o;o--){var s=i[o],l=s.instance,d=s.currentTarget;if(s=s.listener,l!==r&&t.isPropagationStopped())break e;dl(t,s,d),r=l}else for(o=0;o<i.length;o++){if(s=i[o],l=s.instance,d=s.currentTarget,s=s.listener,l!==r&&t.isPropagationStopped())break e;dl(t,s,d),r=l}}}if(Pi)throw e=gr,Pi=!1,gr=null,e}function V(e,n){var a=cl(n),i=e+"__bubble";a.has(i)||(hl(n,e,2,!1),a.add(i))}var gl="_reactListening"+Math.random().toString(36).slice(2);function pl(e){e[gl]||(e[gl]=!0,$o.forEach(function(n){ul.has(n)||ml(n,!1,e,null),ml(n,!0,e,null)}))}function ml(e,n,a,i){var t=4<arguments.length&&arguments[4]!==void 0?arguments[4]:0,r=a;if(e==="selectionchange"&&a.nodeType!==9&&(r=a.ownerDocument),i!==null&&!n&&ul.has(e)){if(e!=="scroll")return;t|=2,r=i}var o=cl(r),s=e+"__"+(n?"capture":"bubble");o.has(s)||(n&&(t|=4),hl(r,e,t,n),o.add(s))}function hl(e,n,a,i){var t=kr.get(n);switch(t===void 0?2:t){case 0:t=lh;break;case 1:t=uh;break;default:t=Ir}a=t.bind(null,n,a,e),t=void 0,!cr||n!=="touchstart"&&n!=="touchmove"&&n!=="wheel"||(t=!0),i?t!==void 0?e.addEventListener(n,a,{capture:!0,passive:t}):e.addEventListener(n,a,!0):t!==void 0?e.addEventListener(n,a,{passive:t}):e.addEventListener(n,a,!1)}function bs(e,n,a,i,t){var r=i;if((n&1)==0&&(n&2)==0&&i!==null)e:for(;;){if(i===null)return;var o=i.tag;if(o===3||o===4){var s=i.stateNode.containerInfo;if(s===t||s.nodeType===8&&s.parentNode===t)break;if(o===4)for(o=i.return;o!==null;){var l=o.tag;if((l===3||l===4)&&(l=o.stateNode.containerInfo,l===t||l.nodeType===8&&l.parentNode===t))return;o=o.return}for(;s!==null;){if(o=En(s),o===null)return;if(l=o.tag,l===5||l===6){i=r=o;continue e}s=s.parentNode}}i=i.return}Qd(function(){var d=r,k=or(a),N=[];e:{var f=Fs.get(e);if(f!==void 0){var w=Er,P=e;switch(e){case"keypress":if(bi(a)===0)break e;case"keydown":case"keyup":w=Eh;break;case"focusin":P="focus",w=Or;break;case"focusout":P="blur",w=Or;break;case"beforeblur":case"afterblur":w=Or;break;case"click":if(a.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":w=xs;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":w=ch;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":w=Mh;break;case Rs:case Ds:case Us:w=ph;break;case Ls:w=Wh;break;case"scroll":w=dh;break;case"wheel":w=Nh;break;case"copy":case"cut":case"paste":w=Sh;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":w=js}var O=(n&4)!=0,c=!O&&e==="scroll",u=O?f!==null?f+"Capture":null:f;O=[];for(var h=d,m;h!==null;){m=h;var p=m.stateNode;if(m.tag===5&&p!==null&&(m=p,u!==null&&(p=Ba(h,u),p!=null&&O.push(Va(h,p,m)))),c)break;h=h.return}0<O.length&&(f=new w(f,P,null,a,k),N.push({event:f,listeners:O}))}}if((n&7)==0){e:{if(f=e==="mouseover"||e==="pointerover",w=e==="mouseout"||e==="pointerout",f&&(n&16)==0&&(P=a.relatedTarget||a.fromElement)&&(En(P)||P[$n]))break e;if((w||f)&&(f=k.window===k?k:(f=k.ownerDocument)?f.defaultView||f.parentWindow:window,w?(P=a.relatedTarget||a.toElement,w=d,P=P?En(P):null,P!==null&&(c=vn(P),P!==c||P.tag!==5&&P.tag!==6)&&(P=null)):(w=null,P=d),w!==P)){if(O=xs,p="onMouseLeave",u="onMouseEnter",h="mouse",(e==="pointerout"||e==="pointerover")&&(O=js,p="onPointerLeave",u="onPointerEnter",h="pointer"),c=w==null?f:qn(w),m=P==null?f:qn(P),f=new O(p,h+"leave",w,a,k),f.target=c,f.relatedTarget=m,p=null,En(k)===d&&(O=new O(u,h+"enter",P,a,k),O.target=m,O.relatedTarget=c,p=O),c=p,w&&P)n:{for(O=w,u=P,h=0,m=O;m;m=Xn(m))h++;for(m=0,p=u;p;p=Xn(p))m++;for(;0<h-m;)O=Xn(O),h--;for(;0<m-h;)u=Xn(u),m--;for(;h--;){if(O===u||u!==null&&O===u.alternate)break n;O=Xn(O),u=Xn(u)}O=null}else O=null;w!==null&&fl(N,f,w,O,!1),P!==null&&c!==null&&fl(N,c,P,O,!0)}}e:{if(f=d?qn(d):window,w=f.nodeName&&f.nodeName.toLowerCase(),w==="select"||w==="input"&&f.type==="file")var G=Fh;else if(Zs(f))if(el)G=Yh;else{G=bh;var v=Hh}else(w=f.nodeName)&&w.toLowerCase()==="input"&&(f.type==="checkbox"||f.type==="radio")&&(G=Kh);if(G&&(G=G(e,d))){Xs(N,G,a,k);break e}v&&v(e,f,d),e==="focusout"&&(v=f._wrapperState)&&v.controlled&&f.type==="number"&&Xt(f,"number",f.value)}switch(v=d?qn(d):window,e){case"focusin":(Zs(v)||v.contentEditable==="true")&&(Zn=v,Pr=d,Qa=null);break;case"focusout":Qa=Pr=Zn=null;break;case"mousedown":Gr=!0;break;case"contextmenu":case"mouseup":case"dragend":Gr=!1,sl(N,a,k);break;case"selectionchange":if(jh)break;case"keydown":case"keyup":sl(N,a,k)}var W;if(Wr)e:{switch(e){case"compositionstart":var D="onCompositionStart";break e;case"compositionend":D="onCompositionEnd";break e;case"compositionupdate":D="onCompositionUpdate";break e}D=void 0}else _n?_s(e,a)&&(D="onCompositionEnd"):e==="keydown"&&a.keyCode===229&&(D="onCompositionStart");D&&(Vs&&a.locale!=="ko"&&(_n||D!=="onCompositionStart"?D==="onCompositionEnd"&&_n&&(W=Ks()):($e=k,vr="value"in $e?$e.value:$e.textContent,_n=!0)),v=xi(d,D),0<v.length&&(D=new Qs(D,e,null,a,k),N.push({event:D,listeners:v}),W?D.data=W:(W=qs(a),W!==null&&(D.data=W)))),(W=Gh?Rh(e,a):Dh(e,a))&&(d=xi(d,"onBeforeInput"),0<d.length&&(k=new Qs("onBeforeInput","beforeinput",null,a,k),N.push({event:k,listeners:d}),k.data=W))}$s(N,n)})}function Va(e,n,a){return{instance:e,listener:n,currentTarget:a}}function xi(e,n){for(var a=n+"Capture",i=[];e!==null;){var t=e,r=t.stateNode;t.tag===5&&r!==null&&(t=r,r=Ba(e,a),r!=null&&i.unshift(Va(e,r,t)),r=Ba(e,n),r!=null&&i.push(Va(e,r,t))),e=e.return}return i}function Xn(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function fl(e,n,a,i,t){for(var r=n._reactName,o=[];a!==null&&a!==i;){var s=a,l=s.alternate,d=s.stateNode;if(l!==null&&l===i)break;s.tag===5&&d!==null&&(s=d,t?(l=Ba(a,r),l!=null&&o.unshift(Va(a,l,s))):t||(l=Ba(a,r),l!=null&&o.push(Va(a,l,s)))),a=a.return}o.length!==0&&e.push({event:n,listeners:o})}function Ji(){}var Dr=null,Ur=null;function Sl(e,n){switch(e){case"button":case"input":case"select":case"textarea":return!!n.autoFocus}return!1}function Lr(e,n){return e==="textarea"||e==="option"||e==="noscript"||typeof n.children=="string"||typeof n.children=="number"||typeof n.dangerouslySetInnerHTML=="object"&&n.dangerouslySetInnerHTML!==null&&n.dangerouslySetInnerHTML.__html!=null}var yl=typeof setTimeout=="function"?setTimeout:void 0,Vh=typeof clearTimeout=="function"?clearTimeout:void 0;function Fr(e){e.nodeType===1?e.textContent="":e.nodeType===9&&(e=e.body,e!=null&&(e.textContent=""))}function ea(e){for(;e!=null;e=e.nextSibling){var n=e.nodeType;if(n===1||n===3)break}return e}function kl(e){e=e.previousSibling;for(var n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="$"||a==="$!"||a==="$?"){if(n===0)return e;n--}else a==="/$"&&n++}e=e.previousSibling}return null}var Hr=0;function Jh(e){return{$$typeof:Vt,toString:e,valueOf:e}}var zi=Math.random().toString(36).slice(2),en="__reactFiber$"+zi,_i="__reactProps$"+zi,$n="__reactContainer$"+zi,Tl="__reactEvents$"+zi;function En(e){var n=e[en];if(n)return n;for(var a=e.parentNode;a;){if(n=a[$n]||a[en]){if(a=n.alternate,n.child!==null||a!==null&&a.child!==null)for(e=kl(e);e!==null;){if(a=e[en])return a;e=kl(e)}return n}e=a,a=e.parentNode}return null}function Wa(e){return e=e[en]||e[$n],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function qn(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(T(33))}function Bi(e){return e[_i]||null}function cl(e){var n=e[Tl];return n===void 0&&(n=e[Tl]=new Set),n}var br=[],na=-1;function nn(e){return{current:e}}function J(e){0>na||(e.current=br[na],br[na]=null,na--)}function q(e,n){na++,br[na]=e.current,e.current=n}var an={},ce=nn(an),ke=nn(!1),wn=an;function aa(e,n){var a=e.type.contextTypes;if(!a)return an;var i=e.stateNode;if(i&&i.__reactInternalMemoizedUnmaskedChildContext===n)return i.__reactInternalMemoizedMaskedChildContext;var t={},r;for(r in a)t[r]=n[r];return i&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=t),t}function Te(e){return e=e.childContextTypes,e!=null}function qi(){J(ke),J(ce)}function Al(e,n,a){if(ce.current!==an)throw Error(T(168));q(ce,n),q(ke,a)}function Il(e,n,a){var i=e.stateNode;if(e=n.childContextTypes,typeof i.getChildContext!="function")return a;i=i.getChildContext();for(var t in i)if(!(t in e))throw Error(T(108,bn(n)||"Unknown",t));return Y({},a,i)}function Zi(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||an,wn=ce.current,q(ce,e),q(ke,ke.current),!0}function vl(e,n,a){var i=e.stateNode;if(!i)throw Error(T(169));a?(e=Il(e,n,wn),i.__reactInternalMemoizedMergedChildContext=e,J(ke),J(ce),q(ce,e)):J(ke),q(ke,a)}var Kr=null,Cn=null,zh=ne.unstable_runWithPriority,Yr=ne.unstable_scheduleCallback,xr=ne.unstable_cancelCallback,_h=ne.unstable_shouldYield,El=ne.unstable_requestPaint,Qr=ne.unstable_now,qh=ne.unstable_getCurrentPriorityLevel,Xi=ne.unstable_ImmediatePriority,wl=ne.unstable_UserBlockingPriority,Cl=ne.unstable_NormalPriority,Ml=ne.unstable_LowPriority,Ol=ne.unstable_IdlePriority,jr={},Zh=El!==void 0?El:function(){},Ke=null,$i=null,Vr=!1,Wl=Qr(),ge=1e4>Wl?Qr:function(){return Qr()-Wl};function ia(){switch(qh()){case Xi:return 99;case wl:return 98;case Cl:return 97;case Ml:return 96;case Ol:return 95;default:throw Error(T(332))}}function Bl(e){switch(e){case 99:return Xi;case 98:return wl;case 97:return Cl;case 96:return Ml;case 95:return Ol;default:throw Error(T(332))}}function Mn(e,n){return e=Bl(e),zh(e,n)}function Ja(e,n,a){return e=Bl(e),Yr(e,n,a)}function De(){if($i!==null){var e=$i;$i=null,xr(e)}Nl()}function Nl(){if(!Vr&&Ke!==null){Vr=!0;var e=0;try{var n=Ke;Mn(99,function(){for(;e<n.length;e++){var a=n[e];do a=a(!0);while(a!==null)}}),Ke=null}catch(a){throw Ke!==null&&(Ke=Ke.slice(e+1)),Yr(Xi,De),a}finally{Vr=!1}}}var Xh=Tn.ReactCurrentBatchConfig;function Pe(e,n){if(e&&e.defaultProps){n=Y({},n),e=e.defaultProps;for(var a in e)n[a]===void 0&&(n[a]=e[a]);return n}return n}var et=nn(null),nt=null,ta=null,at=null;function Jr(){at=ta=nt=null}function zr(e){var n=et.current;J(et),e.type._context._currentValue=n}function Pl(e,n){for(;e!==null;){var a=e.alternate;if((e.childLanes&n)===n){if(a===null||(a.childLanes&n)===n)break;a.childLanes|=n}else e.childLanes|=n,a!==null&&(a.childLanes|=n);e=e.return}}function ra(e,n){nt=e,at=ta=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&n)!=0&&(Ge=!0),e.firstContext=null)}function Me(e,n){if(at!==e&&n!==!1&&n!==0)if((typeof n!="number"||n===1073741823)&&(at=e,n=1073741823),n={context:e,observedBits:n,next:null},ta===null){if(nt===null)throw Error(T(308));ta=n,nt.dependencies={lanes:0,firstContext:n,responders:null}}else ta=ta.next=n;return e._currentValue}var tn=!1;function _r(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null},effects:null}}function Gl(e,n){e=e.updateQueue,n.updateQueue===e&&(n.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function rn(e,n){return{eventTime:e,lane:n,tag:0,payload:null,callback:null,next:null}}function on(e,n){if(e=e.updateQueue,e!==null){e=e.shared;var a=e.pending;a===null?n.next=n:(n.next=a.next,a.next=n),e.pending=n}}function Rl(e,n){var a=e.updateQueue,i=e.alternate;if(i!==null&&(i=i.updateQueue,a===i)){var t=null,r=null;if(a=a.firstBaseUpdate,a!==null){do{var o={eventTime:a.eventTime,lane:a.lane,tag:a.tag,payload:a.payload,callback:a.callback,next:null};r===null?t=r=o:r=r.next=o,a=a.next}while(a!==null);r===null?t=r=n:r=r.next=n}else t=r=n;a={baseState:i.baseState,firstBaseUpdate:t,lastBaseUpdate:r,shared:i.shared,effects:i.effects},e.updateQueue=a;return}e=a.lastBaseUpdate,e===null?a.firstBaseUpdate=n:e.next=n,a.lastBaseUpdate=n}function _a(e,n,a,i){var t=e.updateQueue;tn=!1;var r=t.firstBaseUpdate,o=t.lastBaseUpdate,s=t.shared.pending;if(s!==null){t.shared.pending=null;var l=s,d=l.next;l.next=null,o===null?r=d:o.next=d,o=l;var k=e.alternate;if(k!==null){k=k.updateQueue;var N=k.lastBaseUpdate;N!==o&&(N===null?k.firstBaseUpdate=d:N.next=d,k.lastBaseUpdate=l)}}if(r!==null){N=t.baseState,o=0,k=d=l=null;do{s=r.lane;var f=r.eventTime;if((i&s)===s){k!==null&&(k=k.next={eventTime:f,lane:0,tag:r.tag,payload:r.payload,callback:r.callback,next:null});e:{var w=e,P=r;switch(s=n,f=a,P.tag){case 1:if(w=P.payload,typeof w=="function"){N=w.call(f,N,s);break e}N=w;break e;case 3:w.flags=w.flags&-4097|64;case 0:if(w=P.payload,s=typeof w=="function"?w.call(f,N,s):w,s==null)break e;N=Y({},N,s);break e;case 2:tn=!0}}r.callback!==null&&(e.flags|=32,s=t.effects,s===null?t.effects=[r]:s.push(r))}else f={eventTime:f,lane:s,tag:r.tag,payload:r.payload,callback:r.callback,next:null},k===null?(d=k=f,l=N):k=k.next=f,o|=s;if(r=r.next,r===null){if(s=t.shared.pending,s===null)break;r=s.next,s.next=null,t.lastBaseUpdate=s,t.shared.pending=null}}while(1);k===null&&(l=N),t.baseState=l,t.firstBaseUpdate=d,t.lastBaseUpdate=k,za|=o,e.lanes=o,e.memoizedState=N}}function Dl(e,n,a){if(e=n.effects,n.effects=null,e!==null)for(n=0;n<e.length;n++){var i=e[n],t=i.callback;if(t!==null){if(i.callback=null,i=a,typeof t!="function")throw Error(T(191,t));t.call(i)}}}var Ul=new b.Component().refs;function it(e,n,a,i){n=e.memoizedState,a=a(i,n),a=a==null?n:Y({},n,a),e.memoizedState=a,e.lanes===0&&(e.updateQueue.baseState=a)}var tt={isMounted:function(e){return(e=e._reactInternals)?vn(e)===e:!1},enqueueSetState:function(e,n,a){e=e._reactInternals;var i=we(),t=sn(e),r=rn(i,t);r.payload=n,a!=null&&(r.callback=a),on(e,r),ln(e,t,i)},enqueueReplaceState:function(e,n,a){e=e._reactInternals;var i=we(),t=sn(e),r=rn(i,t);r.tag=1,r.payload=n,a!=null&&(r.callback=a),on(e,r),ln(e,t,i)},enqueueForceUpdate:function(e,n){e=e._reactInternals;var a=we(),i=sn(e),t=rn(a,i);t.tag=2,n!=null&&(t.callback=n),on(e,t),ln(e,i,a)}};function Ll(e,n,a,i,t,r,o){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(i,r,o):n.prototype&&n.prototype.isPureReactComponent?!xa(a,i)||!xa(t,r):!0}function Fl(e,n,a){var i=!1,t=an,r=n.contextType;return typeof r=="object"&&r!==null?r=Me(r):(t=Te(n)?wn:ce.current,i=n.contextTypes,r=(i=i!=null)?aa(e,t):an),n=new n(a,r),e.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,n.updater=tt,e.stateNode=n,n._reactInternals=e,i&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=t,e.__reactInternalMemoizedMaskedChildContext=r),n}function Hl(e,n,a,i){e=n.state,typeof n.componentWillReceiveProps=="function"&&n.componentWillReceiveProps(a,i),typeof n.UNSAFE_componentWillReceiveProps=="function"&&n.UNSAFE_componentWillReceiveProps(a,i),n.state!==e&&tt.enqueueReplaceState(n,n.state,null)}function qr(e,n,a,i){var t=e.stateNode;t.props=a,t.state=e.memoizedState,t.refs=Ul,_r(e);var r=n.contextType;typeof r=="object"&&r!==null?t.context=Me(r):(r=Te(n)?wn:ce.current,t.context=aa(e,r)),_a(e,a,t,i),t.state=e.memoizedState,r=n.getDerivedStateFromProps,typeof r=="function"&&(it(e,n,r,a),t.state=e.memoizedState),typeof n.getDerivedStateFromProps=="function"||typeof t.getSnapshotBeforeUpdate=="function"||typeof t.UNSAFE_componentWillMount!="function"&&typeof t.componentWillMount!="function"||(n=t.state,typeof t.componentWillMount=="function"&&t.componentWillMount(),typeof t.UNSAFE_componentWillMount=="function"&&t.UNSAFE_componentWillMount(),n!==t.state&&tt.enqueueReplaceState(t,t.state,null),_a(e,a,t,i),t.state=e.memoizedState),typeof t.componentDidMount=="function"&&(e.flags|=4)}var rt=Array.isArray;function qa(e,n,a){if(e=a.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(a._owner){if(a=a._owner,a){if(a.tag!==1)throw Error(T(309));var i=a.stateNode}if(!i)throw Error(T(147,e));var t=""+e;return n!==null&&n.ref!==null&&typeof n.ref=="function"&&n.ref._stringRef===t?n.ref:(n=function(r){var o=i.refs;o===Ul&&(o=i.refs={}),r===null?delete o[t]:o[t]=r},n._stringRef=t,n)}if(typeof e!="string")throw Error(T(284));if(!a._owner)throw Error(T(290,e))}return e}function ot(e,n){if(e.type!=="textarea")throw Error(T(31,Object.prototype.toString.call(n)==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":n))}function bl(e){function n(c,u){if(e){var h=c.lastEffect;h!==null?(h.nextEffect=u,c.lastEffect=u):c.firstEffect=c.lastEffect=u,u.nextEffect=null,u.flags=8}}function a(c,u){if(!e)return null;for(;u!==null;)n(c,u),u=u.sibling;return null}function i(c,u){for(c=new Map;u!==null;)u.key!==null?c.set(u.key,u):c.set(u.index,u),u=u.sibling;return c}function t(c,u){return c=un(c,u),c.index=0,c.sibling=null,c}function r(c,u,h){return c.index=h,e?(h=c.alternate,h!==null?(h=h.index,h<u?(c.flags=2,u):h):(c.flags=2,u)):u}function o(c){return e&&c.alternate===null&&(c.flags=2),c}function s(c,u,h,m){return u===null||u.tag!==6?(u=Zr(h,c.mode,m),u.return=c,u):(u=t(u,h),u.return=c,u)}function l(c,u,h,m){return u!==null&&u.elementType===h.type?(m=t(u,h.props),m.ref=qa(c,u,h),m.return=c,m):(m=st(h.type,h.key,h.props,null,c.mode,m),m.ref=qa(c,u,h),m.return=c,m)}function d(c,u,h,m){return u===null||u.tag!==4||u.stateNode.containerInfo!==h.containerInfo||u.stateNode.implementation!==h.implementation?(u=Xr(h,c.mode,m),u.return=c,u):(u=t(u,h.children||[]),u.return=c,u)}function k(c,u,h,m,p){return u===null||u.tag!==7?(u=oa(h,c.mode,m,p),u.return=c,u):(u=t(u,h),u.return=c,u)}function N(c,u,h){if(typeof u=="string"||typeof u=="number")return u=Zr(""+u,c.mode,h),u.return=c,u;if(typeof u=="object"&&u!==null){switch(u.$$typeof){case Ia:return h=st(u.type,u.key,u.props,null,c.mode,h),h.ref=qa(c,null,u),h.return=c,h;case An:return u=Xr(u,c.mode,h),u.return=c,u}if(rt(u)||wa(u))return u=oa(u,c.mode,h,null),u.return=c,u;ot(c,u)}return null}function f(c,u,h,m){var p=u!==null?u.key:null;if(typeof h=="string"||typeof h=="number")return p!==null?null:s(c,u,""+h,m);if(typeof h=="object"&&h!==null){switch(h.$$typeof){case Ia:return h.key===p?h.type===Je?k(c,u,h.props.children,m,p):l(c,u,h,m):null;case An:return h.key===p?d(c,u,h,m):null}if(rt(h)||wa(h))return p!==null?null:k(c,u,h,m,null);ot(c,h)}return null}function w(c,u,h,m,p){if(typeof m=="string"||typeof m=="number")return c=c.get(h)||null,s(u,c,""+m,p);if(typeof m=="object"&&m!==null){switch(m.$$typeof){case Ia:return c=c.get(m.key===null?h:m.key)||null,m.type===Je?k(u,c,m.props.children,p,m.key):l(u,c,m,p);case An:return c=c.get(m.key===null?h:m.key)||null,d(u,c,m,p)}if(rt(m)||wa(m))return c=c.get(h)||null,k(u,c,m,p,null);ot(u,m)}return null}function P(c,u,h,m){for(var p=null,G=null,v=u,W=u=0,D=null;v!==null&&W<h.length;W++){v.index>W?(D=v,v=null):D=v.sibling;var R=f(c,v,h[W],m);if(R===null){v===null&&(v=D);break}e&&v&&R.alternate===null&&n(c,v),u=r(R,u,W),G===null?p=R:G.sibling=R,G=R,v=D}if(W===h.length)return a(c,v),p;if(v===null){for(;W<h.length;W++)v=N(c,h[W],m),v!==null&&(u=r(v,u,W),G===null?p=v:G.sibling=v,G=v);return p}for(v=i(c,v);W<h.length;W++)D=w(v,c,W,h[W],m),D!==null&&(e&&D.alternate!==null&&v.delete(D.key===null?W:D.key),u=r(D,u,W),G===null?p=D:G.sibling=D,G=D);return e&&v.forEach(function(_){return n(c,_)}),p}function O(c,u,h,m){var p=wa(h);if(typeof p!="function")throw Error(T(150));if(h=p.call(h),h==null)throw Error(T(151));for(var G=p=null,v=u,W=u=0,D=null,R=h.next();v!==null&&!R.done;W++,R=h.next()){v.index>W?(D=v,v=null):D=v.sibling;var _=f(c,v,R.value,m);if(_===null){v===null&&(v=D);break}e&&v&&_.alternate===null&&n(c,v),u=r(_,u,W),G===null?p=_:G.sibling=_,G=_,v=D}if(R.done)return a(c,v),p;if(v===null){for(;!R.done;W++,R=h.next())R=N(c,R.value,m),R!==null&&(u=r(R,u,W),G===null?p=R:G.sibling=R,G=R);return p}for(v=i(c,v);!R.done;W++,R=h.next())R=w(v,c,W,R.value,m),R!==null&&(e&&R.alternate!==null&&v.delete(R.key===null?W:R.key),u=r(R,u,W),G===null?p=R:G.sibling=R,G=R);return e&&v.forEach(function(ye){return n(c,ye)}),p}return function(c,u,h,m){var p=typeof h=="object"&&h!==null&&h.type===Je&&h.key===null;p&&(h=h.props.children);var G=typeof h=="object"&&h!==null;if(G)switch(h.$$typeof){case Ia:e:{for(G=h.key,p=u;p!==null;){if(p.key===G){switch(p.tag){case 7:if(h.type===Je){a(c,p.sibling),u=t(p,h.props.children),u.return=c,c=u;break e}break;default:if(p.elementType===h.type){a(c,p.sibling),u=t(p,h.props),u.ref=qa(c,p,h),u.return=c,c=u;break e}}a(c,p);break}else n(c,p);p=p.sibling}h.type===Je?(u=oa(h.props.children,c.mode,m,h.key),u.return=c,c=u):(m=st(h.type,h.key,h.props,null,c.mode,m),m.ref=qa(c,u,h),m.return=c,c=m)}return o(c);case An:e:{for(p=h.key;u!==null;){if(u.key===p)if(u.tag===4&&u.stateNode.containerInfo===h.containerInfo&&u.stateNode.implementation===h.implementation){a(c,u.sibling),u=t(u,h.children||[]),u.return=c,c=u;break e}else{a(c,u);break}else n(c,u);u=u.sibling}u=Xr(h,c.mode,m),u.return=c,c=u}return o(c)}if(typeof h=="string"||typeof h=="number")return h=""+h,u!==null&&u.tag===6?(a(c,u.sibling),u=t(u,h),u.return=c,c=u):(a(c,u),u=Zr(h,c.mode,m),u.return=c,c=u),o(c);if(rt(h))return P(c,u,h,m);if(wa(h))return O(c,u,h,m);if(G&&ot(c,h),typeof h=="undefined"&&!p)switch(c.tag){case 1:case 22:case 0:case 11:case 15:throw Error(T(152,bn(c.type)||"Component"))}return a(c,u)}}var lt=bl(!0),Kl=bl(!1),Za={},Ue=nn(Za),Xa=nn(Za),$a=nn(Za);function On(e){if(e===Za)throw Error(T(174));return e}function $r(e,n){switch(q($a,n),q(Xa,e),q(Ue,Za),e=n.nodeType,e){case 9:case 11:n=(n=n.documentElement)?n.namespaceURI:ir(null,"");break;default:e=e===8?n.parentNode:n,n=e.namespaceURI||null,e=e.tagName,n=ir(n,e)}J(Ue),q(Ue,n)}function sa(){J(Ue),J(Xa),J($a)}function Yl(e){On($a.current);var n=On(Ue.current),a=ir(n,e.type);n!==a&&(q(Xa,e),q(Ue,a))}function eo(e){Xa.current===e&&(J(Ue),J(Xa))}var Z=nn(0);function ut(e){for(var n=e;n!==null;){if(n.tag===13){var a=n.memoizedState;if(a!==null&&(a=a.dehydrated,a===null||a.data==="$?"||a.data==="$!"))return n}else if(n.tag===19&&n.memoizedProps.revealOrder!==void 0){if((n.flags&64)!=0)return n}else if(n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}return null}var Ye=null,dn=null,Le=!1;function xl(e,n){var a=Oe(5,null,null,0);a.elementType="DELETED",a.type="DELETED",a.stateNode=n,a.return=e,a.flags=8,e.lastEffect!==null?(e.lastEffect.nextEffect=a,e.lastEffect=a):e.firstEffect=e.lastEffect=a}function Ql(e,n){switch(e.tag){case 5:var a=e.type;return n=n.nodeType!==1||a.toLowerCase()!==n.nodeName.toLowerCase()?null:n,n!==null?(e.stateNode=n,!0):!1;case 6:return n=e.pendingProps===""||n.nodeType!==3?null:n,n!==null?(e.stateNode=n,!0):!1;case 13:return!1;default:return!1}}function no(e){if(Le){var n=dn;if(n){var a=n;if(!Ql(e,n)){if(n=ea(a.nextSibling),!n||!Ql(e,n)){e.flags=e.flags&-1025|2,Le=!1,Ye=e;return}xl(Ye,a)}Ye=e,dn=ea(n.firstChild)}else e.flags=e.flags&-1025|2,Le=!1,Ye=e}}function jl(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;Ye=e}function dt(e){if(e!==Ye)return!1;if(!Le)return jl(e),Le=!0,!1;var n=e.type;if(e.tag!==5||n!=="head"&&n!=="body"&&!Lr(n,e.memoizedProps))for(n=dn;n;)xl(e,n),n=ea(n.nextSibling);if(jl(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(T(317));e:{for(e=e.nextSibling,n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="/$"){if(n===0){dn=ea(e.nextSibling);break e}n--}else a!=="$"&&a!=="$!"&&a!=="$?"||n++}e=e.nextSibling}dn=null}}else dn=Ye?ea(e.stateNode.nextSibling):null;return!0}function ao(){dn=Ye=null,Le=!1}var la=[];function io(){for(var e=0;e<la.length;e++)la[e]._workInProgressVersionPrimary=null;la.length=0}var ei=Tn.ReactCurrentDispatcher,We=Tn.ReactCurrentBatchConfig,ni=0,X=null,me=null,de=null,ht=!1,ai=!1;function Ae(){throw Error(T(321))}function to(e,n){if(n===null)return!1;for(var a=0;a<n.length&&a<e.length;a++)if(!Ce(e[a],n[a]))return!1;return!0}function ro(e,n,a,i,t,r){if(ni=r,X=n,n.memoizedState=null,n.updateQueue=null,n.lanes=0,ei.current=e===null||e.memoizedState===null?$h:ec,e=a(i,t),ai){r=0;do{if(ai=!1,!(25>r))throw Error(T(301));r+=1,de=me=null,n.updateQueue=null,ei.current=nc,e=a(i,t)}while(ai)}if(ei.current=ct,n=me!==null&&me.next!==null,ni=0,de=me=X=null,ht=!1,n)throw Error(T(300));return e}function Wn(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return de===null?X.memoizedState=de=e:de=de.next=e,de}function Bn(){if(me===null){var e=X.alternate;e=e!==null?e.memoizedState:null}else e=me.next;var n=de===null?X.memoizedState:de.next;if(n!==null)de=n,me=e;else{if(e===null)throw Error(T(310));me=e,e={memoizedState:me.memoizedState,baseState:me.baseState,baseQueue:me.baseQueue,queue:me.queue,next:null},de===null?X.memoizedState=de=e:de=de.next=e}return de}function Fe(e,n){return typeof n=="function"?n(e):n}function ii(e){var n=Bn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var i=me,t=i.baseQueue,r=a.pending;if(r!==null){if(t!==null){var o=t.next;t.next=r.next,r.next=o}i.baseQueue=t=r,a.pending=null}if(t!==null){t=t.next,i=i.baseState;var s=o=r=null,l=t;do{var d=l.lane;if((ni&d)===d)s!==null&&(s=s.next={lane:0,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null}),i=l.eagerReducer===e?l.eagerState:e(i,l.action);else{var k={lane:d,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null};s===null?(o=s=k,r=i):s=s.next=k,X.lanes|=d,za|=d}l=l.next}while(l!==null&&l!==t);s===null?r=i:s.next=o,Ce(i,n.memoizedState)||(Ge=!0),n.memoizedState=i,n.baseState=r,n.baseQueue=s,a.lastRenderedState=i}return[n.memoizedState,a.dispatch]}function ti(e){var n=Bn(),a=n.queue;if(a===null)throw Error(T(311));a.lastRenderedReducer=e;var i=a.dispatch,t=a.pending,r=n.memoizedState;if(t!==null){a.pending=null;var o=t=t.next;do r=e(r,o.action),o=o.next;while(o!==t);Ce(r,n.memoizedState)||(Ge=!0),n.memoizedState=r,n.baseQueue===null&&(n.baseState=r),a.lastRenderedState=r}return[r,i]}function Vl(e,n,a){var i=n._getVersion;i=i(n._source);var t=n._workInProgressVersionPrimary;if(t!==null?e=t===i:(e=e.mutableReadLanes,(e=(ni&e)===e)&&(n._workInProgressVersionPrimary=i,la.push(n))),e)return a(n._source);throw la.push(n),Error(T(350))}function Jl(e,n,a,i){var t=Se;if(t===null)throw Error(T(349));var r=n._getVersion,o=r(n._source),s=ei.current,l=s.useState(function(){return Vl(t,n,a)}),d=l[1],k=l[0];l=de;var N=e.memoizedState,f=N.refs,w=f.getSnapshot,P=N.source;N=N.subscribe;var O=X;return e.memoizedState={refs:f,source:n,subscribe:i},s.useEffect(function(){f.getSnapshot=a,f.setSnapshot=d;var c=r(n._source);if(!Ce(o,c)){c=a(n._source),Ce(k,c)||(d(c),c=sn(O),t.mutableReadLanes|=c&t.pendingLanes),c=t.mutableReadLanes,t.entangledLanes|=c;for(var u=t.entanglements,h=c;0<h;){var m=31-Xe(h),p=1<<m;u[m]|=c,h&=~p}}},[a,n,i]),s.useEffect(function(){return i(n._source,function(){var c=f.getSnapshot,u=f.setSnapshot;try{u(c(n._source));var h=sn(O);t.mutableReadLanes|=h&t.pendingLanes}catch(m){u(function(){throw m})}})},[n,i]),Ce(w,a)&&Ce(P,n)&&Ce(N,i)||(e={pending:null,dispatch:null,lastRenderedReducer:Fe,lastRenderedState:k},e.dispatch=d=oo.bind(null,X,e),l.queue=e,l.baseQueue=null,k=Vl(t,n,a),l.memoizedState=l.baseState=k),k}function zl(e,n,a){var i=Bn();return Jl(i,e,n,a)}function ri(e){var n=Wn();return typeof e=="function"&&(e=e()),n.memoizedState=n.baseState=e,e=n.queue={pending:null,dispatch:null,lastRenderedReducer:Fe,lastRenderedState:e},e=e.dispatch=oo.bind(null,X,e),[n.memoizedState,e]}function gt(e,n,a,i){return e={tag:e,create:n,destroy:a,deps:i,next:null},n=X.updateQueue,n===null?(n={lastEffect:null},X.updateQueue=n,n.lastEffect=e.next=e):(a=n.lastEffect,a===null?n.lastEffect=e.next=e:(i=a.next,a.next=e,e.next=i,n.lastEffect=e)),e}function _l(e){var n=Wn();return e={current:e},n.memoizedState=e}function mt(){return Bn().memoizedState}function so(e,n,a,i){var t=Wn();X.flags|=e,t.memoizedState=gt(1|n,a,void 0,i===void 0?null:i)}function lo(e,n,a,i){var t=Bn();i=i===void 0?null:i;var r=void 0;if(me!==null){var o=me.memoizedState;if(r=o.destroy,i!==null&&to(i,o.deps)){gt(n,a,r,i);return}}X.flags|=e,t.memoizedState=gt(1|n,a,r,i)}function ql(e,n){return so(516,4,e,n)}function pt(e,n){return lo(516,4,e,n)}function Zl(e,n){return lo(4,2,e,n)}function Xl(e,n){if(typeof n=="function")return e=e(),n(e),function(){n(null)};if(n!=null)return e=e(),n.current=e,function(){n.current=null}}function $l(e,n,a){return a=a!=null?a.concat([e]):null,lo(4,2,Xl.bind(null,n,e),a)}function uo(){}function eu(e,n){var a=Bn();n=n===void 0?null:n;var i=a.memoizedState;return i!==null&&n!==null&&to(n,i[1])?i[0]:(a.memoizedState=[e,n],e)}function nu(e,n){var a=Bn();n=n===void 0?null:n;var i=a.memoizedState;return i!==null&&n!==null&&to(n,i[1])?i[0]:(e=e(),a.memoizedState=[e,n],e)}function ac(e,n){var a=ia();Mn(98>a?98:a,function(){e(!0)}),Mn(97<a?97:a,function(){var i=We.transition;We.transition=1;try{e(!1),n()}finally{We.transition=i}})}function oo(e,n,a){var i=we(),t=sn(e),r={lane:t,action:a,eagerReducer:null,eagerState:null,next:null},o=n.pending;if(o===null?r.next=r:(r.next=o.next,o.next=r),n.pending=r,o=e.alternate,e===X||o!==null&&o===X)ai=ht=!0;else{if(e.lanes===0&&(o===null||o.lanes===0)&&(o=n.lastRenderedReducer,o!==null))try{var s=n.lastRenderedState,l=o(s,a);if(r.eagerReducer=o,r.eagerState=l,Ce(l,s))return}catch(d){}finally{}ln(e,t,i)}}var ct={readContext:Me,useCallback:Ae,useContext:Ae,useEffect:Ae,useImperativeHandle:Ae,useLayoutEffect:Ae,useMemo:Ae,useReducer:Ae,useRef:Ae,useState:Ae,useDebugValue:Ae,useDeferredValue:Ae,useTransition:Ae,useMutableSource:Ae,useOpaqueIdentifier:Ae,unstable_isNewReconciler:!1},$h={readContext:Me,useCallback:function(e,n){return Wn().memoizedState=[e,n===void 0?null:n],e},useContext:Me,useEffect:ql,useImperativeHandle:function(e,n,a){return a=a!=null?a.concat([e]):null,so(4,2,Xl.bind(null,n,e),a)},useLayoutEffect:function(e,n){return so(4,2,e,n)},useMemo:function(e,n){var a=Wn();return n=n===void 0?null:n,e=e(),a.memoizedState=[e,n],e},useReducer:function(e,n,a){var i=Wn();return n=a!==void 0?a(n):n,i.memoizedState=i.baseState=n,e=i.queue={pending:null,dispatch:null,lastRenderedReducer:e,lastRenderedState:n},e=e.dispatch=oo.bind(null,X,e),[i.memoizedState,e]},useRef:_l,useState:ri,useDebugValue:uo,useDeferredValue:function(e){var n=ri(e),a=n[0],i=n[1];return ql(function(){var t=We.transition;We.transition=1;try{i(e)}finally{We.transition=t}},[e]),a},useTransition:function(){var e=ri(!1),n=e[0];return e=ac.bind(null,e[1]),_l(e),[e,n]},useMutableSource:function(e,n,a){var i=Wn();return i.memoizedState={refs:{getSnapshot:n,setSnapshot:null},source:e,subscribe:a},Jl(i,e,n,a)},useOpaqueIdentifier:function(){if(Le){var e=!1,n=Jh(function(){throw e||(e=!0,a("r:"+(Hr++).toString(36))),Error(T(355))}),a=ri(n)[1];return(X.mode&2)==0&&(X.flags|=516,gt(5,function(){a("r:"+(Hr++).toString(36))},void 0,null)),n}return n="r:"+(Hr++).toString(36),ri(n),n},unstable_isNewReconciler:!1},ec={readContext:Me,useCallback:eu,useContext:Me,useEffect:pt,useImperativeHandle:$l,useLayoutEffect:Zl,useMemo:nu,useReducer:ii,useRef:mt,useState:function(){return ii(Fe)},useDebugValue:uo,useDeferredValue:function(e){var n=ii(Fe),a=n[0],i=n[1];return pt(function(){var t=We.transition;We.transition=1;try{i(e)}finally{We.transition=t}},[e]),a},useTransition:function(){var e=ii(Fe)[0];return[mt().current,e]},useMutableSource:zl,useOpaqueIdentifier:function(){return ii(Fe)[0]},unstable_isNewReconciler:!1},nc={readContext:Me,useCallback:eu,useContext:Me,useEffect:pt,useImperativeHandle:$l,useLayoutEffect:Zl,useMemo:nu,useReducer:ti,useRef:mt,useState:function(){return ti(Fe)},useDebugValue:uo,useDeferredValue:function(e){var n=ti(Fe),a=n[0],i=n[1];return pt(function(){var t=We.transition;We.transition=1;try{i(e)}finally{We.transition=t}},[e]),a},useTransition:function(){var e=ti(Fe)[0];return[mt().current,e]},useMutableSource:zl,useOpaqueIdentifier:function(){return ti(Fe)[0]},unstable_isNewReconciler:!1},ic=Tn.ReactCurrentOwner,Ge=!1;function Ie(e,n,a,i){n.child=e===null?Kl(n,null,a,i):lt(n,e.child,a,i)}function au(e,n,a,i,t){a=a.render;var r=n.ref;return ra(n,t),i=ro(e,n,a,i,r,t),e!==null&&!Ge?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~t,xe(e,n,t)):(n.flags|=1,Ie(e,n,i,t),n.child)}function tu(e,n,a,i,t,r){if(e===null){var o=a.type;return typeof o=="function"&&!ho(o)&&o.defaultProps===void 0&&a.compare===null&&a.defaultProps===void 0?(n.tag=15,n.type=o,iu(e,n,o,i,t,r)):(e=st(a.type,null,i,n,n.mode,r),e.ref=n.ref,e.return=n,n.child=e)}return o=e.child,(t&r)==0&&(t=o.memoizedProps,a=a.compare,a=a!==null?a:xa,a(t,i)&&e.ref===n.ref)?xe(e,n,r):(n.flags|=1,e=un(o,i),e.ref=n.ref,e.return=n,n.child=e)}function iu(e,n,a,i,t,r){if(e!==null&&xa(e.memoizedProps,i)&&e.ref===n.ref)if(Ge=!1,(r&t)!=0)(e.flags&16384)!=0&&(Ge=!0);else return n.lanes=e.lanes,xe(e,n,r);return co(e,n,a,i,r)}function go(e,n,a){var i=n.pendingProps,t=i.children,r=e!==null?e.memoizedState:null;if(i.mode==="hidden"||i.mode==="unstable-defer-without-hiding")if((n.mode&4)==0)n.memoizedState={baseLanes:0},ft(n,a);else if((a&1073741824)!=0)n.memoizedState={baseLanes:0},ft(n,r!==null?r.baseLanes:a);else return e=r!==null?r.baseLanes|a:a,n.lanes=n.childLanes=1073741824,n.memoizedState={baseLanes:e},ft(n,e),null;else r!==null?(i=r.baseLanes|a,n.memoizedState=null):i=a,ft(n,i);return Ie(e,n,t,a),n.child}function ru(e,n){var a=n.ref;(e===null&&a!==null||e!==null&&e.ref!==a)&&(n.flags|=128)}function co(e,n,a,i,t){var r=Te(a)?wn:ce.current;return r=aa(n,r),ra(n,t),a=ro(e,n,a,i,r,t),e!==null&&!Ge?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~t,xe(e,n,t)):(n.flags|=1,Ie(e,n,a,t),n.child)}function ou(e,n,a,i,t){if(Te(a)){var r=!0;Zi(n)}else r=!1;if(ra(n,t),n.stateNode===null)e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),Fl(n,a,i),qr(n,a,i,t),i=!0;else if(e===null){var o=n.stateNode,s=n.memoizedProps;o.props=s;var l=o.context,d=a.contextType;typeof d=="object"&&d!==null?d=Me(d):(d=Te(a)?wn:ce.current,d=aa(n,d));var k=a.getDerivedStateFromProps,N=typeof k=="function"||typeof o.getSnapshotBeforeUpdate=="function";N||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==i||l!==d)&&Hl(n,o,i,d),tn=!1;var f=n.memoizedState;o.state=f,_a(n,i,o,t),l=n.memoizedState,s!==i||f!==l||ke.current||tn?(typeof k=="function"&&(it(n,a,k,i),l=n.memoizedState),(s=tn||Ll(n,a,s,i,f,l,d))?(N||typeof o.UNSAFE_componentWillMount!="function"&&typeof o.componentWillMount!="function"||(typeof o.componentWillMount=="function"&&o.componentWillMount(),typeof o.UNSAFE_componentWillMount=="function"&&o.UNSAFE_componentWillMount()),typeof o.componentDidMount=="function"&&(n.flags|=4)):(typeof o.componentDidMount=="function"&&(n.flags|=4),n.memoizedProps=i,n.memoizedState=l),o.props=i,o.state=l,o.context=d,i=s):(typeof o.componentDidMount=="function"&&(n.flags|=4),i=!1)}else{o=n.stateNode,Gl(e,n),s=n.memoizedProps,d=n.type===n.elementType?s:Pe(n.type,s),o.props=d,N=n.pendingProps,f=o.context,l=a.contextType,typeof l=="object"&&l!==null?l=Me(l):(l=Te(a)?wn:ce.current,l=aa(n,l));var w=a.getDerivedStateFromProps;(k=typeof w=="function"||typeof o.getSnapshotBeforeUpdate=="function")||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==N||f!==l)&&Hl(n,o,i,l),tn=!1,f=n.memoizedState,o.state=f,_a(n,i,o,t);var P=n.memoizedState;s!==N||f!==P||ke.current||tn?(typeof w=="function"&&(it(n,a,w,i),P=n.memoizedState),(d=tn||Ll(n,a,d,i,f,P,l))?(k||typeof o.UNSAFE_componentWillUpdate!="function"&&typeof o.componentWillUpdate!="function"||(typeof o.componentWillUpdate=="function"&&o.componentWillUpdate(i,P,l),typeof o.UNSAFE_componentWillUpdate=="function"&&o.UNSAFE_componentWillUpdate(i,P,l)),typeof o.componentDidUpdate=="function"&&(n.flags|=4),typeof o.getSnapshotBeforeUpdate=="function"&&(n.flags|=256)):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=256),n.memoizedProps=i,n.memoizedState=P),o.props=i,o.state=P,o.context=l,i=d):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=256),i=!1)}return mo(e,n,a,i,r,t)}function mo(e,n,a,i,t,r){ru(e,n);var o=(n.flags&64)!=0;if(!i&&!o)return t&&vl(n,a,!1),xe(e,n,r);i=n.stateNode,ic.current=n;var s=o&&typeof a.getDerivedStateFromError!="function"?null:i.render();return n.flags|=1,e!==null&&o?(n.child=lt(n,e.child,null,r),n.child=lt(n,null,s,r)):Ie(e,n,s,r),n.memoizedState=i.state,t&&vl(n,a,!0),n.child}function su(e){var n=e.stateNode;n.pendingContext?Al(e,n.pendingContext,n.pendingContext!==n.context):n.context&&Al(e,n.context,!1),$r(e,n.containerInfo)}var St={dehydrated:null,retryLane:0};function hu(e,n,a){var i=n.pendingProps,t=Z.current,r=!1,o;return(o=(n.flags&64)!=0)||(o=e!==null&&e.memoizedState===null?!1:(t&2)!=0),o?(r=!0,n.flags&=-65):e!==null&&e.memoizedState===null||i.fallback===void 0||i.unstable_avoidThisFallback===!0||(t|=1),q(Z,t&1),e===null?(i.fallback!==void 0&&no(n),e=i.children,t=i.fallback,r?(e=lu(n,e,t,a),n.child.memoizedState={baseLanes:a},n.memoizedState=St,e):typeof i.unstable_expectedLoadTime=="number"?(e=lu(n,e,t,a),n.child.memoizedState={baseLanes:a},n.memoizedState=St,n.lanes=33554432,e):(a=po({mode:"visible",children:e},n.mode,a,null),a.return=n,n.child=a)):e.memoizedState!==null?r?(i=du(e,n,i.children,i.fallback,a),r=n.child,t=e.child.memoizedState,r.memoizedState=t===null?{baseLanes:a}:{baseLanes:t.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=St,i):(a=uu(e,n,i.children,a),n.memoizedState=null,a):r?(i=du(e,n,i.children,i.fallback,a),r=n.child,t=e.child.memoizedState,r.memoizedState=t===null?{baseLanes:a}:{baseLanes:t.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=St,i):(a=uu(e,n,i.children,a),n.memoizedState=null,a)}function lu(e,n,a,i){var t=e.mode,r=e.child;return n={mode:"hidden",children:n},(t&2)==0&&r!==null?(r.childLanes=0,r.pendingProps=n):r=po(n,t,0,null),a=oa(a,t,i,null),r.return=e,a.return=e,r.sibling=a,e.child=r,a}function uu(e,n,a,i){var t=e.child;return e=t.sibling,a=un(t,{mode:"visible",children:a}),(n.mode&2)==0&&(a.lanes=i),a.return=n,a.sibling=null,e!==null&&(e.nextEffect=null,e.flags=8,n.firstEffect=n.lastEffect=e),n.child=a}function du(e,n,a,i,t){var r=n.mode,o=e.child;e=o.sibling;var s={mode:"hidden",children:a};return(r&2)==0&&n.child!==o?(a=n.child,a.childLanes=0,a.pendingProps=s,o=a.lastEffect,o!==null?(n.firstEffect=a.firstEffect,n.lastEffect=o,o.nextEffect=null):n.firstEffect=n.lastEffect=null):a=un(o,s),e!==null?i=un(e,i):(i=oa(i,r,t,null),i.flags|=2),i.return=n,a.return=n,a.sibling=i,n.child=a,i}function cu(e,n){e.lanes|=n;var a=e.alternate;a!==null&&(a.lanes|=n),Pl(e.return,n)}function fo(e,n,a,i,t,r){var o=e.memoizedState;o===null?e.memoizedState={isBackwards:n,rendering:null,renderingStartTime:0,last:i,tail:a,tailMode:t,lastEffect:r}:(o.isBackwards=n,o.rendering=null,o.renderingStartTime=0,o.last=i,o.tail=a,o.tailMode=t,o.lastEffect=r)}function gu(e,n,a){var i=n.pendingProps,t=i.revealOrder,r=i.tail;if(Ie(e,n,i.children,a),i=Z.current,(i&2)!=0)i=i&1|2,n.flags|=64;else{if(e!==null&&(e.flags&64)!=0)e:for(e=n.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&cu(e,a);else if(e.tag===19)cu(e,a);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===n)break e;for(;e.sibling===null;){if(e.return===null||e.return===n)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}i&=1}if(q(Z,i),(n.mode&2)==0)n.memoizedState=null;else switch(t){case"forwards":for(a=n.child,t=null;a!==null;)e=a.alternate,e!==null&&ut(e)===null&&(t=a),a=a.sibling;a=t,a===null?(t=n.child,n.child=null):(t=a.sibling,a.sibling=null),fo(n,!1,t,a,r,n.lastEffect);break;case"backwards":for(a=null,t=n.child,n.child=null;t!==null;){if(e=t.alternate,e!==null&&ut(e)===null){n.child=t;break}e=t.sibling,t.sibling=a,a=t,t=e}fo(n,!0,a,null,r,n.lastEffect);break;case"together":fo(n,!1,null,null,void 0,n.lastEffect);break;default:n.memoizedState=null}return n.child}function xe(e,n,a){if(e!==null&&(n.dependencies=e.dependencies),za|=n.lanes,(a&n.childLanes)!=0){if(e!==null&&n.child!==e.child)throw Error(T(153));if(n.child!==null){for(e=n.child,a=un(e,e.pendingProps),n.child=a,a.return=n;e.sibling!==null;)e=e.sibling,a=a.sibling=un(e,e.pendingProps),a.return=n;a.sibling=null}return n.child}return null}var mu,So,pu,fu;mu=function(e,n){for(var a=n.child;a!==null;){if(a.tag===5||a.tag===6)e.appendChild(a.stateNode);else if(a.tag!==4&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return}a.sibling.return=a.return,a=a.sibling}};So=function(){};pu=function(e,n,a,i){var t=e.memoizedProps;if(t!==i){e=n.stateNode,On(Ue.current);var r=null;switch(a){case"input":t=Zt(e,t),i=Zt(e,i),r=[];break;case"option":t=er(e,t),i=er(e,i),r=[];break;case"select":t=Y({},t,{value:void 0}),i=Y({},i,{value:void 0}),r=[];break;case"textarea":t=nr(e,t),i=nr(e,i),r=[];break;default:typeof t.onClick!="function"&&typeof i.onClick=="function"&&(e.onclick=Ji)}tr(a,i);var o;a=null;for(d in t)if(!i.hasOwnProperty(d)&&t.hasOwnProperty(d)&&t[d]!=null)if(d==="style"){var s=t[d];for(o in s)s.hasOwnProperty(o)&&(a||(a={}),a[o]="")}else d!=="dangerouslySetInnerHTML"&&d!=="children"&&d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&d!=="autoFocus"&&(Aa.hasOwnProperty(d)?r||(r=[]):(r=r||[]).push(d,null));for(d in i){var l=i[d];if(s=t!=null?t[d]:void 0,i.hasOwnProperty(d)&&l!==s&&(l!=null||s!=null))if(d==="style")if(s){for(o in s)!s.hasOwnProperty(o)||l&&l.hasOwnProperty(o)||(a||(a={}),a[o]="");for(o in l)l.hasOwnProperty(o)&&s[o]!==l[o]&&(a||(a={}),a[o]=l[o])}else a||(r||(r=[]),r.push(d,a)),a=l;else d==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,s=s?s.__html:void 0,l!=null&&s!==l&&(r=r||[]).push(d,l)):d==="children"?typeof l!="string"&&typeof l!="number"||(r=r||[]).push(d,""+l):d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&(Aa.hasOwnProperty(d)?(l!=null&&d==="onScroll"&&V("scroll",e),r||s===l||(r=[])):typeof l=="object"&&l!==null&&l.$$typeof===Vt?l.toString():(r=r||[]).push(d,l))}a&&(r=r||[]).push("style",a);var d=r;(n.updateQueue=d)&&(n.flags|=4)}};fu=function(e,n,a,i){a!==i&&(n.flags|=4)};function oi(e,n){if(!Le)switch(e.tailMode){case"hidden":n=e.tail;for(var a=null;n!==null;)n.alternate!==null&&(a=n),n=n.sibling;a===null?e.tail=null:a.sibling=null;break;case"collapsed":a=e.tail;for(var i=null;a!==null;)a.alternate!==null&&(i=a),a=a.sibling;i===null?n||e.tail===null?e.tail=null:e.tail.sibling=null:i.sibling=null}}function tc(e,n,a){var i=n.pendingProps;switch(n.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return null;case 1:return Te(n.type)&&qi(),null;case 3:return sa(),J(ke),J(ce),io(),i=n.stateNode,i.pendingContext&&(i.context=i.pendingContext,i.pendingContext=null),(e===null||e.child===null)&&(dt(n)?n.flags|=4:i.hydrate||(n.flags|=256)),So(n),null;case 5:eo(n);var t=On($a.current);if(a=n.type,e!==null&&n.stateNode!=null)pu(e,n,a,i,t),e.ref!==n.ref&&(n.flags|=128);else{if(!i){if(n.stateNode===null)throw Error(T(166));return null}if(e=On(Ue.current),dt(n)){i=n.stateNode,a=n.type;var r=n.memoizedProps;switch(i[en]=n,i[_i]=r,a){case"dialog":V("cancel",i),V("close",i);break;case"iframe":case"object":case"embed":V("load",i);break;case"video":case"audio":for(e=0;e<ja.length;e++)V(ja[e],i);break;case"source":V("error",i);break;case"img":case"image":case"link":V("error",i),V("load",i);break;case"details":V("toggle",i);break;case"input":ss(i,r),V("invalid",i);break;case"select":i._wrapperState={wasMultiple:!!r.multiple},V("invalid",i);break;case"textarea":ds(i,r),V("invalid",i)}tr(a,r),e=null;for(var o in r)r.hasOwnProperty(o)&&(t=r[o],o==="children"?typeof t=="string"?i.textContent!==t&&(e=["children",t]):typeof t=="number"&&i.textContent!==""+t&&(e=["children",""+t]):Aa.hasOwnProperty(o)&&t!=null&&o==="onScroll"&&V("scroll",i));switch(a){case"input":Mi(i),us(i,r,!0);break;case"textarea":Mi(i),cs(i);break;case"select":case"option":break;default:typeof r.onClick=="function"&&(i.onclick=Ji)}i=e,n.updateQueue=i,i!==null&&(n.flags|=4)}else{switch(o=t.nodeType===9?t:t.ownerDocument,e===ar.html&&(e=gs(a)),e===ar.html?a==="script"?(e=o.createElement("div"),e.innerHTML="<script></script>",e=e.removeChild(e.firstChild)):typeof i.is=="string"?e=o.createElement(a,{is:i.is}):(e=o.createElement(a),a==="select"&&(o=e,i.multiple?o.multiple=!0:i.size&&(o.size=i.size))):e=o.createElementNS(e,a),e[en]=n,e[_i]=i,mu(e,n,!1,!1),n.stateNode=e,o=rr(a,i),a){case"dialog":V("cancel",e),V("close",e),t=i;break;case"iframe":case"object":case"embed":V("load",e),t=i;break;case"video":case"audio":for(t=0;t<ja.length;t++)V(ja[t],e);t=i;break;case"source":V("error",e),t=i;break;case"img":case"image":case"link":V("error",e),V("load",e),t=i;break;case"details":V("toggle",e),t=i;break;case"input":ss(e,i),t=Zt(e,i),V("invalid",e);break;case"option":t=er(e,i);break;case"select":e._wrapperState={wasMultiple:!!i.multiple},t=Y({},i,{value:void 0}),V("invalid",e);break;case"textarea":ds(e,i),t=nr(e,i),V("invalid",e);break;default:t=i}tr(a,t);var s=t;for(r in s)if(s.hasOwnProperty(r)){var l=s[r];r==="style"?fs(e,l):r==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,l!=null&&ms(e,l)):r==="children"?typeof l=="string"?(a!=="textarea"||l!=="")&&Ma(e,l):typeof l=="number"&&Ma(e,""+l):r!=="suppressContentEditableWarning"&&r!=="suppressHydrationWarning"&&r!=="autoFocus"&&(Aa.hasOwnProperty(r)?l!=null&&r==="onScroll"&&V("scroll",e):l!=null&&bt(e,r,l,o))}switch(a){case"input":Mi(e),us(e,i,!1);break;case"textarea":Mi(e),cs(e);break;case"option":i.value!=null&&e.setAttribute("value",""+ze(i.value));break;case"select":e.multiple=!!i.multiple,r=i.value,r!=null?Kn(e,!!i.multiple,r,!1):i.defaultValue!=null&&Kn(e,!!i.multiple,i.defaultValue,!0);break;default:typeof t.onClick=="function"&&(e.onclick=Ji)}Sl(a,i)&&(n.flags|=4)}n.ref!==null&&(n.flags|=128)}return null;case 6:if(e&&n.stateNode!=null)fu(e,n,e.memoizedProps,i);else{if(typeof i!="string"&&n.stateNode===null)throw Error(T(166));a=On($a.current),On(Ue.current),dt(n)?(i=n.stateNode,a=n.memoizedProps,i[en]=n,i.nodeValue!==a&&(n.flags|=4)):(i=(a.nodeType===9?a:a.ownerDocument).createTextNode(i),i[en]=n,n.stateNode=i)}return null;case 13:return J(Z),i=n.memoizedState,(n.flags&64)!=0?(n.lanes=a,n):(i=i!==null,a=!1,e===null?n.memoizedProps.fallback!==void 0&&dt(n):a=e.memoizedState!==null,i&&!a&&(n.mode&2)!=0&&(e===null&&n.memoizedProps.unstable_avoidThisFallback!==!0||(Z.current&1)!=0?he===0&&(he=3):((he===0||he===3)&&(he=4),Se===null||(za&134217727)==0&&(ua&134217727)==0||da(Se,pe))),(i||a)&&(n.flags|=4),null);case 4:return sa(),So(n),e===null&&pl(n.stateNode.containerInfo),null;case 10:return zr(n),null;case 17:return Te(n.type)&&qi(),null;case 19:if(J(Z),i=n.memoizedState,i===null)return null;if(r=(n.flags&64)!=0,o=i.rendering,o===null)if(r)oi(i,!1);else{if(he!==0||e!==null&&(e.flags&64)!=0)for(e=n.child;e!==null;){if(o=ut(e),o!==null){for(n.flags|=64,oi(i,!1),r=o.updateQueue,r!==null&&(n.updateQueue=r,n.flags|=4),i.lastEffect===null&&(n.firstEffect=null),n.lastEffect=i.lastEffect,i=a,a=n.child;a!==null;)r=a,e=i,r.flags&=2,r.nextEffect=null,r.firstEffect=null,r.lastEffect=null,o=r.alternate,o===null?(r.childLanes=0,r.lanes=e,r.child=null,r.memoizedProps=null,r.memoizedState=null,r.updateQueue=null,r.dependencies=null,r.stateNode=null):(r.childLanes=o.childLanes,r.lanes=o.lanes,r.child=o.child,r.memoizedProps=o.memoizedProps,r.memoizedState=o.memoizedState,r.updateQueue=o.updateQueue,r.type=o.type,e=o.dependencies,r.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),a=a.sibling;return q(Z,Z.current&1|2),n.child}e=e.sibling}i.tail!==null&&ge()>yo&&(n.flags|=64,r=!0,oi(i,!1),n.lanes=33554432)}else{if(!r)if(e=ut(o),e!==null){if(n.flags|=64,r=!0,a=e.updateQueue,a!==null&&(n.updateQueue=a,n.flags|=4),oi(i,!0),i.tail===null&&i.tailMode==="hidden"&&!o.alternate&&!Le)return n=n.lastEffect=i.lastEffect,n!==null&&(n.nextEffect=null),null}else 2*ge()-i.renderingStartTime>yo&&a!==1073741824&&(n.flags|=64,r=!0,oi(i,!1),n.lanes=33554432);i.isBackwards?(o.sibling=n.child,n.child=o):(a=i.last,a!==null?a.sibling=o:n.child=o,i.last=o)}return i.tail!==null?(a=i.tail,i.rendering=a,i.tail=a.sibling,i.lastEffect=n.lastEffect,i.renderingStartTime=ge(),a.sibling=null,n=Z.current,q(Z,r?n&1|2:n&1),a):null;case 23:case 24:return ko(),e!==null&&e.memoizedState!==null!=(n.memoizedState!==null)&&i.mode!=="unstable-defer-without-hiding"&&(n.flags|=4),null}throw Error(T(156,n.tag))}function rc(e){switch(e.tag){case 1:Te(e.type)&&qi();var n=e.flags;return n&4096?(e.flags=n&-4097|64,e):null;case 3:if(sa(),J(ke),J(ce),io(),n=e.flags,(n&64)!=0)throw Error(T(285));return e.flags=n&-4097|64,e;case 5:return eo(e),null;case 13:return J(Z),n=e.flags,n&4096?(e.flags=n&-4097|64,e):null;case 19:return J(Z),null;case 4:return sa(),null;case 10:return zr(e),null;case 23:case 24:return ko(),null;default:return null}}function To(e,n){try{var a="",i=n;do a+=Hd(i),i=i.return;while(i);var t=a}catch(r){t=`
Error generating stack: `+r.message+`
`+r.stack}return{value:e,source:n,stack:t}}function Ao(e,n){try{console.error(n.value)}catch(a){setTimeout(function(){throw a})}}var oc=typeof WeakMap=="function"?WeakMap:Map;function Su(e,n,a){a=rn(-1,a),a.tag=3,a.payload={element:null};var i=n.value;return a.callback=function(){yt||(yt=!0,Io=i),Ao(e,n)},a}function yu(e,n,a){a=rn(-1,a),a.tag=3;var i=e.type.getDerivedStateFromError;if(typeof i=="function"){var t=n.value;a.payload=function(){return Ao(e,n),i(t)}}var r=e.stateNode;return r!==null&&typeof r.componentDidCatch=="function"&&(a.callback=function(){typeof i!="function"&&(He===null?He=new Set([this]):He.add(this),Ao(e,n));var o=n.stack;this.componentDidCatch(n.value,{componentStack:o!==null?o:""})}),a}var sc=typeof WeakSet=="function"?WeakSet:Set;function ku(e){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(a){hn(e,a)}else n.current=null}function lc(e,n){switch(n.tag){case 0:case 11:case 15:case 22:return;case 1:if(n.flags&256&&e!==null){var a=e.memoizedProps,i=e.memoizedState;e=n.stateNode,n=e.getSnapshotBeforeUpdate(n.elementType===n.type?a:Pe(n.type,a),i),e.__reactInternalSnapshotBeforeUpdate=n}return;case 3:n.flags&256&&Fr(n.stateNode.containerInfo);return;case 5:case 6:case 4:case 17:return}throw Error(T(163))}function dc(e,n,a){switch(a.tag){case 0:case 11:case 15:case 22:if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{if((e.tag&3)==3){var i=e.create;e.destroy=i()}e=e.next}while(e!==n)}if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{var t=e;i=t.next,t=t.tag,(t&4)!=0&&(t&1)!=0&&(Tu(a,e),uc(a,e)),e=i}while(e!==n)}return;case 1:e=a.stateNode,a.flags&4&&(n===null?e.componentDidMount():(i=a.elementType===a.type?n.memoizedProps:Pe(a.type,n.memoizedProps),e.componentDidUpdate(i,n.memoizedState,e.__reactInternalSnapshotBeforeUpdate))),n=a.updateQueue,n!==null&&Dl(a,n,e);return;case 3:if(n=a.updateQueue,n!==null){if(e=null,a.child!==null)switch(a.child.tag){case 5:e=a.child.stateNode;break;case 1:e=a.child.stateNode}Dl(a,n,e)}return;case 5:e=a.stateNode,n===null&&a.flags&4&&Sl(a.type,a.memoizedProps)&&e.focus();return;case 6:return;case 4:return;case 12:return;case 13:a.memoizedState===null&&(a=a.alternate,a!==null&&(a=a.memoizedState,a!==null&&(a=a.dehydrated,a!==null&&Ps(a))));return;case 19:case 17:case 20:case 21:case 23:case 24:return}throw Error(T(163))}function Au(e,n){for(var a=e;;){if(a.tag===5){var i=a.stateNode;if(n)i=i.style,typeof i.setProperty=="function"?i.setProperty("display","none","important"):i.display="none";else{i=a.stateNode;var t=a.memoizedProps.style;t=t!=null&&t.hasOwnProperty("display")?t.display:null,i.style.display=ps("display",t)}}else if(a.tag===6)a.stateNode.nodeValue=n?"":a.memoizedProps;else if((a.tag!==23&&a.tag!==24||a.memoizedState===null||a===e)&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===e)break;for(;a.sibling===null;){if(a.return===null||a.return===e)return;a=a.return}a.sibling.return=a.return,a=a.sibling}}function vu(e,n){if(Cn&&typeof Cn.onCommitFiberUnmount=="function")try{Cn.onCommitFiberUnmount(Kr,n)}catch(r){}switch(n.tag){case 0:case 11:case 14:case 15:case 22:if(e=n.updateQueue,e!==null&&(e=e.lastEffect,e!==null)){var a=e=e.next;do{var i=a,t=i.destroy;if(i=i.tag,t!==void 0)if((i&4)!=0)Tu(n,a);else{i=n;try{t()}catch(r){hn(i,r)}}a=a.next}while(a!==e)}break;case 1:if(ku(n),e=n.stateNode,typeof e.componentWillUnmount=="function")try{e.props=n.memoizedProps,e.state=n.memoizedState,e.componentWillUnmount()}catch(r){hn(n,r)}break;case 5:ku(n);break;case 4:Iu(e,n)}}function Eu(e){e.alternate=null,e.child=null,e.dependencies=null,e.firstEffect=null,e.lastEffect=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.return=null,e.updateQueue=null}function wu(e){return e.tag===5||e.tag===3||e.tag===4}function Cu(e){e:{for(var n=e.return;n!==null;){if(wu(n))break e;n=n.return}throw Error(T(160))}var a=n;switch(n=a.stateNode,a.tag){case 5:var i=!1;break;case 3:n=n.containerInfo,i=!0;break;case 4:n=n.containerInfo,i=!0;break;default:throw Error(T(161))}a.flags&16&&(Ma(n,""),a.flags&=-17);e:n:for(a=e;;){for(;a.sibling===null;){if(a.return===null||wu(a.return)){a=null;break e}a=a.return}for(a.sibling.return=a.return,a=a.sibling;a.tag!==5&&a.tag!==6&&a.tag!==18;){if(a.flags&2||a.child===null||a.tag===4)continue n;a.child.return=a,a=a.child}if(!(a.flags&2)){a=a.stateNode;break e}}i?vo(e,a,n):Eo(e,a,n)}function vo(e,n,a){var i=e.tag,t=i===5||i===6;if(t)e=t?e.stateNode:e.stateNode.instance,n?a.nodeType===8?a.parentNode.insertBefore(e,n):a.insertBefore(e,n):(a.nodeType===8?(n=a.parentNode,n.insertBefore(e,a)):(n=a,n.appendChild(e)),a=a._reactRootContainer,a!=null||n.onclick!==null||(n.onclick=Ji));else if(i!==4&&(e=e.child,e!==null))for(vo(e,n,a),e=e.sibling;e!==null;)vo(e,n,a),e=e.sibling}function Eo(e,n,a){var i=e.tag,t=i===5||i===6;if(t)e=t?e.stateNode:e.stateNode.instance,n?a.insertBefore(e,n):a.appendChild(e);else if(i!==4&&(e=e.child,e!==null))for(Eo(e,n,a),e=e.sibling;e!==null;)Eo(e,n,a),e=e.sibling}function Iu(e,n){for(var a=n,i=!1,t,r;;){if(!i){i=a.return;e:for(;;){if(i===null)throw Error(T(160));switch(t=i.stateNode,i.tag){case 5:r=!1;break e;case 3:t=t.containerInfo,r=!0;break e;case 4:t=t.containerInfo,r=!0;break e}i=i.return}i=!0}if(a.tag===5||a.tag===6){e:for(var o=e,s=a,l=s;;)if(vu(o,l),l.child!==null&&l.tag!==4)l.child.return=l,l=l.child;else{if(l===s)break e;for(;l.sibling===null;){if(l.return===null||l.return===s)break e;l=l.return}l.sibling.return=l.return,l=l.sibling}r?(o=t,s=a.stateNode,o.nodeType===8?o.parentNode.removeChild(s):o.removeChild(s)):t.removeChild(a.stateNode)}else if(a.tag===4){if(a.child!==null){t=a.stateNode.containerInfo,r=!0,a.child.return=a,a=a.child;continue}}else if(vu(e,a),a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return,a.tag===4&&(i=!1)}a.sibling.return=a.return,a=a.sibling}}function Co(e,n){switch(n.tag){case 0:case 11:case 14:case 15:case 22:var a=n.updateQueue;if(a=a!==null?a.lastEffect:null,a!==null){var i=a=a.next;do(i.tag&3)==3&&(e=i.destroy,i.destroy=void 0,e!==void 0&&e()),i=i.next;while(i!==a)}return;case 1:return;case 5:if(a=n.stateNode,a!=null){i=n.memoizedProps;var t=e!==null?e.memoizedProps:i;e=n.type;var r=n.updateQueue;if(n.updateQueue=null,r!==null){for(a[_i]=i,e==="input"&&i.type==="radio"&&i.name!=null&&ls(a,i),rr(e,t),n=rr(e,i),t=0;t<r.length;t+=2){var o=r[t],s=r[t+1];o==="style"?fs(a,s):o==="dangerouslySetInnerHTML"?ms(a,s):o==="children"?Ma(a,s):bt(a,o,s,n)}switch(e){case"input":$t(a,i);break;case"textarea":hs(a,i);break;case"select":e=a._wrapperState.wasMultiple,a._wrapperState.wasMultiple=!!i.multiple,r=i.value,r!=null?Kn(a,!!i.multiple,r,!1):e!==!!i.multiple&&(i.defaultValue!=null?Kn(a,!!i.multiple,i.defaultValue,!0):Kn(a,!!i.multiple,i.multiple?[]:"",!1))}}}return;case 6:if(n.stateNode===null)throw Error(T(162));n.stateNode.nodeValue=n.memoizedProps;return;case 3:a=n.stateNode,a.hydrate&&(a.hydrate=!1,Ps(a.containerInfo));return;case 12:return;case 13:n.memoizedState!==null&&(wo=ge(),Au(n.child,!0)),Mu(n);return;case 19:Mu(n);return;case 17:return;case 23:case 24:Au(n,n.memoizedState!==null);return}throw Error(T(163))}function Mu(e){var n=e.updateQueue;if(n!==null){e.updateQueue=null;var a=e.stateNode;a===null&&(a=e.stateNode=new sc),n.forEach(function(i){var t=hc.bind(null,e,i);a.has(i)||(a.add(i),i.then(t,t))})}}function cc(e,n){return e!==null&&(e=e.memoizedState,e===null||e.dehydrated!==null)?(n=n.memoizedState,n!==null&&n.dehydrated===null):!1}var gc=Math.ceil,kt=Tn.ReactCurrentDispatcher,Mo=Tn.ReactCurrentOwner,U=0,Se=null,ie=null,pe=0,Nn=0,Oo=nn(0),he=0,Tt=null,ha=0,za=0,ua=0,Wo=0,Bo=null,wo=0,yo=Infinity;function ca(){yo=ge()+500}var M=null,yt=!1,Io=null,He=null,cn=!1,si=null,li=90,No=[],Po=[],Qe=null,ui=0,Go=null,At=-1,je=0,It=0,di=null,vt=!1;function we(){return(U&48)!=0?ge():At!==-1?At:At=ge()}function sn(e){if(e=e.mode,(e&2)==0)return 1;if((e&4)==0)return ia()===99?1:2;if(je===0&&(je=ha),Xh.transition!==0){It!==0&&(It=Bo!==null?Bo.pendingLanes:0),e=je;var n=4186112&~It;return n&=-n,n===0&&(e=4186112&~e,n=e&-e,n===0&&(n=8192)),n}return e=ia(),(U&4)!=0&&e===98?e=Ui(12,je):(e=nh(e),e=Ui(e,je)),e}function ln(e,n,a){if(50<ui)throw ui=0,Go=null,Error(T(185));if(e=Et(e,n),e===null)return null;Li(e,n,a),e===Se&&(ua|=n,he===4&&da(e,pe));var i=ia();n===1?(U&8)!=0&&(U&48)==0?Ro(e):(Be(e,a),U===0&&(ca(),De())):((U&4)==0||i!==98&&i!==99||(Qe===null?Qe=new Set([e]):Qe.add(e)),Be(e,a)),Bo=e}function Et(e,n){e.lanes|=n;var a=e.alternate;for(a!==null&&(a.lanes|=n),a=e,e=e.return;e!==null;)e.childLanes|=n,a=e.alternate,a!==null&&(a.childLanes|=n),a=e,e=e.return;return a.tag===3?a.stateNode:null}function Be(e,n){for(var a=e.callbackNode,i=e.suspendedLanes,t=e.pingedLanes,r=e.expirationTimes,o=e.pendingLanes;0<o;){var s=31-Xe(o),l=1<<s,d=r[s];if(d===-1){if((l&i)==0||(l&t)!=0){d=n,Vn(l);var k=j;r[s]=10<=k?d+250:6<=k?d+5e3:-1}}else d<=n&&(e.expiredLanes|=l);o&=~l}if(i=La(e,e===Se?pe:0),n=j,i===0)a!==null&&(a!==jr&&xr(a),e.callbackNode=null,e.callbackPriority=0);else{if(a!==null){if(e.callbackPriority===n)return;a!==jr&&xr(a)}n===15?(a=Ro.bind(null,e),Ke===null?(Ke=[a],$i=Yr(Xi,Nl)):Ke.push(a),a=jr):n===14?a=Ja(99,Ro.bind(null,e)):(a=ah(n),a=Ja(a,Ou.bind(null,e))),e.callbackPriority=n,e.callbackNode=a}}function Ou(e){if(At=-1,It=je=0,(U&48)!=0)throw Error(T(327));var n=e.callbackNode;if(gn()&&e.callbackNode!==n)return null;var a=La(e,e===Se?pe:0);if(a===0)return null;var i=a,t=U;U|=16;var r=Bu();(Se!==e||pe!==i)&&(ca(),ga(e,i));do try{mc();break}catch(s){Wu(e,s)}while(1);if(Jr(),kt.current=r,U=t,ie!==null?i=0:(Se=null,pe=0,i=he),(ha&ua)!=0)ga(e,0);else if(i!==0){if(i===2&&(U|=64,e.hydrate&&(e.hydrate=!1,Fr(e.containerInfo)),a=Hs(e),a!==0&&(i=hi(e,a))),i===1)throw n=Tt,ga(e,0),da(e,a),Be(e,ge()),n;switch(e.finishedWork=e.current.alternate,e.finishedLanes=a,i){case 0:case 1:throw Error(T(345));case 2:Pn(e);break;case 3:if(da(e,a),(a&62914560)===a&&(i=wo+500-ge(),10<i)){if(La(e,0)!==0)break;if(t=e.suspendedLanes,(t&a)!==a){we(),e.pingedLanes|=e.suspendedLanes&t;break}e.timeoutHandle=yl(Pn.bind(null,e),i);break}Pn(e);break;case 4:if(da(e,a),(a&4186112)===a)break;for(i=e.eventTimes,t=-1;0<a;){var o=31-Xe(a);r=1<<o,o=i[o],o>t&&(t=o),a&=~r}if(a=t,a=ge()-a,a=(120>a?120:480>a?480:1080>a?1080:1920>a?1920:3e3>a?3e3:4320>a?4320:1960*gc(a/1960))-a,10<a){e.timeoutHandle=yl(Pn.bind(null,e),a);break}Pn(e);break;case 5:Pn(e);break;default:throw Error(T(329))}}return Be(e,ge()),e.callbackNode===n?Ou.bind(null,e):null}function da(e,n){for(n&=~Wo,n&=~ua,e.suspendedLanes|=n,e.pingedLanes&=~n,e=e.expirationTimes;0<n;){var a=31-Xe(n),i=1<<a;e[a]=-1,n&=~i}}function Ro(e){if((U&48)!=0)throw Error(T(327));if(gn(),e===Se&&(e.expiredLanes&pe)!=0){var n=pe,a=hi(e,n);(ha&ua)!=0&&(n=La(e,n),a=hi(e,n))}else n=La(e,0),a=hi(e,n);if(e.tag!==0&&a===2&&(U|=64,e.hydrate&&(e.hydrate=!1,Fr(e.containerInfo)),n=Hs(e),n!==0&&(a=hi(e,n))),a===1)throw a=Tt,ga(e,0),da(e,n),Be(e,ge()),a;return e.finishedWork=e.current.alternate,e.finishedLanes=n,Pn(e),Be(e,ge()),null}function pc(){if(Qe!==null){var e=Qe;Qe=null,e.forEach(function(n){n.expiredLanes|=24&n.pendingLanes,Be(n,ge())})}De()}function Nu(e,n){var a=U;U|=1;try{return e(n)}finally{U=a,U===0&&(ca(),De())}}function Pu(e,n){var a=U;U&=-2,U|=8;try{return e(n)}finally{U=a,U===0&&(ca(),De())}}function ft(e,n){q(Oo,Nn),Nn|=n,ha|=n}function ko(){Nn=Oo.current,J(Oo)}function ga(e,n){e.finishedWork=null,e.finishedLanes=0;var a=e.timeoutHandle;if(a!==-1&&(e.timeoutHandle=-1,Vh(a)),ie!==null)for(a=ie.return;a!==null;){var i=a;switch(i.tag){case 1:i=i.type.childContextTypes,i!=null&&qi();break;case 3:sa(),J(ke),J(ce),io();break;case 5:eo(i);break;case 4:sa();break;case 13:J(Z);break;case 19:J(Z);break;case 10:zr(i);break;case 23:case 24:ko()}a=a.return}Se=e,ie=un(e.current,null),pe=Nn=ha=n,he=0,Tt=null,Wo=ua=za=0}function Wu(e,n){do{var a=ie;try{if(Jr(),ei.current=ct,ht){for(var i=X.memoizedState;i!==null;){var t=i.queue;t!==null&&(t.pending=null),i=i.next}ht=!1}if(ni=0,de=me=X=null,ai=!1,Mo.current=null,a===null||a.return===null){he=1,Tt=n,ie=null;break}e:{var r=e,o=a.return,s=a,l=n;if(n=pe,s.flags|=2048,s.firstEffect=s.lastEffect=null,l!==null&&typeof l=="object"&&typeof l.then=="function"){var d=l;if((s.mode&2)==0){var k=s.alternate;k?(s.updateQueue=k.updateQueue,s.memoizedState=k.memoizedState,s.lanes=k.lanes):(s.updateQueue=null,s.memoizedState=null)}var N=(Z.current&1)!=0,f=o;do{var w;if(w=f.tag===13){var P=f.memoizedState;if(P!==null)w=P.dehydrated!==null;else{var O=f.memoizedProps;w=O.fallback===void 0?!1:O.unstable_avoidThisFallback!==!0?!0:!N}}if(w){var c=f.updateQueue;if(c===null){var u=new Set;u.add(d),f.updateQueue=u}else c.add(d);if((f.mode&2)==0){if(f.flags|=64,s.flags|=16384,s.flags&=-2981,s.tag===1)if(s.alternate===null)s.tag=17;else{var h=rn(-1,1);h.tag=2,on(s,h)}s.lanes|=1;break e}l=void 0,s=n;var m=r.pingCache;if(m===null?(m=r.pingCache=new oc,l=new Set,m.set(d,l)):(l=m.get(d),l===void 0&&(l=new Set,m.set(d,l))),!l.has(s)){l.add(s);var p=fc.bind(null,r,d,s);d.then(p,p)}f.flags|=4096,f.lanes=n;break e}f=f.return}while(f!==null);l=Error((bn(s.type)||"A React component")+` suspended while rendering, but no fallback UI was specified.

Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.`)}he!==5&&(he=2),l=To(l,s),f=o;do{switch(f.tag){case 3:r=l,f.flags|=4096,n&=-n,f.lanes|=n;var G=Su(f,r,n);Rl(f,G);break e;case 1:r=l;var v=f.type,W=f.stateNode;if((f.flags&64)==0&&(typeof v.getDerivedStateFromError=="function"||W!==null&&typeof W.componentDidCatch=="function"&&(He===null||!He.has(W)))){f.flags|=4096,n&=-n,f.lanes|=n;var D=yu(f,r,n);Rl(f,D);break e}}f=f.return}while(f!==null)}Gu(a)}catch(R){n=R,ie===a&&a!==null&&(ie=a=a.return);continue}break}while(1)}function Bu(){var e=kt.current;return kt.current=ct,e===null?ct:e}function hi(e,n){var a=U;U|=16;var i=Bu();Se===e&&pe===n||ga(e,n);do try{Sc();break}catch(t){Wu(e,t)}while(1);if(Jr(),U=a,kt.current=i,ie!==null)throw Error(T(261));return Se=null,pe=0,he}function Sc(){for(;ie!==null;)Ru(ie)}function mc(){for(;ie!==null&&!_h();)Ru(ie)}function Ru(e){var n=Du(e.alternate,e,Nn);e.memoizedProps=e.pendingProps,n===null?Gu(e):ie=n,Mo.current=null}function Gu(e){var n=e;do{var a=n.alternate;if(e=n.return,(n.flags&2048)==0){if(a=tc(a,n,Nn),a!==null){ie=a;return}if(a=n,a.tag!==24&&a.tag!==23||a.memoizedState===null||(Nn&1073741824)!=0||(a.mode&4)==0){for(var i=0,t=a.child;t!==null;)i|=t.lanes|t.childLanes,t=t.sibling;a.childLanes=i}e!==null&&(e.flags&2048)==0&&(e.firstEffect===null&&(e.firstEffect=n.firstEffect),n.lastEffect!==null&&(e.lastEffect!==null&&(e.lastEffect.nextEffect=n.firstEffect),e.lastEffect=n.lastEffect),1<n.flags&&(e.lastEffect!==null?e.lastEffect.nextEffect=n:e.firstEffect=n,e.lastEffect=n))}else{if(a=rc(n),a!==null){a.flags&=2047,ie=a;return}e!==null&&(e.firstEffect=e.lastEffect=null,e.flags|=2048)}if(n=n.sibling,n!==null){ie=n;return}ie=n=e}while(n!==null);he===0&&(he=5)}function Pn(e){var n=ia();return Mn(99,yc.bind(null,e,n)),null}function yc(e,n){do gn();while(si!==null);if((U&48)!=0)throw Error(T(327));var a=e.finishedWork;if(a===null)return null;if(e.finishedWork=null,e.finishedLanes=0,a===e.current)throw Error(T(177));e.callbackNode=null;var i=a.lanes|a.childLanes,t=i,r=e.pendingLanes&~t;e.pendingLanes=t,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=t,e.mutableReadLanes&=t,e.entangledLanes&=t,t=e.entanglements;for(var o=e.eventTimes,s=e.expirationTimes;0<r;){var l=31-Xe(r),d=1<<l;t[l]=0,o[l]=-1,s[l]=-1,r&=~d}if(Qe!==null&&(i&24)==0&&Qe.has(e)&&Qe.delete(e),e===Se&&(ie=Se=null,pe=0),1<a.flags?a.lastEffect!==null?(a.lastEffect.nextEffect=a,i=a.firstEffect):i=a:i=a.firstEffect,i!==null){if(t=U,U|=32,Mo.current=null,Dr=Fi,o=ol(),Nr(o)){if("selectionStart"in o)s={start:o.selectionStart,end:o.selectionEnd};else e:if(s=(s=o.ownerDocument)&&s.defaultView||window,(d=s.getSelection&&s.getSelection())&&d.rangeCount!==0){s=d.anchorNode,r=d.anchorOffset,l=d.focusNode,d=d.focusOffset;try{s.nodeType,l.nodeType}catch(R){s=null;break e}var k=0,N=-1,f=-1,w=0,P=0,O=o,c=null;n:for(;;){for(var u;O!==s||r!==0&&O.nodeType!==3||(N=k+r),O!==l||d!==0&&O.nodeType!==3||(f=k+d),O.nodeType===3&&(k+=O.nodeValue.length),(u=O.firstChild)!==null;)c=O,O=u;for(;;){if(O===o)break n;if(c===s&&++w===r&&(N=k),c===l&&++P===d&&(f=k),(u=O.nextSibling)!==null)break;O=c,c=O.parentNode}O=u}s=N===-1||f===-1?null:{start:N,end:f}}else s=null;s=s||{start:0,end:0}}else s=null;Ur={focusedElem:o,selectionRange:s},Fi=!1,di=null,vt=!1,M=i;do try{kc()}catch(R){if(M===null)throw Error(T(330));hn(M,R),M=M.nextEffect}while(M!==null);di=null,M=i;do try{for(o=e;M!==null;){var h=M.flags;if(h&16&&Ma(M.stateNode,""),h&128){var m=M.alternate;if(m!==null){var p=m.ref;p!==null&&(typeof p=="function"?p(null):p.current=null)}}switch(h&1038){case 2:Cu(M),M.flags&=-3;break;case 6:Cu(M),M.flags&=-3,Co(M.alternate,M);break;case 1024:M.flags&=-1025;break;case 1028:M.flags&=-1025,Co(M.alternate,M);break;case 4:Co(M.alternate,M);break;case 8:s=M,Iu(o,s);var G=s.alternate;Eu(s),G!==null&&Eu(G)}M=M.nextEffect}}catch(R){if(M===null)throw Error(T(330));hn(M,R),M=M.nextEffect}while(M!==null);if(p=Ur,m=ol(),h=p.focusedElem,o=p.selectionRange,m!==h&&h&&h.ownerDocument&&rl(h.ownerDocument.documentElement,h)){for(o!==null&&Nr(h)&&(m=o.start,p=o.end,p===void 0&&(p=m),"selectionStart"in h?(h.selectionStart=m,h.selectionEnd=Math.min(p,h.value.length)):(p=(m=h.ownerDocument||document)&&m.defaultView||window,p.getSelection&&(p=p.getSelection(),s=h.textContent.length,G=Math.min(o.start,s),o=o.end===void 0?G:Math.min(o.end,s),!p.extend&&G>o&&(s=o,o=G,G=s),s=tl(h,G),r=tl(h,o),s&&r&&(p.rangeCount!==1||p.anchorNode!==s.node||p.anchorOffset!==s.offset||p.focusNode!==r.node||p.focusOffset!==r.offset)&&(m=m.createRange(),m.setStart(s.node,s.offset),p.removeAllRanges(),G>o?(p.addRange(m),p.extend(r.node,r.offset)):(m.setEnd(r.node,r.offset),p.addRange(m)))))),m=[],p=h;p=p.parentNode;)p.nodeType===1&&m.push({element:p,left:p.scrollLeft,top:p.scrollTop});for(typeof h.focus=="function"&&h.focus(),h=0;h<m.length;h++)p=m[h],p.element.scrollLeft=p.left,p.element.scrollTop=p.top}Fi=!!Dr,Ur=Dr=null,e.current=a,M=i;do try{for(h=e;M!==null;){var v=M.flags;if(v&36&&dc(h,M.alternate,M),v&128){m=void 0;var W=M.ref;if(W!==null){var D=M.stateNode;switch(M.tag){case 5:m=D;break;default:m=D}typeof W=="function"?W(m):W.current=m}}M=M.nextEffect}}catch(R){if(M===null)throw Error(T(330));hn(M,R),M=M.nextEffect}while(M!==null);M=null,Zh(),U=t}else e.current=a;if(cn)cn=!1,si=e,li=n;else for(M=i;M!==null;)n=M.nextEffect,M.nextEffect=null,M.flags&8&&(v=M,v.sibling=null,v.stateNode=null),M=n;if(i=e.pendingLanes,i===0&&(He=null),i===1?e===Go?ui++:(ui=0,Go=e):ui=0,a=a.stateNode,Cn&&typeof Cn.onCommitFiberRoot=="function")try{Cn.onCommitFiberRoot(Kr,a,void 0,(a.current.flags&64)==64)}catch(R){}if(Be(e,ge()),yt)throw yt=!1,e=Io,Io=null,e;return(U&8)!=0||De(),null}function kc(){for(;M!==null;){var e=M.alternate;vt||di===null||((M.flags&8)!=0?ws(M,di)&&(vt=!0):M.tag===13&&cc(e,M)&&ws(M,di)&&(vt=!0));var n=M.flags;(n&256)!=0&&lc(e,M),(n&512)==0||cn||(cn=!0,Ja(97,function(){return gn(),null})),M=M.nextEffect}}function gn(){if(li!==90){var e=97<li?97:li;return li=90,Mn(e,Tc)}return!1}function uc(e,n){No.push(n,e),cn||(cn=!0,Ja(97,function(){return gn(),null}))}function Tu(e,n){Po.push(n,e),cn||(cn=!0,Ja(97,function(){return gn(),null}))}function Tc(){if(si===null)return!1;var e=si;if(si=null,(U&48)!=0)throw Error(T(331));var n=U;U|=32;var a=Po;Po=[];for(var i=0;i<a.length;i+=2){var t=a[i],r=a[i+1],o=t.destroy;if(t.destroy=void 0,typeof o=="function")try{o()}catch(l){if(r===null)throw Error(T(330));hn(r,l)}}for(a=No,No=[],i=0;i<a.length;i+=2){t=a[i],r=a[i+1];try{var s=t.create;t.destroy=s()}catch(l){if(r===null)throw Error(T(330));hn(r,l)}}for(s=e.current.firstEffect;s!==null;)e=s.nextEffect,s.nextEffect=null,s.flags&8&&(s.sibling=null,s.stateNode=null),s=e;return U=n,De(),!0}function Uu(e,n,a){n=To(a,n),n=Su(e,n,1),on(e,n),n=we(),e=Et(e,1),e!==null&&(Li(e,1,n),Be(e,n))}function hn(e,n){if(e.tag===3)Uu(e,e,n);else for(var a=e.return;a!==null;){if(a.tag===3){Uu(a,e,n);break}else if(a.tag===1){var i=a.stateNode;if(typeof a.type.getDerivedStateFromError=="function"||typeof i.componentDidCatch=="function"&&(He===null||!He.has(i))){e=To(n,e);var t=yu(a,e,1);if(on(a,t),t=we(),a=Et(a,1),a!==null)Li(a,1,t),Be(a,t);else if(typeof i.componentDidCatch=="function"&&(He===null||!He.has(i)))try{i.componentDidCatch(n,e)}catch(r){}break}}a=a.return}}function fc(e,n,a){var i=e.pingCache;i!==null&&i.delete(n),n=we(),e.pingedLanes|=e.suspendedLanes&a,Se===e&&(pe&a)===a&&(he===4||he===3&&(pe&62914560)===pe&&500>ge()-wo?ga(e,0):Wo|=a),Be(e,n)}function hc(e,n){var a=e.stateNode;a!==null&&a.delete(n),n=0,n===0&&(n=e.mode,(n&2)==0?n=1:(n&4)==0?n=ia()===99?1:2:(je===0&&(je=ha),n=Jn(62914560&~je),n===0&&(n=4194304))),a=we(),e=Et(e,n),e!==null&&(Li(e,n,a),Be(e,a))}var Du;Du=function(e,n,a){var i=n.lanes;if(e!==null)if(e.memoizedProps!==n.pendingProps||ke.current)Ge=!0;else if((a&i)!=0)Ge=(e.flags&16384)!=0;else{switch(Ge=!1,n.tag){case 3:su(n),ao();break;case 5:Yl(n);break;case 1:Te(n.type)&&Zi(n);break;case 4:$r(n,n.stateNode.containerInfo);break;case 10:i=n.memoizedProps.value;var t=n.type._context;q(et,t._currentValue),t._currentValue=i;break;case 13:if(n.memoizedState!==null)return(a&n.child.childLanes)!=0?hu(e,n,a):(q(Z,Z.current&1),n=xe(e,n,a),n!==null?n.sibling:null);q(Z,Z.current&1);break;case 19:if(i=(a&n.childLanes)!=0,(e.flags&64)!=0){if(i)return gu(e,n,a);n.flags|=64}if(t=n.memoizedState,t!==null&&(t.rendering=null,t.tail=null,t.lastEffect=null),q(Z,Z.current),i)break;return null;case 23:case 24:return n.lanes=0,go(e,n,a)}return xe(e,n,a)}else Ge=!1;switch(n.lanes=0,n.tag){case 2:if(i=n.type,e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,t=aa(n,ce.current),ra(n,a),t=ro(null,n,i,e,t,a),n.flags|=1,typeof t=="object"&&t!==null&&typeof t.render=="function"&&t.$$typeof===void 0){if(n.tag=1,n.memoizedState=null,n.updateQueue=null,Te(i)){var r=!0;Zi(n)}else r=!1;n.memoizedState=t.state!==null&&t.state!==void 0?t.state:null,_r(n);var o=i.getDerivedStateFromProps;typeof o=="function"&&it(n,i,o,e),t.updater=tt,n.stateNode=t,t._reactInternals=n,qr(n,i,e,a),n=mo(null,n,i,!0,r,a)}else n.tag=0,Ie(null,n,t,a),n=n.child;return n;case 16:t=n.elementType;e:{switch(e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,r=t._init,t=r(t._payload),n.type=t,r=n.tag=Ac(t),e=Pe(t,e),r){case 0:n=co(null,n,t,e,a);break e;case 1:n=ou(null,n,t,e,a);break e;case 11:n=au(null,n,t,e,a);break e;case 14:n=tu(null,n,t,Pe(t.type,e),i,a);break e}throw Error(T(306,t,""))}return n;case 0:return i=n.type,t=n.pendingProps,t=n.elementType===i?t:Pe(i,t),co(e,n,i,t,a);case 1:return i=n.type,t=n.pendingProps,t=n.elementType===i?t:Pe(i,t),ou(e,n,i,t,a);case 3:if(su(n),i=n.updateQueue,e===null||i===null)throw Error(T(282));if(i=n.pendingProps,t=n.memoizedState,t=t!==null?t.element:null,Gl(e,n),_a(n,i,null,a),i=n.memoizedState.element,i===t)ao(),n=xe(e,n,a);else{if(t=n.stateNode,(r=t.hydrate)&&(dn=ea(n.stateNode.containerInfo.firstChild),Ye=n,r=Le=!0),r){if(e=t.mutableSourceEagerHydrationData,e!=null)for(t=0;t<e.length;t+=2)r=e[t],r._workInProgressVersionPrimary=e[t+1],la.push(r);for(a=Kl(n,null,i,a),n.child=a;a;)a.flags=a.flags&-3|1024,a=a.sibling}else Ie(e,n,i,a),ao();n=n.child}return n;case 5:return Yl(n),e===null&&no(n),i=n.type,t=n.pendingProps,r=e!==null?e.memoizedProps:null,o=t.children,Lr(i,t)?o=null:r!==null&&Lr(i,r)&&(n.flags|=16),ru(e,n),Ie(e,n,o,a),n.child;case 6:return e===null&&no(n),null;case 13:return hu(e,n,a);case 4:return $r(n,n.stateNode.containerInfo),i=n.pendingProps,e===null?n.child=lt(n,null,i,a):Ie(e,n,i,a),n.child;case 11:return i=n.type,t=n.pendingProps,t=n.elementType===i?t:Pe(i,t),au(e,n,i,t,a);case 7:return Ie(e,n,n.pendingProps,a),n.child;case 8:return Ie(e,n,n.pendingProps.children,a),n.child;case 12:return Ie(e,n,n.pendingProps.children,a),n.child;case 10:e:{i=n.type._context,t=n.pendingProps,o=n.memoizedProps,r=t.value;var s=n.type._context;if(q(et,s._currentValue),s._currentValue=r,o!==null)if(s=o.value,r=Ce(s,r)?0:(typeof i._calculateChangedBits=="function"?i._calculateChangedBits(s,r):1073741823)|0,r===0){if(o.children===t.children&&!ke.current){n=xe(e,n,a);break e}}else for(s=n.child,s!==null&&(s.return=n);s!==null;){var l=s.dependencies;if(l!==null){o=s.child;for(var d=l.firstContext;d!==null;){if(d.context===i&&(d.observedBits&r)!=0){s.tag===1&&(d=rn(-1,a&-a),d.tag=2,on(s,d)),s.lanes|=a,d=s.alternate,d!==null&&(d.lanes|=a),Pl(s.return,a),l.lanes|=a;break}d=d.next}}else o=s.tag===10&&s.type===n.type?null:s.child;if(o!==null)o.return=s;else for(o=s;o!==null;){if(o===n){o=null;break}if(s=o.sibling,s!==null){s.return=o.return,o=s;break}o=o.return}s=o}Ie(e,n,t.children,a),n=n.child}return n;case 9:return t=n.type,r=n.pendingProps,i=r.children,ra(n,a),t=Me(t,r.unstable_observedBits),i=i(t),n.flags|=1,Ie(e,n,i,a),n.child;case 14:return t=n.type,r=Pe(t,n.pendingProps),r=Pe(t.type,r),tu(e,n,t,r,i,a);case 15:return iu(e,n,n.type,n.pendingProps,i,a);case 17:return i=n.type,t=n.pendingProps,t=n.elementType===i?t:Pe(i,t),e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),n.tag=1,Te(i)?(e=!0,Zi(n)):e=!1,ra(n,a),Fl(n,i,t),qr(n,i,t,a),mo(null,n,i,!0,e,a);case 19:return gu(e,n,a);case 23:return go(e,n,a);case 24:return go(e,n,a)}throw Error(T(156,n.tag))};function Ic(e,n,a,i){this.tag=e,this.key=a,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=n,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=i,this.flags=0,this.lastEffect=this.firstEffect=this.nextEffect=null,this.childLanes=this.lanes=0,this.alternate=null}function Oe(e,n,a,i){return new Ic(e,n,a,i)}function ho(e){return e=e.prototype,!(!e||!e.isReactComponent)}function Ac(e){if(typeof e=="function")return ho(e)?1:0;if(e!=null){if(e=e.$$typeof,e===vi)return 11;if(e===wi)return 14}return 2}function un(e,n){var a=e.alternate;return a===null?(a=Oe(e.tag,n,e.key,e.mode),a.elementType=e.elementType,a.type=e.type,a.stateNode=e.stateNode,a.alternate=e,e.alternate=a):(a.pendingProps=n,a.type=e.type,a.flags=0,a.nextEffect=null,a.firstEffect=null,a.lastEffect=null),a.childLanes=e.childLanes,a.lanes=e.lanes,a.child=e.child,a.memoizedProps=e.memoizedProps,a.memoizedState=e.memoizedState,a.updateQueue=e.updateQueue,n=e.dependencies,a.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext},a.sibling=e.sibling,a.index=e.index,a.ref=e.ref,a}function st(e,n,a,i,t,r){var o=2;if(i=e,typeof e=="function")ho(e)&&(o=1);else if(typeof e=="string")o=5;else e:switch(e){case Je:return oa(a.children,t,r,n);case is:o=8,t|=16;break;case Kt:o=8,t|=1;break;case va:return e=Oe(12,a,n,t|8),e.elementType=va,e.type=va,e.lanes=r,e;case Ea:return e=Oe(13,a,n,t),e.type=Ea,e.elementType=Ea,e.lanes=r,e;case Ei:return e=Oe(19,a,n,t),e.elementType=Ei,e.lanes=r,e;case Jt:return po(a,t,r,n);case zt:return e=Oe(24,a,n,t),e.elementType=zt,e.lanes=r,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case Yt:o=10;break e;case xt:o=9;break e;case vi:o=11;break e;case wi:o=14;break e;case Qt:o=16,i=null;break e;case jt:o=22;break e}throw Error(T(130,e==null?e:typeof e,""))}return n=Oe(o,a,n,t),n.elementType=e,n.type=i,n.lanes=r,n}function oa(e,n,a,i){return e=Oe(7,e,i,n),e.lanes=a,e}function po(e,n,a,i){return e=Oe(23,e,i,n),e.elementType=Jt,e.lanes=a,e}function Zr(e,n,a){return e=Oe(6,e,null,n),e.lanes=a,e}function Xr(e,n,a){return n=Oe(4,e.children!==null?e.children:[],e.key,n),n.lanes=a,n.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},n}function vc(e,n,a){this.tag=n,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.pendingContext=this.context=null,this.hydrate=a,this.callbackNode=null,this.callbackPriority=0,this.eventTimes=Ar(0),this.expirationTimes=Ar(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Ar(0),this.mutableSourceEagerHydrationData=null}function Ec(e,n,a){var i=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:An,key:i==null?null:""+i,children:e,containerInfo:n,implementation:a}}function wt(e,n,a,i){var t=n.current,r=we(),o=sn(t);e:if(a){a=a._reactInternals;n:{if(vn(a)!==a||a.tag!==1)throw Error(T(170));var s=a;do{switch(s.tag){case 3:s=s.stateNode.context;break n;case 1:if(Te(s.type)){s=s.stateNode.__reactInternalMemoizedMergedChildContext;break n}}s=s.return}while(s!==null);throw Error(T(171))}if(a.tag===1){var l=a.type;if(Te(l)){a=Il(a,l,s);break e}}a=s}else a=an;return n.context===null?n.context=a:n.pendingContext=a,n=rn(r,o),n.payload={element:e},i=i===void 0?null:i,i!==null&&(n.callback=i),on(t,n),ln(t,o,r),o}function Do(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function Lu(e,n){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var a=e.retryLane;e.retryLane=a!==0&&a<n?a:n}}function Uo(e,n){Lu(e,n),(e=e.alternate)&&Lu(e,n)}function wc(){return null}function Lo(e,n,a){var i=a!=null&&a.hydrationOptions!=null&&a.hydrationOptions.mutableSources||null;if(a=new vc(e,n,a!=null&&a.hydrate===!0),n=Oe(3,null,null,n===2?7:n===1?3:0),a.current=n,n.stateNode=a,_r(n),e[$n]=a.current,pl(e.nodeType===8?e.parentNode:e),i)for(e=0;e<i.length;e++){n=i[e];var t=n._getVersion;t=t(n._source),a.mutableSourceEagerHydrationData==null?a.mutableSourceEagerHydrationData=[n,t]:a.mutableSourceEagerHydrationData.push(n,t)}this._internalRoot=a}Lo.prototype.render=function(e){wt(e,this._internalRoot,null,null)};Lo.prototype.unmount=function(){var e=this._internalRoot,n=e.containerInfo;wt(null,e,null,function(){n[$n]=null})};function ci(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function Cc(e,n){if(n||(n=e?e.nodeType===9?e.documentElement:e.firstChild:null,n=!(!n||n.nodeType!==1||!n.hasAttribute("data-reactroot"))),!n)for(var a;a=e.lastChild;)e.removeChild(a);return new Lo(e,0,n?{hydrate:!0}:void 0)}function Ct(e,n,a,i,t){var r=a._reactRootContainer;if(r){var o=r._internalRoot;if(typeof t=="function"){var s=t;t=function(){var d=Do(o);s.call(d)}}wt(n,o,e,t)}else{if(r=a._reactRootContainer=Cc(a,i),o=r._internalRoot,typeof t=="function"){var l=t;t=function(){var d=Do(o);l.call(d)}}Pu(function(){wt(n,o,e,t)})}return Do(o)}Cs=function(e){if(e.tag===13){var n=we();ln(e,4,n),Uo(e,4)}};mr=function(e){if(e.tag===13){var n=we();ln(e,67108864,n),Uo(e,67108864)}};Ms=function(e){if(e.tag===13){var n=we(),a=sn(e);ln(e,a,n),Uo(e,a)}};Os=function(e,n){return n()};sr=function(e,n,a){switch(n){case"input":if($t(e,a),n=a.name,a.type==="radio"&&n!=null){for(a=e;a.parentNode;)a=a.parentNode;for(a=a.querySelectorAll("input[name="+JSON.stringify(""+n)+'][type="radio"]'),n=0;n<a.length;n++){var i=a[n];if(i!==e&&i.form===e.form){var t=Bi(i);if(!t)throw Error(T(90));os(i),$t(i,t)}}}break;case"textarea":hs(e,a);break;case"select":n=a.value,n!=null&&Kn(e,!!a.multiple,n,!1)}};lr=Nu;Ts=function(e,n,a,i,t){var r=U;U|=4;try{return Mn(98,e.bind(null,n,a,i,t))}finally{U=r,U===0&&(ca(),De())}};ur=function(){(U&49)==0&&(pc(),gn())};As=function(e,n){var a=U;U|=2;try{return e(n)}finally{U=a,U===0&&(ca(),De())}};function Fu(e,n){var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!ci(n))throw Error(T(200));return Ec(e,n,null,a)}var Mc={Events:[Wa,qn,Bi,ys,ks,gn,{current:!1}]},gi={findFiberByHostInstance:En,bundleType:0,version:"17.0.2",rendererPackageName:"react-dom"},Oc={bundleType:gi.bundleType,version:gi.version,rendererPackageName:gi.rendererPackageName,rendererConfig:gi.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:Tn.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=Es(e),e===null?null:e.stateNode},findFiberByHostInstance:gi.findFiberByHostInstance||wc,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__!="undefined"&&(mi=__REACT_DEVTOOLS_GLOBAL_HOOK__,!mi.isDisabled&&mi.supportsFiber))try{Kr=mi.inject(Oc),Cn=mi}catch(e){}var mi,Wc=Mc,Bc=Fu,Nc=function(e){if(e==null)return null;if(e.nodeType===1)return e;var n=e._reactInternals;if(n===void 0)throw typeof e.render=="function"?Error(T(188)):Error(T(268,Object.keys(e)));return e=Es(n),e=e===null?null:e.stateNode,e},Pc=function(e,n){var a=U;if((a&48)!=0)return e(n);U|=1;try{if(e)return Mn(99,e.bind(null,n))}finally{U=a,De()}},Gc=function(e,n,a){if(!ci(n))throw Error(T(200));return Ct(null,e,n,!0,a)},Rc=function(e,n,a){if(!ci(n))throw Error(T(200));return Ct(null,e,n,!1,a)},Dc=function(e){if(!ci(e))throw Error(T(40));return e._reactRootContainer?(Pu(function(){Ct(null,null,e,!1,function(){e._reactRootContainer=null,e[$n]=null})}),!0):!1},Uc=Nu,Lc=function(e,n){return Fu(e,n,2<arguments.length&&arguments[2]!==void 0?arguments[2]:null)},Fc=function(e,n,a,i){if(!ci(a))throw Error(T(200));if(e==null||e._reactInternals===void 0)throw Error(T(38));return Ct(e,n,a,!1,i)},Hc="17.0.2",bc={__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:Wc,createPortal:Bc,findDOMNode:Nc,flushSync:Pc,hydrate:Gc,render:Rc,unmountComponentAtNode:Dc,unstable_batchedUpdates:Uc,unstable_createPortal:Lc,unstable_renderSubtreeIntoContainer:Fc,version:Hc},Kc=Ve(function(e){function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__=="undefined"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(a){console.error(a)}}n(),e.exports=bc}),Fo=Kc.render;var Ho=Symbol(),bo=Symbol(),Ko=Symbol(),Mt=Symbol();function Gn(e,n){function a(...i){if(i.length>=e.length)return e(...i);{let t=(...r)=>a(...i,...r);return t[Ho]=e,t[bo]=a,t[Ko]=i,t[Mt]=a[Mt],t}}return a[Ho]=e,a[bo]=a,a[Ko]=[],a[Mt]=n||Hu(e),a}function Yo(e){return e[Ho]}function Yc(e){return e[bo]}function Ot(e){return e[Ko]||[]}function Hu(e){return e[Mt]||e.name}function Qc(){let e=[];return{test:n,getAllTests:a};function n(i,t){e.push(...Object.entries(t).map(([r,o])=>xc(i,r,o)))}function a(){return e}}function S(e,n,...a){let i=n(...a,e);if(typeof i=="function")throw new Error("The matcher function `"+xo(i)+"` returned a function instead of a boolean. You might need to pass another argument to it.");if(!i)throw new Wt([e,n,...a])}function xc(e,n,a){return{subject:e,scenario:n,fn:a}}var Wt=class extends Error{constructor(n){super("Expectation failed");this.expectArgs=n}};function jc(e){return e[e.length-1]}function bu(e){return e[0]}var Vc=Gn(function(e,n){return e(n)},"which"),K=Gn(function(e,n){var a,i;if(Jc(e))return e(n);if(Array.isArray(e)&&Array.isArray(n))return e.length===n.length&&e.every((t,r)=>K(e[r],n[r]));if(e instanceof Function&&n instanceof Function)return Yo(e)&&Yo(e)===Yo(n)?K(Ot(e),Ot(n)):e===n;if(e instanceof Date&&n instanceof Date)return e.toISOString()===n.toISOString();if(e instanceof Set&&n instanceof Set)return e.size===n.size&&[...e.values()].every(t=>n.has(t));if(e instanceof Error&&n instanceof Error)return e.message===n.message&&e.__proto__.constructor===n.__proto__.constructor;if(Ku(e)&&Ku(n)){let t=Object.keys(e),r=Object.keys(n);return t.length===r.length&&t.every(o=>K(e[o],n[o]))&&((a=e.__proto__)==null?void 0:a.constructor)===((i=n.__proto__)==null?void 0:i.constructor)}return e===n},"equals"),I=Gn(function(e,n){return e===n},"is"),Qo=Gn(function(e,n,...a){return!e(n,...a)},"not"),Yu=Gn(function(e){return/^\s*$/.test(e)},"isBlank");function Ku(e){return!!e&&typeof e=="object"}function Jc(e){return e instanceof Function&&Yc(e)===Vc&&Ot(e).length===1}function xo(e){return Hu(e)||"<function>"}function Qu(e){let n=[];return a(e);function a(l){var d;if(l===null)return"null";if(typeof l=="function")return i(l,t);if(typeof l=="string")return jo(l);if(typeof l=="bigint")return`${l}n`;if(Array.isArray(l))return i(l,r);if(l instanceof Date)return`Date(${l.toISOString().replace("T"," ").replace("Z"," UTC")})`;if(l instanceof RegExp)return String(l);if(l instanceof Error)return`${xu(l)}(${jo(l.message)})`;if(l instanceof Set)return i(l,s);if(typeof l=="object"){let k=(d=l==null?void 0:l.__proto__)==null?void 0:d.constructor;return k===Object||!k?i(l,o):`${xu(l)} ${i(l,o)}`}return String(l)}function i(l,d){if(n.indexOf(l)>-1)return"<circular reference>";n.push(l);let k=d(l);return n.pop(),k}function t(l){let d=Ot(l).map(a),k=xo(l);return d.length?pi(k+"(",d,",",")"):k}function r(l){return pi("[",l.map(a),",","]")}function o(l){let d=Object.entries(l).map(([k,N])=>`${zc(k)}: ${a(N)}`);return pi("{",d,",","}")}function s(l){let d=[...l.values()].map(a);return pi("Set {",d,",","}")}}function zc(e){return/^[a-zA-Z0-9_$]+$/.test(e)?e:jo(e)}function xu(e){return xo(e.__proto__.constructor)}function jo(e){return'"'+String(e).replace(/\\/g,"\\\\").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/"/g,'\\"').replace(/[\x00-\x1f\x7f]/g,_c)+'"'}function _c(e){let n=e.charCodeAt(0).toString(16);return"\\x"+(n.length<2?"0"+n:n)}function Bt(e,n){return n.split(`
`).map(a=>a&&Zc(qc(e," "))(a)).join(`
`)}function qc(e,n){return Array(e+1).join(n)}var Zc=e=>n=>e+n,Xc=Gn(function(n,a){return a.slice(0,n.length)===n?a.slice(n.length):a});function $c(e){return String(e).split(/\r?\n/)}function eg(e){let n=$c(e);Yu(bu(n))&&n.shift(),Yu(jc(n))&&n.pop();let a=/^[ \t]*/.exec(bu(n))[0];return n.map(Xc(a)).join(`
`)}function pi(e,n,a,i){return n.length<2?e+n.join("")+i:e+`
`+Bt(2,n.join(a+`
`))+`
`+i}function Vu(e){return Ii(this,null,function*(){let n=[];for(let a of e){let i=yield ng(a.fn),t=ju.map(r=>({type:"debug",args:r}));ju.length=0,n.push({test:a,error:i,instrumentLog:t})}return{results:n}})}function ng(e){let n;try{let a=e();if(a instanceof Promise)return new Promise(i=>{a.then(()=>i()).catch(i)})}catch(a){n=a}return Promise.resolve(n)}var ju=[],pm=Gn(function(n,a){return a instanceof Wt&&K(n,a.expectArgs)}),Nt=`

`;function Ju({results:e}){let n=!1,a=!1,i=[];for(let t of e){let r=!1;t.error&&(r=n=!0),t.instrumentLog.length&&(r=a=!0),r&&i.push(t)}return n?ag(i):a?tg(e.length,i):ig(e.length)}function ag(e){return e.map(zu).join(Nt)+Nt+"Tests failed."}function ig(e){switch(e){case 0:return"No tests to run.";case 1:return"One test ran, and found no issues.";default:return`${e} tests ran, and found no issues.`}}function tg(e,n){return n.map(zu).join(Nt)+Nt+rg(e)+`, but debugging instrumentation is present.
Remove it before shipping.`}function rg(e){switch(e){case 1:return"The test passed";case 2:return"Both tests passed";default:return`All ${e} tests passed`}}function zu({test:e,error:n,instrumentLog:a}){let t=[e.subject+" "+e.scenario];return a.length&&t.push(Bt(2,sg(a))),n&&t.push(Bt(2,og(n))),t.join(`
`)}function og(e){return e instanceof Wt?lg(e):ug(e)}function sg(e){return e.map(({args:n})=>_u("debug",n)).join("")}function lg(e){return _u("expect",e.expectArgs)}function ug(e){return Qu(e)+" thrown"+Bt(2,dg(e.stack))}function _u(e,n){return pi(e+"(",n.map(Qu),",",")")}function dg(e){if(!e)return"";let n=eg(e).split(`
`);return`
`+n.slice(0,hg(n)).map(a=>a.replace(/(file:\/\/|http:\/\/[^/]*)/,"").replace(/^([^@]*)@(.*)$/,"at $1 ($2)")).join(`
`)}function hg(e){let n=e.findIndex(a=>a.includes("errorFrom"));return n===-1?e.length:n}var fm=Object.freeze({test:{subject:"a thing",scenario:"does something",fn(){}},error:void 0,instrumentLog:[]}),cg=Qc(),{getAllTests:qu}=cg;function z(...e){}function mn(){return(+new Date%1e6/1e3).toFixed(3)}function x(e,n=0){return isNaN(e)||e===Infinity||e===-Infinity?"--:--":e<0?"-"+Zu(-e,n):Zu(e,n)}function Zu(e,n){function a(o,s=gg){return(o<10?"0":"")+s(o)}let i=Math.floor(e/3600),t=Math.floor(e%3600/60),r=e%60;return i>0?`${i}:${a(t)}:${a(r,Xu(n))}`:`${t}:${a(r,Xu(n))}`}z("hoursMinutesSeconds",{"formats NaN"(){S(x(0/0),I,"--:--")},"formats Infinities"(){S(x(Infinity),I,"--:--"),S(x(-Infinity),I,"--:--")},"formats negative numbers"(){S(x(-1),I,"-0:01"),S(x(-3661.12,2),I,"-1:01:01.12")},"formats single-digit seconds with leading zero"(){S(x(0),I,"0:00"),S(x(1),I,"0:01"),S(x(9),I,"0:09")},"formats double-digit seconds"(){S(x(10),I,"0:10"),S(x(59),I,"0:59")},"formats minutes"(){S(x(60),I,"1:00"),S(x(61),I,"1:01"),S(x(119),I,"1:59"),S(x(120),I,"2:00"),S(x(3599),I,"59:59")},"formats hours"(){S(x(3600),I,"1:00:00"),S(x(7200),I,"2:00:00"),S(x(3661),I,"1:01:01"),S(x(3610),I,"1:00:10"),S(x(3600+600),I,"1:10:00"),S(x(36001),I,"10:00:01")},"adds decimal places"(){S(x(0,0),I,"0:00"),S(x(0,1),I,"0:00.0"),S(x(0,2),I,"0:00.00")},"formats fractional seconds"(){S(x(1.23,2),I,"0:01.23")},"rounds decimals"(){S(x(2.3456,2),I,"0:02.35")}});var gg=e=>e,Xu=e=>n=>n.toFixed(e);function ma(e){var n;return(n=/v=(.{11})/.exec(e))==null?void 0:n[1]}function $u(){return{getPlayerState(){return re.UNSTARTED},getCurrentTime(){return 0},getVideoUrl(){return""},cueVideoById(){},playVideo(){},seekTo(){},getDuration(){return 0},addEventListener(){},removeEventListener(){}}}function ed(e){return{getPlayerState(){return e.getPlayerState()},getCurrentTime(){return e.getCurrentTime()},getVideoUrl(){return e.getVideoUrl()},cueVideoById(...n){return console.debug(mn(),"player.cueVideoById",...n),e.cueVideoById(...n)},playVideo(...n){return console.debug(mn(),"player.playVideo",...n),e.playVideo(...n)},seekTo(...n){return console.debug(mn(),"player.seekTo",...n,ma(e.getVideoUrl())),e.seekTo(...n)},getDuration(){return e.getDuration()},addEventListener(...n){return console.debug(mn(),"player.addEventListener"),e.addEventListener(...n)},removeEventListener(...n){return console.debug(mn(),"player.removeEventListener"),e.removeEventListener(...n)}}}var re={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};function nd(e){return Ii(this,null,function*(){let n=yield mg();return new Promise(a=>{let i=new n.Player(e,{height:450,width:800,videoId:null,playerVars:{controls:0,disablekb:1},events:{onReady(){a(i)}}})})})}function mg(){return ad?Promise.resolve(window.YT):new Promise(e=>{var n;if(document.querySelector("script[src='https://www.youtube.com/iframe_api']")===null){let a=document.createElement("script");a.src="https://www.youtube.com/iframe_api";let i=document.getElementsByTagName("script")[0];(n=i.parentNode)==null||n.insertBefore(a,i)}Vo.push(e)})}var ad=!1,Vo=[];window.onYouTubeIframeAPIReady=()=>{ad=!0,Vo.forEach(e=>e(window.YT)),Vo.length=0};function id(e,n){let a=Ta(),i=Ta();i.current=e,Fn(()=>(a.current=setInterval(()=>{var t;return(t=i.current)==null?void 0:t.call(i)},n),()=>clearInterval(a.current)),[n])}function td(){let[e,n]=Ne(!1);return[e,()=>n(!0)]}function fi(e){switch(e){case re.BUFFERING:return"buffering";case re.UNSTARTED:return"unstarted";case re.CUED:return"cued";case re.ENDED:return"ended";case re.PLAYING:return"playing";case re.PAUSED:return"paused";default:return""}}function rd(e){return e.channel.getName()+" "+fi(e.code)}function Si(e){try{e()}catch(n){return n}}function pa(e,n){if(e.length===0)throw new Error("can't pick element from an empty array");if(n>=1||n<0)throw new Error("fraction out of bounds: "+n);return e[Math.floor(n*e.length)]}z("pick",{"throws if the array is empty"(){S(Si(()=>pa([],0)),K,new Error("can't pick element from an empty array"))},"throws if the fraction is 1"(){S(Si(()=>pa([""],1)),K,new Error("fraction out of bounds: 1"))},"throws if the fraction is > 1"(){S(Si(()=>pa([""],1.25)),K,new Error("fraction out of bounds: 1.25"))},"throws if the fraction is > 0"(){S(Si(()=>pa([""],-.25)),K,new Error("fraction out of bounds: -0.25"))},"picks the first element of the array given 0"(){S(pa([1,2],0),I,1)},"picks the last element of the array given 1 - epsilon"(){S(pa([1,2],.99),I,2)}});function Pt(e){return e.length===0}function fa(e,n){let a={};return i=>(i in a||(Object.keys(a).length===e&&(a={}),a[i]=n(i)),a[i])}z("cache",{"caches a value"(){let e=0,n=fa(1,()=>(e++,123));n("foo"),n("foo"),S(e,I,1)},"computes and caches values by key"(){let e=fa(2,n=>n+"x");S(e("foo"),I,"foox"),S(e("bar"),I,"barx")},"caches multiple values"(){let e=0,n=fa(2,a=>(e++,a+"x"));n("foo"),n("foo"),n("bar"),n("bar"),S(e,I,2),S(n("foo"),I,"foox"),S(n("bar"),I,"barx")},"a max size of 0 means no limit"(){let e=0,n=fa(0,()=>(e++,123));n("a"),n("b"),n("c"),S(e,I,3)}});function yi(e){let n=1779033703,a=3144134277,i=1013904242,t=2773480762;for(let r=0,o;r<e.length;r++)o=e.charCodeAt(r),n=a^Math.imul(n^o,597399067),a=i^Math.imul(a^o,2869860233),i=t^Math.imul(i^o,951274213),t=n^Math.imul(t^o,2716044179);return n=Math.imul(i^n>>>18,597399067),a=Math.imul(t^a>>>22,2869860233),i=Math.imul(n^i>>>17,951274213),t=Math.imul(a^t>>>19,2716044179),[(n^a^i^t)>>>0,(a^n)>>>0,(i^n)>>>0,(t^n)>>>0]}z("cyrb128_32",{"hashes unix timestamps to random-looking values"(){S(yi("1661673600"),K,[1866196007,1194674827,898714046,497018642]),S(yi("1661760000"),K,[3655929289,901600698,732811234,3355023249]),S(yi("1661846400"),K,[2165297363,2940322590,3636107238,4143219755])}});function Gt(e,n,a,i){function t(){e|=0,n|=0,a|=0,i|=0;var r=(e+n|0)+i|0;return i=i+1|0,e=n^n>>>9,n=a+(a<<3)|0,a=a<<21|a>>>11,a=a+r|0,(r>>>0)/4294967296}for(let r=0;r<20;r++)t();return t}z("sfc32",{"flips coins fairly"(){let e=0,n=0,a=Gt(0,0,0,0);for(let i=0;i<200;i++)a()<.5?e++:n++;S(e-n,I,-8)},"generates a reasonably uniform distribution of numbers"(){let e=new Set,n=Gt(0,0,0,0);for(let a=0;a<100;a++)e.add(Math.floor(n()*1e4));S(e.size,I,99)}});function $(e,n){let a=-1,i=e.length-1;for(;a<i;){let t=pg(a,i);n(e[t])?a=t:i=t-1}return e[a]}function pg(e,n){return Math.ceil((e+n)/2)}z("binarySearch",{"returns undefined given an empty array"(){S($([],()=>!1),I,void 0)},"returns an element that is to the left of the target"(){S($([1],()=>!0),I,1)},"returns undefined when the only element is not left of the target"(){S($([1],()=>!1),I,void 0)},"returns the rightmost element that is left of the target"(){S($([1,2,3,4],e=>e<=2.5),I,2)},"works with duplicates"(){S($([0,1,2,3,0,0,0,0,0],e=>e>0),I,3)},"works with two elements"(){S($([1,2],e=>e<=1.5),I,1),S($([1,2],e=>e<=2),I,2)},"works with three elements"(){S($([1,2,3],e=>e<=1.5),I,1),S($([1,2,3],e=>e<=2),I,2),S($([1,2,3],e=>e<=3),I,3)},"works with four elements"(){S($([1,2,3,4],e=>e<=1.5),I,1),S($([1,2,3,4],e=>e<=2),I,2),S($([1,2,3,4],e=>e<=3),I,3),S($([1,2,3,4],e=>e<=4),I,4)},"works with five elements"(){S($([1,2,3,4,5],e=>e<=1.5),I,1),S($([1,2,3,4,5],e=>e<=2),I,2),S($([1,2,3,4,5],e=>e<=3),I,3),S($([1,2,3,4,5],e=>e<=4),I,4),S($([1,2,3,4,5],e=>e<=5),I,5)}});var Sa=(...e)=>e.reduce(fg);z("pipe",{"given one function"(){S(Sa(n=>n+1)(1),I,2)},"given two functions"(){let e=n=>n+1;S(Sa(e,e)(1),I,3)}});function fg(e,n){return(...a)=>n(e(...a))}function Rt(e){return n=>n.map(e)}function od(e){return e.trim()}var ya=Rt(Sa(oe,Jo));function Jo(e){return{videos:e}}function oe(e){return e.split(/\n+/).map(od).filter(Qo(Sg)).filter(Qo(Pt)).map(ki(/ +/,3)).flatMap(([n,a,i])=>a==="SHORTS"?[]:[{videoId:n,timeWindow:yg(a),title:i}])}function Rn(e){return{start:0,end:e}}function Dt(e,n){return{start:e,end:n}}z("parseVideos",{"empty string"(){S(oe(""),K,[])},spaces(){S(oe("  "),K,[])},newlines(){S(oe(`


`),K,[])},"newlines and spaces"(){S(oe(` 
 
 
`),K,[])},comments(){S(oe(`#foo
# bar`),K,[])},"strips spaces before comments"(){S(oe(`  #foo
  # bar`),K,[])},"parses actual data"(){S(oe(`
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
      Ga8tNxnHjt4 3:01 Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971
    `),K,[{videoId:"leb645Xu6uo",timeWindow:{start:0,end:654},title:"Captain Murderer - Emlyn Williams"},{videoId:"Ga8tNxnHjt4",timeWindow:{start:0,end:181},title:"Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971"}])},"parses time ranges"(){S(oe(`
      leb645Xu6uo 1:01-5:00 The Title
    `),K,[{videoId:"leb645Xu6uo",timeWindow:{start:61,end:300},title:"The Title"}])},"removes shorts"(){S(oe(`
      undefined SHORTS blah blah
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
    `),K,[{videoId:"leb645Xu6uo",timeWindow:{start:0,end:654},title:"Captain Murderer - Emlyn Williams"}])}});function Sg(e){return e.startsWith("#")}function yg(e){let n=e.split("-");return n.length===1?Rn(ve(n[0])):Dt(ve(n[0]),ve(n[1]))}function ve(e){let n=[1,60,3600,86400],a=e.split(":").map(i=>parseInt(i,10)).reverse();return kg(a,n).map(([i,t])=>i*t).reduce(Tg,0)}z("parseDuration",{"0:00"(){S(ve("0:00"),I,0)},"00:00"(){S(ve("00:00"),I,0)},"1 second"(){S(ve("0:01"),I,1)},"10 seconds"(){S(ve("0:10"),I,10)},"1 minute"(){S(ve("1:00"),I,60)},"1 minute 10 seconds"(){S(ve("1:10"),I,70)},"10 minutes 10 seconds"(){S(ve("10:10"),I,610)},"1 hour"(){S(ve("1:00:00"),I,3600)},"1 hour 1 second"(){S(ve("1:00:01"),I,3601)},"10 hours 1 second"(){S(ve("10:00:01"),I,36001)},"1 day 1 second"(){S(ve("1:0:00:01"),I,86401)}});var ki=(e,n=Infinity)=>a=>{if(typeof e=="string"&&e.length===0)throw"split(): empty delimiter not supported";let i=0,t=0,r=[],o=a;for(;r.length<n-1&&o.length>0;){let s=o.match(e);if(s==null)break;r.push(o.slice(0,s.index)),o=o.slice(s.index+s[0].length)}return r.push(o),r};z("split",{"empty string"(){S(ki(" ")(""),K,[""])},"no limit"(){S(ki(" ")("a b c"),K,["a","b","c"])},limit(){S(ki(" ",2)("a b c"),K,["a","b c"])},regex(){S(ki(/ +/)("a b   c"),K,["a","b","c"])}});function kg(e,n){let a=[];for(let i=0;i<e.length&&i<n.length;i++)a.push([e[i],n[i]]);return a}function Tg(e,n){return e+n}function zo(e){return e.timeWindow.end-e.timeWindow.start}z("duration",{"is the difference between the timeWindow's start and end"(){S(zo({videoId:"",title:"",timeWindow:{start:50,end:99}}),I,49)}});var Ti=2,sd=24*3600,ld=8*3600;function pn(e,n){let a=fa(1,Ai(n));return{getBroadcast:i,getName(){return e}};function i(t){var k;let r=t/1e3,o=(r-ld)%sd,s=r-o,l=a(String(s)),d=$(l,N=>N.startSecondOfDay<=o);return(d==null?void 0:d.type)==="video"?{type:"video",videoId:d.videoId,videoTitle:d.videoTitle,currentTime:o-d.startSecondOfDay+d.startSecondOfVideo}:{type:"nothing",nextVideoId:(k=d==null?void 0:d.nextVideoId)!=null?k:""}}}var Ai=e=>n=>{if(Pt(e))return[];e=[...e];let a=Gt(...yi(n)),i=0,t=[],r=0;for(;i<sd;){r===e.length&&(r=0),Ag(e,r,_o(r,e.length-1,a));let o=e[r++];for(let s of o.videos)t.push({type:"nothing",startSecondOfDay:i,nextVideoId:s.videoId},{type:"video",videoId:s.videoId,videoTitle:s.title,startSecondOfDay:i+Ti,startSecondOfVideo:s.timeWindow.start}),i+=zo(s)+Ti}return t};function Ag(e,n,a){let i=e[n];e[n]=e[a],e[a]=i}function _o(e,n,a){return e+Math.floor(a()*(n+1-e))}z("a Channel",{"broadcasts nothing given no episodes"(){let n=pn("",[]);S(n.getBroadcast(999),K,{type:"nothing",nextVideoId:""})},"starts a video when it's supposed to start"(){let e=[{videos:[{timeWindow:Dt(1e3,2e3),videoId:"",title:""}]}],n=pn("",e),a=(ld+5)*1e3;S(n.getBroadcast(a),K,{type:"video",currentTime:1003,videoId:"",videoTitle:""})}});z("randomIntInRange",{"when low and high are the same"(){S(_o(3,3,Math.random),I,3)},"when low and high are 1 apart"(){let e=new Set;for(let n=0;n<30;n++)e.add(_o(0,1,Math.random));S(e,K,new Set([0,1]))}});z("ScheduleGenerator",{"schedules a single 24-hour video"(){let e=[{videos:[{timeWindow:Rn(3600*24),videoId:"the-video-id",title:"the-title"}]}],n=Ai(e);S(n(""),K,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:2,startSecondOfVideo:0}])},"schedules a 12-hour video twice"(){let e=[{videos:[{timeWindow:Rn(3600*12),videoId:"the-video-id",title:"the-title"}]}],n=Ai(e);S(n(""),K,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:2,startSecondOfVideo:0},{type:"nothing",startSecondOfDay:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:43204,startSecondOfVideo:0}])},"schedules a time window of a video"(){let e=[{videos:[{timeWindow:Dt(3600,3600*13),videoId:"the-video-id",title:"the-title"}]}],n=Ai(e);S(n(""),K,[{type:"nothing",startSecondOfDay:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:2,startSecondOfVideo:3600},{type:"nothing",startSecondOfDay:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startSecondOfDay:43204,startSecondOfVideo:3600}])},"picks the videos to show randomly"(){let e=[{videos:[{timeWindow:Rn(3600*2),videoId:"one",title:""}]},{videos:[{timeWindow:Rn(3600*2),videoId:"two",title:""}]},{videos:[{timeWindow:Rn(3600*2),videoId:"three",title:""}]}],n=Ai(e);S(n("asdfx").map(a=>a.videoId).filter(Boolean),K,["three","one","two","three","two","one","one","two","three","two","three","one"])}});var ud=ya(["BecZdQvjGrY 54:49 In Gowan Ring - Compendium (Full Album)","B3oAx9VmAdA 43:52 In Gowan Ring - Hazel Steps Through A Weathered Home",`
  ...
  `,"Gf1RHyuuLnI 4:59 Kirsten Bråten Berg - Heiemo og Nykkjen(folkesang)","Tt8p5AxJn18 4:14 Sinéad O'Connor - Mna na h Eireann (Women of Ireland)","HgwypQ_9_DE 4:25 Ripoff Raskolnikov - Azt gondoltam eső esik (Live at Paks)","apE1n63ZhMQ 3:39 Muzsikás: Repülj madár, repülj (Fly Bird, fly) + pics of Hollókő (read the info)","8n5u_IfVLd0 5:45 Cirque Du Soleil O, Gamelan"]);var dd=ya([`
...
g8twezOz2h4 0:03 WGBH Boston | Title Card | 2003 | PBS Kids
g8twezOz2h4 0:03 WGBH Boston | Title Card | 2003 | PBS Kids
`),cd=dd.concat(ya([`# Elif'in Hecesi
...
`),fd=Rt(Sa(oe,Jo))([`
  ...
  `]);var Lt=[pn("Channel 1",[...cd,...hd.map(Ut)]),pn("Channel 2",gd.map(Ut)),pn("Channel 3",ud),pn("Channel 4",md.map(Ut)),pn("🎄",[...fd,...pd.map(Ut)])];function Ut(e){return{videos:[e]}}function Sd(e){return E(Ln,null,Lt.map(n=>E("button",{key:n.getName(),onClick:()=>e.onChannelSelected(n)},n.getName())))}function yd(){let[e,n]=Ne(+new Date);return id(()=>n(+new Date),250),e}function kd(e=""){return{type:"nothing",nextVideoId:e}}function Td(e,n){let{state:a,videoId:i,time:t}=n;if(e.type==="nothing")switch(a){case re.ENDED:case re.CUED:case re.UNSTARTED:return e.nextVideoId?i!==e.nextVideoId?[{type:"cue",videoId:e.nextVideoId,timestamp:0}]:[{type:"seek",timestamp:0},{type:"play"}]:[];default:return[]}else{if(a===re.BUFFERING)return[];let{videoId:r,currentTime:o}=e;if(i!==r)return[{type:"cue",videoId:r,timestamp:o<Ti?0:o}];{let s=[];switch(a){case re.PAUSED:case re.CUED:case re.UNSTARTED:i&&s.push({type:"play"})}return t&&Ig(t,o)>=Ti&&(console.debug("time is off; seeking",t,o),s.push({type:"seek",timestamp:o})),s}}}function Ig(e,n){return Math.abs(e-n)}var vg=0;function Eg(){let[,e]=Ne(0);return()=>e(++vg)}function Ad(e){let n=Eg(),a=Ta($u());return Fn(()=>{nd(e).then(i=>{a.current=i,i.addEventListener("onStateChange",t=>{console.debug(mn(),"player onStateChange",fi(t.data),ma(i.getVideoUrl())),n()}),n()})},[e]),a.current}var Id="javascript:(function()%7Bfunction%20last(e)%7Breturn%20e%5Be.length-1%5D%7Dvideos%3D%2F%5C%2Fwatch%5C%3F%2F.test(window.location)%3F%5B%2Fv%3D(.%7B11%7D)%2F.exec(window.location)%3F.%5B1%5D%2Clast(document.querySelectorAll(%22.ytp-time-duration%22)).innerText.trim()%2Cdocument.querySelector(%22.title%20.ytd-video-primary-info-renderer%22).innerText.split(%22%5Cn%22)%5B0%5D.trim()%5D.join(%22%20%22)%3A%2F%5C%2Fplaylist%5C%3F%2F.test(window.location)%3F%5B...document.querySelectorAll(%22ytd-playlist-video-renderer%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22a%23video-title%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Ci%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Cn%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bi%7D%20%24%7Bn%7D%60%7D)).join(%22%5Cn%22)%3A%5B...document.querySelectorAll(%22ytd-rich-grid-media%22)%5D.map((e%3D%3E%7Bconst%20t%3De.querySelector(%22%23thumbnail%22)%3F.href%3F%3F%22%22%2Cr%3D%2Fv%3D(.%7B11%7D)%2F.exec(t)%3F.%5B1%5D%2Ci%3De.querySelector(%22span%23text.ytd-thumbnail-overlay-time-status-renderer%22)%3F.innerText.trim()%2Cn%3De.querySelector(%22%23video-title%22)%3F.innerText%3Breturn%60%24%7Br%7D%20%24%7Bi%7D%20%24%7Bn%7D%60%7D)).join(%22%5Cn%22)%2Cconsole.log(videos)%2Cnavigator.clipboard.writeText(videos).catch((e%3D%3Econsole.error(e)))%3B%7D)()";function wg({broadcast:e,player:n}){var i;let a=t=>x(t,2);return{videoLink:e.type==="video"?{text:e.videoTitle,href:"https://youtube.com/watch?v="+e.videoId}:null,actual:{video:(i=n.videoId)!=null?i:"",playerState:fi(n.state),currentTime:n.time!=null?a(n.time):"-"},scheduled:{video:e.type==="video"?e.videoId:"-",playerState:e.type,currentTime:e.type==="video"?a(e.currentTime):"-"},secondsBehindSchedule:e.type==="video"&&n.time!=null?(e.currentTime-n.time).toFixed(2):"-",timeRemainingInVideo:n.duration!=null&&n.time!=null?a(n.duration-n.time):"-"}}function vd(e){let{broadcast:n,player:a,onClose:i}=e,t=wg({broadcast:n,player:a});return E(Ln,null,E("button",{className:"close-button",onClick:i},"close"),E("h1",null,"Culture Machine"),E("p",null,"Made by ",E("a",{href:"https://github.com/benchristel"},"Ben Christel"),"."," ",E("a",{href:"https://github.com/benchristel/tv"},"Source code here"),". Some rights reserved. See the"," ",E("a",{href:"https://www.gnu.org/licenses/gpl-3.0.en.html"},"license"),"."),E("p",null,E("a",{href:Id},"Bookmarklet to scrape videos from YouTube")," ","(",E("a",{href:"https://github.com/benchristel/tv#what-is-a-bookmarklet"},"What's this?"),")"),E("hr",null),E("h2",null,"Video Info"),E("p",{style:{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},"Now playing:"," ",t.videoLink?E("a",{href:t.videoLink.href},t.videoLink.text):"-"),E("table",null,E("thead",null,E("tr",null,E("td",null),E("th",{scope:"col"},"actual"),E("th",{scope:"col"},"scheduled"))),E("tbody",null,E("tr",null,E("th",{scope:"row"},"video"),E("td",null,t.actual.video),E("td",null,t.scheduled.video)),E("tr",null,E("th",{scope:"row"},"player state"),E("td",null,t.actual.playerState),E("td",null,t.scheduled.playerState)),E("tr",null,E("th",{scope:"row"},"current time"),E("td",null,t.actual.currentTime),E("td",null,t.scheduled.currentTime)))),E("p",null,"Seconds behind schedule: ",t.secondsBehindSchedule),E("p",null,"Time remaining in video: ",t.timeRemainingInVideo))}var qo=class extends Xo{componentDidUpdate(){let{player:n,commands:a}=this.props;a.forEach(i=>{switch(i.type){case"play":n.playVideo();break;case"cue":n.cueVideoById(i.videoId,i.timestamp);break;case"seek":n.seekTo(i.timestamp);break;default:console.error("unexpected video command type",i.type,i)}})}render(){return null}};function Ed(e){return{state:e.getPlayerState(),videoId:ma(e.getVideoUrl()),time:e.getCurrentTime(),duration:e.getDuration()}}function wd(){let[e,n]=td(),[a,i]=Ne(!1),[t,r]=Ne(Lt[0]),o=yd(),s=e?t.getBroadcast(o):kd(),l=ed(Ad("player-container")),d=Ed(l),k=d.state,N=k!==re.PLAYING,f=Td(s,d);return E(Cg,{effects:E(qo,{commands:f,player:l}),screen:E("div",{className:a?"info-pane-open":""},E("div",{className:"player-assembly"},E("div",{id:"player-container"}),N&&E("div",{className:"black-screen"},E(rd,{code:k,channel:t})),!e&&E(Mg,{onClick:n})),E("div",{className:"info-pane"},E(vd,{player:d,broadcast:s,onClose:()=>i(!1)})),E("div",{className:"info-pane-close-overlay","aria-hidden":!0,onClick:()=>i(!1)})),controlPanel:E(Ln,null,E(Sd,{onChannelSelected:w=>{r(w),n()}}),E("button",{className:a?"info-button info-button-info-pane-open":"info-button",onClick:()=>i(!a)},"Info"))})}function Cg(e){return E("div",{className:"App"},E("div",{className:"bezel"},E("div",{className:"screen"},e.screen),E("div",{style:{height:"12px"}}),E("div",{className:"controls"},e.controlPanel),e.effects))}function Mg(e){return E("button",{id:"start",onClick:e.onClick},"▸ Play")}function Cd(){let[e,n]=Ne("");return Fn(()=>{Vu(qu()).then(Ju).then(n).catch(a=>n(a.message))},[]),/fail/i.test(e)?E("div",{className:"TestResults"},E("code",null,E("pre",null,e))):null}Fo(E(wd,null),document.getElementById("app"));Fo(E(Cd,null),document.getElementById("test-results"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
