var yt=(e,n,a)=>new Promise((t,i)=>{var r=l=>{try{s(a.next(l))}catch(d){i(d)}},o=l=>{try{s(a.throw(l))}catch(d){i(d)}},s=l=>l.done?t(l.value):Promise.resolve(l.value).then(r,o);s((a=a.apply(e,n)).next())});function je(e,n,a){return a={path:n,exports:{},require:function(t,i){return fd(t,i==null?a.path:i)}},e(a,a.exports),a.exports}function fd(){throw new Error("Dynamic requires are not currently supported by @rollup/plugin-commonjs")}var Jo=Object.getOwnPropertySymbols,Sd=Object.prototype.hasOwnProperty,Td=Object.prototype.propertyIsEnumerable;function yd(e){if(e==null)throw new TypeError("Object.assign cannot be called with null or undefined");return Object(e)}function kd(){try{if(!Object.assign)return!1;var e=new String("abc");if(e[5]="de",Object.getOwnPropertyNames(e)[0]==="5")return!1;for(var n={},a=0;a<10;a++)n["_"+String.fromCharCode(a)]=a;var t=Object.getOwnPropertyNames(n).map(function(r){return n[r]});if(t.join("")!=="0123456789")return!1;var i={};return"abcdefghijklmnopqrst".split("").forEach(function(r){i[r]=r}),Object.keys(Object.assign({},i)).join("")==="abcdefghijklmnopqrst"}catch(r){return!1}}var Ad=kd()?Object.assign:function(e,n){for(var a,t=yd(e),i,r=1;r<arguments.length;r++){a=Object(arguments[r]);for(var o in a)Sd.call(a,o)&&(t[o]=a[o]);if(Jo){i=Jo(a);for(var s=0;s<i.length;s++)Td.call(a,i[s])&&(t[i[s]]=a[i[s]])}}return t},Y=Ad;var Id=je(function(e,n){var a=60103,t=60106;n.Fragment=60107,n.StrictMode=60108,n.Profiler=60114;var i=60109,r=60110,o=60112;n.Suspense=60113;var s=60115,l=60116;if(typeof Symbol=="function"&&Symbol.for){var d=Symbol.for;a=d("react.element"),t=d("react.portal"),n.Fragment=d("react.fragment"),n.StrictMode=d("react.strict_mode"),n.Profiler=d("react.profiler"),i=d("react.provider"),r=d("react.context"),o=d("react.forward_ref"),n.Suspense=d("react.suspense"),s=d("react.memo"),l=d("react.lazy")}var y=typeof Symbol=="function"&&Symbol.iterator;function B(g){return g===null||typeof g!="object"?null:(g=y&&g[y]||g["@@iterator"],typeof g=="function"?g:null)}function f(g){for(var A="https://reactjs.org/docs/error-decoder.html?invariant="+g,H=1;H<arguments.length;H++)A+="&args[]="+encodeURIComponent(arguments[H]);return"Minified React error #"+g+"; visit "+A+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var E={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},N={};function P(g,A,H){this.props=g,this.context=A,this.refs=N,this.updater=H||E}P.prototype.isReactComponent={},P.prototype.setState=function(g,A){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error(f(85));this.updater.enqueueSetState(this,g,A,"setState")},P.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function h(){}h.prototype=P.prototype;function u(g,A,H){this.props=g,this.context=A,this.refs=N,this.updater=H||E}var c=u.prototype=new h;c.constructor=u,Y(c,P.prototype),c.isPureReactComponent=!0;var m={current:null},p=Object.prototype.hasOwnProperty,G={key:!0,ref:!0,__self:!0,__source:!0};function C(g,A,H){var x,T={},v=null,O=null;if(A!=null)for(x in A.ref!==void 0&&(O=A.ref),A.key!==void 0&&(v=""+A.key),A)p.call(A,x)&&!G.hasOwnProperty(x)&&(T[x]=A[x]);var K=arguments.length-2;if(K===1)T.children=H;else if(1<K){for(var L=Array(K),ee=0;ee<K;ee++)L[ee]=arguments[ee+2];T.children=L}if(g&&g.defaultProps)for(x in K=g.defaultProps,K)T[x]===void 0&&(T[x]=K[x]);return{$$typeof:a,type:g,key:v,ref:O,props:T,_owner:m.current}}function W(g,A){return{$$typeof:a,type:g.type,key:A,ref:g.ref,props:g.props,_owner:g._owner}}function U(g){return typeof g=="object"&&g!==null&&g.$$typeof===a}function R(g){var A={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(H){return A[H]})}var z=/\/+/g;function Te(g,A){return typeof g=="object"&&g!==null&&g.key!=null?R(""+g.key):A.toString(36)}function Gn(g,A,H,x,T){var v=typeof g;(v==="undefined"||v==="boolean")&&(g=null);var O=!1;if(g===null)O=!0;else switch(v){case"string":case"number":O=!0;break;case"object":switch(g.$$typeof){case a:case t:O=!0}}if(O)return O=g,T=T(O),g=x===""?"."+Te(O,0):x,Array.isArray(T)?(H="",g!=null&&(H=g.replace(z,"$&/")+"/"),Gn(T,A,H,"",function(ee){return ee})):T!=null&&(U(T)&&(T=W(T,H+(!T.key||O&&O.key===T.key?"":(""+T.key).replace(z,"$&/")+"/")+g)),A.push(T)),1;if(O=0,x=x===""?".":x+":",Array.isArray(g))for(var K=0;K<g.length;K++){v=g[K];var L=x+Te(v,K);O+=Gn(v,A,H,L,T)}else if(L=B(g),typeof L=="function")for(g=L.call(g),K=0;!(v=g.next()).done;)v=v.value,L=x+Te(v,K++),O+=Gn(v,A,H,L,T);else if(v==="object")throw A=""+g,Error(f(31,A==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":A));return O}function se(g,A,H){if(g==null)return g;var x=[],T=0;return Gn(g,x,"","",function(v){return A.call(H,v,T++)}),x}function ie(g){if(g._status===-1){var A=g._result;A=A(),g._status=0,g._result=A,A.then(function(H){g._status===0&&(H=H.default,g._status=1,g._result=H)},function(H){g._status===0&&(g._status=2,g._result=H)})}if(g._status===1)return g._result;throw g._result}var pn={current:null};function le(){var g=pn.current;if(g===null)throw Error(f(321));return g}var fn={ReactCurrentDispatcher:pn,ReactCurrentBatchConfig:{transition:0},ReactCurrentOwner:m,IsSomeRendererActing:{current:!1},assign:Y};n.Children={map:se,forEach:function(g,A,H){se(g,function(){A.apply(this,arguments)},H)},count:function(g){var A=0;return se(g,function(){A++}),A},toArray:function(g){return se(g,function(A){return A})||[]},only:function(g){if(!U(g))throw Error(f(143));return g}},n.Component=P,n.PureComponent=u,n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=fn,n.cloneElement=function(g,A,H){if(g==null)throw Error(f(267,g));var x=Y({},g.props),T=g.key,v=g.ref,O=g._owner;if(A!=null){if(A.ref!==void 0&&(v=A.ref,O=m.current),A.key!==void 0&&(T=""+A.key),g.type&&g.type.defaultProps)var K=g.type.defaultProps;for(L in A)p.call(A,L)&&!G.hasOwnProperty(L)&&(x[L]=A[L]===void 0&&K!==void 0?K[L]:A[L])}var L=arguments.length-2;if(L===1)x.children=H;else if(1<L){K=Array(L);for(var ee=0;ee<L;ee++)K[ee]=arguments[ee+2];x.children=K}return{$$typeof:a,type:g.type,key:T,ref:v,props:x,_owner:O}},n.createContext=function(g,A){return A===void 0&&(A=null),g={$$typeof:r,_calculateChangedBits:A,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider={$$typeof:i,_context:g},g.Consumer=g},n.createElement=C,n.createFactory=function(g){var A=C.bind(null,g);return A.type=g,A},n.createRef=function(){return{current:null}},n.forwardRef=function(g){return{$$typeof:o,render:g}},n.isValidElement=U,n.lazy=function(g){return{$$typeof:l,_payload:{_status:-1,_result:g},_init:ie}},n.memo=function(g,A){return{$$typeof:s,type:g,compare:A===void 0?null:A}},n.useCallback=function(g,A){return le().useCallback(g,A)},n.useContext=function(g,A){return le().useContext(g,A)},n.useDebugValue=function(){},n.useEffect=function(g,A){return le().useEffect(g,A)},n.useImperativeHandle=function(g,A,H){return le().useImperativeHandle(g,A,H)},n.useLayoutEffect=function(g,A){return le().useLayoutEffect(g,A)},n.useMemo=function(g,A){return le().useMemo(g,A)},n.useReducer=function(g,A,H){return le().useReducer(g,A,H)},n.useRef=function(g){return le().useRef(g)},n.useState=function(g){return le().useState(g)},n.version="17.0.2"}),F=je(function(e){e.exports=Id});var Og=F.Children,jo=F.Component,Un=F.Fragment,Bg=F.Profiler,Ng=F.PureComponent,Gg=F.StrictMode,Rg=F.Suspense,Ug=F.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,Dg=F.cloneElement,Kg=F.createContext,w=F.createElement,Lg=F.createFactory,Hg=F.createRef,Fg=F.forwardRef,bg=F.isValidElement,Yg=F.lazy,Qg=F.memo,xg=F.useCallback,Jg=F.useContext,jg=F.useDebugValue,Dn=F.useEffect,Vg=F.useImperativeHandle,zg=F.useLayoutEffect,_g=F.useMemo,Zg=F.useReducer,Ta=F.useRef,Be=F.useState,qg=F.version;var Cd=je(function(e,n){var a,t,i,r;if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;n.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();n.unstable_now=function(){return s.now()-l}}if(typeof window=="undefined"||typeof MessageChannel!="function"){var d=null,y=null,B=function(){if(d!==null)try{var T=n.unstable_now();d(!0,T),d=null}catch(v){throw setTimeout(B,0),v}};a=function(T){d!==null?setTimeout(a,0,T):(d=T,setTimeout(B,0))},t=function(T,v){y=setTimeout(T,v)},i=function(){clearTimeout(y)},n.unstable_shouldYield=function(){return!1},r=n.unstable_forceFrameRate=function(){}}else{var f=window.setTimeout,E=window.clearTimeout;if(typeof console!="undefined"){var N=window.cancelAnimationFrame;typeof window.requestAnimationFrame!="function"&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),typeof N!="function"&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var P=!1,h=null,u=-1,c=5,m=0;n.unstable_shouldYield=function(){return n.unstable_now()>=m},r=function(){},n.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):c=0<T?Math.floor(1e3/T):5};var p=new MessageChannel,G=p.port2;p.port1.onmessage=function(){if(h!==null){var T=n.unstable_now();m=T+c;try{h(!0,T)?G.postMessage(null):(P=!1,h=null)}catch(v){throw G.postMessage(null),v}}else P=!1},a=function(T){h=T,P||(P=!0,G.postMessage(null))},t=function(T,v){u=f(function(){T(n.unstable_now())},v)},i=function(){E(u),u=-1}}function C(T,v){var O=T.length;T.push(v);e:for(;;){var K=O-1>>>1,L=T[K];if(L!==void 0&&0<R(L,v))T[K]=v,T[O]=L,O=K;else break e}}function W(T){return T=T[0],T===void 0?null:T}function U(T){var v=T[0];if(v!==void 0){var O=T.pop();if(O!==v){T[0]=O;e:for(var K=0,L=T.length;K<L;){var ee=2*(K+1)-1,Sn=T[ee],Sa=ee+1,Rn=T[Sa];if(Sn!==void 0&&0>R(Sn,O))Rn!==void 0&&0>R(Rn,Sn)?(T[K]=Rn,T[Sa]=O,K=Sa):(T[K]=Sn,T[ee]=O,K=ee);else if(Rn!==void 0&&0>R(Rn,O))T[K]=Rn,T[Sa]=O,K=Sa;else break e}}return v}return null}function R(T,v){var O=T.sortIndex-v.sortIndex;return O!==0?O:T.id-v.id}var z=[],Te=[],Gn=1,se=null,ie=3,pn=!1,le=!1,fn=!1;function g(T){for(var v=W(Te);v!==null;){if(v.callback===null)U(Te);else if(v.startTime<=T)U(Te),v.sortIndex=v.expirationTime,C(z,v);else break;v=W(Te)}}function A(T){if(fn=!1,g(T),!le)if(W(z)!==null)le=!0,a(H);else{var v=W(Te);v!==null&&t(A,v.startTime-T)}}function H(T,v){le=!1,fn&&(fn=!1,i()),pn=!0;var O=ie;try{for(g(v),se=W(z);se!==null&&(!(se.expirationTime>v)||T&&!n.unstable_shouldYield());){var K=se.callback;if(typeof K=="function"){se.callback=null,ie=se.priorityLevel;var L=K(se.expirationTime<=v);v=n.unstable_now(),typeof L=="function"?se.callback=L:se===W(z)&&U(z),g(v)}else U(z);se=W(z)}if(se!==null)var ee=!0;else{var Sn=W(Te);Sn!==null&&t(A,Sn.startTime-v),ee=!1}return ee}finally{se=null,ie=O,pn=!1}}var x=r;n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(T){T.callback=null},n.unstable_continueExecution=function(){le||pn||(le=!0,a(H))},n.unstable_getCurrentPriorityLevel=function(){return ie},n.unstable_getFirstCallbackNode=function(){return W(z)},n.unstable_next=function(T){switch(ie){case 1:case 2:case 3:var v=3;break;default:v=ie}var O=ie;ie=v;try{return T()}finally{ie=O}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=x,n.unstable_runWithPriority=function(T,v){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var O=ie;ie=T;try{return v()}finally{ie=O}},n.unstable_scheduleCallback=function(T,v,O){var K=n.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?K+O:K):O=K,T){case 1:var L=-1;break;case 2:L=250;break;case 5:L=1073741823;break;case 4:L=1e4;break;default:L=5e3}return L=O+L,T={id:Gn++,callback:v,priorityLevel:T,startTime:O,expirationTime:L,sortIndex:-1},O>K?(T.sortIndex=O,C(Te,T),W(z)===null&&T===W(Te)&&(fn?i():fn=!0,t(A,O-K))):(T.sortIndex=L,C(z,T),le||pn||(le=!0,a(H))),T},n.unstable_wrapCallback=function(T){var v=ie;return function(){var O=ie;ie=v;try{return T.apply(this,arguments)}finally{ie=O}}}}),ne=je(function(e){e.exports=Cd});function k(e){for(var n="https://reactjs.org/docs/error-decoder.html?invariant="+e,a=1;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a]);return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!F)throw Error(k(227));var Vo=new Set,ya={};function Tn(e,n){Kn(e,n),Kn(e+"Capture",n)}function Kn(e,n){for(ya[e]=n,e=0;e<n.length;e++)Vo.add(n[e])}var Fe=!(typeof window=="undefined"||typeof window.document=="undefined"||typeof window.document.createElement=="undefined"),Ed=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,zo=Object.prototype.hasOwnProperty,_o={},Zo={};function vd(e){return zo.call(Zo,e)?!0:zo.call(_o,e)?!1:Ed.test(e)?Zo[e]=!0:(_o[e]=!0,!1)}function Md(e,n,a,t){if(a!==null&&a.type===0)return!1;switch(typeof n){case"function":case"symbol":return!0;case"boolean":return t?!1:a!==null?!a.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function wd(e,n,a,t){if(n===null||typeof n=="undefined"||Md(e,n,a,t))return!0;if(t)return!1;if(a!==null)switch(a.type){case 3:return!n;case 4:return n===!1;case 5:return isNaN(n);case 6:return isNaN(n)||1>n}return!1}function fe(e,n,a,t,i,r,o){this.acceptsBooleans=n===2||n===3||n===4,this.attributeName=t,this.attributeNamespace=i,this.mustUseProperty=a,this.propertyName=e,this.type=n,this.sanitizeURL=r,this.removeEmptyString=o}var ue={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){ue[e]=new fe(e,0,!1,e,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var n=e[0];ue[n]=new fe(n,1,!1,e[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(e){ue[e]=new fe(e,2,!1,e.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){ue[e]=new fe(e,2,!1,e,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){ue[e]=new fe(e,3,!1,e.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(e){ue[e]=new fe(e,3,!0,e,null,!1,!1)});["capture","download"].forEach(function(e){ue[e]=new fe(e,4,!1,e,null,!1,!1)});["cols","rows","size","span"].forEach(function(e){ue[e]=new fe(e,6,!1,e,null,!1,!1)});["rowSpan","start"].forEach(function(e){ue[e]=new fe(e,5,!1,e.toLowerCase(),null,!1,!1)});var Ri=/[\-:]([a-z])/g;function Ui(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var n=e.replace(Ri,Ui);ue[n]=new fe(n,1,!1,e,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var n=e.replace(Ri,Ui);ue[n]=new fe(n,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var n=e.replace(Ri,Ui);ue[n]=new fe(n,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(e){ue[e]=new fe(e,1,!1,e.toLowerCase(),null,!1,!1)});ue.xlinkHref=new fe("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(e){ue[e]=new fe(e,1,!1,e.toLowerCase(),null,!0,!0)});function Di(e,n,a,t){var i=ue.hasOwnProperty(n)?ue[n]:null,r=i!==null?i.type===0:t?!1:!(!(2<n.length)||n[0]!=="o"&&n[0]!=="O"||n[1]!=="n"&&n[1]!=="N");r||(wd(n,a,i,t)&&(a=null),t||i===null?vd(n)&&(a===null?e.removeAttribute(n):e.setAttribute(n,""+a)):i.mustUseProperty?e[i.propertyName]=a===null?i.type===3?!1:"":a:(n=i.attributeName,t=i.attributeNamespace,a===null?e.removeAttribute(n):(i=i.type,a=i===3||i===4&&a===!0?"":""+a,t?e.setAttributeNS(t,n,a):e.setAttribute(n,a))))}var yn=F.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,ka=60103,kn=60106,Ve=60107,Ki=60108,Aa=60114,Li=60109,Hi=60110,kt=60112,Ia=60113,At=60120,It=60115,Fi=60116,bi=60121,Yi=60128,qo=60129,Qi=60130,xi=60131;typeof Symbol=="function"&&Symbol.for&&(ae=Symbol.for,ka=ae("react.element"),kn=ae("react.portal"),Ve=ae("react.fragment"),Ki=ae("react.strict_mode"),Aa=ae("react.profiler"),Li=ae("react.provider"),Hi=ae("react.context"),kt=ae("react.forward_ref"),Ia=ae("react.suspense"),At=ae("react.suspense_list"),It=ae("react.memo"),Fi=ae("react.lazy"),bi=ae("react.block"),ae("react.scope"),Yi=ae("react.opaque.id"),qo=ae("react.debug_trace_mode"),Qi=ae("react.offscreen"),xi=ae("react.legacy_hidden"));var ae,Xo=typeof Symbol=="function"&&Symbol.iterator;function Ca(e){return e===null||typeof e!="object"?null:(e=Xo&&e[Xo]||e["@@iterator"],typeof e=="function"?e:null)}var Ji;function Ea(e){if(Ji===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);Ji=n&&n[1]||""}return`
`+Ji+e}var ji=!1;function Ct(e,n){if(!e||ji)return"";ji=!0;var a=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{if(n)if(n=function(){throw Error()},Object.defineProperty(n.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(n,[])}catch(l){var t=l}Reflect.construct(e,[],n)}else{try{n.call()}catch(l){t=l}e.call(n.prototype)}else{try{throw Error()}catch(l){t=l}e()}}catch(l){if(l&&t&&typeof l.stack=="string"){for(var i=l.stack.split(`
`),r=t.stack.split(`
`),o=i.length-1,s=r.length-1;1<=o&&0<=s&&i[o]!==r[s];)s--;for(;1<=o&&0<=s;o--,s--)if(i[o]!==r[s]){if(o!==1||s!==1)do if(o--,s--,0>s||i[o]!==r[s])return`
`+i[o].replace(" at new "," at ");while(1<=o&&0<=s);break}}}finally{ji=!1,Error.prepareStackTrace=a}return(e=e?e.displayName||e.name:"")?Ea(e):""}function Pd(e){switch(e.tag){case 5:return Ea(e.type);case 16:return Ea("Lazy");case 13:return Ea("Suspense");case 19:return Ea("SuspenseList");case 0:case 2:case 15:return e=Ct(e.type,!1),e;case 11:return e=Ct(e.type.render,!1),e;case 22:return e=Ct(e.type._render,!1),e;case 1:return e=Ct(e.type,!0),e;default:return""}}function Ln(e){if(e==null)return null;if(typeof e=="function")return e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case Ve:return"Fragment";case kn:return"Portal";case Aa:return"Profiler";case Ki:return"StrictMode";case Ia:return"Suspense";case At:return"SuspenseList"}if(typeof e=="object")switch(e.$$typeof){case Hi:return(e.displayName||"Context")+".Consumer";case Li:return(e._context.displayName||"Context")+".Provider";case kt:var n=e.render;return n=n.displayName||n.name||"",e.displayName||(n!==""?"ForwardRef("+n+")":"ForwardRef");case It:return Ln(e.type);case bi:return Ln(e._render);case Fi:n=e._payload,e=e._init;try{return Ln(e(n))}catch(a){}}return null}function ze(e){switch(typeof e){case"boolean":case"number":case"object":case"string":case"undefined":return e;default:return""}}function $o(e){var n=e.type;return(e=e.nodeName)&&e.toLowerCase()==="input"&&(n==="checkbox"||n==="radio")}function Wd(e){var n=$o(e)?"checked":"value",a=Object.getOwnPropertyDescriptor(e.constructor.prototype,n),t=""+e[n];if(!e.hasOwnProperty(n)&&typeof a!="undefined"&&typeof a.get=="function"&&typeof a.set=="function"){var i=a.get,r=a.set;return Object.defineProperty(e,n,{configurable:!0,get:function(){return i.call(this)},set:function(o){t=""+o,r.call(this,o)}}),Object.defineProperty(e,n,{enumerable:a.enumerable}),{getValue:function(){return t},setValue:function(o){t=""+o},stopTracking:function(){e._valueTracker=null,delete e[n]}}}}function Et(e){e._valueTracker||(e._valueTracker=Wd(e))}function es(e){if(!e)return!1;var n=e._valueTracker;if(!n)return!0;var a=n.getValue(),t="";return e&&(t=$o(e)?e.checked?"true":"false":e.value),e=t,e!==a?(n.setValue(e),!0):!1}function vt(e){if(e=e||(typeof document!="undefined"?document:void 0),typeof e=="undefined")return null;try{return e.activeElement||e.body}catch(n){return e.body}}function Vi(e,n){var a=n.checked;return Y({},n,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:a!=null?a:e._wrapperState.initialChecked})}function ns(e,n){var a=n.defaultValue==null?"":n.defaultValue,t=n.checked!=null?n.checked:n.defaultChecked;a=ze(n.value!=null?n.value:a),e._wrapperState={initialChecked:t,initialValue:a,controlled:n.type==="checkbox"||n.type==="radio"?n.checked!=null:n.value!=null}}function as(e,n){n=n.checked,n!=null&&Di(e,"checked",n,!1)}function _i(e,n){as(e,n);var a=ze(n.value),t=n.type;if(a!=null)t==="number"?(a===0&&e.value===""||e.value!=a)&&(e.value=""+a):e.value!==""+a&&(e.value=""+a);else if(t==="submit"||t==="reset"){e.removeAttribute("value");return}n.hasOwnProperty("value")?zi(e,n.type,a):n.hasOwnProperty("defaultValue")&&zi(e,n.type,ze(n.defaultValue)),n.checked==null&&n.defaultChecked!=null&&(e.defaultChecked=!!n.defaultChecked)}function ts(e,n,a){if(n.hasOwnProperty("value")||n.hasOwnProperty("defaultValue")){var t=n.type;if(!(t!=="submit"&&t!=="reset"||n.value!==void 0&&n.value!==null))return;n=""+e._wrapperState.initialValue,a||n===e.value||(e.value=n),e.defaultValue=n}a=e.name,a!==""&&(e.name=""),e.defaultChecked=!!e._wrapperState.initialChecked,a!==""&&(e.name=a)}function zi(e,n,a){(n!=="number"||vt(e.ownerDocument)!==e)&&(a==null?e.defaultValue=""+e._wrapperState.initialValue:e.defaultValue!==""+a&&(e.defaultValue=""+a))}function Od(e){var n="";return F.Children.forEach(e,function(a){a!=null&&(n+=a)}),n}function Zi(e,n){return e=Y({children:void 0},n),(n=Od(n.children))&&(e.children=n),e}function Hn(e,n,a,t){if(e=e.options,n){n={};for(var i=0;i<a.length;i++)n["$"+a[i]]=!0;for(a=0;a<e.length;a++)i=n.hasOwnProperty("$"+e[a].value),e[a].selected!==i&&(e[a].selected=i),i&&t&&(e[a].defaultSelected=!0)}else{for(a=""+ze(a),n=null,i=0;i<e.length;i++){if(e[i].value===a){e[i].selected=!0,t&&(e[i].defaultSelected=!0);return}n!==null||e[i].disabled||(n=e[i])}n!==null&&(n.selected=!0)}}function qi(e,n){if(n.dangerouslySetInnerHTML!=null)throw Error(k(91));return Y({},n,{value:void 0,defaultValue:void 0,children:""+e._wrapperState.initialValue})}function is(e,n){var a=n.value;if(a==null){if(a=n.children,n=n.defaultValue,a!=null){if(n!=null)throw Error(k(92));if(Array.isArray(a)){if(!(1>=a.length))throw Error(k(93));a=a[0]}n=a}n==null&&(n=""),a=n}e._wrapperState={initialValue:ze(a)}}function rs(e,n){var a=ze(n.value),t=ze(n.defaultValue);a!=null&&(a=""+a,a!==e.value&&(e.value=a),n.defaultValue==null&&e.defaultValue!==a&&(e.defaultValue=a)),t!=null&&(e.defaultValue=""+t)}function os(e){var n=e.textContent;n===e._wrapperState.initialValue&&n!==""&&n!==null&&(e.value=n)}var Xi={html:"http://www.w3.org/1999/xhtml",mathml:"http://www.w3.org/1998/Math/MathML",svg:"http://www.w3.org/2000/svg"};function ss(e){switch(e){case"svg":return"http://www.w3.org/2000/svg";case"math":return"http://www.w3.org/1998/Math/MathML";default:return"http://www.w3.org/1999/xhtml"}}function $i(e,n){return e==null||e==="http://www.w3.org/1999/xhtml"?ss(n):e==="http://www.w3.org/2000/svg"&&n==="foreignObject"?"http://www.w3.org/1999/xhtml":e}var Mt,ls=function(e){return typeof MSApp!="undefined"&&MSApp.execUnsafeLocalFunction?function(n,a,t,i){MSApp.execUnsafeLocalFunction(function(){return e(n,a,t,i)})}:e}(function(e,n){if(e.namespaceURI!==Xi.svg||"innerHTML"in e)e.innerHTML=n;else{for(Mt=Mt||document.createElement("div"),Mt.innerHTML="<svg>"+n.valueOf().toString()+"</svg>",n=Mt.firstChild;e.firstChild;)e.removeChild(e.firstChild);for(;n.firstChild;)e.appendChild(n.firstChild)}});function va(e,n){if(n){var a=e.firstChild;if(a&&a===e.lastChild&&a.nodeType===3){a.nodeValue=n;return}}e.textContent=n}var Ma={animationIterationCount:!0,borderImageOutset:!0,borderImageSlice:!0,borderImageWidth:!0,boxFlex:!0,boxFlexGroup:!0,boxOrdinalGroup:!0,columnCount:!0,columns:!0,flex:!0,flexGrow:!0,flexPositive:!0,flexShrink:!0,flexNegative:!0,flexOrder:!0,gridArea:!0,gridRow:!0,gridRowEnd:!0,gridRowSpan:!0,gridRowStart:!0,gridColumn:!0,gridColumnEnd:!0,gridColumnSpan:!0,gridColumnStart:!0,fontWeight:!0,lineClamp:!0,lineHeight:!0,opacity:!0,order:!0,orphans:!0,tabSize:!0,widows:!0,zIndex:!0,zoom:!0,fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Bd=["Webkit","ms","Moz","O"];Object.keys(Ma).forEach(function(e){Bd.forEach(function(n){n=n+e.charAt(0).toUpperCase()+e.substring(1),Ma[n]=Ma[e]})});function us(e,n,a){return n==null||typeof n=="boolean"||n===""?"":a||typeof n!="number"||n===0||Ma.hasOwnProperty(e)&&Ma[e]?(""+n).trim():n+"px"}function ds(e,n){e=e.style;for(var a in n)if(n.hasOwnProperty(a)){var t=a.indexOf("--")===0,i=us(a,n[a],t);a==="float"&&(a="cssFloat"),t?e.setProperty(a,i):e[a]=i}}var Nd=Y({menuitem:!0},{area:!0,base:!0,br:!0,col:!0,embed:!0,hr:!0,img:!0,input:!0,keygen:!0,link:!0,meta:!0,param:!0,source:!0,track:!0,wbr:!0});function er(e,n){if(n){if(Nd[e]&&(n.children!=null||n.dangerouslySetInnerHTML!=null))throw Error(k(137,e));if(n.dangerouslySetInnerHTML!=null){if(n.children!=null)throw Error(k(60));if(!(typeof n.dangerouslySetInnerHTML=="object"&&"__html"in n.dangerouslySetInnerHTML))throw Error(k(61))}if(n.style!=null&&typeof n.style!="object")throw Error(k(62))}}function nr(e,n){if(e.indexOf("-")===-1)return typeof n.is=="string";switch(e){case"annotation-xml":case"color-profile":case"font-face":case"font-face-src":case"font-face-uri":case"font-face-format":case"font-face-name":case"missing-glyph":return!1;default:return!0}}function ar(e){return e=e.target||e.srcElement||window,e.correspondingUseElement&&(e=e.correspondingUseElement),e.nodeType===3?e.parentNode:e}var tr=null,Fn=null,bn=null;function cs(e){if(e=wa(e)){if(typeof tr!="function")throw Error(k(280));var n=e.stateNode;n&&(n=wt(n),tr(e.stateNode,e.type,n))}}function hs(e){Fn?bn?bn.push(e):bn=[e]:Fn=e}function gs(){if(Fn){var e=Fn,n=bn;if(bn=Fn=null,cs(e),n)for(e=0;e<n.length;e++)cs(n[e])}}function ir(e,n){return e(n)}function ms(e,n,a,t,i){return e(n,a,t,i)}function rr(){}var ps=ir,An=!1,or=!1;function sr(){(Fn!==null||bn!==null)&&(rr(),gs())}function Gd(e,n,a){if(or)return e(n,a);or=!0;try{return ps(e,n,a)}finally{or=!1,sr()}}function Pa(e,n){var a=e.stateNode;if(a===null)return null;var t=wt(a);if(t===null)return null;a=t[n];e:switch(n){case"onClick":case"onClickCapture":case"onDoubleClick":case"onDoubleClickCapture":case"onMouseDown":case"onMouseDownCapture":case"onMouseMove":case"onMouseMoveCapture":case"onMouseUp":case"onMouseUpCapture":case"onMouseEnter":(t=!t.disabled)||(e=e.type,t=!(e==="button"||e==="input"||e==="select"||e==="textarea")),e=!t;break e;default:e=!1}if(e)return null;if(a&&typeof a!="function")throw Error(k(231,n,typeof a));return a}var lr=!1;if(Fe)try{Yn={},Object.defineProperty(Yn,"passive",{get:function(){lr=!0}}),window.addEventListener("test",Yn,Yn),window.removeEventListener("test",Yn,Yn)}catch(e){lr=!1}var Yn;function Rd(e,n,a,t,i,r,o,s,l){var d=Array.prototype.slice.call(arguments,3);try{n.apply(a,d)}catch(y){this.onError(y)}}var Wa=!1,Pt=null,Wt=!1,ur=null,Ud={onError:function(e){Wa=!0,Pt=e}};function Dd(e,n,a,t,i,r,o,s,l){Wa=!1,Pt=null,Rd.apply(Ud,arguments)}function Kd(e,n,a,t,i,r,o,s,l){if(Dd.apply(this,arguments),Wa){if(Wa){var d=Pt;Wa=!1,Pt=null}else throw Error(k(198));Wt||(Wt=!0,ur=d)}}function In(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&1026)!=0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function fs(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function Ss(e){if(In(e)!==e)throw Error(k(188))}function Ld(e){var n=e.alternate;if(!n){if(n=In(e),n===null)throw Error(k(188));return n!==e?null:e}for(var a=e,t=n;;){var i=a.return;if(i===null)break;var r=i.alternate;if(r===null){if(t=i.return,t!==null){a=t;continue}break}if(i.child===r.child){for(r=i.child;r;){if(r===a)return Ss(i),e;if(r===t)return Ss(i),n;r=r.sibling}throw Error(k(188))}if(a.return!==t.return)a=i,t=r;else{for(var o=!1,s=i.child;s;){if(s===a){o=!0,a=i,t=r;break}if(s===t){o=!0,t=i,a=r;break}s=s.sibling}if(!o){for(s=r.child;s;){if(s===a){o=!0,a=r,t=i;break}if(s===t){o=!0,t=r,a=i;break}s=s.sibling}if(!o)throw Error(k(189))}}if(a.alternate!==t)throw Error(k(190))}if(a.tag!==3)throw Error(k(188));return a.stateNode.current===a?e:n}function Ts(e){if(e=Ld(e),!e)return null;for(var n=e;;){if(n.tag===5||n.tag===6)return n;if(n.child)n.child.return=n,n=n.child;else{if(n===e)break;for(;!n.sibling;){if(!n.return||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}}return null}function ys(e,n){for(var a=e.alternate;n!==null;){if(n===e||n===a)return!0;n=n.return}return!1}var ks,dr,As,Is,cr=!1,Re=[],_e=null,Ze=null,qe=null,Oa=new Map,Ba=new Map,Na=[],Cs="mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");function hr(e,n,a,t,i){return{blockedOn:e,domEventName:n,eventSystemFlags:a|16,nativeEvent:i,targetContainers:[t]}}function Es(e,n){switch(e){case"focusin":case"focusout":_e=null;break;case"dragenter":case"dragleave":Ze=null;break;case"mouseover":case"mouseout":qe=null;break;case"pointerover":case"pointerout":Oa.delete(n.pointerId);break;case"gotpointercapture":case"lostpointercapture":Ba.delete(n.pointerId)}}function Ga(e,n,a,t,i,r){return e===null||e.nativeEvent!==r?(e=hr(n,a,t,i,r),n!==null&&(n=wa(n),n!==null&&dr(n)),e):(e.eventSystemFlags|=t,n=e.targetContainers,i!==null&&n.indexOf(i)===-1&&n.push(i),e)}function Hd(e,n,a,t,i){switch(n){case"focusin":return _e=Ga(_e,e,n,a,t,i),!0;case"dragenter":return Ze=Ga(Ze,e,n,a,t,i),!0;case"mouseover":return qe=Ga(qe,e,n,a,t,i),!0;case"pointerover":var r=i.pointerId;return Oa.set(r,Ga(Oa.get(r)||null,e,n,a,t,i)),!0;case"gotpointercapture":return r=i.pointerId,Ba.set(r,Ga(Ba.get(r)||null,e,n,a,t,i)),!0}return!1}function Fd(e){var n=Cn(e.target);if(n!==null){var a=In(n);if(a!==null){if(n=a.tag,n===13){if(n=fs(a),n!==null){e.blockedOn=n,Is(e.lanePriority,function(){ne.unstable_runWithPriority(e.priority,function(){As(a)})});return}}else if(n===3&&a.stateNode.hydrate){e.blockedOn=a.tag===3?a.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Ot(e){if(e.blockedOn!==null)return!1;for(var n=e.targetContainers;0<n.length;){var a=gr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null)return n=wa(a),n!==null&&dr(n),e.blockedOn=a,!1;n.shift()}return!0}function vs(e,n,a){Ot(e)&&a.delete(n)}function bd(){for(cr=!1;0<Re.length;){var e=Re[0];if(e.blockedOn!==null){e=wa(e.blockedOn),e!==null&&ks(e);break}for(var n=e.targetContainers;0<n.length;){var a=gr(e.domEventName,e.eventSystemFlags,n[0],e.nativeEvent);if(a!==null){e.blockedOn=a;break}n.shift()}e.blockedOn===null&&Re.shift()}_e!==null&&Ot(_e)&&(_e=null),Ze!==null&&Ot(Ze)&&(Ze=null),qe!==null&&Ot(qe)&&(qe=null),Oa.forEach(vs),Ba.forEach(vs)}function Ra(e,n){e.blockedOn===n&&(e.blockedOn=null,cr||(cr=!0,ne.unstable_scheduleCallback(ne.unstable_NormalPriority,bd)))}function Ms(e){function n(i){return Ra(i,e)}if(0<Re.length){Ra(Re[0],e);for(var a=1;a<Re.length;a++){var t=Re[a];t.blockedOn===e&&(t.blockedOn=null)}}for(_e!==null&&Ra(_e,e),Ze!==null&&Ra(Ze,e),qe!==null&&Ra(qe,e),Oa.forEach(n),Ba.forEach(n),a=0;a<Na.length;a++)t=Na[a],t.blockedOn===e&&(t.blockedOn=null);for(;0<Na.length&&(a=Na[0],a.blockedOn===null);)Fd(a),a.blockedOn===null&&Na.shift()}function Bt(e,n){var a={};return a[e.toLowerCase()]=n.toLowerCase(),a["Webkit"+e]="webkit"+n,a["Moz"+e]="moz"+n,a}var Qn={animationend:Bt("Animation","AnimationEnd"),animationiteration:Bt("Animation","AnimationIteration"),animationstart:Bt("Animation","AnimationStart"),transitionend:Bt("Transition","TransitionEnd")},mr={},ws={};Fe&&(ws=document.createElement("div").style,"AnimationEvent"in window||(delete Qn.animationend.animation,delete Qn.animationiteration.animation,delete Qn.animationstart.animation),"TransitionEvent"in window||delete Qn.transitionend.transition);function Nt(e){if(mr[e])return mr[e];if(!Qn[e])return e;var n=Qn[e],a;for(a in n)if(n.hasOwnProperty(a)&&a in ws)return mr[e]=n[a];return e}var Ps=Nt("animationend"),Ws=Nt("animationiteration"),Os=Nt("animationstart"),Bs=Nt("transitionend"),Ns=new Map,pr=new Map,Yd=["abort","abort",Ps,"animationEnd",Ws,"animationIteration",Os,"animationStart","canplay","canPlay","canplaythrough","canPlayThrough","durationchange","durationChange","emptied","emptied","encrypted","encrypted","ended","ended","error","error","gotpointercapture","gotPointerCapture","load","load","loadeddata","loadedData","loadedmetadata","loadedMetadata","loadstart","loadStart","lostpointercapture","lostPointerCapture","playing","playing","progress","progress","seeking","seeking","stalled","stalled","suspend","suspend","timeupdate","timeUpdate",Bs,"transitionEnd","waiting","waiting"];function fr(e,n){for(var a=0;a<e.length;a+=2){var t=e[a],i=e[a+1];i="on"+(i[0].toUpperCase()+i.slice(1)),pr.set(t,n),Ns.set(t,i),Tn(i,[t])}}var Qd=ne.unstable_now;Qd();var J=8;function xn(e){if((1&e)!=0)return J=15,1;if((2&e)!=0)return J=14,2;if((4&e)!=0)return J=13,4;var n=24&e;return n!==0?(J=12,n):(e&32)!=0?(J=11,32):(n=192&e,n!==0?(J=10,n):(e&256)!=0?(J=9,256):(n=3584&e,n!==0?(J=8,n):(e&4096)!=0?(J=7,4096):(n=4186112&e,n!==0?(J=6,n):(n=62914560&e,n!==0?(J=5,n):e&67108864?(J=4,67108864):(e&134217728)!=0?(J=3,134217728):(n=805306368&e,n!==0?(J=2,n):(1073741824&e)!=0?(J=1,1073741824):(J=8,e))))))}function xd(e){switch(e){case 99:return 15;case 98:return 10;case 97:case 96:return 8;case 95:return 2;default:return 0}}function Jd(e){switch(e){case 15:case 14:return 99;case 13:case 12:case 11:case 10:return 98;case 9:case 8:case 7:case 6:case 4:case 5:return 97;case 3:case 2:case 1:return 95;case 0:return 90;default:throw Error(k(358,e))}}function Ua(e,n){var a=e.pendingLanes;if(a===0)return J=0;var t=0,i=0,r=e.expiredLanes,o=e.suspendedLanes,s=e.pingedLanes;if(r!==0)t=r,i=J=15;else if(r=a&134217727,r!==0){var l=r&~o;l!==0?(t=xn(l),i=J):(s&=r,s!==0&&(t=xn(s),i=J))}else r=a&~o,r!==0?(t=xn(r),i=J):s!==0&&(t=xn(s),i=J);if(t===0)return 0;if(t=31-Xe(t),t=a&((0>t?0:1<<t)<<1)-1,n!==0&&n!==t&&(n&o)==0){if(xn(n),i<=J)return n;J=i}if(n=e.entangledLanes,n!==0)for(e=e.entanglements,n&=t;0<n;)a=31-Xe(n),i=1<<a,t|=e[a],n&=~i;return t}function Gs(e){return e=e.pendingLanes&-1073741825,e!==0?e:e&1073741824?1073741824:0}function Gt(e,n){switch(e){case 15:return 1;case 14:return 2;case 12:return e=Jn(24&~n),e===0?Gt(10,n):e;case 10:return e=Jn(192&~n),e===0?Gt(8,n):e;case 8:return e=Jn(3584&~n),e===0&&(e=Jn(4186112&~n),e===0&&(e=512)),e;case 2:return n=Jn(805306368&~n),n===0&&(n=268435456),n}throw Error(k(358,e))}function Jn(e){return e&-e}function Sr(e){for(var n=[],a=0;31>a;a++)n.push(e);return n}function Rt(e,n,a){e.pendingLanes|=n;var t=n-1;e.suspendedLanes&=t,e.pingedLanes&=t,e=e.eventTimes,n=31-Xe(n),e[n]=a}var Xe=Math.clz32?Math.clz32:jd,Vd=Math.log,zd=Math.LN2;function jd(e){return e===0?32:31-(Vd(e)/zd|0)|0}var _d=ne.unstable_UserBlockingPriority,Zd=ne.unstable_runWithPriority,Ut=!0;function qd(e,n,a,t){An||rr();var i=Tr,r=An;An=!0;try{ms(i,e,n,a,t)}finally{(An=r)||sr()}}function Xd(e,n,a,t){Zd(_d,Tr.bind(null,e,n,a,t))}function Tr(e,n,a,t){if(Ut){var i;if((i=(n&4)==0)&&0<Re.length&&-1<Cs.indexOf(e))e=hr(null,e,n,a,t),Re.push(e);else{var r=gr(e,n,a,t);if(r===null)i&&Es(e,t);else{if(i){if(-1<Cs.indexOf(e)){e=hr(r,e,n,a,t),Re.push(e);return}if(Hd(r,e,n,a,t))return;Es(e,t)}Rs(e,n,t,null,a)}}}}function gr(e,n,a,t){var i=ar(t);if(i=Cn(i),i!==null){var r=In(i);if(r===null)i=null;else{var o=r.tag;if(o===13){if(i=fs(r),i!==null)return i;i=null}else if(o===3){if(r.stateNode.hydrate)return r.tag===3?r.stateNode.containerInfo:null;i=null}else r!==i&&(i=null)}}return Rs(e,n,t,i,a),null}var $e=null,yr=null,Dt=null;function Us(){if(Dt)return Dt;var e,n=yr,a=n.length,t,i="value"in $e?$e.value:$e.textContent,r=i.length;for(e=0;e<a&&n[e]===i[e];e++);var o=a-e;for(t=1;t<=o&&n[a-t]===i[r-t];t++);return Dt=i.slice(e,1<t?1-t:void 0)}function Kt(e){var n=e.keyCode;return"charCode"in e?(e=e.charCode,e===0&&n===13&&(e=13)):e=n,e===10&&(e=13),32<=e||e===13?e:0}function Lt(){return!0}function Ds(){return!1}function Ce(e){function n(a,t,i,r,o){this._reactName=a,this._targetInst=i,this.type=t,this.nativeEvent=r,this.target=o,this.currentTarget=null;for(var s in e)e.hasOwnProperty(s)&&(a=e[s],this[s]=a?a(r):r[s]);return this.isDefaultPrevented=(r.defaultPrevented!=null?r.defaultPrevented:r.returnValue===!1)?Lt:Ds,this.isPropagationStopped=Ds,this}return Y(n.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():typeof a.returnValue!="unknown"&&(a.returnValue=!1),this.isDefaultPrevented=Lt)},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():typeof a.cancelBubble!="unknown"&&(a.cancelBubble=!0),this.isPropagationStopped=Lt)},persist:function(){},isPersistent:Lt}),n}var jn={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},kr=Ce(jn),Da=Y({},jn,{view:0,detail:0}),$d=Ce(Da),Ar,Ir,Ka,Ht=Y({},Da,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:Cr,button:0,buttons:0,relatedTarget:function(e){return e.relatedTarget===void 0?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==Ka&&(Ka&&e.type==="mousemove"?(Ar=e.screenX-Ka.screenX,Ir=e.screenY-Ka.screenY):Ir=Ar=0,Ka=e),Ar)},movementY:function(e){return"movementY"in e?e.movementY:Ir}}),Ks=Ce(Ht),ec=Y({},Ht,{dataTransfer:0}),nc=Ce(ec),ac=Y({},Da,{relatedTarget:0}),Er=Ce(ac),tc=Y({},jn,{animationName:0,elapsedTime:0,pseudoElement:0}),ic=Ce(tc),rc=Y({},jn,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}}),oc=Ce(rc),sc=Y({},jn,{data:0}),Ls=Ce(sc),lc={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},uc={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},dc={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function cc(e){var n=this.nativeEvent;return n.getModifierState?n.getModifierState(e):(e=dc[e])?!!n[e]:!1}function Cr(){return cc}var hc=Y({},Da,{key:function(e){if(e.key){var n=lc[e.key]||e.key;if(n!=="Unidentified")return n}return e.type==="keypress"?(e=Kt(e),e===13?"Enter":String.fromCharCode(e)):e.type==="keydown"||e.type==="keyup"?uc[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:Cr,charCode:function(e){return e.type==="keypress"?Kt(e):0},keyCode:function(e){return e.type==="keydown"||e.type==="keyup"?e.keyCode:0},which:function(e){return e.type==="keypress"?Kt(e):e.type==="keydown"||e.type==="keyup"?e.keyCode:0}}),gc=Ce(hc),mc=Y({},Ht,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0}),Hs=Ce(mc),pc=Y({},Da,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:Cr}),fc=Ce(pc),Sc=Y({},jn,{propertyName:0,elapsedTime:0,pseudoElement:0}),Tc=Ce(Sc),yc=Y({},Ht,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0}),kc=Ce(yc),Ac=[9,13,27,32],vr=Fe&&"CompositionEvent"in window,La=null;Fe&&"documentMode"in document&&(La=document.documentMode);var Ic=Fe&&"TextEvent"in window&&!La,Fs=Fe&&(!vr||La&&8<La&&11>=La),bs=String.fromCharCode(32),Ys=!1;function Qs(e,n){switch(e){case"keyup":return Ac.indexOf(n.keyCode)!==-1;case"keydown":return n.keyCode!==229;case"keypress":case"mousedown":case"focusout":return!0;default:return!1}}function xs(e){return e=e.detail,typeof e=="object"&&"data"in e?e.data:null}var Vn=!1;function Cc(e,n){switch(e){case"compositionend":return xs(n);case"keypress":return n.which!==32?null:(Ys=!0,bs);case"textInput":return e=n.data,e===bs&&Ys?null:e;default:return null}}function Ec(e,n){if(Vn)return e==="compositionend"||!vr&&Qs(e,n)?(e=Us(),Dt=yr=$e=null,Vn=!1,e):null;switch(e){case"paste":return null;case"keypress":if(!(n.ctrlKey||n.altKey||n.metaKey)||n.ctrlKey&&n.altKey){if(n.char&&1<n.char.length)return n.char;if(n.which)return String.fromCharCode(n.which)}return null;case"compositionend":return Fs&&n.locale!=="ko"?null:n.data;default:return null}}var vc={color:!0,date:!0,datetime:!0,"datetime-local":!0,email:!0,month:!0,number:!0,password:!0,range:!0,search:!0,tel:!0,text:!0,time:!0,url:!0,week:!0};function Js(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n==="input"?!!vc[e.type]:n==="textarea"}function js(e,n,a,t){hs(t),n=Ft(n,"onChange"),0<n.length&&(a=new kr("onChange","change",null,a,t),e.push({event:a,listeners:n}))}var Ha=null,Fa=null;function Mc(e){Vs(e,0)}function bt(e){var n=zn(e);if(es(n))return e}function wc(e,n){if(e==="change")return n}var zs=!1;Fe&&(Fe?(Qt="oninput"in document,Qt||(Mr=document.createElement("div"),Mr.setAttribute("oninput","return;"),Qt=typeof Mr.oninput=="function"),Yt=Qt):Yt=!1,zs=Yt&&(!document.documentMode||9<document.documentMode));var Yt,Qt,Mr;function Zs(){Ha&&(Ha.detachEvent("onpropertychange",_s),Fa=Ha=null)}function _s(e){if(e.propertyName==="value"&&bt(Fa)){var n=[];if(js(n,Fa,e,ar(e)),e=Mc,An)e(n);else{An=!0;try{ir(e,n)}finally{An=!1,sr()}}}}function Pc(e,n,a){e==="focusin"?(Zs(),Ha=n,Fa=a,Ha.attachEvent("onpropertychange",_s)):e==="focusout"&&Zs()}function Wc(e){if(e==="selectionchange"||e==="keyup"||e==="keydown")return bt(Fa)}function Oc(e,n){if(e==="click")return bt(n)}function Bc(e,n){if(e==="input"||e==="change")return bt(n)}function Nc(e,n){return e===n&&(e!==0||1/e==1/n)||e!==e&&n!==n}var ve=typeof Object.is=="function"?Object.is:Nc,Gc=Object.prototype.hasOwnProperty;function ba(e,n){if(ve(e,n))return!0;if(typeof e!="object"||e===null||typeof n!="object"||n===null)return!1;var a=Object.keys(e),t=Object.keys(n);if(a.length!==t.length)return!1;for(t=0;t<a.length;t++)if(!Gc.call(n,a[t])||!ve(e[a[t]],n[a[t]]))return!1;return!0}function qs(e){for(;e&&e.firstChild;)e=e.firstChild;return e}function Xs(e,n){var a=qs(e);e=0;for(var t;a;){if(a.nodeType===3){if(t=e+a.textContent.length,e<=n&&t>=n)return{node:a,offset:n-e};e=t}e:{for(;a;){if(a.nextSibling){a=a.nextSibling;break e}a=a.parentNode}a=void 0}a=qs(a)}}function $s(e,n){return e&&n?e===n?!0:e&&e.nodeType===3?!1:n&&n.nodeType===3?$s(e,n.parentNode):"contains"in e?e.contains(n):e.compareDocumentPosition?!!(e.compareDocumentPosition(n)&16):!1:!1}function el(){for(var e=window,n=vt();n instanceof e.HTMLIFrameElement;){try{var a=typeof n.contentWindow.location.href=="string"}catch(t){a=!1}if(a)e=n.contentWindow;else break;n=vt(e.document)}return n}function wr(e){var n=e&&e.nodeName&&e.nodeName.toLowerCase();return n&&(n==="input"&&(e.type==="text"||e.type==="search"||e.type==="tel"||e.type==="url"||e.type==="password")||n==="textarea"||e.contentEditable==="true")}var Rc=Fe&&"documentMode"in document&&11>=document.documentMode,_n=null,Pr=null,Ya=null,Wr=!1;function nl(e,n,a){var t=a.window===a?a.document:a.nodeType===9?a:a.ownerDocument;Wr||_n==null||_n!==vt(t)||(t=_n,"selectionStart"in t&&wr(t)?t={start:t.selectionStart,end:t.selectionEnd}:(t=(t.ownerDocument&&t.ownerDocument.defaultView||window).getSelection(),t={anchorNode:t.anchorNode,anchorOffset:t.anchorOffset,focusNode:t.focusNode,focusOffset:t.focusOffset}),Ya&&ba(Ya,t)||(Ya=t,t=Ft(Pr,"onSelect"),0<t.length&&(n=new kr("onSelect","select",null,n,a),e.push({event:n,listeners:t}),n.target=_n)))}fr("cancel cancel click click close close contextmenu contextMenu copy copy cut cut auxclick auxClick dblclick doubleClick dragend dragEnd dragstart dragStart drop drop focusin focus focusout blur input input invalid invalid keydown keyDown keypress keyPress keyup keyUp mousedown mouseDown mouseup mouseUp paste paste pause pause play play pointercancel pointerCancel pointerdown pointerDown pointerup pointerUp ratechange rateChange reset reset seeked seeked submit submit touchcancel touchCancel touchend touchEnd touchstart touchStart volumechange volumeChange".split(" "),0);fr("drag drag dragenter dragEnter dragexit dragExit dragleave dragLeave dragover dragOver mousemove mouseMove mouseout mouseOut mouseover mouseOver pointermove pointerMove pointerout pointerOut pointerover pointerOver scroll scroll toggle toggle touchmove touchMove wheel wheel".split(" "),1);fr(Yd,2);for(var al="change selectionchange textInput compositionstart compositionend compositionupdate".split(" "),Or=0;Or<al.length;Or++)pr.set(al[Or],0);Kn("onMouseEnter",["mouseout","mouseover"]);Kn("onMouseLeave",["mouseout","mouseover"]);Kn("onPointerEnter",["pointerout","pointerover"]);Kn("onPointerLeave",["pointerout","pointerover"]);Tn("onChange","change click focusin focusout input keydown keyup selectionchange".split(" "));Tn("onSelect","focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" "));Tn("onBeforeInput",["compositionend","keypress","textInput","paste"]);Tn("onCompositionEnd","compositionend focusout keydown keypress keyup mousedown".split(" "));Tn("onCompositionStart","compositionstart focusout keydown keypress keyup mousedown".split(" "));Tn("onCompositionUpdate","compositionupdate focusout keydown keypress keyup mousedown".split(" "));var Qa="abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),tl=new Set("cancel close invalid load scroll toggle".split(" ").concat(Qa));function il(e,n,a){var t=e.type||"unknown-event";e.currentTarget=a,Kd(t,n,void 0,e),e.currentTarget=null}function Vs(e,n){n=(n&4)!=0;for(var a=0;a<e.length;a++){var t=e[a],i=t.event;t=t.listeners;e:{var r=void 0;if(n)for(var o=t.length-1;0<=o;o--){var s=t[o],l=s.instance,d=s.currentTarget;if(s=s.listener,l!==r&&i.isPropagationStopped())break e;il(i,s,d),r=l}else for(o=0;o<t.length;o++){if(s=t[o],l=s.instance,d=s.currentTarget,s=s.listener,l!==r&&i.isPropagationStopped())break e;il(i,s,d),r=l}}}if(Wt)throw e=ur,Wt=!1,ur=null,e}function j(e,n){var a=ol(n),t=e+"__bubble";a.has(t)||(rl(n,e,2,!1),a.add(t))}var sl="_reactListening"+Math.random().toString(36).slice(2);function ul(e){e[sl]||(e[sl]=!0,Vo.forEach(function(n){tl.has(n)||ll(n,!1,e,null),ll(n,!0,e,null)}))}function ll(e,n,a,t){var i=4<arguments.length&&arguments[4]!==void 0?arguments[4]:0,r=a;if(e==="selectionchange"&&a.nodeType!==9&&(r=a.ownerDocument),t!==null&&!n&&tl.has(e)){if(e!=="scroll")return;i|=2,r=t}var o=ol(r),s=e+"__"+(n?"capture":"bubble");o.has(s)||(n&&(i|=4),rl(r,e,i,n),o.add(s))}function rl(e,n,a,t){var i=pr.get(n);switch(i===void 0?2:i){case 0:i=qd;break;case 1:i=Xd;break;default:i=Tr}a=i.bind(null,n,a,e),i=void 0,!lr||n!=="touchstart"&&n!=="touchmove"&&n!=="wheel"||(i=!0),t?i!==void 0?e.addEventListener(n,a,{capture:!0,passive:i}):e.addEventListener(n,a,!0):i!==void 0?e.addEventListener(n,a,{passive:i}):e.addEventListener(n,a,!1)}function Rs(e,n,a,t,i){var r=t;if((n&1)==0&&(n&2)==0&&t!==null)e:for(;;){if(t===null)return;var o=t.tag;if(o===3||o===4){var s=t.stateNode.containerInfo;if(s===i||s.nodeType===8&&s.parentNode===i)break;if(o===4)for(o=t.return;o!==null;){var l=o.tag;if((l===3||l===4)&&(l=o.stateNode.containerInfo,l===i||l.nodeType===8&&l.parentNode===i))return;o=o.return}for(;s!==null;){if(o=Cn(s),o===null)return;if(l=o.tag,l===5||l===6){t=r=o;continue e}s=s.parentNode}}t=t.return}Gd(function(){var d=r,y=ar(a),B=[];e:{var f=Ns.get(e);if(f!==void 0){var E=kr,N=e;switch(e){case"keypress":if(Kt(a)===0)break e;case"keydown":case"keyup":E=gc;break;case"focusin":N="focus",E=Er;break;case"focusout":N="blur",E=Er;break;case"beforeblur":case"afterblur":E=Er;break;case"click":if(a.button===2)break e;case"auxclick":case"dblclick":case"mousedown":case"mousemove":case"mouseup":case"mouseout":case"mouseover":case"contextmenu":E=Ks;break;case"drag":case"dragend":case"dragenter":case"dragexit":case"dragleave":case"dragover":case"dragstart":case"drop":E=nc;break;case"touchcancel":case"touchend":case"touchmove":case"touchstart":E=fc;break;case Ps:case Ws:case Os:E=ic;break;case Bs:E=Tc;break;case"scroll":E=$d;break;case"wheel":E=kc;break;case"copy":case"cut":case"paste":E=oc;break;case"gotpointercapture":case"lostpointercapture":case"pointercancel":case"pointerdown":case"pointermove":case"pointerout":case"pointerover":case"pointerup":E=Hs}var P=(n&4)!=0,h=!P&&e==="scroll",u=P?f!==null?f+"Capture":null:f;P=[];for(var c=d,m;c!==null;){m=c;var p=m.stateNode;if(m.tag===5&&p!==null&&(m=p,u!==null&&(p=Pa(c,u),p!=null&&P.push(xa(c,p,m)))),h)break;c=c.return}0<P.length&&(f=new E(f,N,null,a,y),B.push({event:f,listeners:P}))}}if((n&7)==0){e:{if(f=e==="mouseover"||e==="pointerover",E=e==="mouseout"||e==="pointerout",f&&(n&16)==0&&(N=a.relatedTarget||a.fromElement)&&(Cn(N)||N[qn]))break e;if((E||f)&&(f=y.window===y?y:(f=y.ownerDocument)?f.defaultView||f.parentWindow:window,E?(N=a.relatedTarget||a.toElement,E=d,N=N?Cn(N):null,N!==null&&(h=In(N),N!==h||N.tag!==5&&N.tag!==6)&&(N=null)):(E=null,N=d),E!==N)){if(P=Ks,p="onMouseLeave",u="onMouseEnter",c="mouse",(e==="pointerout"||e==="pointerover")&&(P=Hs,p="onPointerLeave",u="onPointerEnter",c="pointer"),h=E==null?f:zn(E),m=N==null?f:zn(N),f=new P(p,c+"leave",E,a,y),f.target=h,f.relatedTarget=m,p=null,Cn(y)===d&&(P=new P(u,c+"enter",N,a,y),P.target=m,P.relatedTarget=h,p=P),h=p,E&&N)n:{for(P=E,u=N,c=0,m=P;m;m=Zn(m))c++;for(m=0,p=u;p;p=Zn(p))m++;for(;0<c-m;)P=Zn(P),c--;for(;0<m-c;)u=Zn(u),m--;for(;c--;){if(P===u||u!==null&&P===u.alternate)break n;P=Zn(P),u=Zn(u)}P=null}else P=null;E!==null&&dl(B,f,E,P,!1),N!==null&&h!==null&&dl(B,h,N,P,!0)}}e:{if(f=d?zn(d):window,E=f.nodeName&&f.nodeName.toLowerCase(),E==="select"||E==="input"&&f.type==="file")var G=wc;else if(Js(f))if(zs)G=Bc;else{G=Wc;var C=Pc}else(E=f.nodeName)&&E.toLowerCase()==="input"&&(f.type==="checkbox"||f.type==="radio")&&(G=Oc);if(G&&(G=G(e,d))){js(B,G,a,y);break e}C&&C(e,f,d),e==="focusout"&&(C=f._wrapperState)&&C.controlled&&f.type==="number"&&zi(f,"number",f.value)}switch(C=d?zn(d):window,e){case"focusin":(Js(C)||C.contentEditable==="true")&&(_n=C,Pr=d,Ya=null);break;case"focusout":Ya=Pr=_n=null;break;case"mousedown":Wr=!0;break;case"contextmenu":case"mouseup":case"dragend":Wr=!1,nl(B,a,y);break;case"selectionchange":if(Rc)break;case"keydown":case"keyup":nl(B,a,y)}var W;if(vr)e:{switch(e){case"compositionstart":var U="onCompositionStart";break e;case"compositionend":U="onCompositionEnd";break e;case"compositionupdate":U="onCompositionUpdate";break e}U=void 0}else Vn?Qs(e,a)&&(U="onCompositionEnd"):e==="keydown"&&a.keyCode===229&&(U="onCompositionStart");U&&(Fs&&a.locale!=="ko"&&(Vn||U!=="onCompositionStart"?U==="onCompositionEnd"&&Vn&&(W=Us()):($e=y,yr="value"in $e?$e.value:$e.textContent,Vn=!0)),C=Ft(d,U),0<C.length&&(U=new Ls(U,e,null,a,y),B.push({event:U,listeners:C}),W?U.data=W:(W=xs(a),W!==null&&(U.data=W)))),(W=Ic?Cc(e,a):Ec(e,a))&&(d=Ft(d,"onBeforeInput"),0<d.length&&(y=new Ls("onBeforeInput","beforeinput",null,a,y),B.push({event:y,listeners:d}),y.data=W))}Vs(B,n)})}function xa(e,n,a){return{instance:e,listener:n,currentTarget:a}}function Ft(e,n){for(var a=n+"Capture",t=[];e!==null;){var i=e,r=i.stateNode;i.tag===5&&r!==null&&(i=r,r=Pa(e,a),r!=null&&t.unshift(xa(e,r,i)),r=Pa(e,n),r!=null&&t.push(xa(e,r,i))),e=e.return}return t}function Zn(e){if(e===null)return null;do e=e.return;while(e&&e.tag!==5);return e||null}function dl(e,n,a,t,i){for(var r=n._reactName,o=[];a!==null&&a!==t;){var s=a,l=s.alternate,d=s.stateNode;if(l!==null&&l===t)break;s.tag===5&&d!==null&&(s=d,i?(l=Pa(a,r),l!=null&&o.unshift(xa(a,l,s))):i||(l=Pa(a,r),l!=null&&o.push(xa(a,l,s)))),a=a.return}o.length!==0&&e.push({event:n,listeners:o})}function xt(){}var Br=null,Nr=null;function cl(e,n){switch(e){case"button":case"input":case"select":case"textarea":return!!n.autoFocus}return!1}function Gr(e,n){return e==="textarea"||e==="option"||e==="noscript"||typeof n.children=="string"||typeof n.children=="number"||typeof n.dangerouslySetInnerHTML=="object"&&n.dangerouslySetInnerHTML!==null&&n.dangerouslySetInnerHTML.__html!=null}var hl=typeof setTimeout=="function"?setTimeout:void 0,Uc=typeof clearTimeout=="function"?clearTimeout:void 0;function Rr(e){e.nodeType===1?e.textContent="":e.nodeType===9&&(e=e.body,e!=null&&(e.textContent=""))}function Xn(e){for(;e!=null;e=e.nextSibling){var n=e.nodeType;if(n===1||n===3)break}return e}function gl(e){e=e.previousSibling;for(var n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="$"||a==="$!"||a==="$?"){if(n===0)return e;n--}else a==="/$"&&n++}e=e.previousSibling}return null}var Ur=0;function Dc(e){return{$$typeof:Yi,toString:e,valueOf:e}}var Jt=Math.random().toString(36).slice(2),en="__reactFiber$"+Jt,jt="__reactProps$"+Jt,qn="__reactContainer$"+Jt,ml="__reactEvents$"+Jt;function Cn(e){var n=e[en];if(n)return n;for(var a=e.parentNode;a;){if(n=a[qn]||a[en]){if(a=n.alternate,n.child!==null||a!==null&&a.child!==null)for(e=gl(e);e!==null;){if(a=e[en])return a;e=gl(e)}return n}e=a,a=e.parentNode}return null}function wa(e){return e=e[en]||e[qn],!e||e.tag!==5&&e.tag!==6&&e.tag!==13&&e.tag!==3?null:e}function zn(e){if(e.tag===5||e.tag===6)return e.stateNode;throw Error(k(33))}function wt(e){return e[jt]||null}function ol(e){var n=e[ml];return n===void 0&&(n=e[ml]=new Set),n}var Dr=[],$n=-1;function nn(e){return{current:e}}function V(e){0>$n||(e.current=Dr[$n],Dr[$n]=null,$n--)}function _(e,n){$n++,Dr[$n]=e.current,e.current=n}var an={},he=nn(an),ye=nn(!1),En=an;function ea(e,n){var a=e.type.contextTypes;if(!a)return an;var t=e.stateNode;if(t&&t.__reactInternalMemoizedUnmaskedChildContext===n)return t.__reactInternalMemoizedMaskedChildContext;var i={},r;for(r in a)i[r]=n[r];return t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=n,e.__reactInternalMemoizedMaskedChildContext=i),i}function ke(e){return e=e.childContextTypes,e!=null}function Vt(){V(ye),V(he)}function pl(e,n,a){if(he.current!==an)throw Error(k(168));_(he,n),_(ye,a)}function fl(e,n,a){var t=e.stateNode;if(e=n.childContextTypes,typeof t.getChildContext!="function")return a;t=t.getChildContext();for(var i in t)if(!(i in e))throw Error(k(108,Ln(n)||"Unknown",i));return Y({},a,t)}function zt(e){return e=(e=e.stateNode)&&e.__reactInternalMemoizedMergedChildContext||an,En=he.current,_(he,e),_(ye,ye.current),!0}function Sl(e,n,a){var t=e.stateNode;if(!t)throw Error(k(169));a?(e=fl(e,n,En),t.__reactInternalMemoizedMergedChildContext=e,V(ye),V(he),_(he,e)):V(ye),_(ye,a)}var Kr=null,vn=null,Kc=ne.unstable_runWithPriority,Lr=ne.unstable_scheduleCallback,Hr=ne.unstable_cancelCallback,Lc=ne.unstable_shouldYield,Tl=ne.unstable_requestPaint,Fr=ne.unstable_now,Hc=ne.unstable_getCurrentPriorityLevel,_t=ne.unstable_ImmediatePriority,yl=ne.unstable_UserBlockingPriority,kl=ne.unstable_NormalPriority,Al=ne.unstable_LowPriority,Il=ne.unstable_IdlePriority,br={},Fc=Tl!==void 0?Tl:function(){},be=null,Zt=null,Yr=!1,Cl=Fr(),ge=1e4>Cl?Fr:function(){return Fr()-Cl};function na(){switch(Hc()){case _t:return 99;case yl:return 98;case kl:return 97;case Al:return 96;case Il:return 95;default:throw Error(k(332))}}function El(e){switch(e){case 99:return _t;case 98:return yl;case 97:return kl;case 96:return Al;case 95:return Il;default:throw Error(k(332))}}function Mn(e,n){return e=El(e),Kc(e,n)}function Ja(e,n,a){return e=El(e),Lr(e,n,a)}function Ue(){if(Zt!==null){var e=Zt;Zt=null,Hr(e)}vl()}function vl(){if(!Yr&&be!==null){Yr=!0;var e=0;try{var n=be;Mn(99,function(){for(;e<n.length;e++){var a=n[e];do a=a(!0);while(a!==null)}}),be=null}catch(a){throw be!==null&&(be=be.slice(e+1)),Lr(_t,Ue),a}finally{Yr=!1}}}var bc=yn.ReactCurrentBatchConfig;function Ne(e,n){if(e&&e.defaultProps){n=Y({},n),e=e.defaultProps;for(var a in e)n[a]===void 0&&(n[a]=e[a]);return n}return n}var qt=nn(null),Xt=null,aa=null,$t=null;function Qr(){$t=aa=Xt=null}function xr(e){var n=qt.current;V(qt),e.type._context._currentValue=n}function Ml(e,n){for(;e!==null;){var a=e.alternate;if((e.childLanes&n)===n){if(a===null||(a.childLanes&n)===n)break;a.childLanes|=n}else e.childLanes|=n,a!==null&&(a.childLanes|=n);e=e.return}}function ta(e,n){Xt=e,$t=aa=null,e=e.dependencies,e!==null&&e.firstContext!==null&&((e.lanes&n)!=0&&(Ge=!0),e.firstContext=null)}function Me(e,n){if($t!==e&&n!==!1&&n!==0)if((typeof n!="number"||n===1073741823)&&($t=e,n=1073741823),n={context:e,observedBits:n,next:null},aa===null){if(Xt===null)throw Error(k(308));aa=n,Xt.dependencies={lanes:0,firstContext:n,responders:null}}else aa=aa.next=n;return e._currentValue}var tn=!1;function Jr(e){e.updateQueue={baseState:e.memoizedState,firstBaseUpdate:null,lastBaseUpdate:null,shared:{pending:null},effects:null}}function wl(e,n){e=e.updateQueue,n.updateQueue===e&&(n.updateQueue={baseState:e.baseState,firstBaseUpdate:e.firstBaseUpdate,lastBaseUpdate:e.lastBaseUpdate,shared:e.shared,effects:e.effects})}function rn(e,n){return{eventTime:e,lane:n,tag:0,payload:null,callback:null,next:null}}function on(e,n){if(e=e.updateQueue,e!==null){e=e.shared;var a=e.pending;a===null?n.next=n:(n.next=a.next,a.next=n),e.pending=n}}function Pl(e,n){var a=e.updateQueue,t=e.alternate;if(t!==null&&(t=t.updateQueue,a===t)){var i=null,r=null;if(a=a.firstBaseUpdate,a!==null){do{var o={eventTime:a.eventTime,lane:a.lane,tag:a.tag,payload:a.payload,callback:a.callback,next:null};r===null?i=r=o:r=r.next=o,a=a.next}while(a!==null);r===null?i=r=n:r=r.next=n}else i=r=n;a={baseState:t.baseState,firstBaseUpdate:i,lastBaseUpdate:r,shared:t.shared,effects:t.effects},e.updateQueue=a;return}e=a.lastBaseUpdate,e===null?a.firstBaseUpdate=n:e.next=n,a.lastBaseUpdate=n}function Va(e,n,a,t){var i=e.updateQueue;tn=!1;var r=i.firstBaseUpdate,o=i.lastBaseUpdate,s=i.shared.pending;if(s!==null){i.shared.pending=null;var l=s,d=l.next;l.next=null,o===null?r=d:o.next=d,o=l;var y=e.alternate;if(y!==null){y=y.updateQueue;var B=y.lastBaseUpdate;B!==o&&(B===null?y.firstBaseUpdate=d:B.next=d,y.lastBaseUpdate=l)}}if(r!==null){B=i.baseState,o=0,y=d=l=null;do{s=r.lane;var f=r.eventTime;if((t&s)===s){y!==null&&(y=y.next={eventTime:f,lane:0,tag:r.tag,payload:r.payload,callback:r.callback,next:null});e:{var E=e,N=r;switch(s=n,f=a,N.tag){case 1:if(E=N.payload,typeof E=="function"){B=E.call(f,B,s);break e}B=E;break e;case 3:E.flags=E.flags&-4097|64;case 0:if(E=N.payload,s=typeof E=="function"?E.call(f,B,s):E,s==null)break e;B=Y({},B,s);break e;case 2:tn=!0}}r.callback!==null&&(e.flags|=32,s=i.effects,s===null?i.effects=[r]:s.push(r))}else f={eventTime:f,lane:s,tag:r.tag,payload:r.payload,callback:r.callback,next:null},y===null?(d=y=f,l=B):y=y.next=f,o|=s;if(r=r.next,r===null){if(s=i.shared.pending,s===null)break;r=s.next,s.next=null,i.lastBaseUpdate=s,i.shared.pending=null}}while(1);y===null&&(l=B),i.baseState=l,i.firstBaseUpdate=d,i.lastBaseUpdate=y,ja|=o,e.lanes=o,e.memoizedState=B}}function Wl(e,n,a){if(e=n.effects,n.effects=null,e!==null)for(n=0;n<e.length;n++){var t=e[n],i=t.callback;if(i!==null){if(t.callback=null,t=a,typeof i!="function")throw Error(k(191,i));i.call(t)}}}var Ol=new F.Component().refs;function ei(e,n,a,t){n=e.memoizedState,a=a(t,n),a=a==null?n:Y({},n,a),e.memoizedState=a,e.lanes===0&&(e.updateQueue.baseState=a)}var ni={isMounted:function(e){return(e=e._reactInternals)?In(e)===e:!1},enqueueSetState:function(e,n,a){e=e._reactInternals;var t=Ee(),i=sn(e),r=rn(t,i);r.payload=n,a!=null&&(r.callback=a),on(e,r),ln(e,i,t)},enqueueReplaceState:function(e,n,a){e=e._reactInternals;var t=Ee(),i=sn(e),r=rn(t,i);r.tag=1,r.payload=n,a!=null&&(r.callback=a),on(e,r),ln(e,i,t)},enqueueForceUpdate:function(e,n){e=e._reactInternals;var a=Ee(),t=sn(e),i=rn(a,t);i.tag=2,n!=null&&(i.callback=n),on(e,i),ln(e,t,a)}};function Bl(e,n,a,t,i,r,o){return e=e.stateNode,typeof e.shouldComponentUpdate=="function"?e.shouldComponentUpdate(t,r,o):n.prototype&&n.prototype.isPureReactComponent?!ba(a,t)||!ba(i,r):!0}function Nl(e,n,a){var t=!1,i=an,r=n.contextType;return typeof r=="object"&&r!==null?r=Me(r):(i=ke(n)?En:he.current,t=n.contextTypes,r=(t=t!=null)?ea(e,i):an),n=new n(a,r),e.memoizedState=n.state!==null&&n.state!==void 0?n.state:null,n.updater=ni,e.stateNode=n,n._reactInternals=e,t&&(e=e.stateNode,e.__reactInternalMemoizedUnmaskedChildContext=i,e.__reactInternalMemoizedMaskedChildContext=r),n}function Gl(e,n,a,t){e=n.state,typeof n.componentWillReceiveProps=="function"&&n.componentWillReceiveProps(a,t),typeof n.UNSAFE_componentWillReceiveProps=="function"&&n.UNSAFE_componentWillReceiveProps(a,t),n.state!==e&&ni.enqueueReplaceState(n,n.state,null)}function jr(e,n,a,t){var i=e.stateNode;i.props=a,i.state=e.memoizedState,i.refs=Ol,Jr(e);var r=n.contextType;typeof r=="object"&&r!==null?i.context=Me(r):(r=ke(n)?En:he.current,i.context=ea(e,r)),Va(e,a,i,t),i.state=e.memoizedState,r=n.getDerivedStateFromProps,typeof r=="function"&&(ei(e,n,r,a),i.state=e.memoizedState),typeof n.getDerivedStateFromProps=="function"||typeof i.getSnapshotBeforeUpdate=="function"||typeof i.UNSAFE_componentWillMount!="function"&&typeof i.componentWillMount!="function"||(n=i.state,typeof i.componentWillMount=="function"&&i.componentWillMount(),typeof i.UNSAFE_componentWillMount=="function"&&i.UNSAFE_componentWillMount(),n!==i.state&&ni.enqueueReplaceState(i,i.state,null),Va(e,a,i,t),i.state=e.memoizedState),typeof i.componentDidMount=="function"&&(e.flags|=4)}var ai=Array.isArray;function za(e,n,a){if(e=a.ref,e!==null&&typeof e!="function"&&typeof e!="object"){if(a._owner){if(a=a._owner,a){if(a.tag!==1)throw Error(k(309));var t=a.stateNode}if(!t)throw Error(k(147,e));var i=""+e;return n!==null&&n.ref!==null&&typeof n.ref=="function"&&n.ref._stringRef===i?n.ref:(n=function(r){var o=t.refs;o===Ol&&(o=t.refs={}),r===null?delete o[i]:o[i]=r},n._stringRef=i,n)}if(typeof e!="string")throw Error(k(284));if(!a._owner)throw Error(k(290,e))}return e}function ti(e,n){if(e.type!=="textarea")throw Error(k(31,Object.prototype.toString.call(n)==="[object Object]"?"object with keys {"+Object.keys(n).join(", ")+"}":n))}function Rl(e){function n(h,u){if(e){var c=h.lastEffect;c!==null?(c.nextEffect=u,h.lastEffect=u):h.firstEffect=h.lastEffect=u,u.nextEffect=null,u.flags=8}}function a(h,u){if(!e)return null;for(;u!==null;)n(h,u),u=u.sibling;return null}function t(h,u){for(h=new Map;u!==null;)u.key!==null?h.set(u.key,u):h.set(u.index,u),u=u.sibling;return h}function i(h,u){return h=un(h,u),h.index=0,h.sibling=null,h}function r(h,u,c){return h.index=c,e?(c=h.alternate,c!==null?(c=c.index,c<u?(h.flags=2,u):c):(h.flags=2,u)):u}function o(h){return e&&h.alternate===null&&(h.flags=2),h}function s(h,u,c,m){return u===null||u.tag!==6?(u=Vr(c,h.mode,m),u.return=h,u):(u=i(u,c),u.return=h,u)}function l(h,u,c,m){return u!==null&&u.elementType===c.type?(m=i(u,c.props),m.ref=za(h,u,c),m.return=h,m):(m=ii(c.type,c.key,c.props,null,h.mode,m),m.ref=za(h,u,c),m.return=h,m)}function d(h,u,c,m){return u===null||u.tag!==4||u.stateNode.containerInfo!==c.containerInfo||u.stateNode.implementation!==c.implementation?(u=zr(c,h.mode,m),u.return=h,u):(u=i(u,c.children||[]),u.return=h,u)}function y(h,u,c,m,p){return u===null||u.tag!==7?(u=ia(c,h.mode,m,p),u.return=h,u):(u=i(u,c),u.return=h,u)}function B(h,u,c){if(typeof u=="string"||typeof u=="number")return u=Vr(""+u,h.mode,c),u.return=h,u;if(typeof u=="object"&&u!==null){switch(u.$$typeof){case ka:return c=ii(u.type,u.key,u.props,null,h.mode,c),c.ref=za(h,null,u),c.return=h,c;case kn:return u=zr(u,h.mode,c),u.return=h,u}if(ai(u)||Ca(u))return u=ia(u,h.mode,c,null),u.return=h,u;ti(h,u)}return null}function f(h,u,c,m){var p=u!==null?u.key:null;if(typeof c=="string"||typeof c=="number")return p!==null?null:s(h,u,""+c,m);if(typeof c=="object"&&c!==null){switch(c.$$typeof){case ka:return c.key===p?c.type===Ve?y(h,u,c.props.children,m,p):l(h,u,c,m):null;case kn:return c.key===p?d(h,u,c,m):null}if(ai(c)||Ca(c))return p!==null?null:y(h,u,c,m,null);ti(h,c)}return null}function E(h,u,c,m,p){if(typeof m=="string"||typeof m=="number")return h=h.get(c)||null,s(u,h,""+m,p);if(typeof m=="object"&&m!==null){switch(m.$$typeof){case ka:return h=h.get(m.key===null?c:m.key)||null,m.type===Ve?y(u,h,m.props.children,p,m.key):l(u,h,m,p);case kn:return h=h.get(m.key===null?c:m.key)||null,d(u,h,m,p)}if(ai(m)||Ca(m))return h=h.get(c)||null,y(u,h,m,p,null);ti(u,m)}return null}function N(h,u,c,m){for(var p=null,G=null,C=u,W=u=0,U=null;C!==null&&W<c.length;W++){C.index>W?(U=C,C=null):U=C.sibling;var R=f(h,C,c[W],m);if(R===null){C===null&&(C=U);break}e&&C&&R.alternate===null&&n(h,C),u=r(R,u,W),G===null?p=R:G.sibling=R,G=R,C=U}if(W===c.length)return a(h,C),p;if(C===null){for(;W<c.length;W++)C=B(h,c[W],m),C!==null&&(u=r(C,u,W),G===null?p=C:G.sibling=C,G=C);return p}for(C=t(h,C);W<c.length;W++)U=E(C,h,W,c[W],m),U!==null&&(e&&U.alternate!==null&&C.delete(U.key===null?W:U.key),u=r(U,u,W),G===null?p=U:G.sibling=U,G=U);return e&&C.forEach(function(z){return n(h,z)}),p}function P(h,u,c,m){var p=Ca(c);if(typeof p!="function")throw Error(k(150));if(c=p.call(c),c==null)throw Error(k(151));for(var G=p=null,C=u,W=u=0,U=null,R=c.next();C!==null&&!R.done;W++,R=c.next()){C.index>W?(U=C,C=null):U=C.sibling;var z=f(h,C,R.value,m);if(z===null){C===null&&(C=U);break}e&&C&&z.alternate===null&&n(h,C),u=r(z,u,W),G===null?p=z:G.sibling=z,G=z,C=U}if(R.done)return a(h,C),p;if(C===null){for(;!R.done;W++,R=c.next())R=B(h,R.value,m),R!==null&&(u=r(R,u,W),G===null?p=R:G.sibling=R,G=R);return p}for(C=t(h,C);!R.done;W++,R=c.next())R=E(C,h,W,R.value,m),R!==null&&(e&&R.alternate!==null&&C.delete(R.key===null?W:R.key),u=r(R,u,W),G===null?p=R:G.sibling=R,G=R);return e&&C.forEach(function(Te){return n(h,Te)}),p}return function(h,u,c,m){var p=typeof c=="object"&&c!==null&&c.type===Ve&&c.key===null;p&&(c=c.props.children);var G=typeof c=="object"&&c!==null;if(G)switch(c.$$typeof){case ka:e:{for(G=c.key,p=u;p!==null;){if(p.key===G){switch(p.tag){case 7:if(c.type===Ve){a(h,p.sibling),u=i(p,c.props.children),u.return=h,h=u;break e}break;default:if(p.elementType===c.type){a(h,p.sibling),u=i(p,c.props),u.ref=za(h,p,c),u.return=h,h=u;break e}}a(h,p);break}else n(h,p);p=p.sibling}c.type===Ve?(u=ia(c.props.children,h.mode,m,c.key),u.return=h,h=u):(m=ii(c.type,c.key,c.props,null,h.mode,m),m.ref=za(h,u,c),m.return=h,h=m)}return o(h);case kn:e:{for(p=c.key;u!==null;){if(u.key===p)if(u.tag===4&&u.stateNode.containerInfo===c.containerInfo&&u.stateNode.implementation===c.implementation){a(h,u.sibling),u=i(u,c.children||[]),u.return=h,h=u;break e}else{a(h,u);break}else n(h,u);u=u.sibling}u=zr(c,h.mode,m),u.return=h,h=u}return o(h)}if(typeof c=="string"||typeof c=="number")return c=""+c,u!==null&&u.tag===6?(a(h,u.sibling),u=i(u,c),u.return=h,h=u):(a(h,u),u=Vr(c,h.mode,m),u.return=h,h=u),o(h);if(ai(c))return N(h,u,c,m);if(Ca(c))return P(h,u,c,m);if(G&&ti(h,c),typeof c=="undefined"&&!p)switch(h.tag){case 1:case 22:case 0:case 11:case 15:throw Error(k(152,Ln(h.type)||"Component"))}return a(h,u)}}var ri=Rl(!0),Ul=Rl(!1),_a={},De=nn(_a),Za=nn(_a),qa=nn(_a);function wn(e){if(e===_a)throw Error(k(174));return e}function _r(e,n){switch(_(qa,n),_(Za,e),_(De,_a),e=n.nodeType,e){case 9:case 11:n=(n=n.documentElement)?n.namespaceURI:$i(null,"");break;default:e=e===8?n.parentNode:n,n=e.namespaceURI||null,e=e.tagName,n=$i(n,e)}V(De),_(De,n)}function ra(){V(De),V(Za),V(qa)}function Dl(e){wn(qa.current);var n=wn(De.current),a=$i(n,e.type);n!==a&&(_(Za,e),_(De,a))}function Zr(e){Za.current===e&&(V(De),V(Za))}var Z=nn(0);function oi(e){for(var n=e;n!==null;){if(n.tag===13){var a=n.memoizedState;if(a!==null&&(a=a.dehydrated,a===null||a.data==="$?"||a.data==="$!"))return n}else if(n.tag===19&&n.memoizedProps.revealOrder!==void 0){if((n.flags&64)!=0)return n}else if(n.child!==null){n.child.return=n,n=n.child;continue}if(n===e)break;for(;n.sibling===null;){if(n.return===null||n.return===e)return null;n=n.return}n.sibling.return=n.return,n=n.sibling}return null}var Ye=null,dn=null,Ke=!1;function Kl(e,n){var a=we(5,null,null,0);a.elementType="DELETED",a.type="DELETED",a.stateNode=n,a.return=e,a.flags=8,e.lastEffect!==null?(e.lastEffect.nextEffect=a,e.lastEffect=a):e.firstEffect=e.lastEffect=a}function Ll(e,n){switch(e.tag){case 5:var a=e.type;return n=n.nodeType!==1||a.toLowerCase()!==n.nodeName.toLowerCase()?null:n,n!==null?(e.stateNode=n,!0):!1;case 6:return n=e.pendingProps===""||n.nodeType!==3?null:n,n!==null?(e.stateNode=n,!0):!1;case 13:return!1;default:return!1}}function qr(e){if(Ke){var n=dn;if(n){var a=n;if(!Ll(e,n)){if(n=Xn(a.nextSibling),!n||!Ll(e,n)){e.flags=e.flags&-1025|2,Ke=!1,Ye=e;return}Kl(Ye,a)}Ye=e,dn=Xn(n.firstChild)}else e.flags=e.flags&-1025|2,Ke=!1,Ye=e}}function Hl(e){for(e=e.return;e!==null&&e.tag!==5&&e.tag!==3&&e.tag!==13;)e=e.return;Ye=e}function si(e){if(e!==Ye)return!1;if(!Ke)return Hl(e),Ke=!0,!1;var n=e.type;if(e.tag!==5||n!=="head"&&n!=="body"&&!Gr(n,e.memoizedProps))for(n=dn;n;)Kl(e,n),n=Xn(n.nextSibling);if(Hl(e),e.tag===13){if(e=e.memoizedState,e=e!==null?e.dehydrated:null,!e)throw Error(k(317));e:{for(e=e.nextSibling,n=0;e;){if(e.nodeType===8){var a=e.data;if(a==="/$"){if(n===0){dn=Xn(e.nextSibling);break e}n--}else a!=="$"&&a!=="$!"&&a!=="$?"||n++}e=e.nextSibling}dn=null}}else dn=Ye?Xn(e.stateNode.nextSibling):null;return!0}function Xr(){dn=Ye=null,Ke=!1}var oa=[];function $r(){for(var e=0;e<oa.length;e++)oa[e]._workInProgressVersionPrimary=null;oa.length=0}var Xa=yn.ReactCurrentDispatcher,Pe=yn.ReactCurrentBatchConfig,$a=0,q=null,me=null,de=null,li=!1,et=!1;function Ae(){throw Error(k(321))}function eo(e,n){if(n===null)return!1;for(var a=0;a<n.length&&a<e.length;a++)if(!ve(e[a],n[a]))return!1;return!0}function no(e,n,a,t,i,r){if($a=r,q=n,n.memoizedState=null,n.updateQueue=null,n.lanes=0,Xa.current=e===null||e.memoizedState===null?Yc:Qc,e=a(t,i),et){r=0;do{if(et=!1,!(25>r))throw Error(k(301));r+=1,de=me=null,n.updateQueue=null,Xa.current=xc,e=a(t,i)}while(et)}if(Xa.current=ui,n=me!==null&&me.next!==null,$a=0,de=me=q=null,li=!1,n)throw Error(k(300));return e}function Pn(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null};return de===null?q.memoizedState=de=e:de=de.next=e,de}function Wn(){if(me===null){var e=q.alternate;e=e!==null?e.memoizedState:null}else e=me.next;var n=de===null?q.memoizedState:de.next;if(n!==null)de=n,me=e;else{if(e===null)throw Error(k(310));me=e,e={memoizedState:me.memoizedState,baseState:me.baseState,baseQueue:me.baseQueue,queue:me.queue,next:null},de===null?q.memoizedState=de=e:de=de.next=e}return de}function Le(e,n){return typeof n=="function"?n(e):n}function nt(e){var n=Wn(),a=n.queue;if(a===null)throw Error(k(311));a.lastRenderedReducer=e;var t=me,i=t.baseQueue,r=a.pending;if(r!==null){if(i!==null){var o=i.next;i.next=r.next,r.next=o}t.baseQueue=i=r,a.pending=null}if(i!==null){i=i.next,t=t.baseState;var s=o=r=null,l=i;do{var d=l.lane;if(($a&d)===d)s!==null&&(s=s.next={lane:0,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null}),t=l.eagerReducer===e?l.eagerState:e(t,l.action);else{var y={lane:d,action:l.action,eagerReducer:l.eagerReducer,eagerState:l.eagerState,next:null};s===null?(o=s=y,r=t):s=s.next=y,q.lanes|=d,ja|=d}l=l.next}while(l!==null&&l!==i);s===null?r=t:s.next=o,ve(t,n.memoizedState)||(Ge=!0),n.memoizedState=t,n.baseState=r,n.baseQueue=s,a.lastRenderedState=t}return[n.memoizedState,a.dispatch]}function at(e){var n=Wn(),a=n.queue;if(a===null)throw Error(k(311));a.lastRenderedReducer=e;var t=a.dispatch,i=a.pending,r=n.memoizedState;if(i!==null){a.pending=null;var o=i=i.next;do r=e(r,o.action),o=o.next;while(o!==i);ve(r,n.memoizedState)||(Ge=!0),n.memoizedState=r,n.baseQueue===null&&(n.baseState=r),a.lastRenderedState=r}return[r,t]}function Fl(e,n,a){var t=n._getVersion;t=t(n._source);var i=n._workInProgressVersionPrimary;if(i!==null?e=i===t:(e=e.mutableReadLanes,(e=($a&e)===e)&&(n._workInProgressVersionPrimary=t,oa.push(n))),e)return a(n._source);throw oa.push(n),Error(k(350))}function bl(e,n,a,t){var i=Se;if(i===null)throw Error(k(349));var r=n._getVersion,o=r(n._source),s=Xa.current,l=s.useState(function(){return Fl(i,n,a)}),d=l[1],y=l[0];l=de;var B=e.memoizedState,f=B.refs,E=f.getSnapshot,N=B.source;B=B.subscribe;var P=q;return e.memoizedState={refs:f,source:n,subscribe:t},s.useEffect(function(){f.getSnapshot=a,f.setSnapshot=d;var h=r(n._source);if(!ve(o,h)){h=a(n._source),ve(y,h)||(d(h),h=sn(P),i.mutableReadLanes|=h&i.pendingLanes),h=i.mutableReadLanes,i.entangledLanes|=h;for(var u=i.entanglements,c=h;0<c;){var m=31-Xe(c),p=1<<m;u[m]|=h,c&=~p}}},[a,n,t]),s.useEffect(function(){return t(n._source,function(){var h=f.getSnapshot,u=f.setSnapshot;try{u(h(n._source));var c=sn(P);i.mutableReadLanes|=c&i.pendingLanes}catch(m){u(function(){throw m})}})},[n,t]),ve(E,a)&&ve(N,n)&&ve(B,t)||(e={pending:null,dispatch:null,lastRenderedReducer:Le,lastRenderedState:y},e.dispatch=d=ao.bind(null,q,e),l.queue=e,l.baseQueue=null,y=Fl(i,n,a),l.memoizedState=l.baseState=y),y}function Yl(e,n,a){var t=Wn();return bl(t,e,n,a)}function tt(e){var n=Pn();return typeof e=="function"&&(e=e()),n.memoizedState=n.baseState=e,e=n.queue={pending:null,dispatch:null,lastRenderedReducer:Le,lastRenderedState:e},e=e.dispatch=ao.bind(null,q,e),[n.memoizedState,e]}function di(e,n,a,t){return e={tag:e,create:n,destroy:a,deps:t,next:null},n=q.updateQueue,n===null?(n={lastEffect:null},q.updateQueue=n,n.lastEffect=e.next=e):(a=n.lastEffect,a===null?n.lastEffect=e.next=e:(t=a.next,a.next=e,e.next=t,n.lastEffect=e)),e}function Ql(e){var n=Pn();return e={current:e},n.memoizedState=e}function ci(){return Wn().memoizedState}function to(e,n,a,t){var i=Pn();q.flags|=e,i.memoizedState=di(1|n,a,void 0,t===void 0?null:t)}function io(e,n,a,t){var i=Wn();t=t===void 0?null:t;var r=void 0;if(me!==null){var o=me.memoizedState;if(r=o.destroy,t!==null&&eo(t,o.deps)){di(n,a,r,t);return}}q.flags|=e,i.memoizedState=di(1|n,a,r,t)}function xl(e,n){return to(516,4,e,n)}function hi(e,n){return io(516,4,e,n)}function Jl(e,n){return io(4,2,e,n)}function jl(e,n){if(typeof n=="function")return e=e(),n(e),function(){n(null)};if(n!=null)return e=e(),n.current=e,function(){n.current=null}}function Vl(e,n,a){return a=a!=null?a.concat([e]):null,io(4,2,jl.bind(null,n,e),a)}function ro(){}function zl(e,n){var a=Wn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&eo(n,t[1])?t[0]:(a.memoizedState=[e,n],e)}function _l(e,n){var a=Wn();n=n===void 0?null:n;var t=a.memoizedState;return t!==null&&n!==null&&eo(n,t[1])?t[0]:(e=e(),a.memoizedState=[e,n],e)}function Jc(e,n){var a=na();Mn(98>a?98:a,function(){e(!0)}),Mn(97<a?97:a,function(){var t=Pe.transition;Pe.transition=1;try{e(!1),n()}finally{Pe.transition=t}})}function ao(e,n,a){var t=Ee(),i=sn(e),r={lane:i,action:a,eagerReducer:null,eagerState:null,next:null},o=n.pending;if(o===null?r.next=r:(r.next=o.next,o.next=r),n.pending=r,o=e.alternate,e===q||o!==null&&o===q)et=li=!0;else{if(e.lanes===0&&(o===null||o.lanes===0)&&(o=n.lastRenderedReducer,o!==null))try{var s=n.lastRenderedState,l=o(s,a);if(r.eagerReducer=o,r.eagerState=l,ve(l,s))return}catch(d){}finally{}ln(e,i,t)}}var ui={readContext:Me,useCallback:Ae,useContext:Ae,useEffect:Ae,useImperativeHandle:Ae,useLayoutEffect:Ae,useMemo:Ae,useReducer:Ae,useRef:Ae,useState:Ae,useDebugValue:Ae,useDeferredValue:Ae,useTransition:Ae,useMutableSource:Ae,useOpaqueIdentifier:Ae,unstable_isNewReconciler:!1},Yc={readContext:Me,useCallback:function(e,n){return Pn().memoizedState=[e,n===void 0?null:n],e},useContext:Me,useEffect:xl,useImperativeHandle:function(e,n,a){return a=a!=null?a.concat([e]):null,to(4,2,jl.bind(null,n,e),a)},useLayoutEffect:function(e,n){return to(4,2,e,n)},useMemo:function(e,n){var a=Pn();return n=n===void 0?null:n,e=e(),a.memoizedState=[e,n],e},useReducer:function(e,n,a){var t=Pn();return n=a!==void 0?a(n):n,t.memoizedState=t.baseState=n,e=t.queue={pending:null,dispatch:null,lastRenderedReducer:e,lastRenderedState:n},e=e.dispatch=ao.bind(null,q,e),[t.memoizedState,e]},useRef:Ql,useState:tt,useDebugValue:ro,useDeferredValue:function(e){var n=tt(e),a=n[0],t=n[1];return xl(function(){var i=Pe.transition;Pe.transition=1;try{t(e)}finally{Pe.transition=i}},[e]),a},useTransition:function(){var e=tt(!1),n=e[0];return e=Jc.bind(null,e[1]),Ql(e),[e,n]},useMutableSource:function(e,n,a){var t=Pn();return t.memoizedState={refs:{getSnapshot:n,setSnapshot:null},source:e,subscribe:a},bl(t,e,n,a)},useOpaqueIdentifier:function(){if(Ke){var e=!1,n=Dc(function(){throw e||(e=!0,a("r:"+(Ur++).toString(36))),Error(k(355))}),a=tt(n)[1];return(q.mode&2)==0&&(q.flags|=516,di(5,function(){a("r:"+(Ur++).toString(36))},void 0,null)),n}return n="r:"+(Ur++).toString(36),tt(n),n},unstable_isNewReconciler:!1},Qc={readContext:Me,useCallback:zl,useContext:Me,useEffect:hi,useImperativeHandle:Vl,useLayoutEffect:Jl,useMemo:_l,useReducer:nt,useRef:ci,useState:function(){return nt(Le)},useDebugValue:ro,useDeferredValue:function(e){var n=nt(Le),a=n[0],t=n[1];return hi(function(){var i=Pe.transition;Pe.transition=1;try{t(e)}finally{Pe.transition=i}},[e]),a},useTransition:function(){var e=nt(Le)[0];return[ci().current,e]},useMutableSource:Yl,useOpaqueIdentifier:function(){return nt(Le)[0]},unstable_isNewReconciler:!1},xc={readContext:Me,useCallback:zl,useContext:Me,useEffect:hi,useImperativeHandle:Vl,useLayoutEffect:Jl,useMemo:_l,useReducer:at,useRef:ci,useState:function(){return at(Le)},useDebugValue:ro,useDeferredValue:function(e){var n=at(Le),a=n[0],t=n[1];return hi(function(){var i=Pe.transition;Pe.transition=1;try{t(e)}finally{Pe.transition=i}},[e]),a},useTransition:function(){var e=at(Le)[0];return[ci().current,e]},useMutableSource:Yl,useOpaqueIdentifier:function(){return at(Le)[0]},unstable_isNewReconciler:!1},jc=yn.ReactCurrentOwner,Ge=!1;function Ie(e,n,a,t){n.child=e===null?Ul(n,null,a,t):ri(n,e.child,a,t)}function Zl(e,n,a,t,i){a=a.render;var r=n.ref;return ta(n,i),t=no(e,n,a,t,r,i),e!==null&&!Ge?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,Qe(e,n,i)):(n.flags|=1,Ie(e,n,t,i),n.child)}function Xl(e,n,a,t,i,r){if(e===null){var o=a.type;return typeof o=="function"&&!oo(o)&&o.defaultProps===void 0&&a.compare===null&&a.defaultProps===void 0?(n.tag=15,n.type=o,ql(e,n,o,t,i,r)):(e=ii(a.type,null,t,n,n.mode,r),e.ref=n.ref,e.return=n,n.child=e)}return o=e.child,(i&r)==0&&(i=o.memoizedProps,a=a.compare,a=a!==null?a:ba,a(i,t)&&e.ref===n.ref)?Qe(e,n,r):(n.flags|=1,e=un(o,t),e.ref=n.ref,e.return=n,n.child=e)}function ql(e,n,a,t,i,r){if(e!==null&&ba(e.memoizedProps,t)&&e.ref===n.ref)if(Ge=!1,(r&i)!=0)(e.flags&16384)!=0&&(Ge=!0);else return n.lanes=e.lanes,Qe(e,n,r);return so(e,n,a,t,r)}function lo(e,n,a){var t=n.pendingProps,i=t.children,r=e!==null?e.memoizedState:null;if(t.mode==="hidden"||t.mode==="unstable-defer-without-hiding")if((n.mode&4)==0)n.memoizedState={baseLanes:0},gi(n,a);else if((a&1073741824)!=0)n.memoizedState={baseLanes:0},gi(n,r!==null?r.baseLanes:a);else return e=r!==null?r.baseLanes|a:a,n.lanes=n.childLanes=1073741824,n.memoizedState={baseLanes:e},gi(n,e),null;else r!==null?(t=r.baseLanes|a,n.memoizedState=null):t=a,gi(n,t);return Ie(e,n,i,a),n.child}function $l(e,n){var a=n.ref;(e===null&&a!==null||e!==null&&e.ref!==a)&&(n.flags|=128)}function so(e,n,a,t,i){var r=ke(a)?En:he.current;return r=ea(n,r),ta(n,i),a=no(e,n,a,t,r,i),e!==null&&!Ge?(n.updateQueue=e.updateQueue,n.flags&=-517,e.lanes&=~i,Qe(e,n,i)):(n.flags|=1,Ie(e,n,a,i),n.child)}function eu(e,n,a,t,i){if(ke(a)){var r=!0;zt(n)}else r=!1;if(ta(n,i),n.stateNode===null)e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),Nl(n,a,t),jr(n,a,t,i),t=!0;else if(e===null){var o=n.stateNode,s=n.memoizedProps;o.props=s;var l=o.context,d=a.contextType;typeof d=="object"&&d!==null?d=Me(d):(d=ke(a)?En:he.current,d=ea(n,d));var y=a.getDerivedStateFromProps,B=typeof y=="function"||typeof o.getSnapshotBeforeUpdate=="function";B||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==t||l!==d)&&Gl(n,o,t,d),tn=!1;var f=n.memoizedState;o.state=f,Va(n,t,o,i),l=n.memoizedState,s!==t||f!==l||ye.current||tn?(typeof y=="function"&&(ei(n,a,y,t),l=n.memoizedState),(s=tn||Bl(n,a,s,t,f,l,d))?(B||typeof o.UNSAFE_componentWillMount!="function"&&typeof o.componentWillMount!="function"||(typeof o.componentWillMount=="function"&&o.componentWillMount(),typeof o.UNSAFE_componentWillMount=="function"&&o.UNSAFE_componentWillMount()),typeof o.componentDidMount=="function"&&(n.flags|=4)):(typeof o.componentDidMount=="function"&&(n.flags|=4),n.memoizedProps=t,n.memoizedState=l),o.props=t,o.state=l,o.context=d,t=s):(typeof o.componentDidMount=="function"&&(n.flags|=4),t=!1)}else{o=n.stateNode,wl(e,n),s=n.memoizedProps,d=n.type===n.elementType?s:Ne(n.type,s),o.props=d,B=n.pendingProps,f=o.context,l=a.contextType,typeof l=="object"&&l!==null?l=Me(l):(l=ke(a)?En:he.current,l=ea(n,l));var E=a.getDerivedStateFromProps;(y=typeof E=="function"||typeof o.getSnapshotBeforeUpdate=="function")||typeof o.UNSAFE_componentWillReceiveProps!="function"&&typeof o.componentWillReceiveProps!="function"||(s!==B||f!==l)&&Gl(n,o,t,l),tn=!1,f=n.memoizedState,o.state=f,Va(n,t,o,i);var N=n.memoizedState;s!==B||f!==N||ye.current||tn?(typeof E=="function"&&(ei(n,a,E,t),N=n.memoizedState),(d=tn||Bl(n,a,d,t,f,N,l))?(y||typeof o.UNSAFE_componentWillUpdate!="function"&&typeof o.componentWillUpdate!="function"||(typeof o.componentWillUpdate=="function"&&o.componentWillUpdate(t,N,l),typeof o.UNSAFE_componentWillUpdate=="function"&&o.UNSAFE_componentWillUpdate(t,N,l)),typeof o.componentDidUpdate=="function"&&(n.flags|=4),typeof o.getSnapshotBeforeUpdate=="function"&&(n.flags|=256)):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=256),n.memoizedProps=t,n.memoizedState=N),o.props=t,o.state=N,o.context=l,t=d):(typeof o.componentDidUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=4),typeof o.getSnapshotBeforeUpdate!="function"||s===e.memoizedProps&&f===e.memoizedState||(n.flags|=256),t=!1)}return uo(e,n,a,t,r,i)}function uo(e,n,a,t,i,r){$l(e,n);var o=(n.flags&64)!=0;if(!t&&!o)return i&&Sl(n,a,!1),Qe(e,n,r);t=n.stateNode,jc.current=n;var s=o&&typeof a.getDerivedStateFromError!="function"?null:t.render();return n.flags|=1,e!==null&&o?(n.child=ri(n,e.child,null,r),n.child=ri(n,null,s,r)):Ie(e,n,s,r),n.memoizedState=t.state,i&&Sl(n,a,!0),n.child}function nu(e){var n=e.stateNode;n.pendingContext?pl(e,n.pendingContext,n.pendingContext!==n.context):n.context&&pl(e,n.context,!1),_r(e,n.containerInfo)}var mi={dehydrated:null,retryLane:0};function ru(e,n,a){var t=n.pendingProps,i=Z.current,r=!1,o;return(o=(n.flags&64)!=0)||(o=e!==null&&e.memoizedState===null?!1:(i&2)!=0),o?(r=!0,n.flags&=-65):e!==null&&e.memoizedState===null||t.fallback===void 0||t.unstable_avoidThisFallback===!0||(i|=1),_(Z,i&1),e===null?(t.fallback!==void 0&&qr(n),e=t.children,i=t.fallback,r?(e=au(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=mi,e):typeof t.unstable_expectedLoadTime=="number"?(e=au(n,e,i,a),n.child.memoizedState={baseLanes:a},n.memoizedState=mi,n.lanes=33554432,e):(a=co({mode:"visible",children:e},n.mode,a,null),a.return=n,n.child=a)):e.memoizedState!==null?r?(t=iu(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=mi,t):(a=tu(e,n,t.children,a),n.memoizedState=null,a):r?(t=iu(e,n,t.children,t.fallback,a),r=n.child,i=e.child.memoizedState,r.memoizedState=i===null?{baseLanes:a}:{baseLanes:i.baseLanes|a},r.childLanes=e.childLanes&~a,n.memoizedState=mi,t):(a=tu(e,n,t.children,a),n.memoizedState=null,a)}function au(e,n,a,t){var i=e.mode,r=e.child;return n={mode:"hidden",children:n},(i&2)==0&&r!==null?(r.childLanes=0,r.pendingProps=n):r=co(n,i,0,null),a=ia(a,i,t,null),r.return=e,a.return=e,r.sibling=a,e.child=r,a}function tu(e,n,a,t){var i=e.child;return e=i.sibling,a=un(i,{mode:"visible",children:a}),(n.mode&2)==0&&(a.lanes=t),a.return=n,a.sibling=null,e!==null&&(e.nextEffect=null,e.flags=8,n.firstEffect=n.lastEffect=e),n.child=a}function iu(e,n,a,t,i){var r=n.mode,o=e.child;e=o.sibling;var s={mode:"hidden",children:a};return(r&2)==0&&n.child!==o?(a=n.child,a.childLanes=0,a.pendingProps=s,o=a.lastEffect,o!==null?(n.firstEffect=a.firstEffect,n.lastEffect=o,o.nextEffect=null):n.firstEffect=n.lastEffect=null):a=un(o,s),e!==null?t=un(e,t):(t=ia(t,r,i,null),t.flags|=2),t.return=n,a.return=n,a.sibling=t,n.child=a,t}function ou(e,n){e.lanes|=n;var a=e.alternate;a!==null&&(a.lanes|=n),Ml(e.return,n)}function ho(e,n,a,t,i,r){var o=e.memoizedState;o===null?e.memoizedState={isBackwards:n,rendering:null,renderingStartTime:0,last:t,tail:a,tailMode:i,lastEffect:r}:(o.isBackwards=n,o.rendering=null,o.renderingStartTime=0,o.last=t,o.tail=a,o.tailMode=i,o.lastEffect=r)}function su(e,n,a){var t=n.pendingProps,i=t.revealOrder,r=t.tail;if(Ie(e,n,t.children,a),t=Z.current,(t&2)!=0)t=t&1|2,n.flags|=64;else{if(e!==null&&(e.flags&64)!=0)e:for(e=n.child;e!==null;){if(e.tag===13)e.memoizedState!==null&&ou(e,a);else if(e.tag===19)ou(e,a);else if(e.child!==null){e.child.return=e,e=e.child;continue}if(e===n)break e;for(;e.sibling===null;){if(e.return===null||e.return===n)break e;e=e.return}e.sibling.return=e.return,e=e.sibling}t&=1}if(_(Z,t),(n.mode&2)==0)n.memoizedState=null;else switch(i){case"forwards":for(a=n.child,i=null;a!==null;)e=a.alternate,e!==null&&oi(e)===null&&(i=a),a=a.sibling;a=i,a===null?(i=n.child,n.child=null):(i=a.sibling,a.sibling=null),ho(n,!1,i,a,r,n.lastEffect);break;case"backwards":for(a=null,i=n.child,n.child=null;i!==null;){if(e=i.alternate,e!==null&&oi(e)===null){n.child=i;break}e=i.sibling,i.sibling=a,a=i,i=e}ho(n,!0,a,null,r,n.lastEffect);break;case"together":ho(n,!1,null,null,void 0,n.lastEffect);break;default:n.memoizedState=null}return n.child}function Qe(e,n,a){if(e!==null&&(n.dependencies=e.dependencies),ja|=n.lanes,(a&n.childLanes)!=0){if(e!==null&&n.child!==e.child)throw Error(k(153));if(n.child!==null){for(e=n.child,a=un(e,e.pendingProps),n.child=a,a.return=n;e.sibling!==null;)e=e.sibling,a=a.sibling=un(e,e.pendingProps),a.return=n;a.sibling=null}return n.child}return null}var lu,go,uu,du;lu=function(e,n){for(var a=n.child;a!==null;){if(a.tag===5||a.tag===6)e.appendChild(a.stateNode);else if(a.tag!==4&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return}a.sibling.return=a.return,a=a.sibling}};go=function(){};uu=function(e,n,a,t){var i=e.memoizedProps;if(i!==t){e=n.stateNode,wn(De.current);var r=null;switch(a){case"input":i=Vi(e,i),t=Vi(e,t),r=[];break;case"option":i=Zi(e,i),t=Zi(e,t),r=[];break;case"select":i=Y({},i,{value:void 0}),t=Y({},t,{value:void 0}),r=[];break;case"textarea":i=qi(e,i),t=qi(e,t),r=[];break;default:typeof i.onClick!="function"&&typeof t.onClick=="function"&&(e.onclick=xt)}er(a,t);var o;a=null;for(d in i)if(!t.hasOwnProperty(d)&&i.hasOwnProperty(d)&&i[d]!=null)if(d==="style"){var s=i[d];for(o in s)s.hasOwnProperty(o)&&(a||(a={}),a[o]="")}else d!=="dangerouslySetInnerHTML"&&d!=="children"&&d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&d!=="autoFocus"&&(ya.hasOwnProperty(d)?r||(r=[]):(r=r||[]).push(d,null));for(d in t){var l=t[d];if(s=i!=null?i[d]:void 0,t.hasOwnProperty(d)&&l!==s&&(l!=null||s!=null))if(d==="style")if(s){for(o in s)!s.hasOwnProperty(o)||l&&l.hasOwnProperty(o)||(a||(a={}),a[o]="");for(o in l)l.hasOwnProperty(o)&&s[o]!==l[o]&&(a||(a={}),a[o]=l[o])}else a||(r||(r=[]),r.push(d,a)),a=l;else d==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,s=s?s.__html:void 0,l!=null&&s!==l&&(r=r||[]).push(d,l)):d==="children"?typeof l!="string"&&typeof l!="number"||(r=r||[]).push(d,""+l):d!=="suppressContentEditableWarning"&&d!=="suppressHydrationWarning"&&(ya.hasOwnProperty(d)?(l!=null&&d==="onScroll"&&j("scroll",e),r||s===l||(r=[])):typeof l=="object"&&l!==null&&l.$$typeof===Yi?l.toString():(r=r||[]).push(d,l))}a&&(r=r||[]).push("style",a);var d=r;(n.updateQueue=d)&&(n.flags|=4)}};du=function(e,n,a,t){a!==t&&(n.flags|=4)};function it(e,n){if(!Ke)switch(e.tailMode){case"hidden":n=e.tail;for(var a=null;n!==null;)n.alternate!==null&&(a=n),n=n.sibling;a===null?e.tail=null:a.sibling=null;break;case"collapsed":a=e.tail;for(var t=null;a!==null;)a.alternate!==null&&(t=a),a=a.sibling;t===null?n||e.tail===null?e.tail=null:e.tail.sibling=null:t.sibling=null}}function Vc(e,n,a){var t=n.pendingProps;switch(n.tag){case 2:case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:return null;case 1:return ke(n.type)&&Vt(),null;case 3:return ra(),V(ye),V(he),$r(),t=n.stateNode,t.pendingContext&&(t.context=t.pendingContext,t.pendingContext=null),(e===null||e.child===null)&&(si(n)?n.flags|=4:t.hydrate||(n.flags|=256)),go(n),null;case 5:Zr(n);var i=wn(qa.current);if(a=n.type,e!==null&&n.stateNode!=null)uu(e,n,a,t,i),e.ref!==n.ref&&(n.flags|=128);else{if(!t){if(n.stateNode===null)throw Error(k(166));return null}if(e=wn(De.current),si(n)){t=n.stateNode,a=n.type;var r=n.memoizedProps;switch(t[en]=n,t[jt]=r,a){case"dialog":j("cancel",t),j("close",t);break;case"iframe":case"object":case"embed":j("load",t);break;case"video":case"audio":for(e=0;e<Qa.length;e++)j(Qa[e],t);break;case"source":j("error",t);break;case"img":case"image":case"link":j("error",t),j("load",t);break;case"details":j("toggle",t);break;case"input":ns(t,r),j("invalid",t);break;case"select":t._wrapperState={wasMultiple:!!r.multiple},j("invalid",t);break;case"textarea":is(t,r),j("invalid",t)}er(a,r),e=null;for(var o in r)r.hasOwnProperty(o)&&(i=r[o],o==="children"?typeof i=="string"?t.textContent!==i&&(e=["children",i]):typeof i=="number"&&t.textContent!==""+i&&(e=["children",""+i]):ya.hasOwnProperty(o)&&i!=null&&o==="onScroll"&&j("scroll",t));switch(a){case"input":Et(t),ts(t,r,!0);break;case"textarea":Et(t),os(t);break;case"select":case"option":break;default:typeof r.onClick=="function"&&(t.onclick=xt)}t=e,n.updateQueue=t,t!==null&&(n.flags|=4)}else{switch(o=i.nodeType===9?i:i.ownerDocument,e===Xi.html&&(e=ss(a)),e===Xi.html?a==="script"?(e=o.createElement("div"),e.innerHTML="<script></script>",e=e.removeChild(e.firstChild)):typeof t.is=="string"?e=o.createElement(a,{is:t.is}):(e=o.createElement(a),a==="select"&&(o=e,t.multiple?o.multiple=!0:t.size&&(o.size=t.size))):e=o.createElementNS(e,a),e[en]=n,e[jt]=t,lu(e,n,!1,!1),n.stateNode=e,o=nr(a,t),a){case"dialog":j("cancel",e),j("close",e),i=t;break;case"iframe":case"object":case"embed":j("load",e),i=t;break;case"video":case"audio":for(i=0;i<Qa.length;i++)j(Qa[i],e);i=t;break;case"source":j("error",e),i=t;break;case"img":case"image":case"link":j("error",e),j("load",e),i=t;break;case"details":j("toggle",e),i=t;break;case"input":ns(e,t),i=Vi(e,t),j("invalid",e);break;case"option":i=Zi(e,t);break;case"select":e._wrapperState={wasMultiple:!!t.multiple},i=Y({},t,{value:void 0}),j("invalid",e);break;case"textarea":is(e,t),i=qi(e,t),j("invalid",e);break;default:i=t}er(a,i);var s=i;for(r in s)if(s.hasOwnProperty(r)){var l=s[r];r==="style"?ds(e,l):r==="dangerouslySetInnerHTML"?(l=l?l.__html:void 0,l!=null&&ls(e,l)):r==="children"?typeof l=="string"?(a!=="textarea"||l!=="")&&va(e,l):typeof l=="number"&&va(e,""+l):r!=="suppressContentEditableWarning"&&r!=="suppressHydrationWarning"&&r!=="autoFocus"&&(ya.hasOwnProperty(r)?l!=null&&r==="onScroll"&&j("scroll",e):l!=null&&Di(e,r,l,o))}switch(a){case"input":Et(e),ts(e,t,!1);break;case"textarea":Et(e),os(e);break;case"option":t.value!=null&&e.setAttribute("value",""+ze(t.value));break;case"select":e.multiple=!!t.multiple,r=t.value,r!=null?Hn(e,!!t.multiple,r,!1):t.defaultValue!=null&&Hn(e,!!t.multiple,t.defaultValue,!0);break;default:typeof i.onClick=="function"&&(e.onclick=xt)}cl(a,t)&&(n.flags|=4)}n.ref!==null&&(n.flags|=128)}return null;case 6:if(e&&n.stateNode!=null)du(e,n,e.memoizedProps,t);else{if(typeof t!="string"&&n.stateNode===null)throw Error(k(166));a=wn(qa.current),wn(De.current),si(n)?(t=n.stateNode,a=n.memoizedProps,t[en]=n,t.nodeValue!==a&&(n.flags|=4)):(t=(a.nodeType===9?a:a.ownerDocument).createTextNode(t),t[en]=n,n.stateNode=t)}return null;case 13:return V(Z),t=n.memoizedState,(n.flags&64)!=0?(n.lanes=a,n):(t=t!==null,a=!1,e===null?n.memoizedProps.fallback!==void 0&&si(n):a=e.memoizedState!==null,t&&!a&&(n.mode&2)!=0&&(e===null&&n.memoizedProps.unstable_avoidThisFallback!==!0||(Z.current&1)!=0?ce===0&&(ce=3):((ce===0||ce===3)&&(ce=4),Se===null||(ja&134217727)==0&&(sa&134217727)==0||la(Se,pe))),(t||a)&&(n.flags|=4),null);case 4:return ra(),go(n),e===null&&ul(n.stateNode.containerInfo),null;case 10:return xr(n),null;case 17:return ke(n.type)&&Vt(),null;case 19:if(V(Z),t=n.memoizedState,t===null)return null;if(r=(n.flags&64)!=0,o=t.rendering,o===null)if(r)it(t,!1);else{if(ce!==0||e!==null&&(e.flags&64)!=0)for(e=n.child;e!==null;){if(o=oi(e),o!==null){for(n.flags|=64,it(t,!1),r=o.updateQueue,r!==null&&(n.updateQueue=r,n.flags|=4),t.lastEffect===null&&(n.firstEffect=null),n.lastEffect=t.lastEffect,t=a,a=n.child;a!==null;)r=a,e=t,r.flags&=2,r.nextEffect=null,r.firstEffect=null,r.lastEffect=null,o=r.alternate,o===null?(r.childLanes=0,r.lanes=e,r.child=null,r.memoizedProps=null,r.memoizedState=null,r.updateQueue=null,r.dependencies=null,r.stateNode=null):(r.childLanes=o.childLanes,r.lanes=o.lanes,r.child=o.child,r.memoizedProps=o.memoizedProps,r.memoizedState=o.memoizedState,r.updateQueue=o.updateQueue,r.type=o.type,e=o.dependencies,r.dependencies=e===null?null:{lanes:e.lanes,firstContext:e.firstContext}),a=a.sibling;return _(Z,Z.current&1|2),n.child}e=e.sibling}t.tail!==null&&ge()>mo&&(n.flags|=64,r=!0,it(t,!1),n.lanes=33554432)}else{if(!r)if(e=oi(o),e!==null){if(n.flags|=64,r=!0,a=e.updateQueue,a!==null&&(n.updateQueue=a,n.flags|=4),it(t,!0),t.tail===null&&t.tailMode==="hidden"&&!o.alternate&&!Ke)return n=n.lastEffect=t.lastEffect,n!==null&&(n.nextEffect=null),null}else 2*ge()-t.renderingStartTime>mo&&a!==1073741824&&(n.flags|=64,r=!0,it(t,!1),n.lanes=33554432);t.isBackwards?(o.sibling=n.child,n.child=o):(a=t.last,a!==null?a.sibling=o:n.child=o,t.last=o)}return t.tail!==null?(a=t.tail,t.rendering=a,t.tail=a.sibling,t.lastEffect=n.lastEffect,t.renderingStartTime=ge(),a.sibling=null,n=Z.current,_(Z,r?n&1|2:n&1),a):null;case 23:case 24:return po(),e!==null&&e.memoizedState!==null!=(n.memoizedState!==null)&&t.mode!=="unstable-defer-without-hiding"&&(n.flags|=4),null}throw Error(k(156,n.tag))}function zc(e){switch(e.tag){case 1:ke(e.type)&&Vt();var n=e.flags;return n&4096?(e.flags=n&-4097|64,e):null;case 3:if(ra(),V(ye),V(he),$r(),n=e.flags,(n&64)!=0)throw Error(k(285));return e.flags=n&-4097|64,e;case 5:return Zr(e),null;case 13:return V(Z),n=e.flags,n&4096?(e.flags=n&-4097|64,e):null;case 19:return V(Z),null;case 4:return ra(),null;case 10:return xr(e),null;case 23:case 24:return po(),null;default:return null}}function fo(e,n){try{var a="",t=n;do a+=Pd(t),t=t.return;while(t);var i=a}catch(r){i=`
Error generating stack: `+r.message+`
`+r.stack}return{value:e,source:n,stack:i}}function So(e,n){try{console.error(n.value)}catch(a){setTimeout(function(){throw a})}}var _c=typeof WeakMap=="function"?WeakMap:Map;function cu(e,n,a){a=rn(-1,a),a.tag=3,a.payload={element:null};var t=n.value;return a.callback=function(){pi||(pi=!0,To=t),So(e,n)},a}function hu(e,n,a){a=rn(-1,a),a.tag=3;var t=e.type.getDerivedStateFromError;if(typeof t=="function"){var i=n.value;a.payload=function(){return So(e,n),t(i)}}var r=e.stateNode;return r!==null&&typeof r.componentDidCatch=="function"&&(a.callback=function(){typeof t!="function"&&(He===null?He=new Set([this]):He.add(this),So(e,n));var o=n.stack;this.componentDidCatch(n.value,{componentStack:o!==null?o:""})}),a}var Zc=typeof WeakSet=="function"?WeakSet:Set;function gu(e){var n=e.ref;if(n!==null)if(typeof n=="function")try{n(null)}catch(a){cn(e,a)}else n.current=null}function qc(e,n){switch(n.tag){case 0:case 11:case 15:case 22:return;case 1:if(n.flags&256&&e!==null){var a=e.memoizedProps,t=e.memoizedState;e=n.stateNode,n=e.getSnapshotBeforeUpdate(n.elementType===n.type?a:Ne(n.type,a),t),e.__reactInternalSnapshotBeforeUpdate=n}return;case 3:n.flags&256&&Rr(n.stateNode.containerInfo);return;case 5:case 6:case 4:case 17:return}throw Error(k(163))}function $c(e,n,a){switch(a.tag){case 0:case 11:case 15:case 22:if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{if((e.tag&3)==3){var t=e.create;e.destroy=t()}e=e.next}while(e!==n)}if(n=a.updateQueue,n=n!==null?n.lastEffect:null,n!==null){e=n=n.next;do{var i=e;t=i.next,i=i.tag,(i&4)!=0&&(i&1)!=0&&(mu(a,e),Xc(a,e)),e=t}while(e!==n)}return;case 1:e=a.stateNode,a.flags&4&&(n===null?e.componentDidMount():(t=a.elementType===a.type?n.memoizedProps:Ne(a.type,n.memoizedProps),e.componentDidUpdate(t,n.memoizedState,e.__reactInternalSnapshotBeforeUpdate))),n=a.updateQueue,n!==null&&Wl(a,n,e);return;case 3:if(n=a.updateQueue,n!==null){if(e=null,a.child!==null)switch(a.child.tag){case 5:e=a.child.stateNode;break;case 1:e=a.child.stateNode}Wl(a,n,e)}return;case 5:e=a.stateNode,n===null&&a.flags&4&&cl(a.type,a.memoizedProps)&&e.focus();return;case 6:return;case 4:return;case 12:return;case 13:a.memoizedState===null&&(a=a.alternate,a!==null&&(a=a.memoizedState,a!==null&&(a=a.dehydrated,a!==null&&Ms(a))));return;case 19:case 17:case 20:case 21:case 23:case 24:return}throw Error(k(163))}function pu(e,n){for(var a=e;;){if(a.tag===5){var t=a.stateNode;if(n)t=t.style,typeof t.setProperty=="function"?t.setProperty("display","none","important"):t.display="none";else{t=a.stateNode;var i=a.memoizedProps.style;i=i!=null&&i.hasOwnProperty("display")?i.display:null,t.style.display=us("display",i)}}else if(a.tag===6)a.stateNode.nodeValue=n?"":a.memoizedProps;else if((a.tag!==23&&a.tag!==24||a.memoizedState===null||a===e)&&a.child!==null){a.child.return=a,a=a.child;continue}if(a===e)break;for(;a.sibling===null;){if(a.return===null||a.return===e)return;a=a.return}a.sibling.return=a.return,a=a.sibling}}function Su(e,n){if(vn&&typeof vn.onCommitFiberUnmount=="function")try{vn.onCommitFiberUnmount(Kr,n)}catch(r){}switch(n.tag){case 0:case 11:case 14:case 15:case 22:if(e=n.updateQueue,e!==null&&(e=e.lastEffect,e!==null)){var a=e=e.next;do{var t=a,i=t.destroy;if(t=t.tag,i!==void 0)if((t&4)!=0)mu(n,a);else{t=n;try{i()}catch(r){cn(t,r)}}a=a.next}while(a!==e)}break;case 1:if(gu(n),e=n.stateNode,typeof e.componentWillUnmount=="function")try{e.props=n.memoizedProps,e.state=n.memoizedState,e.componentWillUnmount()}catch(r){cn(n,r)}break;case 5:gu(n);break;case 4:fu(e,n)}}function Tu(e){e.alternate=null,e.child=null,e.dependencies=null,e.firstEffect=null,e.lastEffect=null,e.memoizedProps=null,e.memoizedState=null,e.pendingProps=null,e.return=null,e.updateQueue=null}function yu(e){return e.tag===5||e.tag===3||e.tag===4}function ku(e){e:{for(var n=e.return;n!==null;){if(yu(n))break e;n=n.return}throw Error(k(160))}var a=n;switch(n=a.stateNode,a.tag){case 5:var t=!1;break;case 3:n=n.containerInfo,t=!0;break;case 4:n=n.containerInfo,t=!0;break;default:throw Error(k(161))}a.flags&16&&(va(n,""),a.flags&=-17);e:n:for(a=e;;){for(;a.sibling===null;){if(a.return===null||yu(a.return)){a=null;break e}a=a.return}for(a.sibling.return=a.return,a=a.sibling;a.tag!==5&&a.tag!==6&&a.tag!==18;){if(a.flags&2||a.child===null||a.tag===4)continue n;a.child.return=a,a=a.child}if(!(a.flags&2)){a=a.stateNode;break e}}t?yo(e,a,n):ko(e,a,n)}function yo(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.nodeType===8?a.parentNode.insertBefore(e,n):a.insertBefore(e,n):(a.nodeType===8?(n=a.parentNode,n.insertBefore(e,a)):(n=a,n.appendChild(e)),a=a._reactRootContainer,a!=null||n.onclick!==null||(n.onclick=xt));else if(t!==4&&(e=e.child,e!==null))for(yo(e,n,a),e=e.sibling;e!==null;)yo(e,n,a),e=e.sibling}function ko(e,n,a){var t=e.tag,i=t===5||t===6;if(i)e=i?e.stateNode:e.stateNode.instance,n?a.insertBefore(e,n):a.appendChild(e);else if(t!==4&&(e=e.child,e!==null))for(ko(e,n,a),e=e.sibling;e!==null;)ko(e,n,a),e=e.sibling}function fu(e,n){for(var a=n,t=!1,i,r;;){if(!t){t=a.return;e:for(;;){if(t===null)throw Error(k(160));switch(i=t.stateNode,t.tag){case 5:r=!1;break e;case 3:i=i.containerInfo,r=!0;break e;case 4:i=i.containerInfo,r=!0;break e}t=t.return}t=!0}if(a.tag===5||a.tag===6){e:for(var o=e,s=a,l=s;;)if(Su(o,l),l.child!==null&&l.tag!==4)l.child.return=l,l=l.child;else{if(l===s)break e;for(;l.sibling===null;){if(l.return===null||l.return===s)break e;l=l.return}l.sibling.return=l.return,l=l.sibling}r?(o=i,s=a.stateNode,o.nodeType===8?o.parentNode.removeChild(s):o.removeChild(s)):i.removeChild(a.stateNode)}else if(a.tag===4){if(a.child!==null){i=a.stateNode.containerInfo,r=!0,a.child.return=a,a=a.child;continue}}else if(Su(e,a),a.child!==null){a.child.return=a,a=a.child;continue}if(a===n)break;for(;a.sibling===null;){if(a.return===null||a.return===n)return;a=a.return,a.tag===4&&(t=!1)}a.sibling.return=a.return,a=a.sibling}}function Io(e,n){switch(n.tag){case 0:case 11:case 14:case 15:case 22:var a=n.updateQueue;if(a=a!==null?a.lastEffect:null,a!==null){var t=a=a.next;do(t.tag&3)==3&&(e=t.destroy,t.destroy=void 0,e!==void 0&&e()),t=t.next;while(t!==a)}return;case 1:return;case 5:if(a=n.stateNode,a!=null){t=n.memoizedProps;var i=e!==null?e.memoizedProps:t;e=n.type;var r=n.updateQueue;if(n.updateQueue=null,r!==null){for(a[jt]=t,e==="input"&&t.type==="radio"&&t.name!=null&&as(a,t),nr(e,i),n=nr(e,t),i=0;i<r.length;i+=2){var o=r[i],s=r[i+1];o==="style"?ds(a,s):o==="dangerouslySetInnerHTML"?ls(a,s):o==="children"?va(a,s):Di(a,o,s,n)}switch(e){case"input":_i(a,t);break;case"textarea":rs(a,t);break;case"select":e=a._wrapperState.wasMultiple,a._wrapperState.wasMultiple=!!t.multiple,r=t.value,r!=null?Hn(a,!!t.multiple,r,!1):e!==!!t.multiple&&(t.defaultValue!=null?Hn(a,!!t.multiple,t.defaultValue,!0):Hn(a,!!t.multiple,t.multiple?[]:"",!1))}}}return;case 6:if(n.stateNode===null)throw Error(k(162));n.stateNode.nodeValue=n.memoizedProps;return;case 3:a=n.stateNode,a.hydrate&&(a.hydrate=!1,Ms(a.containerInfo));return;case 12:return;case 13:n.memoizedState!==null&&(Ao=ge(),pu(n.child,!0)),Au(n);return;case 19:Au(n);return;case 17:return;case 23:case 24:pu(n,n.memoizedState!==null);return}throw Error(k(163))}function Au(e){var n=e.updateQueue;if(n!==null){e.updateQueue=null;var a=e.stateNode;a===null&&(a=e.stateNode=new Zc),n.forEach(function(t){var i=eh.bind(null,e,t);a.has(t)||(a.add(t),t.then(i,i))})}}function nh(e,n){return e!==null&&(e=e.memoizedState,e===null||e.dehydrated!==null)?(n=n.memoizedState,n!==null&&n.dehydrated===null):!1}var ah=Math.ceil,fi=yn.ReactCurrentDispatcher,Co=yn.ReactCurrentOwner,D=0,Se=null,te=null,pe=0,On=0,Eo=nn(0),ce=0,Si=null,ua=0,ja=0,sa=0,vo=0,Mo=null,Ao=0,mo=Infinity;function da(){mo=ge()+500}var M=null,pi=!1,To=null,He=null,hn=!1,rt=null,ot=90,wo=[],Po=[],xe=null,st=0,Wo=null,Ti=-1,Je=0,yi=0,lt=null,ki=!1;function Ee(){return(D&48)!=0?ge():Ti!==-1?Ti:Ti=ge()}function sn(e){if(e=e.mode,(e&2)==0)return 1;if((e&4)==0)return na()===99?1:2;if(Je===0&&(Je=ua),bc.transition!==0){yi!==0&&(yi=Mo!==null?Mo.pendingLanes:0),e=Je;var n=4186112&~yi;return n&=-n,n===0&&(e=4186112&~e,n=e&-e,n===0&&(n=8192)),n}return e=na(),(D&4)!=0&&e===98?e=Gt(12,Je):(e=xd(e),e=Gt(e,Je)),e}function ln(e,n,a){if(50<st)throw st=0,Wo=null,Error(k(185));if(e=Ai(e,n),e===null)return null;Rt(e,n,a),e===Se&&(sa|=n,ce===4&&la(e,pe));var t=na();n===1?(D&8)!=0&&(D&48)==0?Oo(e):(We(e,a),D===0&&(da(),Ue())):((D&4)==0||t!==98&&t!==99||(xe===null?xe=new Set([e]):xe.add(e)),We(e,a)),Mo=e}function Ai(e,n){e.lanes|=n;var a=e.alternate;for(a!==null&&(a.lanes|=n),a=e,e=e.return;e!==null;)e.childLanes|=n,a=e.alternate,a!==null&&(a.childLanes|=n),a=e,e=e.return;return a.tag===3?a.stateNode:null}function We(e,n){for(var a=e.callbackNode,t=e.suspendedLanes,i=e.pingedLanes,r=e.expirationTimes,o=e.pendingLanes;0<o;){var s=31-Xe(o),l=1<<s,d=r[s];if(d===-1){if((l&t)==0||(l&i)!=0){d=n,xn(l);var y=J;r[s]=10<=y?d+250:6<=y?d+5e3:-1}}else d<=n&&(e.expiredLanes|=l);o&=~l}if(t=Ua(e,e===Se?pe:0),n=J,t===0)a!==null&&(a!==br&&Hr(a),e.callbackNode=null,e.callbackPriority=0);else{if(a!==null){if(e.callbackPriority===n)return;a!==br&&Hr(a)}n===15?(a=Oo.bind(null,e),be===null?(be=[a],Zt=Lr(_t,vl)):be.push(a),a=br):n===14?a=Ja(99,Oo.bind(null,e)):(a=Jd(n),a=Ja(a,Iu.bind(null,e))),e.callbackPriority=n,e.callbackNode=a}}function Iu(e){if(Ti=-1,yi=Je=0,(D&48)!=0)throw Error(k(327));var n=e.callbackNode;if(gn()&&e.callbackNode!==n)return null;var a=Ua(e,e===Se?pe:0);if(a===0)return null;var t=a,i=D;D|=16;var r=Eu();(Se!==e||pe!==t)&&(da(),ca(e,t));do try{th();break}catch(s){Cu(e,s)}while(1);if(Qr(),fi.current=r,D=i,te!==null?t=0:(Se=null,pe=0,t=ce),(ua&sa)!=0)ca(e,0);else if(t!==0){if(t===2&&(D|=64,e.hydrate&&(e.hydrate=!1,Rr(e.containerInfo)),a=Gs(e),a!==0&&(t=ut(e,a))),t===1)throw n=Si,ca(e,0),la(e,a),We(e,ge()),n;switch(e.finishedWork=e.current.alternate,e.finishedLanes=a,t){case 0:case 1:throw Error(k(345));case 2:Bn(e);break;case 3:if(la(e,a),(a&62914560)===a&&(t=Ao+500-ge(),10<t)){if(Ua(e,0)!==0)break;if(i=e.suspendedLanes,(i&a)!==a){Ee(),e.pingedLanes|=e.suspendedLanes&i;break}e.timeoutHandle=hl(Bn.bind(null,e),t);break}Bn(e);break;case 4:if(la(e,a),(a&4186112)===a)break;for(t=e.eventTimes,i=-1;0<a;){var o=31-Xe(a);r=1<<o,o=t[o],o>i&&(i=o),a&=~r}if(a=i,a=ge()-a,a=(120>a?120:480>a?480:1080>a?1080:1920>a?1920:3e3>a?3e3:4320>a?4320:1960*ah(a/1960))-a,10<a){e.timeoutHandle=hl(Bn.bind(null,e),a);break}Bn(e);break;case 5:Bn(e);break;default:throw Error(k(329))}}return We(e,ge()),e.callbackNode===n?Iu.bind(null,e):null}function la(e,n){for(n&=~vo,n&=~sa,e.suspendedLanes|=n,e.pingedLanes&=~n,e=e.expirationTimes;0<n;){var a=31-Xe(n),t=1<<a;e[a]=-1,n&=~t}}function Oo(e){if((D&48)!=0)throw Error(k(327));if(gn(),e===Se&&(e.expiredLanes&pe)!=0){var n=pe,a=ut(e,n);(ua&sa)!=0&&(n=Ua(e,n),a=ut(e,n))}else n=Ua(e,0),a=ut(e,n);if(e.tag!==0&&a===2&&(D|=64,e.hydrate&&(e.hydrate=!1,Rr(e.containerInfo)),n=Gs(e),n!==0&&(a=ut(e,n))),a===1)throw a=Si,ca(e,0),la(e,n),We(e,ge()),a;return e.finishedWork=e.current.alternate,e.finishedLanes=n,Bn(e),We(e,ge()),null}function ih(){if(xe!==null){var e=xe;xe=null,e.forEach(function(n){n.expiredLanes|=24&n.pendingLanes,We(n,ge())})}Ue()}function vu(e,n){var a=D;D|=1;try{return e(n)}finally{D=a,D===0&&(da(),Ue())}}function Mu(e,n){var a=D;D&=-2,D|=8;try{return e(n)}finally{D=a,D===0&&(da(),Ue())}}function gi(e,n){_(Eo,On),On|=n,ua|=n}function po(){On=Eo.current,V(Eo)}function ca(e,n){e.finishedWork=null,e.finishedLanes=0;var a=e.timeoutHandle;if(a!==-1&&(e.timeoutHandle=-1,Uc(a)),te!==null)for(a=te.return;a!==null;){var t=a;switch(t.tag){case 1:t=t.type.childContextTypes,t!=null&&Vt();break;case 3:ra(),V(ye),V(he),$r();break;case 5:Zr(t);break;case 4:ra();break;case 13:V(Z);break;case 19:V(Z);break;case 10:xr(t);break;case 23:case 24:po()}a=a.return}Se=e,te=un(e.current,null),pe=On=ua=n,ce=0,Si=null,vo=sa=ja=0}function Cu(e,n){do{var a=te;try{if(Qr(),Xa.current=ui,li){for(var t=q.memoizedState;t!==null;){var i=t.queue;i!==null&&(i.pending=null),t=t.next}li=!1}if($a=0,de=me=q=null,et=!1,Co.current=null,a===null||a.return===null){ce=1,Si=n,te=null;break}e:{var r=e,o=a.return,s=a,l=n;if(n=pe,s.flags|=2048,s.firstEffect=s.lastEffect=null,l!==null&&typeof l=="object"&&typeof l.then=="function"){var d=l;if((s.mode&2)==0){var y=s.alternate;y?(s.updateQueue=y.updateQueue,s.memoizedState=y.memoizedState,s.lanes=y.lanes):(s.updateQueue=null,s.memoizedState=null)}var B=(Z.current&1)!=0,f=o;do{var E;if(E=f.tag===13){var N=f.memoizedState;if(N!==null)E=N.dehydrated!==null;else{var P=f.memoizedProps;E=P.fallback===void 0?!1:P.unstable_avoidThisFallback!==!0?!0:!B}}if(E){var h=f.updateQueue;if(h===null){var u=new Set;u.add(d),f.updateQueue=u}else h.add(d);if((f.mode&2)==0){if(f.flags|=64,s.flags|=16384,s.flags&=-2981,s.tag===1)if(s.alternate===null)s.tag=17;else{var c=rn(-1,1);c.tag=2,on(s,c)}s.lanes|=1;break e}l=void 0,s=n;var m=r.pingCache;if(m===null?(m=r.pingCache=new _c,l=new Set,m.set(d,l)):(l=m.get(d),l===void 0&&(l=new Set,m.set(d,l))),!l.has(s)){l.add(s);var p=rh.bind(null,r,d,s);d.then(p,p)}f.flags|=4096,f.lanes=n;break e}f=f.return}while(f!==null);l=Error((Ln(s.type)||"A React component")+` suspended while rendering, but no fallback UI was specified.

Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.`)}ce!==5&&(ce=2),l=fo(l,s),f=o;do{switch(f.tag){case 3:r=l,f.flags|=4096,n&=-n,f.lanes|=n;var G=cu(f,r,n);Pl(f,G);break e;case 1:r=l;var C=f.type,W=f.stateNode;if((f.flags&64)==0&&(typeof C.getDerivedStateFromError=="function"||W!==null&&typeof W.componentDidCatch=="function"&&(He===null||!He.has(W)))){f.flags|=4096,n&=-n,f.lanes|=n;var U=hu(f,r,n);Pl(f,U);break e}}f=f.return}while(f!==null)}wu(a)}catch(R){n=R,te===a&&a!==null&&(te=a=a.return);continue}break}while(1)}function Eu(){var e=fi.current;return fi.current=ui,e===null?ui:e}function ut(e,n){var a=D;D|=16;var t=Eu();Se===e&&pe===n||ca(e,n);do try{oh();break}catch(i){Cu(e,i)}while(1);if(Qr(),D=a,fi.current=t,te!==null)throw Error(k(261));return Se=null,pe=0,ce}function oh(){for(;te!==null;)Pu(te)}function th(){for(;te!==null&&!Lc();)Pu(te)}function Pu(e){var n=Wu(e.alternate,e,On);e.memoizedProps=e.pendingProps,n===null?wu(e):te=n,Co.current=null}function wu(e){var n=e;do{var a=n.alternate;if(e=n.return,(n.flags&2048)==0){if(a=Vc(a,n,On),a!==null){te=a;return}if(a=n,a.tag!==24&&a.tag!==23||a.memoizedState===null||(On&1073741824)!=0||(a.mode&4)==0){for(var t=0,i=a.child;i!==null;)t|=i.lanes|i.childLanes,i=i.sibling;a.childLanes=t}e!==null&&(e.flags&2048)==0&&(e.firstEffect===null&&(e.firstEffect=n.firstEffect),n.lastEffect!==null&&(e.lastEffect!==null&&(e.lastEffect.nextEffect=n.firstEffect),e.lastEffect=n.lastEffect),1<n.flags&&(e.lastEffect!==null?e.lastEffect.nextEffect=n:e.firstEffect=n,e.lastEffect=n))}else{if(a=zc(n),a!==null){a.flags&=2047,te=a;return}e!==null&&(e.firstEffect=e.lastEffect=null,e.flags|=2048)}if(n=n.sibling,n!==null){te=n;return}te=n=e}while(n!==null);ce===0&&(ce=5)}function Bn(e){var n=na();return Mn(99,sh.bind(null,e,n)),null}function sh(e,n){do gn();while(rt!==null);if((D&48)!=0)throw Error(k(327));var a=e.finishedWork;if(a===null)return null;if(e.finishedWork=null,e.finishedLanes=0,a===e.current)throw Error(k(177));e.callbackNode=null;var t=a.lanes|a.childLanes,i=t,r=e.pendingLanes&~i;e.pendingLanes=i,e.suspendedLanes=0,e.pingedLanes=0,e.expiredLanes&=i,e.mutableReadLanes&=i,e.entangledLanes&=i,i=e.entanglements;for(var o=e.eventTimes,s=e.expirationTimes;0<r;){var l=31-Xe(r),d=1<<l;i[l]=0,o[l]=-1,s[l]=-1,r&=~d}if(xe!==null&&(t&24)==0&&xe.has(e)&&xe.delete(e),e===Se&&(te=Se=null,pe=0),1<a.flags?a.lastEffect!==null?(a.lastEffect.nextEffect=a,t=a.firstEffect):t=a:t=a.firstEffect,t!==null){if(i=D,D|=32,Co.current=null,Br=Ut,o=el(),wr(o)){if("selectionStart"in o)s={start:o.selectionStart,end:o.selectionEnd};else e:if(s=(s=o.ownerDocument)&&s.defaultView||window,(d=s.getSelection&&s.getSelection())&&d.rangeCount!==0){s=d.anchorNode,r=d.anchorOffset,l=d.focusNode,d=d.focusOffset;try{s.nodeType,l.nodeType}catch(R){s=null;break e}var y=0,B=-1,f=-1,E=0,N=0,P=o,h=null;n:for(;;){for(var u;P!==s||r!==0&&P.nodeType!==3||(B=y+r),P!==l||d!==0&&P.nodeType!==3||(f=y+d),P.nodeType===3&&(y+=P.nodeValue.length),(u=P.firstChild)!==null;)h=P,P=u;for(;;){if(P===o)break n;if(h===s&&++E===r&&(B=y),h===l&&++N===d&&(f=y),(u=P.nextSibling)!==null)break;P=h,h=P.parentNode}P=u}s=B===-1||f===-1?null:{start:B,end:f}}else s=null;s=s||{start:0,end:0}}else s=null;Nr={focusedElem:o,selectionRange:s},Ut=!1,lt=null,ki=!1,M=t;do try{lh()}catch(R){if(M===null)throw Error(k(330));cn(M,R),M=M.nextEffect}while(M!==null);lt=null,M=t;do try{for(o=e;M!==null;){var c=M.flags;if(c&16&&va(M.stateNode,""),c&128){var m=M.alternate;if(m!==null){var p=m.ref;p!==null&&(typeof p=="function"?p(null):p.current=null)}}switch(c&1038){case 2:ku(M),M.flags&=-3;break;case 6:ku(M),M.flags&=-3,Io(M.alternate,M);break;case 1024:M.flags&=-1025;break;case 1028:M.flags&=-1025,Io(M.alternate,M);break;case 4:Io(M.alternate,M);break;case 8:s=M,fu(o,s);var G=s.alternate;Tu(s),G!==null&&Tu(G)}M=M.nextEffect}}catch(R){if(M===null)throw Error(k(330));cn(M,R),M=M.nextEffect}while(M!==null);if(p=Nr,m=el(),c=p.focusedElem,o=p.selectionRange,m!==c&&c&&c.ownerDocument&&$s(c.ownerDocument.documentElement,c)){for(o!==null&&wr(c)&&(m=o.start,p=o.end,p===void 0&&(p=m),"selectionStart"in c?(c.selectionStart=m,c.selectionEnd=Math.min(p,c.value.length)):(p=(m=c.ownerDocument||document)&&m.defaultView||window,p.getSelection&&(p=p.getSelection(),s=c.textContent.length,G=Math.min(o.start,s),o=o.end===void 0?G:Math.min(o.end,s),!p.extend&&G>o&&(s=o,o=G,G=s),s=Xs(c,G),r=Xs(c,o),s&&r&&(p.rangeCount!==1||p.anchorNode!==s.node||p.anchorOffset!==s.offset||p.focusNode!==r.node||p.focusOffset!==r.offset)&&(m=m.createRange(),m.setStart(s.node,s.offset),p.removeAllRanges(),G>o?(p.addRange(m),p.extend(r.node,r.offset)):(m.setEnd(r.node,r.offset),p.addRange(m)))))),m=[],p=c;p=p.parentNode;)p.nodeType===1&&m.push({element:p,left:p.scrollLeft,top:p.scrollTop});for(typeof c.focus=="function"&&c.focus(),c=0;c<m.length;c++)p=m[c],p.element.scrollLeft=p.left,p.element.scrollTop=p.top}Ut=!!Br,Nr=Br=null,e.current=a,M=t;do try{for(c=e;M!==null;){var C=M.flags;if(C&36&&$c(c,M.alternate,M),C&128){m=void 0;var W=M.ref;if(W!==null){var U=M.stateNode;switch(M.tag){case 5:m=U;break;default:m=U}typeof W=="function"?W(m):W.current=m}}M=M.nextEffect}}catch(R){if(M===null)throw Error(k(330));cn(M,R),M=M.nextEffect}while(M!==null);M=null,Fc(),D=i}else e.current=a;if(hn)hn=!1,rt=e,ot=n;else for(M=t;M!==null;)n=M.nextEffect,M.nextEffect=null,M.flags&8&&(C=M,C.sibling=null,C.stateNode=null),M=n;if(t=e.pendingLanes,t===0&&(He=null),t===1?e===Wo?st++:(st=0,Wo=e):st=0,a=a.stateNode,vn&&typeof vn.onCommitFiberRoot=="function")try{vn.onCommitFiberRoot(Kr,a,void 0,(a.current.flags&64)==64)}catch(R){}if(We(e,ge()),pi)throw pi=!1,e=To,To=null,e;return(D&8)!=0||Ue(),null}function lh(){for(;M!==null;){var e=M.alternate;ki||lt===null||((M.flags&8)!=0?ys(M,lt)&&(ki=!0):M.tag===13&&nh(e,M)&&ys(M,lt)&&(ki=!0));var n=M.flags;(n&256)!=0&&qc(e,M),(n&512)==0||hn||(hn=!0,Ja(97,function(){return gn(),null})),M=M.nextEffect}}function gn(){if(ot!==90){var e=97<ot?97:ot;return ot=90,Mn(e,uh)}return!1}function Xc(e,n){wo.push(n,e),hn||(hn=!0,Ja(97,function(){return gn(),null}))}function mu(e,n){Po.push(n,e),hn||(hn=!0,Ja(97,function(){return gn(),null}))}function uh(){if(rt===null)return!1;var e=rt;if(rt=null,(D&48)!=0)throw Error(k(331));var n=D;D|=32;var a=Po;Po=[];for(var t=0;t<a.length;t+=2){var i=a[t],r=a[t+1],o=i.destroy;if(i.destroy=void 0,typeof o=="function")try{o()}catch(l){if(r===null)throw Error(k(330));cn(r,l)}}for(a=wo,wo=[],t=0;t<a.length;t+=2){i=a[t],r=a[t+1];try{var s=i.create;i.destroy=s()}catch(l){if(r===null)throw Error(k(330));cn(r,l)}}for(s=e.current.firstEffect;s!==null;)e=s.nextEffect,s.nextEffect=null,s.flags&8&&(s.sibling=null,s.stateNode=null),s=e;return D=n,Ue(),!0}function Ou(e,n,a){n=fo(a,n),n=cu(e,n,1),on(e,n),n=Ee(),e=Ai(e,1),e!==null&&(Rt(e,1,n),We(e,n))}function cn(e,n){if(e.tag===3)Ou(e,e,n);else for(var a=e.return;a!==null;){if(a.tag===3){Ou(a,e,n);break}else if(a.tag===1){var t=a.stateNode;if(typeof a.type.getDerivedStateFromError=="function"||typeof t.componentDidCatch=="function"&&(He===null||!He.has(t))){e=fo(n,e);var i=hu(a,e,1);if(on(a,i),i=Ee(),a=Ai(a,1),a!==null)Rt(a,1,i),We(a,i);else if(typeof t.componentDidCatch=="function"&&(He===null||!He.has(t)))try{t.componentDidCatch(n,e)}catch(r){}break}}a=a.return}}function rh(e,n,a){var t=e.pingCache;t!==null&&t.delete(n),n=Ee(),e.pingedLanes|=e.suspendedLanes&a,Se===e&&(pe&a)===a&&(ce===4||ce===3&&(pe&62914560)===pe&&500>ge()-Ao?ca(e,0):vo|=a),We(e,n)}function eh(e,n){var a=e.stateNode;a!==null&&a.delete(n),n=0,n===0&&(n=e.mode,(n&2)==0?n=1:(n&4)==0?n=na()===99?1:2:(Je===0&&(Je=ua),n=Jn(62914560&~Je),n===0&&(n=4194304))),a=Ee(),e=Ai(e,n),e!==null&&(Rt(e,n,a),We(e,a))}var Wu;Wu=function(e,n,a){var t=n.lanes;if(e!==null)if(e.memoizedProps!==n.pendingProps||ye.current)Ge=!0;else if((a&t)!=0)Ge=(e.flags&16384)!=0;else{switch(Ge=!1,n.tag){case 3:nu(n),Xr();break;case 5:Dl(n);break;case 1:ke(n.type)&&zt(n);break;case 4:_r(n,n.stateNode.containerInfo);break;case 10:t=n.memoizedProps.value;var i=n.type._context;_(qt,i._currentValue),i._currentValue=t;break;case 13:if(n.memoizedState!==null)return(a&n.child.childLanes)!=0?ru(e,n,a):(_(Z,Z.current&1),n=Qe(e,n,a),n!==null?n.sibling:null);_(Z,Z.current&1);break;case 19:if(t=(a&n.childLanes)!=0,(e.flags&64)!=0){if(t)return su(e,n,a);n.flags|=64}if(i=n.memoizedState,i!==null&&(i.rendering=null,i.tail=null,i.lastEffect=null),_(Z,Z.current),t)break;return null;case 23:case 24:return n.lanes=0,lo(e,n,a)}return Qe(e,n,a)}else Ge=!1;switch(n.lanes=0,n.tag){case 2:if(t=n.type,e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,i=ea(n,he.current),ta(n,a),i=no(null,n,t,e,i,a),n.flags|=1,typeof i=="object"&&i!==null&&typeof i.render=="function"&&i.$$typeof===void 0){if(n.tag=1,n.memoizedState=null,n.updateQueue=null,ke(t)){var r=!0;zt(n)}else r=!1;n.memoizedState=i.state!==null&&i.state!==void 0?i.state:null,Jr(n);var o=t.getDerivedStateFromProps;typeof o=="function"&&ei(n,t,o,e),i.updater=ni,n.stateNode=i,i._reactInternals=n,jr(n,t,e,a),n=uo(null,n,t,!0,r,a)}else n.tag=0,Ie(null,n,i,a),n=n.child;return n;case 16:i=n.elementType;e:{switch(e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),e=n.pendingProps,r=i._init,i=r(i._payload),n.type=i,r=n.tag=dh(i),e=Ne(i,e),r){case 0:n=so(null,n,i,e,a);break e;case 1:n=eu(null,n,i,e,a);break e;case 11:n=Zl(null,n,i,e,a);break e;case 14:n=Xl(null,n,i,Ne(i.type,e),t,a);break e}throw Error(k(306,i,""))}return n;case 0:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ne(t,i),so(e,n,t,i,a);case 1:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ne(t,i),eu(e,n,t,i,a);case 3:if(nu(n),t=n.updateQueue,e===null||t===null)throw Error(k(282));if(t=n.pendingProps,i=n.memoizedState,i=i!==null?i.element:null,wl(e,n),Va(n,t,null,a),t=n.memoizedState.element,t===i)Xr(),n=Qe(e,n,a);else{if(i=n.stateNode,(r=i.hydrate)&&(dn=Xn(n.stateNode.containerInfo.firstChild),Ye=n,r=Ke=!0),r){if(e=i.mutableSourceEagerHydrationData,e!=null)for(i=0;i<e.length;i+=2)r=e[i],r._workInProgressVersionPrimary=e[i+1],oa.push(r);for(a=Ul(n,null,t,a),n.child=a;a;)a.flags=a.flags&-3|1024,a=a.sibling}else Ie(e,n,t,a),Xr();n=n.child}return n;case 5:return Dl(n),e===null&&qr(n),t=n.type,i=n.pendingProps,r=e!==null?e.memoizedProps:null,o=i.children,Gr(t,i)?o=null:r!==null&&Gr(t,r)&&(n.flags|=16),$l(e,n),Ie(e,n,o,a),n.child;case 6:return e===null&&qr(n),null;case 13:return ru(e,n,a);case 4:return _r(n,n.stateNode.containerInfo),t=n.pendingProps,e===null?n.child=ri(n,null,t,a):Ie(e,n,t,a),n.child;case 11:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ne(t,i),Zl(e,n,t,i,a);case 7:return Ie(e,n,n.pendingProps,a),n.child;case 8:return Ie(e,n,n.pendingProps.children,a),n.child;case 12:return Ie(e,n,n.pendingProps.children,a),n.child;case 10:e:{t=n.type._context,i=n.pendingProps,o=n.memoizedProps,r=i.value;var s=n.type._context;if(_(qt,s._currentValue),s._currentValue=r,o!==null)if(s=o.value,r=ve(s,r)?0:(typeof t._calculateChangedBits=="function"?t._calculateChangedBits(s,r):1073741823)|0,r===0){if(o.children===i.children&&!ye.current){n=Qe(e,n,a);break e}}else for(s=n.child,s!==null&&(s.return=n);s!==null;){var l=s.dependencies;if(l!==null){o=s.child;for(var d=l.firstContext;d!==null;){if(d.context===t&&(d.observedBits&r)!=0){s.tag===1&&(d=rn(-1,a&-a),d.tag=2,on(s,d)),s.lanes|=a,d=s.alternate,d!==null&&(d.lanes|=a),Ml(s.return,a),l.lanes|=a;break}d=d.next}}else o=s.tag===10&&s.type===n.type?null:s.child;if(o!==null)o.return=s;else for(o=s;o!==null;){if(o===n){o=null;break}if(s=o.sibling,s!==null){s.return=o.return,o=s;break}o=o.return}s=o}Ie(e,n,i.children,a),n=n.child}return n;case 9:return i=n.type,r=n.pendingProps,t=r.children,ta(n,a),i=Me(i,r.unstable_observedBits),t=t(i),n.flags|=1,Ie(e,n,t,a),n.child;case 14:return i=n.type,r=Ne(i,n.pendingProps),r=Ne(i.type,r),Xl(e,n,i,r,t,a);case 15:return ql(e,n,n.type,n.pendingProps,t,a);case 17:return t=n.type,i=n.pendingProps,i=n.elementType===t?i:Ne(t,i),e!==null&&(e.alternate=null,n.alternate=null,n.flags|=2),n.tag=1,ke(t)?(e=!0,zt(n)):e=!1,ta(n,a),Nl(n,t,i),jr(n,t,i,a),uo(null,n,t,!0,e,a);case 19:return su(e,n,a);case 23:return lo(e,n,a);case 24:return lo(e,n,a)}throw Error(k(156,n.tag))};function ch(e,n,a,t){this.tag=e,this.key=a,this.sibling=this.child=this.return=this.stateNode=this.type=this.elementType=null,this.index=0,this.ref=null,this.pendingProps=n,this.dependencies=this.memoizedState=this.updateQueue=this.memoizedProps=null,this.mode=t,this.flags=0,this.lastEffect=this.firstEffect=this.nextEffect=null,this.childLanes=this.lanes=0,this.alternate=null}function we(e,n,a,t){return new ch(e,n,a,t)}function oo(e){return e=e.prototype,!(!e||!e.isReactComponent)}function dh(e){if(typeof e=="function")return oo(e)?1:0;if(e!=null){if(e=e.$$typeof,e===kt)return 11;if(e===It)return 14}return 2}function un(e,n){var a=e.alternate;return a===null?(a=we(e.tag,n,e.key,e.mode),a.elementType=e.elementType,a.type=e.type,a.stateNode=e.stateNode,a.alternate=e,e.alternate=a):(a.pendingProps=n,a.type=e.type,a.flags=0,a.nextEffect=null,a.firstEffect=null,a.lastEffect=null),a.childLanes=e.childLanes,a.lanes=e.lanes,a.child=e.child,a.memoizedProps=e.memoizedProps,a.memoizedState=e.memoizedState,a.updateQueue=e.updateQueue,n=e.dependencies,a.dependencies=n===null?null:{lanes:n.lanes,firstContext:n.firstContext},a.sibling=e.sibling,a.index=e.index,a.ref=e.ref,a}function ii(e,n,a,t,i,r){var o=2;if(t=e,typeof e=="function")oo(e)&&(o=1);else if(typeof e=="string")o=5;else e:switch(e){case Ve:return ia(a.children,i,r,n);case qo:o=8,i|=16;break;case Ki:o=8,i|=1;break;case Aa:return e=we(12,a,n,i|8),e.elementType=Aa,e.type=Aa,e.lanes=r,e;case Ia:return e=we(13,a,n,i),e.type=Ia,e.elementType=Ia,e.lanes=r,e;case At:return e=we(19,a,n,i),e.elementType=At,e.lanes=r,e;case Qi:return co(a,i,r,n);case xi:return e=we(24,a,n,i),e.elementType=xi,e.lanes=r,e;default:if(typeof e=="object"&&e!==null)switch(e.$$typeof){case Li:o=10;break e;case Hi:o=9;break e;case kt:o=11;break e;case It:o=14;break e;case Fi:o=16,t=null;break e;case bi:o=22;break e}throw Error(k(130,e==null?e:typeof e,""))}return n=we(o,a,n,i),n.elementType=e,n.type=t,n.lanes=r,n}function ia(e,n,a,t){return e=we(7,e,t,n),e.lanes=a,e}function co(e,n,a,t){return e=we(23,e,t,n),e.elementType=Qi,e.lanes=a,e}function Vr(e,n,a){return e=we(6,e,null,n),e.lanes=a,e}function zr(e,n,a){return n=we(4,e.children!==null?e.children:[],e.key,n),n.lanes=a,n.stateNode={containerInfo:e.containerInfo,pendingChildren:null,implementation:e.implementation},n}function hh(e,n,a){this.tag=n,this.containerInfo=e,this.finishedWork=this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.pendingContext=this.context=null,this.hydrate=a,this.callbackNode=null,this.callbackPriority=0,this.eventTimes=Sr(0),this.expirationTimes=Sr(-1),this.entangledLanes=this.finishedLanes=this.mutableReadLanes=this.expiredLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=Sr(0),this.mutableSourceEagerHydrationData=null}function gh(e,n,a){var t=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:kn,key:t==null?null:""+t,children:e,containerInfo:n,implementation:a}}function Ii(e,n,a,t){var i=n.current,r=Ee(),o=sn(i);e:if(a){a=a._reactInternals;n:{if(In(a)!==a||a.tag!==1)throw Error(k(170));var s=a;do{switch(s.tag){case 3:s=s.stateNode.context;break n;case 1:if(ke(s.type)){s=s.stateNode.__reactInternalMemoizedMergedChildContext;break n}}s=s.return}while(s!==null);throw Error(k(171))}if(a.tag===1){var l=a.type;if(ke(l)){a=fl(a,l,s);break e}}a=s}else a=an;return n.context===null?n.context=a:n.pendingContext=a,n=rn(r,o),n.payload={element:e},t=t===void 0?null:t,t!==null&&(n.callback=t),on(i,n),ln(i,o,r),o}function Bo(e){if(e=e.current,!e.child)return null;switch(e.child.tag){case 5:return e.child.stateNode;default:return e.child.stateNode}}function Bu(e,n){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var a=e.retryLane;e.retryLane=a!==0&&a<n?a:n}}function No(e,n){Bu(e,n),(e=e.alternate)&&Bu(e,n)}function mh(){return null}function Go(e,n,a){var t=a!=null&&a.hydrationOptions!=null&&a.hydrationOptions.mutableSources||null;if(a=new hh(e,n,a!=null&&a.hydrate===!0),n=we(3,null,null,n===2?7:n===1?3:0),a.current=n,n.stateNode=a,Jr(n),e[qn]=a.current,ul(e.nodeType===8?e.parentNode:e),t)for(e=0;e<t.length;e++){n=t[e];var i=n._getVersion;i=i(n._source),a.mutableSourceEagerHydrationData==null?a.mutableSourceEagerHydrationData=[n,i]:a.mutableSourceEagerHydrationData.push(n,i)}this._internalRoot=a}Go.prototype.render=function(e){Ii(e,this._internalRoot,null,null)};Go.prototype.unmount=function(){var e=this._internalRoot,n=e.containerInfo;Ii(null,e,null,function(){n[qn]=null})};function dt(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11&&(e.nodeType!==8||e.nodeValue!==" react-mount-point-unstable "))}function ph(e,n){if(n||(n=e?e.nodeType===9?e.documentElement:e.firstChild:null,n=!(!n||n.nodeType!==1||!n.hasAttribute("data-reactroot"))),!n)for(var a;a=e.lastChild;)e.removeChild(a);return new Go(e,0,n?{hydrate:!0}:void 0)}function Ci(e,n,a,t,i){var r=a._reactRootContainer;if(r){var o=r._internalRoot;if(typeof i=="function"){var s=i;i=function(){var d=Bo(o);s.call(d)}}Ii(n,o,e,i)}else{if(r=a._reactRootContainer=ph(a,t),o=r._internalRoot,typeof i=="function"){var l=i;i=function(){var d=Bo(o);l.call(d)}}Mu(function(){Ii(n,o,e,i)})}return Bo(o)}ks=function(e){if(e.tag===13){var n=Ee();ln(e,4,n),No(e,4)}};dr=function(e){if(e.tag===13){var n=Ee();ln(e,67108864,n),No(e,67108864)}};As=function(e){if(e.tag===13){var n=Ee(),a=sn(e);ln(e,a,n),No(e,a)}};Is=function(e,n){return n()};tr=function(e,n,a){switch(n){case"input":if(_i(e,a),n=a.name,a.type==="radio"&&n!=null){for(a=e;a.parentNode;)a=a.parentNode;for(a=a.querySelectorAll("input[name="+JSON.stringify(""+n)+'][type="radio"]'),n=0;n<a.length;n++){var t=a[n];if(t!==e&&t.form===e.form){var i=wt(t);if(!i)throw Error(k(90));es(t),_i(t,i)}}}break;case"textarea":rs(e,a);break;case"select":n=a.value,n!=null&&Hn(e,!!a.multiple,n,!1)}};ir=vu;ms=function(e,n,a,t,i){var r=D;D|=4;try{return Mn(98,e.bind(null,n,a,t,i))}finally{D=r,D===0&&(da(),Ue())}};rr=function(){(D&49)==0&&(ih(),gn())};ps=function(e,n){var a=D;D|=2;try{return e(n)}finally{D=a,D===0&&(da(),Ue())}};function Nu(e,n){var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!dt(n))throw Error(k(200));return gh(e,n,null,a)}var fh={Events:[wa,zn,wt,hs,gs,gn,{current:!1}]},ct={findFiberByHostInstance:Cn,bundleType:0,version:"17.0.2",rendererPackageName:"react-dom"},Sh={bundleType:ct.bundleType,version:ct.version,rendererPackageName:ct.rendererPackageName,rendererConfig:ct.rendererConfig,overrideHookState:null,overrideHookStateDeletePath:null,overrideHookStateRenamePath:null,overrideProps:null,overridePropsDeletePath:null,overridePropsRenamePath:null,setSuspenseHandler:null,scheduleUpdate:null,currentDispatcherRef:yn.ReactCurrentDispatcher,findHostInstanceByFiber:function(e){return e=Ts(e),e===null?null:e.stateNode},findFiberByHostInstance:ct.findFiberByHostInstance||mh,findHostInstancesForRefresh:null,scheduleRefresh:null,scheduleRoot:null,setRefreshHandler:null,getCurrentFiber:null};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__!="undefined"&&(ht=__REACT_DEVTOOLS_GLOBAL_HOOK__,!ht.isDisabled&&ht.supportsFiber))try{Kr=ht.inject(Sh),vn=ht}catch(e){}var ht,Th=fh,yh=Nu,kh=function(e){if(e==null)return null;if(e.nodeType===1)return e;var n=e._reactInternals;if(n===void 0)throw typeof e.render=="function"?Error(k(188)):Error(k(268,Object.keys(e)));return e=Ts(n),e=e===null?null:e.stateNode,e},Ah=function(e,n){var a=D;if((a&48)!=0)return e(n);D|=1;try{if(e)return Mn(99,e.bind(null,n))}finally{D=a,Ue()}},Ih=function(e,n,a){if(!dt(n))throw Error(k(200));return Ci(null,e,n,!0,a)},Ch=function(e,n,a){if(!dt(n))throw Error(k(200));return Ci(null,e,n,!1,a)},Eh=function(e){if(!dt(e))throw Error(k(40));return e._reactRootContainer?(Mu(function(){Ci(null,null,e,!1,function(){e._reactRootContainer=null,e[qn]=null})}),!0):!1},vh=vu,Mh=function(e,n){return Nu(e,n,2<arguments.length&&arguments[2]!==void 0?arguments[2]:null)},wh=function(e,n,a,t){if(!dt(a))throw Error(k(200));if(e==null||e._reactInternals===void 0)throw Error(k(38));return Ci(e,n,a,!1,t)},Ph="17.0.2",Wh={__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED:Th,createPortal:yh,findDOMNode:kh,flushSync:Ah,hydrate:Ih,render:Ch,unmountComponentAtNode:Eh,unstable_batchedUpdates:vh,unstable_createPortal:Mh,unstable_renderSubtreeIntoContainer:wh,version:Ph},Oh=je(function(e){function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__=="undefined"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(a){console.error(a)}}n(),e.exports=Wh}),Ro=Oh.render;var Uo=Symbol(),Do=Symbol(),Ko=Symbol(),Ei=Symbol();function Nn(e,n){function a(...t){if(t.length>=e.length)return e(...t);{let i=(...r)=>a(...t,...r);return i[Uo]=e,i[Do]=a,i[Ko]=t,i[Ei]=a[Ei],i}}return a[Uo]=e,a[Do]=a,a[Ko]=[],a[Ei]=n||Gu(e),a}function Lo(e){return e[Uo]}function Bh(e){return e[Do]}function vi(e){return e[Ko]||[]}function Gu(e){return e[Ei]||e.name}function Gh(){let e=[];return{test:n,getAllTests:a};function n(t,i){e.push(...Object.entries(i).map(([r,o])=>Nh(t,r,o)))}function a(){return e}}function S(e,n,...a){let t=n(...a,e);if(typeof t=="function")throw new Error("The matcher function `"+Ho(t)+"` returned a function instead of a boolean. You might need to pass another argument to it.");if(!t)throw new Mi([e,n,...a])}function Nh(e,n,a){return{subject:e,scenario:n,fn:a}}var Mi=class extends Error{constructor(n){super("Expectation failed");this.expectArgs=n}};function Rh(e){return e[e.length-1]}function Ru(e){return e[0]}var Uh=Nn(function(e,n){return e(n)},"which"),b=Nn(function(e,n){var a,t;if(Dh(e))return e(n);if(Array.isArray(e)&&Array.isArray(n))return e.length===n.length&&e.every((i,r)=>b(e[r],n[r]));if(e instanceof Function&&n instanceof Function)return Lo(e)&&Lo(e)===Lo(n)?b(vi(e),vi(n)):e===n;if(e instanceof Date&&n instanceof Date)return e.toISOString()===n.toISOString();if(e instanceof Set&&n instanceof Set)return e.size===n.size&&[...e.values()].every(i=>n.has(i));if(e instanceof Error&&n instanceof Error)return e.message===n.message&&e.__proto__.constructor===n.__proto__.constructor;if(Uu(e)&&Uu(n)){let i=Object.keys(e),r=Object.keys(n);return i.length===r.length&&i.every(o=>b(e[o],n[o]))&&((a=e.__proto__)==null?void 0:a.constructor)===((t=n.__proto__)==null?void 0:t.constructor)}return e===n},"equals"),I=Nn(function(e,n){return e===n},"is"),Fo=Nn(function(e,n,...a){return!e(n,...a)},"not"),Du=Nn(function(e){return/^\s*$/.test(e)},"isBlank");function Uu(e){return!!e&&typeof e=="object"}function Dh(e){return e instanceof Function&&Bh(e)===Uh&&vi(e).length===1}function Ho(e){return Gu(e)||"<function>"}function Lu(e){let n=[];return a(e);function a(l){var d;if(l===null)return"null";if(typeof l=="function")return t(l,i);if(typeof l=="string")return bo(l);if(typeof l=="bigint")return`${l}n`;if(Array.isArray(l))return t(l,r);if(l instanceof Date)return`Date(${l.toISOString().replace("T"," ").replace("Z"," UTC")})`;if(l instanceof RegExp)return String(l);if(l instanceof Error)return`${Ku(l)}(${bo(l.message)})`;if(l instanceof Set)return t(l,s);if(typeof l=="object"){let y=(d=l==null?void 0:l.__proto__)==null?void 0:d.constructor;return y===Object||!y?t(l,o):`${Ku(l)} ${t(l,o)}`}return String(l)}function t(l,d){if(n.indexOf(l)>-1)return"<circular reference>";n.push(l);let y=d(l);return n.pop(),y}function i(l){let d=vi(l).map(a),y=Ho(l);return d.length?gt(y+"(",d,",",")"):y}function r(l){return gt("[",l.map(a),",","]")}function o(l){let d=Object.entries(l).map(([y,B])=>`${Kh(y)}: ${a(B)}`);return gt("{",d,",","}")}function s(l){let d=[...l.values()].map(a);return gt("Set {",d,",","}")}}function Kh(e){return/^[a-zA-Z0-9_$]+$/.test(e)?e:bo(e)}function Ku(e){return Ho(e.__proto__.constructor)}function bo(e){return'"'+String(e).replace(/\\/g,"\\\\").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/"/g,'\\"').replace(/[\x00-\x1f\x7f]/g,Lh)+'"'}function Lh(e){let n=e.charCodeAt(0).toString(16);return"\\x"+(n.length<2?"0"+n:n)}function wi(e,n){return n.split(`
`).map(a=>a&&Fh(Hh(e," "))(a)).join(`
`)}function Hh(e,n){return Array(e+1).join(n)}var Fh=e=>n=>e+n,bh=Nn(function(n,a){return a.slice(0,n.length)===n?a.slice(n.length):a});function Yh(e){return String(e).split(/\r?\n/)}function Qh(e){let n=Yh(e);Du(Ru(n))&&n.shift(),Du(Rh(n))&&n.pop();let a=/^[ \t]*/.exec(Ru(n))[0];return n.map(bh(a)).join(`
`)}function gt(e,n,a,t){return n.length<2?e+n.join("")+t:e+`
`+wi(2,n.join(a+`
`))+`
`+t}function Fu(e){return yt(this,null,function*(){let n=[];for(let a of e){let t=yield xh(a.fn),i=Hu.map(r=>({type:"debug",args:r}));Hu.length=0,n.push({test:a,error:t,instrumentLog:i})}return{results:n}})}function xh(e){let n;try{let a=e();if(a instanceof Promise)return new Promise(t=>{a.then(()=>t()).catch(t)})}catch(a){n=a}return Promise.resolve(n)}var Hu=[],o1=Nn(function(n,a){return a instanceof Mi&&b(n,a.expectArgs)}),Pi=`

`;function bu({results:e}){let n=!1,a=!1,t=[];for(let i of e){let r=!1;i.error&&(r=n=!0),i.instrumentLog.length&&(r=a=!0),r&&t.push(i)}return n?Jh(t):a?Vh(e.length,t):jh(e.length)}function Jh(e){return e.map(Yu).join(Pi)+Pi+"Tests failed."}function jh(e){switch(e){case 0:return"No tests to run.";case 1:return"One test ran, and found no issues.";default:return`${e} tests ran, and found no issues.`}}function Vh(e,n){return n.map(Yu).join(Pi)+Pi+zh(e)+`, but debugging instrumentation is present.
Remove it before shipping.`}function zh(e){switch(e){case 1:return"The test passed";case 2:return"Both tests passed";default:return`All ${e} tests passed`}}function Yu({test:e,error:n,instrumentLog:a}){let i=[e.subject+" "+e.scenario];return a.length&&i.push(wi(2,Zh(a))),n&&i.push(wi(2,_h(n))),i.join(`
`)}function _h(e){return e instanceof Mi?qh(e):Xh(e)}function Zh(e){return e.map(({args:n})=>Qu("debug",n)).join("")}function qh(e){return Qu("expect",e.expectArgs)}function Xh(e){return Lu(e)+" thrown"+wi(2,$h(e.stack))}function Qu(e,n){return gt(e+"(",n.map(Lu),",",")")}function $h(e){if(!e)return"";let n=Qh(e).split(`
`);return`
`+n.slice(0,eg(n)).map(a=>a.replace(/(file:\/\/|http:\/\/[^/]*)/,"").replace(/^([^@]*)@(.*)$/,"at $1 ($2)")).join(`
`)}function eg(e){let n=e.findIndex(a=>a.includes("errorFrom"));return n===-1?e.length:n}var s1=Object.freeze({test:{subject:"a thing",scenario:"does something",fn(){}},error:void 0,instrumentLog:[]}),ng=Gh(),{getAllTests:xu}=ng;function X(...e){}function mn(){return(+new Date%1e6/1e3).toFixed(3)}function Q(e,n=0){return isNaN(e)||e===Infinity||e===-Infinity?"--:--":e<0?"-"+Ju(-e,n):Ju(e,n)}function Ju(e,n){function a(o,s=ag){return(o<10?"0":"")+s(o)}let t=Math.floor(e/3600),i=Math.floor(e%3600/60),r=e%60;return t>0?`${t}:${a(i)}:${a(r,ju(n))}`:`${i}:${a(r,ju(n))}`}X("hoursMinutesSeconds",{"formats NaN"(){S(Q(0/0),I,"--:--")},"formats Infinities"(){S(Q(Infinity),I,"--:--"),S(Q(-Infinity),I,"--:--")},"formats negative numbers"(){S(Q(-1),I,"-0:01"),S(Q(-3661.12,2),I,"-1:01:01.12")},"formats single-digit seconds with leading zero"(){S(Q(0),I,"0:00"),S(Q(1),I,"0:01"),S(Q(9),I,"0:09")},"formats double-digit seconds"(){S(Q(10),I,"0:10"),S(Q(59),I,"0:59")},"formats minutes"(){S(Q(60),I,"1:00"),S(Q(61),I,"1:01"),S(Q(119),I,"1:59"),S(Q(120),I,"2:00"),S(Q(3599),I,"59:59")},"formats hours"(){S(Q(3600),I,"1:00:00"),S(Q(7200),I,"2:00:00"),S(Q(3661),I,"1:01:01"),S(Q(3610),I,"1:00:10"),S(Q(3600+600),I,"1:10:00"),S(Q(36001),I,"10:00:01")},"adds decimal places"(){S(Q(0,0),I,"0:00"),S(Q(0,1),I,"0:00.0"),S(Q(0,2),I,"0:00.00")},"formats fractional seconds"(){S(Q(1.23,2),I,"0:01.23")},"rounds decimals"(){S(Q(2.3456,2),I,"0:02.35")}});var ag=e=>e,ju=e=>n=>n.toFixed(e);function ha(e){var n;return(n=/v=(.{11})/.exec(e))==null?void 0:n[1]}function Vu(){return{getPlayerState(){return re.UNSTARTED},getCurrentTime(){return 0},getVideoUrl(){return""},cueVideoById(){},playVideo(){},seekTo(){},getDuration(){return 0},addEventListener(){},removeEventListener(){}}}function zu(e){return{getPlayerState(){return e.getPlayerState()},getCurrentTime(){return e.getCurrentTime()},getVideoUrl(){return e.getVideoUrl()},cueVideoById(...n){return console.debug(mn(),"player.cueVideoById",...n),e.cueVideoById(...n)},playVideo(...n){return console.debug(mn(),"player.playVideo",...n),e.playVideo(...n)},seekTo(...n){return console.debug(mn(),"player.seekTo",...n,ha(e.getVideoUrl())),e.seekTo(...n)},getDuration(){return e.getDuration()},addEventListener(...n){return console.debug(mn(),"player.addEventListener"),e.addEventListener(...n)},removeEventListener(...n){return console.debug(mn(),"player.removeEventListener"),e.removeEventListener(...n)}}}var re={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5};function _u(e){return yt(this,null,function*(){let n=yield tg();return new Promise(a=>{let t=new n.Player(e,{height:450,width:800,videoId:null,playerVars:{controls:0,disablekb:1},events:{onReady(){a(t)}}})})})}function tg(){return Zu?Promise.resolve(window.YT):new Promise(e=>{var n;if(document.querySelector("script[src='https://www.youtube.com/iframe_api']")===null){let a=document.createElement("script");a.src="https://www.youtube.com/iframe_api";let t=document.getElementsByTagName("script")[0];(n=t.parentNode)==null||n.insertBefore(a,t)}Yo.push(e)})}var Zu=!1,Yo=[];window.onYouTubeIframeAPIReady=()=>{Zu=!0,Yo.forEach(e=>e(window.YT)),Yo.length=0};function qu(e,n){let a=Ta(),t=Ta();t.current=e,Dn(()=>(a.current=setInterval(()=>{var i;return(i=t.current)==null?void 0:i.call(t)},n),()=>clearInterval(a.current)),[n])}function Xu(){let[e,n]=Be(!1);return[e,()=>n(!0)]}function mt(e){switch(e){case re.BUFFERING:return"buffering";case re.UNSTARTED:return"unstarted";case re.CUED:return"cued";case re.ENDED:return"ended";case re.PLAYING:return"playing";case re.PAUSED:return"paused";default:return""}}function $u(e){return e.channel.getName()+" "+mt(e.code)}function pt(e){try{e()}catch(n){return n}}function ga(e,n){if(e.length===0)throw new Error("can't pick element from an empty array");if(n>=1||n<0)throw new Error("fraction out of bounds: "+n);return e[Math.floor(n*e.length)]}X("pick",{"throws if the array is empty"(){S(pt(()=>ga([],0)),b,new Error("can't pick element from an empty array"))},"throws if the fraction is 1"(){S(pt(()=>ga([""],1)),b,new Error("fraction out of bounds: 1"))},"throws if the fraction is > 1"(){S(pt(()=>ga([""],1.25)),b,new Error("fraction out of bounds: 1.25"))},"throws if the fraction is > 0"(){S(pt(()=>ga([""],-.25)),b,new Error("fraction out of bounds: -0.25"))},"picks the first element of the array given 0"(){S(ga([1,2],0),I,1)},"picks the last element of the array given 1 - epsilon"(){S(ga([1,2],.99),I,2)}});function ma(e,n){let a={};return t=>(t in a||(Object.keys(a).length===e&&(a={}),a[t]=n(t)),a[t])}X("cache",{"caches a value"(){let e=0,n=ma(1,()=>(e++,123));n("foo"),n("foo"),S(e,I,1)},"computes and caches values by key"(){let e=ma(2,n=>n+"x");S(e("foo"),I,"foox"),S(e("bar"),I,"barx")},"caches multiple values"(){let e=0,n=ma(2,a=>(e++,a+"x"));n("foo"),n("foo"),n("bar"),n("bar"),S(e,I,2),S(n("foo"),I,"foox"),S(n("bar"),I,"barx")},"a max size of 0 means no limit"(){let e=0,n=ma(0,()=>(e++,123));n("a"),n("b"),n("c"),S(e,I,3)}});function ft(e){let n=1779033703,a=3144134277,t=1013904242,i=2773480762;for(let r=0,o;r<e.length;r++)o=e.charCodeAt(r),n=a^Math.imul(n^o,597399067),a=t^Math.imul(a^o,2869860233),t=i^Math.imul(t^o,951274213),i=n^Math.imul(i^o,2716044179);return n=Math.imul(t^n>>>18,597399067),a=Math.imul(i^a>>>22,2869860233),t=Math.imul(n^t>>>17,951274213),i=Math.imul(a^i>>>19,2716044179),[(n^a^t^i)>>>0,(a^n)>>>0,(t^n)>>>0,(i^n)>>>0]}X("cyrb128_32",{"hashes unix timestamps to random-looking values"(){S(ft("1661673600"),b,[1866196007,1194674827,898714046,497018642]),S(ft("1661760000"),b,[3655929289,901600698,732811234,3355023249]),S(ft("1661846400"),b,[2165297363,2940322590,3636107238,4143219755])}});function Wi(e,n,a,t){function i(){e|=0,n|=0,a|=0,t|=0;var r=(e+n|0)+t|0;return t=t+1|0,e=n^n>>>9,n=a+(a<<3)|0,a=a<<21|a>>>11,a=a+r|0,(r>>>0)/4294967296}for(let r=0;r<20;r++)i();return i}X("sfc32",{"flips coins fairly"(){let e=0,n=0,a=Wi(0,0,0,0);for(let t=0;t<200;t++)a()<.5?e++:n++;S(e-n,I,-8)},"generates a reasonably uniform distribution of numbers"(){let e=new Set,n=Wi(0,0,0,0);for(let a=0;a<100;a++)e.add(Math.floor(n()*1e4));S(e.size,I,99)}});function $(e,n){let a=-1,t=e.length-1;for(;a<t;){let i=ig(a,t);n(e[i])?a=i:t=i-1}return e[a]}function ig(e,n){return Math.ceil((e+n)/2)}X("binarySearch",{"returns undefined given an empty array"(){S($([],()=>!1),I,void 0)},"returns an element that is to the left of the target"(){S($([1],()=>!0),I,1)},"returns undefined when the only element is not left of the target"(){S($([1],()=>!1),I,void 0)},"returns the rightmost element that is left of the target"(){S($([1,2,3,4],e=>e<=2.5),I,2)},"works with duplicates"(){S($([0,1,2,3,0,0,0,0,0],e=>e>0),I,3)},"works with two elements"(){S($([1,2],e=>e<=1.5),I,1),S($([1,2],e=>e<=2),I,2)},"works with three elements"(){S($([1,2,3],e=>e<=1.5),I,1),S($([1,2,3],e=>e<=2),I,2),S($([1,2,3],e=>e<=3),I,3)},"works with four elements"(){S($([1,2,3,4],e=>e<=1.5),I,1),S($([1,2,3,4],e=>e<=2),I,2),S($([1,2,3,4],e=>e<=3),I,3),S($([1,2,3,4],e=>e<=4),I,4)},"works with five elements"(){S($([1,2,3,4,5],e=>e<=1.5),I,1),S($([1,2,3,4,5],e=>e<=2),I,2),S($([1,2,3,4,5],e=>e<=3),I,3),S($([1,2,3,4,5],e=>e<=4),I,4),S($([1,2,3,4,5],e=>e<=5),I,5)}});var St=2,ed=24*3600,rg=8*3600;function pa(e,n){let a=ma(1,Oi(n));return{getBroadcast:t,getName(){return e}};function t(i){let r=i/1e3,o=(r-rg)%ed,s=r-o,l=a(String(s)),d=$(l,y=>y.startAt<=o);return d==null?{type:"nothing",nextVideoId:""}:d.type==="video"?{type:"video",videoId:d.videoId,videoTitle:d.videoTitle,currentTime:o-d.startAt}:{type:"nothing",nextVideoId:d.nextVideoId}}}var Oi=e=>n=>{e=[...e];let a=Wi(...ft(n)),t=0,i=[],r=0;for(;t<ed;){r===e.length&&(r=0),og(e,r,Qo(r,e.length-1,a));let o=e[r++];for(let s of o.videos)i.push({type:"nothing",startAt:t,nextVideoId:s.videoId},{type:"video",videoId:s.videoId,videoTitle:s.title,startAt:t+St}),t+=s.durationSeconds+St}return i};function og(e,n,a){let t=e[n];e[n]=e[a],e[a]=t}function Qo(e,n,a){return e+Math.floor(a()*(n+1-e))}X("randomIntInRange",{"when low and high are the same"(){S(Qo(3,3,Math.random),I,3)},"when low and high are 1 apart"(){let e=new Set;for(let n=0;n<30;n++)e.add(Qo(0,1,Math.random));S(e,b,new Set([0,1]))}});X("ScheduleGenerator",{"schedules a single 24-hour video"(){let e=[{videos:[{durationSeconds:3600*24,videoId:"the-video-id",title:"the-title"}]}],n=Oi(e);S(n(""),b,[{type:"nothing",startAt:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startAt:2}])},"schedules a 12-hour video twice"(){let e=[{videos:[{durationSeconds:3600*12,videoId:"the-video-id",title:"the-title"}]}],n=Oi(e);S(n(""),b,[{type:"nothing",startAt:0,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startAt:2},{type:"nothing",startAt:43202,nextVideoId:"the-video-id"},{type:"video",videoId:"the-video-id",videoTitle:"the-title",startAt:43204}])},"picks the videos to show randomly"(){let e=[{videos:[{durationSeconds:3600*2,videoId:"one",title:""}]},{videos:[{durationSeconds:3600*2,videoId:"two",title:""}]},{videos:[{durationSeconds:3600*2,videoId:"three",title:""}]}],n=Oi(e);S(n("asdfx").map(a=>a.videoId).filter(Boolean),b,["three","one","two","three","two","one","one","two","three","two","three","one"])}});var fa=(...e)=>e.reduce(sg);X("pipe",{"given one function"(){S(fa(n=>n+1)(1),I,2)},"given two functions"(){let e=n=>n+1;S(fa(e,e)(1),I,3)}});function sg(e,n){return(...a)=>n(e(...a))}function Bi(e){return n=>n.map(e)}function oe(e){return e.split(/\n+/).map(ug).filter(Fo(lg)).filter(Fo(dg)).map(Tt(/ +/,3)).flatMap(([n,a,t])=>a==="SHORTS"?[]:[{videoId:n,durationSeconds:Oe(a),title:t}])}X("parseVideos",{"empty string"(){S(oe(""),b,[])},spaces(){S(oe("  "),b,[])},newlines(){S(oe(`
...
# bar`),b,[])},"strips spaces before comments"(){S(oe(`  #foo
  # bar`),b,[])},"parses actual data"(){S(oe(`
    ...
    `),b,[{videoId:"leb645Xu6uo",durationSeconds:654,title:"Captain Murderer - Emlyn Williams"},{videoId:"Ga8tNxnHjt4",durationSeconds:181,title:"Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971"}])},"removes shorts"(){S(oe(`
      undefined SHORTS blah blah
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
    `),b,[{videoId:"leb645Xu6uo",durationSeconds:654,title:"Captain Murderer - Emlyn Williams"}])}});function lg(e){return e.startsWith("#")}function Oe(e){let n=[1,60,3600,86400],a=e.split(":").map(t=>parseInt(t,10)).reverse();return cg(a,n).map(([t,i])=>t*i).reduce(hg,0)}X("parseDuration",{"0:00"(){S(Oe("0:00"),I,0)},"00:00"(){S(Oe("00:00"),I,0)},"1 second"(){S(Oe("0:01"),I,1)},"10 seconds"(){S(Oe("0:10"),I,10)},"1 minute"(){S(Oe("1:00"),I,60)},"1 minute 10 seconds"(){S(Oe("1:10"),I,70)},"10 minutes 10 seconds"(){S(Oe("10:10"),I,610)},"1 hour"(){S(Oe("1:00:00"),I,3600)},"1 hour 1 second"(){S(Oe("1:00:01"),I,3601)},"10 hours 1 second"(){S(Oe("10:00:01"),I,36001)},"1 day 1 second"(){S(Oe("1:0:00:01"),I,86401)}});function ug(e){return e.trim()}function dg(e){return e.length===0}var Tt=(e,n=Infinity)=>a=>{if(typeof e=="string"&&e.length===0)throw"split(): empty delimiter not supported";let t=0,i=0,r=[],o=a;for(;r.length<n-1&&o.length>0;){let s=o.match(e);if(s==null)break;r.push(o.slice(0,s.index)),o=o.slice(s.index+s[0].length)}return r.push(o),r};X("split",{"empty string"(){S(Tt(" ")(""),b,[""])},"no limit"(){S(Tt(" ")("a b c"),b,["a","b","c"])},limit(){S(Tt(" ",2)("a b c"),b,["a","b c"])},regex(){S(Tt(/ +/)("a b   c"),b,["a","b","c"])}});function cg(e,n){let a=[];for(let t=0;t<e.length&&t<n.length;t++)a.push([e[t],n[t]]);return a}function hg(e,n){return e+n}var nd=Bi(fa(oe,e=>({videos:e})))(["BecZdQvjGrY 54:49 In Gowan Ring - Compendium (Full Album)","B3oAx9VmAdA 43:52 In Gowan Ring - Hazel Steps Through A Weathered Home",`
...
`),td=Bi(fa(oe,e=>({videos:e})))([`# Elif'in Hecesi
...
`);var Gi=[pa("Channel 1",[...td,...ad.map(Ni)]),pa("Channel 2",id.map(Ni)),pa("Channel 3",nd),pa("Channel 4",rd.map(Ni)),pa("🎄",od.map(Ni))];function Ni(e){return{videos:[e]}}function sd(e){return w(Un,null,Gi.map(n=>w("button",{key:n.getName(),onClick:()=>e.onChannelSelected(n)},n.getName())))}function ld(){let[e,n]=Be(+new Date);return qu(()=>n(+new Date),250),e}function ud(e=""){return{type:"nothing",nextVideoId:e}}function dd(e,n){let{state:a,videoId:t,time:i}=n;if(e.type==="nothing")switch(a){case re.ENDED:case re.CUED:case re.UNSTARTED:return e.nextVideoId?t!==e.nextVideoId?[{type:"cue",videoId:e.nextVideoId,timestamp:0}]:[{type:"seek",timestamp:0},{type:"play"}]:[];default:return[]}else{if(a===re.BUFFERING)return[];let{videoId:r,currentTime:o}=e;if(t!==r)return[{type:"cue",videoId:r,timestamp:o<St?0:o}];{let s=[];switch(a){case re.PAUSED:case re.CUED:case re.UNSTARTED:t&&s.push({type:"play"})}return i&&gg(i,o)>=St&&(console.debug("time is off; seeking",i,o),s.push({type:"seek",timestamp:o})),s}}}function gg(e,n){return Math.abs(e-n)}var mg=0;function pg(){let[,e]=Be(0);return()=>e(++mg)}function cd(e){let n=pg(),a=Ta(Vu());return Dn(()=>{_u(e).then(t=>{a.current=t,t.addEventListener("onStateChange",i=>{console.debug(mn(),"player onStateChange",mt(i.data),ha(t.getVideoUrl())),n()}),n()})},[e]),a.current}function fg({broadcast:e,player:n}){var t;let a=i=>Q(i,2);return{videoLink:e.type==="video"?{text:e.videoTitle,href:"https://youtube.com/watch?v="+e.videoId}:null,actual:{video:(t=n.videoId)!=null?t:"",playerState:mt(n.state),currentTime:n.time!=null?a(n.time):"-"},scheduled:{video:e.type==="video"?e.videoId:"-",playerState:e.type,currentTime:e.type==="video"?a(e.currentTime):"-"},secondsBehindSchedule:e.type==="video"&&n.time!=null?(e.currentTime-n.time).toFixed(2):"-",timeRemainingInVideo:n.duration!=null&&n.time!=null?a(n.duration-n.time):"-"}}function hd(e){let{broadcast:n,player:a,onClose:t}=e,i=fg({broadcast:n,player:a});return w(Un,null,w("button",{className:"close-button",onClick:t},"close"),w("h1",null,"Culture Machine"),w("p",null,"Made by ",w("a",{href:"https://github.com/benchristel"},"Ben Christel"),"."," ",w("a",{href:"https://github.com/benchristel/tv"},"Source code here"),". Some rights reserved. See the"," ",w("a",{href:"https://www.gnu.org/licenses/gpl-3.0.en.html"},"license"),"."),w("hr",null),w("h2",null,"Video Info"),w("p",{style:{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},"Now playing:"," ",i.videoLink?w("a",{href:i.videoLink.href},i.videoLink.text):"-"),w("table",null,w("thead",null,w("tr",null,w("td",null),w("th",{scope:"col"},"actual"),w("th",{scope:"col"},"scheduled"))),w("tbody",null,w("tr",null,w("th",{scope:"row"},"video"),w("td",null,i.actual.video),w("td",null,i.scheduled.video)),w("tr",null,w("th",{scope:"row"},"player state"),w("td",null,i.actual.playerState),w("td",null,i.scheduled.playerState)),w("tr",null,w("th",{scope:"row"},"current time"),w("td",null,i.actual.currentTime),w("td",null,i.scheduled.currentTime)))),w("p",null,"Seconds behind schedule: ",i.secondsBehindSchedule),w("p",null,"Time remaining in video: ",i.timeRemainingInVideo))}var xo=class extends jo{componentDidUpdate(){let{player:n,commands:a}=this.props;a.forEach(t=>{switch(t.type){case"play":n.playVideo();break;case"cue":n.cueVideoById(t.videoId,t.timestamp);break;case"seek":n.seekTo(t.timestamp);break;default:console.error("unexpected video command type",t.type,t)}})}render(){return null}};function gd(e){return{state:e.getPlayerState(),videoId:ha(e.getVideoUrl()),time:e.getCurrentTime(),duration:e.getDuration()}}function md(){let[e,n]=Xu(),[a,t]=Be(!1),[i,r]=Be(Gi[0]),o=ld(),s=e?i.getBroadcast(o):ud(),l=zu(cd("player-container")),d=gd(l),y=d.state,B=y!==re.PLAYING,f=dd(s,d);return w(Sg,{effects:w(xo,{commands:f,player:l}),screen:w("div",{className:a?"info-pane-open":""},w("div",{className:"player-assembly"},w("div",{id:"player-container"}),B&&w("div",{className:"black-screen"},w($u,{code:y,channel:i})),!e&&w(Tg,{onClick:n})),w("div",{className:"info-pane"},w(hd,{player:d,broadcast:s,onClose:()=>t(!1)})),w("div",{className:"info-pane-close-overlay","aria-hidden":!0,onClick:()=>t(!1)})),controlPanel:w(Un,null,w(sd,{onChannelSelected:E=>{r(E),n()}}),w("button",{className:a?"info-button info-button-info-pane-open":"info-button",onClick:()=>t(!a)},"Info"))})}function Sg(e){return w("div",{className:"App"},w("div",{className:"bezel"},w("div",{className:"screen"},e.screen),w("div",{style:{height:"12px"}}),w("div",{className:"controls"},e.controlPanel),e.effects))}function Tg(e){return w("button",{id:"start",onClick:e.onClick},"▸ Play")}function pd(){let[e,n]=Be("");return Dn(()=>{Fu(xu()).then(bu).then(n).catch(a=>n(a.message))},[]),/fail/i.test(e)?w("div",{className:"TestResults"},w("code",null,w("pre",null,e))):null}Ro(w(md,null),document.getElementById("app"));Ro(w(pd,null),document.getElementById("test-results"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
