...
# bar`),b,[])},"strips spaces before comments"(){S(ce(`  #foo
  # bar`),b,[])},"parses actual data"(){S(ce(`
    ...
    `),b,[{videoId:"leb645Xu6uo",durationSeconds:654,title:"Captain Murderer - Emlyn Williams"},{videoId:"Ga8tNxnHjt4",durationSeconds:181,title:"Sut Wnaethoch Chi Sillafu Caernarfon? Y Dydd 1971"}])},"removes shorts"(){S(ce(`
      ...
      leb645Xu6uo 10:54 Captain Murderer - Emlyn Williams
    `),b,[{videoId:"leb645Xu6uo",durationSeconds:654,title:"Captain Murderer - Emlyn Williams"}])}});function cg(e){return e.startsWith("#")}function Oe(e){let n=[1,60,3600,86400],a=e.split(":").map(t=>parseInt(t,10)).reverse();return mg(a,n).map(([t,i])=>t*i).reduce(pg,0)}X("parseDuration",{"0:00"(){S(Oe("0:00"),I,0)},"00:00"(){S(Oe("00:00"),I,0)},"1 second"(){S(Oe("0:01"),I,1)},"10 seconds"(){S(Oe("0:10"),I,10)},"1 minute"(){S(Oe("1:00"),I,60)},"1 minute 10 seconds"(){S(Oe("1:10"),I,70)},"10 minutes 10 seconds"(){S(Oe("10:10"),I,610)},"1 hour"(){S(Oe("1:00:00"),I,3600)},"1 hour 1 second"(){S(Oe("1:00:01"),I,3601)},"10 hours 1 second"(){S(Oe("10:00:01"),I,36001)},"1 day 1 second"(){S(Oe("1:0:00:01"),I,86401)}});function hg(e){return e.trim()}function gg(e){return e.length===0}var Tt=(e,n=Infinity)=>a=>{if(typeof e=="string"&&e.length===0)throw"split(): empty delimiter not supported";let t=0,i=0,r=[],o=a;for(;r.length<n-1&&o.length>0;){let s=o.match(e);if(s==null)break;r.push(o.slice(0,s.index)),o=o.slice(s.index+s[0].length)}return r.push(o),r};X("split",{"empty string"(){S(Tt(" ")(""),b,[""])},"no limit"(){S(Tt(" ")("a b c"),b,["a","b","c"])},limit(){S(Tt(" ",2)("a b c"),b,["a","b c"])},regex(){S(Tt(/ +/)("a b   c"),b,["a","b","c"])}});function mg(e,n){let a=[];for(let t=0;t<e.length&&t<n.length;t++)a.push([e[t],n[t]]);return a}function pg(e,n){return e+n}var td=Ni(["BecZdQvjGrY 54:49 In Gowan Ring - Compendium (Full Album)","B3oAx9VmAdA 43:52 In Gowan Ring - Hazel Steps Through A Weathered Home",`
