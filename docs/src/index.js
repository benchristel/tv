...
`);var Wi=[wi("Channel 1",Vu.map(Zu)),wi("Channel 2",_u.map(Zu)),wi("Channel 3",Ju)];function Zu(e){return{videos:[e]}}function qu(e){return w(Dn,null,Wi.map(n=>w("button",{key:n.getName(),onClick:()=>e.onChannelSelected(n)},n.getName())))}function Xu(){let[e,n]=Oe(+new Date);return Qu(()=>n(+new Date),250),e}function $u(e=""){return{type:"nothing",nextVideoId:e}}function ec(e,n){let a=n.getPlayerState(),t=mn(n.getVideoUrl());if(e.type==="nothing")switch(a){case te.ENDED:case te.CUED:case te.UNSTARTED:if(!e.nextVideoId)break;t!==e.nextVideoId?n.cueVideoById(e.nextVideoId,0):(n.seekTo(0),n.playVideo())}else{if(a===te.BUFFERING)return;let{videoId:i,currentTime:r}=e;if(t!==i)n.cueVideoById(i,r<mt?0:r);else{switch(a){case te.PAUSED:case te.CUED:case te.UNSTARTED:t&&n.playVideo()}let o=n.getCurrentTime();eg(o,r)>=mt&&(console.debug("time is off; seeking",o,r),n.seekTo(r))}}}function eg(e,n){return Math.abs(e-n)}var ng=0;function ag(){let[,e]=Oe(0);return()=>e(++ng)}function nc(e){let n=ag(),a=pa(Fu());return Rn(()=>{Yu(e).then(t=>{a.current=t,t.addEventListener("onStateChange",i=>{console.debug(gn(),"player onStateChange",dt(i.data),mn(t.getVideoUrl())),n()}),n()})},[e]),a.current}function tg({broadcast:e,player:n}){var t;let a=i=>Y(i,2);return{videoLink:e.type==="video"?{text:e.videoTitle,href:"https://youtube.com/watch?v="+e.videoId}:null,actual:{video:(t=mn(n.getVideoUrl()))!=null?t:"",playerState:dt(n.getPlayerState()),currentTime:a(n.getCurrentTime()||NaN)},scheduled:{video:e.type==="video"?e.videoId:"-",playerState:e.type,currentTime:e.type==="video"?a(e.currentTime):"-"},secondsBehindSchedule:e.type==="video"?(e.currentTime-n.getCurrentTime()).toFixed(2):"-",timeRemainingInVideo:a(n.getDuration()-n.getCurrentTime())}}function ac(e){let n=tg(e);return w(Dn,null,w("h1",null,"Culture Machine"),w("p",null,"Mainly tended by"," ",w("a",{href:"https://github.com/benchristel"},"Ben Christel"),"."," ",w("a",{href:"https://github.com/benchristel/tv"},"Source code here"),". Some rights reserved. See the"," ",w("a",{href:"https://www.gnu.org/licenses/gpl-3.0.en.html"},"license"),"."),w("hr",null),w("h2",null,"Video Info"),w("p",{style:{whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}},"Now playing:"," ",n.videoLink?w("a",{href:n.videoLink.href},n.videoLink.text):"-"),w("table",null,w("thead",null,w("tr",null,w("td",null),w("th",{scope:"col"},"actual"),w("th",{scope:"col"},"scheduled"))),w("tbody",null,w("tr",null,w("th",{scope:"row"},"video"),w("td",null,n.actual.video),w("td",null,n.scheduled.video)),w("tr",null,w("th",{scope:"row"},"player state"),w("td",null,n.actual.playerState),w("td",null,n.scheduled.playerState)),w("tr",null,w("th",{scope:"row"},"current time"),w("td",null,n.actual.currentTime),w("td",null,n.scheduled.currentTime)))),w("p",null,"Seconds behind schedule: ",n.secondsBehindSchedule),w("p",null,"Time remaining in video: ",n.timeRemainingInVideo))}function tc(){let[e,n]=ju(),[a,t]=Oe(!1),[i,r]=Oe(Wi[0]),o=Xu(),s=e?i.getBroadcast(o):$u(),l=bu(nc("player-container")),c=l.getPlayerState(),S=c!==te.PLAYING;return ec(s,l),w(ig,{screen:w("div",{className:a?"info-pane-open":""},w("div",{className:"player-assembly"},w("div",{id:"player-container"}),S&&w("div",{className:"black-screen"},w(zu,{code:c,channel:i})),!e&&w(rg,{onClick:n})),w("div",{className:"info-pane"},w(ac,{player:l,broadcast:s}))),controlPanel:w(Dn,null,w(qu,{onChannelSelected:W=>{r(W),n()}}),w("button",{className:a?"info-button info-button-info-pane-open":"info-button",onClick:()=>t(!a)},"Info"))})}function ig(e){return w("div",{className:"App"},w("div",{className:"bezel"},w("div",{className:"screen"},e.screen),w("div",{style:{height:"12px"}}),w("div",{className:"controls"},e.controlPanel)))}function rg(e){return w("button",{id:"start",onClick:e.onClick},"▸ Play")}function ic(){let[e,n]=Oe("");return Rn(()=>{Ku(Ru()).then(Uu).then(n).catch(a=>n(a.message))},[]),/fail/i.test(e)?w("div",{className:"TestResults"},w("code",null,w("pre",null,e))):null}Po(w(tc,null),document.getElementById("app"));Po(w(ic,null),document.getElementById("test-results"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
